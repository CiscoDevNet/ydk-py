...
_meta_table = {
    'ENTITYSTATEMIB.EntStateTable.EntStateEntry' : {
        'meta_info' : _MetaInfoClass('ENTITYSTATEMIB.EntStateTable.EntStateEntry',
            ...
            _MetaInfoClassMember('entStateAdmin', REFERENCE_ENUM_CLASS, 'EntityAdminState_Enum' , 'ydk.models.entity.ENTITY_STATE_TC_MIB', 'EntityAdminState_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('entStateAlarm', REFERENCE_BITS, 'EntityAlarmStatus_Bits' , 'ydk.models.entity.ENTITY_STATE_TC_MIB', 'EntityAlarmStatus_Bits', 
                [], [], 
            ...
            _MetaInfoClassMember('entStateLastChanged', ATTRIBUTE, 'str' , None, None, 
                ...
                'entstatelastchanged',
                'ENTITY-STATE-MIB', False),
            _MetaInfoClassMember('entStateOper', REFERENCE_ENUM_CLASS, 'EntityOperState_Enum' , 'ydk.models.entity.ENTITY_STATE_TC_MIB', 'EntityOperState_Enum', 
                [], [], 
                ...
                'entstateoper',
                'ENTITY-STATE-MIB', False),
            _MetaInfoClassMember('entStateStandby', REFERENCE_ENUM_CLASS, 'EntityStandbyStatus_Enum' , 'ydk.models.entity.ENTITY_STATE_TC_MIB', 'EntityStandbyStatus_Enum', 
                [], [], 
                ...
                'entstatestandby',
                'ENTITY-STATE-MIB', False),
            _MetaInfoClassMember('entStateUsage', REFERENCE_ENUM_CLASS, 'EntityUsageState_Enum' , 'ydk.models.entity.ENTITY_STATE_TC_MIB', 'EntityUsageState_Enum', 
                [], [], 
        ...
        'ydk.models.entity.ENTITY_STATE_MIB'
        ),
    },
    'ENTITYSTATEMIB.EntStateTable' : {
        'meta_info' : _MetaInfoClass('ENTITYSTATEMIB.EntStateTable',
            False, 
            [
            _MetaInfoClassMember('entStateEntry', REFERENCE_LIST, 'EntStateEntry' , 'ydk.models.entity.ENTITY_STATE_MIB', 'ENTITYSTATEMIB.EntStateTable.EntStateEntry', 
                [], [], 
    ...
    'ENTITYSTATEMIB' : {
        'meta_info' : _MetaInfoClass('ENTITYSTATEMIB',
            False, 
            [
            _MetaInfoClassMember('entStateTable', REFERENCE_CLASS, 'EntStateTable' , 'ydk.models.entity.ENTITY_STATE_MIB', 'ENTITYSTATEMIB.EntStateTable', 
                [], [], 
