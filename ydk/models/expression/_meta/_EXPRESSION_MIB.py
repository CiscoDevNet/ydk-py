...
_meta_table = {
    'EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionError_Enum' : _MetaInfoEnum('ExpExpressionError_Enum', 'ydk.models.expression.EXPRESSION_MIB',
        {
    ...
    'EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionValueType_Enum' : _MetaInfoEnum('ExpExpressionValueType_Enum', 'ydk.models.expression.EXPRESSION_MIB',
        {
            'counter32':'COUNTER32',
    ...
    'EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry',
            ...
            _MetaInfoClassMember('expExpressionDeltaInterval', ATTRIBUTE, 'int' , None, None, 
                ...
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expExpressionError', REFERENCE_ENUM_CLASS, 'ExpExpressionError_Enum' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionError_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('expExpressionPrefix', ATTRIBUTE, 'str' , None, None, 
                ...
                'expexpressionprefix',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expExpressionValueType', REFERENCE_ENUM_CLASS, 'ExpExpressionValueType_Enum' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionValueType_Enum', 
                [], [], 
        ...
        'ydk.models.expression.EXPRESSION_MIB'
        ),
    },
    'EXPRESSIONMIB.ExpExpressionTable' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpExpressionTable',
            False, 
            [
            _MetaInfoClassMember('expExpressionEntry', REFERENCE_LIST, 'ExpExpressionEntry' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry', 
                [], [], 
    ...
    'EXPRESSIONMIB.ExpNameTable.ExpNameEntry' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpNameTable.ExpNameEntry',
            ...
            _MetaInfoClassMember('expExpressionIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'expexpressionindex',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expNameStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'EXPRESSIONMIB.ExpNameTable' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpNameTable',
            False, 
            [
            _MetaInfoClassMember('expNameEntry', REFERENCE_LIST, 'ExpNameEntry' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpNameTable.ExpNameEntry', 
                [], [], 
    ...
    'EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectDiscontinuityIDType_Enum' : _MetaInfoEnum('ExpObjectDiscontinuityIDType_Enum', 'ydk.models.expression.EXPRESSION_MIB',
        {
            'timeTicks':'TIMETICKS',
            'timeStamp':'TIMESTAMP',
        }, 'EXPRESSION-MIB', _yang_ns._namespaces['EXPRESSION-MIB']),
    'EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectSampleType_Enum' : _MetaInfoEnum('ExpObjectSampleType_Enum', 'ydk.models.expression.EXPRESSION_MIB',
        {
    ...
    'EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry',
            ...
            _MetaInfoClassMember('expObjectDeltaDiscontinuityID', ATTRIBUTE, 'str' , None, None, 
                ...
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectDiscontinuityIDType', REFERENCE_ENUM_CLASS, 'ExpObjectDiscontinuityIDType_Enum' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectDiscontinuityIDType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('expObjectIDWildcard', ATTRIBUTE, 'bool' , None, None, 
                ...
                'expobjectidwildcard',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectSampleType', REFERENCE_ENUM_CLASS, 'ExpObjectSampleType_Enum' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectSampleType_Enum', 
                [], [], 
                ...
                'expobjectsampletype',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The control that allows creation/deletion of entries.
    ...
    'EXPRESSIONMIB.ExpObjectTable' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpObjectTable',
            False, 
            [
            _MetaInfoClassMember('expObjectEntry', REFERENCE_LIST, 'ExpObjectEntry' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry', 
                [], [], 
    ...
    'EXPRESSIONMIB.ExpValueTable' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB.ExpValueTable',
            False, 
            [
            _MetaInfoClassMember('expValueEntry', REFERENCE_LIST, 'ExpValueEntry' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpValueTable.ExpValueEntry', 
                [], [], 
    ...
    'EXPRESSIONMIB' : {
        'meta_info' : _MetaInfoClass('EXPRESSIONMIB',
            False, 
            [
            _MetaInfoClassMember('expExpressionTable', REFERENCE_CLASS, 'ExpExpressionTable' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpExpressionTable', 
                [], [], 
                '''                A table of expression definitions.
                ''',
                'expexpressiontable',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expNames', REFERENCE_CLASS, 'ExpNames' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpNames', 
                [], [], 
                '''                ''',
                'expnames',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expNameTable', REFERENCE_CLASS, 'ExpNameTable' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpNameTable', 
                [], [], 
                ...
                'expnametable',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectTable', REFERENCE_CLASS, 'ExpObjectTable' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpObjectTable', 
                [], [], 
                ...
                'expobjecttable',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expResource', REFERENCE_CLASS, 'ExpResource' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpResource', 
                [], [], 
                '''                ''',
                'expresource',
                'EXPRESSION-MIB', False),
            _MetaInfoClassMember('expValueTable', REFERENCE_CLASS, 'ExpValueTable' , 'ydk.models.expression.EXPRESSION_MIB', 'EXPRESSIONMIB.ExpValueTable', 
                [], [], 
