    ...
    class Nodes(Entity):
        ...
        class Node(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"client-ids" : ("client_ids", SessionRedundancyAgent.Nodes.Node.ClientIds), "group-id-xr" : ("group_id_xr", SessionRedundancyAgent.Nodes.Node.GroupIdXr), "group-ids" : ("group_ids", SessionRedundancyAgent.Nodes.Node.GroupIds), "group-summaries" : ("group_summaries", SessionRedundancyAgent.Nodes.Node.GroupSummaries), "interfaces" : ("interfaces", SessionRedundancyAgent.Nodes.Node.Interfaces), "memory" : ("memory", SessionRedundancyAgent.Nodes.Node.Memory), "stats-global" : ("stats_global", SessionRedundancyAgent.Nodes.Node.StatsGlobal)}
                self._child_list_classes = {}
            ...
            class ClientIds(Entity):
                ...
                class ClientId(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.ClientIds.ClientId, ['stats_client_id', 'clean_call_back', 'last_replay_all_count', 'tx_list_active_not_ok', 'tx_list_active_ok', 'tx_list_clear_all_add_not_ok', 'tx_list_clear_all_add_ok', 'tx_list_clear_selected_add_not_ok', 'tx_list_clear_selected_add_ok', 'tx_list_client_cleanup', 'tx_list_client_connection_down', 'tx_list_client_de_registration', 'tx_list_client_registration_not_ok', 'tx_list_client_registration_ok', 'tx_list_de_active_not_ok', 'tx_list_de_active_ok', 'tx_list_encode_session_session_ok', 'tx_list_encode_session_session_partial_write', 'tx_list_end_of_download_add_not_ok', 'tx_list_end_of_download_add_ok', 'tx_list_end_of_message_add_not_ok', 'tx_list_end_of_message_add_ok', 'tx_list_receive_command_replay_all', 'tx_list_receive_command_replay_selected', 'tx_list_receive_session_session_clear_all', 'tx_list_receive_session_session_clear_selected', 'tx_list_receive_session_session_delete_invalid', 'tx_list_receive_session_session_delete_valid', 'tx_list_receive_session_session_eod_all', 'tx_list_receive_session_session_eod_selected', 'tx_list_receive_session_session_eoms', 'tx_list_receive_session_session_neg_ack', 'tx_list_receive_session_session_neg_ack_not_ok', 'tx_list_receive_session_session_sod_all', 'tx_list_receive_session_session_sod_selected', 'tx_list_receive_session_session_update_invalid', 'tx_list_receive_session_session_update_valid', 'tx_list_replay_all_add_not_ok', 'tx_list_replay_all_add_ok', 'tx_list_replay_selected_add_not_ok', 'tx_list_replay_selected_add_ok', 'tx_list_session_session_add_not_ok', 'tx_list_session_session_add_ok', 'tx_list_session_session_delete', 'tx_list_session_session_update_not_ok', 'tx_list_session_session_update_ok', 'tx_list_start_of_download_add_not_ok', 'tx_list_start_of_download_add_ok'], name, value)
            ...
            class GroupIdXr(Entity):
                ...
                class GroupId(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.GroupIdXr.GroupId, ['group_id', 'group_id_xr', 'interface_name', 'key_index', 'negative_acknowledgement_update_all', 'role_master'], name, value)
                    ...
                    class SessionDetailedInformation(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(SessionRedundancyAgent.Nodes.Node.GroupIdXr.GroupId.SessionDetailedInformation, ['component', 'marked_for_cleanup', 'marked_for_sweeping', 'operation_', 'tx_list_queue_fail'], name, value)
                    ...
                    class SessionSyncErrorInformation(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(SessionRedundancyAgent.Nodes.Node.GroupIdXr.GroupId.SessionSyncErrorInformation, ['last_error_code', 'last_error_type', 'sync_error_count'], name, value)
            ...
            class GroupIds(Entity):
                ...
                class GroupId(Entity):
                    ...
                    class Interface(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(SessionRedundancyAgent.Nodes.Node.GroupIds.GroupId.Interface, ['forward_referenced', 'interface_name', 'interface_synchronization_id', 'session_count'], name, value)
            ...
            class GroupSummaries(Entity):
                ...
                class GroupSummary(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.GroupSummaries.GroupSummary, ['group_id', 'disabled', 'group_id_xr', 'interface_count', 'object_tracking_status', 'peer_ipv4_address', 'peer_ipv6_address', 'peer_status', 'pending_add_session_count', 'preferred_role', 'role', 'session_count', 'slave_mode'], name, value)
            ...
            class Interfaces(Entity):
                ...
                class Interface(Entity):
                    ...
                    class InterfaceOper(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(SessionRedundancyAgent.Nodes.Node.Interfaces.Interface.InterfaceOper, ['idb_oper_attr_update', 'idb_oper_caps_add', 'idb_oper_caps_remove', 'idb_oper_reg_disable', 'idb_oper_reg_enable'], name, value)
                    ...
                    class InterfaceStatus(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(SessionRedundancyAgent.Nodes.Node.Interfaces.Interface.InterfaceStatus, ['idb_client_eoms_pending', 'idb_state_caps_added', 'idb_state_fwd_ref', 'idb_state_owned_re_source', 'idb_state_p_end_caps_rem', 'idb_state_p_end_reg_disable', 'idb_state_registered', 'idb_state_stale'], name, value)
            ...
            class Memory(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = True
                    self._child_container_classes = {}
                    self._child_list_classes = {"edm-memory-info" : ("edm_memory_info", SessionRedundancyAgent.Nodes.Node.Memory.EdmMemoryInfo), "memory-info" : ("memory_info", SessionRedundancyAgent.Nodes.Node.Memory.MemoryInfo), "string-memory-info" : ("string_memory_info", SessionRedundancyAgent.Nodes.Node.Memory.StringMemoryInfo)}
                ...
                class EdmMemoryInfo(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.Memory.EdmMemoryInfo, ['failure', 'size', 'success', 'total'], name, value)
                ...
                class MemoryInfo(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.Memory.MemoryInfo, ['alloc_count', 'alloc_fails', 'current_count', 'freed_count', 'memory_type', 'size', 'structure_name'], name, value)
                ...
                class StringMemoryInfo(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.Memory.StringMemoryInfo, ['failure', 'size', 'success', 'total'], name, value)
            ...
            class StatsGlobal(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(SessionRedundancyAgent.Nodes.Node.StatsGlobal, ['client_init_sync_time_stamp', 'peer_action_timer', 'peer_init_sync_time_stamp', 'redundancy_role', 'restart_client_sync_in_progress', 'restart_peer_sync_in_progress', 'retry_timer_remaining', 'source_interface_ipv4_address', 'source_interface_ipv6_address', 'source_interface_name', 'sync_in_progress', 'tx_list_client_connection_down', 'tx_list_client_connection_up', 'tx_list_client_de_registration_invalid', 'tx_list_client_message_call_back', 'tx_list_client_peer_done', 'tx_list_client_receive_command_invalid', 'tx_list_client_receive_command_valid', 'tx_list_client_receive_invalid', 'tx_list_client_receive_session_session_invalid', 'tx_list_client_receive_session_sessionvalid', 'tx_list_client_receive_valid', 'tx_list_client_registration_invalid', 'tx_list_peer_cmd_connection_down_not_ok', 'tx_list_peer_cmd_connection_up_not_ok', 'tx_list_peer_de_registration_invalid', 'tx_list_peer_done', 'tx_list_peer_message_call_back_invalid', 'tx_list_peer_message_call_back_valid', 'tx_list_peer_registration_invalid', 'tx_list_peer_session_connection_down_not_ok', 'tx_list_peer_session_connection_up_not_ok', 'tx_list_peer_timer_handler', 'vrf_name'], name, value)
                ...
                class ClientStatus(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.StatsGlobal.ClientStatus, ['clean_up_timer_remaining', 'client_connection_status', 'client_initialization_synchronization_pending', 'client_synchronization_end_of_download_pending', 'component', 'down_time_stamp', 'up_time_stamp'], name, value)
                ...
                class IntfStatusStatistics(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.StatsGlobal.IntfStatusStatistics, ['grp_bound_cnt', 'non_stale_cnt', 'pend_caps_rem_cnt', 'pend_other_batch_oper_cnt', 'pend_reg_disable_cnt'], name, value)
                ...
                class OpaqueMemoryStatus(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.StatsGlobal.OpaqueMemoryStatus, ['component', 'opaque_data_size', 'opaque_high_size', 'opaque_size', 'session_count'], name, value)
                ...
                class TxListOverTcpStatus(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.StatsGlobal.TxListOverTcpStatus, ['accept_count', 'active_socket_count', 'blocked_connect_count', 'buffer_cache_hit', 'buffer_cache_miss', 'buffer_freed_count', 'buffer_full_occurence_count', 'bytes_received', 'bytes_sent', 'connect_count', 'connect_retry_count', 'maximum_received_message_size', 'maximum_requested_buffer_size', 'maximum_sent_message_size', 'mem_move_bytes_count', 'mem_move_message_count', 'messages_received', 'messages_sent', 'peer_pause_count', 'remote_node_down_count', 'socket_read_count', 'socket_write_count'], name, value)
                ...
                class TxListStatistics(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.StatsGlobal.TxListStatistics, ['tx_list_clean_command', 'tx_list_clean_marker', 'tx_list_clean_negotiation', 'tx_list_encode_command_ok', 'tx_list_encode_command_partial_write', 'tx_list_encode_marker_ok', 'tx_list_encode_marker_partial_write', 'tx_list_encode_negotiation_ok', 'tx_list_encode_negotiation_partial_write'], name, value)
...
class SessionRedundancyManager(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"groups" : ("groups", SessionRedundancyManager.Groups), "interfaces" : ("interfaces", SessionRedundancyManager.Interfaces), "summary" : ("summary", SessionRedundancyManager.Summary)}
        self._child_list_classes = {}
    ...
    class Groups(Entity):
        ...
        class Group(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(SessionRedundancyManager.Groups.Group, ['group', 'description', 'disabled', 'group_id', 'interface_count', 'node_name', 'object_tracking_status', 'peer_ipv4_address', 'peer_ipv6_address', 'preferred_role', 'role', 'slave_mode'], name, value)
    ...
    class Interfaces(Entity):
        ...
        class Interface(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(SessionRedundancyManager.Interfaces.Interface, ['interface', 'forward_referenced', 'group_id', 'interface_mapping_id', 'interface_name', 'role'], name, value)
