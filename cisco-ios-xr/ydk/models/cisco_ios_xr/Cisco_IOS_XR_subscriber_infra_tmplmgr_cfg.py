            ...
            class Dhcpv6(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ...
                        ('dhcpv6_iplease', YLeaf(YType.str, 'dhcpv6-iplease')),
                        ('dhcpv6_option', YLeaf(YType.str, 'dhcpv6-option')),
        ...
        class IpSubscriber(Entity):
            ...
            class Dhcpd(Entity):
                ...
                def __init__(self):
                    ...
                    self._child_classes = OrderedDict([])
                    self._leafs = OrderedDict([
                        ('dhcpv4_iplease', YLeaf(YType.str, 'dhcpv4-iplease')),
                        ('class_', YLeaf(YType.str, 'class')),
