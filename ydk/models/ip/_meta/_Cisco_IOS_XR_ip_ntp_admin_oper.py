...
_meta_table = {
    'NtpPeerStatus_Enum' : _MetaInfoEnum('NtpPeerStatus_Enum', 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper',
        {
    ...
    'NtpMode_Enum' : _MetaInfoEnum('NtpMode_Enum', 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper',
        {
    ...
    'ClockUpdateNode_Enum' : _MetaInfoEnum('ClockUpdateNode_Enum', 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper',
        {
            'clk-never-updated':'CLK_NEVER_UPDATED',
            'clk-updated':'CLK_UPDATED',
            'clk-no-update-info':'CLK_NO_UPDATE_INFO',
        }, 'Cisco-IOS-XR-ip-ntp-admin-oper', _yang_ns._namespaces['Cisco-IOS-XR-ip-ntp-admin-oper']),
    'NtpLoopFilterState_Enum' : _MetaInfoEnum('NtpLoopFilterState_Enum', 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper',
        {
    ...
    'NtpLeap_Enum' : _MetaInfoEnum('NtpLeap_Enum', 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper',
        {
    ...
    'Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Associations.PeerSummaryInfo.PeerInfoCommon' : {
        'meta_info' : _MetaInfoClass('Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Associations.PeerSummaryInfo.PeerInfoCommon',
            ...
            _MetaInfoClassMember('dispersion', ATTRIBUTE, 'str' , None, None, 
                ...
                'dispersion',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('host-mode', REFERENCE_ENUM_CLASS, 'NtpMode_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'NtpMode_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('reference-id', ATTRIBUTE, 'str' , None, None, 
                ...
                'reference_id',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('status', REFERENCE_ENUM_CLASS, 'NtpPeerStatus_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'NtpPeerStatus_Enum', 
                [], [], 
                '''                Peer status
                ''',
                'status',
    ...
    'Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Associations' : {
        'meta_info' : _MetaInfoClass('Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Associations',
            ...
            _MetaInfoClassMember('peer-summary-info', REFERENCE_LIST, 'PeerSummaryInfo' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Associations.PeerSummaryInfo', 
                ...
                'peer_summary_info',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('sys-leap', REFERENCE_ENUM_CLASS, 'NtpLeap_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'NtpLeap_Enum', 
                [], [], 
                '''                Leap
                ''',
                'sys_leap',
    ...
    'Ntp.Racks.Rack.Slots.Slot.Instances.Instance.AssociationsDetail.PeerDetailInfo' : {
        'meta_info' : _MetaInfoClass('Ntp.Racks.Rack.Slots.Slot.Instances.Instance.AssociationsDetail.PeerDetailInfo',
            ...
            _MetaInfoClassMember('is-ref-clock', ATTRIBUTE, 'bool' , None, None, 
                ...
                'is_ref_clock',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('leap', REFERENCE_ENUM_CLASS, 'NtpLeap_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'NtpLeap_Enum', 
                [], [], 
                '''                Leap
                ''',
                'leap',
            ...
            _MetaInfoClassMember('peer-info-common', REFERENCE_CLASS, 'PeerInfoCommon' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'Ntp.Racks.Rack.Slots.Slot.Instances.Instance.AssociationsDetail.PeerDetailInfo.PeerInfoCommon', 
                ...
                'peer_info_common',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('peer-mode', REFERENCE_ENUM_CLASS, 'NtpMode_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'NtpMode_Enum', 
                [], [], 
    ...
    'Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Status' : {
        'meta_info' : _MetaInfoClass('Ntp.Racks.Rack.Slots.Slot.Instances.Instance.Status',
            ...
            _MetaInfoClassMember('is-ntp-enabled', ATTRIBUTE, 'bool' , None, None, 
                ...
                'is_ntp_enabled',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('is-updated', REFERENCE_ENUM_CLASS, 'ClockUpdateNode_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'ClockUpdateNode_Enum', 
                [], [], 
                '''                Is clock updated
                ''',
                'is_updated',
            ...
            _MetaInfoClassMember('last-update', ATTRIBUTE, 'int' , None, None, 
                ...
                'last_update',
                'Cisco-IOS-XR-ip-ntp-admin-oper', False),
            _MetaInfoClassMember('loop-filter-state', REFERENCE_ENUM_CLASS, 'NtpLoopFilterState_Enum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper', 'NtpLoopFilterState_Enum', 
                [], [], 
                '''                Loop Filter State
                ''',
                'loop_filter_state',
