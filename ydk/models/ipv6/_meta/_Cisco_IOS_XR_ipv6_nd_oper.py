...
_meta_table = {
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface.HostAddresses.HostAddress.LastReachedTime' : {
        ...
        'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper'
        ),
    },
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface.HostAddresses' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface.HostAddresses',
            False, 
            [
            _MetaInfoClassMember('host-address', REFERENCE_LIST, 'HostAddress' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface.HostAddresses.HostAddress', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv6-nd-oper', True),
            _MetaInfoClassMember('host-addresses', REFERENCE_CLASS, 'HostAddresses' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface.HostAddresses', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces',
            False, 
            [
            _MetaInfoClassMember('neighbor-interface', REFERENCE_LIST, 'NeighborInterface' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NeighborInterfaces.NeighborInterface', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NeighborSummary' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.NeighborSummary',
            ...
            _MetaInfoClassMember('multicast', REFERENCE_CLASS, 'Multicast' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NeighborSummary.Multicast', 
                ...
                'multicast',
                'Cisco-IOS-XR-ipv6-nd-oper', False),
            _MetaInfoClassMember('static', REFERENCE_CLASS, 'Static' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NeighborSummary.Static', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node.BundleNodes.BundleNode' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.BundleNodes.BundleNode',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-ipv6-nd-oper', True),
            _MetaInfoClassMember('age', REFERENCE_CLASS, 'Age' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.BundleNodes.BundleNode.Age', 
                [], [], 
                '''                Uptime of node (secs)
                ''',
                'age',
    ...
    'Ipv6NodeDiscovery.Nodes.Node.BundleNodes' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.BundleNodes',
            False, 
            [
            _MetaInfoClassMember('bundle-node', REFERENCE_LIST, 'BundleNode' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.BundleNodes.BundleNode', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node.BundleInterfaces' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.BundleInterfaces',
            False, 
            [
            _MetaInfoClassMember('bundle-interface', REFERENCE_LIST, 'BundleInterface' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.BundleInterfaces.BundleInterface', 
                [], [], 
                '''                IPv6 ND operational data for a specific
                bundler interface
                ''',
    ...
    'Ipv6NodeDiscovery.Nodes.Node.Interfaces' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.Interfaces.Interface', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters.NdVirtualRouter' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters.NdVirtualRouter',
            ...
            _MetaInfoClassMember('vr-gl-addr-ct', ATTRIBUTE, 'int' , None, None, 
                ...
                'vr_gl_addr_ct',
                'Cisco-IOS-XR-ipv6-nd-oper', False),
            _MetaInfoClassMember('vr-global-address', REFERENCE_LIST, 'VrGlobalAddress' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters.NdVirtualRouter.VrGlobalAddress', 
                [], [], 
                '''                List of ND global addresses
                ''',
                'vr_global_address',
    ...
    'Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters',
            False, 
            [
            _MetaInfoClassMember('nd-virtual-router', REFERENCE_LIST, 'NdVirtualRouter' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters.NdVirtualRouter', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes.Node',
            ...
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.Interfaces', 
                ...
                'interfaces',
                'Cisco-IOS-XR-ipv6-nd-oper', False),
            _MetaInfoClassMember('nd-virtual-routers', REFERENCE_CLASS, 'NdVirtualRouters' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node.NdVirtualRouters', 
                [], [], 
    ...
    'Ipv6NodeDiscovery.Nodes' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes.Node', 
                [], [], 
                '''                IPv6 node discovery operational data for a
                particular node
                ''',
    ...
    'Ipv6NodeDiscovery' : {
        'meta_info' : _MetaInfoClass('Ipv6NodeDiscovery',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper', 'Ipv6NodeDiscovery.Nodes', 
                [], [], 
