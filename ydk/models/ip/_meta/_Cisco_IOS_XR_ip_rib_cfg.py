...
_meta_table = {
    'Rib.Af.Ipv4.RedistributionHistory.Keep' : {
        ...
        'ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg'
        ),
    },
    ...
    'Rib.Af.Ipv4' : {
        'meta_info' : _MetaInfoClass('Rib.Af.Ipv4',
            ...
            _MetaInfoClassMember('next-hop-dampening-disable', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'Cisco-IOS-XR-ip-rib-cfg', False),
            _MetaInfoClassMember('redistribution-history', REFERENCE_CLASS, 'RedistributionHistory' , 'ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg', 'Rib.Af.Ipv4.RedistributionHistory', 
                [], [], 
    ...
    'Rib.Af.Ipv6' : {
        'meta_info' : _MetaInfoClass('Rib.Af.Ipv6',
            ...
            _MetaInfoClassMember('next-hop-dampening-disable', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'next_hop_dampening_disable',
                'Cisco-IOS-XR-ip-rib-cfg', False),
            _MetaInfoClassMember('redistribution-history', REFERENCE_CLASS, 'RedistributionHistory' , 'ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg', 'Rib.Af.Ipv6.RedistributionHistory', 
                [], [], 
                '''                Redistribution history related configs
                ''',
                'redistribution_history',
    ...
    'Rib.Af' : {
        'meta_info' : _MetaInfoClass('Rib.Af',
            False, 
            [
            _MetaInfoClassMember('ipv4', REFERENCE_CLASS, 'Ipv4' , 'ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg', 'Rib.Af.Ipv4', 
                [], [], 
                '''                IPv4 configuration
                ''',
                'ipv4',
                'Cisco-IOS-XR-ip-rib-cfg', False),
            _MetaInfoClassMember('ipv6', REFERENCE_CLASS, 'Ipv6' , 'ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg', 'Rib.Af.Ipv6', 
                [], [], 
                '''                IPv6 configuration
                ''',
                'ipv6',
    ...
    'Rib' : {
        'meta_info' : _MetaInfoClass('Rib',
            False, 
            [
            _MetaInfoClassMember('af', REFERENCE_CLASS, 'Af' , 'ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg', 'Rib.Af', 
                [], [], 
