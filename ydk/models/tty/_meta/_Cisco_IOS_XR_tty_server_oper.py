...
_meta_table = {
    ...
    'Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine.AuxiliaryStatistics.Aaa' : {
        ...
        'ydk.models.tty.Cisco_IOS_XR_tty_server_oper'
        ),
    },
    ...
    'Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine.Configuration' : {
        'meta_info' : _MetaInfoClass('Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine.Configuration',
            False, 
            [
            _MetaInfoClassMember('connection-configuration', REFERENCE_CLASS, 'ConnectionConfiguration' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine.Configuration.ConnectionConfiguration', 
                [], [], 
    ...
    'Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine' : {
        'meta_info' : _MetaInfoClass('Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine',
            False, 
            [
            _MetaInfoClassMember('auxiliary-statistics', REFERENCE_CLASS, 'AuxiliaryStatistics' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine.AuxiliaryStatistics', 
                [], [], 
    ...
    'Tty.AuxiliaryNodes.AuxiliaryNode' : {
        'meta_info' : _MetaInfoClass('Tty.AuxiliaryNodes.AuxiliaryNode',
            ...
            _MetaInfoClassMember('auxiliary-line', REFERENCE_CLASS, 'AuxiliaryLine' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.AuxiliaryNodes.AuxiliaryNode.AuxiliaryLine', 
                [], [], 
                '''                Auxiliary line
                ''',
                'auxiliary_line',
    ...
    'Tty.AuxiliaryNodes' : {
        'meta_info' : _MetaInfoClass('Tty.AuxiliaryNodes',
            False, 
            [
            _MetaInfoClassMember('auxiliary-node', REFERENCE_LIST, 'AuxiliaryNode' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.AuxiliaryNodes.AuxiliaryNode', 
                [], [], 
    ...
    'Tty.ConsoleNodes.ConsoleNode.ConsoleLine.Configuration' : {
        'meta_info' : _MetaInfoClass('Tty.ConsoleNodes.ConsoleNode.ConsoleLine.Configuration',
            False, 
            [
            _MetaInfoClassMember('connection-configuration', REFERENCE_CLASS, 'ConnectionConfiguration' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.ConsoleNodes.ConsoleNode.ConsoleLine.Configuration.ConnectionConfiguration', 
                [], [], 
                '''                Conection configuration information
                ''',
                'connection_configuration',
    ...
    'Tty.ConsoleNodes.ConsoleNode.ConsoleLine' : {
        'meta_info' : _MetaInfoClass('Tty.ConsoleNodes.ConsoleNode.ConsoleLine',
            ...
            _MetaInfoClassMember('console-statistics', REFERENCE_CLASS, 'ConsoleStatistics' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.ConsoleNodes.ConsoleNode.ConsoleLine.ConsoleStatistics', 
                ...
                'console_statistics',
                'Cisco-IOS-XR-tty-server-oper', False),
            _MetaInfoClassMember('state', REFERENCE_CLASS, 'State' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.ConsoleNodes.ConsoleNode.ConsoleLine.State', 
                [], [], 
                '''                Line state information
                ''',
                'state',
    ...
    'Tty.ConsoleNodes.ConsoleNode' : {
        'meta_info' : _MetaInfoClass('Tty.ConsoleNodes.ConsoleNode',
            ...
            _MetaInfoClassMember('id', ATTRIBUTE, 'str' , None, None, 
                ...
                'id',
                'Cisco-IOS-XR-tty-server-oper', True),
            _MetaInfoClassMember('console-line', REFERENCE_CLASS, 'ConsoleLine' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.ConsoleNodes.ConsoleNode.ConsoleLine', 
                [], [], 
                '''                Console line
                ''',
                'console_line',
    ...
    'Tty.ConsoleNodes' : {
        'meta_info' : _MetaInfoClass('Tty.ConsoleNodes',
            False, 
            [
            _MetaInfoClassMember('console-node', REFERENCE_LIST, 'ConsoleNode' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.ConsoleNodes.ConsoleNode', 
                [], [], 
    ...
    'Tty.VtyLines.VtyLine.Configuration' : {
        'meta_info' : _MetaInfoClass('Tty.VtyLines.VtyLine.Configuration',
            False, 
            [
            _MetaInfoClassMember('connection-configuration', REFERENCE_CLASS, 'ConnectionConfiguration' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.VtyLines.VtyLine.Configuration.ConnectionConfiguration', 
                [], [], 
                '''                Conection configuration information
                ''',
                'connection_configuration',
    ...
    'Tty.VtyLines.VtyLine.Sessions' : {
        'meta_info' : _MetaInfoClass('Tty.VtyLines.VtyLine.Sessions',
            False, 
            [
            _MetaInfoClassMember('outgoing-connection', REFERENCE_LIST, 'OutgoingConnection' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.VtyLines.VtyLine.Sessions.OutgoingConnection', 
                [], [], 
    ...
    'Tty.VtyLines.VtyLine' : {
        'meta_info' : _MetaInfoClass('Tty.VtyLines.VtyLine',
            ...
            _MetaInfoClassMember('configuration', REFERENCE_CLASS, 'Configuration' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.VtyLines.VtyLine.Configuration', 
                ...
                'configuration',
                'Cisco-IOS-XR-tty-server-oper', False),
            _MetaInfoClassMember('sessions', REFERENCE_CLASS, 'Sessions' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.VtyLines.VtyLine.Sessions', 
                [], [], 
                '''                Outgoing sessions
                ''',
                'sessions',
    ...
    'Tty.VtyLines' : {
        'meta_info' : _MetaInfoClass('Tty.VtyLines',
            False, 
            [
            _MetaInfoClassMember('vty-line', REFERENCE_LIST, 'VtyLine' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.VtyLines.VtyLine', 
                [], [], 
                '''                VTY Line
                ''',
                'vty_line',
    ...
    'Tty' : {
        'meta_info' : _MetaInfoClass('Tty',
            ...
            _MetaInfoClassMember('console-nodes', REFERENCE_CLASS, 'ConsoleNodes' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.ConsoleNodes', 
                ...
                'console_nodes',
                'Cisco-IOS-XR-tty-server-oper', False),
            _MetaInfoClassMember('vty-lines', REFERENCE_CLASS, 'VtyLines' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_oper', 'Tty.VtyLines', 
                [], [], 
                '''                List of VTY lines
                ''',
                'vty_lines',
