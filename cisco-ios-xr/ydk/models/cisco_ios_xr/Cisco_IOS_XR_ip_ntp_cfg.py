...
class Ntp(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"peer-vrfs" : ("peer_vrfs", Ntp.PeerVrfs), "dscp-ipv4" : ("dscp_ipv4", Ntp.DscpIpv4), "dscp-ipv6" : ("dscp_ipv6", Ntp.DscpIpv6), "sources" : ("sources", Ntp.Sources), "authentication" : ("authentication", Ntp.Authentication), "passive" : ("passive", Ntp.Passive), "interface-tables" : ("interface_tables", Ntp.InterfaceTables), "access-group-tables" : ("access_group_tables", Ntp.AccessGroupTables)}
        ...
        class InterfaceTable(Entity):
            ...
            class Interface(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"interface-multicast" : ("interface_multicast", Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast), "interface-broadcast" : ("interface_broadcast", Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceBroadcast)}
                    self._child_list_classes = {}
