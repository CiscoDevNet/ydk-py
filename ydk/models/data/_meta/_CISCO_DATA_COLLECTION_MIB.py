...
_meta_table = {
    'CdcFileXferStatus_Enum' : _MetaInfoEnum('CdcFileXferStatus_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
    ...
    'CdcFileFormat_Enum' : _MetaInfoEnum('CdcFileFormat_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
    ...
    'CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable.CdcDGBaseObjectEntry' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable.CdcDGBaseObjectEntry',
            ...
            _MetaInfoClassMember('cdcDGBaseObjectRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
        ...
        'ydk.models.data.CISCO_DATA_COLLECTION_MIB'
        ),
    },
    'CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable',
            False, 
            [
            _MetaInfoClassMember('cdcDGBaseObjectEntry', REFERENCE_LIST, 'CdcDGBaseObjectEntry' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable.CdcDGBaseObjectEntry', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry.CdcDGInstanceType_Enum' : _MetaInfoEnum('CdcDGInstanceType_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
    ...
    'CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry',
            ...
            _MetaInfoClassMember('cdcDGInstanceOtherPtr', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcDGInstanceRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row.
                ''',
                'cdcdginstancerowstatus',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcDGInstanceType', REFERENCE_ENUM_CLASS, 'CdcDGInstanceType_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry.CdcDGInstanceType_Enum', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcDGInstanceTable' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcDGInstanceTable',
            False, 
            [
            _MetaInfoClassMember('cdcDGInstanceEntry', REFERENCE_LIST, 'CdcDGInstanceEntry' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry.CdcDGType_Enum' : _MetaInfoEnum('CdcDGType_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'object':'OBJECT',
            'table':'TABLE',
        }, 'CISCO-DATA-COLLECTION-MIB', _yang_ns._namespaces['CISCO-DATA-COLLECTION-MIB']),
    'CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry',
            ...
            _MetaInfoClassMember('cdcDGPollPeriod', ATTRIBUTE, 'int' , None, None, 
                ...
                'cdcdgpollperiod',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcDGRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row.
            ...
            _MetaInfoClassMember('cdcDGTargetTag', ATTRIBUTE, 'str' , None, None, 
                ...
                'cdcdgtargettag',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcDGType', REFERENCE_ENUM_CLASS, 'CdcDGType_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry.CdcDGType_Enum', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcDGTable' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcDGTable',
            False, 
            [
            _MetaInfoClassMember('cdcDGEntry', REFERENCE_LIST, 'CdcDGEntry' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcFileXferConfTable' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcFileXferConfTable',
            False, 
            [
            _MetaInfoClassMember('cdcFileXferConfEntry', REFERENCE_LIST, 'CdcFileXferConfEntry' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcFileXferConfTable.CdcFileXferConfEntry', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry.CdcVFileMgmtCommand_Enum' : _MetaInfoEnum('CdcVFileMgmtCommand_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'idle':'IDLE',
            'delete':'DELETE',
            'transfer':'TRANSFER',
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry',
            ...
            _MetaInfoClassMember('cdcVFileMgmtIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cdcvfilemgmtindex',
                'CISCO-DATA-COLLECTION-MIB', True),
            _MetaInfoClassMember('cdcVFileMgmtCommand', REFERENCE_ENUM_CLASS, 'CdcVFileMgmtCommand_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry.CdcVFileMgmtCommand_Enum', 
                [], [], 
                ...
                'cdcvfilemgmtcommand',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileMgmtLastXferStatus', REFERENCE_ENUM_CLASS, 'CdcFileXferStatus_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CdcFileXferStatus_Enum', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileMgmtTable' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcVFileMgmtTable',
            False, 
            [
            _MetaInfoClassMember('cdcVFileMgmtEntry', REFERENCE_LIST, 'CdcVFileMgmtEntry' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileAdminStatus_Enum' : _MetaInfoEnum('CdcVFileAdminStatus_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'CISCO-DATA-COLLECTION-MIB', _yang_ns._namespaces['CISCO-DATA-COLLECTION-MIB']),
    'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCollectMode_Enum' : _MetaInfoEnum('CdcVFileCollectMode_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'auto':'AUTO',
            'manual':'MANUAL',
        }, 'CISCO-DATA-COLLECTION-MIB', _yang_ns._namespaces['CISCO-DATA-COLLECTION-MIB']),
    'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCommand_Enum' : _MetaInfoEnum('CdcVFileCommand_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'idle':'IDLE',
            'swapToNewFile':'SWAPTONEWFILE',
            'collectNow':'COLLECTNOW',
        }, 'CISCO-DATA-COLLECTION-MIB', _yang_ns._namespaces['CISCO-DATA-COLLECTION-MIB']),
    'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileErrorCode_Enum' : _MetaInfoEnum('CdcVFileErrorCode_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'noError':'NOERROR',
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileOperStatus_Enum' : _MetaInfoEnum('CdcVFileOperStatus_Enum', 'ydk.models.data.CISCO_DATA_COLLECTION_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
            'error':'ERROR',
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry',
            ...
            _MetaInfoClassMember('cdcVFileIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cdcvfileindex',
                'CISCO-DATA-COLLECTION-MIB', True),
            _MetaInfoClassMember('cdcVFileAdminStatus', REFERENCE_ENUM_CLASS, 'CdcVFileAdminStatus_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cdcVFileCollectionPeriod', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileCollectMode', REFERENCE_ENUM_CLASS, 'CdcVFileCollectMode_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCollectMode_Enum', 
                [], [], 
                ...
                'cdcvfilecollectmode',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileCommand', REFERENCE_ENUM_CLASS, 'CdcVFileCommand_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCommand_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cdcVFileDescription', ATTRIBUTE, 'str' , None, None, 
                ...
                'cdcvfiledescription',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileErrorCode', REFERENCE_ENUM_CLASS, 'CdcVFileErrorCode_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileErrorCode_Enum', 
                [], [], 
                ...
                'cdcvfileerrorcode',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileFormat', REFERENCE_ENUM_CLASS, 'CdcFileFormat_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CdcFileFormat_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cdcVFileName', ATTRIBUTE, 'str' , None, None, 
                ...
                'cdcvfilename',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileOperStatus', REFERENCE_ENUM_CLASS, 'CdcVFileOperStatus_Enum' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileOperStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cdcVFileRetentionPeriod', ATTRIBUTE, 'int' , None, None, 
                ...
                'cdcvfileretentionperiod',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. 
    ...
    'CISCODATACOLLECTIONMIB.CdcVFileTable' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB.CdcVFileTable',
            False, 
            [
            _MetaInfoClassMember('cdcVFileEntry', REFERENCE_LIST, 'CdcVFileEntry' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry', 
                [], [], 
    ...
    'CISCODATACOLLECTIONMIB' : {
        'meta_info' : _MetaInfoClass('CISCODATACOLLECTIONMIB',
            False, 
            [
            _MetaInfoClassMember('cdcDGBaseObjectTable', REFERENCE_CLASS, 'CdcDGBaseObjectTable' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable', 
                [], [], 
                ...
                'cdcdgbaseobjecttable',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcDGInstanceTable', REFERENCE_CLASS, 'CdcDGInstanceTable' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGInstanceTable', 
                [], [], 
                ...
                'cdcdginstancetable',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcDGTable', REFERENCE_CLASS, 'CdcDGTable' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcDGTable', 
                [], [], 
                '''                A table for specifying data groups.
                ''',
                'cdcdgtable',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcFileXferConfTable', REFERENCE_CLASS, 'CdcFileXferConfTable' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcFileXferConfTable', 
                [], [], 
                '''                A table for configuring file transfer operations.
                ''',
                'cdcfilexferconftable',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFile', REFERENCE_CLASS, 'CdcVFile' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFile', 
                [], [], 
                '''                ''',
                'cdcvfile',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileMgmtTable', REFERENCE_CLASS, 'CdcVFileMgmtTable' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileMgmtTable', 
                [], [], 
                '''                A table to manage frozen VFiles.
                ''',
                'cdcvfilemgmttable',
                'CISCO-DATA-COLLECTION-MIB', False),
            _MetaInfoClassMember('cdcVFileTable', REFERENCE_CLASS, 'CdcVFileTable' , 'ydk.models.data.CISCO_DATA_COLLECTION_MIB', 'CISCODATACOLLECTIONMIB.CdcVFileTable', 
                [], [], 
