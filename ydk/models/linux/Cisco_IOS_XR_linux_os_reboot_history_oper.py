...
class RebootHistory(object):
    ...
    .. attribute:: node
    	...
    	Node ID
    	**type**\: list of :py:class:`Node <ydk.models.linux.Cisco_IOS_XR_linux_os_reboot_history_oper.RebootHistory.Node>`
    ...
    class Node(object):
        ...
        .. attribute:: reboot_history
        	...
        	Last Reboots
        	**type**\: list of :py:class:`RebootHistory <ydk.models.linux.Cisco_IOS_XR_linux_os_reboot_history_oper.RebootHistory.Node.RebootHistory>`
        ...
        class RebootHistory(object):
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.linux._meta import _Cisco_IOS_XR_linux_os_reboot_history_oper as meta
