...
class CISCOSONETMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"csApsConfig" : ("csapsconfig", CISCOSONETMIB.Csapsconfig), "csApsConfigTable" : ("csapsconfigtable", CISCOSONETMIB.Csapsconfigtable), "csAu4Tug3ConfigTable" : ("csau4tug3configtable", CISCOSONETMIB.Csau4Tug3Configtable), "csConfigTable" : ("csconfigtable", CISCOSONETMIB.Csconfigtable), "cslFarEndTotalTable" : ("cslfarendtotaltable", CISCOSONETMIB.Cslfarendtotaltable), "cslTotalTable" : ("csltotaltable", CISCOSONETMIB.Csltotaltable), "csNotifications" : ("csnotifications", CISCOSONETMIB.Csnotifications), "cspFarEndTotalTable" : ("cspfarendtotaltable", CISCOSONETMIB.Cspfarendtotaltable), "cspTotalTable" : ("csptotaltable", CISCOSONETMIB.Csptotaltable), "cspTraceTable" : ("csptracetable", CISCOSONETMIB.Csptracetable), "csStatsTable" : ("csstatstable", CISCOSONETMIB.Csstatstable), "cssTotalTable" : ("csstotaltable", CISCOSONETMIB.Csstotaltable), "cssTraceTable" : ("csstracetable", CISCOSONETMIB.Csstracetable)}
    ...
    class Csapsconfigtable(Entity):
        ...
        class Csapsconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csapsconfigtable.Csapsconfigentry, ['csapsworkingindex', 'csapsactiveline', 'csapsarchmode', 'csapsarchmodeoperational', 'csapschannelprotocol', 'csapsdirection', 'csapsdirectionoperational', 'csapsenable', 'csapsfailurestatus', 'csapsprimarysection', 'csapsprotectionindex', 'csapsrevertive', 'csapssigdegradeber', 'csapssigfaultber', 'csapsswitchreason', 'csapswaittorestore'], name, value)
    ...
    class Csconfigtable(Entity):
        ...
        class Csconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csconfigtable.Csconfigentry, ['ifindex', 'csconfigframescramble', 'csconfigloopbacktype', 'csconfigrdiptype', 'csconfigrdivtype', 'csconfigtype', 'csconfigxmtclocksource', 'cssignallingtransportmode', 'cstributaryframingtype', 'cstributarygroupingtype', 'cstributarymappingtype', 'cstributarytype'], name, value)
    ...
    class Cslfarendtotaltable(Entity):
        ...
        class Cslfarendtotalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Cslfarendtotaltable.Cslfarendtotalentry, ['ifindex', 'cslfarendtotalcvs', 'cslfarendtotaless', 'cslfarendtotalsess', 'cslfarendtotaluass'], name, value)
    ...
    class Csltotaltable(Entity):
        ...
        class Csltotalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csltotaltable.Csltotalentry, ['ifindex', 'csltotalcvs', 'csltotaless', 'csltotalsess', 'csltotaluass'], name, value)
    ...
    class Cspfarendtotaltable(Entity):
        ...
        class Cspfarendtotalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Cspfarendtotaltable.Cspfarendtotalentry, ['ifindex', 'cspfarendtotalcvs', 'cspfarendtotaless', 'cspfarendtotalsess', 'cspfarendtotaluass'], name, value)
    ...
    class Csptotaltable(Entity):
        ...
        class Csptotalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csptotaltable.Csptotalentry, ['ifindex', 'csptotalcvs', 'csptotaless', 'csptotalsess', 'csptotaluass'], name, value)
    ...
    class Csptracetable(Entity):
        ...
        class Csptraceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csptracetable.Csptraceentry, ['ifindex', 'csptracefailure', 'csptracereceived', 'csptracetoexpect', 'csptracetotransmit'], name, value)
    ...
    class Csstatstable(Entity):
        ...
        class Csstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csstatstable.Csstatsentry, ['ifindex', 'cslaiss', 'cslrfis', 'cspaiss', 'csprfis', 'csslofs', 'cssloss'], name, value)
    ...
    class Csstotaltable(Entity):
        ...
        class Csstotalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csstotaltable.Csstotalentry, ['ifindex', 'csstotalcvs', 'csstotaless', 'csstotalsefss', 'csstotalsess'], name, value)
    ...
    class Csstracetable(Entity):
        ...
        class Csstraceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSONETMIB.Csstracetable.Csstraceentry, ['ifindex', 'csstracefailure', 'csstracereceived', 'csstracetoexpect', 'csstracetotransmit'], name, value)
