...
_meta_table = {
    'CISCOBULKFILEMIB.CbfDefine' : {
        ...
        'ydk.models.bulk.CISCO_BULK_FILE_MIB'
        ),
    },
    'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry.CbfDefineFileFormat_Enum' : _MetaInfoEnum('CbfDefineFileFormat_Enum', 'ydk.models.bulk.CISCO_BULK_FILE_MIB',
        {
    ...
    'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry.CbfDefineFileNow_Enum' : _MetaInfoEnum('CbfDefineFileNow_Enum', 'ydk.models.bulk.CISCO_BULK_FILE_MIB',
        {
            'notActive':'NOTACTIVE',
            'ready':'READY',
            'create':'CREATE',
    ...
    'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry.CbfDefineFileStorage_Enum' : _MetaInfoEnum('CbfDefineFileStorage_Enum', 'ydk.models.bulk.CISCO_BULK_FILE_MIB',
        {
            'ephemeral':'EPHEMERAL',
            'volatile':'VOLATILE',
            'permanent':'PERMANENT',
    ...
    'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry',
            ...
            _MetaInfoClassMember('cbfDefineFileEntryStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfDefineFileFormat', REFERENCE_ENUM_CLASS, 'CbfDefineFileFormat_Enum' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry.CbfDefineFileFormat_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbfDefineFileNotifyOnCompletion', ATTRIBUTE, 'bool' , None, None, 
                ...
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfDefineFileNow', REFERENCE_ENUM_CLASS, 'CbfDefineFileNow_Enum' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry.CbfDefineFileNow_Enum', 
                [], [], 
                ...
                'cbfdefinefilenow',
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfDefineFileStorage', REFERENCE_ENUM_CLASS, 'CbfDefineFileStorage_Enum' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry.CbfDefineFileStorage_Enum', 
                [], [], 
    ...
    'CISCOBULKFILEMIB.CbfDefineFileTable' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB.CbfDefineFileTable',
            False, 
            [
            _MetaInfoClassMember('cbfDefineFileEntry', REFERENCE_LIST, 'CbfDefineFileEntry' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineFileTable.CbfDefineFileEntry', 
                [], [], 
    ...
    'CISCOBULKFILEMIB.CbfDefineObjectTable.CbfDefineObjectEntry.CbfDefineObjectClass_Enum' : _MetaInfoEnum('CbfDefineObjectClass_Enum', 'ydk.models.bulk.CISCO_BULK_FILE_MIB',
        {
            'object':'OBJECT',
    ...
    'CISCOBULKFILEMIB.CbfDefineObjectTable.CbfDefineObjectEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB.CbfDefineObjectTable.CbfDefineObjectEntry',
            ...
            _MetaInfoClassMember('cbfDefineObjectIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-BULK-FILE-MIB', True),
            _MetaInfoClassMember('cbfDefineObjectClass', REFERENCE_ENUM_CLASS, 'CbfDefineObjectClass_Enum' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineObjectTable.CbfDefineObjectEntry.CbfDefineObjectClass_Enum', 
                [], [], 
                ...
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfDefineObjectEntryStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The control that allows creation, modification, and deletion
                of entries.  For detailed rules see the DESCRIPTION for
    ...
    'CISCOBULKFILEMIB.CbfDefineObjectTable' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB.CbfDefineObjectTable',
            False, 
            [
            _MetaInfoClassMember('cbfDefineObjectEntry', REFERENCE_LIST, 'CbfDefineObjectEntry' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineObjectTable.CbfDefineObjectEntry', 
                [], [], 
    ...
    'CISCOBULKFILEMIB.CbfStatusFileTable.CbfStatusFileEntry.CbfStatusFileState_Enum' : _MetaInfoEnum('CbfStatusFileState_Enum', 'ydk.models.bulk.CISCO_BULK_FILE_MIB',
        {
            'running':'RUNNING',
            'ready':'READY',
            'emptied':'EMPTIED',
    ...
    'CISCOBULKFILEMIB.CbfStatusFileTable.CbfStatusFileEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB.CbfStatusFileTable.CbfStatusFileEntry',
            ...
            _MetaInfoClassMember('cbfStatusFileCompletionTime', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfStatusFileEntryStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfStatusFileState', REFERENCE_ENUM_CLASS, 'CbfStatusFileState_Enum' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfStatusFileTable.CbfStatusFileEntry.CbfStatusFileState_Enum', 
                [], [], 
                '''                The file state:
    ...
    'CISCOBULKFILEMIB.CbfStatusFileTable' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB.CbfStatusFileTable',
            False, 
            [
            _MetaInfoClassMember('cbfStatusFileEntry', REFERENCE_LIST, 'CbfStatusFileEntry' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfStatusFileTable.CbfStatusFileEntry', 
                [], [], 
    ...
    'CISCOBULKFILEMIB' : {
        'meta_info' : _MetaInfoClass('CISCOBULKFILEMIB',
            False, 
            [
            _MetaInfoClassMember('cbfDefine', REFERENCE_CLASS, 'CbfDefine' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefine', 
                [], [], 
                '''                ''',
                'cbfdefine',
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfDefineFileTable', REFERENCE_CLASS, 'CbfDefineFileTable' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineFileTable', 
                [], [], 
                '''                A table of bulk file definition and creation controls.
                ''',
                'cbfdefinefiletable',
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfDefineObjectTable', REFERENCE_CLASS, 'CbfDefineObjectTable' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfDefineObjectTable', 
                [], [], 
                '''                A table of objects to go in bulk files.
                ''',
                'cbfdefineobjecttable',
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfStatus', REFERENCE_CLASS, 'CbfStatus' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfStatus', 
                [], [], 
                '''                ''',
                'cbfstatus',
                'CISCO-BULK-FILE-MIB', False),
            _MetaInfoClassMember('cbfStatusFileTable', REFERENCE_CLASS, 'CbfStatusFileTable' , 'ydk.models.bulk.CISCO_BULK_FILE_MIB', 'CISCOBULKFILEMIB.CbfStatusFileTable', 
                [], [], 
