...
class NTPLeapIndicator_Enum(Enum):
    """
    NTPLeapIndicator_Enum
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.ntp._meta import _CISCO_NTP_MIB as meta
        return meta._meta_table['NTPLeapIndicator_Enum']
...
class CISCONTPMIB(object):
    ...
    .. attribute:: cntpfilterregistertable
    	...
    	**type**\: :py:class:`CntpFilterRegisterTable <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpFilterRegisterTable>`
    ...
    .. attribute:: cntppeersvartable
    	...
    	**type**\: :py:class:`CntpPeersVarTable <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpPeersVarTable>`
    
    .. attribute:: cntpsystem
    
    	
    	**type**\: :py:class:`CntpSystem <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpSystem>`
    ...
    class CntpFilterRegisterTable(object):
        ...
        .. attribute:: cntpfilterregisterentry
        	...
        	**type**\: list of :py:class:`CntpFilterRegisterEntry <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpFilterRegisterTable.CntpFilterRegisterEntry>`
        ...
        class CntpFilterRegisterEntry(object):
            ...
            def _common_path(self):
                if self.cntpfilterindex is None:
                    raise YPYDataValidationError('Key property cntpfilterindex is None')
                if self.cntppeersassocid is None:
                    raise YPYDataValidationError('Key property cntppeersassocid is None')

                return '/CISCO-NTP-MIB:CISCO-NTP-MIB/CISCO-NTP-MIB:cntpFilterRegisterTable/CISCO-NTP-MIB:cntpFilterRegisterEntry[CISCO-NTP-MIB:cntpFilterIndex = ' + str(self.cntpfilterindex) + '][CISCO-NTP-MIB:cntpPeersAssocId = ' + str(self.cntppeersassocid) + ']'
    ...
    class CntpPeersVarTable(object):
        ...
        .. attribute:: cntppeersvarentry
        	...
        	**type**\: list of :py:class:`CntpPeersVarEntry <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpPeersVarTable.CntpPeersVarEntry>`
        ...
        class CntpPeersVarEntry(object):
            ...
            .. attribute:: cntppeersleap
            	...
            	**type**\: :py:class:`NTPLeapIndicator_Enum <ydk.models.ntp.CISCO_NTP_MIB.NTPLeapIndicator_Enum>`
            ...
            .. attribute:: cntppeersmode
            	...
            	**type**\: :py:class:`CntpPeersMode_Enum <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpPeersVarTable.CntpPeersVarEntry.CntpPeersMode_Enum>`
            ...
            class CntpPeersMode_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.ntp._meta import _CISCO_NTP_MIB as meta
                    return meta._meta_table['CISCONTPMIB.CntpPeersVarTable.CntpPeersVarEntry.CntpPeersMode_Enum']
    ...
    class CntpSystem(object):
        ...
        .. attribute:: cntpsyssrvstatus
        	...
        	**type**\: :py:class:`CntpSysSrvStatus_Enum <ydk.models.ntp.CISCO_NTP_MIB.CISCONTPMIB.CntpSystem.CntpSysSrvStatus_Enum>`
        ...
        class CntpSysSrvStatus_Enum(Enum):
            """
            CntpSysSrvStatus_Enum
            ...
            def _meta_info():
                from ydk.models.ntp._meta import _CISCO_NTP_MIB as meta
                return meta._meta_table['CISCONTPMIB.CntpSystem.CntpSysSrvStatus_Enum']
    ...
    def _has_data(self):
        ...
        if self.cntpfilterregistertable is not None and self.cntpfilterregistertable.is_presence():
            return True

        if self.cntppeersvartable is not None and self.cntppeersvartable._has_data():
            return True

        if self.cntppeersvartable is not None and self.cntppeersvartable.is_presence():
            return True

        if self.cntpsystem is not None and self.cntpsystem._has_data():
            return True

        if self.cntpsystem is not None and self.cntpsystem.is_presence():
            return True
