...
_meta_table = {
    'MPLSLDPSTDMIB.MplsFecObjects' : {
        ...
        'ydk.models.mpls.MPLS_LDP_STD_MIB'
        ),
    },
    'MPLSLDPSTDMIB.MplsFecTable.MplsFecEntry.MplsFecType_Enum' : _MetaInfoEnum('MplsFecType_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'prefix':'PREFIX',
    ...
    'MPLSLDPSTDMIB.MplsFecTable.MplsFecEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsFecTable.MplsFecEntry',
            ...
            _MetaInfoClassMember('mplsFecAddrPrefixLength', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsFecAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                ...
                'mplsfecaddrtype',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsFecRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'mplsfecrowstatus',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsFecStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                ...
                'mplsfecstoragetype',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsFecType', REFERENCE_ENUM_CLASS, 'MplsFecType_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsFecTable.MplsFecEntry.MplsFecType_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsFecTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsFecTable',
            False, 
            [
            _MetaInfoClassMember('mplsFecEntry', REFERENCE_LIST, 'MplsFecEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsFecTable.MplsFecEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsInSegmentLdpLspTable.MplsInSegmentLdpLspEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsInSegmentLdpLspTable.MplsInSegmentLdpLspEntry',
            ...
            _MetaInfoClassMember('mplsLdpPeerLdpId', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsldppeerldpid',
                'MPLS-LDP-STD-MIB', True),
            _MetaInfoClassMember('mplsInSegmentLdpLspLabelType', REFERENCE_ENUM_CLASS, 'MplsLdpLabelType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLdpLabelType_Enum', 
                [], [], 
                '''                The Layer 2 Label Type.
                ''',
                'mplsinsegmentldplsplabeltype',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsInSegmentLdpLspType', REFERENCE_ENUM_CLASS, 'MplsLspType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLspType_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsInSegmentLdpLspTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsInSegmentLdpLspTable',
            False, 
            [
            _MetaInfoClassMember('mplsInSegmentLdpLspEntry', REFERENCE_LIST, 'MplsInSegmentLdpLspEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsInSegmentLdpLspTable.MplsInSegmentLdpLspEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry.MplsLdpEntityAdminStatus_Enum' : _MetaInfoEnum('MplsLdpEntityAdminStatus_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'enable':'ENABLE',
            'disable':'DISABLE',
        }, 'MPLS-LDP-STD-MIB', _yang_ns._namespaces['MPLS-LDP-STD-MIB']),
    'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry.MplsLdpEntityOperStatus_Enum' : _MetaInfoEnum('MplsLdpEntityOperStatus_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'unknown':'UNKNOWN',
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'MPLS-LDP-STD-MIB', _yang_ns._namespaces['MPLS-LDP-STD-MIB']),
    'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry.MplsLdpEntityTransportAddrKind_Enum' : _MetaInfoEnum('MplsLdpEntityTransportAddrKind_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'interface':'INTERFACE',
            'loopback':'LOOPBACK',
        }, 'MPLS-LDP-STD-MIB', _yang_ns._namespaces['MPLS-LDP-STD-MIB']),
    'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry',
            ...
            _MetaInfoClassMember('mplsLdpEntityLdpId', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsldpentityldpid',
                'MPLS-LDP-STD-MIB', True),
            _MetaInfoClassMember('mplsLdpEntityAdminStatus', REFERENCE_ENUM_CLASS, 'MplsLdpEntityAdminStatus_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry.MplsLdpEntityAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpEntityKeepAliveHoldTimer', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityLabelDistMethod', REFERENCE_ENUM_CLASS, 'MplsLabelDistributionMethod_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLabelDistributionMethod_Enum', 
                [], [], 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityLabelRetentionMode', REFERENCE_ENUM_CLASS, 'MplsRetentionMode_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsRetentionMode_Enum', 
                [], [], 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityLabelType', REFERENCE_ENUM_CLASS, 'MplsLdpLabelType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLdpLabelType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpEntityMaxPduLength', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityOperStatus', REFERENCE_ENUM_CLASS, 'MplsLdpEntityOperStatus_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry.MplsLdpEntityOperStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpEntityProtocolVersion', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpEntityStatsShutdownSentNotifications', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.
                Conceptual rows having the value 'permanent(4)'
                need not allow write-access to any columnar
            ...
            _MetaInfoClassMember('mplsLdpEntityTargetPeerAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityTargetPeerAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpEntityTcpPort', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityTransportAddrKind', REFERENCE_ENUM_CLASS, 'MplsLdpEntityTransportAddrKind_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry.MplsLdpEntityTransportAddrKind_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpEntityTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpEntityTable',
            False, 
            [
            _MetaInfoClassMember('mplsLdpEntityEntry', REFERENCE_LIST, 'MplsLdpEntityEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpEntityTable.MplsLdpEntityEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable.MplsLdpHelloAdjacencyEntry.MplsLdpHelloAdjacencyType_Enum' : _MetaInfoEnum('MplsLdpHelloAdjacencyType_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'link':'LINK',
            'targeted':'TARGETED',
        }, 'MPLS-LDP-STD-MIB', _yang_ns._namespaces['MPLS-LDP-STD-MIB']),
    'MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable.MplsLdpHelloAdjacencyEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable.MplsLdpHelloAdjacencyEntry',
            ...
            _MetaInfoClassMember('mplsLdpHelloAdjacencyHoldTimeRem', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpHelloAdjacencyType', REFERENCE_ENUM_CLASS, 'MplsLdpHelloAdjacencyType_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable.MplsLdpHelloAdjacencyEntry.MplsLdpHelloAdjacencyType_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable',
            False, 
            [
            _MetaInfoClassMember('mplsLdpHelloAdjacencyEntry', REFERENCE_LIST, 'MplsLdpHelloAdjacencyEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable.MplsLdpHelloAdjacencyEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpLspFecTable.MplsLdpLspFecEntry.MplsLdpLspFecSegment_Enum' : _MetaInfoEnum('MplsLdpLspFecSegment_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'inSegment':'INSEGMENT',
    ...
    'MPLSLDPSTDMIB.MplsLdpLspFecTable.MplsLdpLspFecEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpLspFecTable.MplsLdpLspFecEntry',
            ...
            _MetaInfoClassMember('mplsLdpLspFecIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'mplsldplspfecindex',
                'MPLS-LDP-STD-MIB', True),
            _MetaInfoClassMember('mplsLdpLspFecSegment', REFERENCE_ENUM_CLASS, 'MplsLdpLspFecSegment_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpLspFecTable.MplsLdpLspFecEntry.MplsLdpLspFecSegment_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpPeerLdpId', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsldppeerldpid',
                'MPLS-LDP-STD-MIB', True),
            _MetaInfoClassMember('mplsLdpLspFecRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpLspFecStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.
                Conceptual rows having the value 'permanent(4)'
                need not allow write-access to any columnar
    ...
    'MPLSLDPSTDMIB.MplsLdpLspFecTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpLspFecTable',
            False, 
            [
            _MetaInfoClassMember('mplsLdpLspFecEntry', REFERENCE_LIST, 'MplsLdpLspFecEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpLspFecTable.MplsLdpLspFecEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpLsrObjects.MplsLdpLsrLoopDetectionCapable_Enum' : _MetaInfoEnum('MplsLdpLsrLoopDetectionCapable_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'none':'NONE',
            'other':'OTHER',
            'hopCount':'HOPCOUNT',
    ...
    'MPLSLDPSTDMIB.MplsLdpLsrObjects' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpLsrObjects',
            ...
            _MetaInfoClassMember('mplsLdpLsrId', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsldplsrid',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpLsrLoopDetectionCapable', REFERENCE_ENUM_CLASS, 'MplsLdpLsrLoopDetectionCapable_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpLsrObjects.MplsLdpLsrLoopDetectionCapable_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry.MplsLdpSessionRole_Enum' : _MetaInfoEnum('MplsLdpSessionRole_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
            'unknown':'UNKNOWN',
            'active':'ACTIVE',
            'passive':'PASSIVE',
        }, 'MPLS-LDP-STD-MIB', _yang_ns._namespaces['MPLS-LDP-STD-MIB']),
    'MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry.MplsLdpSessionState_Enum' : _MetaInfoEnum('MplsLdpSessionState_Enum', 'ydk.models.mpls.MPLS_LDP_STD_MIB',
        {
    ...
    'MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry',
            ...
            _MetaInfoClassMember('mplsLdpPeerLdpId', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsldppeerldpid',
                'MPLS-LDP-STD-MIB', True),
            _MetaInfoClassMember('mplsLdpPeerLabelDistMethod', REFERENCE_ENUM_CLASS, 'MplsLabelDistributionMethod_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLabelDistributionMethod_Enum', 
                [], [], 
                '''                For any given LDP session, the method of
                label distribution must be specified.
                ''',
            ...
            _MetaInfoClassMember('mplsLdpPeerTransportAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpPeerTransportAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsLdpSessionProtocolVersion', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpSessionRole', REFERENCE_ENUM_CLASS, 'MplsLdpSessionRole_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry.MplsLdpSessionRole_Enum', 
                [], [], 
                ...
                'mplsldpsessionrole',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpSessionState', REFERENCE_ENUM_CLASS, 'MplsLdpSessionState_Enum' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry.MplsLdpSessionState_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpPeerTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpPeerTable',
            False, 
            [
            _MetaInfoClassMember('mplsLdpPeerEntry', REFERENCE_LIST, 'MplsLdpPeerEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpPeerTable.MplsLdpPeerEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpSessionPeerAddrTable.MplsLdpSessionPeerAddrEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpSessionPeerAddrTable.MplsLdpSessionPeerAddrEntry',
            ...
            _MetaInfoClassMember('mplsLdpSessionPeerNextHopAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpSessionPeerNextHopAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsLdpSessionPeerAddrTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsLdpSessionPeerAddrTable',
            False, 
            [
            _MetaInfoClassMember('mplsLdpSessionPeerAddrEntry', REFERENCE_LIST, 'MplsLdpSessionPeerAddrEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpSessionPeerAddrTable.MplsLdpSessionPeerAddrEntry', 
                [], [], 
    ...
    'MPLSLDPSTDMIB.MplsOutSegmentLdpLspTable.MplsOutSegmentLdpLspEntry' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsOutSegmentLdpLspTable.MplsOutSegmentLdpLspEntry',
            ...
            _MetaInfoClassMember('mplsOutSegmentLdpLspIndex', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsoutsegmentldplspindex',
                'MPLS-LDP-STD-MIB', True),
            _MetaInfoClassMember('mplsOutSegmentLdpLspLabelType', REFERENCE_ENUM_CLASS, 'MplsLdpLabelType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLdpLabelType_Enum', 
                [], [], 
                '''                The Layer 2 Label Type.
                ''',
                'mplsoutsegmentldplsplabeltype',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsOutSegmentLdpLspType', REFERENCE_ENUM_CLASS, 'MplsLspType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsLspType_Enum', 
                [], [], 
                '''                The type of LSP connection.
                ''',
    ...
    'MPLSLDPSTDMIB.MplsOutSegmentLdpLspTable' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB.MplsOutSegmentLdpLspTable',
            False, 
            [
            _MetaInfoClassMember('mplsOutSegmentLdpLspEntry', REFERENCE_LIST, 'MplsOutSegmentLdpLspEntry' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsOutSegmentLdpLspTable.MplsOutSegmentLdpLspEntry', 
                [], [], 
                '''                An entry in this table represents information
                on a single LDP LSP which is represented by
                a session's index triple (mplsLdpEntityLdpId,
    ...
    'MPLSLDPSTDMIB' : {
        'meta_info' : _MetaInfoClass('MPLSLDPSTDMIB',
            False, 
            [
            _MetaInfoClassMember('mplsFecObjects', REFERENCE_CLASS, 'MplsFecObjects' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsFecObjects', 
                [], [], 
                '''                ''',
                'mplsfecobjects',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsFecTable', REFERENCE_CLASS, 'MplsFecTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsFecTable', 
                [], [], 
                ...
                'mplsfectable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsInSegmentLdpLspTable', REFERENCE_CLASS, 'MplsInSegmentLdpLspTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsInSegmentLdpLspTable', 
                [], [], 
                ...
                'mplsinsegmentldplsptable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityObjects', REFERENCE_CLASS, 'MplsLdpEntityObjects' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpEntityObjects', 
                [], [], 
                '''                ''',
                'mplsldpentityobjects',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpEntityTable', REFERENCE_CLASS, 'MplsLdpEntityTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpEntityTable', 
                [], [], 
                ...
                'mplsldpentitytable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpHelloAdjacencyTable', REFERENCE_CLASS, 'MplsLdpHelloAdjacencyTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpHelloAdjacencyTable', 
                [], [], 
                '''                A table of Hello Adjacencies for Sessions.
                ''',
                'mplsldphelloadjacencytable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpLspFecTable', REFERENCE_CLASS, 'MplsLdpLspFecTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpLspFecTable', 
                [], [], 
                ...
                'mplsldplspfectable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpLsrObjects', REFERENCE_CLASS, 'MplsLdpLsrObjects' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpLsrObjects', 
                [], [], 
                '''                ''',
                'mplsldplsrobjects',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpPeerTable', REFERENCE_CLASS, 'MplsLdpPeerTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpPeerTable', 
                [], [], 
                ...
                'mplsldppeertable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpSessionObjects', REFERENCE_CLASS, 'MplsLdpSessionObjects' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpSessionObjects', 
                [], [], 
                '''                ''',
                'mplsldpsessionobjects',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsLdpSessionPeerAddrTable', REFERENCE_CLASS, 'MplsLdpSessionPeerAddrTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsLdpSessionPeerAddrTable', 
                [], [], 
                ...
                'mplsldpsessionpeeraddrtable',
                'MPLS-LDP-STD-MIB', False),
            _MetaInfoClassMember('mplsOutSegmentLdpLspTable', REFERENCE_CLASS, 'MplsOutSegmentLdpLspTable' , 'ydk.models.mpls.MPLS_LDP_STD_MIB', 'MPLSLDPSTDMIB.MplsOutSegmentLdpLspTable', 
                [], [], 
                '''                A table of LDP LSP's which
