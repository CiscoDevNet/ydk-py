...
_meta_table = {
    ...
    'Ntp.PeerVrfs' : {
        'meta_info' : _MetaInfoClass('Ntp.PeerVrfs',
            False, 
            [
            _MetaInfoClassMember('peer-vrf', REFERENCE_LIST, 'PeerVrf' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.PeerVrfs.PeerVrf', 
                [], [], 
    ...
    'Ntp.Sources' : {
        'meta_info' : _MetaInfoClass('Ntp.Sources',
            False, 
            [
            _MetaInfoClassMember('source', REFERENCE_LIST, 'Source' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.Sources.Source', 
                [], [], 
    ...
    'Ntp.Authentication.Keies' : {
        'meta_info' : _MetaInfoClass('Ntp.Authentication.Keies',
            False, 
            [
            _MetaInfoClassMember('key', REFERENCE_LIST, 'Key' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.Authentication.Keies.Key', 
                [], [], 
    ...
    'Ntp.Authentication.TrustedKeies' : {
        'meta_info' : _MetaInfoClass('Ntp.Authentication.TrustedKeies',
            False, 
            [
            _MetaInfoClassMember('trusted-key', REFERENCE_LIST, 'TrustedKey' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.Authentication.TrustedKeies.TrustedKey', 
                [], [], 
    ...
    'Ntp.Authentication' : {
        'meta_info' : _MetaInfoClass('Ntp.Authentication',
            ...
            _MetaInfoClassMember('keies', REFERENCE_CLASS, 'Keies' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.Authentication.Keies', 
                ...
                'keies',
                'Cisco-IOS-XR-ip-ntp-cfg', False),
            _MetaInfoClassMember('trusted-keies', REFERENCE_CLASS, 'TrustedKeies' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.Authentication.TrustedKeies', 
                [], [], 
    ...
    'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastClients' : {
        'meta_info' : _MetaInfoClass('Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastClients',
            False, 
            [
            _MetaInfoClassMember('multicast-client', REFERENCE_LIST, 'MulticastClient' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastClients.MulticastClient', 
                [], [], 
    ...
    'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastServers' : {
        'meta_info' : _MetaInfoClass('Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastServers',
            False, 
            [
            _MetaInfoClassMember('multicast-server', REFERENCE_LIST, 'MulticastServer' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastServers.MulticastServer', 
                [], [], 
    ...
    'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast' : {
        'meta_info' : _MetaInfoClass('Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast',
            False, 
            [
            _MetaInfoClassMember('multicast-clients', REFERENCE_CLASS, 'MulticastClients' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastClients', 
                [], [], 
                '''                Configures multicast client peers
                ''',
                'multicast_clients',
                'Cisco-IOS-XR-ip-ntp-cfg', False),
            _MetaInfoClassMember('multicast-servers', REFERENCE_CLASS, 'MulticastServers' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceMulticast.MulticastServers', 
                [], [], 
    ...
    'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceBroadcast' : {
        'meta_info' : _MetaInfoClass('Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceBroadcast',
            False, 
            [
            _MetaInfoClassMember('broadcast', REFERENCE_CLASS, 'Broadcast' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable.Interface.InterfaceBroadcast.Broadcast', 
                [], [], 
    ...
    'Ntp.InterfaceTables.InterfaceTable' : {
        'meta_info' : _MetaInfoClass('Ntp.InterfaceTables.InterfaceTable',
            ...
            _MetaInfoClassMember('vrf-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'vrf_name',
                'Cisco-IOS-XR-ip-ntp-cfg', True),
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable.Interface', 
                [], [], 
    ...
    'Ntp.InterfaceTables' : {
        'meta_info' : _MetaInfoClass('Ntp.InterfaceTables',
            False, 
            [
            _MetaInfoClassMember('interface-table', REFERENCE_LIST, 'InterfaceTable' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.InterfaceTables.InterfaceTable', 
                [], [], 
    ...
    'Ntp.AccessGroupTables.AccessGroupTable.AccessGroupAfTable' : {
        'meta_info' : _MetaInfoClass('Ntp.AccessGroupTables.AccessGroupTable.AccessGroupAfTable',
            ...
            _MetaInfoClassMember('af', REFERENCE_ENUM_CLASS, 'NtpAccessAfEnum' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'NtpAccessAfEnum', 
                ...
                'af',
                'Cisco-IOS-XR-ip-ntp-cfg', True),
            _MetaInfoClassMember('access-group', REFERENCE_LIST, 'AccessGroup' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.AccessGroupTables.AccessGroupTable.AccessGroupAfTable.AccessGroup', 
                [], [], 
    ...
    'Ntp.AccessGroupTables.AccessGroupTable' : {
        'meta_info' : _MetaInfoClass('Ntp.AccessGroupTables.AccessGroupTable',
            ...
            _MetaInfoClassMember('vrf-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'vrf_name',
                'Cisco-IOS-XR-ip-ntp-cfg', True),
            _MetaInfoClassMember('access-group-af-table', REFERENCE_LIST, 'AccessGroupAfTable' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.AccessGroupTables.AccessGroupTable.AccessGroupAfTable', 
                [], [], 
    ...
    'Ntp.AccessGroupTables' : {
        'meta_info' : _MetaInfoClass('Ntp.AccessGroupTables',
            False, 
            [
            _MetaInfoClassMember('access-group-table', REFERENCE_LIST, 'AccessGroupTable' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.AccessGroupTables.AccessGroupTable', 
                [], [], 
                '''                Control NTP access
                ''',
                'access_group_table',
    ...
    'Ntp' : {
        'meta_info' : _MetaInfoClass('Ntp',
            ...
            _MetaInfoClassMember('dscp-ipv4', REFERENCE_CLASS, 'DscpIpv4' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.DscpIpv4', 
                ...
                'dscp_ipv4',
                'Cisco-IOS-XR-ip-ntp-cfg', False),
            _MetaInfoClassMember('dscp-ipv6', REFERENCE_CLASS, 'DscpIpv6' , 'ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg', 'Ntp.DscpIpv6', 
                [], [], 
