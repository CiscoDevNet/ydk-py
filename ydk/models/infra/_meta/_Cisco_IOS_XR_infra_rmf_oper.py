...
_meta_table = {
    'Redundancy.Nodes.Node.Redundancy.Groupinfo' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper'
        ),
    },
    ...
    'Redundancy.Nodes' : {
        'meta_info' : _MetaInfoClass('Redundancy.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper', 'Redundancy.Nodes.Node', 
                [], [], 
    ...
    'Redundancy.Summary' : {
        'meta_info' : _MetaInfoClass('Redundancy.Summary',
            ...
            _MetaInfoClassMember('err-log', ATTRIBUTE, 'str' , None, None, 
                ...
                'err_log',
                'Cisco-IOS-XR-infra-rmf-oper', False),
            _MetaInfoClassMember('red-pair', REFERENCE_LIST, 'RedPair' , 'ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper', 'Redundancy.Summary.RedPair', 
                [], [], 
                '''                Redundancy Pair
                ''',
                'red_pair',
    ...
    'Redundancy' : {
        'meta_info' : _MetaInfoClass('Redundancy',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper', 'Redundancy.Nodes', 
                [], [], 
                '''                Location show information
                ''',
                'nodes',
                'Cisco-IOS-XR-infra-rmf-oper', False),
            _MetaInfoClassMember('summary', REFERENCE_CLASS, 'Summary' , 'ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper', 'Redundancy.Summary', 
                [], [], 
