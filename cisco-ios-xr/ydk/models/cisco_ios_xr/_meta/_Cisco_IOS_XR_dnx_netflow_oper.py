...
_meta_table = {
    'UdpAddressFamilyEnum' : _MetaInfoEnum('UdpAddressFamilyEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_dnx_netflow_oper',
        {
            'ipv4':'IPV4',
            'ipv6':'IPV6',
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector.DestinationAddress' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector.DestinationAddress',
            False, 
            [
            _MetaInfoClassMember('af-name', REFERENCE_ENUM_CLASS, 'UdpAddressFamilyEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_dnx_netflow_oper', 'UdpAddressFamilyEnum', 
                [], [], 
                '''                AFName
                ''',
                'af_name',
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector',
            ...
            _MetaInfoClassMember('bytes-sent', ATTRIBUTE, 'long' , None, None, 
                ...
                'bytes_sent',
                'Cisco-IOS-XR-dnx-netflow-oper', False),
            _MetaInfoClassMember('destination-address', REFERENCE_CLASS, 'DestinationAddress' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_dnx_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector.DestinationAddress', 
                [], [], 
                '''                Destination address
                ''',
                'destination_address',
            ...
            _MetaInfoClassMember('souce-port', ATTRIBUTE, 'int' , None, None, 
                ...
                'souce_port',
                'Cisco-IOS-XR-dnx-netflow-oper', False),
            _MetaInfoClassMember('source-address', REFERENCE_CLASS, 'SourceAddress' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_dnx_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector.SourceAddress', 
                [], [], 
                '''                Source address
                ''',
                'source_address',
