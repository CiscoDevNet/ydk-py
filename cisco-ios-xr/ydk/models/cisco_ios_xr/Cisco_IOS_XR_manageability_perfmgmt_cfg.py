...
class PerfMgmt(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"enable" : ("enable", PerfMgmt.Enable), "reg-exp-groups" : ("reg_exp_groups", PerfMgmt.RegExpGroups), "resources" : ("resources", PerfMgmt.Resources), "statistics" : ("statistics", PerfMgmt.Statistics), "threshold" : ("threshold", PerfMgmt.Threshold)}
    ...
    class Enable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"monitor-enable" : ("monitor_enable", PerfMgmt.Enable.MonitorEnable), "statistics" : ("statistics", PerfMgmt.Enable.Statistics), "threshold" : ("threshold", PerfMgmt.Enable.Threshold)}
            self._child_list_classes = {}
        ...
        class MonitorEnable(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"basic-counters" : ("basic_counters", PerfMgmt.Enable.MonitorEnable.BasicCounters), "bgp" : ("bgp", PerfMgmt.Enable.MonitorEnable.Bgp), "cpu" : ("cpu", PerfMgmt.Enable.MonitorEnable.Cpu), "data-rates" : ("data_rates", PerfMgmt.Enable.MonitorEnable.DataRates), "generic-counters" : ("generic_counters", PerfMgmt.Enable.MonitorEnable.GenericCounters), "ldp-mpls" : ("ldp_mpls", PerfMgmt.Enable.MonitorEnable.LdpMpls), "memory" : ("memory", PerfMgmt.Enable.MonitorEnable.Memory), "ospfv2-protocol" : ("ospfv2_protocol", PerfMgmt.Enable.MonitorEnable.Ospfv2Protocol), "ospfv3-protocol" : ("ospfv3_protocol", PerfMgmt.Enable.MonitorEnable.Ospfv3Protocol), "process" : ("process", PerfMgmt.Enable.MonitorEnable.Process)}
                self._child_list_classes = {}
        ...
        class Statistics(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"basic-counter-interface" : ("basic_counter_interface", PerfMgmt.Enable.Statistics.BasicCounterInterface), "bgp" : ("bgp", PerfMgmt.Enable.Statistics.Bgp), "cpu-node" : ("cpu_node", PerfMgmt.Enable.Statistics.CpuNode), "data-rate-interface" : ("data_rate_interface", PerfMgmt.Enable.Statistics.DataRateInterface), "generic-counter-interface" : ("generic_counter_interface", PerfMgmt.Enable.Statistics.GenericCounterInterface), "ldp-mpls" : ("ldp_mpls", PerfMgmt.Enable.Statistics.LdpMpls), "memory-node" : ("memory_node", PerfMgmt.Enable.Statistics.MemoryNode), "ospfv2-protocol" : ("ospfv2_protocol", PerfMgmt.Enable.Statistics.Ospfv2Protocol), "ospfv3-protocol" : ("ospfv3_protocol", PerfMgmt.Enable.Statistics.Ospfv3Protocol), "process-node" : ("process_node", PerfMgmt.Enable.Statistics.ProcessNode)}
                self._child_list_classes = {}
        ...
        class Threshold(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"basic-counter-interface" : ("basic_counter_interface", PerfMgmt.Enable.Threshold.BasicCounterInterface), "bgp" : ("bgp", PerfMgmt.Enable.Threshold.Bgp), "cpu-node" : ("cpu_node", PerfMgmt.Enable.Threshold.CpuNode), "data-rate-interface" : ("data_rate_interface", PerfMgmt.Enable.Threshold.DataRateInterface), "generic-counter-interface" : ("generic_counter_interface", PerfMgmt.Enable.Threshold.GenericCounterInterface), "ldp-mpls" : ("ldp_mpls", PerfMgmt.Enable.Threshold.LdpMpls), "memory-node" : ("memory_node", PerfMgmt.Enable.Threshold.MemoryNode), "ospfv2-protocol" : ("ospfv2_protocol", PerfMgmt.Enable.Threshold.Ospfv2Protocol), "ospfv3-protocol" : ("ospfv3_protocol", PerfMgmt.Enable.Threshold.Ospfv3Protocol), "process-node" : ("process_node", PerfMgmt.Enable.Threshold.ProcessNode)}
                self._child_list_classes = {}
            ...
            class CpuNode(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"node-all" : ("node_all", PerfMgmt.Enable.Threshold.CpuNode.NodeAll), "nodes" : ("nodes", PerfMgmt.Enable.Threshold.CpuNode.Nodes)}
                    self._child_list_classes = {}
            ...
            class MemoryNode(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"node-all" : ("node_all", PerfMgmt.Enable.Threshold.MemoryNode.NodeAll), "nodes" : ("nodes", PerfMgmt.Enable.Threshold.MemoryNode.Nodes)}
                    self._child_list_classes = {}
            ...
            class ProcessNode(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"node-all" : ("node_all", PerfMgmt.Enable.Threshold.ProcessNode.NodeAll), "nodes" : ("nodes", PerfMgmt.Enable.Threshold.ProcessNode.Nodes)}
                    self._child_list_classes = {}
    ...
    class Resources(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"dump-local" : ("dump_local", PerfMgmt.Resources.DumpLocal), "memory-resources" : ("memory_resources", PerfMgmt.Resources.MemoryResources), "tftp-resources" : ("tftp_resources", PerfMgmt.Resources.TftpResources)}
            self._child_list_classes = {}
        ...
        class TftpResources(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(PerfMgmt.Resources.TftpResources, ['directory', 'server_address', 'vrf_name'], name, value)
    ...
    class Statistics(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"basic-counter-interface" : ("basic_counter_interface", PerfMgmt.Statistics.BasicCounterInterface), "bgp" : ("bgp", PerfMgmt.Statistics.Bgp), "cpu-node" : ("cpu_node", PerfMgmt.Statistics.CpuNode), "data-rate-interface" : ("data_rate_interface", PerfMgmt.Statistics.DataRateInterface), "generic-counter-interface" : ("generic_counter_interface", PerfMgmt.Statistics.GenericCounterInterface), "ldp-mpls" : ("ldp_mpls", PerfMgmt.Statistics.LdpMpls), "memory-node" : ("memory_node", PerfMgmt.Statistics.MemoryNode), "ospfv2-protocol" : ("ospfv2_protocol", PerfMgmt.Statistics.Ospfv2Protocol), "ospfv3-protocol" : ("ospfv3_protocol", PerfMgmt.Statistics.Ospfv3Protocol), "process-node" : ("process_node", PerfMgmt.Statistics.ProcessNode)}
            self._child_list_classes = {}
        ...
        class BasicCounterInterface(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.BasicCounterInterface.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class Bgp(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.Bgp.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class CpuNode(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.CpuNode.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class DataRateInterface(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.DataRateInterface.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class GenericCounterInterface(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.GenericCounterInterface.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class LdpMpls(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.LdpMpls.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class MemoryNode(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.MemoryNode.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class Ospfv2Protocol(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.Ospfv2Protocol.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class Ospfv3Protocol(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.Ospfv3Protocol.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
        ...
        class ProcessNode(Entity):
            ...
            class Templates(Entity):
                ...
                class Template(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Statistics.ProcessNode.Templates.Template, ['template_name', 'history_persistent', 'reg_exp_group', 'sample_interval', 'sample_size', 'vrf_group'], name, value)
    ...
    class Threshold(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"basic-counter-interface" : ("basic_counter_interface", PerfMgmt.Threshold.BasicCounterInterface), "bgp" : ("bgp", PerfMgmt.Threshold.Bgp), "cpu-node" : ("cpu_node", PerfMgmt.Threshold.CpuNode), "data-rate-interface" : ("data_rate_interface", PerfMgmt.Threshold.DataRateInterface), "generic-counter-interface" : ("generic_counter_interface", PerfMgmt.Threshold.GenericCounterInterface), "ldp-mpls" : ("ldp_mpls", PerfMgmt.Threshold.LdpMpls), "memory-node" : ("memory_node", PerfMgmt.Threshold.MemoryNode), "ospfv2-protocol" : ("ospfv2_protocol", PerfMgmt.Threshold.Ospfv2Protocol), "ospfv3-protocol" : ("ospfv3_protocol", PerfMgmt.Threshold.Ospfv3Protocol), "process-node" : ("process_node", PerfMgmt.Threshold.ProcessNode)}
            self._child_list_classes = {}
            ...
            class BasicCounterInterfaceTemplates(Entity):
                ...
                class BasicCounterInterfaceTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"in-octets" : ("in_octets", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InOctets), "in-packets" : ("in_packets", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InPackets), "input-queue-drops" : ("input_queue_drops", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InputQueueDrops), "input-total-drops" : ("input_total_drops", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InputTotalDrops), "input-total-errors" : ("input_total_errors", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InputTotalErrors), "out-octets" : ("out_octets", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutOctets), "out-packets" : ("out_packets", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutPackets), "output-queue-drops" : ("output_queue_drops", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutputQueueDrops), "output-total-drops" : ("output_total_drops", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutputTotalDrops), "output-total-errors" : ("output_total_errors", PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutputTotalErrors)}
                        self._child_list_classes = {}
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate, ['template_name', 'reg_exp_group', 'sample_interval', 'vrf_group'], name, value)
                    ...
                    class InOctets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InOctets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputQueueDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InputQueueDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputTotalDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InputTotalDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputTotalErrors(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.InputTotalErrors, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutOctets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutOctets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputQueueDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutputQueueDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputTotalDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutputTotalDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputTotalErrors(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.BasicCounterInterface.BasicCounterInterfaceTemplates.BasicCounterInterfaceTemplate.OutputTotalErrors, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class BgpTemplates(Entity):
                ...
                class BgpTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"conn-dropped" : ("conn_dropped", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ConnDropped), "conn-established" : ("conn_established", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ConnEstablished), "errors-received" : ("errors_received", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ErrorsReceived), "errors-sent" : ("errors_sent", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ErrorsSent), "input-messages" : ("input_messages", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.InputMessages), "input-update-messages" : ("input_update_messages", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.InputUpdateMessages), "output-messages" : ("output_messages", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.OutputMessages), "output-update-messages" : ("output_update_messages", PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.OutputUpdateMessages)}
                        self._child_list_classes = {}
                    ...
                    class ConnDropped(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ConnDropped, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class ConnEstablished(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ConnEstablished, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class ErrorsReceived(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ErrorsReceived, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class ErrorsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.ErrorsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputMessages(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.InputMessages, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputUpdateMessages(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.InputUpdateMessages, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputMessages(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.OutputMessages, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputUpdateMessages(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Bgp.BgpTemplates.BgpTemplate.OutputUpdateMessages, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class CpuNodeTemplates(Entity):
                ...
                class CpuNodeTemplate(Entity):
                    ...
                    class AverageCpuUsed(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.CpuNode.CpuNodeTemplates.CpuNodeTemplate.AverageCpuUsed, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class NoProcesses(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.CpuNode.CpuNodeTemplates.CpuNodeTemplate.NoProcesses, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class DataRateInterfaceTemplates(Entity):
                ...
                class DataRateInterfaceTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"bandwidth" : ("bandwidth", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.Bandwidth), "input-data-rate" : ("input_data_rate", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputDataRate), "input-packet-rate" : ("input_packet_rate", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputPacketRate), "input-peak-pkts" : ("input_peak_pkts", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputPeakPkts), "input-peak-rate" : ("input_peak_rate", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputPeakRate), "output-data-rate" : ("output_data_rate", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputDataRate), "output-packet-rate" : ("output_packet_rate", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputPacketRate), "output-peak-pkts" : ("output_peak_pkts", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputPeakPkts), "output-peak-rate" : ("output_peak_rate", PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputPeakRate)}
                        self._child_list_classes = {}
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate, ['template_name', 'reg_exp_group', 'sample_interval', 'vrf_group'], name, value)
                    ...
                    class Bandwidth(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.Bandwidth, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputDataRate(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputDataRate, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputPacketRate(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputPacketRate, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputPeakPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputPeakPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputPeakRate(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.InputPeakRate, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputDataRate(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputDataRate, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputPacketRate(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputPacketRate, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputPeakPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputPeakPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputPeakRate(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.DataRateInterface.DataRateInterfaceTemplates.DataRateInterfaceTemplate.OutputPeakRate, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class GenericCounterInterfaceTemplates(Entity):
                ...
                class GenericCounterInterfaceTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"in-broadcast-pkts" : ("in_broadcast_pkts", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InBroadcastPkts), "in-multicast-pkts" : ("in_multicast_pkts", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InMulticastPkts), "in-octets" : ("in_octets", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InOctets), "in-packets" : ("in_packets", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InPackets), "in-ucast-pkts" : ("in_ucast_pkts", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InUcastPkts), "input-crc" : ("input_crc", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputCrc), "input-frame" : ("input_frame", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputFrame), "input-overrun" : ("input_overrun", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputOverrun), "input-queue-drops" : ("input_queue_drops", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputQueueDrops), "input-total-drops" : ("input_total_drops", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputTotalDrops), "input-total-errors" : ("input_total_errors", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputTotalErrors), "input-unknown-proto" : ("input_unknown_proto", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputUnknownProto), "out-broadcast-pkts" : ("out_broadcast_pkts", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutBroadcastPkts), "out-multicast-pkts" : ("out_multicast_pkts", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutMulticastPkts), "out-octets" : ("out_octets", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutOctets), "out-packets" : ("out_packets", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutPackets), "out-ucast-pkts" : ("out_ucast_pkts", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutUcastPkts), "output-total-drops" : ("output_total_drops", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutputTotalDrops), "output-total-errors" : ("output_total_errors", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutputTotalErrors), "output-underrun" : ("output_underrun", PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutputUnderrun)}
                        self._child_list_classes = {}
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate, ['template_name', 'reg_exp_group', 'sample_interval', 'vrf_group'], name, value)
                    ...
                    class InBroadcastPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InBroadcastPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InMulticastPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InMulticastPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InOctets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InOctets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InUcastPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InUcastPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputCrc(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputCrc, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputFrame(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputFrame, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputOverrun(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputOverrun, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputQueueDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputQueueDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputTotalDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputTotalDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputTotalErrors(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputTotalErrors, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputUnknownProto(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.InputUnknownProto, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutBroadcastPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutBroadcastPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutMulticastPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutMulticastPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutOctets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutOctets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutUcastPkts(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutUcastPkts, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputTotalDrops(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutputTotalDrops, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputTotalErrors(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutputTotalErrors, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputUnderrun(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.GenericCounterInterface.GenericCounterInterfaceTemplates.GenericCounterInterfaceTemplate.OutputUnderrun, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class LdpMplsTemplates(Entity):
                ...
                class LdpMplsTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"address-msgs-rcvd" : ("address_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressMsgsRcvd), "address-msgs-sent" : ("address_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressMsgsSent), "address-withdraw-msgs-rcvd" : ("address_withdraw_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressWithdrawMsgsRcvd), "address-withdraw-msgs-sent" : ("address_withdraw_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressWithdrawMsgsSent), "init-msgs-rcvd" : ("init_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.InitMsgsRcvd), "init-msgs-sent" : ("init_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.InitMsgsSent), "keepalive-msgs-rcvd" : ("keepalive_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.KeepaliveMsgsRcvd), "keepalive-msgs-sent" : ("keepalive_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.KeepaliveMsgsSent), "label-mapping-msgs-rcvd" : ("label_mapping_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelMappingMsgsRcvd), "label-mapping-msgs-sent" : ("label_mapping_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelMappingMsgsSent), "label-release-msgs-rcvd" : ("label_release_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelReleaseMsgsRcvd), "label-release-msgs-sent" : ("label_release_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelReleaseMsgsSent), "label-withdraw-msgs-rcvd" : ("label_withdraw_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelWithdrawMsgsRcvd), "label-withdraw-msgs-sent" : ("label_withdraw_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelWithdrawMsgsSent), "notification-msgs-rcvd" : ("notification_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.NotificationMsgsRcvd), "notification-msgs-sent" : ("notification_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.NotificationMsgsSent), "total-msgs-rcvd" : ("total_msgs_rcvd", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.TotalMsgsRcvd), "total-msgs-sent" : ("total_msgs_sent", PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.TotalMsgsSent)}
                        self._child_list_classes = {}
                    ...
                    class AddressMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class AddressMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class AddressWithdrawMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressWithdrawMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class AddressWithdrawMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.AddressWithdrawMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InitMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.InitMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InitMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.InitMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class KeepaliveMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.KeepaliveMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class KeepaliveMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.KeepaliveMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class LabelMappingMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelMappingMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class LabelMappingMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelMappingMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class LabelReleaseMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelReleaseMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class LabelReleaseMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelReleaseMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class LabelWithdrawMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelWithdrawMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class LabelWithdrawMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.LabelWithdrawMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class NotificationMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.NotificationMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class NotificationMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.NotificationMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class TotalMsgsRcvd(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.TotalMsgsRcvd, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class TotalMsgsSent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.LdpMpls.LdpMplsTemplates.LdpMplsTemplate.TotalMsgsSent, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class MemoryNodeTemplates(Entity):
                ...
                class MemoryNodeTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"curr-memory" : ("curr_memory", PerfMgmt.Threshold.MemoryNode.MemoryNodeTemplates.MemoryNodeTemplate.CurrMemory), "peak-memory" : ("peak_memory", PerfMgmt.Threshold.MemoryNode.MemoryNodeTemplates.MemoryNodeTemplate.PeakMemory)}
                        self._child_list_classes = {}
                    ...
                    class CurrMemory(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.MemoryNode.MemoryNodeTemplates.MemoryNodeTemplate.CurrMemory, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class PeakMemory(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.MemoryNode.MemoryNodeTemplates.MemoryNodeTemplate.PeakMemory, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class Ospfv2ProtocolTemplates(Entity):
                ...
                class Ospfv2ProtocolTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"checksum-errors" : ("checksum_errors", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.ChecksumErrors), "input-db-ds" : ("input_db_ds", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputDbDs), "input-db-ds-lsa" : ("input_db_ds_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputDbDsLsa), "input-hello-packets" : ("input_hello_packets", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputHelloPackets), "input-ls-requests" : ("input_ls_requests", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsRequests), "input-ls-requests-lsa" : ("input_ls_requests_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsRequestsLsa), "input-lsa-acks" : ("input_lsa_acks", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaAcks), "input-lsa-acks-lsa" : ("input_lsa_acks_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaAcksLsa), "input-lsa-updates" : ("input_lsa_updates", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaUpdates), "input-lsa-updates-lsa" : ("input_lsa_updates_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaUpdatesLsa), "input-packets" : ("input_packets", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputPackets), "output-db-ds" : ("output_db_ds", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputDbDs), "output-db-ds-lsa" : ("output_db_ds_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputDbDsLsa), "output-hello-packets" : ("output_hello_packets", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputHelloPackets), "output-ls-requests" : ("output_ls_requests", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsRequests), "output-ls-requests-lsa" : ("output_ls_requests_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsRequestsLsa), "output-lsa-acks" : ("output_lsa_acks", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaAcks), "output-lsa-acks-lsa" : ("output_lsa_acks_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaAcksLsa), "output-lsa-updates" : ("output_lsa_updates", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaUpdates), "output-lsa-updates-lsa" : ("output_lsa_updates_lsa", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaUpdatesLsa), "output-packets" : ("output_packets", PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputPackets)}
                        self._child_list_classes = {}
                    ...
                    class ChecksumErrors(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.ChecksumErrors, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputDbDs(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputDbDs, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputDbDsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputDbDsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputHelloPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputHelloPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsRequests(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsRequests, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsRequestsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsRequestsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaAcks(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaAcks, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaAcksLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaAcksLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaUpdates(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaUpdates, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaUpdatesLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputLsaUpdatesLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.InputPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputDbDs(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputDbDs, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputDbDsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputDbDsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputHelloPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputHelloPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsRequests(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsRequests, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsRequestsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsRequestsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaAcks(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaAcks, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaAcksLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaAcksLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaUpdates(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaUpdates, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaUpdatesLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputLsaUpdatesLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv2Protocol.Ospfv2ProtocolTemplates.Ospfv2ProtocolTemplate.OutputPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class Ospfv3ProtocolTemplates(Entity):
                ...
                class Ospfv3ProtocolTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"input-db-ds" : ("input_db_ds", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputDbDs), "input-db-ds-lsa" : ("input_db_ds_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputDbDsLsa), "input-hello-packets" : ("input_hello_packets", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputHelloPackets), "input-ls-requests" : ("input_ls_requests", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsRequests), "input-ls-requests-lsa" : ("input_ls_requests_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsRequestsLsa), "input-lsa-acks" : ("input_lsa_acks", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaAcks), "input-lsa-acks-lsa" : ("input_lsa_acks_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaAcksLsa), "input-lsa-updates" : ("input_lsa_updates", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaUpdates), "input-lsa-updates-lsa" : ("input_lsa_updates_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaUpdatesLsa), "input-packets" : ("input_packets", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputPackets), "output-db-ds" : ("output_db_ds", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputDbDs), "output-db-ds-lsa" : ("output_db_ds_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputDbDsLsa), "output-hello-packets" : ("output_hello_packets", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputHelloPackets), "output-ls-requests" : ("output_ls_requests", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsRequests), "output-ls-requests-lsa" : ("output_ls_requests_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsRequestsLsa), "output-lsa-acks" : ("output_lsa_acks", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaAcks), "output-lsa-acks-lsa" : ("output_lsa_acks_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaAcksLsa), "output-lsa-updates" : ("output_lsa_updates", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaUpdates), "output-lsa-updates-lsa" : ("output_lsa_updates_lsa", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaUpdatesLsa), "output-packets" : ("output_packets", PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputPackets)}
                        self._child_list_classes = {}
                    ...
                    class InputDbDs(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputDbDs, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputDbDsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputDbDsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputHelloPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputHelloPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsRequests(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsRequests, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsRequestsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsRequestsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaAcks(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaAcks, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaAcksLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaAcksLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaUpdates(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaUpdates, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputLsaUpdatesLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputLsaUpdatesLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class InputPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.InputPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputDbDs(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputDbDs, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputDbDsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputDbDsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputHelloPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputHelloPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsRequests(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsRequests, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsRequestsLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsRequestsLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaAcks(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaAcks, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaAcksLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaAcksLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaUpdates(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaUpdates, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputLsaUpdatesLsa(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputLsaUpdatesLsa, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class OutputPackets(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.Ospfv3Protocol.Ospfv3ProtocolTemplates.Ospfv3ProtocolTemplate.OutputPackets, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
            ...
            class ProcessNodeTemplates(Entity):
                ...
                class ProcessNodeTemplate(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"average-cpu-used" : ("average_cpu_used", PerfMgmt.Threshold.ProcessNode.ProcessNodeTemplates.ProcessNodeTemplate.AverageCpuUsed), "no-threads" : ("no_threads", PerfMgmt.Threshold.ProcessNode.ProcessNodeTemplates.ProcessNodeTemplate.NoThreads), "peak-memory" : ("peak_memory", PerfMgmt.Threshold.ProcessNode.ProcessNodeTemplates.ProcessNodeTemplate.PeakMemory)}
                        self._child_list_classes = {}
                    ...
                    class AverageCpuUsed(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.ProcessNode.ProcessNodeTemplates.ProcessNodeTemplate.AverageCpuUsed, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class NoThreads(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.ProcessNode.ProcessNodeTemplates.ProcessNodeTemplate.NoThreads, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
                    ...
                    class PeakMemory(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(PerfMgmt.Threshold.ProcessNode.ProcessNodeTemplates.ProcessNodeTemplate.PeakMemory, ['end_range_value', 'operator', 'percent', 'rearm_type', 'rearm_window', 'value'], name, value)
