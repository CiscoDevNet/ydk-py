...
_meta_table = {
    'Telnet.Vrfs.Vrf.Ipv4' : {
        ...
        'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg'
        ),
    },
    'Telnet.Vrfs.Vrf' : {
        'meta_info' : _MetaInfoClass('Telnet.Vrfs.Vrf',
            ...
            _MetaInfoClassMember('ipv4', REFERENCE_CLASS, 'Ipv4' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg', 'Telnet.Vrfs.Vrf.Ipv4', 
                [], [], 
                '''                IPv4 configuration
                ''',
                'ipv4',
    ...
    'Telnet.Vrfs' : {
        'meta_info' : _MetaInfoClass('Telnet.Vrfs',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg', 'Telnet.Vrfs.Vrf', 
                [], [], 
    ...
    'Telnet' : {
        'meta_info' : _MetaInfoClass('Telnet',
            False, 
            [
            _MetaInfoClassMember('vrfs', REFERENCE_CLASS, 'Vrfs' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg', 'Telnet.Vrfs', 
                [], [], 
                '''                VRF name for telnet service
                ''',
                'vrfs',
