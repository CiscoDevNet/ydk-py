...
_meta_table = {
    'CISCOAAASESSIONMIB.CasnActive' : {
        ...
        'ydk.models.aaa.CISCO_AAA_SESSION_MIB'
        ),
    },
    ...
    'CISCOAAASESSIONMIB.CasnActiveTable' : {
        'meta_info' : _MetaInfoClass('CISCOAAASESSIONMIB.CasnActiveTable',
            False, 
            [
            _MetaInfoClassMember('casnActiveEntry', REFERENCE_LIST, 'CasnActiveEntry' , 'ydk.models.aaa.CISCO_AAA_SESSION_MIB', 'CISCOAAASESSIONMIB.CasnActiveTable.CasnActiveEntry', 
                [], [], 
    ...
    'CISCOAAASESSIONMIB' : {
        'meta_info' : _MetaInfoClass('CISCOAAASESSIONMIB',
            False, 
            [
            _MetaInfoClassMember('casnActive', REFERENCE_CLASS, 'CasnActive' , 'ydk.models.aaa.CISCO_AAA_SESSION_MIB', 'CISCOAAASESSIONMIB.CasnActive', 
                [], [], 
                '''                ''',
                'casnactive',
                'CISCO-AAA-SESSION-MIB', False),
            _MetaInfoClassMember('casnActiveTable', REFERENCE_CLASS, 'CasnActiveTable' , 'ydk.models.aaa.CISCO_AAA_SESSION_MIB', 'CISCOAAASESSIONMIB.CasnActiveTable', 
                [], [], 
                ...
                'casnactivetable',
                'CISCO-AAA-SESSION-MIB', False),
            _MetaInfoClassMember('casnGeneral', REFERENCE_CLASS, 'CasnGeneral' , 'ydk.models.aaa.CISCO_AAA_SESSION_MIB', 'CISCOAAASESSIONMIB.CasnGeneral', 
                [], [], 
                '''                ''',
                'casngeneral',
                'CISCO-AAA-SESSION-MIB', False),
