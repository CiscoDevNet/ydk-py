...
_meta_table = {
    ...
    'RebootHistory.Node' : {
        'meta_info' : _MetaInfoClass('RebootHistory.Node',
            ...
            _MetaInfoClassMember('reboot-history', REFERENCE_LIST, 'RebootHistory' , 'ydk.models.linux.Cisco_IOS_XR_linux_os_reboot_history_oper', 'RebootHistory.Node.RebootHistory', 
                [], [], 
                '''                Last Reboots
                ''',
                'reboot_history',
    ...
    'RebootHistory' : {
        'meta_info' : _MetaInfoClass('RebootHistory',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.linux.Cisco_IOS_XR_linux_os_reboot_history_oper', 'RebootHistory.Node', 
                [], [], 
                '''                Node ID
                ''',
                'node',
