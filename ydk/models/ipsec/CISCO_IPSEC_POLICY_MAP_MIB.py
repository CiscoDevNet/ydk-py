...
class CISCOIPSECPOLICYMAPMIB(object):
    ...
    .. attribute:: ikepolmaptable
    	...
    	**type**\: :py:class:`IkePolMapTable <ydk.models.ipsec.CISCO_IPSEC_POLICY_MAP_MIB.CISCOIPSECPOLICYMAPMIB.IkePolMapTable>`
    ...
    .. attribute:: ipsecpolmaptable
    	...
    	**type**\: :py:class:`IpSecPolMapTable <ydk.models.ipsec.CISCO_IPSEC_POLICY_MAP_MIB.CISCOIPSECPOLICYMAPMIB.IpSecPolMapTable>`
    ...
    class IkePolMapTable(object):
        ...
        .. attribute:: ikepolmapentry
        	...
        	**type**\: list of :py:class:`IkePolMapEntry <ydk.models.ipsec.CISCO_IPSEC_POLICY_MAP_MIB.CISCOIPSECPOLICYMAPMIB.IkePolMapTable.IkePolMapEntry>`
        ...
        class IkePolMapEntry(object):
            ...
            def _common_path(self):
                if self.ikepolmaptunindex is None:
                    raise YPYDataValidationError('Key property ikepolmaptunindex is None')
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.ipsec._meta import _CISCO_IPSEC_POLICY_MAP_MIB as meta
    ...
    class IpSecPolMapTable(object):
        ...
        .. attribute:: ipsecpolmapentry
        	...
        	**type**\: list of :py:class:`IpSecPolMapEntry <ydk.models.ipsec.CISCO_IPSEC_POLICY_MAP_MIB.CISCOIPSECPOLICYMAPMIB.IpSecPolMapTable.IpSecPolMapEntry>`
        ...
        class IpSecPolMapEntry(object):
            ...
            def _common_path(self):
                if self.ipsecpolmaptunindex is None:
                    raise YPYDataValidationError('Key property ipsecpolmaptunindex is None')
    ...
    def _has_data(self):
        ...
        if self.ikepolmaptable is not None and self.ikepolmaptable.is_presence():
            return True

        if self.ipsecpolmaptable is not None and self.ipsecpolmaptable._has_data():
            return True

        if self.ipsecpolmaptable is not None and self.ipsecpolmaptable.is_presence():
            return True
