...
class Ipv6Arm(Entity):
        ...
        with _handle_type_error():
            ...
            if name in ("multicast_host_interface") and name in self.__dict__:
                if isinstance(value, YLeaf):
                    ...
                    super(Ipv6Arm, self).__setattr__(name, value)
                else:
    ...
    class Addresses(Entity):
        ...
        class Vrfs(Entity):
                ...
                with _handle_type_error():
                    ...
                    if name in () and name in self.__dict__:
                        if isinstance(value, YLeaf):
                            ...
                            super(Ipv6Arm.Addresses.Vrfs, self).__setattr__(name, value)
                        else:
                            self.__dict__[name].set(value)
                    else:
                        if hasattr(value, "parent") and name != "parent":
            ...
            class Vrf(Entity):
                    ...
                    with _handle_type_error():
                        ...
                        if name in ("vrf_name") and name in self.__dict__:
                            if isinstance(value, YLeaf):
                                ...
                                super(Ipv6Arm.Addresses.Vrfs.Vrf, self).__setattr__(name, value)
                            else:
                                self.__dict__[name].set(value)
                        else:
                            if hasattr(value, "parent") and name != "parent":
                        ...
                        with _handle_type_error():
                            ...
                            if name in () and name in self.__dict__:
                                if isinstance(value, YLeaf):
                                    ...
                                    super(Ipv6Arm.Addresses.Vrfs.Vrf.Networks, self).__setattr__(name, value)
                                else:
                                    self.__dict__[name].set(value)
                            else:
                                if hasattr(value, "parent") and name != "parent":
                            ...
                            with _handle_type_error():
                                ...
                                if name in ("address",
                                    ...
                                    if isinstance(value, YLeaf):
                                        ...
                                        super(Ipv6Arm.Addresses.Vrfs.Vrf.Networks.Network, self).__setattr__(name, value)
                                    else:
                                        self.__dict__[name].set(value)
                                else:
                                    if hasattr(value, "parent") and name != "parent":
                                ...
                                with _handle_type_error():
                                    ...
                                    if name in ("is_prefix_sid",
                                        ...
                                        if isinstance(value, YLeaf):
                                            ...
                                            super(Ipv6Arm.Addresses.Vrfs.Vrf.Networks.Network.AddressXr, self).__setattr__(name, value)
                                        else:
                                            self.__dict__[name].set(value)
                                    else:
                                        if hasattr(value, "parent") and name != "parent":
                                    ...
                                    with _handle_type_error():
                                        ...
                                        if name in ("afi",
                                            ...
                                            if isinstance(value, YLeaf):
                                                ...
                                                super(Ipv6Arm.Addresses.Vrfs.Vrf.Networks.Network.AddressXr.Address, self).__setattr__(name, value)
                                            else:
                                                self.__dict__[name].set(value)
                                        else:
                                            if hasattr(value, "parent") and name != "parent":
                        ...
                        if (child_yang_name == "network"):
                            for c in self.network:
                                ...
                                if (segment_path == segment):
                                    return c
                            c = Ipv6Arm.Addresses.Vrfs.Vrf.Networks.Network()
                            c.parent = self
                        ...
                        with _handle_type_error():
                            ...
                            if name in () and name in self.__dict__:
                                if isinstance(value, YLeaf):
                                    ...
                                    super(Ipv6Arm.Addresses.Vrfs.Vrf.Interfaces, self).__setattr__(name, value)
                                else:
                                    self.__dict__[name].set(value)
                            else:
                                if hasattr(value, "parent") and name != "parent":
                            ...
                            with _handle_type_error():
                                ...
                                if name in ("interface",
                                    ...
                                    if isinstance(value, YLeaf):
                                        ...
                                        super(Ipv6Arm.Addresses.Vrfs.Vrf.Interfaces.Interface, self).__setattr__(name, value)
                                    else:
                                        self.__dict__[name].set(value)
                                else:
                                    if hasattr(value, "parent") and name != "parent":
                                ...
                                with _handle_type_error():
                                    ...
                                    if name in ("is_prefix_sid",
                                        ...
                                        if isinstance(value, YLeaf):
                                            ...
                                            super(Ipv6Arm.Addresses.Vrfs.Vrf.Interfaces.Interface.Address, self).__setattr__(name, value)
                                        else:
                                            self.__dict__[name].set(value)
                                    else:
                                        if hasattr(value, "parent") and name != "parent":
                                    ...
                                    with _handle_type_error():
                                        ...
                                        if name in ("afi",
                                            ...
                                            if isinstance(value, YLeaf):
                                                ...
                                                super(Ipv6Arm.Addresses.Vrfs.Vrf.Interfaces.Interface.Address.Address, self).__setattr__(name, value)
                                            else:
                                                self.__dict__[name].set(value)
                                        else:
                                            if hasattr(value, "parent") and name != "parent":
                        ...
                        def get_child_by_name(self, child_yang_name, segment_path):
                            ...
                            if (child_yang_name == "address"):
                                for c in self.address:
                                    ...
                                    if (segment_path == segment):
                                        return c
                                c = Ipv6Arm.Addresses.Vrfs.Vrf.Interfaces.Interface.Address()
                                c.parent = self
                                local_reference_key = "ydk::seg::%s" % segment_path
                                self._local_refs[local_reference_key] = c
                    ...
                    def get_child_by_name(self, child_yang_name, segment_path):
                        ...
                        if (child_yang_name == "interface"):
                            for c in self.interface:
                                ...
                                if (segment_path == segment):
                                    return c
                            c = Ipv6Arm.Addresses.Vrfs.Vrf.Interfaces.Interface()
                            c.parent = self
                            local_reference_key = "ydk::seg::%s" % segment_path
                            self._local_refs[local_reference_key] = c
                ...
                def get_entity_path(self, ancestor):
                    path_buffer = ""
                    if (ancestor is None):
                        path_buffer = "Cisco-IOS-XR-ip-iarm-v6-oper:ipv6arm/addresses/vrfs/%s" % self.get_segment_path()
                    else:
                        path_buffer = _get_relative_entity_path(self, ancestor, path_buffer)
            ...
            def get_entity_path(self, ancestor):
                path_buffer = ""
                if (ancestor is None):
                    path_buffer = "Cisco-IOS-XR-ip-iarm-v6-oper:ipv6arm/addresses/%s" % self.get_segment_path()
                else:
                    path_buffer = _get_relative_entity_path(self, ancestor, path_buffer)
        ...
        def get_entity_path(self, ancestor):
            path_buffer = ""
            if (ancestor is None):
                path_buffer = "Cisco-IOS-XR-ip-iarm-v6-oper:ipv6arm/%s" % self.get_segment_path()
            else:
                path_buffer = _get_relative_entity_path(self, ancestor, path_buffer)
            ...
            with _handle_type_error():
                ...
                if name in ("address_conflict_count",
                    ...
                    if isinstance(value, YLeaf):
                        ...
                        super(Ipv6Arm.Summary, self).__setattr__(name, value)
                    else:
                        self.__dict__[name].set(value)
                else:
                    if hasattr(value, "parent") and name != "parent":
    ...
    class VrfSummaries(Entity):
            ...
            with _handle_type_error():
                ...
                if name in () and name in self.__dict__:
                    if isinstance(value, YLeaf):
                        ...
                        super(Ipv6Arm.VrfSummaries, self).__setattr__(name, value)
                    else:
                        self.__dict__[name].set(value)
                else:
                    if hasattr(value, "parent") and name != "parent":
        ...
        class VrfSummary(Entity):
                ...
                with _handle_type_error():
                    ...
                    if name in ("vrf_name",
                        ...
                        if isinstance(value, YLeaf):
                            ...
                            super(Ipv6Arm.VrfSummaries.VrfSummary, self).__setattr__(name, value)
                        else:
                            self.__dict__[name].set(value)
                    else:
                        if hasattr(value, "parent") and name != "parent":
            ...
            def get_entity_path(self, ancestor):
                path_buffer = ""
                if (ancestor is None):
                    path_buffer = "Cisco-IOS-XR-ip-iarm-v6-oper:ipv6arm/vrf-summaries/%s" % self.get_segment_path()
                else:
                    path_buffer = _get_relative_entity_path(self, ancestor, path_buffer)
        ...
        def get_child_by_name(self, child_yang_name, segment_path):
            ...
            if (child_yang_name == "vrf-summary"):
                for c in self.vrf_summary:
                    ...
                    if (segment_path == segment):
                        return c
                c = Ipv6Arm.VrfSummaries.VrfSummary()
                c.parent = self
                local_reference_key = "ydk::seg::%s" % segment_path
                self._local_refs[local_reference_key] = c
    ...
    def get_segment_path(self):
        path_buffer = ""
        path_buffer = "Cisco-IOS-XR-ip-iarm-v6-oper:ipv6arm" + path_buffer
    ...
    def has_leaf_or_child_of_name(self, name):
        if(name == "addresses" or name == "summary" or name == "vrf-summaries" or name == "multicast-host-interface"):
            return True
        return False
