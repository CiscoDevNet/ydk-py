...
_meta_table = {
    ...
    'GlobalAf.Afs.Af' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg'
        ),
    },
    'GlobalAf.Afs' : {
        'meta_info' : _MetaInfoClass('GlobalAf.Afs',
            False, 
            [
            _MetaInfoClassMember('af', REFERENCE_LIST, 'Af' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'GlobalAf.Afs.Af', 
                [], [], 
    ...
    'GlobalAf' : {
        'meta_info' : _MetaInfoClass('GlobalAf',
            False, 
            [
            _MetaInfoClassMember('afs', REFERENCE_CLASS, 'Afs' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'GlobalAf.Afs', 
                [], [], 
                '''                VRF address family configuration
                ''',
                'afs',
    ...
    'Srlg.Groups.Group.GroupValues' : {
        'meta_info' : _MetaInfoClass('Srlg.Groups.Group.GroupValues',
            False, 
            [
            _MetaInfoClassMember('group-value', REFERENCE_LIST, 'GroupValue' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Groups.Group.GroupValues.GroupValue', 
                [], [], 
    ...
    'Srlg.Groups' : {
        'meta_info' : _MetaInfoClass('Srlg.Groups',
            False, 
            [
            _MetaInfoClassMember('group', REFERENCE_LIST, 'Group' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Groups.Group', 
                [], [], 
    ...
    'Srlg.InheritNodes.InheritNode.InheritNodeValues' : {
        'meta_info' : _MetaInfoClass('Srlg.InheritNodes.InheritNode.InheritNodeValues',
            False, 
            [
            _MetaInfoClassMember('inherit-node-value', REFERENCE_LIST, 'InheritNodeValue' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.InheritNodes.InheritNode.InheritNodeValues.InheritNodeValue', 
                [], [], 
    ...
    'Srlg.InheritNodes' : {
        'meta_info' : _MetaInfoClass('Srlg.InheritNodes',
            False, 
            [
            _MetaInfoClassMember('inherit-node', REFERENCE_LIST, 'InheritNode' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.InheritNodes.InheritNode', 
                [], [], 
    ...
    'Srlg.Interfaces.Interface.InterfaceGroup.GroupNames' : {
        'meta_info' : _MetaInfoClass('Srlg.Interfaces.Interface.InterfaceGroup.GroupNames',
            False, 
            [
            _MetaInfoClassMember('group-name', REFERENCE_LIST, 'GroupName' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Interfaces.Interface.InterfaceGroup.GroupNames.GroupName', 
                [], [], 
    ...
    'Srlg.Interfaces.Interface.InterfaceSrlgNames' : {
        'meta_info' : _MetaInfoClass('Srlg.Interfaces.Interface.InterfaceSrlgNames',
            False, 
            [
            _MetaInfoClassMember('interface-srlg-name', REFERENCE_LIST, 'InterfaceSrlgName' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Interfaces.Interface.InterfaceSrlgNames.InterfaceSrlgName', 
                [], [], 
                '''                SRLG name data
                ''',
                'interface_srlg_name',
    ...
    'Srlg.Interfaces.Interface.Values' : {
        'meta_info' : _MetaInfoClass('Srlg.Interfaces.Interface.Values',
            False, 
            [
            _MetaInfoClassMember('value', REFERENCE_LIST, 'Value' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Interfaces.Interface.Values.Value', 
                [], [], 
                '''                SRLG value data
                ''',
                'value',
    ...
    'Srlg.Interfaces.Interface' : {
        'meta_info' : _MetaInfoClass('Srlg.Interfaces.Interface',
            ...
            _MetaInfoClassMember('include-optical', REFERENCE_CLASS, 'IncludeOptical' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Interfaces.Interface.IncludeOptical', 
                ...
                'include_optical',
                'Cisco-IOS-XR-infra-rsi-cfg', False),
            _MetaInfoClassMember('interface-group', REFERENCE_CLASS, 'InterfaceGroup' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Interfaces.Interface.InterfaceGroup', 
                [], [], 
    ...
    'Srlg.Interfaces' : {
        'meta_info' : _MetaInfoClass('Srlg.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Interfaces.Interface', 
                [], [], 
    ...
    'Srlg.SrlgNames' : {
        'meta_info' : _MetaInfoClass('Srlg.SrlgNames',
            False, 
            [
            _MetaInfoClassMember('srlg-name', REFERENCE_LIST, 'SrlgName' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.SrlgNames.SrlgName', 
                [], [], 
    ...
    'Srlg' : {
        'meta_info' : _MetaInfoClass('Srlg',
            ...
            _MetaInfoClassMember('groups', REFERENCE_CLASS, 'Groups' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.Groups', 
                ...
                'groups',
                'Cisco-IOS-XR-infra-rsi-cfg', False),
            _MetaInfoClassMember('inherit-nodes', REFERENCE_CLASS, 'InheritNodes' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Srlg.InheritNodes', 
                [], [], 
    ...
    'VrfGroups.VrfGroup.Vrfs' : {
        'meta_info' : _MetaInfoClass('VrfGroups.VrfGroup.Vrfs',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'VrfGroups.VrfGroup.Vrfs.Vrf', 
                [], [], 
                '''                VRF configuration
                ''',
                'vrf',
    ...
    'VrfGroups' : {
        'meta_info' : _MetaInfoClass('VrfGroups',
            False, 
            [
            _MetaInfoClassMember('vrf-group', REFERENCE_LIST, 'VrfGroup' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'VrfGroups.VrfGroup', 
                [], [], 
    ...
    'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets.RouteTarget' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets.RouteTarget',
            ...
            _MetaInfoClassMember('type', REFERENCE_ENUM_CLASS, 'BgpVrfRouteTarget_Enum' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_bgp_cfg', 'BgpVrfRouteTarget_Enum', 
                ...
                'type',
                'Cisco-IOS-XR-ipv4-bgp-cfg', True),
            _MetaInfoClassMember('as-or-four-byte-as', REFERENCE_LIST, 'AsOrFourByteAs' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets.RouteTarget.AsOrFourByteAs', 
                [], [], 
                '''                as or four byte as
                ''',
                'as_or_four_byte_as',
                'Cisco-IOS-XR-ipv4-bgp-cfg', False),
            _MetaInfoClassMember('ipv4-address', REFERENCE_LIST, 'Ipv4Address' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets.RouteTarget.Ipv4Address', 
                [], [], 
                '''                ipv4 address
                ''',
                'ipv4_address',
    ...
    'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets',
            False, 
            [
            _MetaInfoClassMember('route-target', REFERENCE_LIST, 'RouteTarget' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets.RouteTarget', 
                [], [], 
                '''                Route target
                ''',
                'route_target',
    ...
    'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets',
            False, 
            [
            _MetaInfoClassMember('route-targets', REFERENCE_CLASS, 'RouteTargets' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets.RouteTargets', 
                [], [], 
                '''                Route target table
                ''',
                'route_targets',
    ...
    'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets.RouteTarget' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets.RouteTarget',
            ...
            _MetaInfoClassMember('type', REFERENCE_ENUM_CLASS, 'BgpVrfRouteTarget_Enum' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_bgp_cfg', 'BgpVrfRouteTarget_Enum', 
                ...
                'type',
                'Cisco-IOS-XR-ipv4-bgp-cfg', True),
            _MetaInfoClassMember('as-or-four-byte-as', REFERENCE_LIST, 'AsOrFourByteAs' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets.RouteTarget.AsOrFourByteAs', 
                [], [], 
                '''                as or four byte as
                ''',
                'as_or_four_byte_as',
                'Cisco-IOS-XR-ipv4-bgp-cfg', False),
            _MetaInfoClassMember('ipv4-address', REFERENCE_LIST, 'Ipv4Address' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets.RouteTarget.Ipv4Address', 
                [], [], 
                '''                ipv4 address
                ''',
                'ipv4_address',
    ...
    'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets',
            False, 
            [
            _MetaInfoClassMember('route-target', REFERENCE_LIST, 'RouteTarget' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets.RouteTarget', 
                [], [], 
                '''                Route target
                ''',
                'route_target',
    ...
    'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets',
            False, 
            [
            _MetaInfoClassMember('route-targets', REFERENCE_CLASS, 'RouteTargets' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ImportRouteTargets.RouteTargets', 
                [], [], 
                '''                Route target table
                ''',
                'route_targets',
    ...
    'Vrfs.Vrf.Afs.Af.Bgp' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs.Af.Bgp',
            ...
            _MetaInfoClassMember('export-route-targets', REFERENCE_CLASS, 'ExportRouteTargets' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.ExportRouteTargets', 
                ...
                'Cisco-IOS-XR-ipv4-bgp-cfg', False),
            _MetaInfoClassMember('global-to-vrf-import-route-policy', REFERENCE_CLASS, 'GlobalToVrfImportRoutePolicy' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af.Bgp.GlobalToVrfImportRoutePolicy', 
                [], [], 
    ...
    'Vrfs.Vrf.Afs' : {
        'meta_info' : _MetaInfoClass('Vrfs.Vrf.Afs',
            False, 
            [
            _MetaInfoClassMember('af', REFERENCE_LIST, 'Af' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf.Afs.Af', 
                [], [], 
                '''                VRF address family configuration
                ''',
                'af',
    ...
    'Vrfs' : {
        'meta_info' : _MetaInfoClass('Vrfs',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg', 'Vrfs.Vrf', 
                [], [], 
                '''                VRF configuration
                ''',
                'vrf',
