...
_meta_table = {
    'Aaa.Usernames.Username.UsergroupUnderUsernames.UsergroupUnderUsername' : {
        ...
        'ydk.models.aaa.Cisco_IOS_XR_aaa_locald_admin_cfg'
        ),
    },
    'Aaa.Usernames.Username.UsergroupUnderUsernames' : {
        'meta_info' : _MetaInfoClass('Aaa.Usernames.Username.UsergroupUnderUsernames',
            False, 
            [
            _MetaInfoClassMember('usergroup-under-username', REFERENCE_LIST, 'UsergroupUnderUsername' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_locald_admin_cfg', 'Aaa.Usernames.Username.UsergroupUnderUsernames.UsergroupUnderUsername', 
                [], [], 
                '''                Name of the usergroup
                ''',
    ...
    'Aaa.Usernames' : {
        'meta_info' : _MetaInfoClass('Aaa.Usernames',
            False, 
            [
            _MetaInfoClassMember('username', REFERENCE_LIST, 'Username' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_locald_admin_cfg', 'Aaa.Usernames.Username', 
                [], [], 
                '''                Admin Username
                ''',
                'username',
    ...
    'Aaa' : {
        'meta_info' : _MetaInfoClass('Aaa',
            False, 
            [
            _MetaInfoClassMember('usernames', REFERENCE_CLASS, 'Usernames' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_locald_admin_cfg', 'Aaa.Usernames', 
                [], [], 
