...
_meta_table = {
    'MplsOam.ReplyMode.ControlChannel' : {
        ...
        'ydk.models.mpls.Cisco_IOS_XR_mpls_oam_cfg'
        ),
    },
    'MplsOam.ReplyMode' : {
        'meta_info' : _MetaInfoClass('MplsOam.ReplyMode',
            False, 
            [
            _MetaInfoClassMember('control-channel', REFERENCE_CLASS, 'ControlChannel' , 'ydk.models.mpls.Cisco_IOS_XR_mpls_oam_cfg', 'MplsOam.ReplyMode.ControlChannel', 
                [], [], 
