...
_meta_table = {
    'SystemMonitoring.CpuUtilization.ProcessCpu' : {
        ...
        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ha_eem_oper'
        ),
    },
    'SystemMonitoring.CpuUtilization' : {
        'meta_info' : _MetaInfoClass('SystemMonitoring.CpuUtilization',
            ...
            _MetaInfoClassMember('process-cpu', REFERENCE_LIST, 'ProcessCpu' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ha_eem_oper', 'SystemMonitoring.CpuUtilization.ProcessCpu', 
                [], [], 
    ...
    'SystemMonitoring' : {
        'meta_info' : _MetaInfoClass('SystemMonitoring',
            False, 
            [
            _MetaInfoClassMember('cpu-utilization', REFERENCE_LIST, 'CpuUtilization' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ha_eem_oper', 'SystemMonitoring.CpuUtilization', 
                [], [], 
