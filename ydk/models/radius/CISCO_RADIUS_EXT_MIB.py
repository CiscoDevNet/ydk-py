...
class CISCORADIUSEXTMIB(object):
    ...
    .. attribute:: creclientaccounting
    	...
    	**type**\: :py:class:`CreClientAccounting <ydk.models.radius.CISCO_RADIUS_EXT_MIB.CISCORADIUSEXTMIB.CreClientAccounting>`
    
    .. attribute:: creclientauthentication
    
    	
    	**type**\: :py:class:`CreClientAuthentication <ydk.models.radius.CISCO_RADIUS_EXT_MIB.CISCORADIUSEXTMIB.CreClientAuthentication>`
    
    .. attribute:: creclientglobal
    
    	
    	**type**\: :py:class:`CreClientGlobal <ydk.models.radius.CISCO_RADIUS_EXT_MIB.CISCORADIUSEXTMIB.CreClientGlobal>`
    
    

    """

    _prefix = 'cisco-radius'
    ...
    class CreClientAccounting(object):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.radius._meta import _CISCO_RADIUS_EXT_MIB as meta
    ...
    def _has_data(self):
        ...
        if self.creclientaccounting is not None and self.creclientaccounting.is_presence():
            return True

        if self.creclientauthentication is not None and self.creclientauthentication._has_data():
            return True

        if self.creclientauthentication is not None and self.creclientauthentication.is_presence():
            return True

        if self.creclientglobal is not None and self.creclientglobal._has_data():
            return True

        if self.creclientglobal is not None and self.creclientglobal.is_presence():
            return True
