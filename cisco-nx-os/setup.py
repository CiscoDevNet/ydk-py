...
NMSP_PKG_NAME = "ydk-models-cisco-nx-os"
NMSP_PKG_VERSION = "0.7.4"
NMSP_PKG_DEPENDENCIES = ['ydk-models-ietf>=0.1.5-post1']
...
DESCRIPTION = "YDK bundle for Cisco NX-OS models"
