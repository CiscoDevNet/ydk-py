...
_meta_table = {
    'RemovePrivateAsOptionEnum' : _MetaInfoEnum('RemovePrivateAsOptionEnum', 'ydk.models.openconfig.bgp_types',
        {
            'ALL':'ALL',
            'REPLACE':'REPLACE',
        }, 'bgp-types', _yang_ns._namespaces['bgp-types']),
    'CommunityTypeEnum' : _MetaInfoEnum('CommunityTypeEnum', 'ydk.models.openconfig.bgp_types',
        {
            'STANDARD':'STANDARD',
            'EXTENDED':'EXTENDED',
            'BOTH':'BOTH',
    ...
    'PeerTypeEnum' : _MetaInfoEnum('PeerTypeEnum', 'ydk.models.openconfig.bgp_types',
        {
            'INTERNAL':'INTERNAL',
            'EXTERNAL':'EXTERNAL',
        }, 'bgp-types', _yang_ns._namespaces['bgp-types']),
    'BgpSessionDirectionEnum' : _MetaInfoEnum('BgpSessionDirectionEnum', 'ydk.models.openconfig.bgp_types',
        {
            'INBOUND':'INBOUND',
            'OUTBOUND':'OUTBOUND',
        }, 'bgp-types', _yang_ns._namespaces['bgp-types']),
    'BgpOriginAttrTypeEnum' : _MetaInfoEnum('BgpOriginAttrTypeEnum', 'ydk.models.openconfig.bgp_types',
        {
            'IGP':'IGP',
            'EGP':'EGP',
    ...
    'AfiSafiTypeIdentity' : {
        ...
        'ydk.models.openconfig.bgp_types'
        ),
    },
