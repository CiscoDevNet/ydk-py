...
class CISCOIMAGELICENSEMGMTMIB(object):
    ...
    .. attribute:: cilmbootimageleveltable
    	...
    	**type**\: :py:class:`CilmBootImageLevelTable <ydk.models.image.CISCO_IMAGE_LICENSE_MGMT_MIB.CISCOIMAGELICENSEMGMTMIB.CilmBootImageLevelTable>`
    ...
    .. attribute:: cilmimageleveltolicensemaptable
    	...
    	**type**\: :py:class:`CilmImageLevelToLicenseMapTable <ydk.models.image.CISCO_IMAGE_LICENSE_MGMT_MIB.CISCOIMAGELICENSEMGMTMIB.CilmImageLevelToLicenseMapTable>`
    
    .. attribute:: cilmnotifcntl
    
    	
    	**type**\: :py:class:`CilmNotifCntl <ydk.models.image.CISCO_IMAGE_LICENSE_MGMT_MIB.CISCOIMAGELICENSEMGMTMIB.CilmNotifCntl>`
    
    .. attribute:: ciscoimagelicensemgmtmibobjects
    
    	
    	**type**\: :py:class:`CiscoImageLicenseMgmtMIBObjects <ydk.models.image.CISCO_IMAGE_LICENSE_MGMT_MIB.CISCOIMAGELICENSEMGMTMIB.CiscoImageLicenseMgmtMIBObjects>`
    ...
    class CilmBootImageLevelTable(object):
        ...
        .. attribute:: cilmbootimagelevelentry
        	...
        	**type**\: list of :py:class:`CilmBootImageLevelEntry <ydk.models.image.CISCO_IMAGE_LICENSE_MGMT_MIB.CISCOIMAGELICENSEMGMTMIB.CilmBootImageLevelTable.CilmBootImageLevelEntry>`
        ...
        class CilmBootImageLevelEntry(object):
            ...
            def _common_path(self):
                if self.cilmmodulename is None:
                    raise YPYDataValidationError('Key property cilmmodulename is None')
                if self.entphysicalindex is None:
                    raise YPYDataValidationError('Key property entphysicalindex is None')

                return '/CISCO-IMAGE-LICENSE-MGMT-MIB:CISCO-IMAGE-LICENSE-MGMT-MIB/CISCO-IMAGE-LICENSE-MGMT-MIB:cilmBootImageLevelTable/CISCO-IMAGE-LICENSE-MGMT-MIB:cilmBootImageLevelEntry[CISCO-IMAGE-LICENSE-MGMT-MIB:cilmModuleName = ' + str(self.cilmmodulename) + '][CISCO-IMAGE-LICENSE-MGMT-MIB:entPhysicalIndex = ' + str(self.entphysicalindex) + ']'
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.image._meta import _CISCO_IMAGE_LICENSE_MGMT_MIB as meta
    ...
    class CilmImageLevelToLicenseMapTable(object):
        ...
        .. attribute:: cilmimageleveltolicensemapentry
        	...
        	**type**\: list of :py:class:`CilmImageLevelToLicenseMapEntry <ydk.models.image.CISCO_IMAGE_LICENSE_MGMT_MIB.CISCOIMAGELICENSEMGMTMIB.CilmImageLevelToLicenseMapTable.CilmImageLevelToLicenseMapEntry>`
        ...
        class CilmImageLevelToLicenseMapEntry(object):
            ...
            .. attribute:: cilmimagelicensemapindex
            ...
            def _common_path(self):
                if self.cilmimagelicensemapindex is None:
                    raise YPYDataValidationError('Key property cilmimagelicensemapindex is None')
                if self.cilmmodulename is None:
                    raise YPYDataValidationError('Key property cilmmodulename is None')
                if self.entphysicalindex is None:
                    raise YPYDataValidationError('Key property entphysicalindex is None')

                return '/CISCO-IMAGE-LICENSE-MGMT-MIB:CISCO-IMAGE-LICENSE-MGMT-MIB/CISCO-IMAGE-LICENSE-MGMT-MIB:cilmImageLevelToLicenseMapTable/CISCO-IMAGE-LICENSE-MGMT-MIB:cilmImageLevelToLicenseMapEntry[CISCO-IMAGE-LICENSE-MGMT-MIB:cilmImageLicenseMapIndex = ' + str(self.cilmimagelicensemapindex) + '][CISCO-IMAGE-LICENSE-MGMT-MIB:cilmModuleName = ' + str(self.cilmmodulename) + '][CISCO-IMAGE-LICENSE-MGMT-MIB:entPhysicalIndex = ' + str(self.entphysicalindex) + ']'
    ...
    def _has_data(self):
        ...
        if self.cilmbootimageleveltable is not None and self.cilmbootimageleveltable.is_presence():
            return True

        if self.cilmimageleveltolicensemaptable is not None and self.cilmimageleveltolicensemaptable._has_data():
            return True

        if self.cilmimageleveltolicensemaptable is not None and self.cilmimageleveltolicensemaptable.is_presence():
            return True

        if self.cilmnotifcntl is not None and self.cilmnotifcntl._has_data():
            return True

        if self.cilmnotifcntl is not None and self.cilmnotifcntl.is_presence():
            return True

        if self.ciscoimagelicensemgmtmibobjects is not None and self.ciscoimagelicensemgmtmibobjects._has_data():
            return True

        if self.ciscoimagelicensemgmtmibobjects is not None and self.ciscoimagelicensemgmtmibobjects.is_presence():
            return True
