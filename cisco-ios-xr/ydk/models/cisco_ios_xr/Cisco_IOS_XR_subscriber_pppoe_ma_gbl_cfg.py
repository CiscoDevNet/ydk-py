...
class PppoeCfg(Entity):
    ...
    def __setattr__(self, name, value):
        self._perform_setattr(PppoeCfg, ['in_flight_window', 'session_id_space_flat'], name, value)
    ...
    class PppoeBbaGroups(Entity):
        ...
        class PppoeBbaGroup(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"control-packets" : ("control_packets", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.ControlPackets), "pa-do-delay" : ("pa_do_delay", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay), "sessions" : ("sessions", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions), "tag" : ("tag", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag)}
                self._child_list_classes = {}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup, ['bba_group', 'completion_timeout', 'enable_padt_after_shut_down', 'invalid_session_id', 'mtu'], name, value)
            ...
            class PaDoDelay(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"circuit-id-strings" : ("circuit_id_strings", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay.CircuitIdStrings), "circuit-id-substrings" : ("circuit_id_substrings", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay.CircuitIdSubstrings), "remote-id-strings" : ("remote_id_strings", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay.RemoteIdStrings), "remote-id-substrings" : ("remote_id_substrings", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay.RemoteIdSubstrings), "service-name-strings" : ("service_name_strings", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay.ServiceNameStrings), "service-name-substrings" : ("service_name_substrings", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay.ServiceNameSubstrings)}
                    self._child_list_classes = {}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.PaDoDelay, ['circuit_id', 'default', 'remote_id'], name, value)
            ...
            class Sessions(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"access-interface-limit" : ("access_interface_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.AccessInterfaceLimit), "circuit-id-and-remote-id-limit" : ("circuit_id_and_remote_id_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.CircuitIdAndRemoteIdLimit), "circuit-id-and-remote-id-throttle" : ("circuit_id_and_remote_id_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.CircuitIdAndRemoteIdThrottle), "circuit-id-limit" : ("circuit_id_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.CircuitIdLimit), "circuit-id-throttle" : ("circuit_id_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.CircuitIdThrottle), "inner-vlan-limit" : ("inner_vlan_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.InnerVlanLimit), "inner-vlan-throttle" : ("inner_vlan_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.InnerVlanThrottle), "mac-access-interface-limit" : ("mac_access_interface_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacAccessInterfaceLimit), "mac-access-interface-throttle" : ("mac_access_interface_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacAccessInterfaceThrottle), "mac-iwf-access-interface-limit" : ("mac_iwf_access_interface_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacIwfAccessInterfaceLimit), "mac-iwf-access-interface-throttle" : ("mac_iwf_access_interface_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacIwfAccessInterfaceThrottle), "mac-iwf-limit" : ("mac_iwf_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacIwfLimit), "mac-limit" : ("mac_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacLimit), "mac-throttle" : ("mac_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacThrottle), "max-limit" : ("max_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MaxLimit), "outer-vlan-limit" : ("outer_vlan_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.OuterVlanLimit), "outer-vlan-throttle" : ("outer_vlan_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.OuterVlanThrottle), "remote-id-limit" : ("remote_id_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.RemoteIdLimit), "remote-id-throttle" : ("remote_id_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.RemoteIdThrottle), "vlan-limit" : ("vlan_limit", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.VlanLimit), "vlan-throttle" : ("vlan_throttle", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.VlanThrottle)}
                    self._child_list_classes = {}
                ...
                class CircuitIdAndRemoteIdThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.CircuitIdAndRemoteIdThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class CircuitIdThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.CircuitIdThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class InnerVlanThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.InnerVlanThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class MacAccessInterfaceThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacAccessInterfaceThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class MacIwfAccessInterfaceThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacIwfAccessInterfaceThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class MacThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.MacThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class OuterVlanThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.OuterVlanThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class RemoteIdThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.RemoteIdThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
                ...
                class VlanThrottle(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Sessions.VlanThrottle, ['blocking_period', 'request_period', 'throttle'], name, value)
            ...
            class Tag(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"padr" : ("padr", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag.Padr), "ppp-max-payload" : ("ppp_max_payload", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag.PppMaxPayload), "service-name-configureds" : ("service_name_configureds", PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag.ServiceNameConfigureds)}
                    self._child_list_classes = {}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag, ['ac_name', 'ppp_max_payload_deny', 'service_selection_disable'], name, value)
                ...
                class Padr(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag.Padr, ['invalid_payload_allow', 'session_unique_relay_session_id'], name, value)
                ...
                class PppMaxPayload(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(PppoeCfg.PppoeBbaGroups.PppoeBbaGroup.Tag.PppMaxPayload, ['max', 'min'], name, value)
