        ...
        class QueryResult(Entity):
            ...
            class Result(Entity):
                ...
                class Select(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(FetchQueryResult.Output.QueryResult.Result.Select, ['data', 'label', 'path', 'value'], name, value)
...
class ResetQuery(Entity):
    ...
    class Input(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(ResetQuery.Input, ['offset', 'query_handle'], name, value)
...
class StartQuery(Entity):
    ...
    class Input(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(StartQuery.Input, ['foreach', 'limit', 'offset', 'sort_by'], name, value)
        ...
        class Select(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(StartQuery.Input.Select, ['expression', 'label', 'result_type'], name, value)
