...
_meta_table = {
    'HsrpState_Enum' : _MetaInfoEnum('HsrpState_Enum', 'ydk.models.hsrp.CISCO_HSRP_MIB',
        {
            'initial':'INITIAL',
            'learn':'LEARN',
            'listen':'LISTEN',
    ...
    'CISCOHSRPMIB.CHsrpGlobalConfig' : {
        ...
        'ydk.models.hsrp.CISCO_HSRP_MIB'
        ),
    },
    'CISCOHSRPMIB.CHsrpGrpTable.CHsrpGrpEntry' : {
        'meta_info' : _MetaInfoClass('CISCOHSRPMIB.CHsrpGrpTable.CHsrpGrpEntry',
            ...
            _MetaInfoClassMember('cHsrpGrpConfiguredHoldTime', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-HSRP-MIB', False),
            _MetaInfoClassMember('cHsrpGrpEntryRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cHsrpGrpStandbyRouter', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-HSRP-MIB', False),
            _MetaInfoClassMember('cHsrpGrpStandbyState', REFERENCE_ENUM_CLASS, 'HsrpState_Enum' , 'ydk.models.hsrp.CISCO_HSRP_MIB', 'HsrpState_Enum', 
                [], [], 
    ...
    'CISCOHSRPMIB.CHsrpGrpTable' : {
        'meta_info' : _MetaInfoClass('CISCOHSRPMIB.CHsrpGrpTable',
            False, 
            [
            _MetaInfoClassMember('cHsrpGrpEntry', REFERENCE_LIST, 'CHsrpGrpEntry' , 'ydk.models.hsrp.CISCO_HSRP_MIB', 'CISCOHSRPMIB.CHsrpGrpTable.CHsrpGrpEntry', 
                [], [], 
    ...
    'CISCOHSRPMIB' : {
        'meta_info' : _MetaInfoClass('CISCOHSRPMIB',
            False, 
            [
            _MetaInfoClassMember('cHsrpGlobalConfig', REFERENCE_CLASS, 'CHsrpGlobalConfig' , 'ydk.models.hsrp.CISCO_HSRP_MIB', 'CISCOHSRPMIB.CHsrpGlobalConfig', 
                [], [], 
                '''                ''',
                'chsrpglobalconfig',
                'CISCO-HSRP-MIB', False),
            _MetaInfoClassMember('cHsrpGrpTable', REFERENCE_CLASS, 'CHsrpGrpTable' , 'ydk.models.hsrp.CISCO_HSRP_MIB', 'CISCOHSRPMIB.CHsrpGrpTable', 
                [], [], 
