...
class MPLSLSRSTDMIB(object):
    ...
    .. attribute:: mplsinsegmentmaptable
    	...
    	**type**\: :py:class:`MplsInSegmentMapTable <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInSegmentMapTable>`
    ...
    .. attribute:: mplsinsegmenttable
    	...
    	**type**\: :py:class:`MplsInSegmentTable <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInSegmentTable>`
    
    .. attribute:: mplsinterfacetable
    
    	This table specifies per\-interface MPLS capability and associated information
    	**type**\: :py:class:`MplsInterfaceTable <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInterfaceTable>`
    ...
    .. attribute:: mplslabelstacktable
    	...
    	**type**\: :py:class:`MplsLabelStackTable <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsLabelStackTable>`
    
    .. attribute:: mplslsrobjects
    
    	
    	**type**\: :py:class:`MplsLsrObjects <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsLsrObjects>`
    
    .. attribute:: mplsoutsegmenttable
    
    	This table contains a representation of the outgoing segments from an LSR
    	**type**\: :py:class:`MplsOutSegmentTable <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsOutSegmentTable>`
    ...
    .. attribute:: mplsxctable
    	...
    	**type**\: :py:class:`MplsXCTable <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsXCTable>`
    ...
    class MplsInSegmentMapTable(object):
        ...
        .. attribute:: mplsinsegmentmapentry
        	...
        	**type**\: list of :py:class:`MplsInSegmentMapEntry <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInSegmentMapTable.MplsInSegmentMapEntry>`
        ...
        class MplsInSegmentMapEntry(object):
            ...
            .. attribute:: mplsinsegmentmapinterface
            ...
            .. attribute:: mplsinsegmentmaplabel
            ...
            .. attribute:: mplsinsegmentmaplabelptrindex
            ...
            def _common_path(self):
                if self.mplsinsegmentmapinterface is None:
                    raise YPYDataValidationError('Key property mplsinsegmentmapinterface is None')
                if self.mplsinsegmentmaplabel is None:
                    raise YPYDataValidationError('Key property mplsinsegmentmaplabel is None')
                if self.mplsinsegmentmaplabelptrindex is None:
                    raise YPYDataValidationError('Key property mplsinsegmentmaplabelptrindex is None')
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.mpls._meta import _MPLS_LSR_STD_MIB as meta
    ...
    class MplsInSegmentTable(object):
        ...
        .. attribute:: mplsinsegmententry
        	...
        	**type**\: list of :py:class:`MplsInSegmentEntry <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInSegmentTable.MplsInSegmentEntry>`
        ...
        class MplsInSegmentEntry(object):
            ...
            def _common_path(self):
                if self.mplsinsegmentindex is None:
                    raise YPYDataValidationError('Key property mplsinsegmentindex is None')
    ...
    class MplsInterfaceTable(object):
        ...
        .. attribute:: mplsinterfaceentry
        	...
        	**type**\: list of :py:class:`MplsInterfaceEntry <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInterfaceTable.MplsInterfaceEntry>`
        ...
        class MplsInterfaceEntry(object):
            ...
            .. attribute:: mplsinterfacelabelparticipationtype
            	...
            	**type**\: :py:class:`MplsInterfaceLabelParticipationType_Bits <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsInterfaceTable.MplsInterfaceEntry.MplsInterfaceLabelParticipationType_Bits>`
            ...
            def __init__(self):
                ...
                self.mplsinterfacelabelparticipationtype = MPLSLSRSTDMIB.MplsInterfaceTable.MplsInterfaceEntry.MplsInterfaceLabelParticipationType_Bits()
            ...
            class MplsInterfaceLabelParticipationType_Bits(FixedBitsDict):
                """
                MplsInterfaceLabelParticipationType_Bits
            ...
            def _common_path(self):
                if self.mplsinterfaceindex is None:
                    raise YPYDataValidationError('Key property mplsinterfaceindex is None')
    ...
    class MplsLabelStackTable(object):
        ...
        .. attribute:: mplslabelstackentry
        	...
        	**type**\: list of :py:class:`MplsLabelStackEntry <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsLabelStackTable.MplsLabelStackEntry>`
        ...
        class MplsLabelStackEntry(object):
            ...
            .. attribute:: mplslabelstacklabelindex
            ...
            def _common_path(self):
                if self.mplslabelstackindex is None:
                    raise YPYDataValidationError('Key property mplslabelstackindex is None')
                if self.mplslabelstacklabelindex is None:
                    raise YPYDataValidationError('Key property mplslabelstacklabelindex is None')
    ...
    class MplsOutSegmentTable(object):
        ...
        .. attribute:: mplsoutsegmententry
        	...
        	**type**\: list of :py:class:`MplsOutSegmentEntry <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsOutSegmentTable.MplsOutSegmentEntry>`
        ...
        class MplsOutSegmentEntry(object):
            ...
            def _common_path(self):
                if self.mplsoutsegmentindex is None:
                    raise YPYDataValidationError('Key property mplsoutsegmentindex is None')
    ...
    class MplsXCTable(object):
        ...
        .. attribute:: mplsxcentry
        	...
        	**type**\: list of :py:class:`MplsXCEntry <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsXCTable.MplsXCEntry>`
        ...
        class MplsXCEntry(object):
            ...
            .. attribute:: mplsxcadminstatus
            	...
            	**type**\: :py:class:`MplsXCAdminStatus_Enum <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsXCTable.MplsXCEntry.MplsXCAdminStatus_Enum>`
            ...
            .. attribute:: mplsxcoperstatus
            	...
            	**type**\: :py:class:`MplsXCOperStatus_Enum <ydk.models.mpls.MPLS_LSR_STD_MIB.MPLSLSRSTDMIB.MplsXCTable.MplsXCEntry.MplsXCOperStatus_Enum>`
            ...
            class MplsXCAdminStatus_Enum(Enum):
                """
                MplsXCAdminStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.mpls._meta import _MPLS_LSR_STD_MIB as meta
                    return meta._meta_table['MPLSLSRSTDMIB.MplsXCTable.MplsXCEntry.MplsXCAdminStatus_Enum']


            class MplsXCOperStatus_Enum(Enum):
                """
                MplsXCOperStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.mpls._meta import _MPLS_LSR_STD_MIB as meta
                    return meta._meta_table['MPLSLSRSTDMIB.MplsXCTable.MplsXCEntry.MplsXCOperStatus_Enum']
    ...
    def _has_data(self):
        ...
        if self.mplsinsegmentmaptable is not None and self.mplsinsegmentmaptable.is_presence():
            return True

        if self.mplsinsegmenttable is not None and self.mplsinsegmenttable._has_data():
            return True

        if self.mplsinsegmenttable is not None and self.mplsinsegmenttable.is_presence():
            return True

        if self.mplsinterfacetable is not None and self.mplsinterfacetable._has_data():
            return True

        if self.mplsinterfacetable is not None and self.mplsinterfacetable.is_presence():
            return True

        if self.mplslabelstacktable is not None and self.mplslabelstacktable._has_data():
            return True

        if self.mplslabelstacktable is not None and self.mplslabelstacktable.is_presence():
            return True

        if self.mplslsrobjects is not None and self.mplslsrobjects._has_data():
            return True

        if self.mplslsrobjects is not None and self.mplslsrobjects.is_presence():
            return True

        if self.mplsoutsegmenttable is not None and self.mplsoutsegmenttable._has_data():
            return True

        if self.mplsoutsegmenttable is not None and self.mplsoutsegmenttable.is_presence():
            return True

        if self.mplsxctable is not None and self.mplsxctable._has_data():
            return True

        if self.mplsxctable is not None and self.mplsxctable.is_presence():
            return True
