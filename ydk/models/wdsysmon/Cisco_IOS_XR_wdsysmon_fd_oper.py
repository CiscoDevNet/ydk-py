...
class SystemMonitoring(object):
    ...
    .. attribute:: cpu_utilization
    	...
    	**type**\: list of :py:class:`CpuUtilization <ydk.models.wdsysmon.Cisco_IOS_XR_wdsysmon_fd_oper.SystemMonitoring.CpuUtilization>`
    ...
    class CpuUtilization(object):
        ...
        .. attribute:: process_cpu
        	...
        	**type**\: list of :py:class:`ProcessCpu <ydk.models.wdsysmon.Cisco_IOS_XR_wdsysmon_fd_oper.SystemMonitoring.CpuUtilization.ProcessCpu>`
        ...
        class ProcessCpu(object):
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.wdsysmon._meta import _Cisco_IOS_XR_wdsysmon_fd_oper as meta
