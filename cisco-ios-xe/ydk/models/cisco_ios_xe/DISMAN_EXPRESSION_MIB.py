...
class DISMANEXPRESSIONMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"expErrorTable" : ("experrortable", DISMANEXPRESSIONMIB.Experrortable), "expExpressionTable" : ("expexpressiontable", DISMANEXPRESSIONMIB.Expexpressiontable), "expObjectTable" : ("expobjecttable", DISMANEXPRESSIONMIB.Expobjecttable), "expResource" : ("expresource", DISMANEXPRESSIONMIB.Expresource), "expValueTable" : ("expvaluetable", DISMANEXPRESSIONMIB.Expvaluetable)}
    ...
    class Experrortable(Entity):
        ...
        class Experrorentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(DISMANEXPRESSIONMIB.Experrortable.Experrorentry, ['expexpressionowner', 'expexpressionname', 'experrorcode', 'experrorindex', 'experrorinstance', 'experrortime'], name, value)
    ...
    class Expexpressiontable(Entity):
        ...
        class Expexpressionentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(DISMANEXPRESSIONMIB.Expexpressiontable.Expexpressionentry, ['expexpressionowner', 'expexpressionname', 'expexpression', 'expexpressioncomment', 'expexpressiondeltainterval', 'expexpressionentrystatus', 'expexpressionerrors', 'expexpressionprefix', 'expexpressionvaluetype'], name, value)
    ...
    class Expobjecttable(Entity):
        ...
        class Expobjectentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(DISMANEXPRESSIONMIB.Expobjecttable.Expobjectentry, ['expexpressionowner', 'expexpressionname', 'expobjectindex', 'expobjectconditional', 'expobjectconditionalwildcard', 'expobjectdeltadiscontinuityid', 'expobjectdiscontinuityidtype', 'expobjectdiscontinuityidwildcard', 'expobjectentrystatus', 'expobjectid', 'expobjectidwildcard', 'expobjectsampletype'], name, value)
    ...
    class Expresource(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(DISMANEXPRESSIONMIB.Expresource, ['expresourcedeltaminimum', 'expresourcedeltawildcardinstancemaximum', 'expresourcedeltawildcardinstanceresourcelacks', 'expresourcedeltawildcardinstances', 'expresourcedeltawildcardinstanceshigh'], name, value)
    ...
    class Expvaluetable(Entity):
        ...
        class Expvalueentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(DISMANEXPRESSIONMIB.Expvaluetable.Expvalueentry, ['expexpressionowner', 'expexpressionname', 'expvalueinstance', 'expvaluecounter32val', 'expvaluecounter64val', 'expvalueinteger32val', 'expvalueipaddressval', 'expvalueoctetstringval', 'expvalueoidval', 'expvaluetimeticksval', 'expvalueunsigned32val'], name, value)
