...
class BRIDGEMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"dot1dBase" : ("dot1dbase", BRIDGEMIB.Dot1Dbase), "dot1dBasePortTable" : ("dot1dbaseporttable", BRIDGEMIB.Dot1Dbaseporttable), "dot1dStaticTable" : ("dot1dstatictable", BRIDGEMIB.Dot1Dstatictable), "dot1dStp" : ("dot1dstp", BRIDGEMIB.Dot1Dstp), "dot1dStpPortTable" : ("dot1dstpporttable", BRIDGEMIB.Dot1Dstpporttable), "dot1dTp" : ("dot1dtp", BRIDGEMIB.Dot1Dtp), "dot1dTpFdbTable" : ("dot1dtpfdbtable", BRIDGEMIB.Dot1Dtpfdbtable), "dot1dTpPortTable" : ("dot1dtpporttable", BRIDGEMIB.Dot1Dtpporttable)}
    ...
    class Dot1Dbaseporttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1dBasePortEntry" : ("dot1dbaseportentry", BRIDGEMIB.Dot1Dbaseporttable.Dot1Dbaseportentry)}
        ...
        class Dot1Dbaseportentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1dBasePortEntry" + "[dot1dBasePort='" + self.dot1dbaseport.get() + "']"
                self._absolute_path = lambda: "BRIDGE-MIB:BRIDGE-MIB/dot1dBasePortTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(BRIDGEMIB.Dot1Dbaseporttable.Dot1Dbaseportentry, ['dot1dbaseport', 'dot1dbaseportcircuit', 'dot1dbaseportdelayexceededdiscards', 'dot1dbaseportifindex', 'dot1dbaseportmtuexceededdiscards', 'dot1dportcapabilities', 'dot1dportdefaultuserpriority', 'dot1dportgarpjointime', 'dot1dportgarpleavealltime', 'dot1dportgarpleavetime', 'dot1dportgmrpfailedregistrations', 'dot1dportgmrplastpduorigin', 'dot1dportgmrpstatus', 'dot1dportnumtrafficclasses', 'dot1dportrestrictedgroupregistration', 'dot1qportacceptableframetypes', 'dot1qportgvrpfailedregistrations', 'dot1qportgvrplastpduorigin', 'dot1qportgvrpstatus', 'dot1qportingressfiltering', 'dot1qportrestrictedvlanregistration', 'dot1qpvid'], name, value)
    ...
    class Dot1Dstatictable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1dStaticEntry" : ("dot1dstaticentry", BRIDGEMIB.Dot1Dstatictable.Dot1Dstaticentry)}
        ...
        class Dot1Dstaticentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1dStaticEntry" + "[dot1dStaticAddress='" + self.dot1dstaticaddress.get() + "']" + "[dot1dStaticReceivePort='" + self.dot1dstaticreceiveport.get() + "']"
    ...
    class Dot1Dstp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(BRIDGEMIB.Dot1Dstp, ['dot1dstpbridgeforwarddelay', 'dot1dstpbridgehellotime', 'dot1dstpbridgemaxage', 'dot1dstpdesignatedroot', 'dot1dstpforwarddelay', 'dot1dstphellotime', 'dot1dstpholdtime', 'dot1dstpmaxage', 'dot1dstppriority', 'dot1dstpprotocolspecification', 'dot1dstprootcost', 'dot1dstprootport', 'dot1dstptimesincetopologychange', 'dot1dstptopchanges'], name, value)
    ...
    class Dot1Dstpporttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1dStpPortEntry" : ("dot1dstpportentry", BRIDGEMIB.Dot1Dstpporttable.Dot1Dstpportentry)}
        ...
        class Dot1Dstpportentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1dStpPortEntry" + "[dot1dStpPort='" + self.dot1dstpport.get() + "']"
                self._absolute_path = lambda: "BRIDGE-MIB:BRIDGE-MIB/dot1dStpPortTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(BRIDGEMIB.Dot1Dstpporttable.Dot1Dstpportentry, ['dot1dstpport', 'dot1dstpportdesignatedbridge', 'dot1dstpportdesignatedcost', 'dot1dstpportdesignatedport', 'dot1dstpportdesignatedroot', 'dot1dstpportenable', 'dot1dstpportforwardtransitions', 'dot1dstpportpathcost', 'dot1dstpportpathcost32', 'dot1dstpportpriority', 'dot1dstpportstate', 'stpxlongstpportpathcost'], name, value)
    ...
    class Dot1Dtp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(BRIDGEMIB.Dot1Dtp, ['dot1dtpagingtime', 'dot1dtplearnedentrydiscards'], name, value)
    ...
    class Dot1Dtpfdbtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1dTpFdbEntry" : ("dot1dtpfdbentry", BRIDGEMIB.Dot1Dtpfdbtable.Dot1Dtpfdbentry)}
        ...
        class Dot1Dtpfdbentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1dTpFdbEntry" + "[dot1dTpFdbAddress='" + self.dot1dtpfdbaddress.get() + "']"
    ...
    class Dot1Dtpporttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1dTpPortEntry" : ("dot1dtpportentry", BRIDGEMIB.Dot1Dtpporttable.Dot1Dtpportentry)}
        ...
        class Dot1Dtpportentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1dTpPortEntry" + "[dot1dTpPort='" + self.dot1dtpport.get() + "']"
                self._absolute_path = lambda: "BRIDGE-MIB:BRIDGE-MIB/dot1dTpPortTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(BRIDGEMIB.Dot1Dtpporttable.Dot1Dtpportentry, ['dot1dtpport', 'dot1dtpportindiscards', 'dot1dtpportinframes', 'dot1dtpportmaxinfo', 'dot1dtpportoutframes'], name, value)
