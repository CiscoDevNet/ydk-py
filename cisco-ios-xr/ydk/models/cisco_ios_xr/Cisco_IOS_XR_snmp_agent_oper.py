...
class Snmp(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"correlator" : ("correlator", Snmp.Correlator), "entity-mib" : ("entity_mib", Snmp.EntityMib), "if-indexes" : ("if_indexes", Snmp.IfIndexes), "information" : ("information", Snmp.Information), "interface-indexes" : ("interface_indexes", Snmp.InterfaceIndexes), "interface-mib" : ("interface_mib", Snmp.InterfaceMib), "interfaces" : ("interfaces", Snmp.Interfaces), "sensor-mib" : ("sensor_mib", Snmp.SensorMib), "trap-servers" : ("trap_servers", Snmp.TrapServers)}
    ...
    class Correlator(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"buffer-status" : ("buffer_status", Snmp.Correlator.BufferStatus), "rule-details" : ("rule_details", Snmp.Correlator.RuleDetails), "rule-set-details" : ("rule_set_details", Snmp.Correlator.RuleSetDetails), "traps" : ("traps", Snmp.Correlator.Traps)}
            self._child_list_classes = {}
        ...
        class BufferStatus(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.Correlator.BufferStatus, ['configured_size', 'current_size'], name, value)
        ...
        class RuleDetails(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"rule-detail" : ("rule_detail", Snmp.Correlator.RuleDetails.RuleDetail)}
            ...
            class RuleDetail(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"root-cause" : ("root_cause", Snmp.Correlator.RuleDetails.RuleDetail.RootCause), "rule-summary" : ("rule_summary", Snmp.Correlator.RuleDetails.RuleDetail.RuleSummary)}
                    self._child_list_classes = {"apply-host" : ("apply_host", Snmp.Correlator.RuleDetails.RuleDetail.ApplyHost), "non-rootcaus" : ("non_rootcaus", Snmp.Correlator.RuleDetails.RuleDetail.NonRootcaus)}
                ...
                class NonRootcaus(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"var-bind" : ("var_bind", Snmp.Correlator.RuleDetails.RuleDetail.NonRootcaus.VarBind)}
                    ...
                    class VarBind(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(Snmp.Correlator.RuleDetails.RuleDetail.NonRootcaus.VarBind, ['match_type', 'oid', 'reg_exp'], name, value)
                ...
                class RootCause(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"var-bind" : ("var_bind", Snmp.Correlator.RuleDetails.RuleDetail.RootCause.VarBind)}
                    ...
                    class VarBind(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(Snmp.Correlator.RuleDetails.RuleDetail.RootCause.VarBind, ['match_type', 'oid', 'reg_exp'], name, value)
                ...
                class RuleSummary(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Correlator.RuleDetails.RuleDetail.RuleSummary, ['buffered_traps_count', 'rule_name', 'rule_state'], name, value)
        ...
        class RuleSetDetails(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"rule-set-detail" : ("rule_set_detail", Snmp.Correlator.RuleSetDetails.RuleSetDetail)}
            ...
            class RuleSetDetail(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"rules" : ("rules", Snmp.Correlator.RuleSetDetails.RuleSetDetail.Rules)}
                ...
                class Rules(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Correlator.RuleSetDetails.RuleSetDetail.Rules, ['buffered_traps_count', 'rule_name', 'rule_state'], name, value)
        ...
        class Traps(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"trap" : ("trap", Snmp.Correlator.Traps.Trap)}
            ...
            class Trap(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"trap-info" : ("trap_info", Snmp.Correlator.Traps.Trap.TrapInfo)}
                    self._child_list_classes = {}
                    ...
                    self._segment_path = lambda: "trap" + "[entry-id='" + self.entry_id.get() + "']"
                ...
                class TrapInfo(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"var-bind" : ("var_bind", Snmp.Correlator.Traps.Trap.TrapInfo.VarBind)}
    ...
    class EntityMib(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"entity-physical-indexes" : ("entity_physical_indexes", Snmp.EntityMib.EntityPhysicalIndexes)}
            self._child_list_classes = {}
        ...
        class EntityPhysicalIndexes(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"entity-physical-index" : ("entity_physical_index", Snmp.EntityMib.EntityPhysicalIndexes.EntityPhysicalIndex)}
            ...
            class EntityPhysicalIndex(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "entity-physical-index" + "[entity-phynum='" + self.entity_phynum.get() + "']"
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.EntityMib.EntityPhysicalIndexes.EntityPhysicalIndex, ['entity_phynum', 'ent_physical_descr', 'ent_physical_firmware_rev', 'ent_physical_hardware_rev', 'ent_physical_mfg_name', 'ent_physical_modelname', 'ent_physical_name', 'ent_physical_serial_num', 'ent_physical_software_rev', 'location', 'physical_index'], name, value)
    ...
    class IfIndexes(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"if-index" : ("if_index", Snmp.IfIndexes.IfIndex)}
        ...
        class IfIndex(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "if-index" + "[interface-index='" + self.interface_index.get() + "']"
    ...
    class Information(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"bulk-stats-transfers" : ("bulk_stats_transfers", Snmp.Information.BulkStatsTransfers), "context-mapping" : ("context_mapping", Snmp.Information.ContextMapping), "drop-nms-addresses" : ("drop_nms_addresses", Snmp.Information.DropNmsAddresses), "duplicate-drop" : ("duplicate_drop", Snmp.Information.DuplicateDrop), "engine-id" : ("engine_id", Snmp.Information.EngineId), "hosts" : ("hosts", Snmp.Information.Hosts), "incoming-queue" : ("incoming_queue", Snmp.Information.IncomingQueue), "infom-details" : ("infom_details", Snmp.Information.InfomDetails), "mibs" : ("mibs", Snmp.Information.Mibs), "nm-spackets" : ("nm_spackets", Snmp.Information.NmSpackets), "nms-addresses" : ("nms_addresses", Snmp.Information.NmsAddresses), "poll-oids" : ("poll_oids", Snmp.Information.PollOids), "request-type-detail" : ("request_type_detail", Snmp.Information.RequestTypeDetail), "rx-queue" : ("rx_queue", Snmp.Information.RxQueue), "serial-numbers" : ("serial_numbers", Snmp.Information.SerialNumbers), "statistics" : ("statistics", Snmp.Information.Statistics), "system-descr" : ("system_descr", Snmp.Information.SystemDescr), "system-name" : ("system_name", Snmp.Information.SystemName), "system-oid" : ("system_oid", Snmp.Information.SystemOid), "system-up-time" : ("system_up_time", Snmp.Information.SystemUpTime), "tables" : ("tables", Snmp.Information.Tables), "trap-infos" : ("trap_infos", Snmp.Information.TrapInfos), "trap-oids" : ("trap_oids", Snmp.Information.TrapOids), "trap-queue" : ("trap_queue", Snmp.Information.TrapQueue), "views" : ("views", Snmp.Information.Views)}
            self._child_list_classes = {}
        ...
        class BulkStatsTransfers(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"bulk-stats-transfer" : ("bulk_stats_transfer", Snmp.Information.BulkStatsTransfers.BulkStatsTransfer)}
            ...
            class BulkStatsTransfer(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "bulk-stats-transfer" + "[transfer-name='" + self.transfer_name.get() + "']"
                    self._absolute_path = lambda: "Cisco-IOS-XR-snmp-agent-oper:snmp/information/bulk-stats-transfers/%s" % self._segment_path()

                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.BulkStatsTransfers.BulkStatsTransfer, ['transfer_name', 'retained_file', 'retry_left', 'time_left', 'transfer_name_xr', 'url_primary', 'url_secondary'], name, value)
        ...
        class ContextMapping(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"contex-mapping" : ("contex_mapping", Snmp.Information.ContextMapping.ContexMapping)}
            ...
            class ContexMapping(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.ContextMapping.ContexMapping, ['context', 'feature', 'feature_name', 'instance', 'topology'], name, value)
        ...
        class DropNmsAddresses(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"drop-nms-address" : ("drop_nms_address", Snmp.Information.DropNmsAddresses.DropNmsAddress)}
            ...
            class DropNmsAddress(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "drop-nms-address" + "[nms-addr='" + self.nms_addr.get() + "']"
                    self._absolute_path = lambda: "Cisco-IOS-XR-snmp-agent-oper:snmp/information/drop-nms-addresses/%s" % self._segment_path()

                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.DropNmsAddresses.DropNmsAddress, ['nms_addr', 'aipc_count', 'duplicate_count', 'encode_count', 'incoming_q_count', 'internal_count', 'nms_address', 'overload_count', 'stack_count', 'threshold_incoming_q_count', 'timeout_count'], name, value)
        ...
        class DuplicateDrop(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.Information.DuplicateDrop, ['duplicate_drop_configured_timeout', 'duplicate_drop_disable_count', 'duplicate_drop_enable_count', 'duplicate_dropped_requests', 'duplicate_request_latest_enable_time', 'duplicate_request_status', 'first_enable_time', 'last_status_change_time', 'latest_duplicate_dropped_requests', 'latest_retry_processed_requests', 'retry_processed_requests'], name, value)
        ...
        class Hosts(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"host" : ("host", Snmp.Information.Hosts.Host)}
            ...
            class Host(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"host-information" : ("host_information", Snmp.Information.Hosts.Host.HostInformation)}

                    self.name = YLeaf(YType.str, "name")

                    self.host_information = YList(self)
                    self._segment_path = lambda: "host" + "[name='" + self.name.get() + "']"
                ...
                class HostInformation(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._segment_path = lambda: "host-information" + "[user='" + self.user.get() + "']"

                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Information.Hosts.Host.HostInformation, ['user', 'snmp_target_address_port', 'snmp_target_address_t_host', 'snmp_target_addresstype', 'snmp_target_params_security_level', 'snmp_target_params_security_model', 'snmp_target_params_security_name'], name, value)
        ...
        class IncomingQueue(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"inq-entry" : ("inq_entry", Snmp.Information.IncomingQueue.InqEntry)}
            ...
            class InqEntry(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.IncomingQueue.InqEntry, ['address_of_queue', 'last_access_time', 'priority', 'processed_request_count', 'request_count'], name, value)
        ...
        class InfomDetails(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"infom-detail" : ("infom_detail", Snmp.Information.InfomDetails.InfomDetail)}
            ...
            class InfomDetail(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"trap-oi-dinfo" : ("trap_oi_dinfo", Snmp.Information.InfomDetails.InfomDetail.TrapOiDinfo)}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.InfomDetails.InfomDetail, ['host', 'port', 'port_xr', 'trap_host', 'trap_oid_count'], name, value)
                ...
                class TrapOiDinfo(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Information.InfomDetails.InfomDetail.TrapOiDinfo, ['count', 'drop_count', 'lasrdrop_time', 'lastsent_time', 'retry_count', 'trap_oid'], name, value)
        ...
        class Mibs(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"mib" : ("mib", Snmp.Information.Mibs.Mib)}
            ...
            class Mib(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"mib-information" : ("mib_information", Snmp.Information.Mibs.Mib.MibInformation), "oids" : ("oids", Snmp.Information.Mibs.Mib.Oids)}
                    self._child_list_classes = {}
                    ...
                    self._segment_path = lambda: "mib" + "[name='" + self.name.get() + "']"
                ...
                class MibInformation(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Information.Mibs.Mib.MibInformation, ['dll_capabilities', 'dll_name', 'is_mib_loaded', 'load_time', 'mib_config_filename', 'mib_name', 'timeout', 'trap_strings'], name, value)
                ...
                class Oids(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"oid" : ("oid", Snmp.Information.Mibs.Mib.Oids.Oid)}
                    ...
                    class Oid(Entity):
                        ...
                        def __init__(self):
                            ...
                            self._segment_path = lambda: "oid" + "[oid='" + self.oid.get() + "']"
        ...
        class NmSpackets(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"nm-spacket" : ("nm_spacket", Snmp.Information.NmSpackets.NmSpacket)}
            ...
            class NmSpacket(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "nm-spacket" + "[packetcount='" + self.packetcount.get() + "']"
                    self._absolute_path = lambda: "Cisco-IOS-XR-snmp-agent-oper:snmp/information/nm-spackets/%s" % self._segment_path()

                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.NmSpackets.NmSpacket, ['packetcount', 'number_of_nmsq_pkts_dropped', 'number_of_pkts_dropped', 'overload_end_time', 'overload_start_time'], name, value)
        ...
        class NmsAddresses(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"nms-address" : ("nms_address", Snmp.Information.NmsAddresses.NmsAddress)}
            ...
            class NmsAddress(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "nms-address" + "[nms-addr='" + self.nms_addr.get() + "']"
                    self._absolute_path = lambda: "Cisco-IOS-XR-snmp-agent-oper:snmp/information/nms-addresses/%s" % self._segment_path()

                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.NmsAddresses.NmsAddress, ['nms_addr', 'get_request_count', 'getbulk_request_count', 'getnext_request_count', 'nms_address', 'set_request_count', 'test_request_count'], name, value)
        ...
        class PollOids(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"poll-oid" : ("poll_oid", Snmp.Information.PollOids.PollOid)}
            ...
            class PollOid(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "poll-oid" + "[object-id='" + self.object_id.get() + "']"
                    self._absolute_path = lambda: "Cisco-IOS-XR-snmp-agent-oper:snmp/information/poll-oids/%s" % self._segment_path()

                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.PollOids.PollOid, ['object_id', 'nms', 'nms_count', 'request_count'], name, value)
        ...
        class RequestTypeDetail(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"nms-addresses" : ("nms_addresses", Snmp.Information.RequestTypeDetail.NmsAddresses)}
                self._child_list_classes = {}
            ...
            class NmsAddresses(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"nms-address" : ("nms_address", Snmp.Information.RequestTypeDetail.NmsAddresses.NmsAddress)}
                ...
                class NmsAddress(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Information.RequestTypeDetail.NmsAddresses.NmsAddress, ['nms_addr', 'agent_request_count', 'entity_request_count', 'infra_request_count', 'interface_request_count', 'route_request_count', 'total_count'], name, value)
        ...
        class RxQueue(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"incoming-q" : ("incoming_q", Snmp.Information.RxQueue.IncomingQ), "pending-q" : ("pending_q", Snmp.Information.RxQueue.PendingQ)}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.Information.RxQueue, ['in_avg', 'in_max', 'in_min', 'pend_avg', 'pend_max', 'pend_min', 'qlen'], name, value)
            ...
            class IncomingQ(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.RxQueue.IncomingQ, ['avg', 'max', 'min'], name, value)
            ...
            class PendingQ(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.RxQueue.PendingQ, ['avg', 'max', 'min'], name, value)
        ...
        class SerialNumbers(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"serial-number" : ("serial_number", Snmp.Information.SerialNumbers.SerialNumber)}
            ...
            class SerialNumber(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.SerialNumbers.SerialNumber, ['error_status', 'input_q', 'nms', 'number', 'output_q', 'pdu_type', 'pending_q', 'port', 'port_xr', 'req_id', 'request_id', 'response_out', 'serial_num'], name, value)
        ...
        class Statistics(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.Information.Statistics, ['asn_parse_errors_received', 'bad_community_names_received', 'bad_community_uses_received', 'bad_values_received', 'bad_values_sent', 'bad_versions_received', 'general_errors_sent', 'get_next_request_sent', 'get_next_requests_received', 'get_requests_received', 'get_requests_sent', 'get_responses_received', 'get_responses_sent', 'max_packet_size', 'no_such_names_received', 'no_such_names_sent', 'packets_received', 'proxy_drop_count', 'read_only_received', 'set_requests_received', 'set_requests_sent', 'silent_drop_count', 'too_big_packet_received', 'too_big_packets_sent', 'total_general_errors', 'total_packets_sent', 'total_requested_variables', 'total_set_variables_received', 'traps_received', 'traps_sent'], name, value)
        ...
        class Tables(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"groups" : ("groups", Snmp.Information.Tables.Groups), "user-engine-ids" : ("user_engine_ids", Snmp.Information.Tables.UserEngineIds)}
                self._child_list_classes = {}
            ...
            class Groups(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"group" : ("group", Snmp.Information.Tables.Groups.Group)}
                ...
                class Group(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"group-informations" : ("group_informations", Snmp.Information.Tables.Groups.Group.GroupInformations)}
                        self._child_list_classes = {}
                    ...
                    class GroupInformations(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.has_list_ancestor = True
                            self._child_container_classes = {}
                            self._child_list_classes = {"group-information" : ("group_information", Snmp.Information.Tables.Groups.Group.GroupInformations.GroupInformation)}
                        ...
                        class GroupInformation(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(Snmp.Information.Tables.Groups.Group.GroupInformations.GroupInformation, ['level', 'modelnumber', 'vacm_access_notify_view_name', 'vacm_access_read_view_name', 'vacm_access_status', 'vacm_access_write_view_name'], name, value)
            ...
            class UserEngineIds(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"user-engine-id" : ("user_engine_id", Snmp.Information.Tables.UserEngineIds.UserEngineId)}
                ...
                class UserEngineId(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = False
                        self._child_container_classes = {}
                        self._child_list_classes = {"user-name" : ("user_name", Snmp.Information.Tables.UserEngineIds.UserEngineId.UserName)}

                        self.engine_id = YLeaf(YType.str, "engine-id")

                        self.user_name = YList(self)
                        self._segment_path = lambda: "user-engine-id" + "[engine-id='" + self.engine_id.get() + "']"
                    ...
                    class UserName(Entity):
                        ...
                        def __init__(self):
                            ...
                            self._segment_path = lambda: "user-name" + "[user-name='" + self.user_name.get() + "']"

                        def __setattr__(self, name, value):
                            self._perform_setattr(Snmp.Information.Tables.UserEngineIds.UserEngineId.UserName, ['user_name', 'usm_user_status', 'usm_user_storage_type'], name, value)
        ...
        class TrapInfos(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"trap-info" : ("trap_info", Snmp.Information.TrapInfos.TrapInfo)}
            ...
            class TrapInfo(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"trap-oi-dinfo" : ("trap_oi_dinfo", Snmp.Information.TrapInfos.TrapInfo.TrapOiDinfo)}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.TrapInfos.TrapInfo, ['host', 'port', 'port_xr', 'trap_host', 'trap_oid_count'], name, value)
                ...
                class TrapOiDinfo(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Information.TrapInfos.TrapInfo.TrapOiDinfo, ['count', 'drop_count', 'lasrdrop_time', 'lastsent_time', 'retry_count', 'trap_oid'], name, value)
        ...
        class TrapOids(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"trap-oid" : ("trap_oid", Snmp.Information.TrapOids.TrapOid)}
            ...
            class TrapOid(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "trap-oid" + "[trap-oid='" + self.trap_oid.get() + "']"
        ...
        class TrapQueue(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"trap-q" : ("trap_q", Snmp.Information.TrapQueue.TrapQ)}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.Information.TrapQueue, ['trap_avg', 'trap_max', 'trap_min'], name, value)
            ...
            class TrapQ(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.Information.TrapQueue.TrapQ, ['avg', 'max', 'min'], name, value)
        ...
        class Views(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"view" : ("view", Snmp.Information.Views.View)}
            ...
            class View(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"view-information" : ("view_information", Snmp.Information.Views.View.ViewInformation)}

                    self.name = YLeaf(YType.str, "name")

                    self.view_information = YList(self)
                    self._segment_path = lambda: "view" + "[name='" + self.name.get() + "']"
                ...
                class ViewInformation(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._segment_path = lambda: "view-information" + "[object-id='" + self.object_id.get() + "']"

                    def __setattr__(self, name, value):
                        self._perform_setattr(Snmp.Information.Views.View.ViewInformation, ['object_id', 'snmp_view_family_status', 'snmp_view_family_storage_type', 'snmp_view_family_type'], name, value)
    ...
    class InterfaceIndexes(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"interface-index" : ("interface_index", Snmp.InterfaceIndexes.InterfaceIndex)}
        ...
        class InterfaceIndex(Entity):
            ...
            def __init__(self):
                ...
                self.interface_name = YLeaf(YType.str, "interface-name")
                self._segment_path = lambda: "interface-index" + "[interface-index='" + self.interface_index.get() + "']"
    ...
    class InterfaceMib(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"interface-aliases" : ("interface_aliases", Snmp.InterfaceMib.InterfaceAliases), "interface-connectors" : ("interface_connectors", Snmp.InterfaceMib.InterfaceConnectors), "interface-stack-statuses" : ("interface_stack_statuses", Snmp.InterfaceMib.InterfaceStackStatuses), "interfaces" : ("interfaces", Snmp.InterfaceMib.Interfaces), "notification-interfaces" : ("notification_interfaces", Snmp.InterfaceMib.NotificationInterfaces)}
            self._child_list_classes = {}
        ...
        class InterfaceAliases(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"interface-alias" : ("interface_alias", Snmp.InterfaceMib.InterfaceAliases.InterfaceAlias)}
            ...
            class InterfaceAlias(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "interface-alias" + "[interface-name='" + self.interface_name.get() + "']"
        ...
        class InterfaceConnectors(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"interface-connector" : ("interface_connector", Snmp.InterfaceMib.InterfaceConnectors.InterfaceConnector)}
            ...
            class InterfaceConnector(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "interface-connector" + "[interface-name='" + self.interface_name.get() + "']"
        ...
        class InterfaceStackStatuses(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"interface-stack-status" : ("interface_stack_status", Snmp.InterfaceMib.InterfaceStackStatuses.InterfaceStackStatus)}
            ...
            class InterfaceStackStatus(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "interface-stack-status" + "[interface-stack-status='" + self.interface_stack_status.get() + "']"
        ...
        class Interfaces(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"interface" : ("interface", Snmp.InterfaceMib.Interfaces.Interface)}
        ...
        class NotificationInterfaces(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"notification-interface" : ("notification_interface", Snmp.InterfaceMib.NotificationInterfaces.NotificationInterface)}
            ...
            class NotificationInterface(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "notification-interface" + "[interface-name='" + self.interface_name.get() + "']"
    ...
    class Interfaces(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"interface" : ("interface", Snmp.Interfaces.Interface)}
    ...
    class SensorMib(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"ent-phy-indexes" : ("ent_phy_indexes", Snmp.SensorMib.EntPhyIndexes), "physical-indexes" : ("physical_indexes", Snmp.SensorMib.PhysicalIndexes)}
            self._child_list_classes = {}
        ...
        class EntPhyIndexes(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"ent-phy-index" : ("ent_phy_index", Snmp.SensorMib.EntPhyIndexes.EntPhyIndex)}
            ...
            class EntPhyIndex(Entity):
                ...
                def __init__(self):
                    ...
                    self._segment_path = lambda: "ent-phy-index" + "[index='" + self.index.get() + "']"
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(Snmp.SensorMib.EntPhyIndexes.EntPhyIndex, ['index', 'age_time_stamp', 'alarm_type', 'data_type', 'device_description', 'device_id', 'field_validity_bitmap', 'measured_entity', 'precision', 'scale', 'status', 'units', 'update_rate', 'value'], name, value)
        ...
        class PhysicalIndexes(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"physical-index" : ("physical_index", Snmp.SensorMib.PhysicalIndexes.PhysicalIndex)}
            ...
            class PhysicalIndex(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"threshold-indexes" : ("threshold_indexes", Snmp.SensorMib.PhysicalIndexes.PhysicalIndex.ThresholdIndexes)}
                    self._child_list_classes = {}
                    ...
                    self._segment_path = lambda: "physical-index" + "[index='" + self.index.get() + "']"
                ...
                class ThresholdIndexes(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"threshold-index" : ("threshold_index", Snmp.SensorMib.PhysicalIndexes.PhysicalIndex.ThresholdIndexes.ThresholdIndex)}
                    ...
                    class ThresholdIndex(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(Snmp.SensorMib.PhysicalIndexes.PhysicalIndex.ThresholdIndexes.ThresholdIndex, ['phy_index', 'thre_index', 'threshold_evaluation', 'threshold_notification_enabled', 'threshold_relation', 'threshold_severity', 'threshold_value'], name, value)
    ...
    class TrapServers(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"trap-server" : ("trap_server", Snmp.TrapServers.TrapServer)}
        ...
        class TrapServer(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.TrapServers.TrapServer, ['max_q_length_of_trap_q', 'number_of_pkts_dropped', 'number_of_pkts_in_trap_q', 'number_of_pkts_sent', 'port', 'trap_host'], name, value)
