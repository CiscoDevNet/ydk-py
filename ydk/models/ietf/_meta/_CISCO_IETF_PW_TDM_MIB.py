...
_meta_table = {
    'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgPayloadSuppression_Enum' : _MetaInfoEnum('CpwCTDMCfgPayloadSuppression_Enum', 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB',
        {
            'enable':'ENABLE',
            'disable':'DISABLE',
        }, 'CISCO-IETF-PW-TDM-MIB', _yang_ns._namespaces['CISCO-IETF-PW-TDM-MIB']),
    'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgPktReplacePolicy_Enum' : _MetaInfoEnum('CpwCTDMCfgPktReplacePolicy_Enum', 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB',
        {
            'ais':'AIS',
            'implementationSpecific':'IMPLEMENTATIONSPECIFIC',
        }, 'CISCO-IETF-PW-TDM-MIB', _yang_ns._namespaces['CISCO-IETF-PW-TDM-MIB']),
    'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgTimestampMode_Enum' : _MetaInfoEnum('CpwCTDMCfgTimestampMode_Enum', 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB',
        {
    ...
    'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry',
            ...
            _MetaInfoClassMember('cpwCTDMCfgClearAlarmThreshold', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCfgConfErr', REFERENCE_BITS, 'CpwCTDMCfgConfErr_Bits' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgConfErr_Bits', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwCTDMCfgPayloadSize', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCfgPayloadSuppression', REFERENCE_ENUM_CLASS, 'CpwCTDMCfgPayloadSuppression_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgPayloadSuppression_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwCTDMCfgPktReorder', ATTRIBUTE, 'bool' , None, None, 
                ...
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCfgPktReplacePolicy', REFERENCE_ENUM_CLASS, 'CpwCTDMCfgPktReplacePolicy_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgPktReplacePolicy_Enum', 
                [], [], 
                ...
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCfgRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwCTDMCfgSetUp2SynchTimeOut', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCfgStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                ...
                'cpwctdmcfgstoragetype',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCfgTimestampMode', REFERENCE_ENUM_CLASS, 'CpwCTDMCfgTimestampMode_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry.CpwCTDMCfgTimestampMode_Enum', 
                [], [], 
        ...
        'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB'
        ),
    },
    'CISCOIETFPWTDMMIB.CpwCTDMCfgTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMCfgTable',
            False, 
            [
            _MetaInfoClassMember('cpwCTDMCfgEntry', REFERENCE_LIST, 'CpwCTDMCfgEntry' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMCfgTable.CpwCTDMCfgEntry', 
                [], [], 
    ...
    'CISCOIETFPWTDMMIB.CpwCTDMPerf1DayIntervalTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMPerf1DayIntervalTable',
            False, 
            [
            _MetaInfoClassMember('cpwCTDMPerf1DayIntervalEntry', REFERENCE_LIST, 'CpwCTDMPerf1DayIntervalEntry' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMPerf1DayIntervalTable.CpwCTDMPerf1DayIntervalEntry', 
                [], [], 
    ...
    'CISCOIETFPWTDMMIB.CpwCTDMPerfCurrentTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMPerfCurrentTable',
            False, 
            [
            _MetaInfoClassMember('cpwCTDMPerfCurrentEntry', REFERENCE_LIST, 'CpwCTDMPerfCurrentEntry' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMPerfCurrentTable.CpwCTDMPerfCurrentEntry', 
                [], [], 
    ...
    'CISCOIETFPWTDMMIB.CpwCTDMPerfIntervalTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMPerfIntervalTable',
            False, 
            [
            _MetaInfoClassMember('cpwCTDMPerfIntervalEntry', REFERENCE_LIST, 'CpwCTDMPerfIntervalEntry' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMPerfIntervalTable.CpwCTDMPerfIntervalEntry', 
                [], [], 
    ...
    'CISCOIETFPWTDMMIB.CpwCTDMTable.CpwCTDMEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMTable.CpwCTDMEntry',
            ...
            _MetaInfoClassMember('cpwCRelTDMCfgIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cpwcreltdmcfgindex',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMConfigError', REFERENCE_BITS, 'CpwCTDMConfigError_Bits' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMTable.CpwCTDMEntry.CpwCTDMConfigError_Bits', 
                [], [], 
                ...
                'cpwctdmconfigerror',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMCurrentIndications', REFERENCE_BITS, 'CpwCTDMCurrentIndications_Bits' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMTable.CpwCTDMEntry.CpwCTDMCurrentIndications_Bits', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwCTDMLastEsTimeStamp', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMLatchedIndications', REFERENCE_BITS, 'CpwCTDMLatchedIndications_Bits' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMTable.CpwCTDMEntry.CpwCTDMLatchedIndications_Bits', 
                [], [], 
    ...
    'CISCOIETFPWTDMMIB.CpwCTDMTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB.CpwCTDMTable',
            False, 
            [
            _MetaInfoClassMember('cpwCTDMEntry', REFERENCE_LIST, 'CpwCTDMEntry' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMTable.CpwCTDMEntry', 
                [], [], 
    ...
    'CISCOIETFPWTDMMIB' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWTDMMIB',
            False, 
            [
            _MetaInfoClassMember('cpwCTDMCfgTable', REFERENCE_CLASS, 'CpwCTDMCfgTable' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMCfgTable', 
                [], [], 
                ...
                'cpwctdmcfgtable',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMObjects', REFERENCE_CLASS, 'CpwCTDMObjects' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMObjects', 
                [], [], 
                '''                ''',
                'cpwctdmobjects',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMPerf1DayIntervalTable', REFERENCE_CLASS, 'CpwCTDMPerf1DayIntervalTable' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMPerf1DayIntervalTable', 
                [], [], 
                ...
                'cpwctdmperf1dayintervaltable',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMPerfCurrentTable', REFERENCE_CLASS, 'CpwCTDMPerfCurrentTable' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMPerfCurrentTable', 
                [], [], 
                ...
                'cpwctdmperfcurrenttable',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMPerfIntervalTable', REFERENCE_CLASS, 'CpwCTDMPerfIntervalTable' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMPerfIntervalTable', 
                [], [], 
                '''                This table provides performance information per TDM PW
                ...
                'cpwctdmperfintervaltable',
                'CISCO-IETF-PW-TDM-MIB', False),
            _MetaInfoClassMember('cpwCTDMTable', REFERENCE_CLASS, 'CpwCTDMTable' , 'ydk.models.ietf.CISCO_IETF_PW_TDM_MIB', 'CISCOIETFPWTDMMIB.CpwCTDMTable', 
                [], [], 
