...
class ENTITYMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"entAliasMappingTable" : ("entaliasmappingtable", ENTITYMIB.Entaliasmappingtable), "entityGeneral" : ("entitygeneral", ENTITYMIB.Entitygeneral), "entLogicalTable" : ("entlogicaltable", ENTITYMIB.Entlogicaltable), "entLPMappingTable" : ("entlpmappingtable", ENTITYMIB.Entlpmappingtable), "entPhysicalContainsTable" : ("entphysicalcontainstable", ENTITYMIB.Entphysicalcontainstable), "entPhysicalTable" : ("entphysicaltable", ENTITYMIB.Entphysicaltable)}
    ...
    class Entaliasmappingtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"entAliasMappingEntry" : ("entaliasmappingentry", ENTITYMIB.Entaliasmappingtable.Entaliasmappingentry)}
        ...
        class Entaliasmappingentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "entAliasMappingEntry" + "[entPhysicalIndex='" + self.entphysicalindex.get() + "']" + "[entAliasLogicalIndexOrZero='" + self.entaliaslogicalindexorzero.get() + "']"
    ...
    class Entlogicaltable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"entLogicalEntry" : ("entlogicalentry", ENTITYMIB.Entlogicaltable.Entlogicalentry)}
        ...
        class Entlogicalentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "entLogicalEntry" + "[entLogicalIndex='" + self.entlogicalindex.get() + "']"
                self._absolute_path = lambda: "ENTITY-MIB:ENTITY-MIB/entLogicalTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(ENTITYMIB.Entlogicaltable.Entlogicalentry, ['entlogicalindex', 'entlogicalcommunity', 'entlogicalcontextengineid', 'entlogicalcontextname', 'entlogicaldescr', 'entlogicaltaddress', 'entlogicaltdomain', 'entlogicaltype'], name, value)
    ...
    class Entlpmappingtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"entLPMappingEntry" : ("entlpmappingentry", ENTITYMIB.Entlpmappingtable.Entlpmappingentry)}
        ...
        class Entlpmappingentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "entLPMappingEntry" + "[entLogicalIndex='" + self.entlogicalindex.get() + "']" + "[entLPPhysicalIndex='" + self.entlpphysicalindex.get() + "']"
    ...
    class Entphysicalcontainstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"entPhysicalContainsEntry" : ("entphysicalcontainsentry", ENTITYMIB.Entphysicalcontainstable.Entphysicalcontainsentry)}
        ...
        class Entphysicalcontainsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "entPhysicalContainsEntry" + "[entPhysicalIndex='" + self.entphysicalindex.get() + "']" + "[entPhysicalChildIndex='" + self.entphysicalchildindex.get() + "']"
    ...
    class Entphysicaltable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"entPhysicalEntry" : ("entphysicalentry", ENTITYMIB.Entphysicaltable.Entphysicalentry)}
        ...
        class Entphysicalentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "entPhysicalEntry" + "[entPhysicalIndex='" + self.entphysicalindex.get() + "']"
                self._absolute_path = lambda: "ENTITY-MIB:ENTITY-MIB/entPhysicalTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(ENTITYMIB.Entphysicaltable.Entphysicalentry, ['entphysicalindex', 'ceentphysicalsecondserialnum', 'entphysicalalias', 'entphysicalassetid', 'entphysicalclass', 'entphysicalcontainedin', 'entphysicaldescr', 'entphysicalfirmwarerev', 'entphysicalhardwarerev', 'entphysicalisfru', 'entphysicalmfgdate', 'entphysicalmfgname', 'entphysicalmodelname', 'entphysicalname', 'entphysicalparentrelpos', 'entphysicalserialnum', 'entphysicalsoftwarerev', 'entphysicaluris', 'entphysicalvendortype'], name, value)
