...
class CISCOCDPMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cdpCacheTable" : ("cdpcachetable", CISCOCDPMIB.Cdpcachetable), "cdpCtAddressTable" : ("cdpctaddresstable", CISCOCDPMIB.Cdpctaddresstable), "cdpGlobal" : ("cdpglobal", CISCOCDPMIB.Cdpglobal), "cdpInterfaceExtTable" : ("cdpinterfaceexttable", CISCOCDPMIB.Cdpinterfaceexttable), "cdpInterfaceTable" : ("cdpinterfacetable", CISCOCDPMIB.Cdpinterfacetable)}
    ...
    class Cdpcachetable(Entity):
        ...
        class Cdpcacheentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCDPMIB.Cdpcachetable.Cdpcacheentry, ['cdpcacheifindex', 'cdpcachedeviceindex', 'cdpcacheaddress', 'cdpcacheaddresstype', 'cdpcacheapplianceid', 'cdpcachecapabilities', 'cdpcachedeviceid', 'cdpcachedeviceport', 'cdpcacheduplex', 'cdpcachelastchange', 'cdpcachemtu', 'cdpcachenativevlan', 'cdpcachephyslocation', 'cdpcacheplatform', 'cdpcachepowerconsumption', 'cdpcacheprimarymgmtaddr', 'cdpcacheprimarymgmtaddrtype', 'cdpcachesecondarymgmtaddr', 'cdpcachesecondarymgmtaddrtype', 'cdpcachesysname', 'cdpcachesysobjectid', 'cdpcacheversion', 'cdpcachevlanid', 'cdpcachevtpmgmtdomain'], name, value)
    ...
    class Cdpctaddresstable(Entity):
        ...
        class Cdpctaddressentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCDPMIB.Cdpctaddresstable.Cdpctaddressentry, ['cdpcacheifindex', 'cdpcachedeviceindex', 'cdpctaddressindex', 'cdpctaddress', 'cdpctaddresstype'], name, value)
    ...
    class Cdpglobal(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOCDPMIB.Cdpglobal, ['cdpglobaldeviceid', 'cdpglobaldeviceidformat', 'cdpglobaldeviceidformatcpb', 'cdpglobalholdtime', 'cdpgloballastchange', 'cdpglobalmessageinterval', 'cdpglobalrun'], name, value)
    ...
    class Cdpinterfaceexttable(Entity):
        ...
        class Cdpinterfaceextentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCDPMIB.Cdpinterfaceexttable.Cdpinterfaceextentry, ['ifindex', 'cdpinterfacecosforuntrustedport', 'cdpinterfaceextendedtrust'], name, value)
    ...
    class Cdpinterfacetable(Entity):
        ...
        class Cdpinterfaceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCDPMIB.Cdpinterfacetable.Cdpinterfaceentry, ['cdpinterfaceifindex', 'cdpinterfaceenable', 'cdpinterfacegroup', 'cdpinterfacemessageinterval', 'cdpinterfacename', 'cdpinterfaceport'], name, value)
