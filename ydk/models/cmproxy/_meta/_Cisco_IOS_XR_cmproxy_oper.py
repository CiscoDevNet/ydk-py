...
_meta_table = {
    'SdrInventoryVm.Nodes.Node.NodeEntries.NodeEntry' : {
        'meta_info' : _MetaInfoClass('SdrInventoryVm.Nodes.Node.NodeEntries.NodeEntry',
            ...
            _MetaInfoClassMember('prev-sw-state', ATTRIBUTE, 'int' , None, None, 
                ...
                'prev_sw_state',
                'Cisco-IOS-XR-cmproxy-oper', False),
            _MetaInfoClassMember('previous-sw-state-string', ATTRIBUTE, 'str' , None, None, 
                [(0, 32)], [], 
        ...
        'ydk.models.cmproxy.Cisco_IOS_XR_cmproxy_oper'
        ),
    },
    'SdrInventoryVm.Nodes.Node.NodeEntries' : {
        'meta_info' : _MetaInfoClass('SdrInventoryVm.Nodes.Node.NodeEntries',
            False, 
            [
            _MetaInfoClassMember('node-entry', REFERENCE_LIST, 'NodeEntry' , 'ydk.models.cmproxy.Cisco_IOS_XR_cmproxy_oper', 'SdrInventoryVm.Nodes.Node.NodeEntries.NodeEntry', 
                [], [], 
    ...
    'SdrInventoryVm.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('SdrInventoryVm.Nodes.Node',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'Cisco-IOS-XR-cmproxy-oper', True),
            _MetaInfoClassMember('node-entries', REFERENCE_CLASS, 'NodeEntries' , 'ydk.models.cmproxy.Cisco_IOS_XR_cmproxy_oper', 'SdrInventoryVm.Nodes.Node.NodeEntries', 
                [], [], 
                '''                VM Information
                ''',
                'node_entries',
    ...
    'SdrInventoryVm.Nodes' : {
        'meta_info' : _MetaInfoClass('SdrInventoryVm.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.cmproxy.Cisco_IOS_XR_cmproxy_oper', 'SdrInventoryVm.Nodes.Node', 
                [], [], 
                '''                Node name
                ''',
                'node',
    ...
    'SdrInventoryVm' : {
        'meta_info' : _MetaInfoClass('SdrInventoryVm',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.cmproxy.Cisco_IOS_XR_cmproxy_oper', 'SdrInventoryVm.Nodes', 
                [], [], 
                '''                Node directory
                ''',
                'nodes',
