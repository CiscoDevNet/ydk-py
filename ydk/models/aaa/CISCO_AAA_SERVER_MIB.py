...
class CiscoAAAProtocol_Enum(Enum):
    """
    CiscoAAAProtocol_Enum
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.aaa._meta import _CISCO_AAA_SERVER_MIB as meta
        return meta._meta_table['CiscoAAAProtocol_Enum']
...
class CISCOAAASERVERMIB(object):
    ...
    .. attribute:: casconfig
    	...
    	**type**\: :py:class:`CasConfig <ydk.models.aaa.CISCO_AAA_SERVER_MIB.CISCOAAASERVERMIB.CasConfig>`
    ...
    .. attribute:: casconfigtable
    	...
    	**type**\: :py:class:`CasConfigTable <ydk.models.aaa.CISCO_AAA_SERVER_MIB.CISCOAAASERVERMIB.CasConfigTable>`
    ...
    class CasConfigTable(object):
        ...
        .. attribute:: casconfigentry
        	...
        	**type**\: list of :py:class:`CasConfigEntry <ydk.models.aaa.CISCO_AAA_SERVER_MIB.CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry>`
        ...
        class CasConfigEntry(object):
            ...
            .. attribute:: casprotocol
            	...
            	**type**\: :py:class:`CiscoAAAProtocol_Enum <ydk.models.aaa.CISCO_AAA_SERVER_MIB.CiscoAAAProtocol_Enum>`
            ...
            .. attribute:: casstate
            	...
            	**type**\: :py:class:`CasState_Enum <ydk.models.aaa.CISCO_AAA_SERVER_MIB.CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry.CasState_Enum>`
            ...
            class CasState_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.aaa._meta import _CISCO_AAA_SERVER_MIB as meta
                    return meta._meta_table['CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry.CasState_Enum']


            @property
            def _common_path(self):
                if self.casindex is None:
                    raise YPYDataValidationError('Key property casindex is None')
                if self.casprotocol is None:
                    raise YPYDataValidationError('Key property casprotocol is None')

                return '/CISCO-AAA-SERVER-MIB:CISCO-AAA-SERVER-MIB/CISCO-AAA-SERVER-MIB:casConfigTable/CISCO-AAA-SERVER-MIB:casConfigEntry[CISCO-AAA-SERVER-MIB:casIndex = ' + str(self.casindex) + '][CISCO-AAA-SERVER-MIB:casProtocol = ' + str(self.casprotocol) + ']'
    ...
    def _has_data(self):
        ...
        if self.casconfig is not None and self.casconfig.is_presence():
            return True

        if self.casconfigtable is not None and self.casconfigtable._has_data():
            return True

        if self.casconfigtable is not None and self.casconfigtable.is_presence():
            return True
