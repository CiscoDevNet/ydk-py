...
class Snmp(Entity):
        ...
        class Targets(Entity):
            ...
            class Target(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"vrf-names" : ("vrf_names", Snmp.Target.Targets.Target.VrfNames), "target-addresses" : ("target_addresses", Snmp.Target.Targets.Target.TargetAddresses)}
                    self._child_list_classes = {}
    ...
    class Notification(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"snmp" : ("snmp", Snmp.Notification.Snmp), "diametermib" : ("diametermib", Snmp.Notification.Diametermib), "vpls" : ("vpls", Snmp.Notification.Vpls), "l2vpn" : ("l2vpn", Snmp.Notification.L2Vpn), "isis" : ("isis", Snmp.Notification.Isis), "config-man" : ("config_man", Snmp.Notification.ConfigMan), "cfm" : ("cfm", Snmp.Notification.Cfm), "oam" : ("oam", Snmp.Notification.Oam), "fabric-crs" : ("fabric_crs", Snmp.Notification.FabricCrs), "flash" : ("flash", Snmp.Notification.Flash), "Cisco-IOS-XR-freqsync-cfg_frequency-synchronization" : ("cisco_ios_xr_freqsync_cfg_frequency_synchronization", Snmp.Notification.CiscoIOSXRFreqsyncCfgFrequencySynchronization), "entity-redundancy" : ("entity_redundancy", Snmp.Notification.EntityRedundancy), "config-copy" : ("config_copy", Snmp.Notification.ConfigCopy), "selective-vrf-download" : ("selective_vrf_download", Snmp.Notification.SelectiveVrfDownload), "system" : ("system", Snmp.Notification.System), "bfd" : ("bfd", Snmp.Notification.Bfd), "addresspool-mib" : ("addresspool_mib", Snmp.Notification.AddresspoolMib), "ntp" : ("ntp", Snmp.Notification.Ntp), "rsvp" : ("rsvp", Snmp.Notification.Rsvp), "bgp" : ("bgp", Snmp.Notification.Bgp), "hsrp" : ("hsrp", Snmp.Notification.Hsrp), "ospf" : ("ospf", Snmp.Notification.Ospf), "vrrp" : ("vrrp", Snmp.Notification.Vrrp), "ospfv3" : ("ospfv3", Snmp.Notification.Ospfv3), "mpls-ldp" : ("mpls_ldp", Snmp.Notification.MplsLdp), "mpls-te-p2mp" : ("mpls_te_p2mp", Snmp.Notification.MplsTeP2Mp), "mpls-te" : ("mpls_te", Snmp.Notification.MplsTe), "mpls-frr" : ("mpls_frr", Snmp.Notification.MplsFrr), "mpls-l3vpn" : ("mpls_l3vpn", Snmp.Notification.MplsL3Vpn), "Cisco-IOS-XR-ncs4k-freqsync-cfg_frequency-synchronization" : ("cisco_ios_xr_ncs4k_freqsync_cfg_frequency_synchronization", Snmp.Notification.CiscoIOSXRNcs4KFreqsyncCfgFrequencySynchronization), "optical" : ("optical", Snmp.Notification.Optical), "optical-ots" : ("optical_ots", Snmp.Notification.OpticalOts), "otn" : ("otn", Snmp.Notification.Otn), "bridge" : ("bridge", Snmp.Notification.Bridge), "sensor" : ("sensor", Snmp.Notification.Sensor), "entity" : ("entity_", Snmp.Notification.Entity_), "entity-state" : ("entity_state", Snmp.Notification.EntityState), "fru-control" : ("fru_control", Snmp.Notification.FruControl), "rf" : ("rf", Snmp.Notification.Rf), "syslog" : ("syslog", Snmp.Notification.Syslog), "subscriber-mib" : ("subscriber_mib", Snmp.Notification.SubscriberMib), "l2tun" : ("l2tun", Snmp.Notification.L2Tun)}
            self._child_list_classes = {}
        ...
        class Snmp(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(Snmp.Notification.Snmp, ['authentication', 'cold_start', 'warm_start', 'enable', 'link_down', 'link_up'], name, value)
        ...
        class Ospf(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"lsa" : ("lsa", Snmp.Notification.Ospf.Lsa), "state-change" : ("state_change", Snmp.Notification.Ospf.StateChange), "retransmit" : ("retransmit", Snmp.Notification.Ospf.Retransmit), "error" : ("error", Snmp.Notification.Ospf.Error)}
                self._child_list_classes = {}
    ...
    class Correlator(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"rules" : ("rules", Snmp.Correlator.Rules), "rule-sets" : ("rule_sets", Snmp.Correlator.RuleSets)}
            self._child_list_classes = {}
        ...
        class Rules(Entity):
            ...
            class Rule(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"non-stateful" : ("non_stateful", Snmp.Correlator.Rules.Rule.NonStateful), "applied-to" : ("applied_to", Snmp.Correlator.Rules.Rule.AppliedTo)}
                    self._child_list_classes = {}
                ...
                class NonStateful(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = True
                        self._child_container_classes = {"root-causes" : ("root_causes", Snmp.Correlator.Rules.Rule.NonStateful.RootCauses), "non-root-causes" : ("non_root_causes", Snmp.Correlator.Rules.Rule.NonStateful.NonRootCauses)}
                        self._child_list_classes = {}
                            ...
                            class VarBinds(Entity):
                                ...
                                class VarBind(Entity):
                                    ...
                                    class Match(Entity):
                                        ...
                                        def __setattr__(self, name, value):
                                            self._perform_setattr(Snmp.Correlator.Rules.Rule.NonStateful.RootCauses.RootCause.VarBinds.VarBind.Match, ['value', 'index'], name, value)
                            ...
                            class VarBinds(Entity):
                                ...
                                class VarBind(Entity):
                                    ...
                                    class Match(Entity):
                                        ...
                                        def __setattr__(self, name, value):
                                            self._perform_setattr(Snmp.Correlator.Rules.Rule.NonStateful.NonRootCauses.NonRootCause.VarBinds.VarBind.Match, ['value', 'index'], name, value)
        ...
        class RuleSets(Entity):
            ...
            class RuleSet(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"rulenames" : ("rulenames", Snmp.Correlator.RuleSets.RuleSet.Rulenames), "applied-to" : ("applied_to", Snmp.Correlator.RuleSets.RuleSet.AppliedTo)}
                    self._child_list_classes = {}
    ...
    class BulkStats(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"schemas" : ("schemas", Snmp.BulkStats.Schemas), "objects" : ("objects", Snmp.BulkStats.Objects), "transfers" : ("transfers", Snmp.BulkStats.Transfers)}
            self._child_list_classes = {}
    ...
    class Vrfs(Entity):
        ...
        class Vrf(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"trap-hosts" : ("trap_hosts", Snmp.Vrfs.Vrf.TrapHosts), "contexts" : ("contexts", Snmp.Vrfs.Vrf.Contexts), "context-mappings" : ("context_mappings", Snmp.Vrfs.Vrf.ContextMappings)}
                self._child_list_classes = {}
                ...
                class TrapHost(Entity):
                    ...
                    class InformHost(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"inform-user-communities" : ("inform_user_communities", Snmp.Vrfs.Vrf.TrapHosts.TrapHost.InformHost.InformUserCommunities), "inform-encrypted-user-communities" : ("inform_encrypted_user_communities", Snmp.Vrfs.Vrf.TrapHosts.TrapHost.InformHost.InformEncryptedUserCommunities)}
                            self._child_list_classes = {}
    ...
    class TrapHosts(Entity):
        ...
        class TrapHost(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"encrypted-user-communities" : ("encrypted_user_communities", Snmp.TrapHosts.TrapHost.EncryptedUserCommunities), "inform-host" : ("inform_host", Snmp.TrapHosts.TrapHost.InformHost), "default-user-communities" : ("default_user_communities", Snmp.TrapHosts.TrapHost.DefaultUserCommunities)}
                self._child_list_classes = {}
            ...
            class InformHost(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"inform-user-communities" : ("inform_user_communities", Snmp.TrapHosts.TrapHost.InformHost.InformUserCommunities), "inform-encrypted-user-communities" : ("inform_encrypted_user_communities", Snmp.TrapHosts.TrapHost.InformHost.InformEncryptedUserCommunities)}
                    self._child_list_classes = {}
...
class Mib(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"mpls-te-mib" : ("mpls_te_mib", Mib.MplsTeMib), "mpls-p2mp-mib" : ("mpls_p2mp_mib", Mib.MplsP2MpMib), "mpls-te-ext-std-mib" : ("mpls_te_ext_std_mib", Mib.MplsTeExtStdMib), "mpls-te-ext-mib" : ("mpls_te_ext_mib", Mib.MplsTeExtMib), "mpls-frr-mib" : ("mpls_frr_mib", Mib.MplsFrrMib), "cb-qosmib" : ("cb_qosmib", Mib.CbQosmib), "entity-mib" : ("entity_mib", Mib.EntityMib), "interface-mib" : ("interface_mib", Mib.InterfaceMib), "subscriber" : ("subscriber", Mib.Subscriber)}
        self._child_list_classes = {}
    ...
    class Subscriber(Entity):
        ...
        class Threshold(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"delta" : ("delta", Mib.Subscriber.Threshold.Delta), "access-interface-sub" : ("access_interface_sub", Mib.Subscriber.Threshold.AccessInterfaceSub), "falling" : ("falling", Mib.Subscriber.Threshold.Falling), "rising" : ("rising", Mib.Subscriber.Threshold.Rising)}
                self._child_list_classes = {}
