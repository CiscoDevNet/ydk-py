...
class CISCOIETFISISMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ciiAreaAddrTable" : ("ciiareaaddrtable", CISCOIETFISISMIB.Ciiareaaddrtable), "ciiCirc" : ("ciicirc", CISCOIETFISISMIB.Ciicirc), "ciiCircLevelTable" : ("ciicircleveltable", CISCOIETFISISMIB.Ciicircleveltable), "ciiCircTable" : ("ciicirctable", CISCOIETFISISMIB.Ciicirctable), "ciiCircuitCounterTable" : ("ciicircuitcountertable", CISCOIETFISISMIB.Ciicircuitcountertable), "ciiIPRATable" : ("ciiipratable", CISCOIETFISISMIB.Ciiipratable), "ciiISAdjAreaAddrTable" : ("ciiisadjareaaddrtable", CISCOIETFISISMIB.Ciiisadjareaaddrtable), "ciiISAdjIPAddrTable" : ("ciiisadjipaddrtable", CISCOIETFISISMIB.Ciiisadjipaddrtable), "ciiISAdjProtSuppTable" : ("ciiisadjprotsupptable", CISCOIETFISISMIB.Ciiisadjprotsupptable), "ciiISAdjTable" : ("ciiisadjtable", CISCOIETFISISMIB.Ciiisadjtable), "ciiLSPSummaryTable" : ("ciilspsummarytable", CISCOIETFISISMIB.Ciilspsummarytable), "ciiLSPTLVTable" : ("ciilsptlvtable", CISCOIETFISISMIB.Ciilsptlvtable), "ciiManAreaAddrTable" : ("ciimanareaaddrtable", CISCOIETFISISMIB.Ciimanareaaddrtable), "ciiPacketCounterTable" : ("ciipacketcountertable", CISCOIETFISISMIB.Ciipacketcountertable), "ciiRATable" : ("ciiratable", CISCOIETFISISMIB.Ciiratable), "ciiRedistributeAddrTable" : ("ciiredistributeaddrtable", CISCOIETFISISMIB.Ciiredistributeaddrtable), "ciiRouterTable" : ("ciiroutertable", CISCOIETFISISMIB.Ciiroutertable), "ciiSummAddrTable" : ("ciisummaddrtable", CISCOIETFISISMIB.Ciisummaddrtable), "ciiSysLevelTable" : ("ciisysleveltable", CISCOIETFISISMIB.Ciisysleveltable), "ciiSysObject" : ("ciisysobject", CISCOIETFISISMIB.Ciisysobject), "ciiSysProtSuppTable" : ("ciisysprotsupptable", CISCOIETFISISMIB.Ciisysprotsupptable), "ciiSystemCounterTable" : ("ciisystemcountertable", CISCOIETFISISMIB.Ciisystemcountertable)}
    ...
    class Ciicircleveltable(Entity):
        ...
        class Ciicirclevelentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciicircleveltable.Ciicirclevelentry, ['ciicircindex', 'ciicirclevelindex', 'ciicirclevelcsnpinterval', 'ciicircleveldesis', 'ciicircleveldrhellotimer', 'ciicirclevelhellomultiplier', 'ciicirclevelhellotimer', 'ciicirclevelid', 'ciicirclevelidoctet', 'ciicirclevelispriority', 'ciicirclevellspthrottle', 'ciicirclevelmetric', 'ciicirclevelminlspretransint', 'ciicirclevelpartsnpinterval', 'ciicirclevelwidemetric'], name, value)
    ...
    class Ciicirctable(Entity):
        ...
        class Ciicircentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciicirctable.Ciicircentry, ['ciicircindex', 'ciicirc3wayenabled', 'ciicircadminstate', 'ciicircexiststate', 'ciicircextdomain', 'ciicircextendedcircid', 'ciicircifindex', 'ciicircifsubindex', 'ciicirclastuptime', 'ciicirclevel', 'ciicircmeshgroup', 'ciicircmeshgroupenabled', 'ciicircpassivecircuit', 'ciicircsmallhellos', 'ciicirctype'], name, value)
    ...
    class Ciicircuitcountertable(Entity):
        ...
        class Ciicircuitcounterentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciicircuitcountertable.Ciicircuitcounterentry, ['ciicircindex', 'ciicircuittype', 'ciicircadjchanges', 'ciicircauthfails', 'ciicircauthtypefails', 'ciicircidfieldlenmismatches', 'ciicircinitfails', 'ciicirclandesischanges', 'ciicircmaxareaaddrmismatches', 'ciicircnumadj', 'ciicircrejadjs'], name, value)
    ...
    class Ciiipratable(Entity):
        ...
        class Ciiipraentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciiipratable.Ciiipraentry, ['ciiipradesttype', 'ciiipradest', 'ciiipradestprefixlen', 'ciiipranexthopindex', 'ciiipraadminstate', 'ciiipraexiststate', 'ciiiprafullmetric', 'ciiiprametric', 'ciiiprametrictype', 'ciiipranexthop', 'ciiipranexthoptype', 'ciiiprasnpaaddress', 'ciiiprasourcetype', 'ciiipratype'], name, value)
    ...
    class Ciiisadjipaddrtable(Entity):
        ...
        class Ciiisadjipaddrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciiisadjipaddrtable.Ciiisadjipaddrentry, ['ciicircindex', 'ciiisadjindex', 'ciiisadjipaddrindex', 'ciiisadjipaddraddress', 'ciiisadjipaddrtype'], name, value)
    ...
    class Ciiisadjtable(Entity):
        ...
        class Ciiisadjentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciiisadjtable.Ciiisadjentry, ['ciicircindex', 'ciiisadjindex', 'ciiisadj3waystate', 'ciiisadjholdtimer', 'ciiisadjlastuptime', 'ciiisadjnbrextendedcircid', 'ciiisadjneighpriority', 'ciiisadjneighsnpaaddress', 'ciiisadjneighsysid', 'ciiisadjneighsystype', 'ciiisadjstate', 'ciiisadjusage'], name, value)
    ...
    class Ciilspsummarytable(Entity):
        ...
        class Ciilspsummaryentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciilspsummarytable.Ciilspsummaryentry, ['ciilsplevel', 'ciilspid', 'ciilspattributes', 'ciilspchecksum', 'ciilsplifetimeremain', 'ciilsppdulength', 'ciilspseq', 'ciilspzerolife'], name, value)
    ...
    class Ciilsptlvtable(Entity):
        ...
        class Ciilsptlventry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciilsptlvtable.Ciilsptlventry, ['ciilsplevel', 'ciilspid', 'ciilsptlvindex', 'ciilsptlvchecksum', 'ciilsptlvlen', 'ciilsptlvseq', 'ciilsptlvtype', 'ciilsptlvvalue'], name, value)
    ...
    class Ciipacketcountertable(Entity):
        ...
        class Ciipacketcounterentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciipacketcountertable.Ciipacketcounterentry, ['ciicircindex', 'ciipacketcountlevel', 'ciipacketcountdirection', 'ciipacketcountcsnps', 'ciipacketcounteshellos', 'ciipacketcountiihellos', 'ciipacketcountishellos', 'ciipacketcountlsps', 'ciipacketcountpsnps', 'ciipacketcountunknowns'], name, value)
    ...
    class Ciiratable(Entity):
        ...
        class Ciiraentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciiratable.Ciiraentry, ['ciicircindex', 'ciiraindex', 'ciiraaddrprefix', 'ciiraadminstate', 'ciiraexiststate', 'ciiramaptype', 'ciirametric', 'ciirametrictype', 'ciirasnpaaddress', 'ciirasnpamask', 'ciirasnpaprefix', 'ciiratype'], name, value)
    ...
    class Ciisummaddrtable(Entity):
        ...
        class Ciisummaddrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciisummaddrtable.Ciisummaddrentry, ['ciisummaddresstype', 'ciisummaddress', 'ciisummaddrprefixlen', 'ciisummaddrexiststate', 'ciisummaddrfullmetric', 'ciisummaddrmetric'], name, value)
    ...
    class Ciisysleveltable(Entity):
        ...
        class Ciisyslevelentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciisysleveltable.Ciisyslevelentry, ['ciisyslevelindex', 'ciisyslevelmetricstyle', 'ciisyslevelminlspgenint', 'ciisysleveloriglspbuffsize', 'ciisysleveloverloadstate', 'ciisyslevelsetoverload', 'ciisyslevelsetoverloaduntil', 'ciisyslevelspfconsiders', 'ciisyslevelteenabled'], name, value)
    ...
    class Ciisysobject(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOIETFISISMIB.Ciisysobject, ['ciisysadminstate', 'ciisysid', 'ciisysl2tol1leaking', 'ciisysmaxage', 'ciisysmaxlspgenint', 'ciisysmaxpathsplits', 'ciisyspolleshellorate', 'ciisysreceivelspbuffersize', 'ciisystype', 'ciisysversion', 'ciisyswaittime'], name, value)
    ...
    class Ciisystemcountertable(Entity):
        ...
        class Ciisystemcounterentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFISISMIB.Ciisystemcountertable.Ciisystemcounterentry, ['ciisysstatlevel', 'ciisysstatattmpttoexmaxseqnums', 'ciisysstatauthfails', 'ciisysstatauthtypefails', 'ciisysstatcorrlsps', 'ciisysstatidfieldlenmismatches', 'ciisysstatlspdbaseoloads', 'ciisysstatlsperrors', 'ciisysstatmanaddrdropfromareas', 'ciisysstatownlsppurges', 'ciisysstatpartchanges', 'ciisysstatseqnumskips', 'ciisysstatspfruns'], name, value)
