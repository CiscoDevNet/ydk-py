    ...
    class Sdr(Entity):
        ...
        def __init__(self):
            ...
            self._leafs = OrderedDict([
                ...
                ('lead_down_delta', YLeaf(YType.uint32, 'lead_down_delta')),
                ('pairing_mode', YLeaf(YType.enumeration, 'pairing-mode')),
                ('issu', YLeaf(YType.enumeration, 'issu')),
            ])
            self.name = None
        ...
        class Resources(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ...
                    ('disk_space_size', YLeaf(YType.uint32, 'disk-space-size')),
                ])
                self.fgid = None
            ...
            class CardType(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ...
                        ('vm_cpu', YLeaf(YType.uint32, 'vm-cpu')),
                    ])
                    self.type = None
                    self.vm_memory = None
                    self.vm_cpu = None
            ...
            class Location(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ...
                        ('boot_part', YLeaf(YType.str, 'boot_part')),
                        ('data_part', YLeaf(YType.str, 'data_part')),
                        ('big_disk', YLeaf(YType.str, 'big_disk')),
                        ('vm_id', YLeaf(YType.uint32, 'vm_id')),
                        ('vmcpu', YLeaf(YType.uint32, 'vmcpu')),
                        ('vmmemory', YLeaf(YType.uint32, 'vmmemory')),
                        ('card_type', YLeaf(YType.str, 'card-type')),
                        ('card_serial', YLeaf(YType.str, 'card_serial')),
                        ('rack_type', YLeaf(YType.str, 'rack-type')),
                        ('chassis_serial', YLeaf(YType.str, 'chassis_serial')),
                        ('hw_version', YLeaf(YType.str, 'hw_version')),
                        ('mgmt_ext_vlan', YLeaf(YType.str, 'mgmt_ext_vlan')),
                        ('state', YLeaf(YType.str, 'state')),
                        ('start_time', YLeaf(YType.str, 'start-time')),
                        ('reboot_count', YLeaf(YType.uint32, 'reboot_count')),
                        ('rh_count', YLeaf(YType.uint32, 'rh_count')),
                    ])
                    self.node_location = None
                    self.sdr_id = None
                    self.ip_addr = None
            ...
            class Location(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ...
                        ('state', YLeaf(YType.str, 'state')),
                        ('start_time', YLeaf(YType.str, 'start-time')),
                        ('reload_reason', YLeaf(YType.str, 'reload_reason')),
                        ('reboot_count', YLeaf(YType.uint32, 'reboot_count')),
                        ('rh_count', YLeaf(YType.uint32, 'rh_count')),
                    ])
                    self.node_location = None
    ...
    class SdrName(Entity):
        ...
        def __init__(self):
            ...
            self._leafs = OrderedDict([
                ...
                ('lead_rack0', YLeaf(YType.uint32, 'lead_rack0')),
                ('lead_rack1', YLeaf(YType.uint32, 'lead_rack1')),
            ])
            self.name = None
            self.id = None
        ...
        class Pairing(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ...
                    ('rp1_rack', YLeaf(YType.uint32, 'rp1_rack')),
                    ('rp1_slot', YLeaf(YType.uint32, 'rp1_slot')),
                    ('rp2_rack', YLeaf(YType.uint32, 'rp2_rack')),
                    ('rp2_slot', YLeaf(YType.uint32, 'rp2_slot')),
                ])
                self.num = None
