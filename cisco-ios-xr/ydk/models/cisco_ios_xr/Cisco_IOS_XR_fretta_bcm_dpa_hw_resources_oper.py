            ...
            class Node(Entity):
                ...
                class StatsResourcesDatas(Entity):
                    ...
                    class StatsResourcesData(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(Dpa.Stats.Nodes.Node.StatsResourcesDatas.StatsResourcesData, ['resource', 'sys_cp_cnfg_prof', 'next_avail_cp_id', 'num_cntr_engines'], name, value)
                        ...
                        class CntrEngine(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(Dpa.Stats.Nodes.Node.StatsResourcesDatas.StatsResourcesData.CntrEngine, ['state', 'core_id'], name, value)
                            ...
                            class AppsInfo(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(Dpa.Stats.Nodes.Node.StatsResourcesDatas.StatsResourcesData.CntrEngine.AppsInfo, ['app_type', 'num_cntrs_for_app', 'num_cntrs_used'], name, value)
