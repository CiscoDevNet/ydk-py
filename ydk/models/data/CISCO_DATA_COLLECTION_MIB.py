...
class CdcFileFormat_Enum(Enum):
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
        return meta._meta_table['CdcFileFormat_Enum']


class CdcFileXferStatus_Enum(Enum):
    """
    CdcFileXferStatus_Enum
    ...
    def _meta_info():
        from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
        return meta._meta_table['CdcFileXferStatus_Enum']
...
class CISCODATACOLLECTIONMIB(object):
    ...
    .. attribute:: cdcdgbaseobjecttable
    	...
    	**type**\: :py:class:`CdcDGBaseObjectTable <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable>`
    ...
    .. attribute:: cdcdginstancetable
    	...
    	**type**\: :py:class:`CdcDGInstanceTable <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGInstanceTable>`
    
    .. attribute:: cdcdgtable
    
    	A table for specifying data groups
    	**type**\: :py:class:`CdcDGTable <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGTable>`
    
    .. attribute:: cdcfilexferconftable
    
    	A table for configuring file transfer operations
    	**type**\: :py:class:`CdcFileXferConfTable <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcFileXferConfTable>`
    
    .. attribute:: cdcvfile
    
    	
    	**type**\: :py:class:`CdcVFile <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFile>`
    
    .. attribute:: cdcvfilemgmttable
    
    	A table to manage frozen VFiles
    	**type**\: :py:class:`CdcVFileMgmtTable <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileMgmtTable>`
    
    .. attribute:: cdcvfiletable
    
    	A table for setting up VFiles for collecting data
    	**type**\: :py:class:`CdcVFileTable <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable>`
    ...
    class CdcDGBaseObjectTable(object):
        ...
        .. attribute:: cdcdgbaseobjectentry
        	...
        	**type**\: list of :py:class:`CdcDGBaseObjectEntry <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGBaseObjectTable.CdcDGBaseObjectEntry>`
        ...
        class CdcDGBaseObjectEntry(object):
            ...
            .. attribute:: cdcdgbaseobjectgrpindex
            ...
            .. attribute:: cdcdgbaseobjectindex
            ...
            def _common_path(self):
                if self.cdcdgbaseobjectgrpindex is None:
                    raise YPYDataValidationError('Key property cdcdgbaseobjectgrpindex is None')
                if self.cdcdgbaseobjectindex is None:
                    raise YPYDataValidationError('Key property cdcdgbaseobjectindex is None')
    ...
    class CdcDGInstanceTable(object):
        ...
        .. attribute:: cdcdginstanceentry
        	...
        	**type**\: list of :py:class:`CdcDGInstanceEntry <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry>`
        ...
        class CdcDGInstanceEntry(object):
            ...
            .. attribute:: cdcdginstancegrpindex
            ...
            .. attribute:: cdcdginstancetype
            	...
            	**type**\: :py:class:`CdcDGInstanceType_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry.CdcDGInstanceType_Enum>`
            ...
            class CdcDGInstanceType_Enum(Enum):
                """
                CdcDGInstanceType_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcDGInstanceTable.CdcDGInstanceEntry.CdcDGInstanceType_Enum']


            @property
            def _common_path(self):
                if self.cdcdginstancegrpindex is None:
                    raise YPYDataValidationError('Key property cdcdginstancegrpindex is None')
                if self.cdcdginstanceindex is None:
                    raise YPYDataValidationError('Key property cdcdginstanceindex is None')
    ...
    class CdcDGTable(object):
        ...
        .. attribute:: cdcdgentry
        	...
        	**type**\: list of :py:class:`CdcDGEntry <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry>`
        ...
        class CdcDGEntry(object):
            ...
            .. attribute:: cdcdgtype
            	...
            	**type**\: :py:class:`CdcDGType_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry.CdcDGType_Enum>`
            ...
            class CdcDGType_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcDGTable.CdcDGEntry.CdcDGType_Enum']


            @property
            def _common_path(self):
                if self.cdcdgindex is None:
                    raise YPYDataValidationError('Key property cdcdgindex is None')
    ...
    class CdcFileXferConfTable(object):
        ...
        .. attribute:: cdcfilexferconfentry
        	...
        	**type**\: list of :py:class:`CdcFileXferConfEntry <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcFileXferConfTable.CdcFileXferConfEntry>`
        ...
        class CdcFileXferConfEntry(object):
            ...
            def _common_path(self):
                if self.cdcvfileindex is None:
                    raise YPYDataValidationError('Key property cdcvfileindex is None')
    ...
    class CdcVFileMgmtTable(object):
        ...
        .. attribute:: cdcvfilemgmtentry
        	...
        	**type**\: list of :py:class:`CdcVFileMgmtEntry <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry>`
        ...
        class CdcVFileMgmtEntry(object):
            ...
            .. attribute:: cdcvfilemgmtcommand
            	...
            	**type**\: :py:class:`CdcVFileMgmtCommand_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry.CdcVFileMgmtCommand_Enum>`
            
            .. attribute:: cdcvfilemgmtlastxferstatus
            
            	Indicates the status of the last completed transfer
            	**type**\: :py:class:`CdcFileXferStatus_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CdcFileXferStatus_Enum>`
            ...
            class CdcVFileMgmtCommand_Enum(Enum):
                """
                CdcVFileMgmtCommand_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcVFileMgmtTable.CdcVFileMgmtEntry.CdcVFileMgmtCommand_Enum']
            ...
            def _common_path(self):
                ...
                if self.cdcvfilemgmtindex is None:
                    raise YPYDataValidationError('Key property cdcvfilemgmtindex is None')
    ...
    class CdcVFileTable(object):
        ...
        .. attribute:: cdcvfileentry
        	...
        	**type**\: list of :py:class:`CdcVFileEntry <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry>`
        ...
        class CdcVFileEntry(object):
            ...
            .. attribute:: cdcvfileadminstatus
            	...
            	**type**\: :py:class:`CdcVFileAdminStatus_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileAdminStatus_Enum>`
            ...
            .. attribute:: cdcvfilecollectmode
            	...
            	**type**\: :py:class:`CdcVFileCollectMode_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCollectMode_Enum>`
            ...
            .. attribute:: cdcvfilecommand
            	...
            	**type**\: :py:class:`CdcVFileCommand_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCommand_Enum>`
            ...
            .. attribute:: cdcvfileerrorcode
            	...
            	**type**\: :py:class:`CdcVFileErrorCode_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileErrorCode_Enum>`
            ...
            .. attribute:: cdcvfileformat
            	...
            	**type**\: :py:class:`CdcFileFormat_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CdcFileFormat_Enum>`
            ...
            .. attribute:: cdcvfileoperstatus
            	...
            	**type**\: :py:class:`CdcVFileOperStatus_Enum <ydk.models.data.CISCO_DATA_COLLECTION_MIB.CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileOperStatus_Enum>`
            ...
            class CdcVFileAdminStatus_Enum(Enum):
                """
                CdcVFileAdminStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileAdminStatus_Enum']


            class CdcVFileCollectMode_Enum(Enum):
                """
                CdcVFileCollectMode_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCollectMode_Enum']


            class CdcVFileCommand_Enum(Enum):
                """
                CdcVFileCommand_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileCommand_Enum']


            class CdcVFileErrorCode_Enum(Enum):
                """
                CdcVFileErrorCode_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileErrorCode_Enum']


            class CdcVFileOperStatus_Enum(Enum):
                """
                CdcVFileOperStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.data._meta import _CISCO_DATA_COLLECTION_MIB as meta
                    return meta._meta_table['CISCODATACOLLECTIONMIB.CdcVFileTable.CdcVFileEntry.CdcVFileOperStatus_Enum']
    ...
    def _has_data(self):
        ...
        if self.cdcdgbaseobjecttable is not None and self.cdcdgbaseobjecttable.is_presence():
            return True

        if self.cdcdginstancetable is not None and self.cdcdginstancetable._has_data():
            return True

        if self.cdcdginstancetable is not None and self.cdcdginstancetable.is_presence():
            return True

        if self.cdcdgtable is not None and self.cdcdgtable._has_data():
            return True

        if self.cdcdgtable is not None and self.cdcdgtable.is_presence():
            return True

        if self.cdcfilexferconftable is not None and self.cdcfilexferconftable._has_data():
            return True

        if self.cdcfilexferconftable is not None and self.cdcfilexferconftable.is_presence():
            return True

        if self.cdcvfile is not None and self.cdcvfile._has_data():
            return True

        if self.cdcvfile is not None and self.cdcvfile.is_presence():
            return True

        if self.cdcvfilemgmttable is not None and self.cdcvfilemgmttable._has_data():
            return True

        if self.cdcvfilemgmttable is not None and self.cdcvfilemgmttable.is_presence():
            return True

        if self.cdcvfiletable is not None and self.cdcvfiletable._has_data():
            return True

        if self.cdcvfiletable is not None and self.cdcvfiletable.is_presence():
            return True
