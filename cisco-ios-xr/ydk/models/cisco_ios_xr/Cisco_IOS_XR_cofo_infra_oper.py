                ...
                class ClientId(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._leafs = OrderedDict([
                            ...
                            ('purge_timeout', YLeaf(YType.uint32, 'purge-timeout')),
                            ('host_client', YLeaf(YType.boolean, 'host-client')),
                            ('connection_state', YLeaf(YType.uint32, 'connection-state')),
                        ])
                        self.id = None
                        self.client_id = None
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Cofo.Nodes.Node.ClientIds.ClientId, ['id', u'client_id', u'purge_timeout', u'host_client', u'connection_state'], name, value)
            ...
            class TopicIds(Entity):
                ...
                class TopicId(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._leafs = OrderedDict([
                            ('id', YLeaf(YType.uint32, 'id')),
                            ('topic_id', YLeaf(YType.uint32, 'topic-id')),
                        ])
                        self.id = None
                        self.topic_id = None
                    ...
                    class DatabaseInfoStruct(Entity):
                        ...
                        class ClientDbInfoStruct(Entity):
                            ...
                            .. attribute:: total_objects_published
                            ...
                            def __init__(self):
                                ...
                                self._leafs = OrderedDict([
                                    ('total_objects_published', YLeaf(YType.uint32, 'total-objects-published')),
                                    ('total_valid_items_in_db', YLeaf(YType.uint32, 'total-valid-items-in-db')),
                                ])
                                self.total_objects_published = None
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(Cofo.Nodes.Node.TopicIds.TopicId.DatabaseInfoStruct.ClientDbInfoStruct, [u'total_objects_published', u'total_valid_items_in_db'], name, value)
                            ...
                            class CofoObjectPublishedArray(Entity):
                                ...
                                def __init__(self):
                                    ...
                                    self._child_classes = OrderedDict([])
                                    self._leafs = OrderedDict([
                                        ('cofo_infra_object_key', YLeaf(YType.str, 'cofo-infra-object-key')),
                                        ('cofo_infra_object_value', YLeaf(YType.str, 'cofo-infra-object-value')),
                                    ])
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(Cofo.Nodes.Node.TopicIds.TopicId.DatabaseInfoStruct.ClientDbInfoStruct.CofoObjectPublishedArray, [u'cofo_infra_object_key', u'cofo_infra_object_value'], name, value)
