            ...
            class Devices(Entity):
                ...
                class Device(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._leafs = OrderedDict([
                            ('fpd_type', (YLeaf(YType.enumeration, 'fpd-type'), [('ydk.models.cisco_ios_xr.Cisco_IOS_XR_upgrade_fpd_oper', 'Fpd', '')])),
                            ('instance', (YLeaf(YType.uint32, 'instance'), ['int'])),
                            ('sub_type', (YLeaf(YType.enumeration, 'sub-type'), [('ydk.models.cisco_ios_xr.Cisco_IOS_XR_upgrade_fpd_oper', 'FpdSub', '')])),
                            ...
                            ('is_upgrade_downgrade', (YLeaf(YType.boolean, 'is-upgrade-downgrade'), ['bool'])),
                        ])
                        self.fpd_type = None
                        self.instance = None
                        self.sub_type = None
    ...
    class Packages(Entity):
        ...
        class AllPackage(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ('card_type', (YLeaf(YType.str, 'card-type'), ['str'])),
                    ('card_description', (YLeaf(YType.str, 'card-description'), ['str'])),
                    ('fpd_type', (YLeaf(YType.enumeration, 'fpd-type'), [('ydk.models.cisco_ios_xr.Cisco_IOS_XR_upgrade_fpd_oper', 'Fpd1', '')])),
                    ('fpd_sub_type', (YLeaf(YType.enumeration, 'fpd-sub-type'), [('ydk.models.cisco_ios_xr.Cisco_IOS_XR_upgrade_fpd_oper', 'FpdSub1', '')])),
                    ('software_version', (YLeaf(YType.str, 'software-version'), ['str'])),
                    ('minimum_required_software_version', (YLeaf(YType.str, 'minimum-required-software-version'), ['str'])),
                    ('minimum_required_hardware_version', (YLeaf(YType.str, 'minimum-required-hardware-version'), ['str'])),
                ])
                self.card_type = None
