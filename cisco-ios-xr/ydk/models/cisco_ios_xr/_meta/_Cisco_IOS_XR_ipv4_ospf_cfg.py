...
_meta_table = {
    ...
    'OspfFastRerouteEnum' : _MetaInfoEnum('OspfFastRerouteEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'none':'NONE',
            'per-link':'PER_LINK',
            'per-prefix':'PER_PREFIX',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfRedistLsaEnum' : _MetaInfoEnum('OspfRedistLsaEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'summary':'SUMMARY',
            'external':'EXTERNAL',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfIetfNsfEnum' : _MetaInfoEnum('OspfIetfNsfEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'all':'ALL',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'BfdEnableModeEnum' : _MetaInfoEnum('BfdEnableModeEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'disable':'DISABLE',
            'default':'DEFAULT',
            'strict':'STRICT',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfFastReroutePriorityEnum' : _MetaInfoEnum('OspfFastReroutePriorityEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'critical':'CRITICAL',
            'high':'HIGH',
            'medium':'MEDIUM',
    ...
    'OspfCiscoNsfEnum' : _MetaInfoEnum('OspfCiscoNsfEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'always':'ALWAYS',
            'require-nsf-neighbors':'REQUIRE_NSF_NEIGHBORS',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfRedistProtocolEnum' : _MetaInfoEnum('OspfRedistProtocolEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'all':'ALL',
            'connected':'CONNECTED',
            'static':'STATIC',
    ...
    'OspfSegmentRoutingEnum' : _MetaInfoEnum('OspfSegmentRoutingEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'disable':'DISABLE',
            'mpls':'MPLS',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfUloopAvoidanceEnum' : _MetaInfoEnum('OspfUloopAvoidanceEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'protected':'PROTECTED',
            'all':'ALL',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    ...
    'OspfAddressFamilyEnum' : _MetaInfoEnum('OspfAddressFamilyEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'ipv4':'IPV4',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfIetfNsfSupportEnum' : _MetaInfoEnum('OspfIetfNsfSupportEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'never':'NEVER',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfAuthenticationEnum' : _MetaInfoEnum('OspfAuthenticationEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'none':'NONE',
            'plain':'PLAIN',
            'md5':'MD5',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfLogAdjEnum' : _MetaInfoEnum('OspfLogAdjEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'brief':'BRIEF',
            'detail':'DETAIL',
            'suppress':'SUPPRESS',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfSubAddressFamilyEnum' : _MetaInfoEnum('OspfSubAddressFamilyEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'unicast':'UNICAST',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfDomainIdEnum' : _MetaInfoEnum('OspfDomainIdEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'type0005':'TYPE0005',
            'type0105':'TYPE0105',
            'type0205':'TYPE0205',
    ...
    'OspfEigrpRouteEnum' : _MetaInfoEnum('OspfEigrpRouteEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'internal':'INTERNAL',
            'external':'EXTERNAL',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfSidEnum' : _MetaInfoEnum('OspfSidEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'index':'INDEX',
            'absolute':'ABSOLUTE',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'NsrEnum' : _MetaInfoEnum('NsrEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'true':'TRUE',
            'false':'FALSE',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfLinkStateMetricEnum' : _MetaInfoEnum('OspfLinkStateMetricEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'type1':'TYPE1',
            'type2':'TYPE2',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfDistListProtocolEnum' : _MetaInfoEnum('OspfDistListProtocolEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'all':'ALL',
            'connected':'CONNECTED',
            'static':'STATIC',
    ...
    'OspfRouteLevelEnum' : _MetaInfoEnum('OspfRouteLevelEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'type1':'TYPE1',
            'type2':'TYPE2',
            'type1-and2':'TYPE1_AND2',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfNetworkEnum' : _MetaInfoEnum('OspfNetworkEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'broadcast':'BROADCAST',
    ...
    'OspfFrrRlfaTunnelEnum' : _MetaInfoEnum('OspfFrrRlfaTunnelEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'none':'NONE',
            'mpls-ldp':'MPLS_LDP',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfShutdownEnum' : _MetaInfoEnum('OspfShutdownEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'full':'FULL',
            'hostmode':'HOSTMODE',
            'onreload':'ONRELOAD',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    'OspfKeychainAuthEnum' : _MetaInfoEnum('OspfKeychainAuthEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg',
        {
            'none':'NONE',
            'keychain':'KEYCHAIN',
        }, 'Cisco-IOS-XR-ipv4-ospf-cfg', _yang_ns._namespaces['Cisco-IOS-XR-ipv4-ospf-cfg']),
    ...
    'Ospf.Processes.Process.Snmp' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Snmp',
            False, 
            [
            _MetaInfoClassMember('trap-rate-limit', REFERENCE_CLASS, 'TrapRateLimit' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Snmp.TrapRateLimit', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.DomainId.PrimaryDomainId' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.DomainId.PrimaryDomainId',
            ...
            _MetaInfoClassMember('domain-id-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'domain_id_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('domain-id-type', REFERENCE_ENUM_CLASS, 'OspfDomainIdEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfDomainIdEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.DomainId.SecondaryDomainIds' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.DomainId.SecondaryDomainIds',
            False, 
            [
            _MetaInfoClassMember('secondary-domain-id', REFERENCE_LIST, 'SecondaryDomainId' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.DomainId.SecondaryDomainIds.SecondaryDomainId', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.DomainId' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.DomainId',
            False, 
            [
            _MetaInfoClassMember('primary-domain-id', REFERENCE_CLASS, 'PrimaryDomainId' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.DomainId.PrimaryDomainId', 
                [], [], 
                '''                OSPF Primary domain ID
                ''',
                'primary_domain_id',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('secondary-domain-ids', REFERENCE_CLASS, 'SecondaryDomainIds' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.DomainId.SecondaryDomainIds', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Microloop.Avoidance' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Microloop.Avoidance',
            False, 
            [
            _MetaInfoClassMember('enable', REFERENCE_ENUM_CLASS, 'OspfUloopAvoidanceEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfUloopAvoidanceEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Microloop' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Microloop',
            False, 
            [
            _MetaInfoClassMember('avoidance', REFERENCE_CLASS, 'Avoidance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Microloop.Avoidance', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.DefaultInformation' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.DefaultInformation',
            ...
            _MetaInfoClassMember('metric', ATTRIBUTE, 'int' , None, None, 
                ...
                'metric',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('metric-type', REFERENCE_ENUM_CLASS, 'OspfLinkStateMetricEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfLinkStateMetricEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Af' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Af',
            False, 
            [
            _MetaInfoClassMember('af-name', REFERENCE_ENUM_CLASS, 'OspfAddressFamilyEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfAddressFamilyEnum', 
                [], [], 
                '''                Address family
                ''',
                'af_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('saf-name', REFERENCE_ENUM_CLASS, 'OspfSubAddressFamilyEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSubAddressFamilyEnum', 
                [], [], 
                '''                Sub-Address family
                ''',
                'saf_name',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.MaxMetric',
            False, 
            [
            _MetaInfoClassMember('max-metric-always', REFERENCE_CLASS, 'MaxMetricAlways' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric.MaxMetricAlways', 
                [], [], 
            ...
            _MetaInfoClassMember('max-metric-no-abr-off', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-proc-migration', REFERENCE_CLASS, 'MaxMetricOnProcMigration' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric.MaxMetricOnProcMigration', 
                [], [], 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-proc-restart', REFERENCE_CLASS, 'MaxMetricOnProcRestart' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric.MaxMetricOnProcRestart', 
                [], [], 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-startup', REFERENCE_CLASS, 'MaxMetricOnStartup' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric.MaxMetricOnStartup', 
                [], [], 
                '''                Set maximum metric on-startup configuration
                ''',
                'max_metric_on_startup',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-switchover', REFERENCE_CLASS, 'MaxMetricOnSwitchover' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric.MaxMetricOnSwitchover', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Nsf' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Nsf',
            False, 
            [
            _MetaInfoClassMember('cisco', REFERENCE_ENUM_CLASS, 'OspfCiscoNsfEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfCiscoNsfEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('flush-delay-time', ATTRIBUTE, 'int' , None, None, 
                ...
                'flush_delay_time',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ietf', REFERENCE_ENUM_CLASS, 'OspfIetfNsfEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfIetfNsfEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('ietf-strict-lsa-checking', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ietf-support-role', REFERENCE_ENUM_CLASS, 'OspfIetfNsfSupportEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfIetfNsfSupportEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Bfd' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Bfd',
            ...
            _MetaInfoClassMember('detection-multiplier', ATTRIBUTE, 'int' , None, None, 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-detect-mode', REFERENCE_ENUM_CLASS, 'BfdEnableModeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'BfdEnableModeEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.Type' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.Type',
            False, 
            [
            _MetaInfoClassMember('authen-type', REFERENCE_ENUM_CLASS, 'OspfAuthenticationEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfAuthenticationEnum', 
                [], [], 
                '''                Authentication type code 
                ''',
                'authen_type',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('keychain-authen-type', REFERENCE_ENUM_CLASS, 'OspfKeychainAuthEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfKeychainAuthEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Security.Ttl', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.RemoteLfa' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.RemoteLfa',
            ...
            _MetaInfoClassMember('maximum-cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'maximum_cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('tunnel', REFERENCE_ENUM_CLASS, 'OspfFrrRlfaTunnelEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFrrRlfaTunnelEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute',
            False, 
            [
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                [], [], 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute.PerPrefix', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.ProcessScope',
            False, 
            [
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.CostFallback', 
                [], [], 
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.DeadIntervalMinimal', 
                [], [], 
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.DistributeList', 
                [], [], 
            ...
            _MetaInfoClassMember('external-out', ATTRIBUTE, 'bool' , None, None, 
                ...
                'external_out',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.FastReroute', 
                [], [], 
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('network-type', REFERENCE_ENUM_CLASS, 'OspfNetworkEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfNetworkEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('retransmit-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'retransmit_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Security', 
                [], [], 
                ...
                'security',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('segment-routing', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingEnum', 
                [], [], 
                ...
                'segment_routing',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('segment-routing-forwarding', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingForwardingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingForwardingEnum', 
                [], [], 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('srgb', REFERENCE_CLASS, 'Srgb' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope.Srgb', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute.ConnectedOrStaticOrDagrOrSubscriberOrMobileOrRip' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute.ConnectedOrStaticOrDagrOrSubscriberOrMobileOrRip',
            ...
            _MetaInfoClassMember('default-redistributed-route-metric', ATTRIBUTE, 'int' , None, None, 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('eigrp-route-type', REFERENCE_ENUM_CLASS, 'OspfEigrpRouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfEigrpRouteEnum', 
                [], [], 
                '''                EIGRP route type
                ''',
                'eigrp_route_type',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('isis-levels', REFERENCE_ENUM_CLASS, 'OspfRouteLevelEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfRouteLevelEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('metric-type', REFERENCE_ENUM_CLASS, 'OspfLinkStateMetricEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfLinkStateMetricEnum', 
                ...
                'metric_type',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ospf-external', REFERENCE_ENUM_CLASS, 'OspfRouteLevelEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfRouteLevelEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('ospf-internal', ATTRIBUTE, 'bool' , None, None, 
                ...
                'ospf_internal',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ospf-nssa-level', REFERENCE_ENUM_CLASS, 'OspfRouteLevelEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfRouteLevelEnum', 
                [], [], 
                '''                OSPF NSSA external route types
                ''',
                'ospf_nssa_level',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ospf-redist-lsa-type', REFERENCE_ENUM_CLASS, 'OspfRedistLsaEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfRedistLsaEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute',
            False, 
            [
            _MetaInfoClassMember('protocol-name', REFERENCE_ENUM_CLASS, 'OspfRedistProtocolEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfRedistProtocolEnum', 
                [], [], 
                '''                Distribute list protocol type
                ''',
                'protocol_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('application-or-isis-or-ospf', REFERENCE_LIST, 'ApplicationOrIsisOrOspf' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute.ApplicationOrIsisOrOspf', 
                [], [], 
                '''                application or isis or ospf
                ''',
                'application_or_isis_or_ospf',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bgp', REFERENCE_LIST, 'Bgp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute.Bgp', 
                [], [], 
                '''                bgp
                ''',
                'bgp',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('connected-or-static-or-dagr-or-subscriber-or-mobile-or-rip', REFERENCE_CLASS, 'ConnectedOrStaticOrDagrOrSubscriberOrMobileOrRip' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute.ConnectedOrStaticOrDagrOrSubscriberOrMobileOrRip', 
                [], [], 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('eigrp', REFERENCE_LIST, 'Eigrp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute.Eigrp', 
                [], [], 
                '''                eigrp
                ''',
                'eigrp',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes',
            False, 
            [
            _MetaInfoClassMember('redistribute', REFERENCE_LIST, 'Redistribute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes.Redistribute', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Redistribution' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Redistribution',
            False, 
            [
            _MetaInfoClassMember('redistributes', REFERENCE_CLASS, 'Redistributes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution.Redistributes', 
                [], [], 
                '''                Redistribute information from another routing
                protocol
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Ucmp.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Ucmp.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Ucmp.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Ucmp' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Ucmp',
            ...
            _MetaInfoClassMember('delay-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'delay_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('enable', REFERENCE_CLASS, 'Enable' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Ucmp.Enable', 
                [], [], 
                '''                UCMP feature enable configuration
                ''',
                'enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Ucmp.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('priority', REFERENCE_ENUM_CLASS, 'OspfFastReroutePriorityEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastReroutePriorityEnum', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix.Tiebreakers.Tiebreaker' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix.Tiebreakers.Tiebreaker',
            False, 
            [
            _MetaInfoClassMember('tiebreaker-type', REFERENCE_ENUM_CLASS, 'OspfFastRerouteTiebreakersEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteTiebreakersEnum', 
                [], [], 
                '''                Tiebreaker type
                ''',
                'tiebreaker_type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix.Tiebreakers' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix.Tiebreakers',
            False, 
            [
            _MetaInfoClassMember('tiebreaker', REFERENCE_LIST, 'Tiebreaker' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix.Tiebreakers.Tiebreaker', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix',
            ...
            _MetaInfoClassMember('priority', REFERENCE_ENUM_CLASS, 'OspfFastReroutePriorityEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastReroutePriorityEnum', 
                ...
                'priority',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('tiebreakers', REFERENCE_CLASS, 'Tiebreakers' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix.Tiebreakers', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.FastReroute',
            False, 
            [
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link global configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.FastReroute.PerPrefix', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes',
            False, 
            [
            _MetaInfoClassMember('netmask', REFERENCE_LIST, 'Netmask' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes.Netmask', 
                [], [], 
                '''                keys: netmask
                ''',
                'netmask',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix', REFERENCE_LIST, 'Prefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes.Prefix', 
                [], [], 
                '''                keys: prefix
                ''',
                'prefix',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix-and-netmask', REFERENCE_LIST, 'PrefixAndNetmask' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes.PrefixAndNetmask', 
                [], [], 
                '''                keys: prefix, netmask
                ''',
                'prefix_and_netmask',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('summary-prefix-data', REFERENCE_CLASS, 'SummaryPrefixData' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes.SummaryPrefixData', 
                [], [], 
                '''                Data container.
                ''',
                'summary_prefix_data',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.OutgoingRouteUpdates.OutgoingRouteUpdate' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.OutgoingRouteUpdates.OutgoingRouteUpdate',
            False, 
            [
            _MetaInfoClassMember('protocol-name', REFERENCE_ENUM_CLASS, 'OspfDistListProtocolEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfDistListProtocolEnum', 
                [], [], 
                '''                Distribute list protocol type
                ''',
                'protocol_name',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.OutgoingRouteUpdates' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.OutgoingRouteUpdates',
            False, 
            [
            _MetaInfoClassMember('outgoing-route-update', REFERENCE_LIST, 'OutgoingRouteUpdate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.OutgoingRouteUpdates.OutgoingRouteUpdate', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Distance.IpDistances' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Distance.IpDistances',
            False, 
            [
            _MetaInfoClassMember('ip-distance', REFERENCE_LIST, 'IpDistance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Distance.IpDistances.IpDistance', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Distance' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Distance',
            ...
            _MetaInfoClassMember('admin-distance', ATTRIBUTE, 'int' , None, None, 
                ...
                'admin_distance',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ip-distances', REFERENCE_CLASS, 'IpDistances' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Distance.IpDistances', 
                [], [], 
                ...
                'ip_distances',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ospf-distance', REFERENCE_CLASS, 'OspfDistance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Distance.OspfDistance', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope',
            ...
            _MetaInfoClassMember('address', ATTRIBUTE, 'str' , None, None, 
                ...
                'address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes',
            False, 
            [
            _MetaInfoClassMember('virtual-link-scope', REFERENCE_LIST, 'VirtualLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope',
            ...
            _MetaInfoClassMember('source-address', ATTRIBUTE, 'str' , None, None, 
                ...
                'source_address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes',
            False, 
            [
            _MetaInfoClassMember('sham-link-scope', REFERENCE_LIST, 'ShamLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope',
            False, 
            [
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('retransmit-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'retransmit_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.PrefixSid' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.PrefixSid',
            ...
            _MetaInfoClassMember('sid-value', ATTRIBUTE, 'int' , None, None, 
                ...
                'sid_value',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_ENUM_CLASS, 'OspfSidEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSidEnum', 
                [], [], 
                '''                OSPF SID Type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors.Neighbor', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors', 
                [], [], 
            ...
            _MetaInfoClassMember('passive', ATTRIBUTE, 'bool' , None, None, 
                ...
                'passive',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix-sid', REFERENCE_CLASS, 'PrefixSid' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.PrefixSid', 
                [], [], 
                '''                Prefix SID
                ''',
                'prefix_sid',
            ...
            _MetaInfoClassMember('running', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'running',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes',
            False, 
            [
            _MetaInfoClassMember('name-scope', REFERENCE_LIST, 'NameScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes.NameScope', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes',
            False, 
            [
            _MetaInfoClassMember('multi-area-interface-scope', REFERENCE_LIST, 'MultiAreaInterfaceScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaRanges' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaRanges',
            False, 
            [
            _MetaInfoClassMember('area-range', REFERENCE_LIST, 'AreaRange' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaRanges.AreaRange', 
                [], [], 
                '''                Ordering index
                ''',
                'area_range',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress',
            ...
            _MetaInfoClassMember('address', ATTRIBUTE, 'str' , None, None, 
                ...
                'address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('area-ranges', REFERENCE_CLASS, 'AreaRanges' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaRanges', 
                [], [], 
                ...
                'area_ranges',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-scope', REFERENCE_CLASS, 'AreaScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.AreaScope', 
                [], [], 
            ...
            _MetaInfoClassMember('mpls-traffic-eng', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'mpls_traffic_eng',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('multi-area-interface-scopes', REFERENCE_CLASS, 'MultiAreaInterfaceScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes', 
                [], [], 
                '''                Multi Area Interface scope configurations
                ''',
                'multi_area_interface_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('name-scopes', REFERENCE_CLASS, 'NameScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.NameScopes', 
                [], [], 
                '''                Name scope configurations
                ''',
                'name_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('nssa', REFERENCE_CLASS, 'Nssa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.Nssa', 
                [], [], 
            ...
            _MetaInfoClassMember('segment-routing', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingEnum', 
                ...
                'segment_routing',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('sham-link-scopes', REFERENCE_CLASS, 'ShamLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.ShamLinkScopes', 
                [], [], 
            ...
            _MetaInfoClassMember('summary-in', ATTRIBUTE, 'bool' , None, None, 
                ...
                'summary_in',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('virtual-link-scopes', REFERENCE_CLASS, 'VirtualLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress.VirtualLinkScopes', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope',
            ...
            _MetaInfoClassMember('address', ATTRIBUTE, 'str' , None, None, 
                ...
                'address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes',
            False, 
            [
            _MetaInfoClassMember('virtual-link-scope', REFERENCE_LIST, 'VirtualLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope', 
                [], [], 
                '''                Virtual Link configuration
                ''',
                'virtual_link_scope',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope',
            ...
            _MetaInfoClassMember('source-address', ATTRIBUTE, 'str' , None, None, 
                ...
                'source_address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes',
            False, 
            [
            _MetaInfoClassMember('sham-link-scope', REFERENCE_LIST, 'ShamLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope', 
                [], [], 
                '''                Sham Link configuration
                ''',
                'sham_link_scope',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope',
            False, 
            [
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('retransmit-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'retransmit_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
            ...
            _MetaInfoClassMember('passive', ATTRIBUTE, 'bool' , None, None, 
                ...
                'passive',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix-sid', REFERENCE_CLASS, 'PrefixSid' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.PrefixSid', 
                [], [], 
                '''                Prefix SID
                ''',
                'prefix_sid',
            ...
            _MetaInfoClassMember('running', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'running',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes',
            False, 
            [
            _MetaInfoClassMember('name-scope', REFERENCE_LIST, 'NameScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes.NameScope', 
                [], [], 
                '''                Name scope configuration
                ''',
                'name_scope',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes',
            False, 
            [
            _MetaInfoClassMember('multi-area-interface-scope', REFERENCE_LIST, 'MultiAreaInterfaceScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope', 
                [], [], 
                '''                Multi Area Interface configuration
                ''',
                'multi_area_interface_scope',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaRanges' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaRanges',
            False, 
            [
            _MetaInfoClassMember('area-range', REFERENCE_LIST, 'AreaRange' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaRanges.AreaRange', 
                [], [], 
                '''                Ordering index
                ''',
                'area_range',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId',
            ...
            _MetaInfoClassMember('area-id', ATTRIBUTE, 'int' , None, None, 
                ...
                'area_id',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('area-ranges', REFERENCE_CLASS, 'AreaRanges' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaRanges', 
                [], [], 
                '''                Summarize routes matching address/mask (border
                routers only)
                ''',
                'area_ranges',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-scope', REFERENCE_CLASS, 'AreaScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.AreaScope', 
                [], [], 
                '''                Area scope configuration
                ''',
                'area_scope',
            ...
            _MetaInfoClassMember('mpls-traffic-eng', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'mpls_traffic_eng',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('multi-area-interface-scopes', REFERENCE_CLASS, 'MultiAreaInterfaceScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes', 
                [], [], 
                '''                Multi Area Interface scope configurations
                ''',
                'multi_area_interface_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('name-scopes', REFERENCE_CLASS, 'NameScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.NameScopes', 
                [], [], 
                '''                Name scope configurations
                ''',
                'name_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('nssa', REFERENCE_CLASS, 'Nssa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.Nssa', 
                [], [], 
                '''                Specify area as a NSSA area
                ''',
                'nssa',
            ...
            _MetaInfoClassMember('segment-routing', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingEnum', 
                ...
                'segment_routing',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('sham-link-scopes', REFERENCE_CLASS, 'ShamLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.ShamLinkScopes', 
                [], [], 
                '''                Sham Link scope configurations
                ''',
                'sham_link_scopes',
            ...
            _MetaInfoClassMember('summary-in', ATTRIBUTE, 'bool' , None, None, 
                ...
                'summary_in',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('virtual-link-scopes', REFERENCE_CLASS, 'VirtualLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId.VirtualLinkScopes', 
                [], [], 
                '''                Virtual Link scope configurations
                ''',
                'virtual_link_scopes',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses',
            False, 
            [
            _MetaInfoClassMember('area-address', REFERENCE_LIST, 'AreaAddress' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAddress', 
                [], [], 
                '''                Configuration for a particular area
                ''',
                'area_address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-area-id', REFERENCE_LIST, 'AreaAreaId' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses.AreaAreaId', 
                [], [], 
                '''                Configuration for a particular area
                ''',
                'area_area_id',
    ...
    'Ospf.Processes.Process.Vrfs.Vrf.Timers' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf.Timers',
            ...
            _MetaInfoClassMember('fast-reroute-timer', ATTRIBUTE, 'int' , None, None, 
                ...
                'fast_reroute_timer',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('lsa-generation-timer', REFERENCE_CLASS, 'LsaGenerationTimer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Timers.LsaGenerationTimer', 
                [], [], 
            ...
            _MetaInfoClassMember('lsa-refresh', ATTRIBUTE, 'int' , None, None, 
                ...
                'lsa_refresh',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('spf-timer', REFERENCE_CLASS, 'SpfTimer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Timers.SpfTimer', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs.Vrf' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs.Vrf',
            ...
            _MetaInfoClassMember('vrf-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'vrf_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('adjacency-changes', REFERENCE_ENUM_CLASS, 'OspfLogAdjEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfLogAdjEnum', 
                [], [], 
                '''                Log changes in adjacency state
                ''',
                'adjacency_changes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('adjacency-stagger', REFERENCE_CLASS, 'AdjacencyStagger' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AdjacencyStagger', 
                [], [], 
                '''                Staggering OSPF adjacency bring up
                ''',
                'adjacency_stagger',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('af', REFERENCE_CLASS, 'Af' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Af', 
                [], [], 
                '''                OSPF address family
                ''',
                'af',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-addresses', REFERENCE_CLASS, 'AreaAddresses' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AreaAddresses', 
                [], [], 
                '''                Area configuration
                ''',
                'area_addresses',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('auto-cost', REFERENCE_CLASS, 'AutoCost' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.AutoCost', 
                [], [], 
                '''                Controls automatic cost based on bandwidth
                ''',
                'auto_cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('default-information', REFERENCE_CLASS, 'DefaultInformation' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.DefaultInformation', 
                [], [], 
            ...
            _MetaInfoClassMember('disable-dn-bit-check', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distance', REFERENCE_CLASS, 'Distance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Distance', 
                [], [], 
                '''                Administrative distance configuration
                ''',
                'distance',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('domain-id', REFERENCE_CLASS, 'DomainId' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.DomainId', 
                [], [], 
                '''                OSPF Domain ID
                ''',
                'domain_id',
            ...
            _MetaInfoClassMember('domain-tag', ATTRIBUTE, 'int' , None, None, 
                ...
                'domain_tag',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.FastReroute', 
                [], [], 
            ...
            _MetaInfoClassMember('ignore-mospf', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'ignore_mospf',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-lsa', REFERENCE_CLASS, 'MaxLsa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxLsa', 
                [], [], 
                '''                Set max-lsa configuration
                ''',
                'max_lsa',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric', REFERENCE_CLASS, 'MaxMetric' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaxMetric', 
                [], [], 
            ...
            _MetaInfoClassMember('maximum-paths', ATTRIBUTE, 'int' , None, None, 
                ...
                'maximum_paths',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('maximum-redistribute-prefix', REFERENCE_CLASS, 'MaximumRedistributePrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.MaximumRedistributePrefix', 
                [], [], 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('microloop', REFERENCE_CLASS, 'Microloop' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Microloop', 
                [], [], 
            ...
            _MetaInfoClassMember('no-opaque', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'no_opaque',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('nsf', REFERENCE_CLASS, 'Nsf' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Nsf', 
                [], [], 
                '''                Non Stop Forwarding configuration
                ''',
                'nsf',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('outgoing-route-updates', REFERENCE_CLASS, 'OutgoingRouteUpdates' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.OutgoingRouteUpdates', 
                [], [], 
                '''                Filter outgoing routing updates
                ''',
                'outgoing_route_updates',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('process-scope', REFERENCE_CLASS, 'ProcessScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.ProcessScope', 
                [], [], 
                '''                Process scope configuration
                ''',
                'process_scope',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('queue', REFERENCE_CLASS, 'Queue' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Queue', 
                [], [], 
                ...
                'queue',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('redistribution', REFERENCE_CLASS, 'Redistribution' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Redistribution', 
                [], [], 
            ...
            _MetaInfoClassMember('spf-prefix-priority', ATTRIBUTE, 'str' , None, None, 
                ...
                'spf_prefix_priority',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('summary-prefixes', REFERENCE_CLASS, 'SummaryPrefixes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.SummaryPrefixes', 
                [], [], 
                '''                Configure IP prefix summary
                ''',
                'summary_prefixes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('timers', REFERENCE_CLASS, 'Timers' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Timers', 
                [], [], 
            ...
            _MetaInfoClassMember('type7', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'type7',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ucmp', REFERENCE_CLASS, 'Ucmp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf.Ucmp', 
                [], [], 
    ...
    'Ospf.Processes.Process.Vrfs' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.Vrfs',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs.Vrf', 
                [], [], 
    ...
    'Ospf.Processes.Process.DefaultVrf.SegmentRouting' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.SegmentRouting',
            ...
            _MetaInfoClassMember('prefix-sid-map-receive-disable', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('sr-prefer', REFERENCE_CLASS, 'SrPrefer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SegmentRouting.SrPrefer', 
                [], [], 
    ...
    'Ospf.Processes.Process.DefaultVrf.Mpls' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Mpls',
            ...
            _MetaInfoClassMember('ldp-sync-update', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'ldp_sync_update',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('mpls-router-id', REFERENCE_CLASS, 'MplsRouterId' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Mpls.MplsRouterId', 
                [], [], 
    ...
    'Ospf.Processes.Process.DefaultVrf.Microloop' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Microloop',
            False, 
            [
            _MetaInfoClassMember('avoidance', REFERENCE_CLASS, 'Avoidance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Microloop.Avoidance', 
                [], [], 
                '''                Microloop avoidance configuration
                ''',
                'avoidance',
    ...
    'Ospf.Processes.Process.DefaultVrf.MaxMetric' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.MaxMetric',
            False, 
            [
            _MetaInfoClassMember('max-metric-always', REFERENCE_CLASS, 'MaxMetricAlways' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxMetric.MaxMetricAlways', 
                [], [], 
                '''                Set maximum metric always configuration
                ''',
                'max_metric_always',
            ...
            _MetaInfoClassMember('max-metric-no-abr-off', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'max_metric_no_abr_off',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-proc-migration', REFERENCE_CLASS, 'MaxMetricOnProcMigration' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxMetric.MaxMetricOnProcMigration', 
                [], [], 
                '''                Set maximum metric on-proc-migration
                configuration
                ''',
                'max_metric_on_proc_migration',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-proc-restart', REFERENCE_CLASS, 'MaxMetricOnProcRestart' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxMetric.MaxMetricOnProcRestart', 
                [], [], 
                '''                Set maximum metric on-proc-restart
                configuration
                ''',
                'max_metric_on_proc_restart',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-startup', REFERENCE_CLASS, 'MaxMetricOnStartup' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxMetric.MaxMetricOnStartup', 
                [], [], 
                '''                Set maximum metric on-startup configuration
                ''',
                'max_metric_on_startup',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric-on-switchover', REFERENCE_CLASS, 'MaxMetricOnSwitchover' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxMetric.MaxMetricOnSwitchover', 
                [], [], 
                '''                Set maximum metric on-switchover configuration
                ''',
                'max_metric_on_switchover',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.DefaultVrf.ProcessScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.ProcessScope',
            False, 
            [
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
            ...
            _MetaInfoClassMember('external-out', ATTRIBUTE, 'bool' , None, None, 
                ...
                'external_out',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('retransmit-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'retransmit_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
            ...
            _MetaInfoClassMember('segment-routing-forwarding', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingForwardingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingForwardingEnum', 
                ...
                'segment_routing_forwarding',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('srgb', REFERENCE_CLASS, 'Srgb' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope.Srgb', 
                [], [], 
                '''                Segment Routing Global Block configuration
                ''',
                'srgb',
    ...
    'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute',
            ...
            _MetaInfoClassMember('protocol-name', REFERENCE_ENUM_CLASS, 'OspfRedistProtocolEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfRedistProtocolEnum', 
                ...
                'protocol_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('application-or-isis-or-ospf', REFERENCE_LIST, 'ApplicationOrIsisOrOspf' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute.ApplicationOrIsisOrOspf', 
                [], [], 
                '''                application or isis or ospf
                ''',
                'application_or_isis_or_ospf',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bgp', REFERENCE_LIST, 'Bgp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute.Bgp', 
                [], [], 
                '''                bgp
                ''',
                'bgp',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('connected-or-static-or-dagr-or-subscriber-or-mobile-or-rip', REFERENCE_CLASS, 'ConnectedOrStaticOrDagrOrSubscriberOrMobileOrRip' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute.ConnectedOrStaticOrDagrOrSubscriberOrMobileOrRip', 
                [], [], 
                '''                connected or static or dagr or subscriber or
                mobile or rip
                ''',
                'connected_or_static_or_dagr_or_subscriber_or_mobile_or_rip',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('eigrp', REFERENCE_LIST, 'Eigrp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute.Eigrp', 
                [], [], 
                '''                eigrp
                ''',
                'eigrp',
    ...
    'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes',
            False, 
            [
            _MetaInfoClassMember('redistribute', REFERENCE_LIST, 'Redistribute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes.Redistribute', 
                [], [], 
                '''                Redistribute information from another routing
                protocol
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.Redistribution' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Redistribution',
            False, 
            [
            _MetaInfoClassMember('redistributes', REFERENCE_CLASS, 'Redistributes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution.Redistributes', 
                [], [], 
                '''                Redistribute information from another routing
                protocol
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.Ucmp.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Ucmp.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Ucmp.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.Ucmp' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Ucmp',
            ...
            _MetaInfoClassMember('delay-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'delay_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('enable', REFERENCE_CLASS, 'Enable' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Ucmp.Enable', 
                [], [], 
                '''                UCMP feature enable configuration
                ''',
                'enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Ucmp.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix.Tiebreakers' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix.Tiebreakers',
            False, 
            [
            _MetaInfoClassMember('tiebreaker', REFERENCE_LIST, 'Tiebreaker' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix.Tiebreakers.Tiebreaker', 
                [], [], 
                '''                Fast-reroute tiebreakers configuration
                ''',
                'tiebreaker',
    ...
    'Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix',
            ...
            _MetaInfoClassMember('priority', REFERENCE_ENUM_CLASS, 'OspfFastReroutePriorityEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastReroutePriorityEnum', 
                ...
                'priority',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('tiebreakers', REFERENCE_CLASS, 'Tiebreakers' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix.Tiebreakers', 
                [], [], 
                '''                Fast-reroute tiebreakers configurations
                ''',
                'tiebreakers',
    ...
    'Ospf.Processes.Process.DefaultVrf.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.FastReroute',
            False, 
            [
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link global configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix global configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.DefaultVrf.SummaryPrefixes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.SummaryPrefixes',
            False, 
            [
            _MetaInfoClassMember('netmask', REFERENCE_LIST, 'Netmask' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SummaryPrefixes.Netmask', 
                [], [], 
                '''                keys: netmask
                ''',
                'netmask',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix', REFERENCE_LIST, 'Prefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SummaryPrefixes.Prefix', 
                [], [], 
                '''                keys: prefix
                ''',
                'prefix',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix-and-netmask', REFERENCE_LIST, 'PrefixAndNetmask' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SummaryPrefixes.PrefixAndNetmask', 
                [], [], 
                '''                keys: prefix, netmask
                ''',
                'prefix_and_netmask',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('summary-prefix-data', REFERENCE_CLASS, 'SummaryPrefixData' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SummaryPrefixes.SummaryPrefixData', 
                [], [], 
                '''                Data container.
                ''',
                'summary_prefix_data',
    ...
    'Ospf.Processes.Process.DefaultVrf.OutgoingRouteUpdates' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.OutgoingRouteUpdates',
            False, 
            [
            _MetaInfoClassMember('outgoing-route-update', REFERENCE_LIST, 'OutgoingRouteUpdate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.OutgoingRouteUpdates.OutgoingRouteUpdate', 
                [], [], 
                '''                Filter outgoing routing updates for a
                particular protocol
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.Distance.IpDistances' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Distance.IpDistances',
            False, 
            [
            _MetaInfoClassMember('ip-distance', REFERENCE_LIST, 'IpDistance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Distance.IpDistances.IpDistance', 
                [], [], 
                '''                Administrative distance configuration for a
                particular IP address
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.Distance' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Distance',
            ...
            _MetaInfoClassMember('admin-distance', ATTRIBUTE, 'int' , None, None, 
                ...
                'admin_distance',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ip-distances', REFERENCE_CLASS, 'IpDistances' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Distance.IpDistances', 
                [], [], 
                '''                IP specific administrative distance
                configuration
                ''',
                'ip_distances',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ospf-distance', REFERENCE_CLASS, 'OspfDistance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Distance.OspfDistance', 
                [], [], 
                '''                OSPF distance configuration
                ''',
                'ospf_distance',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope',
            ...
            _MetaInfoClassMember('address', ATTRIBUTE, 'str' , None, None, 
                ...
                'address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes',
            False, 
            [
            _MetaInfoClassMember('virtual-link-scope', REFERENCE_LIST, 'VirtualLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes.VirtualLinkScope', 
                [], [], 
                '''                Virtual Link configuration
                ''',
                'virtual_link_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope',
            ...
            _MetaInfoClassMember('source-address', ATTRIBUTE, 'str' , None, None, 
                ...
                'source_address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes',
            False, 
            [
            _MetaInfoClassMember('sham-link-scope', REFERENCE_LIST, 'ShamLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes.ShamLinkScope', 
                [], [], 
                '''                Sham Link configuration
                ''',
                'sham_link_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope',
            False, 
            [
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('retransmit-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'retransmit_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
            ...
            _MetaInfoClassMember('passive', ATTRIBUTE, 'bool' , None, None, 
                ...
                'passive',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix-sid', REFERENCE_CLASS, 'PrefixSid' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.PrefixSid', 
                [], [], 
                '''                Prefix SID
                ''',
                'prefix_sid',
            ...
            _MetaInfoClassMember('running', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'running',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes',
            False, 
            [
            _MetaInfoClassMember('name-scope', REFERENCE_LIST, 'NameScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes.NameScope', 
                [], [], 
                '''                Name scope configuration
                ''',
                'name_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes',
            False, 
            [
            _MetaInfoClassMember('multi-area-interface-scope', REFERENCE_LIST, 'MultiAreaInterfaceScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes.MultiAreaInterfaceScope', 
                [], [], 
                '''                Multi Area Interface configuration
                ''',
                'multi_area_interface_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaRanges' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaRanges',
            False, 
            [
            _MetaInfoClassMember('area-range', REFERENCE_LIST, 'AreaRange' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaRanges.AreaRange', 
                [], [], 
                '''                Ordering index
                ''',
                'area_range',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress',
            ...
            _MetaInfoClassMember('address', ATTRIBUTE, 'str' , None, None, 
                ...
                'address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('area-ranges', REFERENCE_CLASS, 'AreaRanges' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaRanges', 
                [], [], 
                '''                Summarize routes matching address/mask (border
                routers only)
                ''',
                'area_ranges',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-scope', REFERENCE_CLASS, 'AreaScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.AreaScope', 
                [], [], 
                '''                Area scope configuration
                ''',
                'area_scope',
            ...
            _MetaInfoClassMember('mpls-traffic-eng', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'mpls_traffic_eng',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('multi-area-interface-scopes', REFERENCE_CLASS, 'MultiAreaInterfaceScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.MultiAreaInterfaceScopes', 
                [], [], 
                '''                Multi Area Interface scope configurations
                ''',
                'multi_area_interface_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('name-scopes', REFERENCE_CLASS, 'NameScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.NameScopes', 
                [], [], 
                '''                Name scope configurations
                ''',
                'name_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('nssa', REFERENCE_CLASS, 'Nssa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.Nssa', 
                [], [], 
                '''                Specify area as a NSSA area
                ''',
                'nssa',
            ...
            _MetaInfoClassMember('segment-routing', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingEnum', 
                ...
                'segment_routing',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('sham-link-scopes', REFERENCE_CLASS, 'ShamLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.ShamLinkScopes', 
                [], [], 
                '''                Sham Link scope configurations
                ''',
                'sham_link_scopes',
            ...
            _MetaInfoClassMember('summary-in', ATTRIBUTE, 'bool' , None, None, 
                ...
                'summary_in',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('virtual-link-scopes', REFERENCE_CLASS, 'VirtualLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress.VirtualLinkScopes', 
                [], [], 
                '''                Virtual Link scope configurations
                ''',
                'virtual_link_scopes',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope',
            ...
            _MetaInfoClassMember('address', ATTRIBUTE, 'str' , None, None, 
                ...
                'address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes',
            False, 
            [
            _MetaInfoClassMember('virtual-link-scope', REFERENCE_LIST, 'VirtualLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes.VirtualLinkScope', 
                [], [], 
                '''                Virtual Link configuration
                ''',
                'virtual_link_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope',
            ...
            _MetaInfoClassMember('source-address', ATTRIBUTE, 'str' , None, None, 
                ...
                'source_address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes',
            False, 
            [
            _MetaInfoClassMember('sham-link-scope', REFERENCE_LIST, 'ShamLinkScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes.ShamLinkScope', 
                [], [], 
                '''                Sham Link configuration
                ''',
                'sham_link_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope',
            False, 
            [
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('retransmit-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'retransmit_interval',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security',
            False, 
            [
            _MetaInfoClassMember('ttl', REFERENCE_CLASS, 'Ttl' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security.Ttl', 
                [], [], 
                '''                Enabling turns on TTL security
                ''',
                'ttl',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces',
            False, 
            [
            _MetaInfoClassMember('candidate-interface', REFERENCE_LIST, 'CandidateInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces.CandidateInterface', 
                [], [], 
                '''                Candidate backup interface
                ''',
                'candidate_interface',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces',
            False, 
            [
            _MetaInfoClassMember('exclude-interface', REFERENCE_LIST, 'ExcludeInterface' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces.ExcludeInterface', 
                [], [], 
                '''                Exclude an interface from becoming a backup or
                UCMP
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix',
            False, 
            [
            _MetaInfoClassMember('candidate-interfaces', REFERENCE_CLASS, 'CandidateInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.CandidateInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix candidate
                interface configuration
                ''',
                'candidate_interfaces',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('exclude-interfaces', REFERENCE_CLASS, 'ExcludeInterfaces' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.ExcludeInterfaces', 
                [], [], 
                '''                Fast-reroute per-link/per-prefix or UCMP exclude
                interface configuration
                ''',
            ...
            _MetaInfoClassMember('fast-reroute-use-candidate-only', ATTRIBUTE, 'bool' , None, None, 
                ...
                'fast_reroute_use_candidate_only',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix.RemoteLfa', 
                [], [], 
                '''                Remote LFA configuration
                ''',
                'remote_lfa',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute',
            ...
            _MetaInfoClassMember('fast-reroute-enable', REFERENCE_ENUM_CLASS, 'OspfFastRerouteEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfFastRerouteEnum', 
                ...
                'fast_reroute_enable',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-link', REFERENCE_CLASS, 'PerLink' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerLink', 
                [], [], 
                '''                Fast-reroute per-link configuration
                ''',
                'per_link',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('per-prefix', REFERENCE_CLASS, 'PerPrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute.PerPrefix', 
                [], [], 
                '''                Fast-reroute per-prefix configuration
                ''',
                'per_prefix',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('bfd', REFERENCE_CLASS, 'Bfd' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Bfd', 
                [], [], 
                '''                BFD configuration
                ''',
                'bfd',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
            ...
            _MetaInfoClassMember('demand-circuit', ATTRIBUTE, 'bool' , None, None, 
                ...
                'demand_circuit',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
                'distribute_list',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.FastReroute', 
                [], [], 
                '''                Fast-reroute configuration
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
            ...
            _MetaInfoClassMember('passive', ATTRIBUTE, 'bool' , None, None, 
                ...
                'passive',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('prefix-sid', REFERENCE_CLASS, 'PrefixSid' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.PrefixSid', 
                [], [], 
                '''                Prefix SID
                ''',
                'prefix_sid',
            ...
            _MetaInfoClassMember('running', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'running',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('security', REFERENCE_CLASS, 'Security' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope.Security', 
                [], [], 
                '''                Container class for security related
                configuration parameters
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes',
            False, 
            [
            _MetaInfoClassMember('name-scope', REFERENCE_LIST, 'NameScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes.NameScope', 
                [], [], 
                '''                Name scope configuration
                ''',
                'name_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies',
            False, 
            [
            _MetaInfoClassMember('message-digest-key', REFERENCE_LIST, 'MessageDigestKey' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies.MessageDigestKey', 
                [], [], 
                '''                Message digest authentication password (key)
                configuration
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication',
            ...
            _MetaInfoClassMember('key', ATTRIBUTE, 'str' , None, None, 
                ...
                'key',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('message-digest-keies', REFERENCE_CLASS, 'MessageDigestKeies' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.MessageDigestKeies', 
                [], [], 
                '''                Message digest authentication password (key)
                configurations, first 16 chars used
                ''',
                'message_digest_keies',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication.Type', 
                [], [], 
                '''                Authentication type
                ''',
                'type',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors.Neighbor', 
                [], [], 
                '''                Router configuration information for a
                particular neighbor
                ''',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Authentication', 
                [], [], 
                '''                Authentication
                ''',
                'authentication',
            ...
            _MetaInfoClassMember('cost', ATTRIBUTE, 'int' , None, None, 
                ...
                'cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('cost-fallback', REFERENCE_CLASS, 'CostFallback' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.CostFallback', 
                [], [], 
                '''                Interface fallback cost
                ''',
                'cost_fallback',
            ...
            _MetaInfoClassMember('database-filter', ATTRIBUTE, 'bool' , None, None, 
                ...
                'database_filter',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('dead-interval-minimal', REFERENCE_CLASS, 'DeadIntervalMinimal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DeadIntervalMinimal', 
                [], [], 
                '''                Interval after which a neighbor is declared dead
                ''',
                'dead_interval_minimal',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distribute-list', REFERENCE_CLASS, 'DistributeList' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.DistributeList', 
                [], [], 
                '''                Filter networks intalled to RIB (disable as ACL
                name means filtering is disabled)
                ''',
            ...
            _MetaInfoClassMember('mtu-ignore', ATTRIBUTE, 'bool' , None, None, 
                ...
                'mtu_ignore',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope.Neighbors', 
                [], [], 
                '''                Neighbor router configuration information
                ''',
                'neighbors',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes',
            False, 
            [
            _MetaInfoClassMember('multi-area-interface-scope', REFERENCE_LIST, 'MultiAreaInterfaceScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes.MultiAreaInterfaceScope', 
                [], [], 
                '''                Multi Area Interface configuration
                ''',
                'multi_area_interface_scope',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaRanges' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaRanges',
            False, 
            [
            _MetaInfoClassMember('area-range', REFERENCE_LIST, 'AreaRange' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaRanges.AreaRange', 
                [], [], 
                '''                Ordering index
                ''',
                'area_range',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId',
            ...
            _MetaInfoClassMember('area-id', ATTRIBUTE, 'int' , None, None, 
                ...
                'area_id',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('area-ranges', REFERENCE_CLASS, 'AreaRanges' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaRanges', 
                [], [], 
                '''                Summarize routes matching address/mask (border
                routers only)
                ''',
                'area_ranges',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-scope', REFERENCE_CLASS, 'AreaScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.AreaScope', 
                [], [], 
                '''                Area scope configuration
                ''',
                'area_scope',
            ...
            _MetaInfoClassMember('mpls-traffic-eng', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'mpls_traffic_eng',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('multi-area-interface-scopes', REFERENCE_CLASS, 'MultiAreaInterfaceScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.MultiAreaInterfaceScopes', 
                [], [], 
                '''                Multi Area Interface scope configurations
                ''',
                'multi_area_interface_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('name-scopes', REFERENCE_CLASS, 'NameScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.NameScopes', 
                [], [], 
                '''                Name scope configurations
                ''',
                'name_scopes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('nssa', REFERENCE_CLASS, 'Nssa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.Nssa', 
                [], [], 
                '''                Specify area as a NSSA area
                ''',
                'nssa',
            ...
            _MetaInfoClassMember('segment-routing', REFERENCE_ENUM_CLASS, 'OspfSegmentRoutingEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfSegmentRoutingEnum', 
                ...
                'segment_routing',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('sham-link-scopes', REFERENCE_CLASS, 'ShamLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.ShamLinkScopes', 
                [], [], 
                '''                Sham Link scope configurations
                ''',
                'sham_link_scopes',
            ...
            _MetaInfoClassMember('summary-in', ATTRIBUTE, 'bool' , None, None, 
                ...
                'summary_in',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('virtual-link-scopes', REFERENCE_CLASS, 'VirtualLinkScopes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId.VirtualLinkScopes', 
                [], [], 
                '''                Virtual Link scope configurations
                ''',
                'virtual_link_scopes',
    ...
    'Ospf.Processes.Process.DefaultVrf.AreaAddresses' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.AreaAddresses',
            False, 
            [
            _MetaInfoClassMember('area-address', REFERENCE_LIST, 'AreaAddress' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAddress', 
                [], [], 
                '''                Configuration for a particular area
                ''',
                'area_address',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-area-id', REFERENCE_LIST, 'AreaAreaId' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses.AreaAreaId', 
                [], [], 
                '''                Configuration for a particular area
                ''',
                'area_area_id',
    ...
    'Ospf.Processes.Process.DefaultVrf.Timers' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf.Timers',
            ...
            _MetaInfoClassMember('fast-reroute-timer', ATTRIBUTE, 'int' , None, None, 
                ...
                'fast_reroute_timer',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('lsa-generation-timer', REFERENCE_CLASS, 'LsaGenerationTimer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Timers.LsaGenerationTimer', 
                [], [], 
                '''                OSPF LSA timers (in milliseconds)
                ''',
                'lsa_generation_timer',
            ...
            _MetaInfoClassMember('lsa-refresh', ATTRIBUTE, 'int' , None, None, 
                ...
                'lsa_refresh',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('spf-timer', REFERENCE_CLASS, 'SpfTimer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Timers.SpfTimer', 
                [], [], 
                '''                OSPF SPF timers (in milliseconds)
                ''',
                'spf_timer',
    ...
    'Ospf.Processes.Process.DefaultVrf' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process.DefaultVrf',
            ...
            _MetaInfoClassMember('adjacency-changes', REFERENCE_ENUM_CLASS, 'OspfLogAdjEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfLogAdjEnum', 
                ...
                'adjacency_changes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('adjacency-stagger', REFERENCE_CLASS, 'AdjacencyStagger' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AdjacencyStagger', 
                [], [], 
                '''                Staggering OSPF adjacency bring up
                ''',
                'adjacency_stagger',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('af', REFERENCE_CLASS, 'Af' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Af', 
                [], [], 
                '''                OSPF address family
                ''',
                'af',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('area-addresses', REFERENCE_CLASS, 'AreaAddresses' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AreaAddresses', 
                [], [], 
                '''                Area configuration
                ''',
                'area_addresses',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('auto-cost', REFERENCE_CLASS, 'AutoCost' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.AutoCost', 
                [], [], 
                '''                Controls automatic cost based on bandwidth
                ''',
                'auto_cost',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('default-information', REFERENCE_CLASS, 'DefaultInformation' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.DefaultInformation', 
                [], [], 
                '''                Control distribution of default information
                ''',
                'default_information',
            ...
            _MetaInfoClassMember('default-metric', ATTRIBUTE, 'int' , None, None, 
                ...
                'default_metric',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('distance', REFERENCE_CLASS, 'Distance' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Distance', 
                [], [], 
                '''                Administrative distance configuration
                ''',
                'distance',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('fast-reroute', REFERENCE_CLASS, 'FastReroute' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.FastReroute', 
                [], [], 
                '''                Fast-reroute instance scoped parameters
                ''',
                'fast_reroute',
            ...
            _MetaInfoClassMember('ignore-mospf', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'ignore_mospf',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-lsa', REFERENCE_CLASS, 'MaxLsa' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxLsa', 
                [], [], 
                '''                Set max-lsa configuration
                ''',
                'max_lsa',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('max-metric', REFERENCE_CLASS, 'MaxMetric' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaxMetric', 
                [], [], 
                '''                Set maximum metric configuration
                ''',
                'max_metric',
            ...
            _MetaInfoClassMember('maximum-paths', ATTRIBUTE, 'int' , None, None, 
                ...
                'maximum_paths',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('maximum-redistribute-prefix', REFERENCE_CLASS, 'MaximumRedistributePrefix' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MaximumRedistributePrefix', 
                [], [], 
                '''                Maximum number of prefixes redistributed into
                OSPF
                ''',
                'maximum_redistribute_prefix',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('microloop', REFERENCE_CLASS, 'Microloop' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Microloop', 
                [], [], 
                '''                Microloop configuration
                ''',
                'microloop',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('monitor-convergence', REFERENCE_CLASS, 'MonitorConvergence' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.MonitorConvergence', 
                [], [], 
                '''                Enable convergence monitoring
                ''',
                'monitor_convergence',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('mpls', REFERENCE_CLASS, 'Mpls' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Mpls', 
                [], [], 
            ...
            _MetaInfoClassMember('no-opaque', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'no_opaque',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('nsf', REFERENCE_CLASS, 'Nsf' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Nsf', 
                [], [], 
                '''                Non Stop Forwarding configuration
                ''',
                'nsf',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('outgoing-route-updates', REFERENCE_CLASS, 'OutgoingRouteUpdates' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.OutgoingRouteUpdates', 
                [], [], 
                '''                Filter outgoing routing updates
                ''',
                'outgoing_route_updates',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('process-scope', REFERENCE_CLASS, 'ProcessScope' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.ProcessScope', 
                [], [], 
                '''                Process scope configuration
                ''',
                'process_scope',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('queue', REFERENCE_CLASS, 'Queue' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Queue', 
                [], [], 
                '''                Adjust OSPF input queue sizes and processing
                quantums
                ''',
                'queue',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('redistribution', REFERENCE_CLASS, 'Redistribution' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Redistribution', 
                [], [], 
                '''                Redistribute configurations
                ''',
                'redistribution',
            ...
            _MetaInfoClassMember('router-id', ATTRIBUTE, 'str' , None, None, 
                ...
                'router_id',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('segment-routing', REFERENCE_CLASS, 'SegmentRouting' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SegmentRouting', 
                [], [], 
            ...
            _MetaInfoClassMember('spf-prefix-priority', ATTRIBUTE, 'str' , None, None, 
                ...
                'spf_prefix_priority',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('summary-prefixes', REFERENCE_CLASS, 'SummaryPrefixes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.SummaryPrefixes', 
                [], [], 
                '''                Configure IP prefix summary
                ''',
                'summary_prefixes',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('timers', REFERENCE_CLASS, 'Timers' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Timers', 
                [], [], 
                '''                Adjust routing timers
                ''',
                'timers',
            ...
            _MetaInfoClassMember('type7', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'type7',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('ucmp', REFERENCE_CLASS, 'Ucmp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf.Ucmp', 
                [], [], 
                '''                Unequal Cost Multi-ptah configuration
                ''',
                'ucmp',
    ...
    'Ospf.Processes.Process' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes.Process',
            ...
            _MetaInfoClassMember('process-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'process_name',
                'Cisco-IOS-XR-ipv4-ospf-cfg', True),
            _MetaInfoClassMember('default-vrf', REFERENCE_CLASS, 'DefaultVrf' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.DefaultVrf', 
                [], [], 
            ...
            _MetaInfoClassMember('nsr', REFERENCE_ENUM_CLASS, 'NsrEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'NsrEnum', 
                ...
                'nsr',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('protocol-shutdown', REFERENCE_ENUM_CLASS, 'OspfShutdownEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'OspfShutdownEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('running', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'running',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('snmp', REFERENCE_CLASS, 'Snmp' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Snmp', 
                [], [], 
            ...
            _MetaInfoClassMember('start', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'start',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('vrfs', REFERENCE_CLASS, 'Vrfs' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process.Vrfs', 
                [], [], 
    ...
    'Ospf.Processes' : {
        'meta_info' : _MetaInfoClass('Ospf.Processes',
            False, 
            [
            _MetaInfoClassMember('process', REFERENCE_LIST, 'Process' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes.Process', 
                [], [], 
    ...
    'Ospf' : {
        'meta_info' : _MetaInfoClass('Ospf',
            False, 
            [
            _MetaInfoClassMember('global', REFERENCE_CLASS, 'Global' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Global', 
                [], [], 
                '''                OSPF global configuration data
                ''',
                'global_',
                'Cisco-IOS-XR-ipv4-ospf-cfg', False),
            _MetaInfoClassMember('processes', REFERENCE_CLASS, 'Processes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_ospf_cfg', 'Ospf.Processes', 
                [], [], 
