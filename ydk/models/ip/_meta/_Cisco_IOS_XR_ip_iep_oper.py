...
_meta_table = {
    ...
    'ExplicitPaths.Identifiers.Identifier.Address' : {
        ...
        'ydk.models.ip.Cisco_IOS_XR_ip_iep_oper'
        ),
    },
    ...
    'ExplicitPaths.Identifiers' : {
        'meta_info' : _MetaInfoClass('ExplicitPaths.Identifiers',
            False, 
            [
            _MetaInfoClassMember('identifier', REFERENCE_LIST, 'Identifier' , 'ydk.models.ip.Cisco_IOS_XR_ip_iep_oper', 'ExplicitPaths.Identifiers.Identifier', 
                [], [], 
    ...
    'ExplicitPaths.Names' : {
        'meta_info' : _MetaInfoClass('ExplicitPaths.Names',
            False, 
            [
            _MetaInfoClassMember('name', REFERENCE_LIST, 'Name' , 'ydk.models.ip.Cisco_IOS_XR_ip_iep_oper', 'ExplicitPaths.Names.Name', 
                [], [], 
                '''                IP explicit path configured for a particular
                path name
                ''',
    ...
    'ExplicitPaths' : {
        'meta_info' : _MetaInfoClass('ExplicitPaths',
            False, 
            [
            _MetaInfoClassMember('identifiers', REFERENCE_CLASS, 'Identifiers' , 'ydk.models.ip.Cisco_IOS_XR_ip_iep_oper', 'ExplicitPaths.Identifiers', 
                [], [], 
                '''                List of configured IP explicit path identifiers
                ''',
                'identifiers',
                'Cisco-IOS-XR-ip-iep-oper', False),
            _MetaInfoClassMember('names', REFERENCE_CLASS, 'Names' , 'ydk.models.ip.Cisco_IOS_XR_ip_iep_oper', 'ExplicitPaths.Names', 
                [], [], 
