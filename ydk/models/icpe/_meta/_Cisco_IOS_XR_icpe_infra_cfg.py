...
_meta_table = {
    'NvSatellites.NvSatellite.CandidateFabricPorts.CandidateFabricPort' : {
        ...
        'ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg'
        ),
    },
    'NvSatellites.NvSatellite.CandidateFabricPorts' : {
        'meta_info' : _MetaInfoClass('NvSatellites.NvSatellite.CandidateFabricPorts',
            False, 
            [
            _MetaInfoClassMember('candidate-fabric-port', REFERENCE_LIST, 'CandidateFabricPort' , 'ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg', 'NvSatellites.NvSatellite.CandidateFabricPorts.CandidateFabricPort', 
                [], [], 
    ...
    'NvSatellites.NvSatellite' : {
        'meta_info' : _MetaInfoClass('NvSatellites.NvSatellite',
            ...
            _MetaInfoClassMember('satellite-id', ATTRIBUTE, 'int' , None, None, 
                ...
                'satellite_id',
                'Cisco-IOS-XR-icpe-infra-cfg', True),
            _MetaInfoClassMember('candidate-fabric-ports', REFERENCE_CLASS, 'CandidateFabricPorts' , 'ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg', 'NvSatellites.NvSatellite.CandidateFabricPorts', 
                [], [], 
                '''                Enable interfaces on the satellite to be used
                ...
                'Cisco-IOS-XR-icpe-infra-cfg', False),
            _MetaInfoClassMember('connection-info', REFERENCE_CLASS, 'ConnectionInfo' , 'ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg', 'NvSatellites.NvSatellite.ConnectionInfo', 
                [], [], 
                '''                Satellite User
                ''',
                'connection_info',
    ...
    'NvSatellites' : {
        'meta_info' : _MetaInfoClass('NvSatellites',
            False, 
            [
            _MetaInfoClassMember('nv-satellite', REFERENCE_LIST, 'NvSatellite' , 'ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg', 'NvSatellites.NvSatellite', 
                [], [], 
    ...
    'NvSatelliteGlobal' : {
        'meta_info' : _MetaInfoClass('NvSatelliteGlobal',
            False, 
            [
            _MetaInfoClassMember('chassis-mac', REFERENCE_CLASS, 'ChassisMac' , 'ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg', 'NvSatelliteGlobal.ChassisMac', 
                [], [], 
                '''                Chassis MAC address
                ''',
                'chassis_mac',
