...
_meta_table = {
    ...
    'Rsvp.Neighbors.Neighbor.Authentication' : {
        ...
        'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg'
        ),
    },
    'Rsvp.Neighbors.Neighbor' : {
        'meta_info' : _MetaInfoClass('Rsvp.Neighbors.Neighbor',
            ...
            _MetaInfoClassMember('authentication', REFERENCE_CLASS, 'Authentication' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Neighbors.Neighbor.Authentication', 
                [], [], 
    ...
    'Rsvp.Neighbors' : {
        'meta_info' : _MetaInfoClass('Rsvp.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Neighbors.Neighbor', 
                [], [], 
    ...
    'Rsvp.Controllers.Controller.CntlSignalling' : {
        'meta_info' : _MetaInfoClass('Rsvp.Controllers.Controller.CntlSignalling',
            False, 
            [
            _MetaInfoClassMember('out-of-band', REFERENCE_CLASS, 'OutOfBand' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Controllers.Controller.CntlSignalling.OutOfBand', 
                [], [], 
    ...
    'Rsvp.Controllers.Controller' : {
        'meta_info' : _MetaInfoClass('Rsvp.Controllers.Controller',
            ...
            _MetaInfoClassMember('controller-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'controller_name',
                'Cisco-IOS-XR-ip-rsvp-cfg', True),
            _MetaInfoClassMember('cntl-signalling', REFERENCE_CLASS, 'CntlSignalling' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Controllers.Controller.CntlSignalling', 
                [], [], 
    ...
    'Rsvp.Controllers' : {
        'meta_info' : _MetaInfoClass('Rsvp.Controllers',
            False, 
            [
            _MetaInfoClassMember('controller', REFERENCE_LIST, 'Controller' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Controllers.Controller', 
                [], [], 
    ...
    'Rsvp.GlobalBandwidth.DefaultInterfacePercent' : {
        'meta_info' : _MetaInfoClass('Rsvp.GlobalBandwidth.DefaultInterfacePercent',
            False, 
            [
            _MetaInfoClassMember('mam', REFERENCE_CLASS, 'Mam' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.GlobalBandwidth.DefaultInterfacePercent.Mam', 
                [], [], 
                ...
                'mam',
                'Cisco-IOS-XR-ip-rsvp-cfg', False),
            _MetaInfoClassMember('rdm', REFERENCE_CLASS, 'Rdm' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.GlobalBandwidth.DefaultInterfacePercent.Rdm', 
                [], [], 
    ...
    'Rsvp.GlobalBandwidth' : {
        'meta_info' : _MetaInfoClass('Rsvp.GlobalBandwidth',
            False, 
            [
            _MetaInfoClassMember('default-interface-percent', REFERENCE_CLASS, 'DefaultInterfacePercent' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.GlobalBandwidth.DefaultInterfacePercent', 
                [], [], 
    ...
    'Rsvp.Interfaces.Interface.Bandwidth' : {
        'meta_info' : _MetaInfoClass('Rsvp.Interfaces.Interface.Bandwidth',
            False, 
            [
            _MetaInfoClassMember('mam', REFERENCE_CLASS, 'Mam' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Interfaces.Interface.Bandwidth.Mam', 
                [], [], 
                '''                Configure MAM bandwidth parameters
                ''',
                'mam',
                'Cisco-IOS-XR-ip-rsvp-cfg', False),
            _MetaInfoClassMember('rdm', REFERENCE_CLASS, 'Rdm' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Interfaces.Interface.Bandwidth.Rdm', 
                [], [], 
    ...
    'Rsvp.Interfaces' : {
        'meta_info' : _MetaInfoClass('Rsvp.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Interfaces.Interface', 
                [], [], 
    ...
    'Rsvp.Signalling' : {
        'meta_info' : _MetaInfoClass('Rsvp.Signalling',
            ...
            _MetaInfoClassMember('global-out-of-band', REFERENCE_CLASS, 'GlobalOutOfBand' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Signalling.GlobalOutOfBand', 
                ...
                'global_out_of_band',
                'Cisco-IOS-XR-ip-rsvp-cfg', False),
            _MetaInfoClassMember('graceful-restart', REFERENCE_CLASS, 'GracefulRestart' , 'ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg', 'Rsvp.Signalling.GracefulRestart', 
                [], [], 
