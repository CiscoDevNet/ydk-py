...
_meta_table = {
    ...
    'Clock.SummerTime' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_cfg'
        ),
    },
    'Clock.TimeZone' : {
    ...
    'Clock' : {
        'meta_info' : _MetaInfoClass('Clock',
            False, 
            [
            _MetaInfoClassMember('summer-time', REFERENCE_CLASS, 'SummerTime' , 'ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_cfg', 'Clock.SummerTime', 
                [], [], 
                '''                Configure summer (daylight savings) time
                ''',
                'summer_time',
                'Cisco-IOS-XR-infra-infra-clock-cfg', False),
            _MetaInfoClassMember('time-zone', REFERENCE_CLASS, 'TimeZone' , 'ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_cfg', 'Clock.TimeZone', 
                [], [], 
                '''                Configure time zone
                ''',
                'time_zone',
