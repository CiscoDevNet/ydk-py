...
_meta_table = {
    'DnxQoseaShowAction_Enum' : _MetaInfoEnum('DnxQoseaShowAction_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
    ...
    'DnxQoseaShowPolicyUnit_Enum' : _MetaInfoEnum('DnxQoseaShowPolicyUnit_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
            'invalid':'INVALID',
            'bytes':'BYTES',
    ...
    'DnxQoseaShowWred_Enum' : _MetaInfoEnum('DnxQoseaShowWred_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
            'wred-cos':'WRED_COS',
            'wred-dscp':'WRED_DSCP',
    ...
    'DnxQoseaShowHpLevel_Enum' : _MetaInfoEnum('DnxQoseaShowHpLevel_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
    ...
    'QosPolicyAccountEnum_Enum' : _MetaInfoEnum('QosPolicyAccountEnum_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
    ...
    'DnxQoseaShowMark_Enum' : _MetaInfoEnum('DnxQoseaShowMark_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
            'mark-none':'MARK_NONE',
            'dscp':'DSCP',
    ...
    'DnxQoseaShowPolicyStatus_Enum' : _MetaInfoEnum('DnxQoseaShowPolicyStatus_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
            'no-error':'NO_ERROR',
            'policy-in-reset':'POLICY_IN_RESET',
        }, 'Cisco-IOS-XR-ncs5500-qos-oper', _yang_ns._namespaces['Cisco-IOS-XR-ncs5500-qos-oper']),
    'DnxQoseaShowIntfStatus_Enum' : _MetaInfoEnum('DnxQoseaShowIntfStatus_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
            'state-unknown':'STATE_UNKNOWN',
            'state-down':'STATE_DOWN',
        }, 'Cisco-IOS-XR-ncs5500-qos-oper', _yang_ns._namespaces['Cisco-IOS-XR-ncs5500-qos-oper']),
    'DnxQoseaShowLevel_Enum' : _MetaInfoEnum('DnxQoseaShowLevel_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
            'level1':'LEVEL1',
            'level2':'LEVEL2',
            'level3':'LEVEL3',
    ...
    'DnxQoseaShowQueue_Enum' : _MetaInfoEnum('DnxQoseaShowQueue_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper',
        {
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.CommonMark' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.CommonMark',
            False, 
            [
            _MetaInfoClassMember('mark-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowMark_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowMark_Enum', 
                [], [], 
                '''                Mark type
                ''',
                'mark_type',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.ConfigMaxRate' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.ConfigMaxRate',
            False, 
            [
            _MetaInfoClassMember('policy-unit', REFERENCE_ENUM_CLASS, 'DnxQoseaShowPolicyUnit_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowPolicyUnit_Enum', 
                [], [], 
                '''                Policy unit
                ''',
                'policy_unit',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.ConformAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.ConformAction',
            False, 
            [
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                [], [], 
                '''                Policer action type
                ''',
                'action_type',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.Wred' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class.Wred',
            ...
            _MetaInfoClassMember('segment-size', ATTRIBUTE, 'int' , None, None, 
                ...
                'segment_size',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('wred-match-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowWred_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowWred_Enum', 
                [], [], 
                '''                WREDMatchType
                ''',
                'wred_match_type',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.Classes.Class',
            ...
            _MetaInfoClassMember('class-level', REFERENCE_ENUM_CLASS, 'DnxQoseaShowLevel_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowLevel_Enum', 
                [], [], 
                '''                Class level
                ''',
                'class_level',
            ...
            _MetaInfoClassMember('policer-stats-handle', ATTRIBUTE, 'int' , None, None, 
                ...
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('priority-level', REFERENCE_ENUM_CLASS, 'DnxQoseaShowHpLevel_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowHpLevel_Enum', 
                [], [], 
                '''                Priority level
                ''',
                'priority_level',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('queue-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowQueue_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowQueue_Enum', 
                [], [], 
                '''                Queue type
                ''',
                'queue_type',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConformAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConformAction',
            ...
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                ...
                'action_type',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('mark', REFERENCE_LIST, 'Mark' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConformAction.Mark', 
                [], [], 
                '''                Action mark
                ''',
                'mark',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ExceedAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ExceedAction',
            ...
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                ...
                'action_type',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('mark', REFERENCE_LIST, 'Mark' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ExceedAction.Mark', 
                [], [], 
                '''                Action mark
                ''',
                'mark',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ViolateAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ViolateAction',
            ...
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                ...
                'action_type',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('mark', REFERENCE_LIST, 'Mark' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ViolateAction.Mark', 
                [], [], 
                '''                Action mark
                ''',
                'mark',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.Wred.WredMatchValue' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.Wred.WredMatchValue',
            False, 
            [
            _MetaInfoClassMember('dnx-qosea-show-red-match-value', REFERENCE_LIST, 'DnxQoseaShowRedMatchValue' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.Wred.WredMatchValue.DnxQoseaShowRedMatchValue', 
                [], [], 
                '''                dnx qosea show red match value
                ''',
                'dnx_qosea_show_red_match_value',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class',
            ...
            _MetaInfoClassMember('config-max-rate', REFERENCE_CLASS, 'ConfigMaxRate' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConfigMaxRate', 
                ...
                'config_max_rate',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('config-min-rate', REFERENCE_CLASS, 'ConfigMinRate' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConfigMinRate', 
                [], [], 
                '''                Configured minimum rate
                ''',
                'config_min_rate',
            ...
            _MetaInfoClassMember('config-policer-conform-burst', REFERENCE_CLASS, 'ConfigPolicerConformBurst' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConfigPolicerConformBurst', 
                ...
                'config_policer_conform_burst',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('config-policer-excess-burst', REFERENCE_CLASS, 'ConfigPolicerExcessBurst' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class.ConfigPolicerExcessBurst', 
                [], [], 
                '''                Configured policer excess burst
                ''',
                'config_policer_excess_burst',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes',
            False, 
            [
            _MetaInfoClassMember('class', REFERENCE_LIST, 'Class' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.Classes.Class', 
                [], [], 
                '''                QoS policy class
                ''',
                'class_',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.PolicyDetails' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface.PolicyDetails',
            ...
            _MetaInfoClassMember('interface-handle', ATTRIBUTE, 'int' , None, None, 
                ...
                'interface_handle',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('interface-status', REFERENCE_ENUM_CLASS, 'DnxQoseaShowIntfStatus_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowIntfStatus_Enum', 
                [], [], 
                '''                Interface Status
                ''',
                'interface_status',
            ...
            _MetaInfoClassMember('policy-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'policy_name',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('policy-status', REFERENCE_ENUM_CLASS, 'DnxQoseaShowPolicyStatus_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowPolicyStatus_Enum', 
                [], [], 
                '''                Policy Status
                ''',
                'policy_status',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('stats-accounting-type', REFERENCE_ENUM_CLASS, 'QosPolicyAccountEnum_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'QosPolicyAccountEnum_Enum', 
                [], [], 
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces',
            False, 
            [
            _MetaInfoClassMember('member-interface', REFERENCE_LIST, 'MemberInterface' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface.MemberInterfaces.MemberInterface', 
                [], [], 
                '''                QoS interface names
                ''',
                'member_interface',
    ...
    'PlatformQos.Nodes.Node.BundleInterfaces' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.BundleInterfaces',
            False, 
            [
            _MetaInfoClassMember('bundle-interface', REFERENCE_LIST, 'BundleInterface' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces.BundleInterface', 
                [], [], 
                '''                QoS interface names
                ''',
                'bundle_interface',
    ...
    'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConformAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConformAction',
            ...
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                ...
                'action_type',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('mark', REFERENCE_LIST, 'Mark' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConformAction.Mark', 
                [], [], 
                '''                Action mark
                ''',
                'mark',
    ...
    'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ExceedAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ExceedAction',
            ...
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                ...
                'action_type',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('mark', REFERENCE_LIST, 'Mark' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ExceedAction.Mark', 
                [], [], 
                '''                Action mark
                ''',
                'mark',
    ...
    'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ViolateAction' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ViolateAction',
            ...
            _MetaInfoClassMember('action-type', REFERENCE_ENUM_CLASS, 'DnxQoseaShowAction_Enum' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'DnxQoseaShowAction_Enum', 
                ...
                'action_type',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('mark', REFERENCE_LIST, 'Mark' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ViolateAction.Mark', 
                [], [], 
                '''                Action mark
                ''',
                'mark',
    ...
    'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.Wred.WredMatchValue' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.Wred.WredMatchValue',
            False, 
            [
            _MetaInfoClassMember('dnx-qosea-show-red-match-value', REFERENCE_LIST, 'DnxQoseaShowRedMatchValue' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.Wred.WredMatchValue.DnxQoseaShowRedMatchValue', 
                [], [], 
                '''                dnx qosea show red match value
                ''',
                'dnx_qosea_show_red_match_value',
    ...
    'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class',
            ...
            _MetaInfoClassMember('config-max-rate', REFERENCE_CLASS, 'ConfigMaxRate' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConfigMaxRate', 
                ...
                'config_max_rate',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('config-min-rate', REFERENCE_CLASS, 'ConfigMinRate' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConfigMinRate', 
                [], [], 
                '''                Configured minimum rate
                ''',
                'config_min_rate',
            ...
            _MetaInfoClassMember('config-policer-conform-burst', REFERENCE_CLASS, 'ConfigPolicerConformBurst' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConfigPolicerConformBurst', 
                ...
                'config_policer_conform_burst',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('config-policer-excess-burst', REFERENCE_CLASS, 'ConfigPolicerExcessBurst' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class.ConfigPolicerExcessBurst', 
                [], [], 
                '''                Configured policer excess burst
                ''',
                'config_policer_excess_burst',
    ...
    'PlatformQos.Nodes.Node.Interfaces.Interface.Classes' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces.Interface.Classes',
            False, 
            [
            _MetaInfoClassMember('class', REFERENCE_LIST, 'Class' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface.Classes.Class', 
                [], [], 
                '''                QoS policy class
                ''',
                'class_',
    ...
    'PlatformQos.Nodes.Node.Interfaces' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces.Interface', 
                [], [], 
                '''                QoS interface names
                ''',
                'interface',
    ...
    'PlatformQos.Nodes.Node.RemoteInterfaces' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node.RemoteInterfaces',
            False, 
            [
            _MetaInfoClassMember('remote-interface', REFERENCE_LIST, 'RemoteInterface' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.RemoteInterfaces.RemoteInterface', 
                [], [], 
    ...
    'PlatformQos.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes.Node',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-ncs5500-qos-oper', True),
            _MetaInfoClassMember('bundle-interfaces', REFERENCE_CLASS, 'BundleInterfaces' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.BundleInterfaces', 
                [], [], 
                '''                QoS list of bundle interfaces
                ''',
                'bundle_interfaces',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.Interfaces', 
                [], [], 
                '''                QoS list of interfaces
                ''',
                'interfaces',
                'Cisco-IOS-XR-ncs5500-qos-oper', False),
            _MetaInfoClassMember('remote-interfaces', REFERENCE_CLASS, 'RemoteInterfaces' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node.RemoteInterfaces', 
                [], [], 
    ...
    'PlatformQos.Nodes' : {
        'meta_info' : _MetaInfoClass('PlatformQos.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes.Node', 
                [], [], 
    ...
    'PlatformQos' : {
        'meta_info' : _MetaInfoClass('PlatformQos',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper', 'PlatformQos.Nodes', 
                [], [], 
