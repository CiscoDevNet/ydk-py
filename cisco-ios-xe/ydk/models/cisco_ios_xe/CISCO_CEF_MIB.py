...
class CISCOCEFMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cefAdjSummaryTable" : ("cefadjsummarytable", CISCOCEFMIB.Cefadjsummarytable), "cefAdjTable" : ("cefadjtable", CISCOCEFMIB.Cefadjtable), "cefCC" : ("cefcc", CISCOCEFMIB.Cefcc), "cefCCGlobalTable" : ("cefccglobaltable", CISCOCEFMIB.Cefccglobaltable), "cefCCTypeTable" : ("cefcctypetable", CISCOCEFMIB.Cefcctypetable), "cefCfgTable" : ("cefcfgtable", CISCOCEFMIB.Cefcfgtable), "cefFESelectionTable" : ("ceffeselectiontable", CISCOCEFMIB.Ceffeselectiontable), "cefFIB" : ("ceffib", CISCOCEFMIB.Ceffib), "cefFIBSummaryTable" : ("ceffibsummarytable", CISCOCEFMIB.Ceffibsummarytable), "cefInconsistencyRecordTable" : ("cefinconsistencyrecordtable", CISCOCEFMIB.Cefinconsistencyrecordtable), "cefIntTable" : ("cefinttable", CISCOCEFMIB.Cefinttable), "cefLMPrefixTable" : ("ceflmprefixtable", CISCOCEFMIB.Ceflmprefixtable), "cefNotifCntl" : ("cefnotifcntl", CISCOCEFMIB.Cefnotifcntl), "cefPathTable" : ("cefpathtable", CISCOCEFMIB.Cefpathtable), "cefPeerFIBTable" : ("cefpeerfibtable", CISCOCEFMIB.Cefpeerfibtable), "cefPeerTable" : ("cefpeertable", CISCOCEFMIB.Cefpeertable), "cefPrefixTable" : ("cefprefixtable", CISCOCEFMIB.Cefprefixtable), "cefResourceTable" : ("cefresourcetable", CISCOCEFMIB.Cefresourcetable), "cefStatsPrefixLenTable" : ("cefstatsprefixlentable", CISCOCEFMIB.Cefstatsprefixlentable), "cefSwitchingStatsTable" : ("cefswitchingstatstable", CISCOCEFMIB.Cefswitchingstatstable)}
    ...
    class Cefadjsummarytable(Entity):
        ...
        class Cefadjsummaryentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefadjsummarytable.Cefadjsummaryentry, ['entphysicalindex', 'cefadjsummarylinktype', 'cefadjsummarycomplete', 'cefadjsummaryfixup', 'cefadjsummaryincomplete', 'cefadjsummaryredirect'], name, value)
    ...
    class Cefadjtable(Entity):
        ...
        class Cefadjentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefadjtable.Cefadjentry, ['entphysicalindex', 'ifindex', 'cefadjnexthopaddrtype', 'cefadjnexthopaddr', 'cefadjconnid', 'cefadjsummarylinktype', 'cefadjbytes', 'cefadjencap', 'cefadjfixup', 'cefadjforwardinginfo', 'cefadjhcbytes', 'cefadjhcpkts', 'cefadjmtu', 'cefadjpkts', 'cefadjsource'], name, value)
    ...
    class Cefcc(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOCEFMIB.Cefcc, ['cefinconsistencyreset', 'cefinconsistencyresetstatus', 'entlastinconsistencydetecttime'], name, value)
    ...
    class Cefccglobaltable(Entity):
        ...
        class Cefccglobalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefccglobaltable.Cefccglobalentry, ['ceffibipversion', 'cefccglobalautorepairdelay', 'cefccglobalautorepairenabled', 'cefccglobalautorepairholddown', 'cefccglobalerrormsgenabled', 'cefccglobalfullscanaction', 'cefccglobalfullscanstatus'], name, value)
    ...
    class Cefcctypetable(Entity):
        ...
        class Cefcctypeentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefcctypetable.Cefcctypeentry, ['ceffibipversion', 'cefcctype', 'cefcccount', 'cefccenabled', 'cefccperiod', 'cefccquerieschecked', 'cefccqueriesignored', 'cefccqueriesiterated', 'cefccqueriessent'], name, value)
    ...
    class Cefcfgtable(Entity):
        ...
        class Cefcfgentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefcfgtable.Cefcfgentry, ['entphysicalindex', 'ceffibipversion', 'cefcfgaccountingmap', 'cefcfgadminstate', 'cefcfgdistributionadminstate', 'cefcfgdistributionoperstate', 'cefcfgloadsharingalgorithm', 'cefcfgloadsharingid', 'cefcfgoperstate', 'cefcfgtrafficstatsloadinterval', 'cefcfgtrafficstatsupdaterate'], name, value)
    ...
    class Ceffeselectiontable(Entity):
        ...
        class Ceffeselectionentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Ceffeselectiontable.Ceffeselectionentry, ['entphysicalindex', 'ceffeselectionname', 'ceffeselectionid', 'ceffeselectionadjconnid', 'ceffeselectionadjinterface', 'ceffeselectionadjlinktype', 'ceffeselectionadjnexthopaddr', 'ceffeselectionadjnexthopaddrtype', 'ceffeselectionlabels', 'ceffeselectionspecial', 'ceffeselectionvrfname', 'ceffeselectionweight'], name, value)
    ...
    class Cefinconsistencyrecordtable(Entity):
        ...
        class Cefinconsistencyrecordentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefinconsistencyrecordtable.Cefinconsistencyrecordentry, ['ceffibipversion', 'cefinconsistencyrecid', 'cefinconsistencycctype', 'cefinconsistencyentity', 'cefinconsistencyprefixaddr', 'cefinconsistencyprefixlen', 'cefinconsistencyprefixtype', 'cefinconsistencyreason', 'cefinconsistencyvrfname'], name, value)
    ...
    class Cefinttable(Entity):
        ...
        class Cefintentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefinttable.Cefintentry, ['entphysicalindex', 'ceffibipversion', 'ifindex', 'cefintloadsharing', 'cefintnonrecursiveaccouting', 'cefintswitchingstate'], name, value)
    ...
    class Ceflmprefixtable(Entity):
        ...
        class Ceflmprefixentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Ceflmprefixtable.Ceflmprefixentry, ['entphysicalindex', 'ceflmprefixdestaddrtype', 'ceflmprefixdestaddr', 'ceflmprefixaddr', 'ceflmprefixlen', 'ceflmprefixrowstatus', 'ceflmprefixstate'], name, value)
    ...
    class Cefnotifcntl(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOCEFMIB.Cefnotifcntl, ['cefinconsistencynotifenable', 'cefnotifthrottlinginterval', 'cefpeerfibstatechangenotifenable', 'cefpeerstatechangenotifenable', 'cefresourcefailurenotifenable'], name, value)
    ...
    class Cefpathtable(Entity):
        ...
        class Cefpathentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefpathtable.Cefpathentry, ['entphysicalindex', 'cefprefixtype', 'cefprefixaddr', 'cefprefixlen', 'cefpathid', 'cefpathinterface', 'cefpathnexthopaddr', 'cefpathrecursevrfname', 'cefpathtype'], name, value)
    ...
    class Cefpeertable(Entity):
        ...
        class Cefpeerentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefpeertable.Cefpeerentry, ['entphysicalindex', 'entpeerphysicalindex', 'cefpeernumberofresets', 'cefpeeroperstate'], name, value)
    ...
    class Cefprefixtable(Entity):
        ...
        class Cefprefixentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefprefixtable.Cefprefixentry, ['entphysicalindex', 'cefprefixtype', 'cefprefixaddr', 'cefprefixlen', 'cefprefixbytes', 'cefprefixexternalnrbytes', 'cefprefixexternalnrhcbytes', 'cefprefixexternalnrhcpkts', 'cefprefixexternalnrpkts', 'cefprefixforwardinginfo', 'cefprefixhcbytes', 'cefprefixhcpkts', 'cefprefixinternalnrbytes', 'cefprefixinternalnrhcbytes', 'cefprefixinternalnrhcpkts', 'cefprefixinternalnrpkts', 'cefprefixpkts'], name, value)
    ...
    class Cefresourcetable(Entity):
        ...
        class Cefresourceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefresourcetable.Cefresourceentry, ['entphysicalindex', 'cefresourcefailurereason', 'cefresourcememoryused'], name, value)
    ...
    class Cefstatsprefixlentable(Entity):
        ...
        class Cefstatsprefixlenentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefstatsprefixlentable.Cefstatsprefixlenentry, ['entphysicalindex', 'ceffibipversion', 'cefstatsprefixlen', 'cefstatsprefixdeletes', 'cefstatsprefixelements', 'cefstatsprefixhcdeletes', 'cefstatsprefixhcelements', 'cefstatsprefixhcinserts', 'cefstatsprefixhcqueries', 'cefstatsprefixinserts', 'cefstatsprefixqueries'], name, value)
    ...
    class Cefswitchingstatstable(Entity):
        ...
        class Cefswitchingstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOCEFMIB.Cefswitchingstatstable.Cefswitchingstatsentry, ['entphysicalindex', 'ceffibipversion', 'cefswitchingindex', 'cefswitchingdrop', 'cefswitchinghcdrop', 'cefswitchinghcpunt', 'cefswitchinghcpunt2host', 'cefswitchingpath', 'cefswitchingpunt', 'cefswitchingpunt2host'], name, value)
