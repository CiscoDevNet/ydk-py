...
_meta_table = {
    ...
    'Pbr.Nodes.Node.PolicyMap.Interfaces.Interface.Direction.Input.ClassStat.GeneralStats' : {
        ...
        'ydk.models.pbr.Cisco_IOS_XR_pbr_oper'
        ),
    },
    ...
    'Pbr.Nodes.Node.PolicyMap.Interfaces.Interface.Direction' : {
        'meta_info' : _MetaInfoClass('Pbr.Nodes.Node.PolicyMap.Interfaces.Interface.Direction',
            False, 
            [
            _MetaInfoClassMember('input', REFERENCE_CLASS, 'Input' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes.Node.PolicyMap.Interfaces.Interface.Direction.Input', 
                [], [], 
    ...
    'Pbr.Nodes.Node.PolicyMap.Interfaces.Interface' : {
        'meta_info' : _MetaInfoClass('Pbr.Nodes.Node.PolicyMap.Interfaces.Interface',
            ...
            _MetaInfoClassMember('direction', REFERENCE_CLASS, 'Direction' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes.Node.PolicyMap.Interfaces.Interface.Direction', 
                [], [], 
                '''                PBR direction
                ''',
                'direction',
    ...
    'Pbr.Nodes.Node.PolicyMap.Interfaces' : {
        'meta_info' : _MetaInfoClass('Pbr.Nodes.Node.PolicyMap.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes.Node.PolicyMap.Interfaces.Interface', 
                [], [], 
    ...
    'Pbr.Nodes.Node.PolicyMap' : {
        'meta_info' : _MetaInfoClass('Pbr.Nodes.Node.PolicyMap',
            False, 
            [
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes.Node.PolicyMap.Interfaces', 
                [], [], 
    ...
    'Pbr.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Pbr.Nodes.Node',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-pbr-oper', True),
            _MetaInfoClassMember('policy-map', REFERENCE_CLASS, 'PolicyMap' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes.Node.PolicyMap', 
                [], [], 
    ...
    'Pbr.Nodes' : {
        'meta_info' : _MetaInfoClass('Pbr.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes.Node', 
                [], [], 
    ...
    'Pbr' : {
        'meta_info' : _MetaInfoClass('Pbr',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.pbr.Cisco_IOS_XR_pbr_oper', 'Pbr.Nodes', 
                [], [], 
