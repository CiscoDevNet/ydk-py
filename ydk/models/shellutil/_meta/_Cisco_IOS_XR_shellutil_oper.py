...
_meta_table = {
    'TimeSource_Enum' : _MetaInfoEnum('TimeSource_Enum', 'ydk.models.shellutil.Cisco_IOS_XR_shellutil_oper',
        {
            'error':'ERROR',
            'none':'NONE',
            'ntp':'NTP',
    ...
    'SystemTime.Clock' : {
        'meta_info' : _MetaInfoClass('SystemTime.Clock',
            ...
            _MetaInfoClassMember('second', ATTRIBUTE, 'int' , None, None, 
                ...
                'second',
                'Cisco-IOS-XR-shellutil-oper', False),
            _MetaInfoClassMember('time-source', REFERENCE_ENUM_CLASS, 'TimeSource_Enum' , 'ydk.models.shellutil.Cisco_IOS_XR_shellutil_oper', 'TimeSource_Enum', 
                [], [], 
                '''                Time source
                ''',
                'time_source',
    ...
    'SystemTime' : {
        'meta_info' : _MetaInfoClass('SystemTime',
            False, 
            [
            _MetaInfoClassMember('clock', REFERENCE_CLASS, 'Clock' , 'ydk.models.shellutil.Cisco_IOS_XR_shellutil_oper', 'SystemTime.Clock', 
                [], [], 
                '''                System clock information
                ''',
                'clock',
                'Cisco-IOS-XR-shellutil-oper', False),
            _MetaInfoClassMember('uptime', REFERENCE_CLASS, 'Uptime' , 'ydk.models.shellutil.Cisco_IOS_XR_shellutil_oper', 'SystemTime.Uptime', 
                [], [], 
