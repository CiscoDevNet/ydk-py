...
class DebugAgent(_Entity_):
        ...
        class Location(_Entity_):
            ...
            class AllOptions(_Entity_):
                ...
                class TraceBlocks(_Entity_):
                    ...
                    @staticmethod
                    def _meta_info():
                        from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_debug_agent as meta
                        return meta._meta_table['DebugAgent.Trace.Location.AllOptions.TraceBlocks']['meta_info']

                @staticmethod
                def _meta_info():
                    from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_debug_agent as meta
                    return meta._meta_table['DebugAgent.Trace.Location.AllOptions']['meta_info']

            @staticmethod
            def _meta_info():
                from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_debug_agent as meta
                return meta._meta_table['DebugAgent.Trace.Location']['meta_info']

        @staticmethod
        def _meta_info():
            from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_debug_agent as meta
            return meta._meta_table['DebugAgent.Trace']['meta_info']
    ...
    def _meta_info():
        from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_debug_agent as meta
        return meta._meta_table['DebugAgent']['meta_info']
