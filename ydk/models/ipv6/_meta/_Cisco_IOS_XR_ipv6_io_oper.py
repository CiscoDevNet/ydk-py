...
_meta_table = {
    'Ipv6Io.Nodes.Node.Statistics.Traffic.Icmp' : {
        ...
        'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper'
        ),
    },
    ...
    'Ipv6Io.Nodes.Node.Statistics.Traffic' : {
        'meta_info' : _MetaInfoClass('Ipv6Io.Nodes.Node.Statistics.Traffic',
            False, 
            [
            _MetaInfoClassMember('icmp', REFERENCE_CLASS, 'Icmp' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes.Node.Statistics.Traffic.Icmp', 
                [], [], 
                '''                ICMP Statistics
                ''',
                'icmp',
                'Cisco-IOS-XR-ipv6-io-oper', False),
            _MetaInfoClassMember('ipv6', REFERENCE_CLASS, 'Ipv6' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes.Node.Statistics.Traffic.Ipv6', 
                [], [], 
                '''                IPv6 Statistics
                ''',
                'ipv6',
                'Cisco-IOS-XR-ipv6-io-oper', False),
            _MetaInfoClassMember('ipv6-node-discovery', REFERENCE_CLASS, 'Ipv6NodeDiscovery' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes.Node.Statistics.Traffic.Ipv6NodeDiscovery', 
                [], [], 
    ...
    'Ipv6Io.Nodes.Node.Statistics' : {
        'meta_info' : _MetaInfoClass('Ipv6Io.Nodes.Node.Statistics',
            False, 
            [
            _MetaInfoClassMember('traffic', REFERENCE_CLASS, 'Traffic' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes.Node.Statistics.Traffic', 
                [], [], 
    ...
    'Ipv6Io.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Ipv6Io.Nodes.Node',
            ...
            _MetaInfoClassMember('statistics', REFERENCE_CLASS, 'Statistics' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes.Node.Statistics', 
                [], [], 
    ...
    'Ipv6Io.Nodes' : {
        'meta_info' : _MetaInfoClass('Ipv6Io.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes.Node', 
                [], [], 
    ...
    'Ipv6Io' : {
        'meta_info' : _MetaInfoClass('Ipv6Io',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper', 'Ipv6Io.Nodes', 
                [], [], 
