...
_meta_table = {
    'Dot3ErrorInitError_Identity' : {
        'meta_info' : _MetaInfoClass('Dot3ErrorInitError_Identity',
            False, 
            [
            ],
            'EtherLike-MIB',
        ...
        'ydk.models.etherlike.EtherLike_MIB'
        ),
    },
    'Dot3ErrorLoopbackError_Identity' : {
        'meta_info' : _MetaInfoClass('Dot3ErrorLoopbackError_Identity',
            False, 
            [
            ],
            'EtherLike-MIB',
    ...
    'Dot3TestLoopBack_Identity' : {
        'meta_info' : _MetaInfoClass('Dot3TestLoopBack_Identity',
            False, 
            [
            ],
            'EtherLike-MIB',
    ...
    'Dot3TestTdr_Identity' : {
        'meta_info' : _MetaInfoClass('Dot3TestTdr_Identity',
            False, 
            [
            ],
            'EtherLike-MIB',
    ...
    'EtherLikeMIB.Dot3CollTable' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3CollTable',
            False, 
            [
            _MetaInfoClassMember('dot3CollEntry', REFERENCE_LIST, 'Dot3CollEntry' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3CollTable.Dot3CollEntry', 
                [], [], 
    ...
    'EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry',
            ...
            _MetaInfoClassMember('dot3StatsIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot3statsindex',
                'EtherLike-MIB', True),
            _MetaInfoClassMember('dot3ControlFunctionsSupported', REFERENCE_BITS, 'Dot3ControlFunctionsSupported_Bits' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry.Dot3ControlFunctionsSupported_Bits', 
                [], [], 
    ...
    'EtherLikeMIB.Dot3ControlTable' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3ControlTable',
            False, 
            [
            _MetaInfoClassMember('dot3ControlEntry', REFERENCE_LIST, 'Dot3ControlEntry' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry', 
                [], [], 
    ...
    'EtherLikeMIB.Dot3HCStatsTable' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3HCStatsTable',
            False, 
            [
            _MetaInfoClassMember('dot3HCStatsEntry', REFERENCE_LIST, 'Dot3HCStatsEntry' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3HCStatsTable.Dot3HCStatsEntry', 
                [], [], 
    ...
    'EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseAdminMode_Enum' : _MetaInfoEnum('Dot3PauseAdminMode_Enum', 'ydk.models.etherlike.EtherLike_MIB',
        {
            'disabled':'DISABLED',
    ...
    'EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseOperMode_Enum' : _MetaInfoEnum('Dot3PauseOperMode_Enum', 'ydk.models.etherlike.EtherLike_MIB',
        {
            'disabled':'DISABLED',
            'enabledXmit':'ENABLEDXMIT',
            'enabledRcv':'ENABLEDRCV',
    ...
    'EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry',
            ...
            _MetaInfoClassMember('dot3OutPauseFrames', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot3outpauseframes',
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3PauseAdminMode', REFERENCE_ENUM_CLASS, 'Dot3PauseAdminMode_Enum' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseAdminMode_Enum', 
                [], [], 
                ...
                'dot3pauseadminmode',
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3PauseOperMode', REFERENCE_ENUM_CLASS, 'Dot3PauseOperMode_Enum' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseOperMode_Enum', 
                [], [], 
    ...
    'EtherLikeMIB.Dot3PauseTable' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3PauseTable',
            False, 
            [
            _MetaInfoClassMember('dot3PauseEntry', REFERENCE_LIST, 'Dot3PauseEntry' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry', 
                [], [], 
                '''                An entry in the table, containing information
    ...
    'EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsDuplexStatus_Enum' : _MetaInfoEnum('Dot3StatsDuplexStatus_Enum', 'ydk.models.etherlike.EtherLike_MIB',
        {
            'unknown':'UNKNOWN',
            'halfDuplex':'HALFDUPLEX',
            'fullDuplex':'FULLDUPLEX',
        }, 'EtherLike-MIB', _yang_ns._namespaces['EtherLike-MIB']),
    'EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsRateControlStatus_Enum' : _MetaInfoEnum('Dot3StatsRateControlStatus_Enum', 'ydk.models.etherlike.EtherLike_MIB',
        {
    ...
    'EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry',
            ...
            _MetaInfoClassMember('dot3StatsDeferredTransmissions', ATTRIBUTE, 'int' , None, None, 
                ...
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3StatsDuplexStatus', REFERENCE_ENUM_CLASS, 'Dot3StatsDuplexStatus_Enum' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsDuplexStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dot3StatsRateControlAbility', ATTRIBUTE, 'bool' , None, None, 
                ...
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3StatsRateControlStatus', REFERENCE_ENUM_CLASS, 'Dot3StatsRateControlStatus_Enum' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsRateControlStatus_Enum', 
                [], [], 
    ...
    'EtherLikeMIB.Dot3StatsTable' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB.Dot3StatsTable',
            False, 
            [
            _MetaInfoClassMember('dot3StatsEntry', REFERENCE_LIST, 'Dot3StatsEntry' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry', 
                [], [], 
    ...
    'EtherLikeMIB' : {
        'meta_info' : _MetaInfoClass('EtherLikeMIB',
            False, 
            [
            _MetaInfoClassMember('dot3CollTable', REFERENCE_CLASS, 'Dot3CollTable' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3CollTable', 
                [], [], 
                ...
                'dot3colltable',
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3ControlTable', REFERENCE_CLASS, 'Dot3ControlTable' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3ControlTable', 
                [], [], 
                ...
                'dot3controltable',
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3HCStatsTable', REFERENCE_CLASS, 'Dot3HCStatsTable' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3HCStatsTable', 
                [], [], 
                ...
                'dot3hcstatstable',
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3PauseTable', REFERENCE_CLASS, 'Dot3PauseTable' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3PauseTable', 
                [], [], 
                '''                A table of descriptive and status information
                ...
                'dot3pausetable',
                'EtherLike-MIB', False),
            _MetaInfoClassMember('dot3StatsTable', REFERENCE_CLASS, 'Dot3StatsTable' , 'ydk.models.etherlike.EtherLike_MIB', 'EtherLikeMIB.Dot3StatsTable', 
                [], [], 
