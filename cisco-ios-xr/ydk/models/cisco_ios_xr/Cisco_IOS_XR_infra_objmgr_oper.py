            ...
            class Objects(Entity):
                ...
                class Object(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"address-ranges" : ("address_ranges", ObjectGroup.Network.Ipv4.Objects.Object.AddressRanges), "addresses" : ("addresses", ObjectGroup.Network.Ipv4.Objects.Object.Addresses), "hosts" : ("hosts", ObjectGroup.Network.Ipv4.Objects.Object.Hosts), "nested-groups" : ("nested_groups", ObjectGroup.Network.Ipv4.Objects.Object.NestedGroups), "parent-groups" : ("parent_groups", ObjectGroup.Network.Ipv4.Objects.Object.ParentGroups)}
                        self._child_list_classes = {}
                    ...
                    class AddressRanges(Entity):
                        ...
                        class AddressRange(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(ObjectGroup.Network.Ipv4.Objects.Object.AddressRanges.AddressRange, ['end_address', 'end_address_xr', 'start_address', 'start_address_xr'], name, value)
                    ...
                    class Addresses(Entity):
                        ...
                        class Address(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(ObjectGroup.Network.Ipv4.Objects.Object.Addresses.Address, ['prefix', 'prefix_length', 'prefix_length_xr', 'prefix_xr'], name, value)
            ...
            class Objects(Entity):
                ...
                class Object(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"address-ranges" : ("address_ranges", ObjectGroup.Network.Ipv6.Objects.Object.AddressRanges), "addresses" : ("addresses", ObjectGroup.Network.Ipv6.Objects.Object.Addresses), "hosts" : ("hosts", ObjectGroup.Network.Ipv6.Objects.Object.Hosts), "nested-groups" : ("nested_groups", ObjectGroup.Network.Ipv6.Objects.Object.NestedGroups), "parent-groups" : ("parent_groups", ObjectGroup.Network.Ipv6.Objects.Object.ParentGroups)}
                        self._child_list_classes = {}
                    ...
                    class AddressRanges(Entity):
                        ...
                        class AddressRange(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(ObjectGroup.Network.Ipv6.Objects.Object.AddressRanges.AddressRange, ['end_address', 'end_address_xr', 'start_address', 'start_address_xr'], name, value)
                    ...
                    class Addresses(Entity):
                        ...
                        class Address(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(ObjectGroup.Network.Ipv6.Objects.Object.Addresses.Address, ['prefix', 'prefix_length', 'prefix_length_xr', 'prefix_xr'], name, value)
            ...
            class Object(Entity):
                ...
                class Operators(Entity):
                    ...
                    class Operator(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(ObjectGroup.Port.Objects.Object.Operators.Operator, ['operator_type', 'operator_type_xr', 'port', 'port_xr'], name, value)
                ...
                class PortRanges(Entity):
                    ...
                    class PortRange(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(ObjectGroup.Port.Objects.Object.PortRanges.PortRange, ['end_port', 'end_port_xr', 'start_port', 'start_port_xr'], name, value)
