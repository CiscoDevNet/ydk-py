...
_meta_table = {
    ...
    'EventManager.Policies' : {
        'meta_info' : _MetaInfoClass('EventManager.Policies',
            False, 
            [
            _MetaInfoClassMember('policy', REFERENCE_LIST, 'Policy' , 'ydk.models.ha.Cisco_IOS_XR_ha_eem_cfg', 'EventManager.Policies.Policy', 
                [], [], 
                '''                Name of the policy file
                ''',
                'policy',
    ...
    'EventManager.SchedulerScript.ThreadClasses' : {
        'meta_info' : _MetaInfoClass('EventManager.SchedulerScript.ThreadClasses',
            False, 
            [
            _MetaInfoClassMember('thread-class', REFERENCE_LIST, 'ThreadClass' , 'ydk.models.ha.Cisco_IOS_XR_ha_eem_cfg', 'EventManager.SchedulerScript.ThreadClasses.ThreadClass', 
                [], [], 
    ...
    'EventManager.SchedulerScript' : {
        'meta_info' : _MetaInfoClass('EventManager.SchedulerScript',
            False, 
            [
            _MetaInfoClassMember('thread-classes', REFERENCE_CLASS, 'ThreadClasses' , 'ydk.models.ha.Cisco_IOS_XR_ha_eem_cfg', 'EventManager.SchedulerScript.ThreadClasses', 
                [], [], 
    ...
    'EventManager.Environments' : {
        'meta_info' : _MetaInfoClass('EventManager.Environments',
            False, 
            [
            _MetaInfoClassMember('environment', REFERENCE_LIST, 'Environment' , 'ydk.models.ha.Cisco_IOS_XR_ha_eem_cfg', 'EventManager.Environments.Environment', 
                [], [], 
                '''                Name of the global variable
                ''',
                'environment',
