...
_meta_table = {
    ...
    'Dhcpv6.Nodes.Node.Proxy.Vrfs.Vrf.Statistics.Solicit' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Proxy.Vrfs.Vrf.Statistics.Solicit',
            ...
            _MetaInfoClassMember('dropped-packets', ATTRIBUTE, 'long' , None, None, 
                ...
                'dropped_packets',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', False),
            _MetaInfoClassMember('received-packets', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                Received packets
                ''',
                'received_packets',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', False),
            _MetaInfoClassMember('transmitted-packets', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                Transmitted packets
                ''',
                'transmitted_packets',
    ...
    'Dhcpv6.Nodes.Node.Proxy.Profiles.Profile.ThrottleInfos' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Proxy.Profiles.Profile.ThrottleInfos',
            False, 
            [
            _MetaInfoClassMember('throttle-info', REFERENCE_LIST, 'ThrottleInfo' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Proxy.Profiles.Profile.ThrottleInfos.ThrottleInfo', 
                [], [], 
    ...
    'Dhcpv6.Nodes.Node.Proxy.Profiles' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Proxy.Profiles',
            False, 
            [
            _MetaInfoClassMember('profile', REFERENCE_LIST, 'Profile' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Proxy.Profiles.Profile', 
                [], [], 
    ...
    'Dhcpv6.Nodes.Node.Server.Binding.Clients' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Server.Binding.Clients',
            False, 
            [
            _MetaInfoClassMember('client', REFERENCE_LIST, 'Client' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Binding.Clients.Client', 
                [], [], 
    ...
    'Dhcpv6.Nodes.Node.Server.Profiles.Profile.ThrottleInfos' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Server.Profiles.Profile.ThrottleInfos',
            False, 
            [
            _MetaInfoClassMember('throttle-info', REFERENCE_LIST, 'ThrottleInfo' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Profiles.Profile.ThrottleInfos.ThrottleInfo', 
                [], [], 
    ...
    'Dhcpv6.Nodes.Node.Server.Profiles.Profile' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Server.Profiles.Profile',
            ...
            _MetaInfoClassMember('profile-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'profile_name',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', True),
            _MetaInfoClassMember('info', REFERENCE_CLASS, 'Info' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Profiles.Profile.Info', 
                [], [], 
                '''                IPv6 DHCP server profile Info
                ''',
                'info',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', False),
            _MetaInfoClassMember('throttle-infos', REFERENCE_CLASS, 'ThrottleInfos' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Profiles.Profile.ThrottleInfos', 
                [], [], 
                '''                DHCPV6 throttle table
                ''',
                'throttle_infos',
    ...
    'Dhcpv6.Nodes.Node.Server.Profiles' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Server.Profiles',
            False, 
            [
            _MetaInfoClassMember('profile', REFERENCE_LIST, 'Profile' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Profiles.Profile', 
                [], [], 
    ...
    'Dhcpv6.Nodes.Node.Server' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node.Server',
            False, 
            [
            _MetaInfoClassMember('binding', REFERENCE_CLASS, 'Binding' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Binding', 
                [], [], 
            ...
            _MetaInfoClassMember('profiles', REFERENCE_CLASS, 'Profiles' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Profiles', 
                ...
                'profiles',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', False),
            _MetaInfoClassMember('statistics', REFERENCE_CLASS, 'Statistics' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Server.Statistics', 
                [], [], 
    ...
    'Dhcpv6.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes.Node',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', True),
            _MetaInfoClassMember('proxy', REFERENCE_CLASS, 'Proxy' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node.Proxy', 
                [], [], 
    ...
    'Dhcpv6.Nodes' : {
        'meta_info' : _MetaInfoClass('Dhcpv6.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes.Node', 
                [], [], 
    ...
    'Dhcpv6' : {
        'meta_info' : _MetaInfoClass('Dhcpv6',
            False, 
            [
            _MetaInfoClassMember('database', REFERENCE_CLASS, 'Database' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Database', 
                [], [], 
                '''                DHCP database
                ''',
                'database',
                'Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', False),
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper', 'Dhcpv6.Nodes', 
                [], [], 
