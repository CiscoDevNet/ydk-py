...
from ydk.models.tc.CISCO_TC import CiscoNetworkProtocol_Enum
...
class CISCOCDPMIB(object):
    ...
    .. attribute:: cdpcachetable
    	...
    	**type**\: :py:class:`CdpCacheTable <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpCacheTable>`
    ...
    .. attribute:: cdpctaddresstable
    	...
    	**type**\: :py:class:`CdpCtAddressTable <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpCtAddressTable>`
    
    .. attribute:: cdpglobal
    
    	
    	**type**\: :py:class:`CdpGlobal <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpGlobal>`
    
    .. attribute:: cdpinterfaceexttable
    
    	This table contains the additional CDP configuration on the device's interfaces
    	**type**\: :py:class:`CdpInterfaceExtTable <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpInterfaceExtTable>`
    
    .. attribute:: cdpinterfacetable
    
    	The (conceptual) table containing the status of CDP on the device's interfaces
    	**type**\: :py:class:`CdpInterfaceTable <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpInterfaceTable>`
    ...
    class CdpCacheTable(object):
        ...
        .. attribute:: cdpcacheentry
        	...
        	**type**\: list of :py:class:`CdpCacheEntry <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpCacheTable.CdpCacheEntry>`
        ...
        class CdpCacheEntry(object):
            ...
            .. attribute:: cdpcacheaddresstype
            	...
            	**type**\: :py:class:`CiscoNetworkProtocol_Enum <ydk.models.tc.CISCO_TC.CiscoNetworkProtocol_Enum>`
            ...
            .. attribute:: cdpcacheduplex
            	...
            	**type**\: :py:class:`CdpCacheDuplex_Enum <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpCacheTable.CdpCacheEntry.CdpCacheDuplex_Enum>`
            ...
            class CdpCacheDuplex_Enum(Enum):
                """
                CdpCacheDuplex_Enum
                ...
                @staticmethod
                def _meta_info():
                    from ydk.models.cdp._meta import _CISCO_CDP_MIB as meta
                    return meta._meta_table['CISCOCDPMIB.CdpCacheTable.CdpCacheEntry.CdpCacheDuplex_Enum']


            @property
            def _common_path(self):
                if self.cdpcachedeviceindex is None:
                    raise YPYDataValidationError('Key property cdpcachedeviceindex is None')
                if self.cdpcacheifindex is None:
                    raise YPYDataValidationError('Key property cdpcacheifindex is None')

                return '/CISCO-CDP-MIB:CISCO-CDP-MIB/CISCO-CDP-MIB:cdpCacheTable/CISCO-CDP-MIB:cdpCacheEntry[CISCO-CDP-MIB:cdpCacheDeviceIndex = ' + str(self.cdpcachedeviceindex) + '][CISCO-CDP-MIB:cdpCacheIfIndex = ' + str(self.cdpcacheifindex) + ']'
    ...
    class CdpCtAddressTable(object):
        ...
        .. attribute:: cdpctaddressentry
        	...
        	**type**\: list of :py:class:`CdpCtAddressEntry <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpCtAddressTable.CdpCtAddressEntry>`
        ...
        class CdpCtAddressEntry(object):
            ...
            def _common_path(self):
                ...
                if self.cdpctaddressindex is None:
                    raise YPYDataValidationError('Key property cdpctaddressindex is None')

                return '/CISCO-CDP-MIB:CISCO-CDP-MIB/CISCO-CDP-MIB:cdpCtAddressTable/CISCO-CDP-MIB:cdpCtAddressEntry[CISCO-CDP-MIB:cdpCacheDeviceIndex = ' + str(self.cdpcachedeviceindex) + '][CISCO-CDP-MIB:cdpCacheIfIndex = ' + str(self.cdpcacheifindex) + '][CISCO-CDP-MIB:cdpCtAddressIndex = ' + str(self.cdpctaddressindex) + ']'
    ...
    class CdpGlobal(object):
        ...
        .. attribute:: cdpglobaldeviceidformat
        	...
        	**type**\: :py:class:`CdpGlobalDeviceIdFormat_Enum <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpGlobal.CdpGlobalDeviceIdFormat_Enum>`
        ...
        .. attribute:: cdpglobaldeviceidformatcpb
        	...
        	**type**\: :py:class:`CdpGlobalDeviceIdFormatCpb_Bits <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpGlobal.CdpGlobalDeviceIdFormatCpb_Bits>`
        ...
        def __init__(self):
            ...
            self.cdpglobaldeviceidformatcpb = CISCOCDPMIB.CdpGlobal.CdpGlobalDeviceIdFormatCpb_Bits()
            self.cdpglobalholdtime = None
            self.cdpgloballastchange = None
            self.cdpglobalmessageinterval = None
            self.cdpglobalrun = None

        class CdpGlobalDeviceIdFormat_Enum(Enum):
            """
            CdpGlobalDeviceIdFormat_Enum
            ...
            def _meta_info():
                from ydk.models.cdp._meta import _CISCO_CDP_MIB as meta
                return meta._meta_table['CISCOCDPMIB.CdpGlobal.CdpGlobalDeviceIdFormat_Enum']


        class CdpGlobalDeviceIdFormatCpb_Bits(FixedBitsDict):
            """
            CdpGlobalDeviceIdFormatCpb_Bits
            ...
            Keys are:- macAddress , serialNumber , other
    ...
    class CdpInterfaceExtTable(object):
        ...
        .. attribute:: cdpinterfaceextentry
        	...
        	**type**\: list of :py:class:`CdpInterfaceExtEntry <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpInterfaceExtTable.CdpInterfaceExtEntry>`
        ...
        class CdpInterfaceExtEntry(object):
            ...
            .. attribute:: cdpinterfaceextendedtrust
            	...
            	**type**\: :py:class:`CdpInterfaceExtendedTrust_Enum <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpInterfaceExtTable.CdpInterfaceExtEntry.CdpInterfaceExtendedTrust_Enum>`
            ...
            class CdpInterfaceExtendedTrust_Enum(Enum):
                """
                CdpInterfaceExtendedTrust_Enum
                ...
                def _meta_info():
                    from ydk.models.cdp._meta import _CISCO_CDP_MIB as meta
                    return meta._meta_table['CISCOCDPMIB.CdpInterfaceExtTable.CdpInterfaceExtEntry.CdpInterfaceExtendedTrust_Enum']
    ...
    class CdpInterfaceTable(object):
        ...
        .. attribute:: cdpinterfaceentry
        	...
        	**type**\: list of :py:class:`CdpInterfaceEntry <ydk.models.cdp.CISCO_CDP_MIB.CISCOCDPMIB.CdpInterfaceTable.CdpInterfaceEntry>`
        ...
        class CdpInterfaceEntry(object):
            ...
            def _common_path(self):
                if self.cdpinterfaceifindex is None:
                    raise YPYDataValidationError('Key property cdpinterfaceifindex is None')
    ...
    def _has_data(self):
        ...
        if self.cdpcachetable is not None and self.cdpcachetable.is_presence():
            return True

        if self.cdpctaddresstable is not None and self.cdpctaddresstable._has_data():
            return True

        if self.cdpctaddresstable is not None and self.cdpctaddresstable.is_presence():
            return True

        if self.cdpglobal is not None and self.cdpglobal._has_data():
            return True

        if self.cdpglobal is not None and self.cdpglobal.is_presence():
            return True

        if self.cdpinterfaceexttable is not None and self.cdpinterfaceexttable._has_data():
            return True

        if self.cdpinterfaceexttable is not None and self.cdpinterfaceexttable.is_presence():
            return True

        if self.cdpinterfacetable is not None and self.cdpinterfacetable._has_data():
            return True

        if self.cdpinterfacetable is not None and self.cdpinterfacetable.is_presence():
            return True
