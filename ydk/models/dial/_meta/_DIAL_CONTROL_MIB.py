...
_meta_table = {
    'DIALCONTROLMIB.CallActiveTable.CallActiveEntry.CallActiveCallOrigin_Enum' : _MetaInfoEnum('CallActiveCallOrigin_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'originate':'ORIGINATE',
            'answer':'ANSWER',
            'callback':'CALLBACK',
        }, 'DIAL-CONTROL-MIB', _yang_ns._namespaces['DIAL-CONTROL-MIB']),
    'DIALCONTROLMIB.CallActiveTable.CallActiveEntry.CallActiveCallState_Enum' : _MetaInfoEnum('CallActiveCallState_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'unknown':'UNKNOWN',
    ...
    'DIALCONTROLMIB.CallActiveTable.CallActiveEntry.CallActiveInfoType_Enum' : _MetaInfoEnum('CallActiveInfoType_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'other':'OTHER',
            'speech':'SPEECH',
    ...
    'DIALCONTROLMIB.CallActiveTable.CallActiveEntry' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.CallActiveTable.CallActiveEntry',
            ...
            _MetaInfoClassMember('callActiveSetupTime', ATTRIBUTE, 'int' , None, None, 
                ...
                'callactivesetuptime',
                'DIAL-CONTROL-MIB', True),
            _MetaInfoClassMember('callActiveCallOrigin', REFERENCE_ENUM_CLASS, 'CallActiveCallOrigin_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallActiveTable.CallActiveEntry.CallActiveCallOrigin_Enum', 
                [], [], 
                '''                The call origin.
                ''',
                'callactivecallorigin',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('callActiveCallState', REFERENCE_ENUM_CLASS, 'CallActiveCallState_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallActiveTable.CallActiveEntry.CallActiveCallState_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('callActiveConnectTime', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('callActiveInfoType', REFERENCE_ENUM_CLASS, 'CallActiveInfoType_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallActiveTable.CallActiveEntry.CallActiveInfoType_Enum', 
                [], [], 
        ...
        'ydk.models.dial.DIAL_CONTROL_MIB'
        ),
    },
    'DIALCONTROLMIB.CallActiveTable' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.CallActiveTable',
            False, 
            [
            _MetaInfoClassMember('callActiveEntry', REFERENCE_LIST, 'CallActiveEntry' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallActiveTable.CallActiveEntry', 
                [], [], 
    ...
    'DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry.CallHistoryCallOrigin_Enum' : _MetaInfoEnum('CallHistoryCallOrigin_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'originate':'ORIGINATE',
            'answer':'ANSWER',
            'callback':'CALLBACK',
        }, 'DIAL-CONTROL-MIB', _yang_ns._namespaces['DIAL-CONTROL-MIB']),
    'DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry.CallHistoryInfoType_Enum' : _MetaInfoEnum('CallHistoryInfoType_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'other':'OTHER',
            'speech':'SPEECH',
            'unrestrictedDigital':'UNRESTRICTEDDIGITAL',
    ...
    'DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry',
            ...
            _MetaInfoClassMember('callActiveSetupTime', ATTRIBUTE, 'int' , None, None, 
                ...
                'callactivesetuptime',
                'DIAL-CONTROL-MIB', True),
            _MetaInfoClassMember('callHistoryCallOrigin', REFERENCE_ENUM_CLASS, 'CallHistoryCallOrigin_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry.CallHistoryCallOrigin_Enum', 
                [], [], 
                '''                The call origin.
                ''',
            ...
            _MetaInfoClassMember('callHistoryDisconnectTime', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('callHistoryInfoType', REFERENCE_ENUM_CLASS, 'CallHistoryInfoType_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry.CallHistoryInfoType_Enum', 
                [], [], 
                '''                The information type for this call.
                ''',
                'callhistoryinfotype',
    ...
    'DIALCONTROLMIB.CallHistoryTable' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.CallHistoryTable',
            False, 
            [
            _MetaInfoClassMember('callHistoryEntry', REFERENCE_LIST, 'CallHistoryEntry' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallHistoryTable.CallHistoryEntry', 
                [], [], 
    ...
    'DIALCONTROLMIB.DialCtlConfiguration.DialCtlAcceptMode_Enum' : _MetaInfoEnum('DialCtlAcceptMode_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'acceptNone':'ACCEPTNONE',
            'acceptAll':'ACCEPTALL',
            'acceptKnown':'ACCEPTKNOWN',
        }, 'DIAL-CONTROL-MIB', _yang_ns._namespaces['DIAL-CONTROL-MIB']),
    'DIALCONTROLMIB.DialCtlConfiguration.DialCtlTrapEnable_Enum' : _MetaInfoEnum('DialCtlTrapEnable_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'DIAL-CONTROL-MIB', _yang_ns._namespaces['DIAL-CONTROL-MIB']),
    'DIALCONTROLMIB.DialCtlConfiguration' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.DialCtlConfiguration',
            False, 
            [
            _MetaInfoClassMember('dialCtlAcceptMode', REFERENCE_ENUM_CLASS, 'DialCtlAcceptMode_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlConfiguration.DialCtlAcceptMode_Enum', 
                [], [], 
                ...
                'dialctlacceptmode',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlTrapEnable', REFERENCE_ENUM_CLASS, 'DialCtlTrapEnable_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlConfiguration.DialCtlTrapEnable_Enum', 
                [], [], 
    ...
    'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry.DialCtlPeerCfgInfoType_Enum' : _MetaInfoEnum('DialCtlPeerCfgInfoType_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'other':'OTHER',
            'speech':'SPEECH',
            'unrestrictedDigital':'UNRESTRICTEDDIGITAL',
    ...
    'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry.DialCtlPeerCfgPermission_Enum' : _MetaInfoEnum('DialCtlPeerCfgPermission_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'originate':'ORIGINATE',
            'answer':'ANSWER',
            'both':'BOTH',
    ...
    'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry.DialCtlPeerCfgTrapEnable_Enum' : _MetaInfoEnum('DialCtlPeerCfgTrapEnable_Enum', 'ydk.models.dial.DIAL_CONTROL_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'DIAL-CONTROL-MIB', _yang_ns._namespaces['DIAL-CONTROL-MIB']),
    'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry',
            ...
            _MetaInfoClassMember('dialCtlPeerCfgFailureDelay', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlPeerCfgIfType', REFERENCE_ENUM_CLASS, 'IANAifType_Enum' , 'ydk.models.ianaiftype.IANAifType_MIB', 'IANAifType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dialCtlPeerCfgInactivityTimer', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlPeerCfgInfoType', REFERENCE_ENUM_CLASS, 'DialCtlPeerCfgInfoType_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry.DialCtlPeerCfgInfoType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dialCtlPeerCfgOriginateAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlPeerCfgPermission', REFERENCE_ENUM_CLASS, 'DialCtlPeerCfgPermission_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry.DialCtlPeerCfgPermission_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dialCtlPeerCfgSpeed', ATTRIBUTE, 'int' , None, None, 
                ...
                'dialctlpeercfgspeed',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlPeerCfgStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dialCtlPeerCfgSubAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlPeerCfgTrapEnable', REFERENCE_ENUM_CLASS, 'DialCtlPeerCfgTrapEnable_Enum' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry.DialCtlPeerCfgTrapEnable_Enum', 
                [], [], 
                '''                This object indicates whether dialCtlPeerCallInformation
                and dialCtlPeerCallSetup traps should be generated for
                this peer.
    ...
    'DIALCONTROLMIB.DialCtlPeerCfgTable' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB.DialCtlPeerCfgTable',
            False, 
            [
            _MetaInfoClassMember('dialCtlPeerCfgEntry', REFERENCE_LIST, 'DialCtlPeerCfgEntry' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlPeerCfgTable.DialCtlPeerCfgEntry', 
                [], [], 
    ...
    'DIALCONTROLMIB' : {
        'meta_info' : _MetaInfoClass('DIALCONTROLMIB',
            False, 
            [
            _MetaInfoClassMember('callActiveTable', REFERENCE_CLASS, 'CallActiveTable' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallActiveTable', 
                [], [], 
                ...
                'callactivetable',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('callHistory', REFERENCE_CLASS, 'CallHistory' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallHistory', 
                [], [], 
                '''                ''',
                'callhistory',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('callHistoryTable', REFERENCE_CLASS, 'CallHistoryTable' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.CallHistoryTable', 
                [], [], 
                ...
                'callhistorytable',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlConfiguration', REFERENCE_CLASS, 'DialCtlConfiguration' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlConfiguration', 
                [], [], 
                '''                ''',
                'dialctlconfiguration',
                'DIAL-CONTROL-MIB', False),
            _MetaInfoClassMember('dialCtlPeerCfgTable', REFERENCE_CLASS, 'DialCtlPeerCfgTable' , 'ydk.models.dial.DIAL_CONTROL_MIB', 'DIALCONTROLMIB.DialCtlPeerCfgTable', 
                [], [], 
