...
class CISCODOT3OAMMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cdot3OamEventConfigTable" : ("cdot3oameventconfigtable", CISCODOT3OAMMIB.Cdot3Oameventconfigtable), "cdot3OamEventLogTable" : ("cdot3oameventlogtable", CISCODOT3OAMMIB.Cdot3Oameventlogtable), "cdot3OamLoopbackTable" : ("cdot3oamloopbacktable", CISCODOT3OAMMIB.Cdot3Oamloopbacktable), "cdot3OamPeerTable" : ("cdot3oampeertable", CISCODOT3OAMMIB.Cdot3Oampeertable), "cdot3OamStatsTable" : ("cdot3oamstatstable", CISCODOT3OAMMIB.Cdot3Oamstatstable), "cdot3OamTable" : ("cdot3oamtable", CISCODOT3OAMMIB.Cdot3Oamtable)}
    ...
    class Cdot3Oameventconfigtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cdot3OamEventConfigEntry" : ("cdot3oameventconfigentry", CISCODOT3OAMMIB.Cdot3Oameventconfigtable.Cdot3Oameventconfigentry)}
        ...
        class Cdot3Oameventconfigentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cdot3OamEventConfigEntry" + "[ifIndex='" + self.ifindex.get() + "']"
                self._absolute_path = lambda: "CISCO-DOT3-OAM-MIB:CISCO-DOT3-OAM-MIB/cdot3OamEventConfigTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCODOT3OAMMIB.Cdot3Oameventconfigtable.Cdot3Oameventconfigentry, ['ifindex', 'cdot3oamcriticaleventenable', 'cdot3oamdyinggaspenable', 'cdot3oamerrframeevnotifenable', 'cdot3oamerrframeperiodevnotifenable', 'cdot3oamerrframeperiodthreshold', 'cdot3oamerrframeperiodwindow', 'cdot3oamerrframesecsevnotifenable', 'cdot3oamerrframesecssummarythreshold', 'cdot3oamerrframesecssummarywindow', 'cdot3oamerrframethreshold', 'cdot3oamerrframewindow', 'cdot3oamerrsymperiodevnotifenable', 'cdot3oamerrsymperiodthresholdhi', 'cdot3oamerrsymperiodthresholdlo', 'cdot3oamerrsymperiodwindowhi', 'cdot3oamerrsymperiodwindowlo'], name, value)
    ...
    class Cdot3Oameventlogtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cdot3OamEventLogEntry" : ("cdot3oameventlogentry", CISCODOT3OAMMIB.Cdot3Oameventlogtable.Cdot3Oameventlogentry)}
        ...
        class Cdot3Oameventlogentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cdot3OamEventLogEntry" + "[ifIndex='" + self.ifindex.get() + "']" + "[cdot3OamEventLogIndex='" + self.cdot3oameventlogindex.get() + "']"
                self._absolute_path = lambda: "CISCO-DOT3-OAM-MIB:CISCO-DOT3-OAM-MIB/cdot3OamEventLogTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCODOT3OAMMIB.Cdot3Oameventlogtable.Cdot3Oameventlogentry, ['ifindex', 'cdot3oameventlogindex', 'cdot3oameventlogeventtotal', 'cdot3oameventloglocation', 'cdot3oameventlogoui', 'cdot3oameventlogrunningtotal', 'cdot3oameventlogthresholdhi', 'cdot3oameventlogthresholdlo', 'cdot3oameventlogtimestamp', 'cdot3oameventlogtype', 'cdot3oameventlogvalue', 'cdot3oameventlogwindowhi', 'cdot3oameventlogwindowlo'], name, value)
    ...
    class Cdot3Oamloopbacktable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cdot3OamLoopbackEntry" : ("cdot3oamloopbackentry", CISCODOT3OAMMIB.Cdot3Oamloopbacktable.Cdot3Oamloopbackentry)}
        ...
        class Cdot3Oamloopbackentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cdot3OamLoopbackEntry" + "[ifIndex='" + self.ifindex.get() + "']"
                self._absolute_path = lambda: "CISCO-DOT3-OAM-MIB:CISCO-DOT3-OAM-MIB/cdot3OamLoopbackTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCODOT3OAMMIB.Cdot3Oamloopbacktable.Cdot3Oamloopbackentry, ['ifindex', 'cdot3oamloopbackignorerx', 'cdot3oamloopbackstatus'], name, value)
    ...
    class Cdot3Oampeertable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cdot3OamPeerEntry" : ("cdot3oampeerentry", CISCODOT3OAMMIB.Cdot3Oampeertable.Cdot3Oampeerentry)}
        ...
        class Cdot3Oampeerentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cdot3OamPeerEntry" + "[ifIndex='" + self.ifindex.get() + "']"
                self._absolute_path = lambda: "CISCO-DOT3-OAM-MIB:CISCO-DOT3-OAM-MIB/cdot3OamPeerTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCODOT3OAMMIB.Cdot3Oampeertable.Cdot3Oampeerentry, ['ifindex', 'cdot3oampeerconfigrevision', 'cdot3oampeerfunctionssupported', 'cdot3oampeermacaddress', 'cdot3oampeermaxoampdusize', 'cdot3oampeermode', 'cdot3oampeervendorinfo', 'cdot3oampeervendoroui'], name, value)
    ...
    class Cdot3Oamstatstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cdot3OamStatsEntry" : ("cdot3oamstatsentry", CISCODOT3OAMMIB.Cdot3Oamstatstable.Cdot3Oamstatsentry)}
        ...
        class Cdot3Oamstatsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cdot3OamStatsEntry" + "[ifIndex='" + self.ifindex.get() + "']"
                self._absolute_path = lambda: "CISCO-DOT3-OAM-MIB:CISCO-DOT3-OAM-MIB/cdot3OamStatsTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCODOT3OAMMIB.Cdot3Oamstatstable.Cdot3Oamstatsentry, ['ifindex', 'cdot3oamduplicateeventnotificationrx', 'cdot3oamduplicateeventnotificationtx', 'cdot3oamframeslostduetooam', 'cdot3oaminformationrx', 'cdot3oaminformationtx', 'cdot3oamloopbackcontrolrx', 'cdot3oamloopbackcontroltx', 'cdot3oamorgspecificrx', 'cdot3oamorgspecifictx', 'cdot3oamuniqueeventnotificationrx', 'cdot3oamuniqueeventnotificationtx', 'cdot3oamunsupportedcodesrx', 'cdot3oamunsupportedcodestx', 'cdot3oamvariablerequestrx', 'cdot3oamvariablerequesttx', 'cdot3oamvariableresponserx', 'cdot3oamvariableresponsetx'], name, value)
    ...
    class Cdot3Oamtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cdot3OamEntry" : ("cdot3oamentry", CISCODOT3OAMMIB.Cdot3Oamtable.Cdot3Oamentry)}
        ...
        class Cdot3Oamentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cdot3OamEntry" + "[ifIndex='" + self.ifindex.get() + "']"
                self._absolute_path = lambda: "CISCO-DOT3-OAM-MIB:CISCO-DOT3-OAM-MIB/cdot3OamTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCODOT3OAMMIB.Cdot3Oamtable.Cdot3Oamentry, ['ifindex', 'cdot3oamadminstate', 'cdot3oamconfigrevision', 'cdot3oamfunctionssupported', 'cdot3oammaxoampdusize', 'cdot3oammode', 'cdot3oamoperstatus'], name, value)
