...
_meta_table = {
    'CISCOIPTAPMIB.CitapStreamEncodePacket' : {
        'meta_info' : _MetaInfoClass('CISCOIPTAPMIB.CitapStreamEncodePacket',
            False, 
            [
            _MetaInfoClassMember('citapStreamCapabilities', REFERENCE_BITS, 'CitapStreamCapabilities_Bits' , 'ydk.models.ip.CISCO_IP_TAP_MIB', 'CISCOIPTAPMIB.CitapStreamEncodePacket.CitapStreamCapabilities_Bits', 
                [], [], 
        ...
        'ydk.models.ip.CISCO_IP_TAP_MIB'
        ),
    },
    'CISCOIPTAPMIB.CitapStreamTable.CitapStreamEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIPTAPMIB.CitapStreamTable.CitapStreamEntry',
            ...
            _MetaInfoClassMember('cTap2StreamIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'ctap2streamindex',
                'CISCO-IP-TAP-MIB', True),
            _MetaInfoClassMember('citapStreamAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('citapStreamSourceLength', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IP-TAP-MIB', False),
            _MetaInfoClassMember('citapStreamStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'CISCOIPTAPMIB.CitapStreamTable' : {
        'meta_info' : _MetaInfoClass('CISCOIPTAPMIB.CitapStreamTable',
            False, 
            [
            _MetaInfoClassMember('citapStreamEntry', REFERENCE_LIST, 'CitapStreamEntry' , 'ydk.models.ip.CISCO_IP_TAP_MIB', 'CISCOIPTAPMIB.CitapStreamTable.CitapStreamEntry', 
                [], [], 
    ...
    'CISCOIPTAPMIB' : {
        'meta_info' : _MetaInfoClass('CISCOIPTAPMIB',
            False, 
            [
            _MetaInfoClassMember('citapStreamEncodePacket', REFERENCE_CLASS, 'CitapStreamEncodePacket' , 'ydk.models.ip.CISCO_IP_TAP_MIB', 'CISCOIPTAPMIB.CitapStreamEncodePacket', 
                [], [], 
                '''                ''',
                'citapstreamencodepacket',
                'CISCO-IP-TAP-MIB', False),
            _MetaInfoClassMember('citapStreamTable', REFERENCE_CLASS, 'CitapStreamTable' , 'ydk.models.ip.CISCO_IP_TAP_MIB', 'CISCOIPTAPMIB.CitapStreamTable', 
                [], [], 
