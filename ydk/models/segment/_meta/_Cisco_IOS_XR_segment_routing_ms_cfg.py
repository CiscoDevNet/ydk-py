...
_meta_table = {
    'SrmsMiFlag_Enum' : _MetaInfoEnum('SrmsMiFlag_Enum', 'ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_cfg',
        {
            'disable':'DISABLE',
            'enable':'ENABLE',
    ...
    'Sr.Mappings.Mapping' : {
        'meta_info' : _MetaInfoClass('Sr.Mappings.Mapping',
            ...
            _MetaInfoClassMember('mask', ATTRIBUTE, 'int' , None, None, 
                ...
                'mask',
                'Cisco-IOS-XR-segment-routing-ms-cfg', True),
            _MetaInfoClassMember('flag-attached', REFERENCE_ENUM_CLASS, 'SrmsMiFlag_Enum' , 'ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_cfg', 'SrmsMiFlag_Enum', 
                [], [], 
    ...
    'Sr.Mappings' : {
        'meta_info' : _MetaInfoClass('Sr.Mappings',
            False, 
            [
            _MetaInfoClassMember('mapping', REFERENCE_LIST, 'Mapping' , 'ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_cfg', 'Sr.Mappings.Mapping', 
                [], [], 
    ...
    'Sr' : {
        'meta_info' : _MetaInfoClass('Sr',
            ...
            _MetaInfoClassMember('global-block', REFERENCE_CLASS, 'GlobalBlock' , 'ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_cfg', 'Sr.GlobalBlock', 
                ...
                'global_block',
                'Cisco-IOS-XR-segment-routing-ms-cfg', False),
            _MetaInfoClassMember('mappings', REFERENCE_CLASS, 'Mappings' , 'ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_cfg', 'Sr.Mappings', 
                [], [], 
                '''                Mapping Server
                ''',
                'mappings',
