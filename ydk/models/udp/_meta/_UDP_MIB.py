...
_meta_table = {
    ...
    'UDPMIB.UdpEndpointTable.UdpEndpointEntry' : {
        'meta_info' : _MetaInfoClass('UDPMIB.UdpEndpointTable.UdpEndpointEntry',
            ...
            _MetaInfoClassMember('udpEndpointLocalAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'UDP-MIB', True),
            _MetaInfoClassMember('udpEndpointLocalAddressType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('udpEndpointRemoteAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'UDP-MIB', True),
            _MetaInfoClassMember('udpEndpointRemoteAddressType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
    ...
    'UDPMIB.UdpEndpointTable' : {
        'meta_info' : _MetaInfoClass('UDPMIB.UdpEndpointTable',
            False, 
            [
            _MetaInfoClassMember('udpEndpointEntry', REFERENCE_LIST, 'UdpEndpointEntry' , 'ydk.models.udp.UDP_MIB', 'UDPMIB.UdpEndpointTable.UdpEndpointEntry', 
                [], [], 
    ...
    'UDPMIB.UdpTable' : {
        'meta_info' : _MetaInfoClass('UDPMIB.UdpTable',
            False, 
            [
            _MetaInfoClassMember('udpEntry', REFERENCE_LIST, 'UdpEntry' , 'ydk.models.udp.UDP_MIB', 'UDPMIB.UdpTable.UdpEntry', 
                [], [], 
    ...
    'UDPMIB' : {
        'meta_info' : _MetaInfoClass('UDPMIB',
            False, 
            [
            _MetaInfoClassMember('udp', REFERENCE_CLASS, 'Udp' , 'ydk.models.udp.UDP_MIB', 'UDPMIB.Udp', 
                [], [], 
                '''                ''',
                'udp',
                'UDP-MIB', False),
            _MetaInfoClassMember('udpEndpointTable', REFERENCE_CLASS, 'UdpEndpointTable' , 'ydk.models.udp.UDP_MIB', 'UDPMIB.UdpEndpointTable', 
                [], [], 
                ...
                'udpendpointtable',
                'UDP-MIB', False),
            _MetaInfoClassMember('udpTable', REFERENCE_CLASS, 'UdpTable' , 'ydk.models.udp.UDP_MIB', 'UDPMIB.UdpTable', 
                [], [], 
