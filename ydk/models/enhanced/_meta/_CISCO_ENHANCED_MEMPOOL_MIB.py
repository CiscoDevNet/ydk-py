...
_meta_table = {
    'CempMemPoolTypes_Enum' : _MetaInfoEnum('CempMemPoolTypes_Enum', 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB',
        {
            'other':'OTHER',
    ...
    'CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable.CempMemBufferCachePoolEntry' : {
        ...
        'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB'
        ),
    },
    'CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable' : {
        'meta_info' : _MetaInfoClass('CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable',
            False, 
            [
            _MetaInfoClassMember('cempMemBufferCachePoolEntry', REFERENCE_LIST, 'CempMemBufferCachePoolEntry' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable.CempMemBufferCachePoolEntry', 
                [], [], 
    ...
    'CISCOENHANCEDMEMPOOLMIB.CempMemBufferPoolTable' : {
        'meta_info' : _MetaInfoClass('CISCOENHANCEDMEMPOOLMIB.CempMemBufferPoolTable',
            False, 
            [
            _MetaInfoClassMember('cempMemBufferPoolEntry', REFERENCE_LIST, 'CempMemBufferPoolEntry' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempMemBufferPoolTable.CempMemBufferPoolEntry', 
                [], [], 
    ...
    'CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable.CempMemPoolEntry' : {
        'meta_info' : _MetaInfoClass('CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable.CempMemPoolEntry',
            ...
            _MetaInfoClassMember('cempMemPoolSharedOvrflw', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-ENHANCED-MEMPOOL-MIB', False),
            _MetaInfoClassMember('cempMemPoolType', REFERENCE_ENUM_CLASS, 'CempMemPoolTypes_Enum' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CempMemPoolTypes_Enum', 
                [], [], 
    ...
    'CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable' : {
        'meta_info' : _MetaInfoClass('CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable',
            False, 
            [
            _MetaInfoClassMember('cempMemPoolEntry', REFERENCE_LIST, 'CempMemPoolEntry' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable.CempMemPoolEntry', 
                [], [], 
    ...
    'CISCOENHANCEDMEMPOOLMIB' : {
        'meta_info' : _MetaInfoClass('CISCOENHANCEDMEMPOOLMIB',
            False, 
            [
            _MetaInfoClassMember('cempMemBufferCachePoolTable', REFERENCE_CLASS, 'CempMemBufferCachePoolTable' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable', 
                [], [], 
                ...
                'cempmembuffercachepooltable',
                'CISCO-ENHANCED-MEMPOOL-MIB', False),
            _MetaInfoClassMember('cempMemBufferPoolTable', REFERENCE_CLASS, 'CempMemBufferPoolTable' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempMemBufferPoolTable', 
                [], [], 
                ...
                'cempmembufferpooltable',
                'CISCO-ENHANCED-MEMPOOL-MIB', False),
            _MetaInfoClassMember('cempMemPoolTable', REFERENCE_CLASS, 'CempMemPoolTable' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable', 
                [], [], 
                ...
                'cempmempooltable',
                'CISCO-ENHANCED-MEMPOOL-MIB', False),
            _MetaInfoClassMember('cempNotificationConfig', REFERENCE_CLASS, 'CempNotificationConfig' , 'ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB', 'CISCOENHANCEDMEMPOOLMIB.CempNotificationConfig', 
                [], [], 
                '''                ''',
                'cempnotificationconfig',
                'CISCO-ENHANCED-MEMPOOL-MIB', False),
