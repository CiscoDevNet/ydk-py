...
_meta_table = {
    ...
    'HeadlessFuncData.EthernetPortNames.EthernetPortName' : {
        'meta_info' : _MetaInfoClass('HeadlessFuncData.EthernetPortNames.EthernetPortName',
            ...
            _MetaInfoClassMember('ether-statistics', REFERENCE_CLASS, 'EtherStatistics' , 'ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_headless_oper', 'HeadlessFuncData.EthernetPortNames.EthernetPortName.EtherStatistics', 
                [], [], 
                '''                Ether Statistics
                ''',
                'ether_statistics',
    ...
    'HeadlessFuncData.EthernetPortNames' : {
        'meta_info' : _MetaInfoClass('HeadlessFuncData.EthernetPortNames',
            False, 
            [
            _MetaInfoClassMember('ethernet-port-name', REFERENCE_LIST, 'EthernetPortName' , 'ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_headless_oper', 'HeadlessFuncData.EthernetPortNames.EthernetPortName', 
                [], [], 
                '''                Port Name
                ''',
                'ethernet_port_name',
    ...
    'HeadlessFuncData.OtnPortNames' : {
        'meta_info' : _MetaInfoClass('HeadlessFuncData.OtnPortNames',
            False, 
            [
            _MetaInfoClassMember('otn-port-name', REFERENCE_LIST, 'OtnPortName' , 'ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_headless_oper', 'HeadlessFuncData.OtnPortNames.OtnPortName', 
                [], [], 
                '''                port Name
                ''',
                'otn_port_name',
