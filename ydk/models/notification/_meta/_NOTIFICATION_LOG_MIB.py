...
_meta_table = {
    'NOTIFICATIONLOGMIB.NlmConfig' : {
        ...
        'ydk.models.notification.NOTIFICATION_LOG_MIB'
        ),
    },
    'NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry.NlmConfigLogAdminStatus_Enum' : _MetaInfoEnum('NlmConfigLogAdminStatus_Enum', 'ydk.models.notification.NOTIFICATION_LOG_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'NOTIFICATION-LOG-MIB', _yang_ns._namespaces['NOTIFICATION-LOG-MIB']),
    'NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry.NlmConfigLogOperStatus_Enum' : _MetaInfoEnum('NlmConfigLogOperStatus_Enum', 'ydk.models.notification.NOTIFICATION_LOG_MIB',
        {
            'disabled':'DISABLED',
    ...
    'NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry' : {
        'meta_info' : _MetaInfoClass('NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry',
            ...
            _MetaInfoClassMember('nlmConfigLogAdminStatus', REFERENCE_ENUM_CLASS, 'NlmConfigLogAdminStatus_Enum' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry.NlmConfigLogAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('nlmConfigLogEntryLimit', ATTRIBUTE, 'int' , None, None, 
                ...
                'nlmconfiglogentrylimit',
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmConfigLogEntryStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('nlmConfigLogFilterName', ATTRIBUTE, 'str' , None, None, 
                ...
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmConfigLogOperStatus', REFERENCE_ENUM_CLASS, 'NlmConfigLogOperStatus_Enum' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry.NlmConfigLogOperStatus_Enum', 
                [], [], 
                ...
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmConfigLogStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
    ...
    'NOTIFICATIONLOGMIB.NlmConfigLogTable' : {
        'meta_info' : _MetaInfoClass('NOTIFICATIONLOGMIB.NlmConfigLogTable',
            False, 
            [
            _MetaInfoClassMember('nlmConfigLogEntry', REFERENCE_LIST, 'NlmConfigLogEntry' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmConfigLogTable.NlmConfigLogEntry', 
                [], [], 
    ...
    'NOTIFICATIONLOGMIB.NlmLogTable' : {
        'meta_info' : _MetaInfoClass('NOTIFICATIONLOGMIB.NlmLogTable',
            False, 
            [
            _MetaInfoClassMember('nlmLogEntry', REFERENCE_LIST, 'NlmLogEntry' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmLogTable.NlmLogEntry', 
                [], [], 
    ...
    'NOTIFICATIONLOGMIB.NlmLogVariableTable.NlmLogVariableEntry.NlmLogVariableValueType_Enum' : _MetaInfoEnum('NlmLogVariableValueType_Enum', 'ydk.models.notification.NOTIFICATION_LOG_MIB',
        {
            'counter32':'COUNTER32',
    ...
    'NOTIFICATIONLOGMIB.NlmLogVariableTable.NlmLogVariableEntry' : {
        'meta_info' : _MetaInfoClass('NOTIFICATIONLOGMIB.NlmLogVariableTable.NlmLogVariableEntry',
            ...
            _MetaInfoClassMember('nlmLogVariableUnsigned32Val', ATTRIBUTE, 'int' , None, None, 
                ...
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmLogVariableValueType', REFERENCE_ENUM_CLASS, 'NlmLogVariableValueType_Enum' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmLogVariableTable.NlmLogVariableEntry.NlmLogVariableValueType_Enum', 
                [], [], 
    ...
    'NOTIFICATIONLOGMIB.NlmLogVariableTable' : {
        'meta_info' : _MetaInfoClass('NOTIFICATIONLOGMIB.NlmLogVariableTable',
            False, 
            [
            _MetaInfoClassMember('nlmLogVariableEntry', REFERENCE_LIST, 'NlmLogVariableEntry' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmLogVariableTable.NlmLogVariableEntry', 
                [], [], 
    ...
    'NOTIFICATIONLOGMIB' : {
        'meta_info' : _MetaInfoClass('NOTIFICATIONLOGMIB',
            False, 
            [
            _MetaInfoClassMember('nlmConfig', REFERENCE_CLASS, 'NlmConfig' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmConfig', 
                [], [], 
                '''                ''',
                'nlmconfig',
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmConfigLogTable', REFERENCE_CLASS, 'NlmConfigLogTable' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmConfigLogTable', 
                [], [], 
                '''                A table of logging control entries.
                ''',
                'nlmconfiglogtable',
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmLogTable', REFERENCE_CLASS, 'NlmLogTable' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmLogTable', 
                [], [], 
                ...
                'nlmlogtable',
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmLogVariableTable', REFERENCE_CLASS, 'NlmLogVariableTable' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmLogVariableTable', 
                [], [], 
                '''                A table of variables to go with Notification log entries.
                ''',
                'nlmlogvariabletable',
                'NOTIFICATION-LOG-MIB', False),
            _MetaInfoClassMember('nlmStats', REFERENCE_CLASS, 'NlmStats' , 'ydk.models.notification.NOTIFICATION_LOG_MIB', 'NOTIFICATIONLOGMIB.NlmStats', 
                [], [], 
                '''                ''',
                'nlmstats',
                'NOTIFICATION-LOG-MIB', False),
