...
class Vty(object):
    ...
    .. attribute:: vty_pools
    	...
    	List of VTY Pools
    	**type**\: :py:class:`VtyPools <ydk.models.tty.Cisco_IOS_XR_tty_vty_cfg.Vty.VtyPools>`
    ...
    class VtyPools(object):
        ...
        .. attribute:: vty_pool
        	...
        	VTY Pool
        	**type**\: list of :py:class:`VtyPool <ydk.models.tty.Cisco_IOS_XR_tty_vty_cfg.Vty.VtyPools.VtyPool>`
        ...
        class VtyPool(object):
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.tty._meta import _Cisco_IOS_XR_tty_vty_cfg as meta
