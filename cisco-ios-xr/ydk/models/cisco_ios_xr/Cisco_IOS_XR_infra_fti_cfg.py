...
class DciFabricInterconnect(Entity):
    ...
    class Acp(Entity):
        ...
        def __init__(self):
            ...
            self._leafs = OrderedDict([
                ('nve_id', YLeaf(YType.uint32, 'nve-id')),
                ('bgp_as', YLeaf(YType.uint32, 'bgp-as')),
                ('bg_name', YLeaf(YType.str, 'bg-name')),
            ])
            self.nve_id = None
            self.bgp_as = None
            self.bg_name = None
            ...
            class Vrf(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ...
                        ('bvi_vrf_ip', YLeaf(YType.str, 'bvi-vrf-ip')),
                    ])
                    self.vrf_name = None
