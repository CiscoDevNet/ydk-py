...
_meta_table = {
    'ShowUsers.Sessions.Session' : {
        ...
        'ydk.models.tty.Cisco_IOS_XR_tty_management_cmd_oper'
        ),
    },
    'ShowUsers.Sessions' : {
        'meta_info' : _MetaInfoClass('ShowUsers.Sessions',
            False, 
            [
            _MetaInfoClassMember('session', REFERENCE_LIST, 'Session' , 'ydk.models.tty.Cisco_IOS_XR_tty_management_cmd_oper', 'ShowUsers.Sessions.Session', 
                [], [], 
    ...
    'ShowUsers' : {
        'meta_info' : _MetaInfoClass('ShowUsers',
            False, 
            [
            _MetaInfoClassMember('sessions', REFERENCE_CLASS, 'Sessions' , 'ydk.models.tty.Cisco_IOS_XR_tty_management_cmd_oper', 'ShowUsers.Sessions', 
                [], [], 
                '''                Show users statistics
                ''',
                'sessions',
