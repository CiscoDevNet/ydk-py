...
class SysmgrProcessRestart(_Entity_):
    """
    ...
    class Input(_Entity_):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysmgr_act as meta
            return meta._meta_table['SysmgrProcessRestart.Input']['meta_info']
    ...
    def _meta_info():
        from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysmgr_act as meta
        return meta._meta_table['SysmgrProcessRestart']['meta_info']
