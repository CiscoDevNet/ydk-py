...
class HsrpState_Enum(Enum):
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.hsrp._meta import _CISCO_HSRP_MIB as meta
        return meta._meta_table['HsrpState_Enum']
...
class CISCOHSRPMIB(object):
    ...
    .. attribute:: chsrpglobalconfig
    	...
    	**type**\: :py:class:`CHsrpGlobalConfig <ydk.models.hsrp.CISCO_HSRP_MIB.CISCOHSRPMIB.CHsrpGlobalConfig>`
    
    .. attribute:: chsrpgrptable
    
    	A table containing information on each HSRP group for each interface
    	**type**\: :py:class:`CHsrpGrpTable <ydk.models.hsrp.CISCO_HSRP_MIB.CISCOHSRPMIB.CHsrpGrpTable>`
    ...
    class CHsrpGrpTable(object):
        ...
        .. attribute:: chsrpgrpentry
        	...
        	**type**\: list of :py:class:`CHsrpGrpEntry <ydk.models.hsrp.CISCO_HSRP_MIB.CISCOHSRPMIB.CHsrpGrpTable.CHsrpGrpEntry>`
        ...
        class CHsrpGrpEntry(object):
            ...
            .. attribute:: chsrpgrpstandbystate
            	...
            	**type**\: :py:class:`HsrpState_Enum <ydk.models.hsrp.CISCO_HSRP_MIB.HsrpState_Enum>`
            ...
            def _common_path(self):
                ...
                return '/CISCO-HSRP-MIB:CISCO-HSRP-MIB/CISCO-HSRP-MIB:cHsrpGrpTable/CISCO-HSRP-MIB:cHsrpGrpEntry[CISCO-HSRP-MIB:cHsrpGrpNumber = ' + str(self.chsrpgrpnumber) + '][CISCO-HSRP-MIB:ifIndex = ' + str(self.ifindex) + ']'
    ...
    def _has_data(self):
        ...
        if self.chsrpglobalconfig is not None and self.chsrpglobalconfig.is_presence():
            return True

        if self.chsrpgrptable is not None and self.chsrpgrptable._has_data():
            return True

        if self.chsrpgrptable is not None and self.chsrpgrptable.is_presence():
            return True
