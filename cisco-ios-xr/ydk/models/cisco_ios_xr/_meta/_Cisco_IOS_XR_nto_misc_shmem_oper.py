...
_meta_table = {
    ...
    'MemorySummary.Nodes.Node.Detail.SharedWindow' : {
        'meta_info' : _MetaInfoClass('MemorySummary.Nodes.Node.Detail.SharedWindow',
            ...
            _MetaInfoClassMember('shared-window', ATTRIBUTE, 'str' , None, None, 
                ...
                'shared_window',
                'Cisco-IOS-XR-nto-misc-shmem-oper', False),
            _MetaInfoClassMember('window-size', ATTRIBUTE, 'str' , None, None, 
                [], [], 
    ...
    'MemorySummary.Nodes.Node.Detail' : {
        'meta_info' : _MetaInfoClass('MemorySummary.Nodes.Node.Detail',
            False, 
            [
            _MetaInfoClassMember('allocated-memory', ATTRIBUTE, 'str' , None, None, 
                [], [], 
            ...
            _MetaInfoClassMember('page-size', ATTRIBUTE, 'int' , None, None, 
                ...
                'page_size',
                'Cisco-IOS-XR-nto-misc-shmem-oper', False),
            _MetaInfoClassMember('program-data', ATTRIBUTE, 'str' , None, None, 
                [], [], 
                '''                Program Data Size
                ''',
                'program_data',
                'Cisco-IOS-XR-nto-misc-shmem-oper', False),
            _MetaInfoClassMember('program-stack', ATTRIBUTE, 'str' , None, None, 
                [], [], 
                '''                Program Stack Size
                ''',
                'program_stack',
                'Cisco-IOS-XR-nto-misc-shmem-oper', False),
            _MetaInfoClassMember('program-text', ATTRIBUTE, 'str' , None, None, 
                [], [], 
                '''                Program Text Size
                ''',
                'program_text',
            ...
            _MetaInfoClassMember('system-ram-memory', ATTRIBUTE, 'int' , None, None, 
                ...
                'system_ram_memory',
                'Cisco-IOS-XR-nto-misc-shmem-oper', False),
            _MetaInfoClassMember('total-shared-window', ATTRIBUTE, 'str' , None, None, 
                [], [], 
                '''                Total Shared window
                ''',
                'total_shared_window',
