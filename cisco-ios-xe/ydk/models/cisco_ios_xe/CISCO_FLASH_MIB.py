...
class CISCOFLASHMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ciscoFlashCfg" : ("ciscoflashcfg", CISCOFLASHMIB.Ciscoflashcfg), "ciscoFlashChipTable" : ("ciscoflashchiptable", CISCOFLASHMIB.Ciscoflashchiptable), "ciscoFlashCopyTable" : ("ciscoflashcopytable", CISCOFLASHMIB.Ciscoflashcopytable), "ciscoFlashDevice" : ("ciscoflashdevice", CISCOFLASHMIB.Ciscoflashdevice), "ciscoFlashDeviceTable" : ("ciscoflashdevicetable", CISCOFLASHMIB.Ciscoflashdevicetable), "ciscoFlashFileByTypeTable" : ("ciscoflashfilebytypetable", CISCOFLASHMIB.Ciscoflashfilebytypetable), "ciscoFlashFileTable" : ("ciscoflashfiletable", CISCOFLASHMIB.Ciscoflashfiletable), "ciscoFlashMiscOpTable" : ("ciscoflashmiscoptable", CISCOFLASHMIB.Ciscoflashmiscoptable), "ciscoFlashPartitioningTable" : ("ciscoflashpartitioningtable", CISCOFLASHMIB.Ciscoflashpartitioningtable), "ciscoFlashPartitionTable" : ("ciscoflashpartitiontable", CISCOFLASHMIB.Ciscoflashpartitiontable)}
    ...
    class Ciscoflashchiptable(Entity):
        ...
        class Ciscoflashchipentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashchiptable.Ciscoflashchipentry, ['ciscoflashdeviceindex', 'ciscoflashchipindex', 'ciscoflashchipcode', 'ciscoflashchipdescr', 'ciscoflashchiperaseretries', 'ciscoflashchipmaxeraseretries', 'ciscoflashchipmaxwriteretries', 'ciscoflashchipwriteretries'], name, value)
    ...
    class Ciscoflashcopytable(Entity):
        ...
        class Ciscoflashcopyentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashcopytable.Ciscoflashcopyentry, ['ciscoflashcopyserialnumber', 'ciscoflashcopycommand', 'ciscoflashcopydestinationname', 'ciscoflashcopyentrystatus', 'ciscoflashcopynotifyoncompletion', 'ciscoflashcopyprotocol', 'ciscoflashcopyremotepassword', 'ciscoflashcopyremoteusername', 'ciscoflashcopyserveraddress', 'ciscoflashcopyserveraddrrev1', 'ciscoflashcopyserveraddrtype', 'ciscoflashcopysourcename', 'ciscoflashcopystatus', 'ciscoflashcopytime', 'ciscoflashcopyverify'], name, value)
    ...
    class Ciscoflashdevicetable(Entity):
        ...
        class Ciscoflashdeviceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashdevicetable.Ciscoflashdeviceentry, ['ciscoflashdeviceindex', 'ciscoflashdevicecard', 'ciscoflashdevicechipcount', 'ciscoflashdevicecontroller', 'ciscoflashdevicedescr', 'ciscoflashdeviceinittime', 'ciscoflashdevicemaxpartitions', 'ciscoflashdeviceminpartitionsize', 'ciscoflashdeviceminpartitionsizeextended', 'ciscoflashdevicename', 'ciscoflashdevicenameextended', 'ciscoflashdevicepartitions', 'ciscoflashdeviceprogrammingjumper', 'ciscoflashdeviceremovable', 'ciscoflashdevicesize', 'ciscoflashdevicesizeextended', 'ciscoflashphyentindex'], name, value)
    ...
    class Ciscoflashfilebytypetable(Entity):
        ...
        class Ciscoflashfilebytypeentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashfilebytypetable.Ciscoflashfilebytypeentry, ['ciscoflashfiletype', 'ciscoflashdeviceindex', 'ciscoflashpartitionindex', 'ciscoflashfileindex', 'ciscoflashfilebytypechecksum', 'ciscoflashfilebytypedate', 'ciscoflashfilebytypename', 'ciscoflashfilebytypesize', 'ciscoflashfilebytypestatus'], name, value)
    ...
    class Ciscoflashfiletable(Entity):
        ...
        class Ciscoflashfileentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashfiletable.Ciscoflashfileentry, ['ciscoflashdeviceindex', 'ciscoflashpartitionindex', 'ciscoflashfileindex', 'ciscoflashfilechecksum', 'ciscoflashfiledate', 'ciscoflashfilename', 'ciscoflashfilesize', 'ciscoflashfilestatus', 'ciscoflashfiletype'], name, value)
    ...
    class Ciscoflashmiscoptable(Entity):
        ...
        class Ciscoflashmiscopentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashmiscoptable.Ciscoflashmiscopentry, ['ciscoflashmiscopserialnumber', 'ciscoflashmiscopcommand', 'ciscoflashmiscopdestinationname', 'ciscoflashmiscopentrystatus', 'ciscoflashmiscopnotifyoncompletion', 'ciscoflashmiscopstatus', 'ciscoflashmiscoptime'], name, value)
    ...
    class Ciscoflashpartitioningtable(Entity):
        ...
        class Ciscoflashpartitioningentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashpartitioningtable.Ciscoflashpartitioningentry, ['ciscoflashpartitioningserialnumber', 'ciscoflashpartitioningcommand', 'ciscoflashpartitioningdestinationname', 'ciscoflashpartitioningentrystatus', 'ciscoflashpartitioningnotifyoncompletion', 'ciscoflashpartitioningpartitioncount', 'ciscoflashpartitioningpartitionsizes', 'ciscoflashpartitioningstatus', 'ciscoflashpartitioningtime'], name, value)
    ...
    class Ciscoflashpartitiontable(Entity):
        ...
        class Ciscoflashpartitionentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOFLASHMIB.Ciscoflashpartitiontable.Ciscoflashpartitionentry, ['ciscoflashdeviceindex', 'ciscoflashpartitionindex', 'ciscoflashpartitionchecksumalgorithm', 'ciscoflashpartitionendchip', 'ciscoflashpartitionfilecount', 'ciscoflashpartitionfilenamelength', 'ciscoflashpartitionfreespace', 'ciscoflashpartitionfreespaceextended', 'ciscoflashpartitionlowspacenotifthreshold', 'ciscoflashpartitionname', 'ciscoflashpartitionneederasure', 'ciscoflashpartitionsize', 'ciscoflashpartitionsizeextended', 'ciscoflashpartitionstartchip', 'ciscoflashpartitionstatus', 'ciscoflashpartitionupgrademethod'], name, value)
