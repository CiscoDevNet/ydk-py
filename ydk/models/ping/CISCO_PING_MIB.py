...
class CISCOPINGMIB(object):
    ...
    .. attribute:: ciscopingtable
    	...
    	**type**\: :py:class:`CiscoPingTable <ydk.models.ping.CISCO_PING_MIB.CISCOPINGMIB.CiscoPingTable>`
    ...
    class CiscoPingTable(object):
        ...
        .. attribute:: ciscopingentry
        	...
        	**type**\: list of :py:class:`CiscoPingEntry <ydk.models.ping.CISCO_PING_MIB.CISCOPINGMIB.CiscoPingTable.CiscoPingEntry>`
        ...
        class CiscoPingEntry(object):
            ...
            .. attribute:: ciscopingserialnumber
            ...
            def _common_path(self):
                if self.ciscopingserialnumber is None:
                    raise YPYDataValidationError('Key property ciscopingserialnumber is None')
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.ping._meta import _CISCO_PING_MIB as meta
    ...
    def _has_data(self):
        ...
        if self.ciscopingtable is not None and self.ciscopingtable.is_presence():
            return True
