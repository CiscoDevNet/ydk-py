...
class IGMPSTDMIB(object):
    ...
    .. attribute:: igmpcachetable
    	...
    	**type**\: :py:class:`IgmpCacheTable <ydk.models.igmp.IGMP_STD_MIB.IGMPSTDMIB.IgmpCacheTable>`
    
    .. attribute:: igmpinterfacetable
    
    	The (conceptual) table listing the interfaces on which IGMP is enabled
    	**type**\: :py:class:`IgmpInterfaceTable <ydk.models.igmp.IGMP_STD_MIB.IGMPSTDMIB.IgmpInterfaceTable>`
    ...
    class IgmpCacheTable(object):
        ...
        .. attribute:: igmpcacheentry
        	...
        	**type**\: list of :py:class:`IgmpCacheEntry <ydk.models.igmp.IGMP_STD_MIB.IGMPSTDMIB.IgmpCacheTable.IgmpCacheEntry>`
        ...
        class IgmpCacheEntry(object):
            ...
            def _common_path(self):
                if self.igmpcacheaddress is None:
                    raise YPYDataValidationError('Key property igmpcacheaddress is None')
                if self.igmpcacheifindex is None:
                    raise YPYDataValidationError('Key property igmpcacheifindex is None')
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.igmp._meta import _IGMP_STD_MIB as meta
    ...
    class IgmpInterfaceTable(object):
        ...
        .. attribute:: igmpinterfaceentry
        	...
        	**type**\: list of :py:class:`IgmpInterfaceEntry <ydk.models.igmp.IGMP_STD_MIB.IGMPSTDMIB.IgmpInterfaceTable.IgmpInterfaceEntry>`
        ...
        class IgmpInterfaceEntry(object):
            ...
            .. attribute:: igmpinterfaceifindex
            ...
            def _common_path(self):
                if self.igmpinterfaceifindex is None:
                    raise YPYDataValidationError('Key property igmpinterfaceifindex is None')
    ...
    def _has_data(self):
        ...
        if self.igmpcachetable is not None and self.igmpcachetable.is_presence():
            return True

        if self.igmpinterfacetable is not None and self.igmpinterfacetable._has_data():
            return True

        if self.igmpinterfacetable is not None and self.igmpinterfacetable.is_presence():
            return True
