...
class CISCOTAP2MIB(object):
    ...
    .. attribute:: ctap2debuggroup
    	...
    	**type**\: :py:class:`CTap2DebugGroup <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2DebugGroup>`
    ...
    .. attribute:: ctap2debugtable
    	...
    	**type**\: :py:class:`CTap2DebugTable <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2DebugTable>`
    ...
    .. attribute:: ctap2debugusertable
    	...
    	**type**\: :py:class:`CTap2DebugUserTable <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2DebugUserTable>`
    
    .. attribute:: ctap2mediationgroup
    
    	
    	**type**\: :py:class:`CTap2MediationGroup <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2MediationGroup>`
    ...
    .. attribute:: ctap2mediationtable
    	...
    	**type**\: :py:class:`CTap2MediationTable <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2MediationTable>`
    ...
    .. attribute:: ctap2streamtable
    	...
    	**type**\: :py:class:`CTap2StreamTable <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2StreamTable>`
    ...
    class CTap2DebugGroup(object):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.tap2._meta import _CISCO_TAP2_MIB as meta
    ...
    class CTap2DebugTable(object):
        ...
        .. attribute:: ctap2debugentry
        	...
        	**type**\: list of :py:class:`CTap2DebugEntry <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2DebugTable.CTap2DebugEntry>`
        ...
        class CTap2DebugEntry(object):
            ...
            def _common_path(self):
                if self.ctap2debugindex is None:
                    raise YPYDataValidationError('Key property ctap2debugindex is None')
    ...
    class CTap2DebugUserTable(object):
        ...
        .. attribute:: ctap2debuguserentry
        	...
        	**type**\: list of :py:class:`CTap2DebugUserEntry <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2DebugUserTable.CTap2DebugUserEntry>`
        ...
        class CTap2DebugUserEntry(object):
            ...
            def _common_path(self):
                if self.ctap2debugusername is None:
                    raise YPYDataValidationError('Key property ctap2debugusername is None')
                if self.ctap2mediationcontentid is None:
                    raise YPYDataValidationError('Key property ctap2mediationcontentid is None')

                return '/CISCO-TAP2-MIB:CISCO-TAP2-MIB/CISCO-TAP2-MIB:cTap2DebugUserTable/CISCO-TAP2-MIB:cTap2DebugUserEntry[CISCO-TAP2-MIB:cTap2DebugUserName = ' + str(self.ctap2debugusername) + '][CISCO-TAP2-MIB:cTap2MediationContentId = ' + str(self.ctap2mediationcontentid) + ']'
    ...
    class CTap2MediationGroup(object):
        ...
        .. attribute:: ctap2mediationcapabilities
        	...
        	**type**\: :py:class:`CTap2MediationCapabilities_Bits <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2MediationGroup.CTap2MediationCapabilities_Bits>`
        ...
        def __init__(self):
            self.parent = None
            self.ctap2mediationcapabilities = CISCOTAP2MIB.CTap2MediationGroup.CTap2MediationCapabilities_Bits()
            self.ctap2mediationnewindex = None

        class CTap2MediationCapabilities_Bits(FixedBitsDict):
            """
            CTap2MediationCapabilities_Bits
            ...
            Keys are:- udp , rtpNack , tcp , ipV6SrcInterface , radius , rtp , ipV4SrcInterface , sctp
    ...
    class CTap2MediationTable(object):
        ...
        .. attribute:: ctap2mediationentry
        	...
        	**type**\: list of :py:class:`CTap2MediationEntry <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2MediationTable.CTap2MediationEntry>`
        ...
        class CTap2MediationEntry(object):
            ...
            .. attribute:: ctap2mediationtransport
            	...
            	**type**\: :py:class:`CTap2MediationTransport_Enum <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2MediationTable.CTap2MediationEntry.CTap2MediationTransport_Enum>`
            ...
            class CTap2MediationTransport_Enum(Enum):
                """
                CTap2MediationTransport_Enum
                ...
                def _meta_info():
                    from ydk.models.tap2._meta import _CISCO_TAP2_MIB as meta
                    return meta._meta_table['CISCOTAP2MIB.CTap2MediationTable.CTap2MediationEntry.CTap2MediationTransport_Enum']
    ...
    class CTap2StreamTable(object):
        ...
        .. attribute:: ctap2streamentry
        	...
        	**type**\: list of :py:class:`CTap2StreamEntry <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2StreamTable.CTap2StreamEntry>`
        ...
        class CTap2StreamEntry(object):
            ...
            .. attribute:: ctap2streamtype
            	...
            	**type**\: :py:class:`CTap2StreamType_Enum <ydk.models.tap2.CISCO_TAP2_MIB.CISCOTAP2MIB.CTap2StreamTable.CTap2StreamEntry.CTap2StreamType_Enum>`
            ...
            class CTap2StreamType_Enum(Enum):
                """
                CTap2StreamType_Enum
                ...
                def _meta_info():
                    from ydk.models.tap2._meta import _CISCO_TAP2_MIB as meta
                    return meta._meta_table['CISCOTAP2MIB.CTap2StreamTable.CTap2StreamEntry.CTap2StreamType_Enum']
    ...
    def _has_data(self):
        ...
        if self.ctap2debuggroup is not None and self.ctap2debuggroup.is_presence():
            return True

        if self.ctap2debugtable is not None and self.ctap2debugtable._has_data():
            return True

        if self.ctap2debugtable is not None and self.ctap2debugtable.is_presence():
            return True

        if self.ctap2debugusertable is not None and self.ctap2debugusertable._has_data():
            return True

        if self.ctap2debugusertable is not None and self.ctap2debugusertable.is_presence():
            return True

        if self.ctap2mediationgroup is not None and self.ctap2mediationgroup._has_data():
            return True

        if self.ctap2mediationgroup is not None and self.ctap2mediationgroup.is_presence():
            return True

        if self.ctap2mediationtable is not None and self.ctap2mediationtable._has_data():
            return True

        if self.ctap2mediationtable is not None and self.ctap2mediationtable.is_presence():
            return True

        if self.ctap2streamtable is not None and self.ctap2streamtable._has_data():
            return True

        if self.ctap2streamtable is not None and self.ctap2streamtable.is_presence():
            return True
