    ...
    class Agent(Entity):
        ...
        class Tty(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"session" : ("session", Netconf.Agent.Tty.Session), "throttle" : ("throttle", Netconf.Agent.Tty.Throttle)}
                self._child_list_classes = {}
...
class XrXml(Entity):
    ...
    class Agent(Entity):
        ...
        class Default(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(XrXml.Agent.Default, ['enable', 'ipv4_disable', 'ipv6_enable', 'iteration_size', 'streaming_size'], name, value)
            ...
            class Throttle(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(XrXml.Agent.Default.Throttle, ['memory', 'process_rate'], name, value)
            ...
            class Vrfs(Entity):
                ...
                class Vrf(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(XrXml.Agent.Default.Vrfs.Vrf, ['vrf_name', 'access_list', 'ipv4_access_list', 'ipv6_access_list', 'shutdown'], name, value)
        ...
        class Ssl(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(XrXml.Agent.Ssl, ['enable', 'iteration_size', 'streaming_size'], name, value)
            ...
            class Throttle(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(XrXml.Agent.Ssl.Throttle, ['memory', 'process_rate'], name, value)
            ...
            class Vrfs(Entity):
                ...
                class Vrf(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(XrXml.Agent.Ssl.Vrfs.Vrf, ['vrf_name', 'access_list', 'ipv4_access_list', 'ipv6_access_list', 'shutdown'], name, value)
        ...
        class Tty(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(XrXml.Agent.Tty, ['enable', 'iteration_size', 'streaming_size'], name, value)
            ...
            class Throttle(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(XrXml.Agent.Tty.Throttle, ['memory', 'process_rate'], name, value)
