...
_meta_table = {
    'UdpAddressFamily_Enum' : _MetaInfoEnum('UdpAddressFamily_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper',
        {
            'ipv4':'IPV4',
            'ipv6':'IPV6',
        }, 'Cisco-IOS-XR-asr9k-netflow-oper', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-netflow-oper']),
    'NfmgrFemEdmExpVer_Enum' : _MetaInfoEnum('NfmgrFemEdmExpVer_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper',
        {
            'v9':'V9',
            'ip-fix':'IP_FIX',
        }, 'Cisco-IOS-XR-asr9k-netflow-oper', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-netflow-oper']),
    'NfmgrFemEdmTransProto_Enum' : _MetaInfoEnum('NfmgrFemEdmTransProto_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper',
        {
    ...
    'NetFlow.Configuration.FlowExporterMaps.FlowExporterMap.Collector' : {
        'meta_info' : _MetaInfoClass('NetFlow.Configuration.FlowExporterMaps.FlowExporterMap.Collector',
            ...
            _MetaInfoClassMember('source-interface', ATTRIBUTE, 'str' , None, None, 
                ...
                'source_interface',
                'Cisco-IOS-XR-asr9k-netflow-oper', False),
            _MetaInfoClassMember('transport-protocol', REFERENCE_ENUM_CLASS, 'NfmgrFemEdmTransProto_Enum' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper', 'NfmgrFemEdmTransProto_Enum', 
                [], [], 
                '''                Transport protocol
                ''',
                'transport_protocol',
    ...
    'NetFlow.Configuration.FlowExporterMaps.FlowExporterMap.Version' : {
        'meta_info' : _MetaInfoClass('NetFlow.Configuration.FlowExporterMaps.FlowExporterMap.Version',
            ...
            _MetaInfoClassMember('ipfix', REFERENCE_CLASS, 'Ipfix' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper', 'NetFlow.Configuration.FlowExporterMaps.FlowExporterMap.Version.Ipfix', 
                ...
                'ipfix',
                'Cisco-IOS-XR-asr9k-netflow-oper', False),
            _MetaInfoClassMember('version', REFERENCE_ENUM_CLASS, 'NfmgrFemEdmExpVer_Enum' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper', 'NfmgrFemEdmExpVer_Enum', 
                [], [], 
                '''                version
                ''',
                'version',
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector.DestinationAddress' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic.Collector.DestinationAddress',
            False, 
            [
            _MetaInfoClassMember('af-name', REFERENCE_ENUM_CLASS, 'UdpAddressFamily_Enum' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper', 'UdpAddressFamily_Enum', 
                [], [], 
                '''                AFName
                ''',
                'af_name',
