...
class CISCOMEDIAGATEWAYMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cMediaGwCallControlConfigTable" : ("cmediagwcallcontrolconfigtable", CISCOMEDIAGATEWAYMIB.Cmediagwcallcontrolconfigtable), "cMediaGwDnsIpConfigTable" : ("cmediagwdnsipconfigtable", CISCOMEDIAGATEWAYMIB.Cmediagwdnsipconfigtable), "cMediaGwDomainNameConfigTable" : ("cmediagwdomainnameconfigtable", CISCOMEDIAGATEWAYMIB.Cmediagwdomainnameconfigtable), "cMediaGwIpConfigTable" : ("cmediagwipconfigtable", CISCOMEDIAGATEWAYMIB.Cmediagwipconfigtable), "cMediaGwRscStatsTable" : ("cmediagwrscstatstable", CISCOMEDIAGATEWAYMIB.Cmediagwrscstatstable), "cMediaGwTable" : ("cmediagwtable", CISCOMEDIAGATEWAYMIB.Cmediagwtable), "cmgwLifTable" : ("cmgwliftable", CISCOMEDIAGATEWAYMIB.Cmgwliftable), "cmgwSignalProtocolTable" : ("cmgwsignalprotocoltable", CISCOMEDIAGATEWAYMIB.Cmgwsignalprotocoltable)}
    ...
    class Cmediagwcallcontrolconfigtable(Entity):
        ...
        class Cmediagwcallcontrolconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmediagwcallcontrolconfigtable.Cmediagwcallcontrolconfigentry, ['cmgwindex', 'cmediagwcccfgaal1svcnameprefix', 'cmediagwcccfgaal2svcnameprefix', 'cmediagwcccfgbearertos', 'cmediagwcccfgclusterenabled', 'cmediagwcccfgcontroltos', 'cmediagwcccfgdefaulttoneplanid', 'cmediagwcccfgdefbearertraffic', 'cmediagwcccfgdefrtpnameprefix', 'cmediagwcccfgdescrinfoenabled', 'cmediagwcccfgdsnameprefix', 'cmediagwcccfgnsepayload', 'cmediagwcccfgnseresptimer', 'cmediagwcccfgntepayload', 'cmediagwcccfgrtpnameprefix', 'cmediagwcccfgvbdjitterdelaymode', 'cmediagwcccfgvbdjittermaxdelay', 'cmediagwcccfgvbdjittermindelay', 'cmediagwcccfgvbdjitternomdelay'], name, value)
    ...
    class Cmediagwdnsipconfigtable(Entity):
        ...
        class Cmediagwdnsipconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmediagwdnsipconfigtable.Cmediagwdnsipconfigentry, ['cmgwindex', 'cmgwdnsipindex', 'cmgwdnsdomainname', 'cmgwdnsip', 'cmgwdnsiprowstatus', 'cmgwdnsiptype'], name, value)
    ...
    class Cmediagwdomainnameconfigtable(Entity):
        ...
        class Cmediagwdomainnameconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmediagwdomainnameconfigtable.Cmediagwdomainnameconfigentry, ['cmgwindex', 'cmgwconfigdomainnameindex', 'cmgwconfigdomainname', 'cmgwconfigdomainnameentity', 'cmgwconfigdomainnamerowstatus'], name, value)
    ...
    class Cmediagwipconfigtable(Entity):
        ...
        class Cmediagwipconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmediagwipconfigtable.Cmediagwipconfigentry, ['cmgwindex', 'cmgwipconfigindex', 'cmgwipconfigaddress', 'cmgwipconfigaddrtype', 'cmgwipconfigdefaultgwip', 'cmgwipconfigforremotemapping', 'cmgwipconfigifindex', 'cmgwipconfigrowstatus', 'cmgwipconfigsubnetmask', 'cmgwipconfigvci', 'cmgwipconfigvpi'], name, value)
    ...
    class Cmediagwrscstatstable(Entity):
        ...
        class Cmediagwrscstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmediagwrscstatstable.Cmediagwrscstatsentry, ['cmgwindex', 'cmgwrscstatsindex', 'cmgwrscaverageutilization', 'cmgwrscmaximumutilization', 'cmgwrscminimumutilization', 'cmgwrscsincelastreset'], name, value)
    ...
    class Cmediagwtable(Entity):
        ...
        class Cmediagwentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmediagwtable.Cmediagwentry, ['cmgwindex', 'cmgwadminstate', 'cmgwdomainname', 'cmgwgracetime', 'cmgwlawinterceptenabled', 'cmgwphysicalindex', 'cmgwservicestate', 'cmgwsrcfilterenabled', 'cmgwv23enabled', 'cmgwvtmappingmode'], name, value)
    ...
    class Cmgwsignalprotocoltable(Entity):
        ...
        class Cmgwsignalprotocolentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOMEDIAGATEWAYMIB.Cmgwsignalprotocoltable.Cmgwsignalprotocolentry, ['cmgwindex', 'cmgwsignalprotocolindex', 'cmgwsignalmgcprotocolport', 'cmgwsignalprotocol', 'cmgwsignalprotocolconfigver', 'cmgwsignalprotocolport', 'cmgwsignalprotocolpreference', 'cmgwsignalprotocolversion'], name, value)
