...
_meta_table = {
    'CiscoAAAProtocol_Enum' : _MetaInfoEnum('CiscoAAAProtocol_Enum', 'ydk.models.aaa.CISCO_AAA_SERVER_MIB',
        {
    ...
    'CISCOAAASERVERMIB.CasConfig' : {
        ...
        'ydk.models.aaa.CISCO_AAA_SERVER_MIB'
        ),
    },
    'CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry.CasState_Enum' : _MetaInfoEnum('CasState_Enum', 'ydk.models.aaa.CISCO_AAA_SERVER_MIB',
        {
            'up':'UP',
            'dead':'DEAD',
        }, 'CISCO-AAA-SERVER-MIB', _yang_ns._namespaces['CISCO-AAA-SERVER-MIB']),
    'CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry' : {
        'meta_info' : _MetaInfoClass('CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry',
            ...
            _MetaInfoClassMember('casProtocol', REFERENCE_ENUM_CLASS, 'CiscoAAAProtocol_Enum' , 'ydk.models.aaa.CISCO_AAA_SERVER_MIB', 'CiscoAAAProtocol_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('casAuthorUnexpectedResponses', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-AAA-SERVER-MIB', False),
            _MetaInfoClassMember('casConfigRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('casPriority', ATTRIBUTE, 'int' , None, None, 
                ...
                'caspriority',
                'CISCO-AAA-SERVER-MIB', False),
            _MetaInfoClassMember('casState', REFERENCE_ENUM_CLASS, 'CasState_Enum' , 'ydk.models.aaa.CISCO_AAA_SERVER_MIB', 'CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry.CasState_Enum', 
                [], [], 
    ...
    'CISCOAAASERVERMIB.CasConfigTable' : {
        'meta_info' : _MetaInfoClass('CISCOAAASERVERMIB.CasConfigTable',
            False, 
            [
            _MetaInfoClassMember('casConfigEntry', REFERENCE_LIST, 'CasConfigEntry' , 'ydk.models.aaa.CISCO_AAA_SERVER_MIB', 'CISCOAAASERVERMIB.CasConfigTable.CasConfigEntry', 
                [], [], 
    ...
    'CISCOAAASERVERMIB' : {
        'meta_info' : _MetaInfoClass('CISCOAAASERVERMIB',
            False, 
            [
            _MetaInfoClassMember('casConfig', REFERENCE_CLASS, 'CasConfig' , 'ydk.models.aaa.CISCO_AAA_SERVER_MIB', 'CISCOAAASERVERMIB.CasConfig', 
                [], [], 
                '''                ''',
                'casconfig',
                'CISCO-AAA-SERVER-MIB', False),
            _MetaInfoClassMember('casConfigTable', REFERENCE_CLASS, 'CasConfigTable' , 'ydk.models.aaa.CISCO_AAA_SERVER_MIB', 'CISCOAAASERVERMIB.CasConfigTable', 
                [], [], 
