...
_meta_table = {
    'Qosl2DataLinkEnum' : _MetaInfoEnum('Qosl2DataLinkEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_qos_ma_cfg',
        {
            'aal5':'AAL5',
    ...
    'Qosl2EncapEnum' : _MetaInfoEnum('Qosl2EncapEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_qos_ma_cfg',
        {
