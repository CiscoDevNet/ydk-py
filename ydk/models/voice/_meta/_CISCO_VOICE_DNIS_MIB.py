...
_meta_table = {
    'CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry.CvDnisMappingRefresh_Enum' : _MetaInfoEnum('CvDnisMappingRefresh_Enum', 'ydk.models.voice.CISCO_VOICE_DNIS_MIB',
        {
            'idle':'IDLE',
            'refresh':'REFRESH',
    ...
    'CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry' : {
        'meta_info' : _MetaInfoClass('CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry',
            ...
            _MetaInfoClassMember('cvDnisMappingRefresh', REFERENCE_ENUM_CLASS, 'CvDnisMappingRefresh_Enum' , 'ydk.models.voice.CISCO_VOICE_DNIS_MIB', 'CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry.CvDnisMappingRefresh_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cvDnisMappingStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
        ...
        'ydk.models.voice.CISCO_VOICE_DNIS_MIB'
        ),
    },
    'CISCOVOICEDNISMIB.CvDnisMappingTable' : {
        'meta_info' : _MetaInfoClass('CISCOVOICEDNISMIB.CvDnisMappingTable',
            False, 
            [
            _MetaInfoClassMember('cvDnisMappingEntry', REFERENCE_LIST, 'CvDnisMappingEntry' , 'ydk.models.voice.CISCO_VOICE_DNIS_MIB', 'CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry', 
                [], [], 
    ...
    'CISCOVOICEDNISMIB.CvDnisNodeTable.CvDnisNodeEntry' : {
        'meta_info' : _MetaInfoClass('CISCOVOICEDNISMIB.CvDnisNodeTable.CvDnisNodeEntry',
            ...
            _MetaInfoClassMember('cvDnisNodeModifiable', ATTRIBUTE, 'bool' , None, None, 
                ...
                'CISCO-VOICE-DNIS-MIB', False),
            _MetaInfoClassMember('cvDnisNodeStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This object is used to create a new row or modify or
    ...
    'CISCOVOICEDNISMIB.CvDnisNodeTable' : {
        'meta_info' : _MetaInfoClass('CISCOVOICEDNISMIB.CvDnisNodeTable',
            False, 
            [
            _MetaInfoClassMember('cvDnisNodeEntry', REFERENCE_LIST, 'CvDnisNodeEntry' , 'ydk.models.voice.CISCO_VOICE_DNIS_MIB', 'CISCOVOICEDNISMIB.CvDnisNodeTable.CvDnisNodeEntry', 
                [], [], 
    ...
    'CISCOVOICEDNISMIB' : {
        'meta_info' : _MetaInfoClass('CISCOVOICEDNISMIB',
            False, 
            [
            _MetaInfoClassMember('cvDnisMappingTable', REFERENCE_CLASS, 'CvDnisMappingTable' , 'ydk.models.voice.CISCO_VOICE_DNIS_MIB', 'CISCOVOICEDNISMIB.CvDnisMappingTable', 
                [], [], 
                ...
                'cvdnismappingtable',
                'CISCO-VOICE-DNIS-MIB', False),
            _MetaInfoClassMember('cvDnisNodeTable', REFERENCE_CLASS, 'CvDnisNodeTable' , 'ydk.models.voice.CISCO_VOICE_DNIS_MIB', 'CISCOVOICEDNISMIB.CvDnisNodeTable', 
                [], [], 
