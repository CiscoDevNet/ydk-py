...
class MplsStatic(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"local-labels" : ("local_labels", MplsStatic.LocalLabels), "summary" : ("summary", MplsStatic.Summary), "vrfs" : ("vrfs", MplsStatic.Vrfs)}
    ...
    class LocalLabels(Entity):
        ...
        class LocalLabel(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"backup-pathset-resolve-nh" : ("backup_pathset_resolve_nh", MplsStatic.LocalLabels.LocalLabel.BackupPathsetResolveNh), "pathset-resolve-nh" : ("pathset_resolve_nh", MplsStatic.LocalLabels.LocalLabel.PathsetResolveNh), "prefix" : ("prefix", MplsStatic.LocalLabels.LocalLabel.Prefix)}
                self._child_list_classes = {"backup-path-info" : ("backup_path_info", MplsStatic.LocalLabels.LocalLabel.BackupPathInfo), "path-info" : ("path_info", MplsStatic.LocalLabels.LocalLabel.PathInfo)}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsStatic.LocalLabels.LocalLabel, ['local_label_id', 'address_family', 'backup_pathset_via_resolve', 'label', 'label_mode', 'label_status', 'pathset_via_resolve', 'vrf_name'], name, value)
            ...
            class BackupPathInfo(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsStatic.LocalLabels.LocalLabel.BackupPathInfo, ['backup_id', 'path_id', 'path_number', 'path_role', 'status', 'type'], name, value)
                ...
                class Nexthop(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsStatic.LocalLabels.LocalLabel.BackupPathInfo.Nexthop, ['afi', 'interface_name', 'label'], name, value)
            ...
            class PathInfo(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsStatic.LocalLabels.LocalLabel.PathInfo, ['backup_id', 'path_id', 'path_number', 'path_role', 'status', 'type'], name, value)
                ...
                class Nexthop(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsStatic.LocalLabels.LocalLabel.PathInfo.Nexthop, ['afi', 'interface_name', 'label'], name, value)
    ...
    class Summary(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(MplsStatic.Summary, ['active_vrf_count', 'im_connected', 'interface_count', 'interface_foward_reference_count', 'ipv4_route_count', 'ipv6_route_count', 'label_count', 'label_discrepancy_count', 'label_error_count', 'lsd_connected', 'mpls_enabled_interface_count', 'ribv4_connected', 'ribv6_connected', 'rsi_connected', 'vrf_count'], name, value)
    ...
    class Vrfs(Entity):
        ...
        class Vrf(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"local-labels" : ("local_labels", MplsStatic.Vrfs.Vrf.LocalLabels), "lsps" : ("lsps", MplsStatic.Vrfs.Vrf.Lsps)}
                self._child_list_classes = {}
            ...
            class LocalLabels(Entity):
                ...
                class LocalLabel(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = True
                        self._child_container_classes = {"backup-pathset-resolve-nh" : ("backup_pathset_resolve_nh", MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.BackupPathsetResolveNh), "pathset-resolve-nh" : ("pathset_resolve_nh", MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.PathsetResolveNh), "prefix" : ("prefix", MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.Prefix)}
                        self._child_list_classes = {"backup-path-info" : ("backup_path_info", MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.BackupPathInfo), "path-info" : ("path_info", MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.PathInfo)}
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel, ['local_label_id', 'address_family', 'backup_pathset_via_resolve', 'label', 'label_mode', 'label_status', 'pathset_via_resolve', 'vrf_name'], name, value)
                    ...
                    class BackupPathInfo(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.BackupPathInfo, ['backup_id', 'path_id', 'path_number', 'path_role', 'status', 'type'], name, value)
                        ...
                        class Nexthop(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.BackupPathInfo.Nexthop, ['afi', 'interface_name', 'label'], name, value)
                    ...
                    class PathInfo(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.PathInfo, ['backup_id', 'path_id', 'path_number', 'path_role', 'status', 'type'], name, value)
                        ...
                        class Nexthop(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.Vrfs.Vrf.LocalLabels.LocalLabel.PathInfo.Nexthop, ['afi', 'interface_name', 'label'], name, value)
                ...
                class Lsp(Entity):
                    ...
                    class Label(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"backup-pathset-resolve-nh" : ("backup_pathset_resolve_nh", MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.BackupPathsetResolveNh), "pathset-resolve-nh" : ("pathset_resolve_nh", MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.PathsetResolveNh), "prefix" : ("prefix", MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.Prefix)}
                            self._child_list_classes = {"backup-path-info" : ("backup_path_info", MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.BackupPathInfo), "path-info" : ("path_info", MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.PathInfo)}
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label, ['address_family', 'backup_pathset_via_resolve', 'label', 'label_mode', 'label_status', 'pathset_via_resolve', 'vrf_name'], name, value)
                        ...
                        class BackupPathInfo(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.BackupPathInfo, ['backup_id', 'path_id', 'path_number', 'path_role', 'status', 'type'], name, value)
                            ...
                            class Nexthop(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.BackupPathInfo.Nexthop, ['afi', 'interface_name', 'label'], name, value)
                        ...
                        class PathInfo(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.PathInfo, ['backup_id', 'path_id', 'path_number', 'path_role', 'status', 'type'], name, value)
                            ...
                            class Nexthop(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(MplsStatic.Vrfs.Vrf.Lsps.Lsp.Label.PathInfo.Nexthop, ['afi', 'interface_name', 'label'], name, value)
