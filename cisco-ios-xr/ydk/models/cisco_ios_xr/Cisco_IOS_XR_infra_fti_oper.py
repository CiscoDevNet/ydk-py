...
class DciFabricInterconnect(Entity):
    ...
    class OpflexSessionInfos(Entity):
        """
        FTI Opflex Session Info for all fabrics
        ...
        class OpflexSessionInfo(Entity):
            """
            FTI Opflex Session Info for a particular fabric
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ('id1', YLeaf(YType.uint32, 'id1')),
                    ('fabric_id', YLeaf(YType.uint32, 'fabric-id')),
                    ('config_state', YLeaf(YType.enumeration, 'config-state')),
                    ('last_upd_ts_config', YLeaf(YType.uint64, 'last-upd-ts-config')),
                    ('fabric_state', YLeaf(YType.enumeration, 'fabric-state')),
                    ('last_upd_ts_fabric', YLeaf(YType.uint64, 'last-upd-ts-fabric')),
                ])
                self.id1 = None
                self.fabric_id = None
            ...
            class PeerInfo(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ...
                        ('peer_port', YLeaf(YType.uint32, 'peer-port')),
                        ('peer_state', YLeaf(YType.enumeration, 'peer-state')),
                        ('last_upd_ts_peer_status', YLeaf(YType.uint64, 'last-upd-ts-peer-status')),
                    ])
                    self.peer_ip = None
                    self.peer_port = None
        ...
        class FabricVrfDb(Entity):
            ...
            class FabricVrf(Entity):
                ...
                def __init__(self):
                    ...
                    self._leafs = OrderedDict([
                        ('fabric_vrf', YLeaf(YType.str, 'fabric-vrf')),
                        ('dci_vrf', YLeaf(YType.str, 'dci-vrf')),
                        ('fabric_vrf_flags', YLeaf(YType.str, 'fabric-vrf-flags')),
                    ])
                ...
                class V4ImportRt(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._child_classes = OrderedDict([])
                        self._leafs = OrderedDict([
                            ('rt_value', YLeaf(YType.str, 'rt-value')),
                            ('rt_flags', YLeaf(YType.str, 'rt-flags')),
                        ])
                        self.rt_value = None
                        self.rt_flags = None
    ...
    class DciVrfs(Entity):
        ...
        class DciVrf(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ('vrf1', YLeaf(YType.str, 'vrf1')),
                    ('dci_vrf', YLeaf(YType.str, 'dci-vrf')),
                    ('num_fabric_vrf', YLeaf(YType.uint32, 'num-fabric-vrf')),
                    ('faric_vrfs_id_name', YLeaf(YType.str, 'faric-vrfs-id-name')),
                    ('vni_id', YLeaf(YType.uint32, 'vni-id')),
                    ('bd_name', YLeaf(YType.str, 'bd-name')),
                    ('bvi_id', YLeaf(YType.uint32, 'bvi-id')),
                    ('bvi_ip', YLeaf(YType.str, 'bvi-ip')),
                    ('bvi_ip_v6', YLeaf(YType.boolean, 'bvi-ip-v6')),
                    ('dci_vrf_flags', YLeaf(YType.str, 'dci-vrf-flags')),
                ])
                self.vrf1 = None
                self.dci_vrf = None
    ...
    class Acp(Entity):
        ...
        def __init__(self):
            ...
            self._leafs = OrderedDict([
                ...
                ('vni_bits', YLeaf(YType.uint32, 'vni-bits')),
                ('bvi_min', YLeaf(YType.uint32, 'bvi-min')),
                ('bvi_max', YLeaf(YType.uint32, 'bvi-max')),
                ('bvi_bits', YLeaf(YType.uint32, 'bvi-bits')),
                ('bd_min', YLeaf(YType.uint32, 'bd-min')),
                ('bd_max', YLeaf(YType.uint32, 'bd-max')),
                ('bd_bits', YLeaf(YType.uint32, 'bd-bits')),
                ('vniused_range', YLeaf(YType.str, 'vniused-range')),
                ('bviused_range', YLeaf(YType.str, 'bviused-range')),
                ('bdused_range', YLeaf(YType.str, 'bdused-range')),
            ])
            self.vni_min = None
            self.vni_max = None
            self.vni_bits = None
