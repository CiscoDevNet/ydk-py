...
_meta_table = {
    'RsvpEncapsulation_Enum' : _MetaInfoEnum('RsvpEncapsulation_Enum', 'ydk.models.rsvp.RSVP_MIB',
        {
            'ip':'IP',
            'udp':'UDP',
            'both':'BOTH',
    ...
    'RSVPMIB.RsvpIfTable.RsvpIfEntry' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpIfTable.RsvpIfEntry',
            ...
            _MetaInfoClassMember('rsvpIfRouteDelay', ATTRIBUTE, 'int' , None, None, 
                ...
                'rsvpifroutedelay',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpIfStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'RSVPMIB.RsvpIfTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpIfTable',
            False, 
            [
            _MetaInfoClassMember('rsvpIfEntry', REFERENCE_LIST, 'RsvpIfEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpIfTable.RsvpIfEntry', 
                [], [], 
    ...
    'RSVPMIB.RsvpNbrTable.RsvpNbrEntry' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpNbrTable.RsvpNbrEntry',
            ...
            _MetaInfoClassMember('rsvpNbrAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'rsvpnbraddress',
                'RSVP-MIB', True),
            _MetaInfoClassMember('rsvpNbrProtocol', REFERENCE_ENUM_CLASS, 'RsvpEncapsulation_Enum' , 'ydk.models.rsvp.RSVP_MIB', 'RsvpEncapsulation_Enum', 
                [], [], 
                ...
                'rsvpnbrprotocol',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpNbrStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'RSVPMIB.RsvpNbrTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpNbrTable',
            False, 
            [
            _MetaInfoClassMember('rsvpNbrEntry', REFERENCE_LIST, 'RsvpNbrEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpNbrTable.RsvpNbrEntry', 
                [], [], 
    ...
    'RSVPMIB.RsvpResvFwdTable.RsvpResvFwdEntry' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpResvFwdTable.RsvpResvFwdEntry',
            ...
            _MetaInfoClassMember('rsvpResvFwdSenderAddrLength', ATTRIBUTE, 'int' , None, None, 
                ...
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpResvFwdService', REFERENCE_ENUM_CLASS, 'QosService_Enum' , 'ydk.models.integrated.INTEGRATED_SERVICES_MIB', 'QosService_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('rsvpResvFwdShared', ATTRIBUTE, 'bool' , None, None, 
                ...
                'rsvpresvfwdshared',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpResvFwdStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'RSVPMIB.RsvpResvFwdTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpResvFwdTable',
            False, 
            [
            _MetaInfoClassMember('rsvpResvFwdEntry', REFERENCE_LIST, 'RsvpResvFwdEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpResvFwdTable.RsvpResvFwdEntry', 
                [], [], 
    ...
    'RSVPMIB.RsvpResvTable.RsvpResvEntry' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpResvTable.RsvpResvEntry',
            ...
            _MetaInfoClassMember('rsvpResvSenderAddrLength', ATTRIBUTE, 'int' , None, None, 
                ...
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpResvService', REFERENCE_ENUM_CLASS, 'QosService_Enum' , 'ydk.models.integrated.INTEGRATED_SERVICES_MIB', 'QosService_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('rsvpResvShared', ATTRIBUTE, 'bool' , None, None, 
                ...
                'rsvpresvshared',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpResvStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                'active' for all active RESV  messages.   This
    ...
    'RSVPMIB.RsvpResvTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpResvTable',
            False, 
            [
            _MetaInfoClassMember('rsvpResvEntry', REFERENCE_LIST, 'RsvpResvEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpResvTable.RsvpResvEntry', 
                [], [], 
                '''                Information	describing the	state  information
    ...
    'RSVPMIB.RsvpSenderOutInterfaceTable.RsvpSenderOutInterfaceEntry' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpSenderOutInterfaceTable.RsvpSenderOutInterfaceEntry',
            ...
            _MetaInfoClassMember('rsvpSessionNumber', ATTRIBUTE, 'int' , None, None, 
                ...
                'rsvpsessionnumber',
                'RSVP-MIB', True),
            _MetaInfoClassMember('rsvpSenderOutInterfaceStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'RSVPMIB.RsvpSenderOutInterfaceTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpSenderOutInterfaceTable',
            False, 
            [
            _MetaInfoClassMember('rsvpSenderOutInterfaceEntry', REFERENCE_LIST, 'RsvpSenderOutInterfaceEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpSenderOutInterfaceTable.RsvpSenderOutInterfaceEntry', 
                [], [], 
    ...
    'RSVPMIB.RsvpSenderTable.RsvpSenderEntry' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpSenderTable.RsvpSenderEntry',
            ...
            _MetaInfoClassMember('rsvpSenderRSVPHop', ATTRIBUTE, 'bool' , None, None, 
                ...
                'rsvpsenderrsvphop',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpSenderStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'RSVPMIB.RsvpSenderTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpSenderTable',
            False, 
            [
            _MetaInfoClassMember('rsvpSenderEntry', REFERENCE_LIST, 'RsvpSenderEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpSenderTable.RsvpSenderEntry', 
                [], [], 
                '''                Information	describing the	state  information
    ...
    'RSVPMIB.RsvpSessionTable' : {
        'meta_info' : _MetaInfoClass('RSVPMIB.RsvpSessionTable',
            False, 
            [
            _MetaInfoClassMember('rsvpSessionEntry', REFERENCE_LIST, 'RsvpSessionEntry' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpSessionTable.RsvpSessionEntry', 
                [], [], 
    ...
    'RSVPMIB' : {
        'meta_info' : _MetaInfoClass('RSVPMIB',
            False, 
            [
            _MetaInfoClassMember('rsvpGenObjects', REFERENCE_CLASS, 'RsvpGenObjects' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpGenObjects', 
                [], [], 
                '''                ''',
                'rsvpgenobjects',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpIfTable', REFERENCE_CLASS, 'RsvpIfTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpIfTable', 
                [], [], 
                ...
                'rsvpiftable',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpNbrTable', REFERENCE_CLASS, 'RsvpNbrTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpNbrTable', 
                [], [], 
                ...
                'rsvpnbrtable',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpResvFwdTable', REFERENCE_CLASS, 'RsvpResvFwdTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpResvFwdTable', 
                [], [], 
                '''                Information	describing the	state  information
                ...
                'rsvpresvfwdtable',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpResvTable', REFERENCE_CLASS, 'RsvpResvTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpResvTable', 
                [], [], 
                '''                Information	describing the	state  information
                ...
                'rsvpresvtable',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpSenderOutInterfaceTable', REFERENCE_CLASS, 'RsvpSenderOutInterfaceTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpSenderOutInterfaceTable', 
                [], [], 
                ...
                'rsvpsenderoutinterfacetable',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpSenderTable', REFERENCE_CLASS, 'RsvpSenderTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpSenderTable', 
                [], [], 
                '''                Information	describing the	state  information
                ...
                'rsvpsendertable',
                'RSVP-MIB', False),
            _MetaInfoClassMember('rsvpSessionTable', REFERENCE_CLASS, 'RsvpSessionTable' , 'ydk.models.rsvp.RSVP_MIB', 'RSVPMIB.RsvpSessionTable', 
                [], [], 
