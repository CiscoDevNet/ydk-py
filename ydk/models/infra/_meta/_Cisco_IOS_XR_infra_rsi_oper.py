...
_meta_table = {
    ...
    'SelectiveVrfDownload.State' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper'
        ),
    },
    'SelectiveVrfDownload' : {
        'meta_info' : _MetaInfoClass('SelectiveVrfDownload',
            False, 
            [
            _MetaInfoClassMember('state', REFERENCE_CLASS, 'State' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'SelectiveVrfDownload.State', 
                [], [], 
    ...
    'Srlg.InterfaceSrlgNames.InterfaceSrlgName' : {
        'meta_info' : _MetaInfoClass('Srlg.InterfaceSrlgNames.InterfaceSrlgName',
            ...
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.InterfaceSrlgNames.InterfaceSrlgName.Interfaces', 
                [], [], 
    ...
    'Srlg.InterfaceSrlgNames' : {
        'meta_info' : _MetaInfoClass('Srlg.InterfaceSrlgNames',
            False, 
            [
            _MetaInfoClassMember('interface-srlg-name', REFERENCE_LIST, 'InterfaceSrlgName' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.InterfaceSrlgNames.InterfaceSrlgName', 
                [], [], 
    ...
    'Srlg.Nodes.Node.Groups.Group' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.Groups.Group',
            ...
            _MetaInfoClassMember('group-values', ATTRIBUTE, 'int' , None, None, 
                ...
                'group_values',
                'Cisco-IOS-XR-infra-rsi-oper', False),
            _MetaInfoClassMember('srlg-attribute', REFERENCE_LIST, 'SrlgAttribute' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.Groups.Group.SrlgAttribute', 
                [], [], 
                '''                SRLG attribute
                ''',
                'srlg_attribute',
    ...
    'Srlg.Nodes.Node.Groups' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.Groups',
            False, 
            [
            _MetaInfoClassMember('group', REFERENCE_LIST, 'Group' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.Groups.Group', 
                [], [], 
                '''                SRLG group details
                ''',
                'group',
    ...
    'Srlg.Nodes.Node.InheritNodes.InheritNode' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.InheritNodes.InheritNode',
            ...
            _MetaInfoClassMember('node-values', ATTRIBUTE, 'int' , None, None, 
                ...
                'node_values',
                'Cisco-IOS-XR-infra-rsi-oper', False),
            _MetaInfoClassMember('srlg-attribute', REFERENCE_LIST, 'SrlgAttribute' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InheritNodes.InheritNode.SrlgAttribute', 
                [], [], 
                '''                SRLG attribute
                ''',
                'srlg_attribute',
    ...
    'Srlg.Nodes.Node.InheritNodes' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.InheritNodes',
            False, 
            [
            _MetaInfoClassMember('inherit-node', REFERENCE_LIST, 'InheritNode' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InheritNodes.InheritNode', 
                [], [], 
    ...
    'Srlg.Nodes.Node.InterfaceDetails.InterfaceDetail' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.InterfaceDetails.InterfaceDetail',
            ...
            _MetaInfoClassMember('nodes', ATTRIBUTE, 'int' , None, None, 
                ...
                'nodes',
                'Cisco-IOS-XR-infra-rsi-oper', False),
            _MetaInfoClassMember('srlg-attribute', REFERENCE_LIST, 'SrlgAttribute' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InterfaceDetails.InterfaceDetail.SrlgAttribute', 
                [], [], 
                '''                SRLG attributes
                ''',
                'srlg_attribute',
    ...
    'Srlg.Nodes.Node.InterfaceDetails' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.InterfaceDetails',
            False, 
            [
            _MetaInfoClassMember('interface-detail', REFERENCE_LIST, 'InterfaceDetail' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InterfaceDetails.InterfaceDetail', 
                [], [], 
    ...
    'Srlg.Nodes.Node.InterfaceSrlgNames.InterfaceSrlgName' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.InterfaceSrlgNames.InterfaceSrlgName',
            ...
            _MetaInfoClassMember('srlg-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'srlg_name',
                'Cisco-IOS-XR-infra-rsi-oper', True),
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InterfaceSrlgNames.InterfaceSrlgName.Interfaces', 
                [], [], 
                '''                Interfaces information
                ''',
                'interfaces',
    ...
    'Srlg.Nodes.Node.InterfaceSrlgNames' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.InterfaceSrlgNames',
            False, 
            [
            _MetaInfoClassMember('interface-srlg-name', REFERENCE_LIST, 'InterfaceSrlgName' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InterfaceSrlgNames.InterfaceSrlgName', 
                [], [], 
                '''                Configured SRLG name details 
                ''',
                'interface_srlg_name',
    ...
    'Srlg.Nodes.Node.Interfaces' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.Interfaces.Interface', 
                [], [], 
    ...
    'Srlg.Nodes.Node.SrlgMaps' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.SrlgMaps',
            False, 
            [
            _MetaInfoClassMember('srlg-map', REFERENCE_LIST, 'SrlgMap' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.SrlgMaps.SrlgMap', 
                [], [], 
                '''                Configured SRLG name details 
                ''',
                'srlg_map',
    ...
    'Srlg.Nodes.Node.SrlgValues' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node.SrlgValues',
            False, 
            [
            _MetaInfoClassMember('srlg-value', REFERENCE_LIST, 'SrlgValue' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.SrlgValues.SrlgValue', 
                [], [], 
    ...
    'Srlg.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes.Node',
            ...
            _MetaInfoClassMember('groups', REFERENCE_CLASS, 'Groups' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.Groups', 
                ...
                'groups',
                'Cisco-IOS-XR-infra-rsi-oper', False),
            _MetaInfoClassMember('inherit-nodes', REFERENCE_CLASS, 'InheritNodes' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node.InheritNodes', 
                [], [], 
    ...
    'Srlg.Nodes' : {
        'meta_info' : _MetaInfoClass('Srlg.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.Nodes.Node', 
                [], [], 
    ...
    'Srlg.SrlgMaps' : {
        'meta_info' : _MetaInfoClass('Srlg.SrlgMaps',
            False, 
            [
            _MetaInfoClassMember('srlg-map', REFERENCE_LIST, 'SrlgMap' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'Srlg.SrlgMaps.SrlgMap', 
                [], [], 
                '''                Configured SRLG name details 
                ''',
                'srlg_map',
    ...
    'VrfGroup.Nodes.Node.Groups' : {
        'meta_info' : _MetaInfoClass('VrfGroup.Nodes.Node.Groups',
            False, 
            [
            _MetaInfoClassMember('group', REFERENCE_LIST, 'Group' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'VrfGroup.Nodes.Node.Groups.Group', 
                [], [], 
                '''                Group details
                ''',
                'group',
    ...
    'VrfGroup.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('VrfGroup.Nodes.Node',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-infra-rsi-oper', True),
            _MetaInfoClassMember('groups', REFERENCE_CLASS, 'Groups' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'VrfGroup.Nodes.Node.Groups', 
                [], [], 
    ...
    'VrfGroup.Nodes' : {
        'meta_info' : _MetaInfoClass('VrfGroup.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'VrfGroup.Nodes.Node', 
                [], [], 
                '''                Node details
                ''',
                'node',
    ...
    'VrfGroup' : {
        'meta_info' : _MetaInfoClass('VrfGroup',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper', 'VrfGroup.Nodes', 
                [], [], 
