...
class Ip(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cinetd" : ("cinetd", Ip.Cinetd), "forward-protocol" : ("forward_protocol", Ip.ForwardProtocol)}
    ...
    class Cinetd(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"services" : ("services", Ip.Cinetd.Services)}
            self._child_list_classes = {}

            self.rate_limit = YLeaf(YType.uint32, "Cisco-IOS-XR-ipv4-cinetd-cfg:rate-limit")
        ...
        class Services(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"ipv4" : ("ipv4", Ip.Cinetd.Services.Ipv4), "ipv6" : ("ipv6", Ip.Cinetd.Services.Ipv6), "vrfs" : ("vrfs", Ip.Cinetd.Services.Vrfs)}
                self._child_list_classes = {}
            ...
            class Ipv4(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"small-servers" : ("small_servers", Ip.Cinetd.Services.Ipv4.SmallServers)}
                    self._child_list_classes = {}
                ...
                class SmallServers(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"tcp-small-servers" : ("tcp_small_servers", Ip.Cinetd.Services.Ipv4.SmallServers.TcpSmallServers), "udp-small-servers" : ("udp_small_servers", Ip.Cinetd.Services.Ipv4.SmallServers.UdpSmallServers)}
                        self._child_list_classes = {}
            ...
            class Ipv6(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"small-servers" : ("small_servers", Ip.Cinetd.Services.Ipv6.SmallServers)}
                    self._child_list_classes = {}
                ...
                class SmallServers(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"tcp-small-servers" : ("tcp_small_servers", Ip.Cinetd.Services.Ipv6.SmallServers.TcpSmallServers)}
                        self._child_list_classes = {}
            ...
            class Vrfs(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"vrf" : ("vrf", Ip.Cinetd.Services.Vrfs.Vrf)}
                ...
                class Vrf(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"ipv4" : ("ipv4", Ip.Cinetd.Services.Vrfs.Vrf.Ipv4), "ipv6" : ("ipv6", Ip.Cinetd.Services.Vrfs.Vrf.Ipv6)}
                        self._child_list_classes = {}
                    ...
                    class Ipv4(Entity):
                        ...
                        def __init__(self):
                            ...
                            self._child_container_classes = {"telnet" : ("telnet", Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Telnet), "tftp" : ("tftp", Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp)}
                            self._child_list_classes = {}
                        ...
                        class Telnet(Entity):
                            ...
                            def __init__(self):
                                ...
                                self.is_top_level_class = False
                                self.has_list_ancestor = True
                                self._child_container_classes = {"tcp" : ("tcp", Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Telnet.Tcp)}
                                self._child_list_classes = {}
                        ...
                        class Tftp(Entity):
                            ...
                            def __init__(self):
                                ...
                                self.is_top_level_class = False
                                self.has_list_ancestor = True
                                self._child_container_classes = {"udp" : ("udp", Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp.Udp)}
                                self._child_list_classes = {}
                            ...
                            class Udp(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp.Udp, ['access_list_name', 'dscp_value', 'home_directory', 'maximum_server'], name, value)
                    ...
                    class Ipv6(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"telnet" : ("telnet", Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Telnet), "tftp" : ("tftp", Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp)}
                            self._child_list_classes = {}
                        ...
                        class Telnet(Entity):
                            ...
                            def __init__(self):
                                ...
                                self.is_top_level_class = False
                                self.has_list_ancestor = True
                                self._child_container_classes = {"tcp" : ("tcp", Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Telnet.Tcp)}
                                self._child_list_classes = {}
                        ...
                        class Tftp(Entity):
                            ...
                            def __init__(self):
                                ...
                                self.is_top_level_class = False
                                self.has_list_ancestor = True
                                self._child_container_classes = {"udp" : ("udp", Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp.Udp)}
                                self._child_list_classes = {}
                            ...
                            class Udp(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp.Udp, ['access_list_name', 'dscp_value', 'home_directory', 'maximum_server'], name, value)
    ...
    class ForwardProtocol(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"udp" : ("udp", Ip.ForwardProtocol.Udp)}
            self._child_list_classes = {}
        ...
        class Udp(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"ports" : ("ports", Ip.ForwardProtocol.Udp.Ports)}
                self._child_list_classes = {}
            ...
            class Ports(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"port" : ("port", Ip.ForwardProtocol.Udp.Ports.Port)}
                ...
                class Port(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._segment_path = lambda: "port" + "[port-id='" + self.port_id.get() + "']"
...
class IpTcp(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"directory" : ("directory", IpTcp.Directory), "num-thread" : ("num_thread", IpTcp.NumThread), "throttle" : ("throttle", IpTcp.Throttle)}
        self._child_list_classes = {}
    ...
    def __setattr__(self, name, value):
        self._perform_setattr(IpTcp, ['accept_rate', 'maximum_segment_size', 'path_mtu_discovery', 'receive_q', 'selective_ack', 'syn_wait_time', 'timestamp', 'window_size'], name, value)
    ...
    class Throttle(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(IpTcp.Throttle, ['tcpmaxthrottle', 'tcpmin_throttle'], name, value)
