...
class HardwareModuleEfd(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"node-all" : ("node_all", HardwareModuleEfd.NodeAll), "nodes" : ("nodes", HardwareModuleEfd.Nodes)}
    ...
    class NodeAll(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"ip-precedence" : ("ip_precedence", HardwareModuleEfd.NodeAll.IpPrecedence), "ip-priority-mask" : ("ip_priority_mask", HardwareModuleEfd.NodeAll.IpPriorityMask), "mpls-exp" : ("mpls_exp", HardwareModuleEfd.NodeAll.MplsExp), "mpls-priority-mask" : ("mpls_priority_mask", HardwareModuleEfd.NodeAll.MplsPriorityMask), "vlan-cos" : ("vlan_cos", HardwareModuleEfd.NodeAll.VlanCos), "vlan-priority-mask" : ("vlan_priority_mask", HardwareModuleEfd.NodeAll.VlanPriorityMask)}
            self._child_list_classes = {}
        ...
        class IpPrecedence(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(HardwareModuleEfd.NodeAll.IpPrecedence, ['operation_', 'precedence'], name, value)
    ...
    class Nodes(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"node" : ("node", HardwareModuleEfd.Nodes.Node)}
        ...
        class Node(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"ip-precedence" : ("ip_precedence", HardwareModuleEfd.Nodes.Node.IpPrecedence), "ip-priority-mask" : ("ip_priority_mask", HardwareModuleEfd.Nodes.Node.IpPriorityMask), "mpls-exp" : ("mpls_exp", HardwareModuleEfd.Nodes.Node.MplsExp), "mpls-priority-mask" : ("mpls_priority_mask", HardwareModuleEfd.Nodes.Node.MplsPriorityMask), "vlan-cos" : ("vlan_cos", HardwareModuleEfd.Nodes.Node.VlanCos), "vlan-priority-mask" : ("vlan_priority_mask", HardwareModuleEfd.Nodes.Node.VlanPriorityMask)}
                self._child_list_classes = {}
            ...
            class IpPrecedence(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(HardwareModuleEfd.Nodes.Node.IpPrecedence, ['operation_', 'precedence'], name, value)
...
class HardwareModuleLoadBalance(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"bundle" : ("bundle", HardwareModuleLoadBalance.Bundle)}
        self._child_list_classes = {}
    ...
    class Bundle(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"l2-service" : ("l2_service", HardwareModuleLoadBalance.Bundle.L2Service)}
            self._child_list_classes = {}
...
class HardwareModuleQosMode(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"nodes" : ("nodes", HardwareModuleQosMode.Nodes)}
        self._child_list_classes = {}
    ...
    class Nodes(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"node" : ("node", HardwareModuleQosMode.Nodes.Node)}
...
class HardwareModuleTcam(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"nodes" : ("nodes", HardwareModuleTcam.Nodes)}
        self._child_list_classes = {}
    ...
    class Nodes(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"node" : ("node", HardwareModuleTcam.Nodes.Node)}
...
class HardwareModuleTcpMssAdjust(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"nodes" : ("nodes", HardwareModuleTcpMssAdjust.Nodes)}
        self._child_list_classes = {}
    ...
    class Nodes(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"node" : ("node", HardwareModuleTcpMssAdjust.Nodes.Node)}
        ...
        class Node(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"nps" : ("nps", HardwareModuleTcpMssAdjust.Nodes.Node.Nps)}
                self._child_list_classes = {}
            ...
            class Nps(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = True
                    self._child_container_classes = {}
                    self._child_list_classes = {"np" : ("np", HardwareModuleTcpMssAdjust.Nodes.Node.Nps.Np)}
                ...
                class Np(Entity):
                    ...
                    def __init__(self):
                        ...
                        self._segment_path = lambda: "np" + "[np-id='" + self.np_id.get() + "']"
