...
class CISCOVPDNMGMTMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ciscoVpdnMgmtMIBNotifs" : ("ciscovpdnmgmtmibnotifs", CISCOVPDNMGMTMIB.Ciscovpdnmgmtmibnotifs), "cvpdnBundleChildTable" : ("cvpdnbundlechildtable", CISCOVPDNMGMTMIB.Cvpdnbundlechildtable), "cvpdnBundleTable" : ("cvpdnbundletable", CISCOVPDNMGMTMIB.Cvpdnbundletable), "cvpdnMultilinkInfo" : ("cvpdnmultilinkinfo", CISCOVPDNMGMTMIB.Cvpdnmultilinkinfo), "cvpdnSessionAttrTable" : ("cvpdnsessionattrtable", CISCOVPDNMGMTMIB.Cvpdnsessionattrtable), "cvpdnSystemInfo" : ("cvpdnsysteminfo", CISCOVPDNMGMTMIB.Cvpdnsysteminfo), "cvpdnSystemTable" : ("cvpdnsystemtable", CISCOVPDNMGMTMIB.Cvpdnsystemtable), "cvpdnTemplateTable" : ("cvpdntemplatetable", CISCOVPDNMGMTMIB.Cvpdntemplatetable), "cvpdnTunnelAttrTable" : ("cvpdntunnelattrtable", CISCOVPDNMGMTMIB.Cvpdntunnelattrtable), "cvpdnTunnelSessionTable" : ("cvpdntunnelsessiontable", CISCOVPDNMGMTMIB.Cvpdntunnelsessiontable), "cvpdnTunnelTable" : ("cvpdntunneltable", CISCOVPDNMGMTMIB.Cvpdntunneltable), "cvpdnUserToFailHistInfoTable" : ("cvpdnusertofailhistinfotable", CISCOVPDNMGMTMIB.Cvpdnusertofailhistinfotable)}
    ...
    class Ciscovpdnmgmtmibnotifs(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVPDNMGMTMIB.Ciscovpdnmgmtmibnotifs, ['cvpdnnotifsessionevent', 'cvpdnnotifsessionid'], name, value)
    ...
    class Cvpdnbundletable(Entity):
        ...
        class Cvpdnbundleentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdnbundletable.Cvpdnbundleentry, ['cvpdnbundlename', 'cvpdnbundleendpoint', 'cvpdnbundleendpointclass', 'cvpdnbundleendpointtype', 'cvpdnbundlelinkcount', 'cvpdnbundlepeeripaddr', 'cvpdnbundlepeeripaddrtype'], name, value)
    ...
    class Cvpdnmultilinkinfo(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdnmultilinkinfo, ['cvpdnbundlelastchanged', 'cvpdnbundleswithmorethantwolinks', 'cvpdnbundleswithonelink', 'cvpdnbundleswithtwolinks'], name, value)
    ...
    class Cvpdnsessionattrtable(Entity):
        ...
        class Cvpdnsessionattrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdnsessionattrtable.Cvpdnsessionattrentry, ['cvpdnsystemtunneltype', 'cvpdntunnelattrtunnelid', 'cvpdnsessionattrsessionid', 'cvpdnsessionattrbytesin', 'cvpdnsessionattrbytesout', 'cvpdnsessionattrcallduration', 'cvpdnsessionattrdevicecallerid', 'cvpdnsessionattrdevicephyid', 'cvpdnsessionattrdevicetype', 'cvpdnsessionattrds1channelindex', 'cvpdnsessionattrds1portindex', 'cvpdnsessionattrds1slotindex', 'cvpdnsessionattrmodemcallstartindex', 'cvpdnsessionattrmodemcallstarttime', 'cvpdnsessionattrmodemportindex', 'cvpdnsessionattrmodemslotindex', 'cvpdnsessionattrmultilink', 'cvpdnsessionattrmultilinkbundle', 'cvpdnsessionattrmultilinkifindex', 'cvpdnsessionattrpacketsin', 'cvpdnsessionattrpacketsout', 'cvpdnsessionattrrecvpktsdropped', 'cvpdnsessionattrsentpktsdropped', 'cvpdnsessionattrstate', 'cvpdnsessionattrusername', 'cvpdnsessionattrvirtualcircuitid'], name, value)
    ...
    class Cvpdnsysteminfo(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdnsysteminfo, ['cvpdndenieduserstotal', 'cvpdnsessiontotal', 'cvpdnsystemclearsessions', 'cvpdnsystemnotifsessionenabled', 'cvpdntunneltotal'], name, value)
    ...
    class Cvpdnsystemtable(Entity):
        ...
        class Cvpdnsystementry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdnsystemtable.Cvpdnsystementry, ['cvpdnsystemtunneltype', 'cvpdnsystemdenieduserstotal', 'cvpdnsystemfailedconnreq', 'cvpdnsysteminitialconnreq', 'cvpdnsystemsessiontotal', 'cvpdnsystemsuccessconnreq', 'cvpdnsystemtunneltotal'], name, value)
    ...
    class Cvpdntunnelattrtable(Entity):
        ...
        class Cvpdntunnelattrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdntunnelattrtable.Cvpdntunnelattrentry, ['cvpdnsystemtunneltype', 'cvpdntunnelattrtunnelid', 'cvpdntunnelattractivesessions', 'cvpdntunnelattrdeniedusers', 'cvpdntunnelattrlocalinetaddress', 'cvpdntunnelattrlocalinetaddresstype', 'cvpdntunnelattrlocalinitconnection', 'cvpdntunnelattrlocalipaddress', 'cvpdntunnelattrlocalname', 'cvpdntunnelattrnetworkservicetype', 'cvpdntunnelattrorigcause', 'cvpdntunnelattrremoteendpointname', 'cvpdntunnelattrremoteinetaddress', 'cvpdntunnelattrremoteinetaddresstype', 'cvpdntunnelattrremoteipaddress', 'cvpdntunnelattrremotename', 'cvpdntunnelattrremotetunnelid', 'cvpdntunnelattrsoftshut', 'cvpdntunnelattrsourceinetaddress', 'cvpdntunnelattrsourceinetaddresstype', 'cvpdntunnelattrsourceipaddress', 'cvpdntunnelattrstate'], name, value)
    ...
    class Cvpdntunnelsessiontable(Entity):
        ...
        class Cvpdntunnelsessionentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdntunnelsessiontable.Cvpdntunnelsessionentry, ['cvpdntunneltunnelid', 'cvpdntunnelsessionid', 'cvpdntunnelsessionbytesin', 'cvpdntunnelsessionbytesout', 'cvpdntunnelsessioncallduration', 'cvpdntunnelsessiondevicecallerid', 'cvpdntunnelsessiondevicephyid', 'cvpdntunnelsessiondevicetype', 'cvpdntunnelsessionds1channelindex', 'cvpdntunnelsessionds1portindex', 'cvpdntunnelsessionds1slotindex', 'cvpdntunnelsessionmodemcallstartindex', 'cvpdntunnelsessionmodemcallstarttime', 'cvpdntunnelsessionmodemportindex', 'cvpdntunnelsessionmodemslotindex', 'cvpdntunnelsessionmultilink', 'cvpdntunnelsessionpacketsin', 'cvpdntunnelsessionpacketsout', 'cvpdntunnelsessionstate', 'cvpdntunnelsessionusername'], name, value)
    ...
    class Cvpdntunneltable(Entity):
        ...
        class Cvpdntunnelentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdntunneltable.Cvpdntunnelentry, ['cvpdntunneltunnelid', 'cvpdntunnelactivesessions', 'cvpdntunneldeniedusers', 'cvpdntunnellocalinitconnection', 'cvpdntunnellocalipaddress', 'cvpdntunnellocalname', 'cvpdntunnelnetworkservicetype', 'cvpdntunnelorigcause', 'cvpdntunnelremoteendpointname', 'cvpdntunnelremoteipaddress', 'cvpdntunnelremotename', 'cvpdntunnelremotetunnelid', 'cvpdntunnelsoftshut', 'cvpdntunnelsourceipaddress', 'cvpdntunnelstate'], name, value)
    ...
    class Cvpdnusertofailhistinfotable(Entity):
        ...
        class Cvpdnusertofailhistinfoentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVPDNMGMTMIB.Cvpdnusertofailhistinfotable.Cvpdnusertofailhistinfoentry, ['cvpdnunametofailhistuname', 'cvpdnunametofailhisttunnelid', 'cvpdnunametofailhistcount', 'cvpdnunametofailhistdestinetaddr', 'cvpdnunametofailhistdestinettype', 'cvpdnunametofailhistdestip', 'cvpdnunametofailhistfailreason', 'cvpdnunametofailhistfailtime', 'cvpdnunametofailhistfailtype', 'cvpdnunametofailhistlocalinitconn', 'cvpdnunametofailhistlocalname', 'cvpdnunametofailhistremotename', 'cvpdnunametofailhistsourceinetaddr', 'cvpdnunametofailhistsourceinettype', 'cvpdnunametofailhistsourceip', 'cvpdnunametofailhistuserid'], name, value)
