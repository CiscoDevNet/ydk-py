...
_meta_table = {
    'WredEnum' : _MetaInfoEnum('WredEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ncs5500_pi_oper',
        {
    ...
    'CacStateEnum' : _MetaInfoEnum('CacStateEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ncs5500_pi_oper',
        {
            'unknown':'UNKNOWN',
            'admit':'ADMIT',
            'redirect':'REDIRECT',
    ...
    'PolicyParamUnitEnum' : _MetaInfoEnum('PolicyParamUnitEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ncs5500_pi_oper',
        {
    ...
    'PolicyStateEnum' : _MetaInfoEnum('PolicyStateEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ncs5500_pi_oper',
        {
            'active':'ACTIVE',
            'suspended':'SUSPENDED',
        }, 'Cisco-IOS-XR-ncs5500-pi-oper', _yang_ns._namespaces['Cisco-IOS-XR-ncs5500-pi-oper']),
