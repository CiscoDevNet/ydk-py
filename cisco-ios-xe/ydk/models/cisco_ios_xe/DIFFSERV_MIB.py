...
class DIFFSERVMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"diffServAction" : ("diffservaction", DIFFSERVMIB.Diffservaction), "diffServActionTable" : ("diffservactiontable", DIFFSERVMIB.Diffservactiontable), "diffServAlgDrop" : ("diffservalgdrop", DIFFSERVMIB.Diffservalgdrop), "diffServAlgDropTable" : ("diffservalgdroptable", DIFFSERVMIB.Diffservalgdroptable), "diffServClassifier" : ("diffservclassifier", DIFFSERVMIB.Diffservclassifier), "diffServClfrElementTable" : ("diffservclfrelementtable", DIFFSERVMIB.Diffservclfrelementtable), "diffServClfrTable" : ("diffservclfrtable", DIFFSERVMIB.Diffservclfrtable), "diffServCountActTable" : ("diffservcountacttable", DIFFSERVMIB.Diffservcountacttable), "diffServDataPathTable" : ("diffservdatapathtable", DIFFSERVMIB.Diffservdatapathtable), "diffServDscpMarkActTable" : ("diffservdscpmarkacttable", DIFFSERVMIB.Diffservdscpmarkacttable), "diffServMaxRateTable" : ("diffservmaxratetable", DIFFSERVMIB.Diffservmaxratetable), "diffServMeter" : ("diffservmeter", DIFFSERVMIB.Diffservmeter), "diffServMeterTable" : ("diffservmetertable", DIFFSERVMIB.Diffservmetertable), "diffServMinRateTable" : ("diffservminratetable", DIFFSERVMIB.Diffservminratetable), "diffServMultiFieldClfrTable" : ("diffservmultifieldclfrtable", DIFFSERVMIB.Diffservmultifieldclfrtable), "diffServQTable" : ("diffservqtable", DIFFSERVMIB.Diffservqtable), "diffServQueue" : ("diffservqueue", DIFFSERVMIB.Diffservqueue), "diffServRandomDropTable" : ("diffservrandomdroptable", DIFFSERVMIB.Diffservrandomdroptable), "diffServScheduler" : ("diffservscheduler", DIFFSERVMIB.Diffservscheduler), "diffServSchedulerTable" : ("diffservschedulertable", DIFFSERVMIB.Diffservschedulertable), "diffServTBParam" : ("diffservtbparam", DIFFSERVMIB.Diffservtbparam), "diffServTBParamTable" : ("diffservtbparamtable", DIFFSERVMIB.Diffservtbparamtable)}
    ...
    class Diffservactiontable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServActionEntry" : ("diffservactionentry", DIFFSERVMIB.Diffservactiontable.Diffservactionentry)}
        ...
        class Diffservactionentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServActionEntry" + "[diffServActionId='" + self.diffservactionid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServActionTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservactiontable.Diffservactionentry, ['diffservactionid', 'diffservactioninterface', 'diffservactionnext', 'diffservactionspecific', 'diffservactionstatus', 'diffservactionstorage'], name, value)
    ...
    class Diffservalgdroptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServAlgDropEntry" : ("diffservalgdropentry", DIFFSERVMIB.Diffservalgdroptable.Diffservalgdropentry)}
        ...
        class Diffservalgdropentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServAlgDropEntry" + "[diffServAlgDropId='" + self.diffservalgdropid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServAlgDropTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservalgdroptable.Diffservalgdropentry, ['diffservalgdropid', 'diffservalgdropnext', 'diffservalgdropoctets', 'diffservalgdroppkts', 'diffservalgdropqmeasure', 'diffservalgdropqthreshold', 'diffservalgdropspecific', 'diffservalgdropstatus', 'diffservalgdropstorage', 'diffservalgdroptype', 'diffservalgrandomdropoctets', 'diffservalgrandomdroppkts'], name, value)
    ...
    class Diffservclassifier(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(DIFFSERVMIB.Diffservclassifier, ['diffservclfrelementnextfree', 'diffservclfrnextfree', 'diffservmultifieldclfrnextfree'], name, value)
    ...
    class Diffservclfrelementtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServClfrElementEntry" : ("diffservclfrelemententry", DIFFSERVMIB.Diffservclfrelementtable.Diffservclfrelemententry)}
        ...
        class Diffservclfrelemententry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServClfrElementEntry" + "[diffServClfrId='" + self.diffservclfrid.get() + "']" + "[diffServClfrElementId='" + self.diffservclfrelementid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServClfrElementTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservclfrelementtable.Diffservclfrelemententry, ['diffservclfrid', 'diffservclfrelementid', 'diffservclfrelementnext', 'diffservclfrelementprecedence', 'diffservclfrelementspecific', 'diffservclfrelementstatus', 'diffservclfrelementstorage'], name, value)
    ...
    class Diffservclfrtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServClfrEntry" : ("diffservclfrentry", DIFFSERVMIB.Diffservclfrtable.Diffservclfrentry)}
        ...
        class Diffservclfrentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServClfrEntry" + "[diffServClfrId='" + self.diffservclfrid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServClfrTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservclfrtable.Diffservclfrentry, ['diffservclfrid', 'diffservclfrstatus', 'diffservclfrstorage'], name, value)
    ...
    class Diffservcountacttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServCountActEntry" : ("diffservcountactentry", DIFFSERVMIB.Diffservcountacttable.Diffservcountactentry)}
        ...
        class Diffservcountactentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServCountActEntry" + "[diffServCountActId='" + self.diffservcountactid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServCountActTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservcountacttable.Diffservcountactentry, ['diffservcountactid', 'diffservcountactoctets', 'diffservcountactpkts', 'diffservcountactstatus', 'diffservcountactstorage'], name, value)
    ...
    class Diffservdatapathtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServDataPathEntry" : ("diffservdatapathentry", DIFFSERVMIB.Diffservdatapathtable.Diffservdatapathentry)}
        ...
        class Diffservdatapathentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServDataPathEntry" + "[ifIndex='" + self.ifindex.get() + "']" + "[diffServDataPathIfDirection='" + self.diffservdatapathifdirection.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServDataPathTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservdatapathtable.Diffservdatapathentry, ['ifindex', 'diffservdatapathifdirection', 'diffservdatapathstart', 'diffservdatapathstatus', 'diffservdatapathstorage'], name, value)
    ...
    class Diffservdscpmarkacttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServDscpMarkActEntry" : ("diffservdscpmarkactentry", DIFFSERVMIB.Diffservdscpmarkacttable.Diffservdscpmarkactentry)}
        ...
        class Diffservdscpmarkactentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServDscpMarkActEntry" + "[diffServDscpMarkActDscp='" + self.diffservdscpmarkactdscp.get() + "']"
    ...
    class Diffservmaxratetable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServMaxRateEntry" : ("diffservmaxrateentry", DIFFSERVMIB.Diffservmaxratetable.Diffservmaxrateentry)}
        ...
        class Diffservmaxrateentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServMaxRateEntry" + "[diffServMaxRateId='" + self.diffservmaxrateid.get() + "']" + "[diffServMaxRateLevel='" + self.diffservmaxratelevel.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServMaxRateTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservmaxratetable.Diffservmaxrateentry, ['diffservmaxrateid', 'diffservmaxratelevel', 'diffservmaxrateabsolute', 'diffservmaxraterelative', 'diffservmaxratestatus', 'diffservmaxratestorage', 'diffservmaxratethreshold'], name, value)
    ...
    class Diffservmetertable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServMeterEntry" : ("diffservmeterentry", DIFFSERVMIB.Diffservmetertable.Diffservmeterentry)}
        ...
        class Diffservmeterentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServMeterEntry" + "[diffServMeterId='" + self.diffservmeterid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServMeterTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservmetertable.Diffservmeterentry, ['diffservmeterid', 'diffservmeterfailnext', 'diffservmeterspecific', 'diffservmeterstatus', 'diffservmeterstorage', 'diffservmetersucceednext'], name, value)
    ...
    class Diffservminratetable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServMinRateEntry" : ("diffservminrateentry", DIFFSERVMIB.Diffservminratetable.Diffservminrateentry)}
        ...
        class Diffservminrateentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServMinRateEntry" + "[diffServMinRateId='" + self.diffservminrateid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServMinRateTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservminratetable.Diffservminrateentry, ['diffservminrateid', 'diffservminrateabsolute', 'diffservminratepriority', 'diffservminraterelative', 'diffservminratestatus', 'diffservminratestorage'], name, value)
    ...
    class Diffservmultifieldclfrtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServMultiFieldClfrEntry" : ("diffservmultifieldclfrentry", DIFFSERVMIB.Diffservmultifieldclfrtable.Diffservmultifieldclfrentry)}
        ...
        class Diffservmultifieldclfrentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServMultiFieldClfrEntry" + "[diffServMultiFieldClfrId='" + self.diffservmultifieldclfrid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServMultiFieldClfrTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservmultifieldclfrtable.Diffservmultifieldclfrentry, ['diffservmultifieldclfrid', 'diffservmultifieldclfraddrtype', 'diffservmultifieldclfrdscp', 'diffservmultifieldclfrdstaddr', 'diffservmultifieldclfrdstl4portmax', 'diffservmultifieldclfrdstl4portmin', 'diffservmultifieldclfrdstprefixlength', 'diffservmultifieldclfrflowid', 'diffservmultifieldclfrprotocol', 'diffservmultifieldclfrsrcaddr', 'diffservmultifieldclfrsrcl4portmax', 'diffservmultifieldclfrsrcl4portmin', 'diffservmultifieldclfrsrcprefixlength', 'diffservmultifieldclfrstatus', 'diffservmultifieldclfrstorage'], name, value)
    ...
    class Diffservqtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServQEntry" : ("diffservqentry", DIFFSERVMIB.Diffservqtable.Diffservqentry)}
        ...
        class Diffservqentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServQEntry" + "[diffServQId='" + self.diffservqid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServQTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservqtable.Diffservqentry, ['diffservqid', 'diffservqmaxrate', 'diffservqminrate', 'diffservqnext', 'diffservqstatus', 'diffservqstorage'], name, value)
    ...
    class Diffservrandomdroptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServRandomDropEntry" : ("diffservrandomdropentry", DIFFSERVMIB.Diffservrandomdroptable.Diffservrandomdropentry)}
    ...
    class Diffservscheduler(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(DIFFSERVMIB.Diffservscheduler, ['diffservmaxratenextfree', 'diffservminratenextfree', 'diffservschedulernextfree'], name, value)
    ...
    class Diffservschedulertable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServSchedulerEntry" : ("diffservschedulerentry", DIFFSERVMIB.Diffservschedulertable.Diffservschedulerentry)}
        ...
        class Diffservschedulerentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServSchedulerEntry" + "[diffServSchedulerId='" + self.diffservschedulerid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServSchedulerTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservschedulertable.Diffservschedulerentry, ['diffservschedulerid', 'diffservschedulermaxrate', 'diffservschedulermethod', 'diffservschedulerminrate', 'diffservschedulernext', 'diffservschedulerstatus', 'diffservschedulerstorage'], name, value)
    ...
    class Diffservtbparamtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"diffServTBParamEntry" : ("diffservtbparamentry", DIFFSERVMIB.Diffservtbparamtable.Diffservtbparamentry)}
        ...
        class Diffservtbparamentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "diffServTBParamEntry" + "[diffServTBParamId='" + self.diffservtbparamid.get() + "']"
                self._absolute_path = lambda: "DIFFSERV-MIB:DIFFSERV-MIB/diffServTBParamTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(DIFFSERVMIB.Diffservtbparamtable.Diffservtbparamentry, ['diffservtbparamid', 'diffservtbparamburstsize', 'diffservtbparaminterval', 'diffservtbparamrate', 'diffservtbparamstatus', 'diffservtbparamstorage', 'diffservtbparamtype'], name, value)
