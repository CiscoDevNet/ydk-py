...
_meta_table = {
    'CryptoSamAction_Enum' : _MetaInfoEnum('CryptoSamAction_Enum', 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg',
        {
            'proceed':'PROCEED',
            'terminate':'TERMINATE',
    ...
    'Crypto.Sam.PromptInterval' : {
        'meta_info' : _MetaInfoClass('Crypto.Sam.PromptInterval',
            False, 
            [
            _MetaInfoClassMember('action', REFERENCE_ENUM_CLASS, 'CryptoSamAction_Enum' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'CryptoSamAction_Enum', 
                [], [], 
        ...
        'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg'
        ),
    },
    'Crypto.Sam' : {
        'meta_info' : _MetaInfoClass('Crypto.Sam',
            False, 
            [
            _MetaInfoClassMember('prompt-interval', REFERENCE_CLASS, 'PromptInterval' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Sam.PromptInterval', 
                [], [], 
    ...
    'Crypto.Ssh.Server.NetconfVrfTable' : {
        'meta_info' : _MetaInfoClass('Crypto.Ssh.Server.NetconfVrfTable',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Ssh.Server.NetconfVrfTable.Vrf', 
                [], [], 
                '''                Enter VRF name
                ''',
                'vrf',
    ...
    'Crypto.Ssh.Server.VrfTable' : {
        'meta_info' : _MetaInfoClass('Crypto.Ssh.Server.VrfTable',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Ssh.Server.VrfTable.Vrf', 
                [], [], 
                '''                Enter VRF name
                ''',
                'vrf',
    ...
    'Crypto.Ssh' : {
        'meta_info' : _MetaInfoClass('Crypto.Ssh',
            False, 
            [
            _MetaInfoClassMember('client', REFERENCE_CLASS, 'Client' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Ssh.Client', 
                [], [], 
                '''                Provide SSH client service
                ''',
                'client',
                'Cisco-IOS-XR-crypto-ssh-cfg', False),
            _MetaInfoClassMember('server', REFERENCE_CLASS, 'Server' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Ssh.Server', 
                [], [], 
    ...
    'Crypto' : {
        'meta_info' : _MetaInfoClass('Crypto',
            False, 
            [
            _MetaInfoClassMember('sam', REFERENCE_CLASS, 'Sam' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Sam', 
                [], [], 
                '''                Software Authentication Manager (SAM) Config
                ''',
                'sam',
                'Cisco-IOS-XR-crypto-sam-cfg', False),
            _MetaInfoClassMember('ssh', REFERENCE_CLASS, 'Ssh' , 'ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg', 'Crypto.Ssh', 
                [], [], 
