...
class CISCOENTITYALARMMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ceAlarmDescrMapTable" : ("cealarmdescrmaptable", CISCOENTITYALARMMIB.Cealarmdescrmaptable), "ceAlarmDescrTable" : ("cealarmdescrtable", CISCOENTITYALARMMIB.Cealarmdescrtable), "ceAlarmFiltering" : ("cealarmfiltering", CISCOENTITYALARMMIB.Cealarmfiltering), "ceAlarmFilterProfileTable" : ("cealarmfilterprofiletable", CISCOENTITYALARMMIB.Cealarmfilterprofiletable), "ceAlarmHistory" : ("cealarmhistory", CISCOENTITYALARMMIB.Cealarmhistory), "ceAlarmHistTable" : ("cealarmhisttable", CISCOENTITYALARMMIB.Cealarmhisttable), "ceAlarmMonitoring" : ("cealarmmonitoring", CISCOENTITYALARMMIB.Cealarmmonitoring), "ceAlarmTable" : ("cealarmtable", CISCOENTITYALARMMIB.Cealarmtable)}
    ...
    class Cealarmfiltering(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOENTITYALARMMIB.Cealarmfiltering, ['cealarmfilterprofileindexnext', 'cealarmnotifiesenable', 'cealarmsyslogenable'], name, value)
    ...
    class Cealarmfilterprofiletable(Entity):
        ...
        class Cealarmfilterprofileentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOENTITYALARMMIB.Cealarmfilterprofiletable.Cealarmfilterprofileentry, ['cealarmfilterindex', 'cealarmfilteralarmsenabled', 'cealarmfilteralias', 'cealarmfilternotifiesenabled', 'cealarmfilterstatus', 'cealarmfiltersyslogenabled'], name, value)
    ...
    class Cealarmhistory(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOENTITYALARMMIB.Cealarmhistory, ['cealarmhistlastindex', 'cealarmhisttablesize'], name, value)
    ...
    class Cealarmhisttable(Entity):
        ...
        class Cealarmhistentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOENTITYALARMMIB.Cealarmhisttable.Cealarmhistentry, ['cealarmhistindex', 'cealarmhistalarmtype', 'cealarmhistentphysicalindex', 'cealarmhistseverity', 'cealarmhisttimestamp', 'cealarmhisttype'], name, value)
    ...
    class Cealarmmonitoring(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOENTITYALARMMIB.Cealarmmonitoring, ['cealarmcriticalcount', 'cealarmcutoff', 'cealarmmajorcount', 'cealarmminorcount'], name, value)
    ...
    class Cealarmtable(Entity):
        ...
        class Cealarmentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOENTITYALARMMIB.Cealarmtable.Cealarmentry, ['entphysicalindex', 'cealarmfilterprofile', 'cealarmlist', 'cealarmseverity'], name, value)
