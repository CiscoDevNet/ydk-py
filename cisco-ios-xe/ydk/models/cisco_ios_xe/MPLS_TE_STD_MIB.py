...
class MPLSTESTDMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"mplsTeObjects" : ("mplsteobjects", MPLSTESTDMIB.Mplsteobjects), "mplsTeScalars" : ("mplstescalars", MPLSTESTDMIB.Mplstescalars), "mplsTunnelARHopTable" : ("mplstunnelarhoptable", MPLSTESTDMIB.Mplstunnelarhoptable), "mplsTunnelCHopTable" : ("mplstunnelchoptable", MPLSTESTDMIB.Mplstunnelchoptable), "mplsTunnelCRLDPResTable" : ("mplstunnelcrldprestable", MPLSTESTDMIB.Mplstunnelcrldprestable), "mplsTunnelHopTable" : ("mplstunnelhoptable", MPLSTESTDMIB.Mplstunnelhoptable), "mplsTunnelResourceTable" : ("mplstunnelresourcetable", MPLSTESTDMIB.Mplstunnelresourcetable), "mplsTunnelTable" : ("mplstunneltable", MPLSTESTDMIB.Mplstunneltable)}
    ...
    class Mplsteobjects(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(MPLSTESTDMIB.Mplsteobjects, ['mplstunnelhoplistindexnext', 'mplstunnelindexnext', 'mplstunnelnotificationenable', 'mplstunnelresourceindexnext'], name, value)
    ...
    class Mplstescalars(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(MPLSTESTDMIB.Mplstescalars, ['mplstunnelactive', 'mplstunnelconfigured', 'mplstunnelmaxhops', 'mplstunnelnotificationmaxrate', 'mplstunneltedistproto'], name, value)
    ...
    class Mplstunnelarhoptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"mplsTunnelARHopEntry" : ("mplstunnelarhopentry", MPLSTESTDMIB.Mplstunnelarhoptable.Mplstunnelarhopentry)}
        ...
        class Mplstunnelarhopentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "mplsTunnelARHopEntry" + "[mplsTunnelARHopListIndex='" + self.mplstunnelarhoplistindex.get() + "']" + "[mplsTunnelARHopIndex='" + self.mplstunnelarhopindex.get() + "']"
                self._absolute_path = lambda: "MPLS-TE-STD-MIB:MPLS-TE-STD-MIB/mplsTunnelARHopTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(MPLSTESTDMIB.Mplstunnelarhoptable.Mplstunnelarhopentry, ['mplstunnelarhoplistindex', 'mplstunnelarhopindex', 'mplstunnelarhopaddrtype', 'mplstunnelarhopaddrunnum', 'mplstunnelarhopipaddr', 'mplstunnelarhoplspid'], name, value)
    ...
    class Mplstunnelchoptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"mplsTunnelCHopEntry" : ("mplstunnelchopentry", MPLSTESTDMIB.Mplstunnelchoptable.Mplstunnelchopentry)}
        ...
        class Mplstunnelchopentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "mplsTunnelCHopEntry" + "[mplsTunnelCHopListIndex='" + self.mplstunnelchoplistindex.get() + "']" + "[mplsTunnelCHopIndex='" + self.mplstunnelchopindex.get() + "']"
                self._absolute_path = lambda: "MPLS-TE-STD-MIB:MPLS-TE-STD-MIB/mplsTunnelCHopTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(MPLSTESTDMIB.Mplstunnelchoptable.Mplstunnelchopentry, ['mplstunnelchoplistindex', 'mplstunnelchopindex', 'mplstunnelchopaddrtype', 'mplstunnelchopaddrunnum', 'mplstunnelchopasnumber', 'mplstunnelchopipaddr', 'mplstunnelchopipprefixlen', 'mplstunnelchoplspid', 'mplstunnelchoptype'], name, value)
    ...
    class Mplstunnelcrldprestable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"mplsTunnelCRLDPResEntry" : ("mplstunnelcrldpresentry", MPLSTESTDMIB.Mplstunnelcrldprestable.Mplstunnelcrldpresentry)}
        ...
        class Mplstunnelcrldpresentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "mplsTunnelCRLDPResEntry" + "[mplsTunnelResourceIndex='" + self.mplstunnelresourceindex.get() + "']"
                self._absolute_path = lambda: "MPLS-TE-STD-MIB:MPLS-TE-STD-MIB/mplsTunnelCRLDPResTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(MPLSTESTDMIB.Mplstunnelcrldprestable.Mplstunnelcrldpresentry, ['mplstunnelresourceindex', 'mplstunnelcrldpresexburstsize', 'mplstunnelcrldpresflags', 'mplstunnelcrldpresfrequency', 'mplstunnelcrldpresmeanburstsize', 'mplstunnelcrldpresrowstatus', 'mplstunnelcrldpresstoragetype', 'mplstunnelcrldpresweight'], name, value)
    ...
    class Mplstunnelhoptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"mplsTunnelHopEntry" : ("mplstunnelhopentry", MPLSTESTDMIB.Mplstunnelhoptable.Mplstunnelhopentry)}
        ...
        class Mplstunnelhopentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "mplsTunnelHopEntry" + "[mplsTunnelHopListIndex='" + self.mplstunnelhoplistindex.get() + "']" + "[mplsTunnelHopPathOptionIndex='" + self.mplstunnelhoppathoptionindex.get() + "']" + "[mplsTunnelHopIndex='" + self.mplstunnelhopindex.get() + "']"
                self._absolute_path = lambda: "MPLS-TE-STD-MIB:MPLS-TE-STD-MIB/mplsTunnelHopTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(MPLSTESTDMIB.Mplstunnelhoptable.Mplstunnelhopentry, ['mplstunnelhoplistindex', 'mplstunnelhoppathoptionindex', 'mplstunnelhopindex', 'mplstunnelhopaddrtype', 'mplstunnelhopaddrunnum', 'mplstunnelhopasnumber', 'mplstunnelhopentrypathcomp', 'mplstunnelhopinclude', 'mplstunnelhopipaddr', 'mplstunnelhopipprefixlen', 'mplstunnelhoplspid', 'mplstunnelhoppathoptionname', 'mplstunnelhoprowstatus', 'mplstunnelhopstoragetype', 'mplstunnelhoptype'], name, value)
    ...
    class Mplstunnelresourcetable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"mplsTunnelResourceEntry" : ("mplstunnelresourceentry", MPLSTESTDMIB.Mplstunnelresourcetable.Mplstunnelresourceentry)}
        ...
        class Mplstunnelresourceentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "mplsTunnelResourceEntry" + "[mplsTunnelResourceIndex='" + self.mplstunnelresourceindex.get() + "']"
                self._absolute_path = lambda: "MPLS-TE-STD-MIB:MPLS-TE-STD-MIB/mplsTunnelResourceTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(MPLSTESTDMIB.Mplstunnelresourcetable.Mplstunnelresourceentry, ['mplstunnelresourceindex', 'mplstunnelresourceexburstsize', 'mplstunnelresourcefrequency', 'mplstunnelresourcemaxburstsize', 'mplstunnelresourcemaxrate', 'mplstunnelresourcemeanburstsize', 'mplstunnelresourcemeanrate', 'mplstunnelresourcerowstatus', 'mplstunnelresourcestoragetype', 'mplstunnelresourceweight'], name, value)
    ...
    class Mplstunneltable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"mplsTunnelEntry" : ("mplstunnelentry", MPLSTESTDMIB.Mplstunneltable.Mplstunnelentry)}
        ...
        class Mplstunnelentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "mplsTunnelEntry" + "[mplsTunnelIndex='" + self.mplstunnelindex.get() + "']" + "[mplsTunnelInstance='" + self.mplstunnelinstance.get() + "']" + "[mplsTunnelIngressLSRId='" + self.mplstunnelingresslsrid.get() + "']" + "[mplsTunnelEgressLSRId='" + self.mplstunnelegresslsrid.get() + "']"
                self._absolute_path = lambda: "MPLS-TE-STD-MIB:MPLS-TE-STD-MIB/mplsTunnelTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(MPLSTESTDMIB.Mplstunneltable.Mplstunnelentry, ['mplstunnelindex', 'mplstunnelinstance', 'mplstunnelingresslsrid', 'mplstunnelegresslsrid', 'mplstunneladminstatus', 'mplstunnelarhoptableindex', 'mplstunnelchoptableindex', 'mplstunnelcreationtime', 'mplstunneldescr', 'mplstunnelexcludeanyaffinity', 'mplstunnelholdingprio', 'mplstunnelhoptableindex', 'mplstunnelifindex', 'mplstunnelincludeallaffinity', 'mplstunnelincludeanyaffinity', 'mplstunnelinstancepriority', 'mplstunnelinstanceuptime', 'mplstunnelisif', 'mplstunnellastpathchange', 'mplstunnellocalprotectinuse', 'mplstunnelname', 'mplstunneloperstatus', 'mplstunnelowner', 'mplstunnelpathchanges', 'mplstunnelpathinuse', 'mplstunnelperfbytes', 'mplstunnelperferrors', 'mplstunnelperfhcbytes', 'mplstunnelperfhcpackets', 'mplstunnelperfpackets', 'mplstunnelprimaryinstance', 'mplstunnelprimaryuptime', 'mplstunnelresourcepointer', 'mplstunnelrole', 'mplstunnelrowstatus', 'mplstunnelsessionattributes', 'mplstunnelsetupprio', 'mplstunnelsignallingproto', 'mplstunnelstatetransitions', 'mplstunnelstoragetype', 'mplstunneltotaluptime', 'mplstunnelxcpointer'], name, value)
