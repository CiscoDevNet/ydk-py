...
_meta_table = {
    'MPLSTESTDMIB.MplsTeObjects' : {
        ...
        'ydk.models.mpls.MPLS_TE_STD_MIB'
        ),
    },
    'MPLSTESTDMIB.MplsTeScalars' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTeScalars',
            ...
            _MetaInfoClassMember('mplsTunnelNotificationMaxRate', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelTEDistProto', REFERENCE_BITS, 'MplsTunnelTEDistProto_Bits' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTeScalars.MplsTunnelTEDistProto_Bits', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelARHopTable.MplsTunnelARHopEntry' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelARHopTable.MplsTunnelARHopEntry',
            ...
            _MetaInfoClassMember('mplsTunnelARHopListIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', True),
            _MetaInfoClassMember('mplsTunnelARHopAddrType', REFERENCE_ENUM_CLASS, 'TeHopAddressType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'TeHopAddressType_Enum', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelARHopTable' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelARHopTable',
            False, 
            [
            _MetaInfoClassMember('mplsTunnelARHopEntry', REFERENCE_LIST, 'MplsTunnelARHopEntry' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelARHopTable.MplsTunnelARHopEntry', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelCHopTable.MplsTunnelCHopEntry.MplsTunnelCHopType_Enum' : _MetaInfoEnum('MplsTunnelCHopType_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'strict':'STRICT',
            'loose':'LOOSE',
    ...
    'MPLSTESTDMIB.MplsTunnelCHopTable.MplsTunnelCHopEntry' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelCHopTable.MplsTunnelCHopEntry',
            ...
            _MetaInfoClassMember('mplsTunnelCHopListIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', True),
            _MetaInfoClassMember('mplsTunnelCHopAddrType', REFERENCE_ENUM_CLASS, 'TeHopAddressType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'TeHopAddressType_Enum', 
                [], [], 
                '''                The Hop Address Type of this tunnel hop.
            ...
            _MetaInfoClassMember('mplsTunnelCHopLspId', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplstunnelchoplspid',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelCHopType', REFERENCE_ENUM_CLASS, 'MplsTunnelCHopType_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelCHopTable.MplsTunnelCHopEntry.MplsTunnelCHopType_Enum', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelCHopTable' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelCHopTable',
            False, 
            [
            _MetaInfoClassMember('mplsTunnelCHopEntry', REFERENCE_LIST, 'MplsTunnelCHopEntry' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelCHopTable.MplsTunnelCHopEntry', 
                [], [], 
                '''                An entry in this table represents a tunnel hop.  An
    ...
    'MPLSTESTDMIB.MplsTunnelCRLDPResTable.MplsTunnelCRLDPResEntry.MplsTunnelCRLDPResFrequency_Enum' : _MetaInfoEnum('MplsTunnelCRLDPResFrequency_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
    ...
    'MPLSTESTDMIB.MplsTunnelCRLDPResTable.MplsTunnelCRLDPResEntry' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelCRLDPResTable.MplsTunnelCRLDPResEntry',
            ...
            _MetaInfoClassMember('mplsTunnelCRLDPResFlags', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelCRLDPResFrequency', REFERENCE_ENUM_CLASS, 'MplsTunnelCRLDPResFrequency_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelCRLDPResTable.MplsTunnelCRLDPResEntry.MplsTunnelCRLDPResFrequency_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsTunnelCRLDPResMeanBurstSize', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelCRLDPResRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelCRLDPResStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelCRLDPResTable' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelCRLDPResTable',
            False, 
            [
            _MetaInfoClassMember('mplsTunnelCRLDPResEntry', REFERENCE_LIST, 'MplsTunnelCRLDPResEntry' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelCRLDPResTable.MplsTunnelCRLDPResEntry', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry.MplsTunnelHopEntryPathComp_Enum' : _MetaInfoEnum('MplsTunnelHopEntryPathComp_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'dynamic':'DYNAMIC',
            'explicit':'EXPLICIT',
        }, 'MPLS-TE-STD-MIB', _yang_ns._namespaces['MPLS-TE-STD-MIB']),
    'MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry.MplsTunnelHopType_Enum' : _MetaInfoEnum('MplsTunnelHopType_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'strict':'STRICT',
            'loose':'LOOSE',
        }, 'MPLS-TE-STD-MIB', _yang_ns._namespaces['MPLS-TE-STD-MIB']),
    'MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry',
            ...
            _MetaInfoClassMember('mplsTunnelHopPathOptionIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', True),
            _MetaInfoClassMember('mplsTunnelHopAddrType', REFERENCE_ENUM_CLASS, 'TeHopAddressType_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'TeHopAddressType_Enum', 
                [], [], 
                '''                The Hop Address Type of this tunnel hop.
            ...
            _MetaInfoClassMember('mplsTunnelHopAsNumber', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelHopEntryPathComp', REFERENCE_ENUM_CLASS, 'MplsTunnelHopEntryPathComp_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry.MplsTunnelHopEntryPathComp_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsTunnelHopPathOptionName', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelHopRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This variable is used to create, modify, and/or
                delete a row in this table.  When a row in this
                table is in active(1) state, no objects in that row
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelHopStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                ...
                'mplstunnelhopstoragetype',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelHopType', REFERENCE_ENUM_CLASS, 'MplsTunnelHopType_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry.MplsTunnelHopType_Enum', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelHopTable' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelHopTable',
            False, 
            [
            _MetaInfoClassMember('mplsTunnelHopEntry', REFERENCE_LIST, 'MplsTunnelHopEntry' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelHopTable.MplsTunnelHopEntry', 
                [], [], 
                '''                An entry in this table represents a tunnel hop.  An
    ...
    'MPLSTESTDMIB.MplsTunnelResourceTable.MplsTunnelResourceEntry.MplsTunnelResourceFrequency_Enum' : _MetaInfoEnum('MplsTunnelResourceFrequency_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'unspecified':'UNSPECIFIED',
            'frequent':'FREQUENT',
            'veryFrequent':'VERYFREQUENT',
    ...
    'MPLSTESTDMIB.MplsTunnelResourceTable.MplsTunnelResourceEntry' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelResourceTable.MplsTunnelResourceEntry',
            ...
            _MetaInfoClassMember('mplsTunnelResourceExBurstSize', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelResourceFrequency', REFERENCE_ENUM_CLASS, 'MplsTunnelResourceFrequency_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelResourceTable.MplsTunnelResourceEntry.MplsTunnelResourceFrequency_Enum', 
                [], [], 
                '''                The granularity of the availability of committed
            ...
            _MetaInfoClassMember('mplsTunnelResourceMeanRate', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelResourceRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This variable is used to create, modify, and/or
                delete a row in this table.  When a row in this
                table is in active(1) state, no objects in that row
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelResourceStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this Hop entry. Conceptual
                rows having the value 'permanent' need not
                allow write-access to any columnar objects
    ...
    'MPLSTESTDMIB.MplsTunnelResourceTable' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelResourceTable',
            False, 
            [
            _MetaInfoClassMember('mplsTunnelResourceEntry', REFERENCE_LIST, 'MplsTunnelResourceEntry' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelResourceTable.MplsTunnelResourceEntry', 
                [], [], 
                '''                An entry in this table represents a set of resources
    ...
    'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelAdminStatus_Enum' : _MetaInfoEnum('MplsTunnelAdminStatus_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'up':'UP',
            'down':'DOWN',
            'testing':'TESTING',
        }, 'MPLS-TE-STD-MIB', _yang_ns._namespaces['MPLS-TE-STD-MIB']),
    'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelOperStatus_Enum' : _MetaInfoEnum('MplsTunnelOperStatus_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'up':'UP',
            'down':'DOWN',
            'testing':'TESTING',
    ...
    'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelRole_Enum' : _MetaInfoEnum('MplsTunnelRole_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'head':'HEAD',
            'transit':'TRANSIT',
            'tail':'TAIL',
    ...
    'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelSignallingProto_Enum' : _MetaInfoEnum('MplsTunnelSignallingProto_Enum', 'ydk.models.mpls.MPLS_TE_STD_MIB',
        {
            'none':'NONE',
            'rsvp':'RSVP',
            'crldp':'CRLDP',
    ...
    'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry',
            ...
            _MetaInfoClassMember('mplsTunnelInstance', ATTRIBUTE, 'int' , None, None, 
                ...
                'mplstunnelinstance',
                'MPLS-TE-STD-MIB', True),
            _MetaInfoClassMember('mplsTunnelAdminStatus', REFERENCE_ENUM_CLASS, 'MplsTunnelAdminStatus_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsTunnelName', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplstunnelname',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelOperStatus', REFERENCE_ENUM_CLASS, 'MplsTunnelOperStatus_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelOperStatus_Enum', 
                [], [], 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelOwner', REFERENCE_ENUM_CLASS, 'MplsOwner_Enum' , 'ydk.models.mpls.MPLS_TC_STD_MIB', 'MplsOwner_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsTunnelResourcePointer', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelRole', REFERENCE_ENUM_CLASS, 'MplsTunnelRole_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelRole_Enum', 
                [], [], 
                ...
                'mplstunnelrole',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This variable is used to create, modify, and/or
                delete a row in this table.  When a row in this
                table is in active(1) state, no objects in that row
                ...
                'mplstunnelrowstatus',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelSessionAttributes', REFERENCE_BITS, 'MplsTunnelSessionAttributes_Bits' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelSessionAttributes_Bits', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsTunnelSetupPrio', ATTRIBUTE, 'int' , None, None, 
                ...
                'mplstunnelsetupprio',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelSignallingProto', REFERENCE_ENUM_CLASS, 'MplsTunnelSignallingProto_Enum' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry.MplsTunnelSignallingProto_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsTunnelStateTransitions', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
    ...
    'MPLSTESTDMIB.MplsTunnelTable' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB.MplsTunnelTable',
            False, 
            [
            _MetaInfoClassMember('mplsTunnelEntry', REFERENCE_LIST, 'MplsTunnelEntry' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable.MplsTunnelEntry', 
                [], [], 
    ...
    'MPLSTESTDMIB' : {
        'meta_info' : _MetaInfoClass('MPLSTESTDMIB',
            False, 
            [
            _MetaInfoClassMember('mplsTeObjects', REFERENCE_CLASS, 'MplsTeObjects' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTeObjects', 
                [], [], 
                '''                ''',
                'mplsteobjects',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTeScalars', REFERENCE_CLASS, 'MplsTeScalars' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTeScalars', 
                [], [], 
                '''                ''',
                'mplstescalars',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelARHopTable', REFERENCE_CLASS, 'MplsTunnelARHopTable' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelARHopTable', 
                [], [], 
                ...
                'mplstunnelarhoptable',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelCHopTable', REFERENCE_CLASS, 'MplsTunnelCHopTable' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelCHopTable', 
                [], [], 
                ...
                'mplstunnelchoptable',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelCRLDPResTable', REFERENCE_CLASS, 'MplsTunnelCRLDPResTable' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelCRLDPResTable', 
                [], [], 
                ...
                'mplstunnelcrldprestable',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelHopTable', REFERENCE_CLASS, 'MplsTunnelHopTable' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelHopTable', 
                [], [], 
                ...
                'mplstunnelhoptable',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelResourceTable', REFERENCE_CLASS, 'MplsTunnelResourceTable' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelResourceTable', 
                [], [], 
                ...
                'mplstunnelresourcetable',
                'MPLS-TE-STD-MIB', False),
            _MetaInfoClassMember('mplsTunnelTable', REFERENCE_CLASS, 'MplsTunnelTable' , 'ydk.models.mpls.MPLS_TE_STD_MIB', 'MPLSTESTDMIB.MplsTunnelTable', 
                [], [], 
