""" Cisco_IOS_XR_reboot_history_oper 
...
class RebootHistory(Entity):
    ...
    .. attribute:: node
    	...
    	Node ID
    	**type**\: list of  		 :py:class:`Node <ydk.models.cisco_ios_xr.Cisco_IOS_XR_reboot_history_oper.RebootHistory.Node>`
    ...
    _prefix = 'reboot-history-oper'
    _revision = '2016-10-04'
    ...
    def __init__(self):
        ...
        self.yang_parent_name = "Cisco-IOS-XR-reboot-history-oper"
        ...
        self._segment_path = lambda: "Cisco-IOS-XR-reboot-history-oper:reboot-history"
    ...
    class Node(Entity):
        ...
        .. attribute:: reboot_history
        	...
        	Last Reboots
        	**type**\: list of  		 :py:class:`RebootHistory_ <ydk.models.cisco_ios_xr.Cisco_IOS_XR_reboot_history_oper.RebootHistory.Node.RebootHistory_>`
