...
class Statistics(object):
    ...
    .. attribute:: period
    	...
    	**type**\: :py:class:`Period <ydk.models.infra.Cisco_IOS_XR_infra_statsd_cfg.Statistics.Period>`
    ...
    class Period(object):
        ...
        .. attribute:: service_accounting
        	...
        	**type**\: :py:class:`ServiceAccounting <ydk.models.infra.Cisco_IOS_XR_infra_statsd_cfg.Statistics.Period.ServiceAccounting>`
        ...
        class ServiceAccounting(object):
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.infra._meta import _Cisco_IOS_XR_infra_statsd_cfg as meta
