...
class MplsOam(object):
    ...
    class ReplyMode(object):
        ...
        .. attribute:: control_channel
        	...
        	**type**\: :py:class:`ControlChannel <ydk.models.mpls.Cisco_IOS_XR_mpls_oam_cfg.MplsOam.ReplyMode.ControlChannel>`
        ...
        class ControlChannel(object):
            ...
            @staticmethod
            def _meta_info():
                from ydk.models.mpls._meta import _Cisco_IOS_XR_mpls_oam_cfg as meta
