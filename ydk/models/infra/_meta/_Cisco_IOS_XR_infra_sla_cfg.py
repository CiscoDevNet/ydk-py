...
_meta_table = {
    'Sla.Protocols.Ethernet.Profiles.Profile.Statistics.Statistic.BucketsSize' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg'
        ),
    },
    ...
    'Sla.Protocols.Ethernet.Profiles.Profile.Statistics' : {
        'meta_info' : _MetaInfoClass('Sla.Protocols.Ethernet.Profiles.Profile.Statistics',
            False, 
            [
            _MetaInfoClassMember('statistic', REFERENCE_LIST, 'Statistic' , 'ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg', 'Sla.Protocols.Ethernet.Profiles.Profile.Statistics.Statistic', 
                [], [], 
                '''                Type of statistic
                ''',
                'statistic',
    ...
    'Sla.Protocols.Ethernet.Profiles' : {
        'meta_info' : _MetaInfoClass('Sla.Protocols.Ethernet.Profiles',
            False, 
            [
            _MetaInfoClassMember('profile', REFERENCE_LIST, 'Profile' , 'ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg', 'Sla.Protocols.Ethernet.Profiles.Profile', 
                [], [], 
                '''                Name of the profile
                ''',
                'profile',
    ...
    'Sla.Protocols.Ethernet' : {
        'meta_info' : _MetaInfoClass('Sla.Protocols.Ethernet',
            False, 
            [
            _MetaInfoClassMember('profiles', REFERENCE_CLASS, 'Profiles' , 'ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg', 'Sla.Protocols.Ethernet.Profiles', 
                [], [], 
    ...
    'Sla.Protocols' : {
        'meta_info' : _MetaInfoClass('Sla.Protocols',
            False, 
            [
            _MetaInfoClassMember('ethernet', REFERENCE_CLASS, 'Ethernet' , 'ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg', 'Sla.Protocols.Ethernet', 
                [], [], 
    ...
    'Sla' : {
        'meta_info' : _MetaInfoClass('Sla',
            False, 
            [
            _MetaInfoClassMember('protocols', REFERENCE_CLASS, 'Protocols' , 'ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg', 'Sla.Protocols', 
                [], [], 
