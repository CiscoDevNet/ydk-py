...
_meta_table = {
    ...
    'System.Radius.Server' : {
        'meta_info' : _MetaInfoClass('System.Radius.Server',
            ...
            _MetaInfoClassMember('udp', REFERENCE_CLASS, 'Udp' , 'ydk.models.ietf.ietf_system', 'System.Radius.Server.Udp', 
                ...
                'udp',
                'ietf-system', False),
            _MetaInfoClassMember('authentication-type', REFERENCE_IDENTITY_CLASS, 'RadiusAuthenticationType_Identity' , 'ydk.models.ietf.ietf_system', 'RadiusAuthenticationType_Identity', 
                [], [], 
    ...
    'Radius_Identity' : {
        'meta_info' : _MetaInfoClass('Radius_Identity',
            False, 
            [
            ],
            'ietf-system',
