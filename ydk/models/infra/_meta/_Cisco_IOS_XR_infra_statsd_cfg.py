...
_meta_table = {
    ...
    'Statistics.Period' : {
        'meta_info' : _MetaInfoClass('Statistics.Period',
            False, 
            [
            _MetaInfoClassMember('service-accounting', REFERENCE_CLASS, 'ServiceAccounting' , 'ydk.models.infra.Cisco_IOS_XR_infra_statsd_cfg', 'Statistics.Period.ServiceAccounting', 
                [], [], 
                '''                Collection polling period for service
                accounting collectors
                ''',
    ...
    'Statistics' : {
        'meta_info' : _MetaInfoClass('Statistics',
            False, 
            [
            _MetaInfoClassMember('period', REFERENCE_CLASS, 'Period' , 'ydk.models.infra.Cisco_IOS_XR_infra_statsd_cfg', 'Statistics.Period', 
                [], [], 
