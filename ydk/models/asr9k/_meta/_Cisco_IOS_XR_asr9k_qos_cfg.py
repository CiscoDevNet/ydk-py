...
_meta_table = {
    'QosFieldNotSupported_Enum' : _MetaInfoEnum('QosFieldNotSupported_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_qos_cfg',
        {
            'not-supported':'NOT_SUPPORTED',
        }, 'Cisco-IOS-XR-asr9k-qos-cfg', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-qos-cfg']),
    'Qosl2DataLink_Enum' : _MetaInfoEnum('Qosl2DataLink_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_qos_cfg',
        {
            'aal5':'AAL5',
        }, 'Cisco-IOS-XR-asr9k-qos-cfg', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-qos-cfg']),
    'QosPolicyAccount_Enum' : _MetaInfoEnum('QosPolicyAccount_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_qos_cfg',
        {
    ...
    'Qosl2Encap_Enum' : _MetaInfoEnum('Qosl2Encap_Enum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_qos_cfg',
        {
