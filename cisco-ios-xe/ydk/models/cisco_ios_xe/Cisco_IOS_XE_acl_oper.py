...
class AccessLists(Entity):
    ...
    def __init__(self):
        ...
        self._child_list_classes = {"access-list" : ("access_list", AccessLists.AccessList)}
    ...
    class AccessList(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"access-list-entries" : ("access_list_entries", AccessLists.AccessList.AccessListEntries)}
            ...
            self._segment_path = lambda: "access-list" + "[access-control-list-name='" + self.access_control_list_name.get() + "']"
        ...
        class AccessListEntries(Entity):
            ...
            def __init__(self):
                ...
                self._child_container_classes = {}
                self._child_list_classes = {"access-list-entry" : ("access_list_entry", AccessLists.AccessList.AccessListEntries.AccessListEntry)}
            ...
            class AccessListEntry(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"access-list-entries-oper-data" : ("access_list_entries_oper_data", AccessLists.AccessList.AccessListEntries.AccessListEntry.AccessListEntriesOperData)}
                    self._child_list_classes = {}
                    ...
                    self._segment_path = lambda: "access-list-entry" + "[rule-name='" + self.rule_name.get() + "']"
