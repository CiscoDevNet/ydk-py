    ...
    class FlowExporterMaps(Entity):
        ...
        class FlowExporterMap(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"udp" : ("udp", NetFlow.FlowExporterMaps.FlowExporterMap.Udp), "versions" : ("versions", NetFlow.FlowExporterMaps.FlowExporterMap.Versions), "destination" : ("destination", NetFlow.FlowExporterMaps.FlowExporterMap.Destination)}
                self._child_list_classes = {}
            ...
            class Versions(Entity):
                ...
                class Version(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(NetFlow.FlowExporterMaps.FlowExporterMap.Versions.Version, ['version_number', 'options_template_timeout', 'common_template_timeout', 'data_template_timeout'], name, value)
    ...
    class FlowMonitorMapTable(Entity):
        ...
        class FlowMonitorMap(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"option" : ("option", NetFlow.FlowMonitorMapTable.FlowMonitorMap.Option), "exporters" : ("exporters", NetFlow.FlowMonitorMapTable.FlowMonitorMap.Exporters), "record" : ("record", NetFlow.FlowMonitorMapTable.FlowMonitorMap.Record)}
                self._child_list_classes = {}
    ...
    class FlowMonitorMapPerformanceTable(Entity):
        ...
        class FlowMonitorMap(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"option" : ("option", NetFlow.FlowMonitorMapPerformanceTable.FlowMonitorMap.Option), "exporters" : ("exporters", NetFlow.FlowMonitorMapPerformanceTable.FlowMonitorMap.Exporters), "record" : ("record", NetFlow.FlowMonitorMapPerformanceTable.FlowMonitorMap.Record)}
                self._child_list_classes = {}
