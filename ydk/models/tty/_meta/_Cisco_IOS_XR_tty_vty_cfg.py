...
_meta_table = {
    'Vty.VtyPools.VtyPool' : {
        ...
        'ydk.models.tty.Cisco_IOS_XR_tty_vty_cfg'
        ),
    },
    'Vty.VtyPools' : {
        'meta_info' : _MetaInfoClass('Vty.VtyPools',
            False, 
            [
            _MetaInfoClassMember('vty-pool', REFERENCE_LIST, 'VtyPool' , 'ydk.models.tty.Cisco_IOS_XR_tty_vty_cfg', 'Vty.VtyPools.VtyPool', 
                [], [], 
                '''                VTY Pool
                ''',
                'vty_pool',
    ...
    'Vty' : {
        'meta_info' : _MetaInfoClass('Vty',
            False, 
            [
            _MetaInfoClassMember('vty-pools', REFERENCE_CLASS, 'VtyPools' , 'ydk.models.tty.Cisco_IOS_XR_tty_vty_cfg', 'Vty.VtyPools', 
                [], [], 
                '''                List of VTY Pools
                ''',
                'vty_pools',
