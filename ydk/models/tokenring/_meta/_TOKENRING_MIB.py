...
_meta_table = {
    'Dot5ChipSetIBM16_Identity' : {
        'meta_info' : _MetaInfoClass('Dot5ChipSetIBM16_Identity',
            False, 
            [
            ],
            'TOKENRING-MIB',
        ...
        'ydk.models.tokenring.TOKENRING_MIB'
        ),
    },
    'Dot5ChipSetTItms380_Identity' : {
        'meta_info' : _MetaInfoClass('Dot5ChipSetTItms380_Identity',
            False, 
            [
            ],
            'TOKENRING-MIB',
    ...
    'Dot5ChipSetTItms380c16_Identity' : {
        'meta_info' : _MetaInfoClass('Dot5ChipSetTItms380c16_Identity',
            False, 
            [
            ],
            'TOKENRING-MIB',
    ...
    'Dot5TestFullDuplexLoopBack_Identity' : {
        'meta_info' : _MetaInfoClass('Dot5TestFullDuplexLoopBack_Identity',
            False, 
            [
            ],
            'TOKENRING-MIB',
    ...
    'Dot5TestInsertFunc_Identity' : {
        'meta_info' : _MetaInfoClass('Dot5TestInsertFunc_Identity',
            False, 
            [
            ],
            'TOKENRING-MIB',
    ...
    'TOKENRINGMIB.Dot5StatsTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGMIB.Dot5StatsTable',
            False, 
            [
            _MetaInfoClassMember('dot5StatsEntry', REFERENCE_LIST, 'Dot5StatsEntry' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5StatsTable.Dot5StatsEntry', 
                [], [], 
    ...
    'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5ActMonParticipate_Enum' : _MetaInfoEnum('Dot5ActMonParticipate_Enum', 'ydk.models.tokenring.TOKENRING_MIB',
        {
            'true':'TRUE',
            'false':'FALSE',
        }, 'TOKENRING-MIB', _yang_ns._namespaces['TOKENRING-MIB']),
    'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5Commands_Enum' : _MetaInfoEnum('Dot5Commands_Enum', 'ydk.models.tokenring.TOKENRING_MIB',
        {
            'noop':'NOOP',
            'open':'OPEN',
            'reset':'RESET',
    ...
    'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5RingOpenStatus_Enum' : _MetaInfoEnum('Dot5RingOpenStatus_Enum', 'ydk.models.tokenring.TOKENRING_MIB',
        {
            'noOpen':'NOOPEN',
            'badParam':'BADPARAM',
    ...
    'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5RingSpeed_Enum' : _MetaInfoEnum('Dot5RingSpeed_Enum', 'ydk.models.tokenring.TOKENRING_MIB',
        {
            'unknown':'UNKNOWN',
    ...
    'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5RingState_Enum' : _MetaInfoEnum('Dot5RingState_Enum', 'ydk.models.tokenring.TOKENRING_MIB',
        {
            'opened':'OPENED',
            'closed':'CLOSED',
            'opening':'OPENING',
    ...
    'TOKENRINGMIB.Dot5Table.Dot5Entry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGMIB.Dot5Table.Dot5Entry',
            ...
            _MetaInfoClassMember('dot5IfIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot5ifindex',
                'TOKENRING-MIB', True),
            _MetaInfoClassMember('dot5ActMonParticipate', REFERENCE_ENUM_CLASS, 'Dot5ActMonParticipate_Enum' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5ActMonParticipate_Enum', 
                [], [], 
                ...
                'TOKENRING-MIB', False),
            _MetaInfoClassMember('dot5Commands', REFERENCE_ENUM_CLASS, 'Dot5Commands_Enum' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5Commands_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dot5LastBeaconSent', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot5lastbeaconsent',
                'TOKENRING-MIB', False),
            _MetaInfoClassMember('dot5RingOpenStatus', REFERENCE_ENUM_CLASS, 'Dot5RingOpenStatus_Enum' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5RingOpenStatus_Enum', 
                [], [], 
                ...
                'dot5ringopenstatus',
                'TOKENRING-MIB', False),
            _MetaInfoClassMember('dot5RingSpeed', REFERENCE_ENUM_CLASS, 'Dot5RingSpeed_Enum' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5RingSpeed_Enum', 
                [], [], 
                ...
                'dot5ringspeed',
                'TOKENRING-MIB', False),
            _MetaInfoClassMember('dot5RingState', REFERENCE_ENUM_CLASS, 'Dot5RingState_Enum' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table.Dot5Entry.Dot5RingState_Enum', 
                [], [], 
    ...
    'TOKENRINGMIB.Dot5Table' : {
        'meta_info' : _MetaInfoClass('TOKENRINGMIB.Dot5Table',
            False, 
            [
            _MetaInfoClassMember('dot5Entry', REFERENCE_LIST, 'Dot5Entry' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table.Dot5Entry', 
                [], [], 
    ...
    'TOKENRINGMIB.Dot5TimerTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGMIB.Dot5TimerTable',
            False, 
            [
            _MetaInfoClassMember('dot5TimerEntry', REFERENCE_LIST, 'Dot5TimerEntry' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5TimerTable.Dot5TimerEntry', 
                [], [], 
    ...
    'TOKENRINGMIB' : {
        'meta_info' : _MetaInfoClass('TOKENRINGMIB',
            False, 
            [
            _MetaInfoClassMember('dot5StatsTable', REFERENCE_CLASS, 'Dot5StatsTable' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5StatsTable', 
                [], [], 
                ...
                'dot5statstable',
                'TOKENRING-MIB', False),
            _MetaInfoClassMember('dot5Table', REFERENCE_CLASS, 'Dot5Table' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5Table', 
                [], [], 
                ...
                'dot5table',
                'TOKENRING-MIB', False),
            _MetaInfoClassMember('dot5TimerTable', REFERENCE_CLASS, 'Dot5TimerTable' , 'ydk.models.tokenring.TOKENRING_MIB', 'TOKENRINGMIB.Dot5TimerTable', 
                [], [], 
                '''                This table contains Token Ring interface
