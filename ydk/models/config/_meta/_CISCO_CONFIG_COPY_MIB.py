...
_meta_table = {
    'ConfigCopyFailCause_Enum' : _MetaInfoEnum('ConfigCopyFailCause_Enum', 'ydk.models.config.CISCO_CONFIG_COPY_MIB',
        {
            'unknown':'UNKNOWN',
    ...
    'ConfigCopyState_Enum' : _MetaInfoEnum('ConfigCopyState_Enum', 'ydk.models.config.CISCO_CONFIG_COPY_MIB',
        {
            'waiting':'WAITING',
            'running':'RUNNING',
    ...
    'ConfigFileType_Enum' : _MetaInfoEnum('ConfigFileType_Enum', 'ydk.models.config.CISCO_CONFIG_COPY_MIB',
        {
    ...
    'ConfigCopyProtocol_Enum' : _MetaInfoEnum('ConfigCopyProtocol_Enum', 'ydk.models.config.CISCO_CONFIG_COPY_MIB',
        {
            'tftp':'TFTP',
            'ftp':'FTP',
            'rcp':'RCP',
    ...
    'CISCOCONFIGCOPYMIB.CcCopyErrorTable.CcCopyErrorEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCONFIGCOPYMIB.CcCopyErrorTable.CcCopyErrorEntry',
            ...
            _MetaInfoClassMember('ccCopyErrorDeviceIpAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyErrorDeviceIpAddressType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
        ...
        'ydk.models.config.CISCO_CONFIG_COPY_MIB'
        ),
    },
    'CISCOCONFIGCOPYMIB.CcCopyErrorTable' : {
        'meta_info' : _MetaInfoClass('CISCOCONFIGCOPYMIB.CcCopyErrorTable',
            False, 
            [
            _MetaInfoClassMember('ccCopyErrorEntry', REFERENCE_LIST, 'CcCopyErrorEntry' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'CISCOCONFIGCOPYMIB.CcCopyErrorTable.CcCopyErrorEntry', 
                [], [], 
    ...
    'CISCOCONFIGCOPYMIB.CcCopyTable.CcCopyEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCONFIGCOPYMIB.CcCopyTable.CcCopyEntry',
            ...
            _MetaInfoClassMember('ccCopyIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cccopyindex',
                'CISCO-CONFIG-COPY-MIB', True),
            _MetaInfoClassMember('ccCopyDestFileType', REFERENCE_ENUM_CLASS, 'ConfigFileType_Enum' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'ConfigFileType_Enum', 
                [], [], 
                ...
                'cccopydestfiletype',
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyEntryRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyFailCause', REFERENCE_ENUM_CLASS, 'ConfigCopyFailCause_Enum' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'ConfigCopyFailCause_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ccCopyNotificationOnCompletion', ATTRIBUTE, 'bool' , None, None, 
                ...
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyProtocol', REFERENCE_ENUM_CLASS, 'ConfigCopyProtocol_Enum' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'ConfigCopyProtocol_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ccCopyServerAddressRev1', ATTRIBUTE, 'str' , None, None, 
                ...
                'cccopyserveraddressrev1',
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyServerAddressType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                ...
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopySourceFileType', REFERENCE_ENUM_CLASS, 'ConfigFileType_Enum' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'ConfigFileType_Enum', 
                [], [], 
                ...
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyState', REFERENCE_ENUM_CLASS, 'ConfigCopyState_Enum' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'ConfigCopyState_Enum', 
                [], [], 
    ...
    'CISCOCONFIGCOPYMIB.CcCopyTable' : {
        'meta_info' : _MetaInfoClass('CISCOCONFIGCOPYMIB.CcCopyTable',
            False, 
            [
            _MetaInfoClassMember('ccCopyEntry', REFERENCE_LIST, 'CcCopyEntry' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'CISCOCONFIGCOPYMIB.CcCopyTable.CcCopyEntry', 
                [], [], 
    ...
    'CISCOCONFIGCOPYMIB' : {
        'meta_info' : _MetaInfoClass('CISCOCONFIGCOPYMIB',
            False, 
            [
            _MetaInfoClassMember('ccCopyErrorTable', REFERENCE_CLASS, 'CcCopyErrorTable' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'CISCOCONFIGCOPYMIB.CcCopyErrorTable', 
                [], [], 
                ...
                'cccopyerrortable',
                'CISCO-CONFIG-COPY-MIB', False),
            _MetaInfoClassMember('ccCopyTable', REFERENCE_CLASS, 'CcCopyTable' , 'ydk.models.config.CISCO_CONFIG_COPY_MIB', 'CISCOCONFIGCOPYMIB.CcCopyTable', 
                [], [], 
