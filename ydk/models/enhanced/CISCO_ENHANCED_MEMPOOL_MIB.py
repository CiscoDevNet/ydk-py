...
class CempMemPoolTypes_Enum(Enum):
    """
    CempMemPoolTypes_Enum
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.enhanced._meta import _CISCO_ENHANCED_MEMPOOL_MIB as meta
        return meta._meta_table['CempMemPoolTypes_Enum']
...
class CISCOENHANCEDMEMPOOLMIB(object):
    ...
    .. attribute:: cempmembuffercachepooltable
    	...
    	**type**\: :py:class:`CempMemBufferCachePoolTable <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable>`
    ...
    .. attribute:: cempmembufferpooltable
    	...
    	**type**\: :py:class:`CempMemBufferPoolTable <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempMemBufferPoolTable>`
    
    .. attribute:: cempmempooltable
    
    	A table of memory pool monitoring entries for all physical entities on a managed system
    	**type**\: :py:class:`CempMemPoolTable <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable>`
    
    .. attribute:: cempnotificationconfig
    
    	
    	**type**\: :py:class:`CempNotificationConfig <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempNotificationConfig>`
    
    

    """

    _prefix = 'cisco-enhanced'
    ...
    class CempMemBufferCachePoolTable(object):
        ...
        .. attribute:: cempmembuffercachepoolentry
        	...
        	**type**\: list of :py:class:`CempMemBufferCachePoolEntry <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempMemBufferCachePoolTable.CempMemBufferCachePoolEntry>`
        ...
        class CempMemBufferCachePoolEntry(object):
            ...
            .. attribute:: cempmembufferpoolindex
    ...
    class CempMemBufferPoolTable(object):
        ...
        .. attribute:: cempmembufferpoolentry
        	...
        	**type**\: list of :py:class:`CempMemBufferPoolEntry <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempMemBufferPoolTable.CempMemBufferPoolEntry>`
    ...
    class CempMemPoolTable(object):
        ...
        .. attribute:: cempmempoolentry
        	...
        	**type**\: list of :py:class:`CempMemPoolEntry <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CISCOENHANCEDMEMPOOLMIB.CempMemPoolTable.CempMemPoolEntry>`
        ...
        class CempMemPoolEntry(object):
            ...
            .. attribute:: cempmempooltype
            	...
            	**type**\: :py:class:`CempMemPoolTypes_Enum <ydk.models.enhanced.CISCO_ENHANCED_MEMPOOL_MIB.CempMemPoolTypes_Enum>`
            ...
            def _common_path(self):
                if self.cempmempoolindex is None:
                    raise YPYDataValidationError('Key property cempmempoolindex is None')
                if self.entphysicalindex is None:
                    raise YPYDataValidationError('Key property entphysicalindex is None')

                return '/CISCO-ENHANCED-MEMPOOL-MIB:CISCO-ENHANCED-MEMPOOL-MIB/CISCO-ENHANCED-MEMPOOL-MIB:cempMemPoolTable/CISCO-ENHANCED-MEMPOOL-MIB:cempMemPoolEntry[CISCO-ENHANCED-MEMPOOL-MIB:cempMemPoolIndex = ' + str(self.cempmempoolindex) + '][CISCO-ENHANCED-MEMPOOL-MIB:entPhysicalIndex = ' + str(self.entphysicalindex) + ']'
    ...
    def _has_data(self):
        ...
        if self.cempmembuffercachepooltable is not None and self.cempmembuffercachepooltable.is_presence():
            return True

        if self.cempmembufferpooltable is not None and self.cempmembufferpooltable._has_data():
            return True

        if self.cempmembufferpooltable is not None and self.cempmembufferpooltable.is_presence():
            return True

        if self.cempmempooltable is not None and self.cempmempooltable._has_data():
            return True

        if self.cempmempooltable is not None and self.cempmempooltable.is_presence():
            return True

        if self.cempnotificationconfig is not None and self.cempnotificationconfig._has_data():
            return True

        if self.cempnotificationconfig is not None and self.cempnotificationconfig.is_presence():
            return True
