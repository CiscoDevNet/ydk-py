...
class CISCOAAASESSIONMIB(object):
    ...
    .. attribute:: casnactive
    	...
    	**type**\: :py:class:`CasnActive <ydk.models.aaa.CISCO_AAA_SESSION_MIB.CISCOAAASESSIONMIB.CasnActive>`
    
    .. attribute:: casnactivetable
    
    	This table contains entries for active AAA accounting sessions in the system
    	**type**\: :py:class:`CasnActiveTable <ydk.models.aaa.CISCO_AAA_SESSION_MIB.CISCOAAASESSIONMIB.CasnActiveTable>`
    
    .. attribute:: casngeneral
    
    	
    	**type**\: :py:class:`CasnGeneral <ydk.models.aaa.CISCO_AAA_SESSION_MIB.CISCOAAASESSIONMIB.CasnGeneral>`
    ...
    class CasnActive(object):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.aaa._meta import _CISCO_AAA_SESSION_MIB as meta
    ...
    class CasnActiveTable(object):
        ...
        .. attribute:: casnactiveentry
        	...
        	**type**\: list of :py:class:`CasnActiveEntry <ydk.models.aaa.CISCO_AAA_SESSION_MIB.CISCOAAASESSIONMIB.CasnActiveTable.CasnActiveEntry>`
        ...
        class CasnActiveEntry(object):
            ...
            def _common_path(self):
                if self.casnsessionid is None:
                    raise YPYDataValidationError('Key property casnsessionid is None')
    ...
    def _has_data(self):
        ...
        if self.casnactive is not None and self.casnactive.is_presence():
            return True

        if self.casnactivetable is not None and self.casnactivetable._has_data():
            return True

        if self.casnactivetable is not None and self.casnactivetable.is_presence():
            return True

        if self.casngeneral is not None and self.casngeneral._has_data():
            return True

        if self.casngeneral is not None and self.casngeneral.is_presence():
            return True
