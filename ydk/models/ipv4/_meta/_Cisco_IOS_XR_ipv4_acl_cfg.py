...
_meta_table = {
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries',
            False, 
            [
            _MetaInfoClassMember('access-list-entry', REFERENCE_LIST, 'AccessListEntry' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry', 
                [], [], 
    ...
    'Ipv4AclAndPrefixList.Accesses.Access' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access',
            ...
            _MetaInfoClassMember('access-list-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'access_list_name',
                'Cisco-IOS-XR-ipv4-acl-cfg', True),
            _MetaInfoClassMember('access-list-entries', REFERENCE_CLASS, 'AccessListEntries' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries', 
                [], [], 
    ...
    'Ipv4AclAndPrefixList.Accesses' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses',
            False, 
            [
            _MetaInfoClassMember('access', REFERENCE_LIST, 'Access' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access', 
                [], [], 
                '''                An ACL
                ''',
                'access',
    ...
    'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries',
            False, 
            [
            _MetaInfoClassMember('prefix-list-entry', REFERENCE_LIST, 'PrefixListEntry' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries.PrefixListEntry', 
                [], [], 
    ...
    'Ipv4AclAndPrefixList.Prefixes.Prefix' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes.Prefix',
            ...
            _MetaInfoClassMember('prefix-list-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'prefix_list_name',
                'Cisco-IOS-XR-ipv4-acl-cfg', True),
            _MetaInfoClassMember('prefix-list-entries', REFERENCE_CLASS, 'PrefixListEntries' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries', 
                [], [], 
    ...
    'Ipv4AclAndPrefixList.Prefixes' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes',
            False, 
            [
            _MetaInfoClassMember('prefix', REFERENCE_LIST, 'Prefix' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes.Prefix', 
                [], [], 
    ...
    'Ipv4AclAndPrefixList' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList',
            False, 
            [
            _MetaInfoClassMember('accesses', REFERENCE_CLASS, 'Accesses' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses', 
                [], [], 
