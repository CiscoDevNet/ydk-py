...
class Srlg(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"interfaces" : ("interfaces", Srlg.Interfaces), "srlg-names" : ("srlg_names", Srlg.SrlgNames), "groups" : ("groups", Srlg.Groups), "inherit-nodes" : ("inherit_nodes", Srlg.InheritNodes)}
        self._child_list_classes = {}
