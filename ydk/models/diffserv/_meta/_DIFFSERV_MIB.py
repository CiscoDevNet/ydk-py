...
_meta_table = {
    'IfDirection_Enum' : _MetaInfoEnum('IfDirection_Enum', 'ydk.models.diffserv.DIFFSERV_MIB',
        {
            'inbound':'INBOUND',
            'outbound':'OUTBOUND',
    ...
    'DIFFSERVMIB.DiffServAction' : {
        ...
        'ydk.models.diffserv.DIFFSERV_MIB'
        ),
    },
    'DIFFSERVMIB.DiffServActionTable.DiffServActionEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServActionTable.DiffServActionEntry',
            ...
            _MetaInfoClassMember('diffServActionSpecific', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServActionStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServActionStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServActionTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServActionTable',
            False, 
            [
            _MetaInfoClassMember('diffServActionEntry', REFERENCE_LIST, 'DiffServActionEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServActionTable.DiffServActionEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServAlgDropTable.DiffServAlgDropEntry.DiffServAlgDropType_Enum' : _MetaInfoEnum('DiffServAlgDropType_Enum', 'ydk.models.diffserv.DIFFSERV_MIB',
        {
            'other':'OTHER',
            'tailDrop':'TAILDROP',
            'headDrop':'HEADDROP',
    ...
    'DIFFSERVMIB.DiffServAlgDropTable.DiffServAlgDropEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServAlgDropTable.DiffServAlgDropEntry',
            ...
            _MetaInfoClassMember('diffServAlgDropSpecific', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServAlgDropStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServAlgDropStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServAlgDropType', REFERENCE_ENUM_CLASS, 'DiffServAlgDropType_Enum' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServAlgDropTable.DiffServAlgDropEntry.DiffServAlgDropType_Enum', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServAlgDropTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServAlgDropTable',
            False, 
            [
            _MetaInfoClassMember('diffServAlgDropEntry', REFERENCE_LIST, 'DiffServAlgDropEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServAlgDropTable.DiffServAlgDropEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServClfrElementTable.DiffServClfrElementEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServClfrElementTable.DiffServClfrElementEntry',
            ...
            _MetaInfoClassMember('diffServClfrElementSpecific', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServClfrElementStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServClfrElementStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServClfrElementTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServClfrElementTable',
            False, 
            [
            _MetaInfoClassMember('diffServClfrElementEntry', REFERENCE_LIST, 'DiffServClfrElementEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServClfrElementTable.DiffServClfrElementEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServClfrTable.DiffServClfrEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServClfrTable.DiffServClfrEntry',
            ...
            _MetaInfoClassMember('diffServClfrId', ATTRIBUTE, 'int' , None, None, 
                ...
                'diffservclfrid',
                'DIFFSERV-MIB', True),
            _MetaInfoClassMember('diffServClfrStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'diffservclfrstatus',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServClfrStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServClfrTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServClfrTable',
            False, 
            [
            _MetaInfoClassMember('diffServClfrEntry', REFERENCE_LIST, 'DiffServClfrEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServClfrTable.DiffServClfrEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServCountActTable.DiffServCountActEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServCountActTable.DiffServCountActEntry',
            ...
            _MetaInfoClassMember('diffServCountActPkts', ATTRIBUTE, 'int' , None, None, 
                ...
                'diffservcountactpkts',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServCountActStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServCountActStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServCountActTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServCountActTable',
            False, 
            [
            _MetaInfoClassMember('diffServCountActEntry', REFERENCE_LIST, 'DiffServCountActEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServCountActTable.DiffServCountActEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServDataPathTable.DiffServDataPathEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServDataPathTable.DiffServDataPathEntry',
            False, 
            [
            _MetaInfoClassMember('diffServDataPathIfDirection', REFERENCE_ENUM_CLASS, 'IfDirection_Enum' , 'ydk.models.diffserv.DIFFSERV_MIB', 'IfDirection_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('diffServDataPathStart', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServDataPathStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServDataPathStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServDataPathTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServDataPathTable',
            False, 
            [
            _MetaInfoClassMember('diffServDataPathEntry', REFERENCE_LIST, 'DiffServDataPathEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServDataPathTable.DiffServDataPathEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServDscpMarkActTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServDscpMarkActTable',
            False, 
            [
            _MetaInfoClassMember('diffServDscpMarkActEntry', REFERENCE_LIST, 'DiffServDscpMarkActEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServDscpMarkActTable.DiffServDscpMarkActEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServMaxRateTable.DiffServMaxRateEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMaxRateTable.DiffServMaxRateEntry',
            ...
            _MetaInfoClassMember('diffServMaxRateRelative', ATTRIBUTE, 'int' , None, None, 
                ...
                'diffservmaxraterelative',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMaxRateStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMaxRateStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServMaxRateTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMaxRateTable',
            False, 
            [
            _MetaInfoClassMember('diffServMaxRateEntry', REFERENCE_LIST, 'DiffServMaxRateEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMaxRateTable.DiffServMaxRateEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServMeterTable.DiffServMeterEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMeterTable.DiffServMeterEntry',
            ...
            _MetaInfoClassMember('diffServMeterSpecific', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMeterStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'diffservmeterstatus',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMeterStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServMeterTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMeterTable',
            False, 
            [
            _MetaInfoClassMember('diffServMeterEntry', REFERENCE_LIST, 'DiffServMeterEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMeterTable.DiffServMeterEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServMinRateTable.DiffServMinRateEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMinRateTable.DiffServMinRateEntry',
            ...
            _MetaInfoClassMember('diffServMinRateRelative', ATTRIBUTE, 'int' , None, None, 
                ...
                'diffservminraterelative',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMinRateStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMinRateStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServMinRateTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMinRateTable',
            False, 
            [
            _MetaInfoClassMember('diffServMinRateEntry', REFERENCE_LIST, 'DiffServMinRateEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMinRateTable.DiffServMinRateEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServMultiFieldClfrTable.DiffServMultiFieldClfrEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMultiFieldClfrTable.DiffServMultiFieldClfrEntry',
            ...
            _MetaInfoClassMember('diffServMultiFieldClfrId', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIFFSERV-MIB', True),
            _MetaInfoClassMember('diffServMultiFieldClfrAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('diffServMultiFieldClfrSrcPrefixLength', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMultiFieldClfrStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMultiFieldClfrStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServMultiFieldClfrTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServMultiFieldClfrTable',
            False, 
            [
            _MetaInfoClassMember('diffServMultiFieldClfrEntry', REFERENCE_LIST, 'DiffServMultiFieldClfrEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMultiFieldClfrTable.DiffServMultiFieldClfrEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServQTable.DiffServQEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServQTable.DiffServQEntry',
            ...
            _MetaInfoClassMember('diffServQNext', ATTRIBUTE, 'str' , None, None, 
                ...
                'diffservqnext',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServQStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'diffservqstatus',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServQStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServQTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServQTable',
            False, 
            [
            _MetaInfoClassMember('diffServQEntry', REFERENCE_LIST, 'DiffServQEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServQTable.DiffServQEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServRandomDropTable.DiffServRandomDropEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServRandomDropTable.DiffServRandomDropEntry',
            ...
            _MetaInfoClassMember('diffServRandomDropSamplingRate', ATTRIBUTE, 'int' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServRandomDropStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServRandomDropStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServRandomDropTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServRandomDropTable',
            False, 
            [
            _MetaInfoClassMember('diffServRandomDropEntry', REFERENCE_LIST, 'DiffServRandomDropEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServRandomDropTable.DiffServRandomDropEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServSchedulerTable.DiffServSchedulerEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServSchedulerTable.DiffServSchedulerEntry',
            ...
            _MetaInfoClassMember('diffServSchedulerNext', ATTRIBUTE, 'str' , None, None, 
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServSchedulerStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServSchedulerStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServSchedulerTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServSchedulerTable',
            False, 
            [
            _MetaInfoClassMember('diffServSchedulerEntry', REFERENCE_LIST, 'DiffServSchedulerEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServSchedulerTable.DiffServSchedulerEntry', 
                [], [], 
    ...
    'DIFFSERVMIB.DiffServTBParamTable.DiffServTBParamEntry' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServTBParamTable.DiffServTBParamEntry',
            ...
            _MetaInfoClassMember('diffServTBParamRate', ATTRIBUTE, 'int' , None, None, 
                ...
                'diffservtbparamrate',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServTBParamStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this conceptual row. All writable objects in this
                row may be modified at any time. Setting this variable to
                'destroy' when the MIB contains one or more RowPointers pointing
                ...
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServTBParamStorage', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                '''                The storage type for this conceptual row.  Conceptual rows
                having the value 'permanent' need not allow write-access to any
                columnar objects in the row.
    ...
    'DIFFSERVMIB.DiffServTBParamTable' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB.DiffServTBParamTable',
            False, 
            [
            _MetaInfoClassMember('diffServTBParamEntry', REFERENCE_LIST, 'DiffServTBParamEntry' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServTBParamTable.DiffServTBParamEntry', 
                [], [], 
    ...
    'DIFFSERVMIB' : {
        'meta_info' : _MetaInfoClass('DIFFSERVMIB',
            False, 
            [
            _MetaInfoClassMember('diffServAction', REFERENCE_CLASS, 'DiffServAction' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServAction', 
                [], [], 
                '''                ''',
                'diffservaction',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServActionTable', REFERENCE_CLASS, 'DiffServActionTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServActionTable', 
                [], [], 
                ...
                'diffservactiontable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServAlgDrop', REFERENCE_CLASS, 'DiffServAlgDrop' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServAlgDrop', 
                [], [], 
                '''                ''',
                'diffservalgdrop',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServAlgDropTable', REFERENCE_CLASS, 'DiffServAlgDropTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServAlgDropTable', 
                [], [], 
                ...
                'diffservalgdroptable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServClassifier', REFERENCE_CLASS, 'DiffServClassifier' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServClassifier', 
                [], [], 
                '''                ''',
                'diffservclassifier',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServClfrElementTable', REFERENCE_CLASS, 'DiffServClfrElementTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServClfrElementTable', 
                [], [], 
                ...
                'diffservclfrelementtable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServClfrTable', REFERENCE_CLASS, 'DiffServClfrTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServClfrTable', 
                [], [], 
                ...
                'diffservclfrtable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServCountActTable', REFERENCE_CLASS, 'DiffServCountActTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServCountActTable', 
                [], [], 
                ...
                'diffservcountacttable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServDataPathTable', REFERENCE_CLASS, 'DiffServDataPathTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServDataPathTable', 
                [], [], 
                ...
                'diffservdatapathtable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServDscpMarkActTable', REFERENCE_CLASS, 'DiffServDscpMarkActTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServDscpMarkActTable', 
                [], [], 
                ...
                'diffservdscpmarkacttable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMaxRateTable', REFERENCE_CLASS, 'DiffServMaxRateTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMaxRateTable', 
                [], [], 
                ...
                'diffservmaxratetable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMeter', REFERENCE_CLASS, 'DiffServMeter' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMeter', 
                [], [], 
                '''                ''',
                'diffservmeter',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMeterTable', REFERENCE_CLASS, 'DiffServMeterTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMeterTable', 
                [], [], 
                ...
                'diffservmetertable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMinRateTable', REFERENCE_CLASS, 'DiffServMinRateTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMinRateTable', 
                [], [], 
                ...
                'diffservminratetable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServMultiFieldClfrTable', REFERENCE_CLASS, 'DiffServMultiFieldClfrTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServMultiFieldClfrTable', 
                [], [], 
                ...
                'diffservmultifieldclfrtable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServQTable', REFERENCE_CLASS, 'DiffServQTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServQTable', 
                [], [], 
                ...
                'diffservqtable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServQueue', REFERENCE_CLASS, 'DiffServQueue' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServQueue', 
                [], [], 
                '''                ''',
                'diffservqueue',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServRandomDropTable', REFERENCE_CLASS, 'DiffServRandomDropTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServRandomDropTable', 
                [], [], 
                ...
                'diffservrandomdroptable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServScheduler', REFERENCE_CLASS, 'DiffServScheduler' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServScheduler', 
                [], [], 
                '''                ''',
                'diffservscheduler',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServSchedulerTable', REFERENCE_CLASS, 'DiffServSchedulerTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServSchedulerTable', 
                [], [], 
                ...
                'diffservschedulertable',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServTBParam', REFERENCE_CLASS, 'DiffServTBParam' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServTBParam', 
                [], [], 
                '''                ''',
                'diffservtbparam',
                'DIFFSERV-MIB', False),
            _MetaInfoClassMember('diffServTBParamTable', REFERENCE_CLASS, 'DiffServTBParamTable' , 'ydk.models.diffserv.DIFFSERV_MIB', 'DIFFSERVMIB.DiffServTBParamTable', 
                [], [], 
    ...
    'DiffServSchedulerPriority_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServSchedulerPriority_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServSchedulerWFQ_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServSchedulerWFQ_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServSchedulerWRR_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServSchedulerWRR_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamAvgRate_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamAvgRate_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamSimpleTokenBucket_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamSimpleTokenBucket_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamSrTCMAware_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamSrTCMAware_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamSrTCMBlind_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamSrTCMBlind_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamTrTCMAware_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamTrTCMAware_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamTrTCMBlind_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamTrTCMBlind_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
    ...
    'DiffServTBParamTswTCM_Identity' : {
        'meta_info' : _MetaInfoClass('DiffServTBParamTswTCM_Identity',
            False, 
            [
            ],
            'DIFFSERV-MIB',
