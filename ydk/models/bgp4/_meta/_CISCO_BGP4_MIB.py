...
_meta_table = {
    'CbgpSafi_Enum' : _MetaInfoEnum('CbgpSafi_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'unicast':'UNICAST',
            'multicast':'MULTICAST',
    ...
    'CISCOBGP4MIB.CbgpGlobal' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpGlobal',
            ...
            _MetaInfoClassMember('cbgpNotifsEnable', REFERENCE_BITS, 'CbgpNotifsEnable_Bits' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpGlobal.CbgpNotifsEnable_Bits', 
                [], [], 
        ...
        'ydk.models.bgp4.CISCO_BGP4_MIB'
        ),
    },
    'CISCOBGP4MIB.CbgpPeer2AddrFamilyPrefixTable.CbgpPeer2AddrFamilyPrefixEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2AddrFamilyPrefixTable.CbgpPeer2AddrFamilyPrefixEntry',
            False, 
            [
            _MetaInfoClassMember('cbgpPeer2AddrFamilyAfi', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                ''',
                'cbgppeer2addrfamilyafi',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpPeer2AddrFamilySafi', REFERENCE_ENUM_CLASS, 'CbgpSafi_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CbgpSafi_Enum', 
                [], [], 
                '''                ''',
            ...
            _MetaInfoClassMember('cbgpPeer2RemoteAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'cbgppeer2remoteaddr',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpPeer2Type', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                ''',
                'cbgppeer2type',
                'CISCO-BGP4-MIB', True),
    ...
    'CISCOBGP4MIB.CbgpPeer2AddrFamilyPrefixTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2AddrFamilyPrefixTable',
            False, 
            [
            _MetaInfoClassMember('cbgpPeer2AddrFamilyPrefixEntry', REFERENCE_LIST, 'CbgpPeer2AddrFamilyPrefixEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2AddrFamilyPrefixTable.CbgpPeer2AddrFamilyPrefixEntry', 
                [], [], 
    ...
    'CISCOBGP4MIB.CbgpPeer2AddrFamilyTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2AddrFamilyTable',
            False, 
            [
            _MetaInfoClassMember('cbgpPeer2AddrFamilyEntry', REFERENCE_LIST, 'CbgpPeer2AddrFamilyEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2AddrFamilyTable.CbgpPeer2AddrFamilyEntry', 
                [], [], 
                '''                An entry is identified by an AFI/SAFI pair and
    ...
    'CISCOBGP4MIB.CbgpPeer2CapsTable.CbgpPeer2CapsEntry.CbgpPeer2CapCode_Enum' : _MetaInfoEnum('CbgpPeer2CapCode_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
    ...
    'CISCOBGP4MIB.CbgpPeer2CapsTable.CbgpPeer2CapsEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2CapsTable.CbgpPeer2CapsEntry',
            False, 
            [
            _MetaInfoClassMember('cbgpPeer2CapCode', REFERENCE_ENUM_CLASS, 'CbgpPeer2CapCode_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2CapsTable.CbgpPeer2CapsEntry.CbgpPeer2CapCode_Enum', 
                [], [], 
    ...
    'CISCOBGP4MIB.CbgpPeer2CapsTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2CapsTable',
            False, 
            [
            _MetaInfoClassMember('cbgpPeer2CapsEntry', REFERENCE_LIST, 'CbgpPeer2CapsEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2CapsTable.CbgpPeer2CapsEntry', 
                [], [], 
    ...
    'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry.CbgpPeer2AdminStatus_Enum' : _MetaInfoEnum('CbgpPeer2AdminStatus_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'stop':'STOP',
            'start':'START',
        }, 'CISCO-BGP4-MIB', _yang_ns._namespaces['CISCO-BGP4-MIB']),
    'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry.CbgpPeer2PrevState_Enum' : _MetaInfoEnum('CbgpPeer2PrevState_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'none':'NONE',
            'idle':'IDLE',
            'connect':'CONNECT',
    ...
    'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry.CbgpPeer2State_Enum' : _MetaInfoEnum('CbgpPeer2State_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'idle':'IDLE',
            'connect':'CONNECT',
            'active':'ACTIVE',
    ...
    'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry',
            ...
            _MetaInfoClassMember('cbgpPeer2Type', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                ...
                'cbgppeer2type',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpPeer2AdminStatus', REFERENCE_ENUM_CLASS, 'CbgpPeer2AdminStatus_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry.CbgpPeer2AdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbgpPeer2OutUpdates', ATTRIBUTE, 'int' , None, None, 
                ...
                'cbgppeer2outupdates',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeer2PrevState', REFERENCE_ENUM_CLASS, 'CbgpPeer2PrevState_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry.CbgpPeer2PrevState_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbgpPeer2RemotePort', ATTRIBUTE, 'int' , None, None, 
                ...
                'cbgppeer2remoteport',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeer2State', REFERENCE_ENUM_CLASS, 'CbgpPeer2State_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry.CbgpPeer2State_Enum', 
                [], [], 
    ...
    'CISCOBGP4MIB.CbgpPeer2Table' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeer2Table',
            False, 
            [
            _MetaInfoClassMember('cbgpPeer2Entry', REFERENCE_LIST, 'CbgpPeer2Entry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2Table.CbgpPeer2Entry', 
                [], [], 
    ...
    'CISCOBGP4MIB.CbgpPeerAddrFamilyPrefixTable.CbgpPeerAddrFamilyPrefixEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeerAddrFamilyPrefixTable.CbgpPeerAddrFamilyPrefixEntry',
            ...
            _MetaInfoClassMember('bgpPeerRemoteAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'bgppeerremoteaddr',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpPeerAddrFamilyAfi', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                ''',
                'cbgppeeraddrfamilyafi',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpPeerAddrFamilySafi', REFERENCE_ENUM_CLASS, 'CbgpSafi_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CbgpSafi_Enum', 
                [], [], 
                '''                ''',
    ...
    'CISCOBGP4MIB.CbgpPeerAddrFamilyPrefixTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeerAddrFamilyPrefixTable',
            False, 
            [
            _MetaInfoClassMember('cbgpPeerAddrFamilyPrefixEntry', REFERENCE_LIST, 'CbgpPeerAddrFamilyPrefixEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerAddrFamilyPrefixTable.CbgpPeerAddrFamilyPrefixEntry', 
                [], [], 
                '''                An entry is identified by an AFI/SAFI pair and
                peer address. It contains information associated 
                with route prefixes belonging to an address family.
    ...
    'CISCOBGP4MIB.CbgpPeerAddrFamilyTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeerAddrFamilyTable',
            False, 
            [
            _MetaInfoClassMember('cbgpPeerAddrFamilyEntry', REFERENCE_LIST, 'CbgpPeerAddrFamilyEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerAddrFamilyTable.CbgpPeerAddrFamilyEntry', 
                [], [], 
                '''                An entry is identified by an AFI/SAFI pair and
                peer address. It contains names associated with
                an address family.
    ...
    'CISCOBGP4MIB.CbgpPeerCapsTable.CbgpPeerCapsEntry.CbgpPeerCapCode_Enum' : _MetaInfoEnum('CbgpPeerCapCode_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'multiProtocol':'MULTIPROTOCOL',
            'routeRefresh':'ROUTEREFRESH',
            'gracefulRestart':'GRACEFULRESTART',
    ...
    'CISCOBGP4MIB.CbgpPeerCapsTable.CbgpPeerCapsEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeerCapsTable.CbgpPeerCapsEntry',
            ...
            _MetaInfoClassMember('bgpPeerRemoteAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'bgppeerremoteaddr',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpPeerCapCode', REFERENCE_ENUM_CLASS, 'CbgpPeerCapCode_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerCapsTable.CbgpPeerCapsEntry.CbgpPeerCapCode_Enum', 
                [], [], 
                '''                The BGP Capability Advertisement Capability Code.
                ''',
                'cbgppeercapcode',
    ...
    'CISCOBGP4MIB.CbgpPeerCapsTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpPeerCapsTable',
            False, 
            [
            _MetaInfoClassMember('cbgpPeerCapsEntry', REFERENCE_LIST, 'CbgpPeerCapsEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerCapsTable.CbgpPeerCapsEntry', 
                [], [], 
                '''                Each entry represents a capability received from a
                peer with a particular code and an index. When a 
                capability is received multiple times with different
    ...
    'CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry.CbgpRouteAtomicAggregate_Enum' : _MetaInfoEnum('CbgpRouteAtomicAggregate_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'lessSpecificRouteNotSelected':'LESSSPECIFICROUTENOTSELECTED',
            'lessSpecificRouteSelected':'LESSSPECIFICROUTESELECTED',
        }, 'CISCO-BGP4-MIB', _yang_ns._namespaces['CISCO-BGP4-MIB']),
    'CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry.CbgpRouteOrigin_Enum' : _MetaInfoEnum('CbgpRouteOrigin_Enum', 'ydk.models.bgp4.CISCO_BGP4_MIB',
        {
            'igp':'IGP',
            'egp':'EGP',
    ...
    'CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry',
            ...
            _MetaInfoClassMember('cbgpRouteAddrPrefixLen', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpRouteAfi', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbgpRoutePeer', ATTRIBUTE, 'str' , None, None, 
                ...
                'cbgproutepeer',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpRoutePeerType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                ...
                'cbgproutepeertype',
                'CISCO-BGP4-MIB', True),
            _MetaInfoClassMember('cbgpRouteSafi', REFERENCE_ENUM_CLASS, 'CbgpSafi_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CbgpSafi_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbgpRouteAggregatorAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpRouteAggregatorAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                Represents the type of Network Layer address stored
            ...
            _MetaInfoClassMember('cbgpRouteASPathSegment', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpRouteAtomicAggregate', REFERENCE_ENUM_CLASS, 'CbgpRouteAtomicAggregate_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry.CbgpRouteAtomicAggregate_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbgpRouteNextHop', ATTRIBUTE, 'str' , None, None, 
                ...
                'cbgproutenexthop',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpRouteOrigin', REFERENCE_ENUM_CLASS, 'CbgpRouteOrigin_Enum' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry.CbgpRouteOrigin_Enum', 
                [], [], 
    ...
    'CISCOBGP4MIB.CbgpRouteTable' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB.CbgpRouteTable',
            False, 
            [
            _MetaInfoClassMember('cbgpRouteEntry', REFERENCE_LIST, 'CbgpRouteEntry' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpRouteTable.CbgpRouteEntry', 
                [], [], 
    ...
    'CISCOBGP4MIB' : {
        'meta_info' : _MetaInfoClass('CISCOBGP4MIB',
            False, 
            [
            _MetaInfoClassMember('cbgpGlobal', REFERENCE_CLASS, 'CbgpGlobal' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpGlobal', 
                [], [], 
                '''                ''',
                'cbgpglobal',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeer2AddrFamilyPrefixTable', REFERENCE_CLASS, 'CbgpPeer2AddrFamilyPrefixTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2AddrFamilyPrefixTable', 
                [], [], 
                ...
                'cbgppeer2addrfamilyprefixtable',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeer2AddrFamilyTable', REFERENCE_CLASS, 'CbgpPeer2AddrFamilyTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2AddrFamilyTable', 
                [], [], 
                ...
                'cbgppeer2addrfamilytable',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeer2CapsTable', REFERENCE_CLASS, 'CbgpPeer2CapsTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2CapsTable', 
                [], [], 
                ...
                'cbgppeer2capstable',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeer2Table', REFERENCE_CLASS, 'CbgpPeer2Table' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeer2Table', 
                [], [], 
                ...
                'cbgppeer2table',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeerAddrFamilyPrefixTable', REFERENCE_CLASS, 'CbgpPeerAddrFamilyPrefixTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerAddrFamilyPrefixTable', 
                [], [], 
                '''                This table contains prefix related information
                related to address families supported by a peer. 
                Supported address families of a peer are known 
                ...
                'cbgppeeraddrfamilyprefixtable',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeerAddrFamilyTable', REFERENCE_CLASS, 'CbgpPeerAddrFamilyTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerAddrFamilyTable', 
                [], [], 
                '''                This table contains information related to
                address families supported by a peer. Supported
                address families of a peer are known during BGP 
                ...
                'cbgppeeraddrfamilytable',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeerCapsTable', REFERENCE_CLASS, 'CbgpPeerCapsTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpPeerCapsTable', 
                [], [], 
                '''                This table contains the capabilities that are
                supported by a peer. Capabilities of a peer are 
                received during BGP connection establishment.
                ...
                'cbgppeercapstable',
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpRouteTable', REFERENCE_CLASS, 'CbgpRouteTable' , 'ydk.models.bgp4.CISCO_BGP4_MIB', 'CISCOBGP4MIB.CbgpRouteTable', 
                [], [], 
