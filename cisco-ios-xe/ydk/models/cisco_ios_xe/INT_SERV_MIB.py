...
class INTSERVMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"intSrvGenObjects" : ("intsrvgenobjects", INTSERVMIB.Intsrvgenobjects), "intSrvIfAttribTable" : ("intsrvifattribtable", INTSERVMIB.Intsrvifattribtable), "intSrvFlowTable" : ("intsrvflowtable", INTSERVMIB.Intsrvflowtable)}
