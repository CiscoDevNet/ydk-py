...
_meta_table = {
    'CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry.CEigrpAuthMode_Enum' : _MetaInfoEnum('CEigrpAuthMode_Enum', 'ydk.models.eigrp.CISCO_EIGRP_MIB',
        {
            'none':'NONE',
            'md5':'MD5',
    ...
    'CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry',
            ...
            _MetaInfoClassMember('cEigrpAuthKeyChain', ATTRIBUTE, 'str' , None, None, 
                ...
                'ceigrpauthkeychain',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpAuthMode', REFERENCE_ENUM_CLASS, 'CEigrpAuthMode_Enum' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry.CEigrpAuthMode_Enum', 
                [], [], 
        ...
        'ydk.models.eigrp.CISCO_EIGRP_MIB'
        ),
    },
    'CISCOEIGRPMIB.CEigrpInterfaceTable' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpInterfaceTable',
            False, 
            [
            _MetaInfoClassMember('cEigrpInterfaceEntry', REFERENCE_LIST, 'CEigrpInterfaceEntry' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpPeerTable.CEigrpPeerEntry' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpPeerTable.CEigrpPeerEntry',
            ...
            _MetaInfoClassMember('cEigrpPeerAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'ceigrppeeraddr',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpPeerAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpPeerTable' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpPeerTable',
            False, 
            [
            _MetaInfoClassMember('cEigrpPeerEntry', REFERENCE_LIST, 'CEigrpPeerEntry' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpPeerTable.CEigrpPeerEntry', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpTopoTable.CEigrpTopoEntry' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpTopoTable.CEigrpTopoEntry',
            ...
            _MetaInfoClassMember('cEigrpDestNetPrefixLen', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-EIGRP-MIB', True),
            _MetaInfoClassMember('cEigrpDestNetType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cEigrpNextHopAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpNextHopAddressType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cEigrpRouteOriginAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpRouteOriginAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpTopoTable' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpTopoTable',
            False, 
            [
            _MetaInfoClassMember('cEigrpTopoEntry', REFERENCE_LIST, 'CEigrpTopoEntry' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpTopoTable.CEigrpTopoEntry', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpTraffStatsTable.CEigrpTraffStatsEntry' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpTraffStatsTable.CEigrpTraffStatsEntry',
            ...
            _MetaInfoClassMember('cEigrpAsRouterId', ATTRIBUTE, 'str' , None, None, 
                ...
                'ceigrpasrouterid',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpAsRouterIdType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpTraffStatsTable' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpTraffStatsTable',
            False, 
            [
            _MetaInfoClassMember('cEigrpTraffStatsEntry', REFERENCE_LIST, 'CEigrpTraffStatsEntry' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpTraffStatsTable.CEigrpTraffStatsEntry', 
                [], [], 
    ...
    'CISCOEIGRPMIB.CEigrpVpnTable' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB.CEigrpVpnTable',
            False, 
            [
            _MetaInfoClassMember('cEigrpVpnEntry', REFERENCE_LIST, 'CEigrpVpnEntry' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpVpnTable.CEigrpVpnEntry', 
                [], [], 
    ...
    'CISCOEIGRPMIB' : {
        'meta_info' : _MetaInfoClass('CISCOEIGRPMIB',
            False, 
            [
            _MetaInfoClassMember('cEigrpInterfaceTable', REFERENCE_CLASS, 'CEigrpInterfaceTable' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpInterfaceTable', 
                [], [], 
                ...
                'ceigrpinterfacetable',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpPeerTable', REFERENCE_CLASS, 'CEigrpPeerTable' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpPeerTable', 
                [], [], 
                ...
                'ceigrppeertable',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpTopoTable', REFERENCE_CLASS, 'CEigrpTopoTable' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpTopoTable', 
                [], [], 
                ...
                'ceigrptopotable',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpTraffStatsTable', REFERENCE_CLASS, 'CEigrpTraffStatsTable' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpTraffStatsTable', 
                [], [], 
                ...
                'ceigrptraffstatstable',
                'CISCO-EIGRP-MIB', False),
            _MetaInfoClassMember('cEigrpVpnTable', REFERENCE_CLASS, 'CEigrpVpnTable' , 'ydk.models.eigrp.CISCO_EIGRP_MIB', 'CISCOEIGRPMIB.CEigrpVpnTable', 
                [], [], 
