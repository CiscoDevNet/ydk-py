...
_meta_table = {
    'BGP4MIB.Bgp' : {
        ...
        'ydk.models.bgp4.BGP4_MIB'
        ),
    },
    'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry.Bgp4PathAttrAtomicAggregate_Enum' : _MetaInfoEnum('Bgp4PathAttrAtomicAggregate_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
    ...
    'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry.Bgp4PathAttrBest_Enum' : _MetaInfoEnum('Bgp4PathAttrBest_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
            'false':'FALSE',
            'true':'TRUE',
        }, 'BGP4-MIB', _yang_ns._namespaces['BGP4-MIB']),
    'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry.Bgp4PathAttrOrigin_Enum' : _MetaInfoEnum('Bgp4PathAttrOrigin_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
            'igp':'IGP',
            'egp':'EGP',
    ...
    'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry' : {
        'meta_info' : _MetaInfoClass('BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry',
            ...
            _MetaInfoClassMember('bgp4PathAttrASPathSegment', ATTRIBUTE, 'str' , None, None, 
                ...
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgp4PathAttrAtomicAggregate', REFERENCE_ENUM_CLASS, 'Bgp4PathAttrAtomicAggregate_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry.Bgp4PathAttrAtomicAggregate_Enum', 
                [], [], 
                ...
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgp4PathAttrBest', REFERENCE_ENUM_CLASS, 'Bgp4PathAttrBest_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry.Bgp4PathAttrBest_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('bgp4PathAttrNextHop', ATTRIBUTE, 'str' , None, None, 
                ...
                'bgp4pathattrnexthop',
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgp4PathAttrOrigin', REFERENCE_ENUM_CLASS, 'Bgp4PathAttrOrigin_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry.Bgp4PathAttrOrigin_Enum', 
                [], [], 
    ...
    'BGP4MIB.Bgp4PathAttrTable' : {
        'meta_info' : _MetaInfoClass('BGP4MIB.Bgp4PathAttrTable',
            False, 
            [
            _MetaInfoClassMember('bgp4PathAttrEntry', REFERENCE_LIST, 'Bgp4PathAttrEntry' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.Bgp4PathAttrTable.Bgp4PathAttrEntry', 
                [], [], 
    ...
    'BGP4MIB.BgpPeerTable.BgpPeerEntry.BgpPeerAdminStatus_Enum' : _MetaInfoEnum('BgpPeerAdminStatus_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
            'stop':'STOP',
            'start':'START',
        }, 'BGP4-MIB', _yang_ns._namespaces['BGP4-MIB']),
    'BGP4MIB.BgpPeerTable.BgpPeerEntry.BgpPeerState_Enum' : _MetaInfoEnum('BgpPeerState_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
            'idle':'IDLE',
            'connect':'CONNECT',
            'active':'ACTIVE',
    ...
    'BGP4MIB.BgpPeerTable.BgpPeerEntry.CbgpPeerPrevState_Enum' : _MetaInfoEnum('CbgpPeerPrevState_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
            'none':'NONE',
            'idle':'IDLE',
            'connect':'CONNECT',
    ...
    'BGP4MIB.BgpPeerTable.BgpPeerEntry' : {
        'meta_info' : _MetaInfoClass('BGP4MIB.BgpPeerTable.BgpPeerEntry',
            ...
            _MetaInfoClassMember('bgpPeerRemoteAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'bgppeerremoteaddr',
                'BGP4-MIB', True),
            _MetaInfoClassMember('bgpPeerAdminStatus', REFERENCE_ENUM_CLASS, 'BgpPeerAdminStatus_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpPeerTable.BgpPeerEntry.BgpPeerAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('bgpPeerRemotePort', ATTRIBUTE, 'int' , None, None, 
                ...
                'bgppeerremoteport',
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgpPeerState', REFERENCE_ENUM_CLASS, 'BgpPeerState_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpPeerTable.BgpPeerEntry.BgpPeerState_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cbgpPeerPrefixWithdrawn', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-BGP4-MIB', False),
            _MetaInfoClassMember('cbgpPeerPrevState', REFERENCE_ENUM_CLASS, 'CbgpPeerPrevState_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpPeerTable.BgpPeerEntry.CbgpPeerPrevState_Enum', 
                [], [], 
    ...
    'BGP4MIB.BgpPeerTable' : {
        'meta_info' : _MetaInfoClass('BGP4MIB.BgpPeerTable',
            False, 
            [
            _MetaInfoClassMember('bgpPeerEntry', REFERENCE_LIST, 'BgpPeerEntry' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpPeerTable.BgpPeerEntry', 
                [], [], 
    ...
    'BGP4MIB.BgpRcvdPathAttrTable.BgpPathAttrEntry.BgpPathAttrOrigin_Enum' : _MetaInfoEnum('BgpPathAttrOrigin_Enum', 'ydk.models.bgp4.BGP4_MIB',
        {
            'igp':'IGP',
            'egp':'EGP',
            'incomplete':'INCOMPLETE',
    ...
    'BGP4MIB.BgpRcvdPathAttrTable.BgpPathAttrEntry' : {
        'meta_info' : _MetaInfoClass('BGP4MIB.BgpRcvdPathAttrTable.BgpPathAttrEntry',
            ...
            _MetaInfoClassMember('bgpPathAttrNextHop', ATTRIBUTE, 'str' , None, None, 
                ...
                'bgppathattrnexthop',
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgpPathAttrOrigin', REFERENCE_ENUM_CLASS, 'BgpPathAttrOrigin_Enum' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpRcvdPathAttrTable.BgpPathAttrEntry.BgpPathAttrOrigin_Enum', 
                [], [], 
    ...
    'BGP4MIB.BgpRcvdPathAttrTable' : {
        'meta_info' : _MetaInfoClass('BGP4MIB.BgpRcvdPathAttrTable',
            False, 
            [
            _MetaInfoClassMember('bgpPathAttrEntry', REFERENCE_LIST, 'BgpPathAttrEntry' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpRcvdPathAttrTable.BgpPathAttrEntry', 
                [], [], 
                '''                Information about a path to a network.
                ''',
                'bgppathattrentry',
    ...
    'BGP4MIB' : {
        'meta_info' : _MetaInfoClass('BGP4MIB',
            False, 
            [
            _MetaInfoClassMember('bgp', REFERENCE_CLASS, 'Bgp' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.Bgp', 
                [], [], 
                '''                ''',
                'bgp',
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgp4PathAttrTable', REFERENCE_CLASS, 'Bgp4PathAttrTable' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.Bgp4PathAttrTable', 
                [], [], 
                ...
                'bgp4pathattrtable',
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgpPeerTable', REFERENCE_CLASS, 'BgpPeerTable' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpPeerTable', 
                [], [], 
                ...
                'bgppeertable',
                'BGP4-MIB', False),
            _MetaInfoClassMember('bgpRcvdPathAttrTable', REFERENCE_CLASS, 'BgpRcvdPathAttrTable' , 'ydk.models.bgp4.BGP4_MIB', 'BGP4MIB.BgpRcvdPathAttrTable', 
                [], [], 
