...
class CISCOVOICEDNISMIB(object):
    ...
    .. attribute:: cvdnismappingtable
    	...
    	**type**\: :py:class:`CvDnisMappingTable <ydk.models.voice.CISCO_VOICE_DNIS_MIB.CISCOVOICEDNISMIB.CvDnisMappingTable>`
    
    .. attribute:: cvdnisnodetable
    
    	The table contains a DNIS name and a url. The url is a pointer to a VXML page for the DNIS name. 
    	**type**\: :py:class:`CvDnisNodeTable <ydk.models.voice.CISCO_VOICE_DNIS_MIB.CISCOVOICEDNISMIB.CvDnisNodeTable>`
    ...
    class CvDnisMappingTable(object):
        ...
        .. attribute:: cvdnismappingentry
        	...
        	**type**\: list of :py:class:`CvDnisMappingEntry <ydk.models.voice.CISCO_VOICE_DNIS_MIB.CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry>`
        ...
        class CvDnisMappingEntry(object):
            ...
            .. attribute:: cvdnismappingrefresh
            	...
            	**type**\: :py:class:`CvDnisMappingRefresh_Enum <ydk.models.voice.CISCO_VOICE_DNIS_MIB.CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry.CvDnisMappingRefresh_Enum>`
            ...
            class CvDnisMappingRefresh_Enum(Enum):
                """
                CvDnisMappingRefresh_Enum
                ...
                @staticmethod
                def _meta_info():
                    from ydk.models.voice._meta import _CISCO_VOICE_DNIS_MIB as meta
                    return meta._meta_table['CISCOVOICEDNISMIB.CvDnisMappingTable.CvDnisMappingEntry.CvDnisMappingRefresh_Enum']


            @property
            def _common_path(self):
                if self.cvdnismappingname is None:
                    raise YPYDataValidationError('Key property cvdnismappingname is None')
    ...
    class CvDnisNodeTable(object):
        ...
        .. attribute:: cvdnisnodeentry
        	...
        	**type**\: list of :py:class:`CvDnisNodeEntry <ydk.models.voice.CISCO_VOICE_DNIS_MIB.CISCOVOICEDNISMIB.CvDnisNodeTable.CvDnisNodeEntry>`
        ...
        class CvDnisNodeEntry(object):
            ...
            def _common_path(self):
                ...
                if self.cvdnisnumber is None:
                    raise YPYDataValidationError('Key property cvdnisnumber is None')
    ...
    def _has_data(self):
        ...
        if self.cvdnismappingtable is not None and self.cvdnismappingtable.is_presence():
            return True

        if self.cvdnisnodetable is not None and self.cvdnisnodetable._has_data():
            return True

        if self.cvdnisnodetable is not None and self.cvdnisnodetable.is_presence():
            return True
