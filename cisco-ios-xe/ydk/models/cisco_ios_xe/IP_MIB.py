...
class IPMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"icmp" : ("icmp", IPMIB.Icmp), "icmpMsgStatsTable" : ("icmpmsgstatstable", IPMIB.Icmpmsgstatstable), "icmpStatsTable" : ("icmpstatstable", IPMIB.Icmpstatstable), "ip" : ("ip", IPMIB.Ip), "ipAddressPrefixTable" : ("ipaddressprefixtable", IPMIB.Ipaddressprefixtable), "ipAddressTable" : ("ipaddresstable", IPMIB.Ipaddresstable), "ipAddrTable" : ("ipaddrtable", IPMIB.Ipaddrtable), "ipDefaultRouterTable" : ("ipdefaultroutertable", IPMIB.Ipdefaultroutertable), "ipIfStatsTable" : ("ipifstatstable", IPMIB.Ipifstatstable), "ipNetToMediaTable" : ("ipnettomediatable", IPMIB.Ipnettomediatable), "ipNetToPhysicalTable" : ("ipnettophysicaltable", IPMIB.Ipnettophysicaltable), "ipSystemStatsTable" : ("ipsystemstatstable", IPMIB.Ipsystemstatstable), "ipTrafficStats" : ("iptrafficstats", IPMIB.Iptrafficstats), "ipv4InterfaceTable" : ("ipv4interfacetable", IPMIB.Ipv4Interfacetable), "ipv6InterfaceTable" : ("ipv6interfacetable", IPMIB.Ipv6Interfacetable), "ipv6RouterAdvertTable" : ("ipv6routeradverttable", IPMIB.Ipv6Routeradverttable), "ipv6ScopeZoneIndexTable" : ("ipv6scopezoneindextable", IPMIB.Ipv6Scopezoneindextable)}
    ...
    class Icmp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(IPMIB.Icmp, ['icmpinaddrmaskreps', 'icmpinaddrmasks', 'icmpindestunreachs', 'icmpinechoreps', 'icmpinechos', 'icmpinerrors', 'icmpinmsgs', 'icmpinparmprobs', 'icmpinredirects', 'icmpinsrcquenchs', 'icmpintimeexcds', 'icmpintimestampreps', 'icmpintimestamps', 'icmpoutaddrmaskreps', 'icmpoutaddrmasks', 'icmpoutdestunreachs', 'icmpoutechoreps', 'icmpoutechos', 'icmpouterrors', 'icmpoutmsgs', 'icmpoutparmprobs', 'icmpoutredirects', 'icmpoutsrcquenchs', 'icmpouttimeexcds', 'icmpouttimestampreps', 'icmpouttimestamps'], name, value)
    ...
    class Icmpstatstable(Entity):
        ...
        class Icmpstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Icmpstatstable.Icmpstatsentry, ['icmpstatsipversion', 'icmpstatsinerrors', 'icmpstatsinmsgs', 'icmpstatsouterrors', 'icmpstatsoutmsgs'], name, value)
    ...
    class Ip(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(IPMIB.Ip, ['ipaddressspinlock', 'ipdefaultttl', 'ipforwarding', 'ipforwdatagrams', 'ipfragcreates', 'ipfragfails', 'ipfragoks', 'ipinaddrerrors', 'ipindelivers', 'ipindiscards', 'ipinhdrerrors', 'ipinreceives', 'ipinunknownprotos', 'ipoutdiscards', 'ipoutnoroutes', 'ipoutrequests', 'ipreasmfails', 'ipreasmoks', 'ipreasmreqds', 'ipreasmtimeout', 'iproutingdiscards', 'ipv4interfacetablelastchange', 'ipv6interfacetablelastchange', 'ipv6ipdefaulthoplimit', 'ipv6ipforwarding', 'ipv6routeradvertspinlock'], name, value)
    ...
    class Ipaddressprefixtable(Entity):
        ...
        class Ipaddressprefixentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipaddressprefixtable.Ipaddressprefixentry, ['ipaddressprefixifindex', 'ipaddressprefixtype', 'ipaddressprefixprefix', 'ipaddressprefixlength', 'ipaddressprefixadvpreferredlifetime', 'ipaddressprefixadvvalidlifetime', 'ipaddressprefixautonomousflag', 'ipaddressprefixonlinkflag', 'ipaddressprefixorigin'], name, value)
    ...
    class Ipaddresstable(Entity):
        ...
        class Ipaddressentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipaddresstable.Ipaddressentry, ['ipaddressaddrtype', 'ipaddressaddr', 'ipaddresscreated', 'ipaddressifindex', 'ipaddresslastchanged', 'ipaddressorigin', 'ipaddressprefix', 'ipaddressrowstatus', 'ipaddressstatus', 'ipaddressstoragetype', 'ipaddresstype'], name, value)
    ...
    class Ipaddrtable(Entity):
        ...
        class Ipaddrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipaddrtable.Ipaddrentry, ['ipadentaddr', 'ipadentbcastaddr', 'ipadentifindex', 'ipadentnetmask', 'ipadentreasmmaxsize'], name, value)
    ...
    class Ipifstatstable(Entity):
        ...
        class Ipifstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipifstatstable.Ipifstatsentry, ['ipifstatsipversion', 'ipifstatsifindex', 'ipifstatsdiscontinuitytime', 'ipifstatshcinbcastpkts', 'ipifstatshcindelivers', 'ipifstatshcinforwdatagrams', 'ipifstatshcinmcastoctets', 'ipifstatshcinmcastpkts', 'ipifstatshcinoctets', 'ipifstatshcinreceives', 'ipifstatshcoutbcastpkts', 'ipifstatshcoutforwdatagrams', 'ipifstatshcoutmcastoctets', 'ipifstatshcoutmcastpkts', 'ipifstatshcoutoctets', 'ipifstatshcoutrequests', 'ipifstatshcouttransmits', 'ipifstatsinaddrerrors', 'ipifstatsinbcastpkts', 'ipifstatsindelivers', 'ipifstatsindiscards', 'ipifstatsinforwdatagrams', 'ipifstatsinhdrerrors', 'ipifstatsinmcastoctets', 'ipifstatsinmcastpkts', 'ipifstatsinnoroutes', 'ipifstatsinoctets', 'ipifstatsinreceives', 'ipifstatsintruncatedpkts', 'ipifstatsinunknownprotos', 'ipifstatsoutbcastpkts', 'ipifstatsoutdiscards', 'ipifstatsoutforwdatagrams', 'ipifstatsoutfragcreates', 'ipifstatsoutfragfails', 'ipifstatsoutfragoks', 'ipifstatsoutfragreqds', 'ipifstatsoutmcastoctets', 'ipifstatsoutmcastpkts', 'ipifstatsoutoctets', 'ipifstatsoutrequests', 'ipifstatsouttransmits', 'ipifstatsreasmfails', 'ipifstatsreasmoks', 'ipifstatsreasmreqds', 'ipifstatsrefreshrate'], name, value)
    ...
    class Ipnettophysicaltable(Entity):
        ...
        class Ipnettophysicalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipnettophysicaltable.Ipnettophysicalentry, ['ipnettophysicalifindex', 'ipnettophysicalnetaddresstype', 'ipnettophysicalnetaddress', 'ipnettophysicallastupdated', 'ipnettophysicalphysaddress', 'ipnettophysicalrowstatus', 'ipnettophysicalstate', 'ipnettophysicaltype'], name, value)
    ...
    class Ipsystemstatstable(Entity):
        ...
        class Ipsystemstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipsystemstatstable.Ipsystemstatsentry, ['ipsystemstatsipversion', 'ipsystemstatsdiscontinuitytime', 'ipsystemstatshcinbcastpkts', 'ipsystemstatshcindelivers', 'ipsystemstatshcinforwdatagrams', 'ipsystemstatshcinmcastoctets', 'ipsystemstatshcinmcastpkts', 'ipsystemstatshcinoctets', 'ipsystemstatshcinreceives', 'ipsystemstatshcoutbcastpkts', 'ipsystemstatshcoutforwdatagrams', 'ipsystemstatshcoutmcastoctets', 'ipsystemstatshcoutmcastpkts', 'ipsystemstatshcoutoctets', 'ipsystemstatshcoutrequests', 'ipsystemstatshcouttransmits', 'ipsystemstatsinaddrerrors', 'ipsystemstatsinbcastpkts', 'ipsystemstatsindelivers', 'ipsystemstatsindiscards', 'ipsystemstatsinforwdatagrams', 'ipsystemstatsinhdrerrors', 'ipsystemstatsinmcastoctets', 'ipsystemstatsinmcastpkts', 'ipsystemstatsinnoroutes', 'ipsystemstatsinoctets', 'ipsystemstatsinreceives', 'ipsystemstatsintruncatedpkts', 'ipsystemstatsinunknownprotos', 'ipsystemstatsoutbcastpkts', 'ipsystemstatsoutdiscards', 'ipsystemstatsoutforwdatagrams', 'ipsystemstatsoutfragcreates', 'ipsystemstatsoutfragfails', 'ipsystemstatsoutfragoks', 'ipsystemstatsoutfragreqds', 'ipsystemstatsoutmcastoctets', 'ipsystemstatsoutmcastpkts', 'ipsystemstatsoutnoroutes', 'ipsystemstatsoutoctets', 'ipsystemstatsoutrequests', 'ipsystemstatsouttransmits', 'ipsystemstatsreasmfails', 'ipsystemstatsreasmoks', 'ipsystemstatsreasmreqds', 'ipsystemstatsrefreshrate'], name, value)
    ...
    class Ipv4Interfacetable(Entity):
        ...
        class Ipv4Interfaceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipv4Interfacetable.Ipv4Interfaceentry, ['ipv4interfaceifindex', 'ipv4interfaceenablestatus', 'ipv4interfacereasmmaxsize', 'ipv4interfaceretransmittime'], name, value)
    ...
    class Ipv6Interfacetable(Entity):
        ...
        class Ipv6Interfaceentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipv6Interfacetable.Ipv6Interfaceentry, ['ipv6interfaceifindex', 'ipv6interfaceenablestatus', 'ipv6interfaceforwarding', 'ipv6interfaceidentifier', 'ipv6interfacereachabletime', 'ipv6interfacereasmmaxsize', 'ipv6interfaceretransmittime'], name, value)
    ...
    class Ipv6Routeradverttable(Entity):
        ...
        class Ipv6Routeradvertentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipv6Routeradverttable.Ipv6Routeradvertentry, ['ipv6routeradvertifindex', 'ipv6routeradvertcurhoplimit', 'ipv6routeradvertdefaultlifetime', 'ipv6routeradvertlinkmtu', 'ipv6routeradvertmanagedflag', 'ipv6routeradvertmaxinterval', 'ipv6routeradvertmininterval', 'ipv6routeradvertotherconfigflag', 'ipv6routeradvertreachabletime', 'ipv6routeradvertretransmittime', 'ipv6routeradvertrowstatus', 'ipv6routeradvertsendadverts'], name, value)
    ...
    class Ipv6Scopezoneindextable(Entity):
        ...
        class Ipv6Scopezoneindexentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IPMIB.Ipv6Scopezoneindextable.Ipv6Scopezoneindexentry, ['ipv6scopezoneindexifindex', 'ipv6scopezoneindex3', 'ipv6scopezoneindex6', 'ipv6scopezoneindex7', 'ipv6scopezoneindex9', 'ipv6scopezoneindexa', 'ipv6scopezoneindexadminlocal', 'ipv6scopezoneindexb', 'ipv6scopezoneindexc', 'ipv6scopezoneindexd', 'ipv6scopezoneindexlinklocal', 'ipv6scopezoneindexorganizationlocal', 'ipv6scopezoneindexsitelocal'], name, value)
