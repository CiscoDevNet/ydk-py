...
class BGP4MIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"bgp" : ("bgp", BGP4MIB.Bgp), "bgp4PathAttrTable" : ("bgp4pathattrtable", BGP4MIB.Bgp4Pathattrtable), "bgpPeerTable" : ("bgppeertable", BGP4MIB.Bgppeertable), "bgpRcvdPathAttrTable" : ("bgprcvdpathattrtable", BGP4MIB.Bgprcvdpathattrtable)}
    ...
    class Bgp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(BGP4MIB.Bgp, ['bgpidentifier', 'bgplocalas', 'bgpversion'], name, value)
    ...
    class Bgp4Pathattrtable(Entity):
        ...
        class Bgp4Pathattrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(BGP4MIB.Bgp4Pathattrtable.Bgp4Pathattrentry, ['bgp4pathattripaddrprefix', 'bgp4pathattripaddrprefixlen', 'bgp4pathattrpeer', 'bgp4pathattraggregatoraddr', 'bgp4pathattraggregatoras', 'bgp4pathattraspathsegment', 'bgp4pathattratomicaggregate', 'bgp4pathattrbest', 'bgp4pathattrcalclocalpref', 'bgp4pathattrlocalpref', 'bgp4pathattrmultiexitdisc', 'bgp4pathattrnexthop', 'bgp4pathattrorigin', 'bgp4pathattrunknown'], name, value)
    ...
    class Bgppeertable(Entity):
        ...
        class Bgppeerentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(BGP4MIB.Bgppeertable.Bgppeerentry, ['bgppeerremoteaddr', 'bgppeeradminstatus', 'bgppeerconnectretryinterval', 'bgppeerfsmestablishedtime', 'bgppeerfsmestablishedtransitions', 'bgppeerholdtime', 'bgppeerholdtimeconfigured', 'bgppeeridentifier', 'bgppeerintotalmessages', 'bgppeerinupdateelapsedtime', 'bgppeerinupdates', 'bgppeerkeepalive', 'bgppeerkeepaliveconfigured', 'bgppeerlasterror', 'bgppeerlocaladdr', 'bgppeerlocalport', 'bgppeerminasoriginationinterval', 'bgppeerminrouteadvertisementinterval', 'bgppeernegotiatedversion', 'bgppeerouttotalmessages', 'bgppeeroutupdates', 'bgppeerremoteas', 'bgppeerremoteport', 'bgppeerstate', 'cbgppeerlasterrortxt', 'cbgppeerprefixaccepted', 'cbgppeerprefixadvertised', 'cbgppeerprefixdenied', 'cbgppeerprefixlimit', 'cbgppeerprefixsuppressed', 'cbgppeerprefixwithdrawn', 'cbgppeerprevstate'], name, value)
    ...
    class Bgprcvdpathattrtable(Entity):
        ...
        class Bgppathattrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(BGP4MIB.Bgprcvdpathattrtable.Bgppathattrentry, ['bgppathattrdestnetwork', 'bgppathattrpeer', 'bgppathattraspath', 'bgppathattrinterasmetric', 'bgppathattrnexthop', 'bgppathattrorigin'], name, value)
