...
class CISCOEIGRPMIB(object):
    ...
    .. attribute:: ceigrpinterfacetable
    	...
    	**type**\: :py:class:`CEigrpInterfaceTable <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpInterfaceTable>`
    ...
    .. attribute:: ceigrppeertable
    	...
    	**type**\: :py:class:`CEigrpPeerTable <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpPeerTable>`
    ...
    .. attribute:: ceigrptopotable
    	...
    	**type**\: :py:class:`CEigrpTopoTable <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpTopoTable>`
    ...
    .. attribute:: ceigrptraffstatstable
    	...
    	**type**\: :py:class:`CEigrpTraffStatsTable <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpTraffStatsTable>`
    ...
    .. attribute:: ceigrpvpntable
    	...
    	**type**\: :py:class:`CEigrpVpnTable <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpVpnTable>`
    ...
    class CEigrpInterfaceTable(object):
        ...
        .. attribute:: ceigrpinterfaceentry
        	...
        	**type**\: list of :py:class:`CEigrpInterfaceEntry <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry>`
        ...
        class CEigrpInterfaceEntry(object):
            ...
            .. attribute:: ceigrpauthmode
            	...
            	**type**\: :py:class:`CEigrpAuthMode_Enum <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry.CEigrpAuthMode_Enum>`
            ...
            class CEigrpAuthMode_Enum(Enum):
                """
                CEigrpAuthMode_Enum
                ...
                @staticmethod
                def _meta_info():
                    from ydk.models.eigrp._meta import _CISCO_EIGRP_MIB as meta
                    return meta._meta_table['CISCOEIGRPMIB.CEigrpInterfaceTable.CEigrpInterfaceEntry.CEigrpAuthMode_Enum']


            @property
            def _common_path(self):
                if self.ceigrpasnumber is None:
                    raise YPYDataValidationError('Key property ceigrpasnumber is None')
                if self.ceigrpvpnid is None:
                    raise YPYDataValidationError('Key property ceigrpvpnid is None')
                if self.ifindex is None:
                    raise YPYDataValidationError('Key property ifindex is None')

                return '/CISCO-EIGRP-MIB:CISCO-EIGRP-MIB/CISCO-EIGRP-MIB:cEigrpInterfaceTable/CISCO-EIGRP-MIB:cEigrpInterfaceEntry[CISCO-EIGRP-MIB:cEigrpAsNumber = ' + str(self.ceigrpasnumber) + '][CISCO-EIGRP-MIB:cEigrpVpnId = ' + str(self.ceigrpvpnid) + '][CISCO-EIGRP-MIB:ifIndex = ' + str(self.ifindex) + ']'
    ...
    class CEigrpPeerTable(object):
        ...
        .. attribute:: ceigrppeerentry
        	...
        	**type**\: list of :py:class:`CEigrpPeerEntry <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpPeerTable.CEigrpPeerEntry>`
        ...
        class CEigrpPeerEntry(object):
            ...
            def _common_path(self):
                ...
                if self.ceigrphandle is None:
                    raise YPYDataValidationError('Key property ceigrphandle is None')
                if self.ceigrpvpnid is None:
                    raise YPYDataValidationError('Key property ceigrpvpnid is None')

                return '/CISCO-EIGRP-MIB:CISCO-EIGRP-MIB/CISCO-EIGRP-MIB:cEigrpPeerTable/CISCO-EIGRP-MIB:cEigrpPeerEntry[CISCO-EIGRP-MIB:cEigrpAsNumber = ' + str(self.ceigrpasnumber) + '][CISCO-EIGRP-MIB:cEigrpHandle = ' + str(self.ceigrphandle) + '][CISCO-EIGRP-MIB:cEigrpVpnId = ' + str(self.ceigrpvpnid) + ']'
    ...
    class CEigrpTopoTable(object):
        ...
        .. attribute:: ceigrptopoentry
        	...
        	**type**\: list of :py:class:`CEigrpTopoEntry <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpTopoTable.CEigrpTopoEntry>`
        ...
        class CEigrpTopoEntry(object):
            ...
            .. attribute:: ceigrpdestnetprefixlen
            ...
            def _common_path(self):
                ...
                if self.ceigrpdestnet is None:
                    raise YPYDataValidationError('Key property ceigrpdestnet is None')
                if self.ceigrpdestnetprefixlen is None:
                    raise YPYDataValidationError('Key property ceigrpdestnetprefixlen is None')
                if self.ceigrpdestnettype is None:
                    raise YPYDataValidationError('Key property ceigrpdestnettype is None')
                if self.ceigrpvpnid is None:
                    raise YPYDataValidationError('Key property ceigrpvpnid is None')

                return '/CISCO-EIGRP-MIB:CISCO-EIGRP-MIB/CISCO-EIGRP-MIB:cEigrpTopoTable/CISCO-EIGRP-MIB:cEigrpTopoEntry[CISCO-EIGRP-MIB:cEigrpAsNumber = ' + str(self.ceigrpasnumber) + '][CISCO-EIGRP-MIB:cEigrpDestNet = ' + str(self.ceigrpdestnet) + '][CISCO-EIGRP-MIB:cEigrpDestNetPrefixLen = ' + str(self.ceigrpdestnetprefixlen) + '][CISCO-EIGRP-MIB:cEigrpDestNetType = ' + str(self.ceigrpdestnettype) + '][CISCO-EIGRP-MIB:cEigrpVpnId = ' + str(self.ceigrpvpnid) + ']'
    ...
    class CEigrpTraffStatsTable(object):
        ...
        .. attribute:: ceigrptraffstatsentry
        	...
        	**type**\: list of :py:class:`CEigrpTraffStatsEntry <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpTraffStatsTable.CEigrpTraffStatsEntry>`
        ...
        class CEigrpTraffStatsEntry(object):
            ...
            def _common_path(self):
                ...
                return '/CISCO-EIGRP-MIB:CISCO-EIGRP-MIB/CISCO-EIGRP-MIB:cEigrpTraffStatsTable/CISCO-EIGRP-MIB:cEigrpTraffStatsEntry[CISCO-EIGRP-MIB:cEigrpAsNumber = ' + str(self.ceigrpasnumber) + '][CISCO-EIGRP-MIB:cEigrpVpnId = ' + str(self.ceigrpvpnid) + ']'
    ...
    class CEigrpVpnTable(object):
        ...
        .. attribute:: ceigrpvpnentry
        	...
        	**type**\: list of :py:class:`CEigrpVpnEntry <ydk.models.eigrp.CISCO_EIGRP_MIB.CISCOEIGRPMIB.CEigrpVpnTable.CEigrpVpnEntry>`
    ...
    def _has_data(self):
        ...
        if self.ceigrpinterfacetable is not None and self.ceigrpinterfacetable.is_presence():
            return True

        if self.ceigrppeertable is not None and self.ceigrppeertable._has_data():
            return True

        if self.ceigrppeertable is not None and self.ceigrppeertable.is_presence():
            return True

        if self.ceigrptopotable is not None and self.ceigrptopotable._has_data():
            return True

        if self.ceigrptopotable is not None and self.ceigrptopotable.is_presence():
            return True

        if self.ceigrptraffstatstable is not None and self.ceigrptraffstatstable._has_data():
            return True

        if self.ceigrptraffstatstable is not None and self.ceigrptraffstatstable.is_presence():
            return True

        if self.ceigrpvpntable is not None and self.ceigrpvpntable._has_data():
            return True

        if self.ceigrpvpntable is not None and self.ceigrpvpntable.is_presence():
            return True
