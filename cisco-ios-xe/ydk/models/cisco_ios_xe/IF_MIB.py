...
class IFMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ifMIBObjects" : ("ifmibobjects", IFMIB.Ifmibobjects), "ifRcvAddressTable" : ("ifrcvaddresstable", IFMIB.Ifrcvaddresstable), "ifStackTable" : ("ifstacktable", IFMIB.Ifstacktable), "ifTable" : ("iftable", IFMIB.Iftable), "interfaces" : ("interfaces", IFMIB.Interfaces)}
    ...
    class Ifmibobjects(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(IFMIB.Ifmibobjects, ['ifstacklastchange', 'iftablelastchange'], name, value)
    ...
    class Iftable(Entity):
        ...
        class Ifentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(IFMIB.Iftable.Ifentry, ['ifindex', 'ifadminstatus', 'ifalias', 'ifconnectorpresent', 'ifcounterdiscontinuitytime', 'ifdescr', 'ifhcinbroadcastpkts', 'ifhcinmulticastpkts', 'ifhcinoctets', 'ifhcinucastpkts', 'ifhcoutbroadcastpkts', 'ifhcoutmulticastpkts', 'ifhcoutoctets', 'ifhcoutucastpkts', 'ifhighspeed', 'ifinbroadcastpkts', 'ifindiscards', 'ifinerrors', 'ifinmulticastpkts', 'ifinnucastpkts', 'ifinoctets', 'ifinucastpkts', 'ifinunknownprotos', 'iflastchange', 'iflinkupdowntrapenable', 'ifmtu', 'ifname', 'ifoperstatus', 'ifoutbroadcastpkts', 'ifoutdiscards', 'ifouterrors', 'ifoutmulticastpkts', 'ifoutnucastpkts', 'ifoutoctets', 'ifoutqlen', 'ifoutucastpkts', 'ifphysaddress', 'ifpromiscuousmode', 'ifspecific', 'ifspeed', 'iftestcode', 'iftestid', 'iftestowner', 'iftestresult', 'ifteststatus', 'iftesttype', 'iftype'], name, value)
