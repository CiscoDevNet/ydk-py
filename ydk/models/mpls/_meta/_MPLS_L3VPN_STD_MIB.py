...
_meta_table = {
    'MplsL3VpnRtType_Enum' : _MetaInfoEnum('MplsL3VpnRtType_Enum', 'ydk.models.mpls.MPLS_L3VPN_STD_MIB',
        {
            'import':'IMPORT',
            'export':'EXPORT',
            'both':'BOTH',
        }, 'MPLS-L3VPN-STD-MIB', _yang_ns._namespaces['MPLS-L3VPN-STD-MIB']),
    'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable.MplsL3VpnIfConfEntry.MplsL3VpnIfVpnClassification_Enum' : _MetaInfoEnum('MplsL3VpnIfVpnClassification_Enum', 'ydk.models.mpls.MPLS_L3VPN_STD_MIB',
        {
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable.MplsL3VpnIfConfEntry' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable.MplsL3VpnIfConfEntry',
            ...
            _MetaInfoClassMember('mplsL3VpnVrfName', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsl3vpnvrfname',
                'MPLS-L3VPN-STD-MIB', True),
            _MetaInfoClassMember('mplsL3VpnIfConfRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsL3VpnIfConfStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnIfVpnClassification', REFERENCE_ENUM_CLASS, 'MplsL3VpnIfVpnClassification_Enum' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable.MplsL3VpnIfConfEntry.MplsL3VpnIfVpnClassification_Enum', 
                [], [], 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnIfVpnRouteDistProtocol', REFERENCE_BITS, 'MplsL3VpnIfVpnRouteDistProtocol_Bits' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable.MplsL3VpnIfConfEntry.MplsL3VpnIfVpnRouteDistProtocol_Bits', 
                [], [], 
        ...
        'ydk.models.mpls.MPLS_L3VPN_STD_MIB'
        ),
    },
    'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable',
            False, 
            [
            _MetaInfoClassMember('mplsL3VpnIfConfEntry', REFERENCE_LIST, 'MplsL3VpnIfConfEntry' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable.MplsL3VpnIfConfEntry', 
                [], [], 
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfRTTable.MplsL3VpnVrfRTEntry' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnVrfRTTable.MplsL3VpnVrfRTEntry',
            ...
            _MetaInfoClassMember('mplsL3VpnVrfRTIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'mplsl3vpnvrfrtindex',
                'MPLS-L3VPN-STD-MIB', True),
            _MetaInfoClassMember('mplsL3VpnVrfRTType', REFERENCE_ENUM_CLASS, 'MplsL3VpnRtType_Enum' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MplsL3VpnRtType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsL3VpnVrfRTDescr', ATTRIBUTE, 'str' , None, None, 
                ...
                'mplsl3vpnvrfrtdescr',
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRTRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This variable is used to create, modify, and/or
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRTStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfRTTable' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnVrfRTTable',
            False, 
            [
            _MetaInfoClassMember('mplsL3VpnVrfRTEntry', REFERENCE_LIST, 'MplsL3VpnVrfRTEntry' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfRTTable.MplsL3VpnVrfRTEntry', 
                [], [], 
                '''                An entry in this table is created by an LSR for
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable.MplsL3VpnVrfRteEntry.MplsL3VpnVrfRteInetCidrType_Enum' : _MetaInfoEnum('MplsL3VpnVrfRteInetCidrType_Enum', 'ydk.models.mpls.MPLS_L3VPN_STD_MIB',
        {
            'other':'OTHER',
            'reject':'REJECT',
            'local':'LOCAL',
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable.MplsL3VpnVrfRteEntry' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable.MplsL3VpnVrfRteEntry',
            ...
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrDest', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-L3VPN-STD-MIB', True),
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrDestType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrNextHop', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-L3VPN-STD-MIB', True),
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrNHopType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrNextHopAS', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrProto', REFERENCE_ENUM_CLASS, 'IANAipRouteProtocol_Enum' , 'ydk.models.iana.IANA_RTPROTO_MIB', 'IANAipRouteProtocol_Enum', 
                [], [], 
                ...
                'mplsl3vpnvrfrteinetcidrproto',
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRteInetCidrType', REFERENCE_ENUM_CLASS, 'MplsL3VpnVrfRteInetCidrType_Enum' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable.MplsL3VpnVrfRteEntry.MplsL3VpnVrfRteInetCidrType_Enum', 
                [], [], 
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable',
            False, 
            [
            _MetaInfoClassMember('mplsL3VpnVrfRteEntry', REFERENCE_LIST, 'MplsL3VpnVrfRteEntry' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable.MplsL3VpnVrfRteEntry', 
                [], [], 
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry.MplsL3VpnVrfConfAdminStatus_Enum' : _MetaInfoEnum('MplsL3VpnVrfConfAdminStatus_Enum', 'ydk.models.mpls.MPLS_L3VPN_STD_MIB',
        {
            'up':'UP',
            'down':'DOWN',
            'testing':'TESTING',
        }, 'MPLS-L3VPN-STD-MIB', _yang_ns._namespaces['MPLS-L3VPN-STD-MIB']),
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry.MplsL3VpnVrfOperStatus_Enum' : _MetaInfoEnum('MplsL3VpnVrfOperStatus_Enum', 'ydk.models.mpls.MPLS_L3VPN_STD_MIB',
        {
            'up':'UP',
            'down':'DOWN',
        }, 'MPLS-L3VPN-STD-MIB', _yang_ns._namespaces['MPLS-L3VPN-STD-MIB']),
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry',
            ...
            _MetaInfoClassMember('mplsL3VpnVrfAssociatedInterfaces', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfConfAdminStatus', REFERENCE_ENUM_CLASS, 'MplsL3VpnVrfConfAdminStatus_Enum' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry.MplsL3VpnVrfConfAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsL3VpnVrfConfMidRteThresh', ATTRIBUTE, 'int' , None, None, 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfConfRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This variable is used to create, modify, and/or
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfConfStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('mplsL3VpnVrfDescription', ATTRIBUTE, 'str' , None, None, 
                ...
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfOperStatus', REFERENCE_ENUM_CLASS, 'MplsL3VpnVrfOperStatus_Enum' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry.MplsL3VpnVrfOperStatus_Enum', 
                [], [], 
    ...
    'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB.MplsL3VpnVrfTable',
            False, 
            [
            _MetaInfoClassMember('mplsL3VpnVrfEntry', REFERENCE_LIST, 'MplsL3VpnVrfEntry' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable.MplsL3VpnVrfEntry', 
                [], [], 
                '''                An entry in this table is created by an LSR for
    ...
    'MPLSL3VPNSTDMIB' : {
        'meta_info' : _MetaInfoClass('MPLSL3VPNSTDMIB',
            False, 
            [
            _MetaInfoClassMember('mplsL3VpnIfConfTable', REFERENCE_CLASS, 'MplsL3VpnIfConfTable' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnIfConfTable', 
                [], [], 
                ...
                'mplsl3vpnifconftable',
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnScalars', REFERENCE_CLASS, 'MplsL3VpnScalars' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnScalars', 
                [], [], 
                '''                ''',
                'mplsl3vpnscalars',
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRteTable', REFERENCE_CLASS, 'MplsL3VpnVrfRteTable' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfRteTable', 
                [], [], 
                ...
                'mplsl3vpnvrfrtetable',
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfRTTable', REFERENCE_CLASS, 'MplsL3VpnVrfRTTable' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfRTTable', 
                [], [], 
                ...
                'mplsl3vpnvrfrttable',
                'MPLS-L3VPN-STD-MIB', False),
            _MetaInfoClassMember('mplsL3VpnVrfTable', REFERENCE_CLASS, 'MplsL3VpnVrfTable' , 'ydk.models.mpls.MPLS_L3VPN_STD_MIB', 'MPLSL3VPNSTDMIB.MplsL3VpnVrfTable', 
                [], [], 
