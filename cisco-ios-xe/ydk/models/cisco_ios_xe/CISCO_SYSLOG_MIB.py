...
class CISCOSYSLOGMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"clogBasic" : ("clogbasic", CISCOSYSLOGMIB.Clogbasic), "clogHistory" : ("cloghistory", CISCOSYSLOGMIB.Cloghistory), "clogHistoryTable" : ("cloghistorytable", CISCOSYSLOGMIB.Cloghistorytable), "clogServer" : ("clogserver", CISCOSYSLOGMIB.Clogserver), "clogServerConfigTable" : ("clogserverconfigtable", CISCOSYSLOGMIB.Clogserverconfigtable)}
    ...
    class Clogbasic(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSYSLOGMIB.Clogbasic, ['clogmaxseverity', 'clogmsgdrops', 'clogmsgignores', 'clognotificationsenabled', 'clognotificationssent', 'clogoriginid', 'clogoriginidtype'], name, value)
    ...
    class Cloghistory(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSYSLOGMIB.Cloghistory, ['cloghistmsgsflushed', 'cloghisttablemaxlength'], name, value)
    ...
    class Cloghistorytable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"clogHistoryEntry" : ("cloghistoryentry", CISCOSYSLOGMIB.Cloghistorytable.Cloghistoryentry)}
        ...
        class Cloghistoryentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "clogHistoryEntry" + "[clogHistIndex='" + self.cloghistindex.get() + "']"
                self._absolute_path = lambda: "CISCO-SYSLOG-MIB:CISCO-SYSLOG-MIB/clogHistoryTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSYSLOGMIB.Cloghistorytable.Cloghistoryentry, ['cloghistindex', 'cloghistfacility', 'cloghistmsgname', 'cloghistmsgtext', 'cloghistseverity', 'cloghisttimestamp'], name, value)
    ...
    class Clogserverconfigtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"clogServerConfigEntry" : ("clogserverconfigentry", CISCOSYSLOGMIB.Clogserverconfigtable.Clogserverconfigentry)}
        ...
        class Clogserverconfigentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "clogServerConfigEntry" + "[clogServerAddrType='" + self.clogserveraddrtype.get() + "']" + "[clogServerAddr='" + self.clogserveraddr.get() + "']"
