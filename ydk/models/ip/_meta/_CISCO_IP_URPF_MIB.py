...
_meta_table = {
    'UnicastRpfType_Enum' : _MetaInfoEnum('UnicastRpfType_Enum', 'ydk.models.ip.CISCO_IP_URPF_MIB',
        {
            'strict':'STRICT',
            'loose':'LOOSE',
            'disabled':'DISABLED',
        }, 'CISCO-IP-URPF-MIB', _yang_ns._namespaces['CISCO-IP-URPF-MIB']),
    'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry.CipUrpfIfCheckStrict_Enum' : _MetaInfoEnum('CipUrpfIfCheckStrict_Enum', 'ydk.models.ip.CISCO_IP_URPF_MIB',
        {
            'strict':'STRICT',
            'loose':'LOOSE',
        }, 'CISCO-IP-URPF-MIB', _yang_ns._namespaces['CISCO-IP-URPF-MIB']),
    'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry.CipUrpfIfIpVersion_Enum' : _MetaInfoEnum('CipUrpfIfIpVersion_Enum', 'ydk.models.ip.CISCO_IP_URPF_MIB',
        {
            'ipv4':'IPV4',
            'ipv6':'IPV6',
        }, 'CISCO-IP-URPF-MIB', _yang_ns._namespaces['CISCO-IP-URPF-MIB']),
    'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry.CipUrpfIfWhichRouteTableID_Enum' : _MetaInfoEnum('CipUrpfIfWhichRouteTableID_Enum', 'ydk.models.ip.CISCO_IP_URPF_MIB',
        {
            'default':'DEFAULT',
            'vrf':'VRF',
        }, 'CISCO-IP-URPF-MIB', _yang_ns._namespaces['CISCO-IP-URPF-MIB']),
    'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry',
            False, 
            [
            _MetaInfoClassMember('cipUrpfIfIpVersion', REFERENCE_ENUM_CLASS, 'CipUrpfIfIpVersion_Enum' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry.CipUrpfIfIpVersion_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ifIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'ifindex',
                'CISCO-IP-URPF-MIB', True),
            _MetaInfoClassMember('cipUrpfIfCheckStrict', REFERENCE_ENUM_CLASS, 'CipUrpfIfCheckStrict_Enum' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry.CipUrpfIfCheckStrict_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cipUrpfIfVrfName', ATTRIBUTE, 'str' , None, None, 
                ...
                'cipurpfifvrfname',
                'CISCO-IP-URPF-MIB', False),
            _MetaInfoClassMember('cipUrpfIfWhichRouteTableID', REFERENCE_ENUM_CLASS, 'CipUrpfIfWhichRouteTableID_Enum' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry.CipUrpfIfWhichRouteTableID_Enum', 
                [], [], 
        ...
        'ydk.models.ip.CISCO_IP_URPF_MIB'
        ),
    },
    'CISCOIPURPFMIB.CipUrpfIfMonTable' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB.CipUrpfIfMonTable',
            False, 
            [
            _MetaInfoClassMember('cipUrpfIfMonEntry', REFERENCE_LIST, 'CipUrpfIfMonEntry' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfIfMonTable.CipUrpfIfMonEntry', 
                [], [], 
    ...
    'CISCOIPURPFMIB.CipUrpfTable.CipUrpfEntry.CipUrpfIpVersion_Enum' : _MetaInfoEnum('CipUrpfIpVersion_Enum', 'ydk.models.ip.CISCO_IP_URPF_MIB',
        {
            'ipv4':'IPV4',
            'ipv6':'IPV6',
        }, 'CISCO-IP-URPF-MIB', _yang_ns._namespaces['CISCO-IP-URPF-MIB']),
    'CISCOIPURPFMIB.CipUrpfTable.CipUrpfEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB.CipUrpfTable.CipUrpfEntry',
            False, 
            [
            _MetaInfoClassMember('cipUrpfIpVersion', REFERENCE_ENUM_CLASS, 'CipUrpfIpVersion_Enum' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfTable.CipUrpfEntry.CipUrpfIpVersion_Enum', 
                [], [], 
                '''                Specifies the version of IP forwarding on an interface
                to which the table row URPF counts, rates, and
                configuration apply.
    ...
    'CISCOIPURPFMIB.CipUrpfTable' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB.CipUrpfTable',
            False, 
            [
            _MetaInfoClassMember('cipUrpfEntry', REFERENCE_LIST, 'CipUrpfEntry' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfTable.CipUrpfEntry', 
                [], [], 
    ...
    'CISCOIPURPFMIB.CipUrpfVrfIfTable' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB.CipUrpfVrfIfTable',
            False, 
            [
            _MetaInfoClassMember('cipUrpfVrfIfEntry', REFERENCE_LIST, 'CipUrpfVrfIfEntry' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfVrfIfTable.CipUrpfVrfIfEntry', 
                [], [], 
    ...
    'CISCOIPURPFMIB.CipUrpfVrfTable' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB.CipUrpfVrfTable',
            False, 
            [
            _MetaInfoClassMember('cipUrpfVrfEntry', REFERENCE_LIST, 'CipUrpfVrfEntry' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfVrfTable.CipUrpfVrfEntry', 
                [], [], 
    ...
    'CISCOIPURPFMIB' : {
        'meta_info' : _MetaInfoClass('CISCOIPURPFMIB',
            False, 
            [
            _MetaInfoClassMember('cipUrpfIfMonTable', REFERENCE_CLASS, 'CipUrpfIfMonTable' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfIfMonTable', 
                [], [], 
                ...
                'cipurpfifmontable',
                'CISCO-IP-URPF-MIB', False),
            _MetaInfoClassMember('cipUrpfScalar', REFERENCE_CLASS, 'CipUrpfScalar' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfScalar', 
                [], [], 
                '''                ''',
                'cipurpfscalar',
                'CISCO-IP-URPF-MIB', False),
            _MetaInfoClassMember('cipUrpfTable', REFERENCE_CLASS, 'CipUrpfTable' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfTable', 
                [], [], 
                ...
                'cipurpftable',
                'CISCO-IP-URPF-MIB', False),
            _MetaInfoClassMember('cipUrpfVrfIfTable', REFERENCE_CLASS, 'CipUrpfVrfIfTable' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfVrfIfTable', 
                [], [], 
                ...
                'cipurpfvrfiftable',
                'CISCO-IP-URPF-MIB', False),
            _MetaInfoClassMember('cipUrpfVrfTable', REFERENCE_CLASS, 'CipUrpfVrfTable' , 'ydk.models.ip.CISCO_IP_URPF_MIB', 'CISCOIPURPFMIB.CipUrpfVrfTable', 
                [], [], 
