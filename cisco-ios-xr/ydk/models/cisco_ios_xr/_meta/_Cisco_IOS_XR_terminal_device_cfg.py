...
_meta_table = {
    ...
    'LogicalAdminStateEnum' : _MetaInfoEnum('LogicalAdminStateEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg',
        {
            'enable':'enable',
            'disable':'disable',
    ...
    'LogicalChannels.Channel.LogicalChannelAssignments.LogicalChannelAssignment' : {
        'meta_info' : _MetaInfoClass('LogicalChannels.Channel.LogicalChannelAssignments.LogicalChannelAssignment',
            ...
            'Cisco-IOS-XR-terminal-device-cfg',
            'logical-channel-assignment',
            _yang_ns._namespaces['Cisco-IOS-XR-terminal-device-cfg'],
        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg'
        ),
    },
    'LogicalChannels.Channel.LogicalChannelAssignments' : {
        'meta_info' : _MetaInfoClass('LogicalChannels.Channel.LogicalChannelAssignments',
            False, 
            [
            _MetaInfoClassMember('logical-channel-assignment', REFERENCE_LIST, 'LogicalChannelAssignment' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalChannels.Channel.LogicalChannelAssignments.LogicalChannelAssignment', 
                [], [], 
    ...
    'LogicalChannels.Channel.Otn' : {
        'meta_info' : _MetaInfoClass('LogicalChannels.Channel.Otn',
            False, 
            [
            _MetaInfoClassMember('tti-msg-auto', REFERENCE_ENUM_CLASS, 'LogicalChannelOtnTtiAutoEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalChannelOtnTtiAutoEnum', 
                [], [], 
    ...
    'LogicalChannels.Channel' : {
        'meta_info' : _MetaInfoClass('LogicalChannels.Channel',
            ...
            _MetaInfoClassMember('channel-index', ATTRIBUTE, 'int' , None, None, 
                ...
                'channel_index',
                'Cisco-IOS-XR-terminal-device-cfg', True),
            _MetaInfoClassMember('admin-state', REFERENCE_ENUM_CLASS, 'LogicalAdminStateEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalAdminStateEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('ingress-physical-channel', ATTRIBUTE, 'int' , None, None, 
                ...
                'Cisco-IOS-XR-terminal-device-cfg', False),
            _MetaInfoClassMember('logical-channel-assignments', REFERENCE_CLASS, 'LogicalChannelAssignments' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalChannels.Channel.LogicalChannelAssignments', 
                [], [], 
                '''                Logical channel assignment for logical channel
                ''',
                'logical_channel_assignments',
                'Cisco-IOS-XR-terminal-device-cfg', False),
            _MetaInfoClassMember('logical-channel-type', REFERENCE_ENUM_CLASS, 'LogicalProtocolEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalProtocolEnum', 
                [], [], 
                '''                Configure the logical-channel-type 
                ''',
                'logical_channel_type',
                'Cisco-IOS-XR-terminal-device-cfg', False),
            _MetaInfoClassMember('loopback-mode', REFERENCE_ENUM_CLASS, 'LogicalLoopbackModeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalLoopbackModeEnum', 
                [], [], 
                '''                Configure the loopback mode 
                ''',
                'loopback_mode',
                'Cisco-IOS-XR-terminal-device-cfg', False),
            _MetaInfoClassMember('otn', REFERENCE_CLASS, 'Otn' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalChannels.Channel.Otn', 
                [], [], 
                '''                Otn Related configs for Logical channel
                ''',
                'otn',
                'Cisco-IOS-XR-terminal-device-cfg', False),
            _MetaInfoClassMember('rate-class', REFERENCE_ENUM_CLASS, 'LogicalTribRateEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalTribRateEnum', 
                [], [], 
                '''                Rounded bit rate of the tributary signal
                ''',
                'rate_class',
                'Cisco-IOS-XR-terminal-device-cfg', False),
            _MetaInfoClassMember('trib-protocol', REFERENCE_ENUM_CLASS, 'LogicalTribProtocolEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalTribProtocolEnum', 
                [], [], 
    ...
    'LogicalChannels' : {
        'meta_info' : _MetaInfoClass('LogicalChannels',
            False, 
            [
            _MetaInfoClassMember('channel', REFERENCE_LIST, 'Channel' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'LogicalChannels.Channel', 
                [], [], 
                '''                Logical channel index
                ''',
                'channel',
    ...
    'OpticalChannels' : {
        'meta_info' : _MetaInfoClass('OpticalChannels',
            False, 
            [
            _MetaInfoClassMember('optical-channel', REFERENCE_LIST, 'OpticalChannel' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_terminal_device_cfg', 'OpticalChannels.OpticalChannel', 
                [], [], 
