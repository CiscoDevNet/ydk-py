...
class NetFlow(Entity):
    ...
    class Statistics(Entity):
        ...
        class Statistic(Entity):
                ...
                class Statistics(Entity):
                    ...
                    def has_operation(self):
                        return (
                            ...
                            self.ethernet_pkts.yfilter != YFilter.not_set or
                    ...
                    def get_entity_path(self, ancestor):
                        ...
                        if (self.ethernet_pkts.is_set or self.ethernet_pkts.yfilter != YFilter.not_set):
                            leaf_name_data.append(self.ethernet_pkts.get_name_leafdata())
                    ...
                    def has_leaf_or_child_of_name(self, name):
                        if(name == "drops-no-space" or name == "drops-others" or name == "ethernet-pkts" or name == "flow-packet-counts" or name == "last-cleared" or name == "spp-rx-counts" or name == "unknown-ingress-flows" or name == "waiting-servers"):
                            return True
                        return False
                    ...
                    def set_value(self, value_path, value, name_space, name_space_prefix):
                        ...
                        if(value_path == "ethernet-pkts"):
                            self.ethernet_pkts = value
                            self.ethernet_pkts.value_namespace = name_space
                            self.ethernet_pkts.value_namespace_prefix = name_space_prefix
            ...
            def get_entity_path(self, ancestor):
                path_buffer = ""
                if (ancestor is None):
                    path_buffer = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/%s" % self.get_segment_path()
                else:
                    path_buffer = _get_relative_entity_path(self, ancestor, path_buffer)
        ...
        def get_entity_path(self, ancestor):
            path_buffer = ""
            if (ancestor is None):
                path_buffer = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/%s" % self.get_segment_path()
            else:
                path_buffer = _get_relative_entity_path(self, ancestor, path_buffer)
    ...
    def get_segment_path(self):
        path_buffer = ""
        path_buffer = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow" + path_buffer
