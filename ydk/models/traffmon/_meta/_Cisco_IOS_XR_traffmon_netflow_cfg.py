...
_meta_table = {
    ...
    'NetFlow.FlowExporterMaps.FlowExporterMap.Versions' : {
        'meta_info' : _MetaInfoClass('NetFlow.FlowExporterMaps.FlowExporterMap.Versions',
            False, 
            [
            _MetaInfoClassMember('version', REFERENCE_LIST, 'Version' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowExporterMaps.FlowExporterMap.Versions.Version', 
                [], [], 
    ...
    'NetFlow.FlowExporterMaps.FlowExporterMap' : {
        'meta_info' : _MetaInfoClass('NetFlow.FlowExporterMaps.FlowExporterMap',
            ...
            _MetaInfoClassMember('udp', REFERENCE_CLASS, 'Udp' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowExporterMaps.FlowExporterMap.Udp', 
                ...
                'udp',
                'Cisco-IOS-XR-traffmon-netflow-cfg', False),
            _MetaInfoClassMember('versions', REFERENCE_CLASS, 'Versions' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowExporterMaps.FlowExporterMap.Versions', 
                [], [], 
    ...
    'NetFlow.FlowExporterMaps' : {
        'meta_info' : _MetaInfoClass('NetFlow.FlowExporterMaps',
            False, 
            [
            _MetaInfoClassMember('flow-exporter-map', REFERENCE_LIST, 'FlowExporterMap' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowExporterMaps.FlowExporterMap', 
                [], [], 
                '''                Exporter map name
                ''',
                'flow_exporter_map',
    ...
    'NetFlow.FlowSamplerMaps.FlowSamplerMap.SamplingModes' : {
        'meta_info' : _MetaInfoClass('NetFlow.FlowSamplerMaps.FlowSamplerMap.SamplingModes',
            False, 
            [
            _MetaInfoClassMember('sampling-mode', REFERENCE_LIST, 'SamplingMode' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowSamplerMaps.FlowSamplerMap.SamplingModes.SamplingMode', 
                [], [], 
    ...
    'NetFlow.FlowSamplerMaps.FlowSamplerMap' : {
        'meta_info' : _MetaInfoClass('NetFlow.FlowSamplerMaps.FlowSamplerMap',
            ...
            _MetaInfoClassMember('sampler-map-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'sampler_map_name',
                'Cisco-IOS-XR-traffmon-netflow-cfg', True),
            _MetaInfoClassMember('sampling-modes', REFERENCE_CLASS, 'SamplingModes' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowSamplerMaps.FlowSamplerMap.SamplingModes', 
                [], [], 
    ...
    'NetFlow.FlowSamplerMaps' : {
        'meta_info' : _MetaInfoClass('NetFlow.FlowSamplerMaps',
            False, 
            [
            _MetaInfoClassMember('flow-sampler-map', REFERENCE_LIST, 'FlowSamplerMap' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowSamplerMaps.FlowSamplerMap', 
                [], [], 
                '''                Sampler map name
                ''',
                'flow_sampler_map',
    ...
    'NetFlow' : {
        'meta_info' : _MetaInfoClass('NetFlow',
            False, 
            [
            _MetaInfoClassMember('flow-exporter-maps', REFERENCE_CLASS, 'FlowExporterMaps' , 'ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg', 'NetFlow.FlowExporterMaps', 
                [], [], 
