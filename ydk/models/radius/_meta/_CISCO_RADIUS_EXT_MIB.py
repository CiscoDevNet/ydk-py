...
_meta_table = {
    'CISCORADIUSEXTMIB.CreClientAccounting' : {
        ...
        'ydk.models.radius.CISCO_RADIUS_EXT_MIB'
        ),
    },
    ...
    'CISCORADIUSEXTMIB' : {
        'meta_info' : _MetaInfoClass('CISCORADIUSEXTMIB',
            False, 
            [
            _MetaInfoClassMember('creClientAccounting', REFERENCE_CLASS, 'CreClientAccounting' , 'ydk.models.radius.CISCO_RADIUS_EXT_MIB', 'CISCORADIUSEXTMIB.CreClientAccounting', 
                [], [], 
                '''                ''',
                'creclientaccounting',
                'CISCO-RADIUS-EXT-MIB', False),
            _MetaInfoClassMember('creClientAuthentication', REFERENCE_CLASS, 'CreClientAuthentication' , 'ydk.models.radius.CISCO_RADIUS_EXT_MIB', 'CISCORADIUSEXTMIB.CreClientAuthentication', 
                [], [], 
                '''                ''',
                'creclientauthentication',
                'CISCO-RADIUS-EXT-MIB', False),
            _MetaInfoClassMember('creClientGlobal', REFERENCE_CLASS, 'CreClientGlobal' , 'ydk.models.radius.CISCO_RADIUS_EXT_MIB', 'CISCORADIUSEXTMIB.CreClientGlobal', 
                [], [], 
                '''                ''',
                'creclientglobal',
                'CISCO-RADIUS-EXT-MIB', False),
