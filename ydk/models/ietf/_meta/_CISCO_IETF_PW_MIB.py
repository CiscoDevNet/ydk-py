...
_meta_table = {
    'CISCOIETFPWMIB.CpwVcIdMappingTable.CpwVcIdMappingEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcIdMappingTable.CpwVcIdMappingEntry',
            ...
            _MetaInfoClassMember('cpwVcIdMappingPeerAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                IP address type of the peer node.
                ''',
            ...
            _MetaInfoClassMember('cpwVcIdMappingVcIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-MIB', True),
            _MetaInfoClassMember('cpwVcIdMappingVcType', REFERENCE_ENUM_CLASS, 'CpwVcType_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TC_MIB', 'CpwVcType_Enum', 
                [], [], 
        ...
        'ydk.models.ietf.CISCO_IETF_PW_MIB'
        ),
    },
    'CISCOIETFPWMIB.CpwVcIdMappingTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcIdMappingTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcIdMappingEntry', REFERENCE_LIST, 'CpwVcIdMappingEntry' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcIdMappingTable.CpwVcIdMappingEntry', 
                [], [], 
    ...
    'CISCOIETFPWMIB.CpwVcPeerMappingTable.CpwVcPeerMappingEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcPeerMappingTable.CpwVcPeerMappingEntry',
            ...
            _MetaInfoClassMember('cpwVcPeerMappingPeerAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-IETF-PW-MIB', True),
            _MetaInfoClassMember('cpwVcPeerMappingPeerAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                IP address type of the peer node.
                ''',
            ...
            _MetaInfoClassMember('cpwVcPeerMappingVcIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-MIB', True),
            _MetaInfoClassMember('cpwVcPeerMappingVcType', REFERENCE_ENUM_CLASS, 'CpwVcType_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TC_MIB', 'CpwVcType_Enum', 
                [], [], 
                '''                The VC type (indicate the service) of this VC.
                ''',
    ...
    'CISCOIETFPWMIB.CpwVcPeerMappingTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcPeerMappingTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcPeerMappingEntry', REFERENCE_LIST, 'CpwVcPeerMappingEntry' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPeerMappingTable.CpwVcPeerMappingEntry', 
                [], [], 
                '''                An entry in this table is created by the agent for every  
    ...
    'CISCOIETFPWMIB.CpwVcPerfCurrentTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcPerfCurrentTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcPerfCurrentEntry', REFERENCE_LIST, 'CpwVcPerfCurrentEntry' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPerfCurrentTable.CpwVcPerfCurrentEntry', 
                [], [], 
    ...
    'CISCOIETFPWMIB.CpwVcPerfIntervalTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcPerfIntervalTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcPerfIntervalEntry', REFERENCE_LIST, 'CpwVcPerfIntervalEntry' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPerfIntervalTable.CpwVcPerfIntervalEntry', 
                [], [], 
    ...
    'CISCOIETFPWMIB.CpwVcPerfTotalTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcPerfTotalTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcPerfTotalEntry', REFERENCE_LIST, 'CpwVcPerfTotalEntry' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPerfTotalTable.CpwVcPerfTotalEntry', 
                [], [], 
                '''                An entry in this table is created agent for every VC.
                ''',
                'cpwvcperftotalentry',
    ...
    'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcAdminStatus_Enum' : _MetaInfoEnum('CpwVcAdminStatus_Enum', 'ydk.models.ietf.CISCO_IETF_PW_MIB',
        {
            'up':'UP',
            'down':'DOWN',
            'testing':'TESTING',
        }, 'CISCO-IETF-PW-MIB', _yang_ns._namespaces['CISCO-IETF-PW-MIB']),
    'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcInboundMode_Enum' : _MetaInfoEnum('CpwVcInboundMode_Enum', 'ydk.models.ietf.CISCO_IETF_PW_MIB',
        {
            'loose':'LOOSE',
            'strict':'STRICT',
        }, 'CISCO-IETF-PW-MIB', _yang_ns._namespaces['CISCO-IETF-PW-MIB']),
    'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcOwner_Enum' : _MetaInfoEnum('CpwVcOwner_Enum', 'ydk.models.ietf.CISCO_IETF_PW_MIB',
        {
            'manual':'MANUAL',
            'maintenanceProtocol':'MAINTENANCEPROTOCOL',
            'other':'OTHER',
        }, 'CISCO-IETF-PW-MIB', _yang_ns._namespaces['CISCO-IETF-PW-MIB']),
    'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcPsnType_Enum' : _MetaInfoEnum('CpwVcPsnType_Enum', 'ydk.models.ietf.CISCO_IETF_PW_MIB',
        {
            'mpls':'MPLS',
            'l2tp':'L2TP',
            'ip':'IP',
    ...
    'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcRemoteControlWord_Enum' : _MetaInfoEnum('CpwVcRemoteControlWord_Enum', 'ydk.models.ietf.CISCO_IETF_PW_MIB',
        {
    ...
    'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcTable.CpwVcEntry',
            ...
            _MetaInfoClassMember('cpwVcIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cpwvcindex',
                'CISCO-IETF-PW-MIB', True),
            _MetaInfoClassMember('cpwVcAdminStatus', REFERENCE_ENUM_CLASS, 'CpwVcAdminStatus_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwVcID', ATTRIBUTE, 'int' , None, None, 
                ...
                'cpwvcid',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcInboundMode', REFERENCE_ENUM_CLASS, 'CpwVcInboundMode_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcInboundMode_Enum', 
                [], [], 
                ...
                'cpwvcinboundmode',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcInboundOperStatus', REFERENCE_ENUM_CLASS, 'CpwOperStatus_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TC_MIB', 'CpwOperStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwVcName', ATTRIBUTE, 'str' , None, None, 
                ...
                'cpwvcname',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcOperStatus', REFERENCE_ENUM_CLASS, 'CpwOperStatus_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TC_MIB', 'CpwOperStatus_Enum', 
                [], [], 
                ...
                'cpwvcoperstatus',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcOutboundOperStatus', REFERENCE_ENUM_CLASS, 'CpwOperStatus_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TC_MIB', 'CpwOperStatus_Enum', 
                [], [], 
                '''                Indicates the actual operational status of this VC in the  
                outbound direction 
                - down:           if PW signaling has not yet finished, or 
            ...
            _MetaInfoClassMember('cpwVcOutboundVcLabel', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcOwner', REFERENCE_ENUM_CLASS, 'CpwVcOwner_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcOwner_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwVcPeerAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'cpwvcpeeraddr',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcPeerAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                ...
                'cpwvcpeeraddrtype',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcPsnType', REFERENCE_ENUM_CLASS, 'CpwVcPsnType_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcPsnType_Enum', 
                [], [], 
                ...
                'cpwvcpsntype',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcRemoteControlWord', REFERENCE_ENUM_CLASS, 'CpwVcRemoteControlWord_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry.CpwVcRemoteControlWord_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwVcRemoteIfString', ATTRIBUTE, 'str' , None, None, 
                ...
                'cpwvcremoteifstring',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwVcSetUpPriority', ATTRIBUTE, 'int' , None, None, 
                ...
                'cpwvcsetuppriority',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcStorageType', REFERENCE_ENUM_CLASS, 'StorageType_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'StorageType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwVcTimeElapsed', ATTRIBUTE, 'int' , None, None, 
                ...
                'cpwvctimeelapsed',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcType', REFERENCE_ENUM_CLASS, 'CpwVcType_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_TC_MIB', 'CpwVcType_Enum', 
                [], [], 
    ...
    'CISCOIETFPWMIB.CpwVcTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB.CpwVcTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcEntry', REFERENCE_LIST, 'CpwVcEntry' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable.CpwVcEntry', 
                [], [], 
    ...
    'CISCOIETFPWMIB' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWMIB',
            False, 
            [
            _MetaInfoClassMember('cpwVcIdMappingTable', REFERENCE_CLASS, 'CpwVcIdMappingTable' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcIdMappingTable', 
                [], [], 
                ...
                'cpwvcidmappingtable',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcObjects', REFERENCE_CLASS, 'CpwVcObjects' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcObjects', 
                [], [], 
                '''                ''',
                'cpwvcobjects',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcPeerMappingTable', REFERENCE_CLASS, 'CpwVcPeerMappingTable' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPeerMappingTable', 
                [], [], 
                '''                This table provides reverse mapping of the existing VCs  
                based on vc type and VC ID ordering. This table is  
                typically useful for EMS ordered query of existing VCs.
                ...
                'cpwvcpeermappingtable',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcPerfCurrentTable', REFERENCE_CLASS, 'CpwVcPerfCurrentTable' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPerfCurrentTable', 
                [], [], 
                ...
                'cpwvcperfcurrenttable',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcPerfIntervalTable', REFERENCE_CLASS, 'CpwVcPerfIntervalTable' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPerfIntervalTable', 
                [], [], 
                ...
                'cpwvcperfintervaltable',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcPerfTotalTable', REFERENCE_CLASS, 'CpwVcPerfTotalTable' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcPerfTotalTable', 
                [], [], 
                ...
                'cpwvcperftotaltable',
                'CISCO-IETF-PW-MIB', False),
            _MetaInfoClassMember('cpwVcTable', REFERENCE_CLASS, 'CpwVcTable' , 'ydk.models.ietf.CISCO_IETF_PW_MIB', 'CISCOIETFPWMIB.CpwVcTable', 
                [], [], 
