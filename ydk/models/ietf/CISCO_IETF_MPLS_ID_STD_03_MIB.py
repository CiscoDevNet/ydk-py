...
class CISCOIETFMPLSIDSTD03MIB(object):
    ...
    .. attribute:: cmplsidobjects
    	...
    	**type**\: :py:class:`CmplsIdObjects <ydk.models.ietf.CISCO_IETF_MPLS_ID_STD_03_MIB.CISCOIETFMPLSIDSTD03MIB.CmplsIdObjects>`
    ...
    class CmplsIdObjects(object):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.ietf._meta import _CISCO_IETF_MPLS_ID_STD_03_MIB as meta
    ...
    def _has_data(self):
        ...
        if self.cmplsidobjects is not None and self.cmplsidobjects.is_presence():
            return True
