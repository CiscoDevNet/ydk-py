...
class CISCOIETFPWMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cpwVcIdMappingTable" : ("cpwvcidmappingtable", CISCOIETFPWMIB.Cpwvcidmappingtable), "cpwVcObjects" : ("cpwvcobjects", CISCOIETFPWMIB.Cpwvcobjects), "cpwVcPeerMappingTable" : ("cpwvcpeermappingtable", CISCOIETFPWMIB.Cpwvcpeermappingtable), "cpwVcPerfCurrentTable" : ("cpwvcperfcurrenttable", CISCOIETFPWMIB.Cpwvcperfcurrenttable), "cpwVcPerfIntervalTable" : ("cpwvcperfintervaltable", CISCOIETFPWMIB.Cpwvcperfintervaltable), "cpwVcPerfTotalTable" : ("cpwvcperftotaltable", CISCOIETFPWMIB.Cpwvcperftotaltable), "cpwVcTable" : ("cpwvctable", CISCOIETFPWMIB.Cpwvctable)}
    ...
    class Cpwvcobjects(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOIETFPWMIB.Cpwvcobjects, ['cpwvcindexnext', 'cpwvcnotifrate', 'cpwvcperftotalerrorpackets', 'cpwvcupdownnotifenable'], name, value)
    ...
    class Cpwvcperfcurrenttable(Entity):
        ...
        class Cpwvcperfcurrententry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFPWMIB.Cpwvcperfcurrenttable.Cpwvcperfcurrententry, ['cpwvcindex', 'cpwvcperfcurrentinhcbytes', 'cpwvcperfcurrentinhcpackets', 'cpwvcperfcurrentouthcbytes', 'cpwvcperfcurrentouthcpackets'], name, value)
    ...
    class Cpwvcperfintervaltable(Entity):
        ...
        class Cpwvcperfintervalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFPWMIB.Cpwvcperfintervaltable.Cpwvcperfintervalentry, ['cpwvcindex', 'cpwvcperfintervalnumber', 'cpwvcperfintervalinhcbytes', 'cpwvcperfintervalinhcpackets', 'cpwvcperfintervalouthcbytes', 'cpwvcperfintervalouthcpackets', 'cpwvcperfintervaltimeelapsed', 'cpwvcperfintervalvaliddata'], name, value)
    ...
    class Cpwvcperftotaltable(Entity):
        ...
        class Cpwvcperftotalentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFPWMIB.Cpwvcperftotaltable.Cpwvcperftotalentry, ['cpwvcindex', 'cpwvcperftotaldiscontinuitytime', 'cpwvcperftotalinhcbytes', 'cpwvcperftotalinhcpackets', 'cpwvcperftotalouthcbytes', 'cpwvcperftotalouthcpackets'], name, value)
    ...
    class Cpwvctable(Entity):
        ...
        class Cpwvcentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOIETFPWMIB.Cpwvctable.Cpwvcentry, ['cpwvcindex', 'cpwvcadminstatus', 'cpwvccontrolword', 'cpwvccreatetime', 'cpwvcdescr', 'cpwvcholdingpriority', 'cpwvcid', 'cpwvcinboundmode', 'cpwvcinboundoperstatus', 'cpwvcinboundvclabel', 'cpwvclocalgroupid', 'cpwvclocalifmtu', 'cpwvclocalifstring', 'cpwvcname', 'cpwvcoperstatus', 'cpwvcoutboundoperstatus', 'cpwvcoutboundvclabel', 'cpwvcowner', 'cpwvcpeeraddr', 'cpwvcpeeraddrtype', 'cpwvcpsntype', 'cpwvcremotecontrolword', 'cpwvcremotegroupid', 'cpwvcremoteifmtu', 'cpwvcremoteifstring', 'cpwvcrowstatus', 'cpwvcsetuppriority', 'cpwvcstoragetype', 'cpwvctimeelapsed', 'cpwvctype', 'cpwvcuptime', 'cpwvcvalidintervals'], name, value)
