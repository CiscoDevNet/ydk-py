...
class SNMPTARGETMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"snmpTargetAddrTable" : ("snmptargetaddrtable", SNMPTARGETMIB.Snmptargetaddrtable), "snmpTargetObjects" : ("snmptargetobjects", SNMPTARGETMIB.Snmptargetobjects), "snmpTargetParamsTable" : ("snmptargetparamstable", SNMPTARGETMIB.Snmptargetparamstable)}
    ...
    class Snmptargetaddrtable(Entity):
        ...
        class Snmptargetaddrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(SNMPTARGETMIB.Snmptargetaddrtable.Snmptargetaddrentry, ['snmptargetaddrname', 'snmptargetaddrparams', 'snmptargetaddrretrycount', 'snmptargetaddrrowstatus', 'snmptargetaddrstoragetype', 'snmptargetaddrtaddress', 'snmptargetaddrtaglist', 'snmptargetaddrtdomain', 'snmptargetaddrtimeout'], name, value)
    ...
    class Snmptargetparamstable(Entity):
        ...
        class Snmptargetparamsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(SNMPTARGETMIB.Snmptargetparamstable.Snmptargetparamsentry, ['snmptargetparamsname', 'snmptargetparamsmpmodel', 'snmptargetparamsrowstatus', 'snmptargetparamssecuritylevel', 'snmptargetparamssecuritymodel', 'snmptargetparamssecurityname', 'snmptargetparamsstoragetype'], name, value)
