...
class EtherLikeMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"dot3CollTable" : ("dot3colltable", EtherLikeMIB.Dot3Colltable), "dot3ControlTable" : ("dot3controltable", EtherLikeMIB.Dot3Controltable), "dot3HCStatsTable" : ("dot3hcstatstable", EtherLikeMIB.Dot3Hcstatstable), "dot3PauseTable" : ("dot3pausetable", EtherLikeMIB.Dot3Pausetable), "dot3StatsTable" : ("dot3statstable", EtherLikeMIB.Dot3Statstable)}
    ...
    class Dot3Colltable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot3CollEntry" : ("dot3collentry", EtherLikeMIB.Dot3Colltable.Dot3Collentry)}
        ...
        class Dot3Collentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot3CollEntry" + "[ifIndex='" + self.ifindex.get() + "']" + "[dot3CollCount='" + self.dot3collcount.get() + "']"
    ...
    class Dot3Controltable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot3ControlEntry" : ("dot3controlentry", EtherLikeMIB.Dot3Controltable.Dot3Controlentry)}
        ...
        class Dot3Controlentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot3ControlEntry" + "[dot3StatsIndex='" + self.dot3statsindex.get() + "']"
    ...
    class Dot3Hcstatstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot3HCStatsEntry" : ("dot3hcstatsentry", EtherLikeMIB.Dot3Hcstatstable.Dot3Hcstatsentry)}
        ...
        class Dot3Hcstatsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot3HCStatsEntry" + "[dot3StatsIndex='" + self.dot3statsindex.get() + "']"
                self._absolute_path = lambda: "EtherLike-MIB:EtherLike-MIB/dot3HCStatsTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(EtherLikeMIB.Dot3Hcstatstable.Dot3Hcstatsentry, ['dot3statsindex', 'dot3hcstatsalignmenterrors', 'dot3hcstatsfcserrors', 'dot3hcstatsframetoolongs', 'dot3hcstatsinternalmacreceiveerrors', 'dot3hcstatsinternalmactransmiterrors', 'dot3hcstatssymbolerrors'], name, value)
    ...
    class Dot3Pausetable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot3PauseEntry" : ("dot3pauseentry", EtherLikeMIB.Dot3Pausetable.Dot3Pauseentry)}
        ...
        class Dot3Pauseentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot3PauseEntry" + "[dot3StatsIndex='" + self.dot3statsindex.get() + "']"
                self._absolute_path = lambda: "EtherLike-MIB:EtherLike-MIB/dot3PauseTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(EtherLikeMIB.Dot3Pausetable.Dot3Pauseentry, ['dot3statsindex', 'dot3hcinpauseframes', 'dot3hcoutpauseframes', 'dot3inpauseframes', 'dot3outpauseframes', 'dot3pauseadminmode', 'dot3pauseopermode'], name, value)
    ...
    class Dot3Statstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot3StatsEntry" : ("dot3statsentry", EtherLikeMIB.Dot3Statstable.Dot3Statsentry)}
        ...
        class Dot3Statsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot3StatsEntry" + "[dot3StatsIndex='" + self.dot3statsindex.get() + "']"
                self._absolute_path = lambda: "EtherLike-MIB:EtherLike-MIB/dot3StatsTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(EtherLikeMIB.Dot3Statstable.Dot3Statsentry, ['dot3statsindex', 'dot3statsalignmenterrors', 'dot3statscarriersenseerrors', 'dot3statsdeferredtransmissions', 'dot3statsduplexstatus', 'dot3statsetherchipset', 'dot3statsexcessivecollisions', 'dot3statsfcserrors', 'dot3statsframetoolongs', 'dot3statsinternalmacreceiveerrors', 'dot3statsinternalmactransmiterrors', 'dot3statslatecollisions', 'dot3statsmultiplecollisionframes', 'dot3statsratecontrolability', 'dot3statsratecontrolstatus', 'dot3statssinglecollisionframes', 'dot3statssqetesterrors', 'dot3statssymbolerrors'], name, value)
