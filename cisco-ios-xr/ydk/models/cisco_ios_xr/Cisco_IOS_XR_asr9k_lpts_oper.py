...
class PlatformLptspIfibStatic(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"node-statics" : ("node_statics", PlatformLptspIfibStatic.NodeStatics)}
        self._child_list_classes = {}
    ...
    class NodeStatics(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"node-static" : ("node_static", PlatformLptspIfibStatic.NodeStatics.NodeStatic)}
        ...
        class NodeStatic(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"police" : ("police", PlatformLptspIfibStatic.NodeStatics.NodeStatic.Police), "stats" : ("stats", PlatformLptspIfibStatic.NodeStatics.NodeStatic.Stats)}
                self._child_list_classes = {}
                ...
                self._children_name_map["stats"] = "stats"
                self._children_yang_names.add("stats")
                self._segment_path = lambda: "node-static" + "[node-name='" + self.node_name.get() + "']"
            ...
            class Police(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = True
                    self._child_container_classes = {}
                    self._child_list_classes = {"static-info" : ("static_info", PlatformLptspIfibStatic.NodeStatics.NodeStatic.Police.StaticInfo)}
