        ...
        class Select(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ...
                    ('result_type', (YLeafList(YType.enumeration, 'result-type'), [('ydk.models.cisco_ios_xe.tailf_netconf_query', 'StartQuery', 'Input.Select.ResultType')])),
                ])
                self.label = None
...
class ImmediateQuery(Entity):
    ...
    .. attribute:: input
    	...
    	**type**\:  :py:class:`Input <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Input>`
    
    .. attribute:: output
    
    	
    	**type**\:  :py:class:`Output <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Output>`
    ...
    class Input(Entity):
        ...
        .. attribute:: select
        	...
        	A list of expressions that define what to return from each node in the node set returned by the 'foreach' expression
        	**type**\: list of  		 :py:class:`Select <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Input.Select>`
        ...
        class Select(Entity):
            ...
            .. attribute:: result_type
            	...
            	Controls how the result of the select expression is returned in 'fetch\-query\-result'
            	**type**\: list of   :py:class:`ResultType <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Input.Select.ResultType>`
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ('label', (YLeaf(YType.str, 'label'), ['str'])),
                    ('expression', (YLeaf(YType.str, 'expression'), ['str'])),
                    ('result_type', (YLeafList(YType.enumeration, 'result-type'), [('ydk.models.cisco_ios_xe.tailf_netconf_query', 'ImmediateQuery', 'Input.Select.ResultType')])),
                ])
                self.label = None
                self.expression = None
                self.result_type = []
    ...
    class Output(Entity):
        ...
        .. attribute:: query_result
        	...
        	**type**\:  :py:class:`QueryResult <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Output.QueryResult>`
        ...
        class QueryResult(Entity):
            ...
            .. attribute:: result
            	...
            	There will be one result for each node in the node set produced by evaluating the 'foreach' expression
            	**type**\: list of  		 :py:class:`Result <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Output.QueryResult.Result>`
            ...
            class Result(Entity):
                ...
                .. attribute:: select
                	...
                	**type**\: list of  		 :py:class:`Select <ydk.models.cisco_ios_xe.tailf_netconf_query.ImmediateQuery.Output.QueryResult.Result.Select>`
