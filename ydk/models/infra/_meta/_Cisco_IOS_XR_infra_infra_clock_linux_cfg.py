...
_meta_table = {
    'Clock.TimeZone' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_linux_cfg'
        ),
    },
    'Clock' : {
        'meta_info' : _MetaInfoClass('Clock',
            False, 
            [
            _MetaInfoClassMember('time-zone', REFERENCE_CLASS, 'TimeZone' , 'ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_linux_cfg', 'Clock.TimeZone', 
                [], [], 
                '''                Configure time zone
                ''',
                'time_zone',
