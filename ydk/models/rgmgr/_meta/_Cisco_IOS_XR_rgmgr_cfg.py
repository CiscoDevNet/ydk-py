...
_meta_table = {
    ...
    'RedundancyGroupManager.Aps.DefaultRedundancyGroup' : {
        ...
        'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg'
        ),
    },
    ...
    'RedundancyGroupManager.Aps.Groups.Group.Controllers' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Aps.Groups.Group.Controllers',
            False, 
            [
            _MetaInfoClassMember('controller', REFERENCE_LIST, 'Controller' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Aps.Groups.Group.Controllers.Controller', 
                [], [], 
                '''                none
                ''',
                'controller',
    ...
    'RedundancyGroupManager.Aps.Groups.Group' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Aps.Groups.Group',
            ...
            _MetaInfoClassMember('group-id', ATTRIBUTE, 'int' , None, None, 
                ...
                'group_id',
                'Cisco-IOS-XR-rgmgr-cfg', True),
            _MetaInfoClassMember('controllers', REFERENCE_CLASS, 'Controllers' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Aps.Groups.Group.Controllers', 
                [], [], 
    ...
    'RedundancyGroupManager.Aps.Groups' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Aps.Groups',
            False, 
            [
            _MetaInfoClassMember('group', REFERENCE_LIST, 'Group' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Aps.Groups.Group', 
                [], [], 
    ...
    'RedundancyGroupManager.Aps' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Aps',
            False, 
            [
            _MetaInfoClassMember('default-redundancy-group', REFERENCE_CLASS, 'DefaultRedundancyGroup' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Aps.DefaultRedundancyGroup', 
                [], [], 
                '''                Default SONET controller backup configuration
                ''',
                'default_redundancy_group',
                'Cisco-IOS-XR-rgmgr-cfg', False),
            _MetaInfoClassMember('groups', REFERENCE_CLASS, 'Groups' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Aps.Groups', 
                [], [], 
    ...
    'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Backbones' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Backbones',
            False, 
            [
            _MetaInfoClassMember('backbone', REFERENCE_LIST, 'Backbone' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Backbones.Backbone', 
                [], [], 
    ...
    'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Members' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Members',
            False, 
            [
            _MetaInfoClassMember('member', REFERENCE_LIST, 'Member' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Members.Member', 
                [], [], 
    ...
    'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Iccp.IccpGroups.IccpGroup',
            ...
            _MetaInfoClassMember('group-number', ATTRIBUTE, 'int' , None, None, 
                ...
                'group_number',
                'Cisco-IOS-XR-rgmgr-cfg', True),
            _MetaInfoClassMember('backbones', REFERENCE_CLASS, 'Backbones' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.Backbones', 
                [], [], 
            ...
            _MetaInfoClassMember('mode', REFERENCE_ENUM_CLASS, 'IccpModeEnum' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'IccpModeEnum', 
                ...
                'mode',
                'Cisco-IOS-XR-rgmgr-cfg', False),
            _MetaInfoClassMember('nv-satellite', REFERENCE_CLASS, 'NvSatellite' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup.NvSatellite', 
                [], [], 
    ...
    'RedundancyGroupManager.Iccp.IccpGroups' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Iccp.IccpGroups',
            False, 
            [
            _MetaInfoClassMember('iccp-group', REFERENCE_LIST, 'IccpGroup' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Iccp.IccpGroups.IccpGroup', 
                [], [], 
                '''                Redundancy Group Configuration
                ''',
                'iccp_group',
    ...
    'RedundancyGroupManager.Iccp' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Iccp',
            False, 
            [
            _MetaInfoClassMember('iccp-groups', REFERENCE_CLASS, 'IccpGroups' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Iccp.IccpGroups', 
                [], [], 
    ...
    'RedundancyGroupManager' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager',
            False, 
            [
            _MetaInfoClassMember('aps', REFERENCE_CLASS, 'Aps' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg', 'RedundancyGroupManager.Aps', 
                [], [], 
                '''                MR-APS groups
                ''',
                'aps',
