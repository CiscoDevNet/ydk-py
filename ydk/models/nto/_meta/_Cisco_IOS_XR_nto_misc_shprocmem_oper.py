...
_meta_table = {
    'ProcessesMemory.Nodes.Node.JobIds.JobId' : {
        ...
        'ydk.models.nto.Cisco_IOS_XR_nto_misc_shprocmem_oper'
        ),
    },
    'ProcessesMemory.Nodes.Node.JobIds' : {
        'meta_info' : _MetaInfoClass('ProcessesMemory.Nodes.Node.JobIds',
            False, 
            [
            _MetaInfoClassMember('job-id', REFERENCE_LIST, 'JobId' , 'ydk.models.nto.Cisco_IOS_XR_nto_misc_shprocmem_oper', 'ProcessesMemory.Nodes.Node.JobIds.JobId', 
                [], [], 
                '''                Job Id
                ''',
                'job_id',
    ...
    'ProcessesMemory.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('ProcessesMemory.Nodes.Node',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-nto-misc-shprocmem-oper', True),
            _MetaInfoClassMember('job-ids', REFERENCE_CLASS, 'JobIds' , 'ydk.models.nto.Cisco_IOS_XR_nto_misc_shprocmem_oper', 'ProcessesMemory.Nodes.Node.JobIds', 
                [], [], 
                '''                List of jobs
                ''',
                'job_ids',
    ...
    'ProcessesMemory.Nodes' : {
        'meta_info' : _MetaInfoClass('ProcessesMemory.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.nto.Cisco_IOS_XR_nto_misc_shprocmem_oper', 'ProcessesMemory.Nodes.Node', 
                [], [], 
                '''                Node ID
                ''',
                'node',
    ...
    'ProcessesMemory' : {
        'meta_info' : _MetaInfoClass('ProcessesMemory',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.nto.Cisco_IOS_XR_nto_misc_shprocmem_oper', 'ProcessesMemory.Nodes', 
                [], [], 
                '''                List of nodes
                ''',
                'nodes',
