...
_meta_table = {
    ...
    'Fia.Nodes.Node.DriverInformation.DeviceInfo' : {
        'meta_info' : _MetaInfoClass('Fia.Nodes.Node.DriverInformation.DeviceInfo',
            ...
            _MetaInfoClassMember('is-valid', ATTRIBUTE, 'bool' , None, None, 
                ...
                'is_valid',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('last-hard-reset-timestamp', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
            ...
            _MetaInfoClassMember('last-init-cause', ATTRIBUTE, 'int' , None, None, 
                ...
                'last_init_cause',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('last-pon-reset-timestamp', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
    ...
    'Fia.Nodes.Node.DriverInformation.CardInfo' : {
        'meta_info' : _MetaInfoClass('Fia.Nodes.Node.DriverInformation.CardInfo',
            ...
            _MetaInfoClassMember('card-type', ATTRIBUTE, 'int' , None, None, 
                ...
                'card_type',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('cxp-avail-bitmap', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                cxp avail bitmap
                ''',
                'cxp_avail_bitmap',
    ...
    'Fia.Nodes.Node.DriverInformation' : {
        'meta_info' : _MetaInfoClass('Fia.Nodes.Node.DriverInformation',
            False, 
            [
            _MetaInfoClassMember('asic-avail-mask', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                asic avail mask
                ''',
                'asic_avail_mask',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('asic-oper-notify-to-fsdb-pending-bmap', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
            ...
            _MetaInfoClassMember('drv-version', ATTRIBUTE, 'int' , None, None, 
                ...
                'drv_version',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('drvr-startup-timestamp', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                drvr startup timestamp
                ''',
                'drvr_startup_timestamp',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('exp-asic-avail-mask', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                exp asic avail mask
                ''',
                'exp_asic_avail_mask',
            ...
            _MetaInfoClassMember('num-pm-conn-reqs', ATTRIBUTE, 'int' , None, None, 
                ...
                'num_pm_conn_reqs',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('offset-time-nsec', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                offset time nsec
                ''',
                'offset_time_nsec',
    ...
    'Fia.Nodes.Node.AsicStatistics.StatisticsAsicInstances.StatisticsAsicInstance.PbcStatistics.PbcStats.StatsInfo.BlockInfo.FieldInfo' : {
        'meta_info' : _MetaInfoClass('Fia.Nodes.Node.AsicStatistics.StatisticsAsicInstances.StatisticsAsicInstance.PbcStatistics.PbcStats.StatsInfo.BlockInfo.FieldInfo',
            ...
            _MetaInfoClassMember('field-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'field_name',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('field-value', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                Field Value
                ''',
                'field_value',
    ...
    'Fia.Nodes.Node.AsicStatistics.StatisticsAsicInstances.StatisticsAsicInstance.FmacStatistics.FmacLinks.FmacLink.FmacAsic.AggrStats.LinkCounters' : {
        'meta_info' : _MetaInfoClass('Fia.Nodes.Node.AsicStatistics.StatisticsAsicInstances.StatisticsAsicInstance.FmacStatistics.FmacLinks.FmacLink.FmacAsic.AggrStats.LinkCounters',
            False, 
            [
            _MetaInfoClassMember('rx-8b-10b-code-errors', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX 8b 10b code errors
                ''',
                'rx_8b_10b_code_errors',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-8b-10b-disparity-errors', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX 8b 10b disparity errors
                ''',
                'rx_8b_10b_disparity_errors',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-asyn-fifo-rate', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX Asyn fifo rate
                ''',
                'rx_asyn_fifo_rate',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-control-cells-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX Control cells counter
                ''',
                'rx_control_cells_counter',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-crc-errors-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX CRC errors counter
                ''',
                'rx_crc_errors_counter',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-data-byte-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX Data byte counter
                ''',
                'rx_data_byte_counter',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-data-cell-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX Data cell counter
                ''',
                'rx_data_cell_counter',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-dropped-retransmitted-control', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX dropped retransmitted control
                ''',
                'rx_dropped_retransmitted_control',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-lfec-fec-correctable-error', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX LFEC FEC correctable error
                ''',
                'rx_lfec_fec_correctable_error',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('rx-lfec-fec-uncorrectable-errors', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                RX LFEC FEC uncorrectable errors
                ''',
                'rx_lfec_fec_uncorrectable_errors',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('tx-asyn-fifo-rate', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                TX Asyn fifo rate
                ''',
                'tx_asyn_fifo_rate',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('tx-control-cells-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                TX Control cells counter
                ''',
                'tx_control_cells_counter',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('tx-data-byte-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
                '''                TX Data byte counter
                ''',
                'tx_data_byte_counter',
                'Cisco-IOS-XR-dnx-driver-oper', False),
            _MetaInfoClassMember('tx-data-cell-counter', ATTRIBUTE, 'long' , None, None, 
                [(0, 18446744073709551615L)], [], 
