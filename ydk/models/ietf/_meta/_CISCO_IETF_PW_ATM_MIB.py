...
_meta_table = {
    'CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry.CpwAtmEncap_Enum' : _MetaInfoEnum('CpwAtmEncap_Enum', 'ydk.models.ietf.CISCO_IETF_PW_ATM_MIB',
        {
            'mpls':'MPLS',
            'l2tpv3':'L2TPV3',
            'unknown':'UNKNOWN',
    ...
    'CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry',
            ...
            _MetaInfoClassMember('cpwAtmClpQosMapping', ATTRIBUTE, 'bool' , None, None, 
                ...
                'cpwatmclpqosmapping',
                'CISCO-IETF-PW-ATM-MIB', False),
            _MetaInfoClassMember('cpwAtmEncap', REFERENCE_ENUM_CLASS, 'CpwAtmEncap_Enum' , 'ydk.models.ietf.CISCO_IETF_PW_ATM_MIB', 'CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry.CpwAtmEncap_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cpwAtmQosScalingFactor', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-IETF-PW-ATM-MIB', False),
            _MetaInfoClassMember('cpwAtmRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
        ...
        'ydk.models.ietf.CISCO_IETF_PW_ATM_MIB'
        ),
    },
    'CISCOIETFPWATMMIB.CpwVcAtmTable' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWATMMIB.CpwVcAtmTable',
            False, 
            [
            _MetaInfoClassMember('cpwVcAtmEntry', REFERENCE_LIST, 'CpwVcAtmEntry' , 'ydk.models.ietf.CISCO_IETF_PW_ATM_MIB', 'CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry', 
                [], [], 
    ...
    'CISCOIETFPWATMMIB' : {
        'meta_info' : _MetaInfoClass('CISCOIETFPWATMMIB',
            False, 
            [
            _MetaInfoClassMember('cpwVcAtmTable', REFERENCE_CLASS, 'CpwVcAtmTable' , 'ydk.models.ietf.CISCO_IETF_PW_ATM_MIB', 'CISCOIETFPWATMMIB.CpwVcAtmTable', 
                [], [], 
