...
_meta_table = {
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.Power.PowerBag' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.Power.PowerBag',
            ...
            _MetaInfoClassMember('power-accuracy', ATTRIBUTE, 'int' , None, None, 
                ...
                ''',
                'power_accuracy',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', False),
            ...
            'power-bag',
            _yang_ns._namespaces['Cisco-IOS-XR-asr9k-sc-envmon-oper'],
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.Power' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.Power',
            False, 
            [
            _MetaInfoClassMember('power-bag', REFERENCE_CLASS, 'PowerBag' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.Power.PowerBag', 
                [], [], 
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds.Threshold' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds.Threshold',
            ...
            _MetaInfoClassMember('type', ATTRIBUTE, 'str' , None, None, 
                ...
                ''',
                'type',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', True),
            ...
            _MetaInfoClassMember('value-brief', ATTRIBUTE, 'int' , None, None, 
                ...
                'value_brief',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', False),
            _MetaInfoClassMember('value-detailed', REFERENCE_CLASS, 'ValueDetailed' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds.Threshold.ValueDetailed', 
                [], [], 
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds',
            False, 
            [
            _MetaInfoClassMember('threshold', REFERENCE_LIST, 'Threshold' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds.Threshold', 
                [], [], 
                '''                Types of thresholds
                ''',
                'threshold',
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', True),
            _MetaInfoClassMember('thresholds', REFERENCE_CLASS, 'Thresholds' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.Thresholds', 
                [], [], 
            ...
            _MetaInfoClassMember('value-brief', ATTRIBUTE, 'int' , None, None, 
                ...
                'value_brief',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', False),
            _MetaInfoClassMember('value-detailed', REFERENCE_CLASS, 'ValueDetailed' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName.ValueDetailed', 
                [], [], 
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames',
            False, 
            [
            _MetaInfoClassMember('sensor-name', REFERENCE_LIST, 'SensorName' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames.SensorName', 
                [], [], 
                '''                Name of sensor
                ''',
                'sensor_name',
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType',
            ...
            _MetaInfoClassMember('type', ATTRIBUTE, 'str' , None, None, 
                ...
                'type',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', True),
            _MetaInfoClassMember('sensor-names', REFERENCE_CLASS, 'SensorNames' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType.SensorNames', 
                [], [], 
                '''                Table of sensors
                ''',
                'sensor_names',
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes',
            False, 
            [
            _MetaInfoClassMember('sensor-type', REFERENCE_LIST, 'SensorType' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes.SensorType', 
                [], [], 
                '''                Type of sensor
                ''',
                'sensor_type',
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module',
            ...
            _MetaInfoClassMember('module', ATTRIBUTE, 'str' , None, None, 
                ...
                'module',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', True),
            _MetaInfoClassMember('power', REFERENCE_CLASS, 'Power' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.Power', 
                [], [], 
                '''                Module Power Draw
                ''',
                'power',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', False),
            _MetaInfoClassMember('sensor-types', REFERENCE_CLASS, 'SensorTypes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module.SensorTypes', 
                [], [], 
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules',
            False, 
            [
            _MetaInfoClassMember('module', REFERENCE_LIST, 'Module' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules.Module', 
                [], [], 
                '''                Name
                ''',
                'module',
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots.Slot' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots.Slot',
            ...
            _MetaInfoClassMember('slot', ATTRIBUTE, 'str' , None, None, 
                ...
                'slot',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', True),
            _MetaInfoClassMember('modules', REFERENCE_CLASS, 'Modules' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot.Modules', 
                [], [], 
                '''                Table of modules
                ''',
                'modules',
    ...
    'EnvironmentalMonitoring.Racks.Rack.Slots' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack.Slots',
            False, 
            [
            _MetaInfoClassMember('slot', REFERENCE_LIST, 'Slot' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots.Slot', 
                [], [], 
                '''                Name
                ''',
                'slot',
    ...
    'EnvironmentalMonitoring.Racks.Rack' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks.Rack',
            ...
            _MetaInfoClassMember('rack', ATTRIBUTE, 'int' , None, None, 
                ...
                'rack',
                'Cisco-IOS-XR-asr9k-sc-envmon-oper', True),
            _MetaInfoClassMember('slots', REFERENCE_CLASS, 'Slots' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack.Slots', 
                [], [], 
                '''                Table of slots
                ''',
                'slots',
    ...
    'EnvironmentalMonitoring.Racks' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring.Racks',
            False, 
            [
            _MetaInfoClassMember('rack', REFERENCE_LIST, 'Rack' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks.Rack', 
                [], [], 
                '''                Number
                ''',
                'rack',
    ...
    'EnvironmentalMonitoring' : {
        'meta_info' : _MetaInfoClass('EnvironmentalMonitoring',
            False, 
            [
            _MetaInfoClassMember('racks', REFERENCE_CLASS, 'Racks' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_asr9k_sc_envmon_oper', 'EnvironmentalMonitoring.Racks', 
                [], [], 
                '''                Table of racks
                ''',
                'racks',
