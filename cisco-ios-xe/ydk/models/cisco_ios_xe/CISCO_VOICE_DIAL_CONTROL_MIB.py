...
class CISCOVOICEDIALCONTROLMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cvActiveCallStatsTable" : ("cvactivecallstatstable", CISCOVOICEDIALCONTROLMIB.Cvactivecallstatstable), "cvActiveCallWMTable" : ("cvactivecallwmtable", CISCOVOICEDIALCONTROLMIB.Cvactivecallwmtable), "cvCallActiveTable" : ("cvcallactivetable", CISCOVOICEDIALCONTROLMIB.Cvcallactivetable), "cvCallDurationStatsTable" : ("cvcalldurationstatstable", CISCOVOICEDIALCONTROLMIB.Cvcalldurationstatstable), "cvCallHistoryTable" : ("cvcallhistorytable", CISCOVOICEDIALCONTROLMIB.Cvcallhistorytable), "cvCallLegRateStatsTable" : ("cvcalllegratestatstable", CISCOVOICEDIALCONTROLMIB.Cvcalllegratestatstable), "cvCallLegRateWMTable" : ("cvcalllegratewmtable", CISCOVOICEDIALCONTROLMIB.Cvcalllegratewmtable), "cvCallRateMonitor" : ("cvcallratemonitor", CISCOVOICEDIALCONTROLMIB.Cvcallratemonitor), "cvCallRateStatsTable" : ("cvcallratestatstable", CISCOVOICEDIALCONTROLMIB.Cvcallratestatstable), "cvCallRateWMTable" : ("cvcallratewmtable", CISCOVOICEDIALCONTROLMIB.Cvcallratewmtable), "cvCallVolConnTable" : ("cvcallvolconntable", CISCOVOICEDIALCONTROLMIB.Cvcallvolconntable), "cvCallVolIfTable" : ("cvcallvoliftable", CISCOVOICEDIALCONTROLMIB.Cvcallvoliftable), "cvCallVolume" : ("cvcallvolume", CISCOVOICEDIALCONTROLMIB.Cvcallvolume), "cvCallVolumeStatsHistory" : ("cvcallvolumestatshistory", CISCOVOICEDIALCONTROLMIB.Cvcallvolumestatshistory), "cvGatewayCallActive" : ("cvgatewaycallactive", CISCOVOICEDIALCONTROLMIB.Cvgatewaycallactive), "cvGeneralConfiguration" : ("cvgeneralconfiguration", CISCOVOICEDIALCONTROLMIB.Cvgeneralconfiguration), "cvPeerCfgTable" : ("cvpeercfgtable", CISCOVOICEDIALCONTROLMIB.Cvpeercfgtable), "cvPeerCommonCfgTable" : ("cvpeercommoncfgtable", CISCOVOICEDIALCONTROLMIB.Cvpeercommoncfgtable), "cvSipMsgRateStatsTable" : ("cvsipmsgratestatstable", CISCOVOICEDIALCONTROLMIB.Cvsipmsgratestatstable), "cvSipMsgRateWMTable" : ("cvsipmsgratewmtable", CISCOVOICEDIALCONTROLMIB.Cvsipmsgratewmtable), "cvVoicePeerCfgTable" : ("cvvoicepeercfgtable", CISCOVOICEDIALCONTROLMIB.Cvvoicepeercfgtable), "cvVoIPCallActiveTable" : ("cvvoipcallactivetable", CISCOVOICEDIALCONTROLMIB.Cvvoipcallactivetable), "cvVoIPCallHistoryTable" : ("cvvoipcallhistorytable", CISCOVOICEDIALCONTROLMIB.Cvvoipcallhistorytable), "cvVoIPPeerCfgTable" : ("cvvoippeercfgtable", CISCOVOICEDIALCONTROLMIB.Cvvoippeercfgtable)}
    ...
    class Cvactivecallstatstable(Entity):
        ...
        class Cvactivecallstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvactivecallstatstable.Cvactivecallstatsentry, ['cvactivecallstatsintvldurunits', 'cvactivecallstatsintvldur', 'cvactivecallstatsavgval', 'cvactivecallstatsmaxval'], name, value)
    ...
    class Cvactivecallwmtable(Entity):
        ...
        class Cvactivecallwmentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvactivecallwmtable.Cvactivecallwmentry, ['cvactivecallwmintvldurunits', 'cvactivecallwmindex', 'cvactivecallwmts', 'cvactivecallwmvalue'], name, value)
    ...
    class Cvcallactivetable(Entity):
        ...
        class Cvcallactiveentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcallactivetable.Cvcallactiveentry, ['callactivesetuptime', 'callactiveindex', 'cvcallactiveaccountcode', 'cvcallactiveacomlevel', 'cvcallactivecalleridblock', 'cvcallactivecallid', 'cvcallactivecallingname', 'cvcallactivecodertyperate', 'cvcallactiveconnectionid', 'cvcallactiveecanreflectorlocation', 'cvcallactiveerllevel', 'cvcallactiveerllevelrev1', 'cvcallactivefaxtxduration', 'cvcallactiveimgpagecount', 'cvcallactiveinsignallevel', 'cvcallactivenoiselevel', 'cvcallactiveoutsignallevel', 'cvcallactivesessiontarget', 'cvcallactivetxduration', 'cvcallactivevoicetxduration'], name, value)
    ...
    class Cvcalldurationstatstable(Entity):
        ...
        class Cvcalldurationstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcalldurationstatstable.Cvcalldurationstatsentry, ['cvcalldurationstatsintvldurunits', 'cvcalldurationstatsintvldur', 'cvcalldurationstatsavgval', 'cvcalldurationstatsmaxval'], name, value)
    ...
    class Cvcallhistorytable(Entity):
        ...
        class Cvcallhistoryentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcallhistorytable.Cvcallhistoryentry, ['ccallhistoryindex', 'cvcallhistoryaccountcode', 'cvcallhistoryacomlevel', 'cvcallhistorycalleridblock', 'cvcallhistorycallid', 'cvcallhistorycallingname', 'cvcallhistorycodertyperate', 'cvcallhistoryconnectionid', 'cvcallhistoryfaxtxduration', 'cvcallhistoryimgpagecount', 'cvcallhistorynoiselevel', 'cvcallhistorysessiontarget', 'cvcallhistorytxduration', 'cvcallhistoryvoicetxduration'], name, value)
    ...
    class Cvcalllegratestatstable(Entity):
        ...
        class Cvcalllegratestatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcalllegratestatstable.Cvcalllegratestatsentry, ['cvcalllegratestatsintvldurunits', 'cvcalllegratestatsintvldur', 'cvcalllegratestatsavgval', 'cvcalllegratestatsmaxval'], name, value)
    ...
    class Cvcalllegratewmtable(Entity):
        ...
        class Cvcalllegratewmentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcalllegratewmtable.Cvcalllegratewmentry, ['cvcalllegratewmintvldurunits', 'cvcalllegratewmindex', 'cvcalllegratewmts', 'cvcalllegratewmvalue'], name, value)
    ...
    class Cvcallratemonitor(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcallratemonitor, ['cvcallrate', 'cvcallratehiwatermark', 'cvcallratemonitorenable', 'cvcallratemonitortime'], name, value)
    ...
    class Cvcallratestatstable(Entity):
        ...
        class Cvcallratestatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcallratestatstable.Cvcallratestatsentry, ['cvcallratestatsintvldurunits', 'cvcallratestatsintvldur', 'cvcallratestatsavgval', 'cvcallratestatsmaxval'], name, value)
    ...
    class Cvcallratewmtable(Entity):
        ...
        class Cvcallratewmentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcallratewmtable.Cvcallratewmentry, ['cvcallratewmintvldurunits', 'cvcallratewmindex', 'cvcallratewmts', 'cvcallratewmvalue'], name, value)
    ...
    class Cvcallvolume(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvcallvolume, ['cvcallvolconnmaxcallconnectionlicenese', 'cvcallvolconntotalactiveconnections'], name, value)
    ...
    class Cvgatewaycallactive(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvgatewaycallactive, ['cvcallactiveds0s', 'cvcallactiveds0shighnotifyenable', 'cvcallactiveds0shighthreshold', 'cvcallactiveds0slownotifyenable', 'cvcallactiveds0slowthreshold'], name, value)
    ...
    class Cvgeneralconfiguration(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvgeneralconfiguration, ['cvgeneraldscppolicynotificationenable', 'cvgeneralfallbacknotificationenable', 'cvgeneralmediapolicynotificationenable', 'cvgeneralpoorqovnotificationenable'], name, value)
    ...
    class Cvpeercfgtable(Entity):
        ...
        class Cvpeercfgentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvpeercfgtable.Cvpeercfgentry, ['cvpeercfgindex', 'cvcallvolpeerincomingcalls', 'cvcallvolpeeroutgoingcalls', 'cvpeercfgifindex', 'cvpeercfgpeertype', 'cvpeercfgrowstatus', 'cvpeercfgtype'], name, value)
    ...
    class Cvpeercommoncfgtable(Entity):
        ...
        class Cvpeercommoncfgentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvpeercommoncfgtable.Cvpeercommoncfgentry, ['ifindex', 'cvpeercommoncfgapplicationname', 'cvpeercommoncfgdnismappingname', 'cvpeercommoncfghuntstop', 'cvpeercommoncfgincomingdnisdigits', 'cvpeercommoncfgmaxconnections', 'cvpeercommoncfgpreference', 'cvpeercommoncfgsourcecarrierid', 'cvpeercommoncfgsourcetrunkgrplabel', 'cvpeercommoncfgtargetcarrierid', 'cvpeercommoncfgtargettrunkgrplabel'], name, value)
    ...
    class Cvsipmsgratestatstable(Entity):
        ...
        class Cvsipmsgratestatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvsipmsgratestatstable.Cvsipmsgratestatsentry, ['cvsipmsgratestatsintvldurunits', 'cvsipmsgratestatsintvldur', 'cvsipmsgratestatsavgval', 'cvsipmsgratestatsmaxval'], name, value)
    ...
    class Cvsipmsgratewmtable(Entity):
        ...
        class Cvsipmsgratewmentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvsipmsgratewmtable.Cvsipmsgratewmentry, ['cvsipmsgratewmintvldurunits', 'cvsipmsgratewmindex', 'cvsipmsgratewmts', 'cvsipmsgratewmvalue'], name, value)
    ...
    class Cvvoicepeercfgtable(Entity):
        ...
        class Cvvoicepeercfgentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvvoicepeercfgtable.Cvvoicepeercfgentry, ['ifindex', 'cvvoicepeercfgcasgroup', 'cvvoicepeercfgdialdigitsprefix', 'cvvoicepeercfgdidcallenable', 'cvvoicepeercfgechocancellertest', 'cvvoicepeercfgforwarddigits', 'cvvoicepeercfgregistere164', 'cvvoicepeercfgsessiontarget'], name, value)
    ...
    class Cvvoipcallactivetable(Entity):
        ...
        class Cvvoipcallactiveentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvvoipcallactivetable.Cvvoipcallactiveentry, ['callactivesetuptime', 'callactiveindex', 'ccvoipcallactivepolicyname', 'cvvoipcallactivebitrates', 'cvvoipcallactivecallid', 'cvvoipcallactivecallreferenceid', 'cvvoipcallactivechannels', 'cvvoipcallactivecodermode', 'cvvoipcallactivecodertyperate', 'cvvoipcallactiveconnectionid', 'cvvoipcallactivecrc', 'cvvoipcallactiveearlypackets', 'cvvoipcallactiveencap', 'cvvoipcallactivegapfillwithinterpolation', 'cvvoipcallactivegapfillwithprediction', 'cvvoipcallactivegapfillwithredundancy', 'cvvoipcallactivegapfillwithsilence', 'cvvoipcallactivehiwaterplayoutdelay', 'cvvoipcallactiveinterleaving', 'cvvoipcallactivelatepackets', 'cvvoipcallactivelostpackets', 'cvvoipcallactivelowaterplayoutdelay', 'cvvoipcallactivemaxptime', 'cvvoipcallactivemodechgneighbor', 'cvvoipcallactivemodechgperiod', 'cvvoipcallactiveoctetaligned', 'cvvoipcallactiveontimervplayout', 'cvvoipcallactiveprotocolcallid', 'cvvoipcallactiveptime', 'cvvoipcallactivereceivedelay', 'cvvoipcallactiveremmediaipaddr', 'cvvoipcallactiveremmediaipaddrt', 'cvvoipcallactiveremmediaport', 'cvvoipcallactiveremoteipaddress', 'cvvoipcallactiveremoteudpport', 'cvvoipcallactiveremsigipaddr', 'cvvoipcallactiveremsigipaddrt', 'cvvoipcallactiveremsigport', 'cvvoipcallactivereverseddirectionpeeraddress', 'cvvoipcallactiverobustsorting', 'cvvoipcallactiveroundtripdelay', 'cvvoipcallactiveselectedqos', 'cvvoipcallactivesessionid', 'cvvoipcallactivesessionprotocol', 'cvvoipcallactivesessiontarget', 'cvvoipcallactivesrtpenable', 'cvvoipcallactiveusername', 'cvvoipcallactivevadenable'], name, value)
    ...
    class Cvvoipcallhistorytable(Entity):
        ...
        class Cvvoipcallhistoryentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvvoipcallhistorytable.Cvvoipcallhistoryentry, ['ccallhistoryindex', 'cvvoipcallhistorybitrates', 'cvvoipcallhistorycallid', 'cvvoipcallhistorycallreferenceid', 'cvvoipcallhistorychannels', 'cvvoipcallhistorycodermode', 'cvvoipcallhistorycodertyperate', 'cvvoipcallhistoryconnectionid', 'cvvoipcallhistorycrc', 'cvvoipcallhistoryearlypackets', 'cvvoipcallhistoryencap', 'cvvoipcallhistoryfallbackdelay', 'cvvoipcallhistoryfallbackicpif', 'cvvoipcallhistoryfallbackloss', 'cvvoipcallhistorygapfillwithinterpolation', 'cvvoipcallhistorygapfillwithprediction', 'cvvoipcallhistorygapfillwithredundancy', 'cvvoipcallhistorygapfillwithsilence', 'cvvoipcallhistoryhiwaterplayoutdelay', 'cvvoipcallhistoryicpif', 'cvvoipcallhistoryinterleaving', 'cvvoipcallhistorylatepackets', 'cvvoipcallhistorylostpackets', 'cvvoipcallhistorylowaterplayoutdelay', 'cvvoipcallhistorymaxptime', 'cvvoipcallhistorymodechgneighbor', 'cvvoipcallhistorymodechgperiod', 'cvvoipcallhistoryoctetaligned', 'cvvoipcallhistoryontimervplayout', 'cvvoipcallhistoryprotocolcallid', 'cvvoipcallhistoryptime', 'cvvoipcallhistoryreceivedelay', 'cvvoipcallhistoryremmediaipaddr', 'cvvoipcallhistoryremmediaipaddrt', 'cvvoipcallhistoryremmediaport', 'cvvoipcallhistoryremoteipaddress', 'cvvoipcallhistoryremoteudpport', 'cvvoipcallhistoryremsigipaddr', 'cvvoipcallhistoryremsigipaddrt', 'cvvoipcallhistoryremsigport', 'cvvoipcallhistoryrobustsorting', 'cvvoipcallhistoryroundtripdelay', 'cvvoipcallhistoryselectedqos', 'cvvoipcallhistorysessionid', 'cvvoipcallhistorysessionprotocol', 'cvvoipcallhistorysessiontarget', 'cvvoipcallhistorysrtpenable', 'cvvoipcallhistoryusername', 'cvvoipcallhistoryvadenable'], name, value)
    ...
    class Cvvoippeercfgtable(Entity):
        ...
        class Cvvoippeercfgentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVOICEDIALCONTROLMIB.Cvvoippeercfgtable.Cvvoippeercfgentry, ['ifindex', 'cvvoippeercfgbitrate', 'cvvoippeercfgbitrates', 'cvvoippeercfgcoderbytes', 'cvvoippeercfgcodermode', 'cvvoippeercfgcoderrate', 'cvvoippeercfgcodingmode', 'cvvoippeercfgcrc', 'cvvoippeercfgdesiredqos', 'cvvoippeercfgdesiredqosvideo', 'cvvoippeercfgdigitrelay', 'cvvoippeercfgdscppolicynotificationenable', 'cvvoippeercfgexpectfactor', 'cvvoippeercfgfaxbytes', 'cvvoippeercfgfaxrate', 'cvvoippeercfgframesize', 'cvvoippeercfgicpif', 'cvvoippeercfginbandsignaling', 'cvvoippeercfgipprecedence', 'cvvoippeercfgmediapolicynotificationenable', 'cvvoippeercfgmediasetting', 'cvvoippeercfgminacceptableqos', 'cvvoippeercfgminacceptableqosvideo', 'cvvoippeercfgoctetaligned', 'cvvoippeercfgpoorqovnotificationenable', 'cvvoippeercfgredirectip2ip', 'cvvoippeercfgsessionprotocol', 'cvvoippeercfgsessiontarget', 'cvvoippeercfgtechprefix', 'cvvoippeercfgudpchecksumenable', 'cvvoippeercfgvadenable'], name, value)
