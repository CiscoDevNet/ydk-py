...
class ShowUsers(object):
    ...
    .. attribute:: sessions
    	...
    	Show users statistics
    	**type**\: :py:class:`Sessions <ydk.models.tty.Cisco_IOS_XR_tty_management_cmd_oper.ShowUsers.Sessions>`
    ...
    class Sessions(object):
        ...
        .. attribute:: session
        	...
        	Show users statistics
        	**type**\: list of :py:class:`Session <ydk.models.tty.Cisco_IOS_XR_tty_management_cmd_oper.ShowUsers.Sessions.Session>`
