...
class Exception(_Entity_):
    ...
    class Choice(_Entity_):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_dumper as meta
            return meta._meta_table['Exception.Choice']['meta_info']
