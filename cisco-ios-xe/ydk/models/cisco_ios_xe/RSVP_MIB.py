...
class RSVPMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"rsvpGenObjects" : ("rsvpgenobjects", RSVPMIB.Rsvpgenobjects), "rsvpIfTable" : ("rsvpiftable", RSVPMIB.Rsvpiftable), "rsvpNbrTable" : ("rsvpnbrtable", RSVPMIB.Rsvpnbrtable), "rsvpResvFwdTable" : ("rsvpresvfwdtable", RSVPMIB.Rsvpresvfwdtable), "rsvpResvTable" : ("rsvpresvtable", RSVPMIB.Rsvpresvtable), "rsvpSenderOutInterfaceTable" : ("rsvpsenderoutinterfacetable", RSVPMIB.Rsvpsenderoutinterfacetable), "rsvpSenderTable" : ("rsvpsendertable", RSVPMIB.Rsvpsendertable), "rsvpSessionTable" : ("rsvpsessiontable", RSVPMIB.Rsvpsessiontable)}
    ...
    class Rsvpgenobjects(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RSVPMIB.Rsvpgenobjects, ['rsvpbadpackets', 'rsvpresvfwdnewindex', 'rsvpresvnewindex', 'rsvpsendernewindex', 'rsvpsessionnewindex'], name, value)
    ...
    class Rsvpiftable(Entity):
        ...
        class Rsvpifentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RSVPMIB.Rsvpiftable.Rsvpifentry, ['ifindex', 'rsvpifenabled', 'rsvpifipnbrs', 'rsvpifnbrs', 'rsvpifrefreshblockademultiple', 'rsvpifrefreshinterval', 'rsvpifrefreshmultiple', 'rsvpifroutedelay', 'rsvpifstatus', 'rsvpifttl', 'rsvpifudpnbrs', 'rsvpifudprequired'], name, value)
    ...
    class Rsvpresvfwdtable(Entity):
        ...
        class Rsvpresvfwdentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RSVPMIB.Rsvpresvfwdtable.Rsvpresvfwdentry, ['rsvpsessionnumber', 'rsvpresvfwdnumber', 'rsvpresvfwddestaddr', 'rsvpresvfwddestaddrlength', 'rsvpresvfwddestport', 'rsvpresvfwdexplicit', 'rsvpresvfwdflowid', 'rsvpresvfwdhopaddr', 'rsvpresvfwdhoplih', 'rsvpresvfwdinterface', 'rsvpresvfwdinterval', 'rsvpresvfwdlastchange', 'rsvpresvfwdpolicy', 'rsvpresvfwdport', 'rsvpresvfwdprotocol', 'rsvpresvfwdrspecrate', 'rsvpresvfwdrspecslack', 'rsvpresvfwdrsvphop', 'rsvpresvfwdscope', 'rsvpresvfwdsenderaddr', 'rsvpresvfwdsenderaddrlength', 'rsvpresvfwdservice', 'rsvpresvfwdshared', 'rsvpresvfwdstatus', 'rsvpresvfwdtspecburst', 'rsvpresvfwdtspecmaxtu', 'rsvpresvfwdtspecmintu', 'rsvpresvfwdtspecpeakrate', 'rsvpresvfwdtspecrate', 'rsvpresvfwdttl', 'rsvpresvfwdtype'], name, value)
    ...
    class Rsvpresvtable(Entity):
        ...
        class Rsvpresventry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RSVPMIB.Rsvpresvtable.Rsvpresventry, ['rsvpsessionnumber', 'rsvpresvnumber', 'rsvpresvdestaddr', 'rsvpresvdestaddrlength', 'rsvpresvdestport', 'rsvpresvexplicit', 'rsvpresvflowid', 'rsvpresvhopaddr', 'rsvpresvhoplih', 'rsvpresvinterface', 'rsvpresvinterval', 'rsvpresvlastchange', 'rsvpresvpolicy', 'rsvpresvport', 'rsvpresvprotocol', 'rsvpresvrspecrate', 'rsvpresvrspecslack', 'rsvpresvrsvphop', 'rsvpresvscope', 'rsvpresvsenderaddr', 'rsvpresvsenderaddrlength', 'rsvpresvservice', 'rsvpresvshared', 'rsvpresvstatus', 'rsvpresvtspecburst', 'rsvpresvtspecmaxtu', 'rsvpresvtspecmintu', 'rsvpresvtspecpeakrate', 'rsvpresvtspecrate', 'rsvpresvttl', 'rsvpresvtype'], name, value)
    ...
    class Rsvpsendertable(Entity):
        ...
        class Rsvpsenderentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RSVPMIB.Rsvpsendertable.Rsvpsenderentry, ['rsvpsessionnumber', 'rsvpsendernumber', 'rsvpsenderaddr', 'rsvpsenderaddrlength', 'rsvpsenderadspecbreak', 'rsvpsenderadspecctrlloadbreak', 'rsvpsenderadspecctrlloadhopcount', 'rsvpsenderadspecctrlloadminlatency', 'rsvpsenderadspecctrlloadmtu', 'rsvpsenderadspecctrlloadpathbw', 'rsvpsenderadspecctrlloadsvc', 'rsvpsenderadspecguaranteedbreak', 'rsvpsenderadspecguaranteedcsum', 'rsvpsenderadspecguaranteedctot', 'rsvpsenderadspecguaranteeddsum', 'rsvpsenderadspecguaranteeddtot', 'rsvpsenderadspecguaranteedhopcount', 'rsvpsenderadspecguaranteedminlatency', 'rsvpsenderadspecguaranteedmtu', 'rsvpsenderadspecguaranteedpathbw', 'rsvpsenderadspecguaranteedsvc', 'rsvpsenderadspechopcount', 'rsvpsenderadspecminlatency', 'rsvpsenderadspecmtu', 'rsvpsenderadspecpathbw', 'rsvpsenderdestaddr', 'rsvpsenderdestaddrlength', 'rsvpsenderdestport', 'rsvpsenderflowid', 'rsvpsenderhopaddr', 'rsvpsenderhoplih', 'rsvpsenderinterface', 'rsvpsenderinterval', 'rsvpsenderlastchange', 'rsvpsenderpolicy', 'rsvpsenderport', 'rsvpsenderprotocol', 'rsvpsenderrsvphop', 'rsvpsenderstatus', 'rsvpsendertspecburst', 'rsvpsendertspecmaxtu', 'rsvpsendertspecmintu', 'rsvpsendertspecpeakrate', 'rsvpsendertspecrate', 'rsvpsenderttl', 'rsvpsendertype'], name, value)
    ...
    class Rsvpsessiontable(Entity):
        ...
        class Rsvpsessionentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RSVPMIB.Rsvpsessiontable.Rsvpsessionentry, ['rsvpsessionnumber', 'rsvpsessiondestaddr', 'rsvpsessiondestaddrlength', 'rsvpsessionport', 'rsvpsessionprotocol', 'rsvpsessionreceivers', 'rsvpsessionrequests', 'rsvpsessionsenders', 'rsvpsessiontype'], name, value)
