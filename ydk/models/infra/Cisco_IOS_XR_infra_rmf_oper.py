...
class Redundancy(object):
    ...
    .. attribute:: nodes
    	...
    	**type**\: :py:class:`Nodes <ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper.Redundancy.Nodes>`
    
    .. attribute:: summary
    
    	Redundancy Summary of Nodes
    	**type**\: :py:class:`Summary <ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper.Redundancy.Summary>`
    ...
    class Nodes(object):
        ...
        .. attribute:: node
        	...
        	**type**\: list of :py:class:`Node <ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper.Redundancy.Nodes.Node>`
    ...
    class Summary(object):
        ...
        .. attribute:: red_pair
        	...
        	Redundancy Pair
        	**type**\: list of :py:class:`RedPair <ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper.Redundancy.Summary.RedPair>`
