...
class CISCOVTPMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"internalVlanInfo" : ("internalvlaninfo", CISCOVTPMIB.Internalvlaninfo), "managementDomainTable" : ("managementdomaintable", CISCOVTPMIB.Managementdomaintable), "vlanStatistics" : ("vlanstatistics", CISCOVTPMIB.Vlanstatistics), "vlanTrunkPorts" : ("vlantrunkports", CISCOVTPMIB.Vlantrunkports), "vlanTrunkPortTable" : ("vlantrunkporttable", CISCOVTPMIB.Vlantrunkporttable), "vtpAuthenticationTable" : ("vtpauthenticationtable", CISCOVTPMIB.Vtpauthenticationtable), "vtpDatabaseTable" : ("vtpdatabasetable", CISCOVTPMIB.Vtpdatabasetable), "vtpDiscoverResultTable" : ("vtpdiscoverresulttable", CISCOVTPMIB.Vtpdiscoverresulttable), "vtpDiscoverTable" : ("vtpdiscovertable", CISCOVTPMIB.Vtpdiscovertable), "vtpInternalVlanTable" : ("vtpinternalvlantable", CISCOVTPMIB.Vtpinternalvlantable), "vtpStatus" : ("vtpstatus", CISCOVTPMIB.Vtpstatus), "vtpVlanEditTable" : ("vtpvlanedittable", CISCOVTPMIB.Vtpvlanedittable), "vtpVlanLocalShutdownTable" : ("vtpvlanlocalshutdowntable", CISCOVTPMIB.Vtpvlanlocalshutdowntable), "vtpVlanTable" : ("vtpvlantable", CISCOVTPMIB.Vtpvlantable)}
    ...
    class Managementdomaintable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"managementDomainEntry" : ("managementdomainentry", CISCOVTPMIB.Managementdomaintable.Managementdomainentry)}
        ...
        class Managementdomainentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "managementDomainEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']"
                self._absolute_path = lambda: "CISCO-VTP-MIB:CISCO-VTP-MIB/managementDomainTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVTPMIB.Managementdomaintable.Managementdomainentry, ['managementdomainindex', 'managementdomainadminsrcif', 'managementdomainconfigfile', 'managementdomainconfigrevnumber', 'managementdomaindeviceid', 'managementdomainlastchange', 'managementdomainlastupdater', 'managementdomainlocalmode', 'managementdomainlocalupdater', 'managementdomainlocalupdatertype', 'managementdomainname', 'managementdomainopersrcif', 'managementdomainpruningstate', 'managementdomainpruningstateoper', 'managementdomainrowstatus', 'managementdomainsourceonlymode', 'managementdomaintftppathname', 'managementdomaintftpserver', 'managementdomainversioninuse', 'vtpconfigdigesterrors', 'vtpconfigrevnumbererrors', 'vtpinadvertrequests', 'vtpinsubsetadverts', 'vtpinsummaryadverts', 'vtpoutadvertrequests', 'vtpoutsubsetadverts', 'vtpoutsummaryadverts', 'vtpvlanapplystatus', 'vtpvlaneditbufferowner', 'vtpvlaneditconfigrevnumber', 'vtpvlaneditmodifiedvlan', 'vtpvlaneditoperation'], name, value)
    ...
    class Vlanstatistics(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVTPMIB.Vlanstatistics, ['vlanstatsextendedvlans', 'vlanstatsfreevlans', 'vlanstatsinternalvlans', 'vlanstatsvlans'], name, value)
    ...
    class Vlantrunkports(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVTPMIB.Vlantrunkports, ['vlantrunkportsdot1qtag', 'vlantrunkportsetserialno'], name, value)
    ...
    class Vlantrunkporttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vlanTrunkPortEntry" : ("vlantrunkportentry", CISCOVTPMIB.Vlantrunkporttable.Vlantrunkportentry)}
        ...
        class Vlantrunkportentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vlanTrunkPortEntry" + "[vlanTrunkPortIfIndex='" + self.vlantrunkportifindex.get() + "']"
                self._absolute_path = lambda: "CISCO-VTP-MIB:CISCO-VTP-MIB/vlanTrunkPortTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVTPMIB.Vlantrunkporttable.Vlantrunkportentry, ['vlantrunkportifindex', 'stpxpreferredmistpinstancesmap', 'stpxpreferredmstinstancesmap', 'stpxpreferredvlansmap', 'stpxpreferredvlansmap2k', 'stpxpreferredvlansmap3k', 'stpxpreferredvlansmap4k', 'vlantrunkportdot1qtunnel', 'vlantrunkportdynamicstate', 'vlantrunkportdynamicstatus', 'vlantrunkportencapsulationopertype', 'vlantrunkportencapsulationtype', 'vlantrunkportinjoins', 'vlantrunkportmanagementdomain', 'vlantrunkportnativevlan', 'vlantrunkportoldadverts', 'vlantrunkportoutjoins', 'vlantrunkportrowstatus', 'vlantrunkportvlansactivefirst2k', 'vlantrunkportvlansactivesecond2k', 'vlantrunkportvlansenabled', 'vlantrunkportvlansenabled2k', 'vlantrunkportvlansenabled3k', 'vlantrunkportvlansenabled4k', 'vlantrunkportvlanspruningeligible', 'vlantrunkportvlansrcvjoined', 'vlantrunkportvlansrcvjoined2k', 'vlantrunkportvlansrcvjoined3k', 'vlantrunkportvlansrcvjoined4k', 'vlantrunkportvlansxmitjoined', 'vlantrunkportvlansxmitjoined2k', 'vlantrunkportvlansxmitjoined3k', 'vlantrunkportvlansxmitjoined4k', 'vlantrunkportvtpenabled', 'vtpvlanspruningeligible2k', 'vtpvlanspruningeligible3k', 'vtpvlanspruningeligible4k'], name, value)
    ...
    class Vtpauthenticationtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpAuthEntry" : ("vtpauthentry", CISCOVTPMIB.Vtpauthenticationtable.Vtpauthentry)}
        ...
        class Vtpauthentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpAuthEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']"
    ...
    class Vtpdatabasetable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpDatabaseEntry" : ("vtpdatabaseentry", CISCOVTPMIB.Vtpdatabasetable.Vtpdatabaseentry)}
        ...
        class Vtpdatabaseentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpDatabaseEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']" + "[vtpDatabaseIndex='" + self.vtpdatabaseindex.get() + "']"
                self._absolute_path = lambda: "CISCO-VTP-MIB:CISCO-VTP-MIB/vtpDatabaseTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVTPMIB.Vtpdatabasetable.Vtpdatabaseentry, ['managementdomainindex', 'vtpdatabaseindex', 'vtpdatabaselocalmode', 'vtpdatabasename', 'vtpdatabaseprimaryserver', 'vtpdatabaseprimaryserverid', 'vtpdatabaserevnumber', 'vtpdatabasetakeoverpassword', 'vtpdatabasetakeoverprimary'], name, value)
    ...
    class Vtpdiscoverresulttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpDiscoverResultEntry" : ("vtpdiscoverresultentry", CISCOVTPMIB.Vtpdiscoverresulttable.Vtpdiscoverresultentry)}
        ...
        class Vtpdiscoverresultentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpDiscoverResultEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']" + "[vtpDiscoverResultIndex='" + self.vtpdiscoverresultindex.get() + "']"
                self._absolute_path = lambda: "CISCO-VTP-MIB:CISCO-VTP-MIB/vtpDiscoverResultTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVTPMIB.Vtpdiscoverresulttable.Vtpdiscoverresultentry, ['managementdomainindex', 'vtpdiscoverresultindex', 'vtpdiscoverresultconflicting', 'vtpdiscoverresultdatabasename', 'vtpdiscoverresultdeviceid', 'vtpdiscoverresultprimaryserver', 'vtpdiscoverresultrevnumber', 'vtpdiscoverresultsystemname'], name, value)
    ...
    class Vtpdiscovertable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpDiscoverEntry" : ("vtpdiscoverentry", CISCOVTPMIB.Vtpdiscovertable.Vtpdiscoverentry)}
        ...
        class Vtpdiscoverentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpDiscoverEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']"
    ...
    class Vtpinternalvlantable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpInternalVlanEntry" : ("vtpinternalvlanentry", CISCOVTPMIB.Vtpinternalvlantable.Vtpinternalvlanentry)}
        ...
        class Vtpinternalvlanentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpInternalVlanEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']" + "[vtpVlanIndex='" + self.vtpvlanindex.get() + "']"
    ...
    class Vtpstatus(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOVTPMIB.Vtpstatus, ['vtpmaxvlanstorage', 'vtpnotificationsenabled', 'vtpversion', 'vtpvlancreatednotifenabled', 'vtpvlandeletednotifenabled'], name, value)
    ...
    class Vtpvlanedittable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpVlanEditEntry" : ("vtpvlaneditentry", CISCOVTPMIB.Vtpvlanedittable.Vtpvlaneditentry)}
        ...
        class Vtpvlaneditentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpVlanEditEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']" + "[vtpVlanEditIndex='" + self.vtpvlaneditindex.get() + "']"
                self._absolute_path = lambda: "CISCO-VTP-MIB:CISCO-VTP-MIB/vtpVlanEditTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVTPMIB.Vtpvlanedittable.Vtpvlaneditentry, ['managementdomainindex', 'vtpvlaneditindex', 'stpxvlanmistpinstmapeditinstindex', 'vtpvlaneditarehopcount', 'vtpvlaneditbridgenumber', 'vtpvlaneditbridgetype', 'vtpvlaneditdot10said', 'vtpvlaneditiscrfbackup', 'vtpvlaneditmtu', 'vtpvlaneditname', 'vtpvlaneditparentvlan', 'vtpvlaneditringnumber', 'vtpvlaneditrowstatus', 'vtpvlaneditstate', 'vtpvlaneditstehopcount', 'vtpvlaneditstptype', 'vtpvlanedittranslationalvlan1', 'vtpvlanedittranslationalvlan2', 'vtpvlanedittype', 'vtpvlanedittypeext', 'vtpvlanedittypeext2'], name, value)
    ...
    class Vtpvlanlocalshutdowntable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpVlanLocalShutdownEntry" : ("vtpvlanlocalshutdownentry", CISCOVTPMIB.Vtpvlanlocalshutdowntable.Vtpvlanlocalshutdownentry)}
        ...
        class Vtpvlanlocalshutdownentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpVlanLocalShutdownEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']" + "[vtpVlanIndex='" + self.vtpvlanindex.get() + "']"
    ...
    class Vtpvlantable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"vtpVlanEntry" : ("vtpvlanentry", CISCOVTPMIB.Vtpvlantable.Vtpvlanentry)}
        ...
        class Vtpvlanentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "vtpVlanEntry" + "[managementDomainIndex='" + self.managementdomainindex.get() + "']" + "[vtpVlanIndex='" + self.vtpvlanindex.get() + "']"
                self._absolute_path = lambda: "CISCO-VTP-MIB:CISCO-VTP-MIB/vtpVlanTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOVTPMIB.Vtpvlantable.Vtpvlanentry, ['managementdomainindex', 'vtpvlanindex', 'stpxvlanmistpinstmapinstindex', 'vtpvlanarehopcount', 'vtpvlanbridgenumber', 'vtpvlanbridgetype', 'vtpvlandot10said', 'vtpvlanifindex', 'vtpvlaniscrfbackup', 'vtpvlanmtu', 'vtpvlanname', 'vtpvlanparentvlan', 'vtpvlanringnumber', 'vtpvlanstate', 'vtpvlanstehopcount', 'vtpvlanstptype', 'vtpvlantranslationalvlan1', 'vtpvlantranslationalvlan2', 'vtpvlantype', 'vtpvlantypeext'], name, value)
