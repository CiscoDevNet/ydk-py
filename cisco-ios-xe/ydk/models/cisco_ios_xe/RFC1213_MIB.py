...
class RFC1213MIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"atTable" : ("attable", RFC1213MIB.Attable), "egp" : ("egp", RFC1213MIB.Egp), "egpNeighTable" : ("egpneightable", RFC1213MIB.Egpneightable), "icmp" : ("icmp", RFC1213MIB.Icmp), "ifTable" : ("iftable", RFC1213MIB.Iftable), "interfaces" : ("interfaces", RFC1213MIB.Interfaces), "ip" : ("ip", RFC1213MIB.Ip), "ipAddrTable" : ("ipaddrtable", RFC1213MIB.Ipaddrtable), "ipNetToMediaTable" : ("ipnettomediatable", RFC1213MIB.Ipnettomediatable), "ipRouteTable" : ("iproutetable", RFC1213MIB.Iproutetable), "snmp" : ("snmp", RFC1213MIB.Snmp), "system" : ("system", RFC1213MIB.System), "tcp" : ("tcp", RFC1213MIB.Tcp), "tcpConnTable" : ("tcpconntable", RFC1213MIB.Tcpconntable), "udp" : ("udp", RFC1213MIB.Udp), "udpTable" : ("udptable", RFC1213MIB.Udptable)}
    ...
    class Egp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RFC1213MIB.Egp, ['egpas', 'egpinerrors', 'egpinmsgs', 'egpouterrors', 'egpoutmsgs'], name, value)
    ...
    class Egpneightable(Entity):
        ...
        class Egpneighentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RFC1213MIB.Egpneightable.Egpneighentry, ['egpneighaddr', 'egpneighas', 'egpneigheventtrigger', 'egpneighinerrmsgs', 'egpneighinerrs', 'egpneighinmsgs', 'egpneighintervalhello', 'egpneighintervalpoll', 'egpneighmode', 'egpneighouterrmsgs', 'egpneighouterrs', 'egpneighoutmsgs', 'egpneighstate', 'egpneighstatedowns', 'egpneighstateups'], name, value)
    ...
    class Iftable(Entity):
        ...
        class Ifentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RFC1213MIB.Iftable.Ifentry, ['ifindex', 'ifadminstatus', 'ifdescr', 'ifindiscards', 'ifinerrors', 'ifinnucastpkts', 'ifinoctets', 'ifinucastpkts', 'ifinunknownprotos', 'iflastchange', 'ifmtu', 'ifoperstatus', 'ifoutdiscards', 'ifouterrors', 'ifoutnucastpkts', 'ifoutoctets', 'ifoutqlen', 'ifoutucastpkts', 'ifphysaddress', 'ifspecific', 'ifspeed', 'iftype'], name, value)
    ...
    class Ip(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RFC1213MIB.Ip, ['ipdefaultttl', 'ipforwarding', 'ipforwdatagrams', 'ipfragcreates', 'ipfragfails', 'ipfragoks', 'ipinaddrerrors', 'ipindelivers', 'ipindiscards', 'ipinhdrerrors', 'ipinreceives', 'ipinunknownprotos', 'ipoutdiscards', 'ipoutnoroutes', 'ipoutrequests', 'ipreasmfails', 'ipreasmoks', 'ipreasmreqds', 'ipreasmtimeout', 'iproutingdiscards'], name, value)
    ...
    class Ipaddrtable(Entity):
        ...
        class Ipaddrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RFC1213MIB.Ipaddrtable.Ipaddrentry, ['ipadentaddr', 'ipadentbcastaddr', 'ipadentifindex', 'ipadentnetmask', 'ipadentreasmmaxsize'], name, value)
    ...
    class Iproutetable(Entity):
        ...
        class Iprouteentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(RFC1213MIB.Iproutetable.Iprouteentry, ['iproutedest', 'iprouteage', 'iprouteifindex', 'iprouteinfo', 'iproutemask', 'iproutemetric1', 'iproutemetric2', 'iproutemetric3', 'iproutemetric4', 'iproutemetric5', 'iproutenexthop', 'iprouteproto', 'iproutetype'], name, value)
    ...
    class Snmp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RFC1213MIB.Snmp, ['snmpenableauthentraps', 'snmpinasnparseerrs', 'snmpinbadcommunitynames', 'snmpinbadcommunityuses', 'snmpinbadvalues', 'snmpinbadversions', 'snmpingenerrs', 'snmpingetnexts', 'snmpingetrequests', 'snmpingetresponses', 'snmpinnosuchnames', 'snmpinpkts', 'snmpinreadonlys', 'snmpinsetrequests', 'snmpintoobigs', 'snmpintotalreqvars', 'snmpintotalsetvars', 'snmpintraps', 'snmpoutbadvalues', 'snmpoutgenerrs', 'snmpoutgetnexts', 'snmpoutgetrequests', 'snmpoutgetresponses', 'snmpoutnosuchnames', 'snmpoutpkts', 'snmpoutsetrequests', 'snmpouttoobigs', 'snmpouttraps'], name, value)
    ...
    class System(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RFC1213MIB.System, ['syscontact', 'sysdescr', 'syslocation', 'sysname', 'sysobjectid', 'sysservices', 'sysuptime'], name, value)
    ...
    class Tcp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RFC1213MIB.Tcp, ['tcpactiveopens', 'tcpattemptfails', 'tcpcurrestab', 'tcpestabresets', 'tcpinerrs', 'tcpinsegs', 'tcpmaxconn', 'tcpoutrsts', 'tcpoutsegs', 'tcppassiveopens', 'tcpretranssegs', 'tcprtoalgorithm', 'tcprtomax', 'tcprtomin'], name, value)
    ...
    class Udp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RFC1213MIB.Udp, ['udpindatagrams', 'udpinerrors', 'udpnoports', 'udpoutdatagrams'], name, value)
