...
class ClearForwarding(Entity):
    ...
    class Input(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(ClearForwarding.Input, ['all', 'prefix_ip', 'vrf_name'], name, value)
...
class ClearMsgCounters(Entity):
    ...
    class Input(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(ClearMsgCounters.Input, ['all', 'nbr_ip', 'vrf_name'], name, value)
...
class MplsLdp(Entity):
    ...
    def __init__(self):
        ...
        self.is_top_level_class = True
        self.has_list_ancestor = False
        self._child_container_classes = {"mpls-ldp-config" : ("mpls_ldp_config", MplsLdp.MplsLdpConfig), "mpls-ldp-state" : ("mpls_ldp_state", MplsLdp.MplsLdpState)}
        self._child_list_classes = {}
    ...
    class MplsLdpConfig(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"discovery" : ("discovery", MplsLdp.MplsLdpConfig.Discovery), "dual-stack" : ("dual_stack", MplsLdp.MplsLdpConfig.DualStack), "global-cfg" : ("global_cfg", MplsLdp.MplsLdpConfig.GlobalCfg), "graceful-restart" : ("graceful_restart", MplsLdp.MplsLdpConfig.GracefulRestart), "interfaces" : ("interfaces", MplsLdp.MplsLdpConfig.Interfaces), "label-cfg" : ("label_cfg", MplsLdp.MplsLdpConfig.LabelCfg), "logging" : ("logging", MplsLdp.MplsLdpConfig.Logging), "nbr-table" : ("nbr_table", MplsLdp.MplsLdpConfig.NbrTable), "passwords" : ("passwords", MplsLdp.MplsLdpConfig.Passwords), "routing" : ("routing", MplsLdp.MplsLdpConfig.Routing), "session" : ("session", MplsLdp.MplsLdpConfig.Session)}
            self._child_list_classes = {}
        ...
        class Discovery(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"int-trans-addrs" : ("int_trans_addrs", MplsLdp.MplsLdpConfig.Discovery.IntTransAddrs), "link-hello" : ("link_hello", MplsLdp.MplsLdpConfig.Discovery.LinkHello), "targeted-hello" : ("targeted_hello", MplsLdp.MplsLdpConfig.Discovery.TargetedHello)}
                self._child_list_classes = {}
            ...
            class IntTransAddrs(Entity):
                ...
                class IntTransAddr(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpConfig.Discovery.IntTransAddrs.IntTransAddr, ['af_name', 'int_name', 'trans_int', 'trans_ip'], name, value)
            ...
            class TargetedHello(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.Discovery.TargetedHello, ['enable', 'holdtime', 'interval'], name, value)
        ...
        class GlobalCfg(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"per-af" : ("per_af", MplsLdp.MplsLdpConfig.GlobalCfg.PerAf), "session" : ("session", MplsLdp.MplsLdpConfig.GlobalCfg.Session)}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpConfig.GlobalCfg, ['admin_status', 'dcsp_val', 'disable_delay', 'disable_delay_proc', 'disable_quick_start', 'enable_nsr', 'high_priority', 'init_sess_thresh', 'loop_detection', 'protocol', 'seconds', 'seconds_delay_proc', 'shutdown'], name, value)
            ...
            class PerAf(Entity):
                ...
                class AfCfg(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpConfig.GlobalCfg.PerAf.AfCfg, ['vrf_name', 'af_name', 'default_route', 'implicit', 'interface', 'ipaddr'], name, value)
            ...
            class RouterId(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.GlobalCfg.RouterId, ['vrf_name', 'force', 'lsr_id_if', 'lsr_id_ip'], name, value)
            ...
            class Session(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.GlobalCfg.Session, ['backoff_init', 'backoff_max', 'infinite', 'seconds'], name, value)
                ...
                class Protection(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpConfig.GlobalCfg.Session.Protection, ['enable_prot', 'inf', 'peer_filter', 'seconds'], name, value)
        ...
        class GracefulRestart(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpConfig.GracefulRestart, ['forwarding_holding', 'is_graceful_restartable', 'max_recovery', 'nbr_liveness'], name, value)
        ...
        class Interfaces(Entity):
            ...
            class Interface(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.Interfaces.Interface, ['vrf', 'interface', 'disable_delay', 'disable_quick_start_int', 'link_hello_hold', 'link_hello_int', 'seconds'], name, value)
                ...
                class Afs(Entity):
                    ...
                    class Af(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpConfig.Interfaces.Interface.Afs.Af, ['af_name', 'autoconfig_disable', 'enable'], name, value)
                        ...
                        class BgpRedist(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsLdp.MplsLdpConfig.Interfaces.Interface.Afs.Af.BgpRedist, ['advertise_to', 'as_xx', 'as_yy', 'enable'], name, value)
        ...
        class LabelCfg(Entity):
            ...
            class LabelAfCfg(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.LabelCfg.LabelAfCfg, ['vrf_name', 'af_name', 'host_route_enable', 'prefix_filter'], name, value)
        ...
        class Logging(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpConfig.Logging, ['adjacency', 'graceful_restart', 'neighbor', 'nsr', 'session_protection'], name, value)
        ...
        class NbrTable(Entity):
            ...
            class NbrCfg(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.NbrTable.NbrCfg, ['nbr_vrf', 'nbr_ip', 'admin_status', 'implicit_withdraw', 'label_binding_filter', 'label_protocol', 'password', 'targeted'], name, value)
        ...
        class Passwords(Entity):
            ...
            class Password(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.Passwords.Password, ['nbr_vrf', 'nbr_id', 'password_num', 'clear_pass', 'encrypt_pass', 'keychain_pass', 'pass_required'], name, value)
        ...
        class Routing(Entity):
            ...
            class RoutingInst(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpConfig.Routing.RoutingInst, ['routing_inst_name', 'area_id', 'autoconfig_enable', 'level_id', 'sync'], name, value)
        ...
        class Session(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpConfig.Session, ['backoff', 'infinite', 'seconds'], name, value)
    ...
    class MplsLdpState(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"backoff-parameters" : ("backoff_parameters", MplsLdp.MplsLdpState.BackoffParameters), "bindings" : ("bindings", MplsLdp.MplsLdpState.Bindings), "bindings-summary" : ("bindings_summary", MplsLdp.MplsLdpState.BindingsSummary), "capabilities" : ("capabilities", MplsLdp.MplsLdpState.Capabilities), "discovery" : ("discovery", MplsLdp.MplsLdpState.Discovery), "forwarding" : ("forwarding", MplsLdp.MplsLdpState.Forwarding), "forwarding-summary" : ("forwarding_summary", MplsLdp.MplsLdpState.ForwardingSummary), "graceful-restart" : ("graceful_restart", MplsLdp.MplsLdpState.GracefulRestart), "icpm-summary-all" : ("icpm_summary_all", MplsLdp.MplsLdpState.IcpmSummaryAll), "label-ranges" : ("label_ranges", MplsLdp.MplsLdpState.LabelRanges), "neighbors" : ("neighbors", MplsLdp.MplsLdpState.Neighbors), "nsr-summary-all" : ("nsr_summary_all", MplsLdp.MplsLdpState.NsrSummaryAll), "oper-summary" : ("oper_summary", MplsLdp.MplsLdpState.OperSummary), "parameters" : ("parameters", MplsLdp.MplsLdpState.Parameters), "vrfs" : ("vrfs", MplsLdp.MplsLdpState.Vrfs)}
            self._child_list_classes = {}
        ...
        class BackoffParameters(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.BackoffParameters, ['backoff_seconds', 'initial_seconds', 'maximum_seconds', 'waiting_seconds'], name, value)
        ...
        class Bindings(Entity):
            ...
            class Binding(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self._child_container_classes = {}
                    self._child_list_classes = {"peers-advertised-to" : ("peers_advertised_to", MplsLdp.MplsLdpState.Bindings.Binding.PeersAdvertisedTo), "remote-binding" : ("remote_binding", MplsLdp.MplsLdpState.Bindings.Binding.RemoteBinding)}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Bindings.Binding, ['vrf_name', 'prefix', 'advertise_lsr_filter', 'advertise_prefix_filter', 'config_enforced_local_label_value', 'fwd_prefix', 'is_no_route', 'label_oor', 'le_local_binding_revision', 'le_local_label_state', 'local_label', 'prefix_length'], name, value)
                ...
                class PeersAdvertisedTo(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Bindings.Binding.PeersAdvertisedTo, ['label_space_id', 'lsr_id'], name, value)
                ...
                class RemoteBinding(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Bindings.Binding.RemoteBinding, ['is_stale', 'remote_label'], name, value)
                    ...
                    class AssigningPeerLdpIdent(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpState.Bindings.Binding.RemoteBinding.AssigningPeerLdpIdent, ['label_space_id', 'lsr_id'], name, value)
            ...
            class BindingsSumAfs(Entity):
                ...
                class BindingSumAf(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Bindings.BindingsSumAfs.BindingSumAf, ['vrf_name', 'af_name', 'binding_local', 'binding_local_explicit_null', 'binding_local_implicit_null', 'binding_local_no_route', 'binding_local_non_null', 'binding_local_null', 'binding_local_oor', 'binding_no_route', 'binding_remote', 'binding_total', 'highest_allocated_label', 'lowest_allocated_label'], name, value)
        ...
        class BindingsSummary(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.BindingsSummary, ['binding_local', 'binding_local_explicit_null', 'binding_local_implicit_null', 'binding_local_no_route', 'binding_local_non_null', 'binding_local_null', 'binding_local_oor', 'binding_no_route', 'binding_remote', 'binding_total', 'highest_allocated_label', 'lowest_allocated_label'], name, value)
        ...
        class Capabilities(Entity):
            ...
            class Capability(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Capabilities.Capability, ['cap_type', 'cap_des', 'capability_data', 'capability_data_length', 'capability_owner'], name, value)
        ...
        class Discovery(Entity):
            ...
            class DiscoveryStats(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Discovery.DiscoveryStats, ['num_of_active_ldp_interfaces', 'num_of_ldp_interfaces', 'num_of_lnk_disc_recv', 'num_of_lnk_disc_xmit', 'num_of_tgt_disc_recv', 'num_of_tgt_disc_xmit'], name, value)
            ...
            class LinkHelloState(Entity):
                ...
                class LinkHellos(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Discovery.LinkHelloState.LinkHellos, ['interface', 'nbr_transport_addr', 'hello_interval', 'hold_time_remaining', 'local_src_addr', 'local_transport_addr', 'nbr_hold_time', 'nbr_ldp_id', 'nbr_src_addr', 'next_hello', 'session_up'], name, value)
            ...
            class TargetedHellos(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Discovery.TargetedHellos, ['targeted_hello_hold_time', 'targeted_hello_interval'], name, value)
                ...
                class TargetedHello(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Discovery.TargetedHellos.TargetedHello, ['vrf_name', 'target_address', 'hold_time_remaining', 'local_address', 'nbr_hold_time', 'neighbor_ldp_identifier', 'next_hello', 'state'], name, value)
        ...
        class Forwarding(Entity):
            ...
            class ForwardingDetail(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail, ['vrf_name', 'prefix', 'fwd_prefix', 'prefix_length', 'table_id'], name, value)
                ...
                class Paths(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = True
                        self._child_container_classes = {"mpls" : ("mpls", MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Mpls), "routing" : ("routing", MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Routing)}
                        self._child_list_classes = {}
                    ...
                    class Mpls(Entity):
                        ...
                        class MplsOutgoingInfo(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Mpls.MplsOutgoingInfo, ['is_from_graceful_restartable_neighbor', 'is_stale', 'out_label', 'out_label_owner', 'out_label_type'], name, value)
                            ...
                            class NexthopPeerLdpIdent(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Mpls.MplsOutgoingInfo.NexthopPeerLdpIdent, ['label_space_id', 'lsr_id'], name, value)
                        ...
                        class RemoteLfa(Entity):
                            ...
                            class MplsOutgoingInfo(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Mpls.RemoteLfa.MplsOutgoingInfo, ['is_from_graceful_restartable_neighbor', 'is_stale', 'out_label', 'out_label_owner', 'out_label_type'], name, value)
                                ...
                                class NexthopPeerLdpIdent(Entity):
                                    ...
                                    def __setattr__(self, name, value):
                                        self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Mpls.RemoteLfa.MplsOutgoingInfo.NexthopPeerLdpIdent, ['label_space_id', 'lsr_id'], name, value)
                    ...
                    class Routing(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Paths.Routing, ['bkup_path_id', 'has_remote_lfa_bkup', 'interface', 'load_metric', 'next_hop', 'next_hop_table_id', 'nexthop_id', 'nh_is_overriden', 'path_id', 'path_type', 'remote_node_id'], name, value)
                ...
                class Route(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingDetail.Route, ['forwarding_update_age', 'forwarding_update_count', 'forwarding_update_timestamp', 'is_local_vrf_leaked', 'local_label', 'metric', 'priority', 'routing_update_age', 'routing_update_count', 'routing_update_timestamp', 'source', 'type', 'version'], name, value)
            ...
            class ForwardingVrfSumms(Entity):
                ...
                class ForwardingVrfSumm(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = False
                        self._child_container_classes = {"nhs" : ("nhs", MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Nhs), "pfxs" : ("pfxs", MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Pfxs)}
                        self._child_list_classes = {}
                    ...
                    class Nhs(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Nhs, ['backup_paths', 'labeled_backup_paths', 'labeled_paths', 'protected_paths', 'remote_backup_paths', 'total_paths'], name, value)
                    ...
                    class Pfxs(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"labeled-pfxs-aggr" : ("labeled_pfxs_aggr", MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Pfxs.LabeledPfxsAggr), "labeled-pfxs-backup" : ("labeled_pfxs_backup", MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Pfxs.LabeledPfxsBackup), "labeled-pfxs-primary" : ("labeled_pfxs_primary", MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Pfxs.LabeledPfxsPrimary)}
                            self._child_list_classes = {}
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpState.Forwarding.ForwardingVrfSumms.ForwardingVrfSumm.Pfxs, ['ecmp_pfxs', 'protected_pfxs', 'total_pfxs'], name, value)
        ...
        class ForwardingSummary(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"nhs" : ("nhs", MplsLdp.MplsLdpState.ForwardingSummary.Nhs), "pfxs" : ("pfxs", MplsLdp.MplsLdpState.ForwardingSummary.Pfxs)}
                self._child_list_classes = {}
            ...
            class Nhs(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.ForwardingSummary.Nhs, ['backup_paths', 'labeled_backup_paths', 'labeled_paths', 'protected_paths', 'remote_backup_paths', 'total_paths'], name, value)
            ...
            class Pfxs(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"labeled-pfxs-aggr" : ("labeled_pfxs_aggr", MplsLdp.MplsLdpState.ForwardingSummary.Pfxs.LabeledPfxsAggr), "labeled-pfxs-backup" : ("labeled_pfxs_backup", MplsLdp.MplsLdpState.ForwardingSummary.Pfxs.LabeledPfxsBackup), "labeled-pfxs-primary" : ("labeled_pfxs_primary", MplsLdp.MplsLdpState.ForwardingSummary.Pfxs.LabeledPfxsPrimary)}
                    self._child_list_classes = {}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.ForwardingSummary.Pfxs, ['ecmp_pfxs', 'protected_pfxs', 'total_pfxs'], name, value)
        ...
        class GracefulRestart(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.GracefulRestart, ['forwarding_state_hold_timer_remaining_seconds', 'graceful_restart_forwarding_state_hold_time', 'graceful_restart_reconnect_timeout', 'is_forwarding_state_hold_timer_running', 'is_graceful_restart_configured'], name, value)
        ...
        class IcpmSummaryAll(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.IcpmSummaryAll, ['iccp_rg_app_data_count', 'iccp_rg_conn_count', 'iccp_rg_disconn_count', 'iccp_rg_notif_count'], name, value)
                ...
                class RedGroup(Entity):
                    ...
                    class IcpmProtocols(Entity):
                        ...
                        class RedunGroups(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsLdp.MplsLdpState.IcpmSummaryAll.IcpmRgidTableInfo.RedGroup.IcpmProtocols.RedunGroups, ['rg_id', 'client_id', 'peer_id', 'state'], name, value)
                ...
                class SessionTable(Entity):
                    ...
                    class IcpmProtocols(Entity):
                        ...
                        class RedunGroups(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsLdp.MplsLdpState.IcpmSummaryAll.IcpmSessionTable.SessionTable.IcpmProtocols.RedunGroups, ['rg_id', 'client_id', 'peer_id', 'state'], name, value)
        ...
        class Neighbors(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"backoffs" : ("backoffs", MplsLdp.MplsLdpState.Neighbors.Backoffs), "nsr-nbr-detail" : ("nsr_nbr_detail", MplsLdp.MplsLdpState.Neighbors.NsrNbrDetail), "stats-info" : ("stats_info", MplsLdp.MplsLdpState.Neighbors.StatsInfo)}
                self._child_list_classes = {"nbr-adjs" : ("nbr_adjs", MplsLdp.MplsLdpState.Neighbors.NbrAdjs), "neighbor" : ("neighbor", MplsLdp.MplsLdpState.Neighbors.Neighbor)}
            ...
            class Neighbor(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"capabilities" : ("capabilities", MplsLdp.MplsLdpState.Neighbors.Neighbor.Capabilities), "graceful-restart-adjacency" : ("graceful_restart_adjacency", MplsLdp.MplsLdpState.Neighbors.Neighbor.GracefulRestartAdjacency), "nbr-stats" : ("nbr_stats", MplsLdp.MplsLdpState.Neighbors.Neighbor.NbrStats), "tcp-information" : ("tcp_information", MplsLdp.MplsLdpState.Neighbors.Neighbor.TcpInformation)}
                    self._child_list_classes = {}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.Neighbor, ['vrf_name', 'lsr_id', 'advertise_bgp_prefixes', 'bgp_advertisement_state', 'client', 'downstream_on_demand', 'duplicate_address', 'has_sp', 'inbound_ipv4', 'inbound_ipv6_filter', 'label_space_id', 'nbr_bound_address', 'nbr_path_vector_limit', 'outbound_ipv4_filter', 'outbound_ipv6_filter', 'peer_hold_time', 'peer_keep_alive_interval', 'peer_state', 'session_prot_ver', 'session_role', 'sp_duration', 'sp_filter', 'sp_has_duration', 'sp_state', 'spht_remaining', 'spht_running', 'up_time_seconds'], name, value)
                ...
                class Capabilities(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"received-caps" : ("received_caps", MplsLdp.MplsLdpState.Neighbors.Neighbor.Capabilities.ReceivedCaps), "sent-caps" : ("sent_caps", MplsLdp.MplsLdpState.Neighbors.Neighbor.Capabilities.SentCaps)}
                    ...
                    class ReceivedCaps(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.Neighbor.Capabilities.ReceivedCaps, ['cap_type', 'cap_des', 'capability_data', 'capability_data_length'], name, value)
                    ...
                    class SentCaps(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.Neighbor.Capabilities.SentCaps, ['cap_type', 'cap_des', 'capability_data', 'capability_data_length'], name, value)
                ...
                class GracefulRestartAdjacency(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.Neighbor.GracefulRestartAdjacency, ['down_nbr_down_reason', 'down_nbr_flap_count', 'is_graceful_restartable', 'is_liveness_timer_running', 'is_recovery_timer_running', 'liveness_timer_remaining_seconds', 'reconnect_timeout', 'recovery_time', 'recovery_timer_remaining_seconds'], name, value)
                ...
                class NbrStats(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.Neighbor.NbrStats, ['num_of_nbr_ipv4_addresses', 'num_of_nbr_ipv4_discovery', 'num_of_nbr_ipv4_lbl', 'num_of_nbr_ipv6_addresses', 'num_of_nbr_ipv6_discovery', 'num_of_nbr_ipv6_lbl', 'ta_pies_rcvd', 'ta_pies_sent'], name, value)
                ...
                class TcpInformation(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.Neighbor.TcpInformation, ['foreign_host', 'foreign_port', 'is_md5_on', 'local_host', 'local_port', 'up_time'], name, value)
            ...
            class NsrNbrDetail(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.NsrNbrDetail, ['nsr_nbr_in_label_reqs_created', 'nsr_nbr_in_label_reqs_freed', 'nsr_nbr_in_label_withdraw_created', 'nsr_nbr_in_label_withdraw_freed', 'nsr_nbr_last_sync_error', 'nsr_nbr_last_sync_nack_reason', 'nsr_nbr_lcl_addr_withdraw_cleared', 'nsr_nbr_lcl_addr_withdraw_set', 'nsr_nbr_pend_label_req_resps', 'nsr_nbr_pend_label_withdraw_resps', 'nsr_nbr_pend_lcl_addr_withdraw_acks', 'nsr_nbr_sync_state', 'nsr_nbr_xmit_ctxt_deq', 'nsr_nbr_xmit_ctxt_enq', 'nsr_state', 'path_vector_limit'], name, value)
                ...
                class NbrSess(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.NsrNbrDetail.NbrSess, ['discon_time', 'keep_alive_remain', 'keep_alive_time', 'last_stat_change', 'max_pdu', 'state', 'unknown_mess_err', 'unknown_tlv'], name, value)
            ...
            class StatsInfo(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"message-in" : ("message_in", MplsLdp.MplsLdpState.Neighbors.StatsInfo.MessageIn), "message-out" : ("message_out", MplsLdp.MplsLdpState.Neighbors.StatsInfo.MessageOut)}
                    self._child_list_classes = {}
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.StatsInfo, ['bad_ldpid', 'bad_msg_len', 'bad_pdu_len', 'bad_tlv_len', 'discon_time', 'keep_alive_exp', 'malformed_tlv_val', 'sess_rej_ad', 'sess_rej_lr', 'sess_rej_max_pdu', 'sess_reject_no_hello', 'session_attempts', 'shutdow_notif_sent', 'shutdown_notif_rec'], name, value)
                ...
                class MessageIn(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.StatsInfo.MessageIn, ['address_count', 'address_withdraw_count', 'iccp_rg_app_data_count', 'iccp_rg_conn_count', 'iccp_rg_disconn_count', 'iccp_rg_notif_count', 'init_count', 'keep_alive_count', 'label_abort_request_count', 'label_map_count', 'label_release_count', 'label_request_count', 'label_withdraw_count', 'notification_count', 'total_count'], name, value)
                ...
                class MessageOut(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Neighbors.StatsInfo.MessageOut, ['address_count', 'address_withdraw_count', 'iccp_rg_app_data_count', 'iccp_rg_conn_count', 'iccp_rg_disconn_count', 'iccp_rg_notif_count', 'init_count', 'keep_alive_count', 'label_abort_request_count', 'label_map_count', 'label_release_count', 'label_request_count', 'label_withdraw_count', 'notification_count', 'total_count'], name, value)
        ...
        class NsrSummaryAll(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.NsrSummaryAll, ['nsr_sum_in_label_reqs_created', 'nsr_sum_in_label_reqs_freed', 'nsr_sum_in_label_withdraw_created', 'nsr_sum_in_label_withdraw_freed', 'nsr_sum_lcl_addr_withdraw_cleared', 'nsr_sum_lcl_addr_withdraw_set'], name, value)
        ...
        class OperSummary(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.OperSummary, ['no_of_ipv4_rib_tbl', 'no_of_ipv4_rib_tbl_reg', 'number_of_autocfg_interfaces', 'number_of_fwd_ref_interfaces', 'number_of_interfaces', 'number_of_vrf', 'number_of_vrf_oper'], name, value)
            ...
            class Common(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(MplsLdp.MplsLdpState.OperSummary.Common, ['address_families', 'number_of_downstream_on_demand_neighbors', 'number_of_graceful_restart_neighbors', 'number_of_ipv4_local_addresses', 'number_of_ipv4_routes', 'number_of_ipv4ldp_interfaces', 'number_of_ldp_interfaces', 'number_of_neighbors', 'numberof_ipv4_hello_adj'], name, value)
        ...
        class Parameters(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(MplsLdp.MplsLdpState.Parameters, ['af_binding_withdraw_delay', 'discovery_quick_start_disabled_on_interfaces', 'dod_max_hop', 'feature', 'global_md5_password_enabled', 'keepalive_interval', 'le_no_route_timeout', 'loop_detection', 'max_intf_attached', 'max_intf_te', 'max_peer', 'out_of_mem_state', 'protocol_version', 'session_hold_time'], name, value)
        ...
        class Vrfs(Entity):
            ...
            class Vrf(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"afs" : ("afs", MplsLdp.MplsLdpState.Vrfs.Vrf.Afs), "vrf-summary" : ("vrf_summary", MplsLdp.MplsLdpState.Vrfs.Vrf.VrfSummary)}
                    self._child_list_classes = {}
                ...
                class Afs(Entity):
                    ...
                    class Af(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"igp" : ("igp", MplsLdp.MplsLdpState.Vrfs.Vrf.Afs.Af.Igp), "interface-summary" : ("interface_summary", MplsLdp.MplsLdpState.Vrfs.Vrf.Afs.Af.InterfaceSummary)}
                            self._child_list_classes = {}
                        ...
                        class Igp(Entity):
                            ...
                            class Sync(Entity):
                                ...
                                def __setattr__(self, name, value):
                                    self._perform_setattr(MplsLdp.MplsLdpState.Vrfs.Vrf.Afs.Af.Igp.Sync, ['interface', 'delay_timer_remaining', 'igp_sync_down_reason', 'igp_sync_state', 'is_delay_timer_running'], name, value)
                                ...
                                class Peers(Entity):
                                    ...
                                    def __setattr__(self, name, value):
                                        self._perform_setattr(MplsLdp.MplsLdpState.Vrfs.Vrf.Afs.Af.Igp.Sync.Peers, ['is_chkpt_created', 'is_gr_enabled', 'peer_id'], name, value)
                        ...
                        class InterfaceSummary(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsLdp.MplsLdpState.Vrfs.Vrf.Afs.Af.InterfaceSummary, ['auto_config', 'auto_config_disabled', 'auto_config_forward_reference_interfaces', 'configured_attached_interface', 'configured_te_interface', 'forward_references', 'known_ip_interface_count', 'known_ip_interface_ldp_enabled'], name, value)
                ...
                class VrfSummary(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(MplsLdp.MplsLdpState.Vrfs.Vrf.VrfSummary, ['address_families', 'number_of_downstream_on_demand_neighbors', 'number_of_graceful_restart_neighbors', 'number_of_ipv4_local_addresses', 'number_of_ipv4_routes', 'number_of_ipv4ldp_interfaces', 'number_of_ldp_interfaces', 'number_of_neighbors', 'numberof_ipv4_hello_adj'], name, value)
...
class RestartNeighbor(Entity):
    ...
    class Input(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(RestartNeighbor.Input, ['all', 'nbr_ip', 'vrf_name'], name, value)
