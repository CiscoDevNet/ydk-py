...
class CISCOIETFPWATMMIB(object):
    ...
    .. attribute:: cpwvcatmtable
    	...
    	**type**\: :py:class:`CpwVcAtmTable <ydk.models.ietf.CISCO_IETF_PW_ATM_MIB.CISCOIETFPWATMMIB.CpwVcAtmTable>`
    ...
    class CpwVcAtmTable(object):
        ...
        .. attribute:: cpwvcatmentry
        	...
        	**type**\: list of :py:class:`CpwVcAtmEntry <ydk.models.ietf.CISCO_IETF_PW_ATM_MIB.CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry>`
        ...
        class CpwVcAtmEntry(object):
            ...
            .. attribute:: cpwatmencap
            	...
            	**type**\: :py:class:`CpwAtmEncap_Enum <ydk.models.ietf.CISCO_IETF_PW_ATM_MIB.CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry.CpwAtmEncap_Enum>`
            ...
            class CpwAtmEncap_Enum(Enum):
                ...
                @staticmethod
                def _meta_info():
                    from ydk.models.ietf._meta import _CISCO_IETF_PW_ATM_MIB as meta
                    return meta._meta_table['CISCOIETFPWATMMIB.CpwVcAtmTable.CpwVcAtmEntry.CpwAtmEncap_Enum']
    ...
    def _has_data(self):
        ...
        if self.cpwvcatmtable is not None and self.cpwvcatmtable.is_presence():
            return True
