...
_meta_table = {
    'IGMPSTDMIB.IgmpCacheTable.IgmpCacheEntry' : {
        'meta_info' : _MetaInfoClass('IGMPSTDMIB.IgmpCacheTable.IgmpCacheEntry',
            ...
            _MetaInfoClassMember('igmpCacheSelf', ATTRIBUTE, 'bool' , None, None, 
                ...
                'igmpcacheself',
                'IGMP-STD-MIB', False),
            _MetaInfoClassMember('igmpCacheStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'IGMPSTDMIB.IgmpCacheTable' : {
        'meta_info' : _MetaInfoClass('IGMPSTDMIB.IgmpCacheTable',
            False, 
            [
            _MetaInfoClassMember('igmpCacheEntry', REFERENCE_LIST, 'IgmpCacheEntry' , 'ydk.models.igmp.IGMP_STD_MIB', 'IGMPSTDMIB.IgmpCacheTable.IgmpCacheEntry', 
                [], [], 
    ...
    'IGMPSTDMIB.IgmpInterfaceTable.IgmpInterfaceEntry' : {
        'meta_info' : _MetaInfoClass('IGMPSTDMIB.IgmpInterfaceTable.IgmpInterfaceEntry',
            ...
            _MetaInfoClassMember('igmpInterfaceRobustness', ATTRIBUTE, 'int' , None, None, 
                ...
                'IGMP-STD-MIB', False),
            _MetaInfoClassMember('igmpInterfaceStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'IGMPSTDMIB.IgmpInterfaceTable' : {
        'meta_info' : _MetaInfoClass('IGMPSTDMIB.IgmpInterfaceTable',
            False, 
            [
            _MetaInfoClassMember('igmpInterfaceEntry', REFERENCE_LIST, 'IgmpInterfaceEntry' , 'ydk.models.igmp.IGMP_STD_MIB', 'IGMPSTDMIB.IgmpInterfaceTable.IgmpInterfaceEntry', 
                [], [], 
    ...
    'IGMPSTDMIB' : {
        'meta_info' : _MetaInfoClass('IGMPSTDMIB',
            False, 
            [
            _MetaInfoClassMember('igmpCacheTable', REFERENCE_CLASS, 'IgmpCacheTable' , 'ydk.models.igmp.IGMP_STD_MIB', 'IGMPSTDMIB.IgmpCacheTable', 
                [], [], 
                ...
                'igmpcachetable',
                'IGMP-STD-MIB', False),
            _MetaInfoClassMember('igmpInterfaceTable', REFERENCE_CLASS, 'IgmpInterfaceTable' , 'ydk.models.igmp.IGMP_STD_MIB', 'IGMPSTDMIB.IgmpInterfaceTable', 
                [], [], 
