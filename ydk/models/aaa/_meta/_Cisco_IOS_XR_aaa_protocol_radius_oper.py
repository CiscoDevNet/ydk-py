...
_meta_table = {
    ...
    'Radius.Nodes.Node.DeadCriteria.Hosts.Host' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes.Node.DeadCriteria.Hosts.Host',
            ...
            _MetaInfoClassMember('time', REFERENCE_CLASS, 'Time' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.DeadCriteria.Hosts.Host.Time', 
                ...
                'time',
                'Cisco-IOS-XR-aaa-protocol-radius-oper', False),
            _MetaInfoClassMember('tries', REFERENCE_CLASS, 'Tries' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.DeadCriteria.Hosts.Host.Tries', 
                [], [], 
                '''                Number of tries
                ''',
                'tries',
    ...
    'Radius.Nodes.Node.DeadCriteria.Hosts' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes.Node.DeadCriteria.Hosts',
            False, 
            [
            _MetaInfoClassMember('host', REFERENCE_LIST, 'Host' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.DeadCriteria.Hosts.Host', 
                [], [], 
                '''                RADIUS Server
                ''',
                'host',
    ...
    'Radius.Nodes.Node.DeadCriteria' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes.Node.DeadCriteria',
            False, 
            [
            _MetaInfoClassMember('hosts', REFERENCE_CLASS, 'Hosts' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.DeadCriteria.Hosts', 
                [], [], 
    ...
    'Radius.Nodes.Node.ServerGroups.ServerGroup.ServerGroup' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes.Node.ServerGroups.ServerGroup.ServerGroup',
            False, 
            [
            _MetaInfoClassMember('accounting', REFERENCE_CLASS, 'Accounting' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.ServerGroups.ServerGroup.ServerGroup.Accounting', 
                [], [], 
                '''                Accounting data
                ''',
                'accounting',
    ...
    'Radius.Nodes.Node.ServerGroups' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes.Node.ServerGroups',
            False, 
            [
            _MetaInfoClassMember('server-group', REFERENCE_LIST, 'ServerGroup' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.ServerGroups.ServerGroup', 
                [], [], 
    ...
    'Radius.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes.Node',
            ...
            _MetaInfoClassMember('client', REFERENCE_CLASS, 'Client' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.Client', 
                ...
                'client',
                'Cisco-IOS-XR-aaa-protocol-radius-oper', False),
            _MetaInfoClassMember('dead-criteria', REFERENCE_CLASS, 'DeadCriteria' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node.DeadCriteria', 
                [], [], 
    ...
    'Radius.Nodes' : {
        'meta_info' : _MetaInfoClass('Radius.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes.Node', 
                [], [], 
    ...
    'Radius' : {
        'meta_info' : _MetaInfoClass('Radius',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper', 'Radius.Nodes', 
                [], [], 
