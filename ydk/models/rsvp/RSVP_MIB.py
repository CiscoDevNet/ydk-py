...
from ydk.models.integrated.INTEGRATED_SERVICES_MIB import QosService_Enum
from ydk.models.snmpv2.SNMPv2_TC import RowStatus_Enum

class RsvpEncapsulation_Enum(Enum):
    """
    RsvpEncapsulation_Enum
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.rsvp._meta import _RSVP_MIB as meta
        return meta._meta_table['RsvpEncapsulation_Enum']
...
class RSVPMIB(object):
    ...
    .. attribute:: rsvpgenobjects
    	...
    	**type**\: :py:class:`RsvpGenObjects <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpGenObjects>`
    
    .. attribute:: rsvpiftable
    
    	The	RSVP\-specific attributes of  the  system's interfaces
    	**type**\: :py:class:`RsvpIfTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpIfTable>`
    
    .. attribute:: rsvpnbrtable
    
    	Information	describing  the	 Neighbors  of	an RSVP	system
    	**type**\: :py:class:`RsvpNbrTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpNbrTable>`
    
    .. attribute:: rsvpresvfwdtable
    
    	Information	describing the	state  information displayed upstream in RESV messages
    	**type**\: :py:class:`RsvpResvFwdTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpResvFwdTable>`
    
    .. attribute:: rsvpresvtable
    
    	Information	describing the	state  information displayed by	receivers in RESV messages
    	**type**\: :py:class:`RsvpResvTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpResvTable>`
    ...
    .. attribute:: rsvpsenderoutinterfacetable
    	...
    	**type**\: :py:class:`RsvpSenderOutInterfaceTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpSenderOutInterfaceTable>`
    
    .. attribute:: rsvpsendertable
    
    	Information	describing the	state  information displayed by	senders	in PATH	messages
    	**type**\: :py:class:`RsvpSenderTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpSenderTable>`
    
    .. attribute:: rsvpsessiontable
    
    	A table  of	 all  sessions	seen  by  a  given system
    	**type**\: :py:class:`RsvpSessionTable <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpSessionTable>`
    ...
    class RsvpIfTable(object):
        ...
        .. attribute:: rsvpifentry
        	...
        	**type**\: list of :py:class:`RsvpIfEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpIfTable.RsvpIfEntry>`
    ...
    class RsvpNbrTable(object):
        ...
        .. attribute:: rsvpnbrentry
        	...
        	**type**\: list of :py:class:`RsvpNbrEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpNbrTable.RsvpNbrEntry>`
        ...
        class RsvpNbrEntry(object):
            ...
            .. attribute:: rsvpnbrprotocol
            	...
            	**type**\: :py:class:`RsvpEncapsulation_Enum <ydk.models.rsvp.RSVP_MIB.RsvpEncapsulation_Enum>`
            ...
            def _common_path(self):
                ...
                if self.rsvpnbraddress is None:
                    raise YPYDataValidationError('Key property rsvpnbraddress is None')
    ...
    class RsvpResvFwdTable(object):
        ...
        .. attribute:: rsvpresvfwdentry
        	...
        	**type**\: list of :py:class:`RsvpResvFwdEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpResvFwdTable.RsvpResvFwdEntry>`
        ...
        class RsvpResvFwdEntry(object):
            ...
            .. attribute:: rsvpresvfwdservice
            	...
            	**type**\: :py:class:`QosService_Enum <ydk.models.integrated.INTEGRATED_SERVICES_MIB.QosService_Enum>`
            ...
            def _common_path(self):
                if self.rsvpresvfwdnumber is None:
                    raise YPYDataValidationError('Key property rsvpresvfwdnumber is None')
                if self.rsvpsessionnumber is None:
                    raise YPYDataValidationError('Key property rsvpsessionnumber is None')

                return '/RSVP-MIB:RSVP-MIB/RSVP-MIB:rsvpResvFwdTable/RSVP-MIB:rsvpResvFwdEntry[RSVP-MIB:rsvpResvFwdNumber = ' + str(self.rsvpresvfwdnumber) + '][RSVP-MIB:rsvpSessionNumber = ' + str(self.rsvpsessionnumber) + ']'
    ...
    class RsvpResvTable(object):
        ...
        .. attribute:: rsvpresventry
        	...
        	**type**\: list of :py:class:`RsvpResvEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpResvTable.RsvpResvEntry>`
        ...
        class RsvpResvEntry(object):
            ...
            def _common_path(self):
                if self.rsvpresvnumber is None:
                    raise YPYDataValidationError('Key property rsvpresvnumber is None')
                if self.rsvpsessionnumber is None:
                    raise YPYDataValidationError('Key property rsvpsessionnumber is None')

                return '/RSVP-MIB:RSVP-MIB/RSVP-MIB:rsvpResvTable/RSVP-MIB:rsvpResvEntry[RSVP-MIB:rsvpResvNumber = ' + str(self.rsvpresvnumber) + '][RSVP-MIB:rsvpSessionNumber = ' + str(self.rsvpsessionnumber) + ']'
    ...
    class RsvpSenderOutInterfaceTable(object):
        ...
        .. attribute:: rsvpsenderoutinterfaceentry
        	...
        	**type**\: list of :py:class:`RsvpSenderOutInterfaceEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpSenderOutInterfaceTable.RsvpSenderOutInterfaceEntry>`
        ...
        class RsvpSenderOutInterfaceEntry(object):
            ...
            def _common_path(self):
                ...
                if self.rsvpsendernumber is None:
                    raise YPYDataValidationError('Key property rsvpsendernumber is None')
                if self.rsvpsessionnumber is None:
                    raise YPYDataValidationError('Key property rsvpsessionnumber is None')

                return '/RSVP-MIB:RSVP-MIB/RSVP-MIB:rsvpSenderOutInterfaceTable/RSVP-MIB:rsvpSenderOutInterfaceEntry[RSVP-MIB:ifIndex = ' + str(self.ifindex) + '][RSVP-MIB:rsvpSenderNumber = ' + str(self.rsvpsendernumber) + '][RSVP-MIB:rsvpSessionNumber = ' + str(self.rsvpsessionnumber) + ']'
    ...
    class RsvpSenderTable(object):
        ...
        .. attribute:: rsvpsenderentry
        	...
        	**type**\: list of :py:class:`RsvpSenderEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpSenderTable.RsvpSenderEntry>`
        ...
        class RsvpSenderEntry(object):
            ...
            def _common_path(self):
                ...
                return '/RSVP-MIB:RSVP-MIB/RSVP-MIB:rsvpSenderTable/RSVP-MIB:rsvpSenderEntry[RSVP-MIB:rsvpSenderNumber = ' + str(self.rsvpsendernumber) + '][RSVP-MIB:rsvpSessionNumber = ' + str(self.rsvpsessionnumber) + ']'
    ...
    class RsvpSessionTable(object):
        ...
        .. attribute:: rsvpsessionentry
        	...
        	**type**\: list of :py:class:`RsvpSessionEntry <ydk.models.rsvp.RSVP_MIB.RSVPMIB.RsvpSessionTable.RsvpSessionEntry>`
    ...
    def _has_data(self):
        ...
        if self.rsvpgenobjects is not None and self.rsvpgenobjects.is_presence():
            return True

        if self.rsvpiftable is not None and self.rsvpiftable._has_data():
            return True

        if self.rsvpiftable is not None and self.rsvpiftable.is_presence():
            return True

        if self.rsvpnbrtable is not None and self.rsvpnbrtable._has_data():
            return True

        if self.rsvpnbrtable is not None and self.rsvpnbrtable.is_presence():
            return True

        if self.rsvpresvfwdtable is not None and self.rsvpresvfwdtable._has_data():
            return True

        if self.rsvpresvfwdtable is not None and self.rsvpresvfwdtable.is_presence():
            return True

        if self.rsvpresvtable is not None and self.rsvpresvtable._has_data():
            return True

        if self.rsvpresvtable is not None and self.rsvpresvtable.is_presence():
            return True

        if self.rsvpsenderoutinterfacetable is not None and self.rsvpsenderoutinterfacetable._has_data():
            return True

        if self.rsvpsenderoutinterfacetable is not None and self.rsvpsenderoutinterfacetable.is_presence():
            return True

        if self.rsvpsendertable is not None and self.rsvpsendertable._has_data():
            return True

        if self.rsvpsendertable is not None and self.rsvpsendertable.is_presence():
            return True

        if self.rsvpsessiontable is not None and self.rsvpsessiontable._has_data():
            return True

        if self.rsvpsessiontable is not None and self.rsvpsessiontable.is_presence():
            return True
