...
class CISCOOSPFMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cospfGeneralGroup" : ("cospfgeneralgroup", CISCOOSPFMIB.Cospfgeneralgroup), "cospfLocalLsdbTable" : ("cospflocallsdbtable", CISCOOSPFMIB.Cospflocallsdbtable), "cospfLsdbTable" : ("cospflsdbtable", CISCOOSPFMIB.Cospflsdbtable), "cospfShamLinkNbrTable" : ("cospfshamlinknbrtable", CISCOOSPFMIB.Cospfshamlinknbrtable), "cospfShamLinksTable" : ("cospfshamlinkstable", CISCOOSPFMIB.Cospfshamlinkstable), "cospfShamLinkTable" : ("cospfshamlinktable", CISCOOSPFMIB.Cospfshamlinktable), "cospfVirtLocalLsdbTable" : ("cospfvirtlocallsdbtable", CISCOOSPFMIB.Cospfvirtlocallsdbtable)}
    ...
    class Cospfgeneralgroup(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOOSPFMIB.Cospfgeneralgroup, ['cospfopaqueaslsacksumsum', 'cospfopaqueaslsacount', 'cospfopaquelsasupport', 'cospfrfc1583compatibility', 'cospftrafficengineeringsupport'], name, value)
    ...
    class Cospflocallsdbtable(Entity):
        ...
        class Cospflocallsdbentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOOSPFMIB.Cospflocallsdbtable.Cospflocallsdbentry, ['cospflocallsdbipaddress', 'cospflocallsdbaddresslessif', 'cospflocallsdbtype', 'cospflocallsdblsid', 'cospflocallsdbrouterid', 'cospflocallsdbadvertisement', 'cospflocallsdbage', 'cospflocallsdbchecksum', 'cospflocallsdbsequence'], name, value)
    ...
    class Cospflsdbtable(Entity):
        ...
        class Cospflsdbentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOOSPFMIB.Cospflsdbtable.Cospflsdbentry, ['ospflsdbareaid', 'cospflsdbtype', 'ospflsdblsid', 'ospflsdbrouterid', 'cospflsdbadvertisement', 'cospflsdbage', 'cospflsdbchecksum', 'cospflsdbsequence'], name, value)
    ...
    class Cospfshamlinknbrtable(Entity):
        ...
        class Cospfshamlinknbrentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOOSPFMIB.Cospfshamlinknbrtable.Cospfshamlinknbrentry, ['cospfshamlinkslocalipaddrtype', 'cospfshamlinkslocalipaddr', 'cospfshamlinknbrarea', 'cospfshamlinknbripaddrtype', 'cospfshamlinknbripaddr', 'cospfshamlinknbrevents', 'cospfshamlinknbrhellosuppressed', 'cospfshamlinknbrlsretransqlen', 'cospfshamlinknbroptions', 'cospfshamlinknbrrtrid', 'cospfshamlinknbrstate'], name, value)
    ...
    class Cospfshamlinkstable(Entity):
        ...
        class Cospfshamlinksentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOOSPFMIB.Cospfshamlinkstable.Cospfshamlinksentry, ['cospfshamlinksareaid', 'cospfshamlinkslocalipaddrtype', 'cospfshamlinkslocalipaddr', 'cospfshamlinksremoteipaddrtype', 'cospfshamlinksremoteipaddr', 'cospfshamlinksevents', 'cospfshamlinkshellointerval', 'cospfshamlinksmetric', 'cospfshamlinksretransinterval', 'cospfshamlinksrtrdeadinterval', 'cospfshamlinksstate'], name, value)
    ...
    class Cospfshamlinktable(Entity):
        ...
        class Cospfshamlinkentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOOSPFMIB.Cospfshamlinktable.Cospfshamlinkentry, ['cospfshamlinkareaid', 'cospfshamlinklocalipaddress', 'cospfshamlinkneighborid', 'cospfshamlinkevents', 'cospfshamlinkhellointerval', 'cospfshamlinkmetric', 'cospfshamlinkretransinterval', 'cospfshamlinkrtrdeadinterval', 'cospfshamlinkstate'], name, value)
    ...
    class Cospfvirtlocallsdbtable(Entity):
        ...
        class Cospfvirtlocallsdbentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOOSPFMIB.Cospfvirtlocallsdbtable.Cospfvirtlocallsdbentry, ['cospfvirtlocallsdbtransitarea', 'cospfvirtlocallsdbneighbor', 'cospfvirtlocallsdbtype', 'cospfvirtlocallsdblsid', 'cospfvirtlocallsdbrouterid', 'cospfvirtlocallsdbadvertisement', 'cospfvirtlocallsdbage', 'cospfvirtlocallsdbchecksum', 'cospfvirtlocallsdbsequence'], name, value)
