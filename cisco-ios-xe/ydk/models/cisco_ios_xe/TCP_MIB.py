...
class TCPMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"tcp" : ("tcp", TCPMIB.Tcp), "tcpConnectionTable" : ("tcpconnectiontable", TCPMIB.Tcpconnectiontable), "tcpConnTable" : ("tcpconntable", TCPMIB.Tcpconntable), "tcpListenerTable" : ("tcplistenertable", TCPMIB.Tcplistenertable)}
    ...
    class Tcp(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(TCPMIB.Tcp, ['tcpactiveopens', 'tcpattemptfails', 'tcpcurrestab', 'tcpestabresets', 'tcphcinsegs', 'tcphcoutsegs', 'tcpinerrs', 'tcpinsegs', 'tcpmaxconn', 'tcpoutrsts', 'tcpoutsegs', 'tcppassiveopens', 'tcpretranssegs', 'tcprtoalgorithm', 'tcprtomax', 'tcprtomin'], name, value)
    ...
    class Tcpconnectiontable(Entity):
        ...
        class Tcpconnectionentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TCPMIB.Tcpconnectiontable.Tcpconnectionentry, ['tcpconnectionlocaladdresstype', 'tcpconnectionlocaladdress', 'tcpconnectionlocalport', 'tcpconnectionremaddresstype', 'tcpconnectionremaddress', 'tcpconnectionremport', 'tcpconnectionprocess', 'tcpconnectionstate'], name, value)
