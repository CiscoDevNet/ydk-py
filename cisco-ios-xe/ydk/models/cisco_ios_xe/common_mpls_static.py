...
class MplsStatic(Entity):
    ...
    class MplsStaticCfg(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("named-lsps", ("named_lsps", MplsStatic.MplsStaticCfg.NamedLsps)), ("in-label-lsps", ("in_label_lsps", MplsStatic.MplsStaticCfg.InLabelLsps)), ("interfaces", ("interfaces", MplsStatic.MplsStaticCfg.Interfaces)), ("ipv6-ingress-lsps", ("ipv6_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv6IngressLsps)), ("ipv4-ingress-lsps", ("ipv4_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv4IngressLsps))])
            self._leafs = OrderedDict()
                ...
                class Path(Entity):
                    ...
                    class NextHop(Entity):
                        ...
                        class NextHopType(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.NextHopType, ['if_index', 'ipv6_address', 'ipv4_address', 'mac_address', 'out_interface_name'], name, value)
