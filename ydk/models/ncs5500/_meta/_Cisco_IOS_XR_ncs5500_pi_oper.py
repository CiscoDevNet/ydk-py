...
_meta_table = {
    'Wred_Enum' : _MetaInfoEnum('Wred_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_pi_oper',
        {
    ...
    'CacState_Enum' : _MetaInfoEnum('CacState_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_pi_oper',
        {
            'unknown':'UNKNOWN',
            'admit':'ADMIT',
            'redirect':'REDIRECT',
    ...
    'PolicyParamUnit_Enum' : _MetaInfoEnum('PolicyParamUnit_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_pi_oper',
        {
    ...
    'PolicyState_Enum' : _MetaInfoEnum('PolicyState_Enum', 'ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_pi_oper',
        {
            'active':'ACTIVE',
            'suspended':'SUSPENDED',
        }, 'Cisco-IOS-XR-ncs5500-pi-oper', _yang_ns._namespaces['Cisco-IOS-XR-ncs5500-pi-oper']),
