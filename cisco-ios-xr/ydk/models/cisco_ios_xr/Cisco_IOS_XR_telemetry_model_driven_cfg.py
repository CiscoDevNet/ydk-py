...
class TelemetryModelDriven(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"destination-groups" : ("destination_groups", TelemetryModelDriven.DestinationGroups), "sensor-groups" : ("sensor_groups", TelemetryModelDriven.SensorGroups), "subscriptions" : ("subscriptions", TelemetryModelDriven.Subscriptions)}
    ...
    class DestinationGroups(Entity):
        ...
        class DestinationGroup(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"ipv4-destinations" : ("ipv4_destinations", TelemetryModelDriven.DestinationGroups.DestinationGroup.Ipv4Destinations), "ipv6-destinations" : ("ipv6_destinations", TelemetryModelDriven.DestinationGroups.DestinationGroup.Ipv6Destinations)}
                self._child_list_classes = {}
            ...
            class Ipv4Destinations(Entity):
                ...
                class Ipv4Destination(Entity):
                    ...
                    class Protocol(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(TelemetryModelDriven.DestinationGroups.DestinationGroup.Ipv4Destinations.Ipv4Destination.Protocol, ['no_tls', 'packetsize', 'protocol', 'tls_hostname'], name, value)
            ...
            class Ipv6Destinations(Entity):
                ...
                class Ipv6Destination(Entity):
                    ...
                    class Protocol(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(TelemetryModelDriven.DestinationGroups.DestinationGroup.Ipv6Destinations.Ipv6Destination.Protocol, ['no_tls', 'packetsize', 'protocol', 'tls_hostname'], name, value)
    ...
    class Subscriptions(Entity):
        ...
        class Subscription(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"destination-profiles" : ("destination_profiles", TelemetryModelDriven.Subscriptions.Subscription.DestinationProfiles), "sensor-profiles" : ("sensor_profiles", TelemetryModelDriven.Subscriptions.Subscription.SensorProfiles)}
                self._child_list_classes = {}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TelemetryModelDriven.Subscriptions.Subscription, ['subscription_identifier', 'source_interface', 'source_qos_marking'], name, value)
            ...
            class SensorProfiles(Entity):
                ...
                class SensorProfile(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(TelemetryModelDriven.Subscriptions.Subscription.SensorProfiles.SensorProfile, ['sensorgroupid', 'sample_interval', 'strict_timer'], name, value)
