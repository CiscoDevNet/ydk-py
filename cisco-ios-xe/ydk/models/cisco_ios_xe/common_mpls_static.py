...
class MplsStatic(Entity):
    ...
    class MplsStaticCfg(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("in-label-lsps", ("in_label_lsps", MplsStatic.MplsStaticCfg.InLabelLsps)), ("ipv4-ingress-lsps", ("ipv4_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv4IngressLsps)), ("ipv6-ingress-lsps", ("ipv6_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv6IngressLsps)), ("named-lsps", ("named_lsps", MplsStatic.MplsStaticCfg.NamedLsps)), ("interfaces", ("interfaces", MplsStatic.MplsStaticCfg.Interfaces))])
            self._leafs = OrderedDict()
                ...
                class Path(Entity):
                    ...
                    class NextHop(Entity):
                        ...
                        class NextHopType(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.NextHopType, ['out_interface_name', 'mac_address', 'if_index', 'ipv4_address', 'ipv6_address'], name, value)
