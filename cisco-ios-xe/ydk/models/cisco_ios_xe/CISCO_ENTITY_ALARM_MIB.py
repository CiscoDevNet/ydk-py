...
class CISCOENTITYALARMMIB(Entity):
    ...
    class CeAlarmDescrMapTable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ceAlarmDescrMapEntry", ("cealarmdescrmapentry", CISCOENTITYALARMMIB.CeAlarmDescrMapTable.CeAlarmDescrMapEntry))])
            self._leafs = OrderedDict()
    ...
    class CeAlarmDescrTable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ceAlarmDescrEntry", ("cealarmdescrentry", CISCOENTITYALARMMIB.CeAlarmDescrTable.CeAlarmDescrEntry))])
            self._leafs = OrderedDict()
    ...
    class CeAlarmTable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ceAlarmEntry", ("cealarmentry", CISCOENTITYALARMMIB.CeAlarmTable.CeAlarmEntry))])
            self._leafs = OrderedDict()
    ...
    class CeAlarmHistTable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ceAlarmHistEntry", ("cealarmhistentry", CISCOENTITYALARMMIB.CeAlarmHistTable.CeAlarmHistEntry))])
            self._leafs = OrderedDict()
    ...
    class CeAlarmFilterProfileTable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ceAlarmFilterProfileEntry", ("cealarmfilterprofileentry", CISCOENTITYALARMMIB.CeAlarmFilterProfileTable.CeAlarmFilterProfileEntry))])
            self._leafs = OrderedDict()
