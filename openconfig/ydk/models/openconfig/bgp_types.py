...
class BgpOriginAttrTypeEnum(Enum):
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.openconfig._meta import _bgp_types as meta
...
class InternetIdentity(BgpWellKnownStdCommunityIdentity):
    """
    ...
    def _meta_info():
        from ydk.models.openconfig._meta import _bgp_types as meta
        return meta._meta_table['InternetIdentity']['meta_info']
