...
_meta_table = {
    'Tty.TtyLines.TtyLine.Aaa.Accounting' : {
        ...
        'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg'
        ),
    },
    ...
    'Tty.TtyLines.TtyLine.Aaa.UserGroups' : {
        'meta_info' : _MetaInfoClass('Tty.TtyLines.TtyLine.Aaa.UserGroups',
            False, 
            [
            _MetaInfoClassMember('user-group', REFERENCE_LIST, 'UserGroup' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg', 'Tty.TtyLines.TtyLine.Aaa.UserGroups.UserGroup', 
                [], [], 
    ...
    'Tty.TtyLines.TtyLine.Connection.SessionTimeout' : {
        'meta_info' : _MetaInfoClass('Tty.TtyLines.TtyLine.Connection.SessionTimeout',
            False, 
            [
            _MetaInfoClassMember('direction', REFERENCE_ENUM_CLASS, 'TtySessionTimeoutDirection_Enum' , 'ydk.models.tty.Cisco_IOS_XR_tty_management_datatypes', 'TtySessionTimeoutDirection_Enum', 
                [], [], 
    ...
    'Tty.TtyLines.TtyLine.Connection' : {
        'meta_info' : _MetaInfoClass('Tty.TtyLines.TtyLine.Connection',
            ...
            _MetaInfoClassMember('transport-output', REFERENCE_CLASS, 'TransportOutput' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg', 'Tty.TtyLines.TtyLine.Connection.TransportOutput', 
                ...
                'transport_output',
                'Cisco-IOS-XR-tty-management-cfg', False),
            _MetaInfoClassMember('transport-preferred', REFERENCE_ENUM_CLASS, 'TtyTransportProtocol_Enum' , 'ydk.models.tty.Cisco_IOS_XR_tty_management_datatypes', 'TtyTransportProtocol_Enum', 
                [], [], 
    ...
    'Tty.TtyLines.TtyLine.ExecMode' : {
        'meta_info' : _MetaInfoClass('Tty.TtyLines.TtyLine.ExecMode',
            False, 
            [
            _MetaInfoClassMember('pager', REFERENCE_ENUM_CLASS, 'TtyPager_Enum' , 'ydk.models.tty.Cisco_IOS_XR_tty_management_datatypes', 'TtyPager_Enum', 
                [], [], 
    ...
    'Tty.TtyLines.TtyLine' : {
        'meta_info' : _MetaInfoClass('Tty.TtyLines.TtyLine',
            ...
            _MetaInfoClassMember('general', REFERENCE_CLASS, 'General' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg', 'Tty.TtyLines.TtyLine.General', 
                ...
                'general',
                'Cisco-IOS-XR-tty-server-cfg', False),
            _MetaInfoClassMember('telnet', REFERENCE_CLASS, 'Telnet' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg', 'Tty.TtyLines.TtyLine.Telnet', 
                [], [], 
    ...
    'Tty.TtyLines' : {
        'meta_info' : _MetaInfoClass('Tty.TtyLines',
            False, 
            [
            _MetaInfoClassMember('tty-line', REFERENCE_LIST, 'TtyLine' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg', 'Tty.TtyLines.TtyLine', 
                [], [], 
    ...
    'Tty' : {
        'meta_info' : _MetaInfoClass('Tty',
            False, 
            [
            _MetaInfoClassMember('tty-lines', REFERENCE_CLASS, 'TtyLines' , 'ydk.models.tty.Cisco_IOS_XR_tty_server_cfg', 'Tty.TtyLines', 
                [], [], 
                '''                TTY templates
                ''',
                'tty_lines',
