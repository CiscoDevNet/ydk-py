...
class CISCOSIPUAMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cSipCfgAaa" : ("csipcfgaaa", CISCOSIPUAMIB.Csipcfgaaa), "cSipCfgBase" : ("csipcfgbase", CISCOSIPUAMIB.Csipcfgbase), "cSipCfgBindSourceAddrTable" : ("csipcfgbindsourceaddrtable", CISCOSIPUAMIB.Csipcfgbindsourceaddrtable), "cSipCfgCauseStatusTable" : ("csipcfgcausestatustable", CISCOSIPUAMIB.Csipcfgcausestatustable), "cSipCfgEarlyMediaTable" : ("csipcfgearlymediatable", CISCOSIPUAMIB.Csipcfgearlymediatable), "cSipCfgPeer" : ("csipcfgpeer", CISCOSIPUAMIB.Csipcfgpeer), "cSipCfgPeerTable" : ("csipcfgpeertable", CISCOSIPUAMIB.Csipcfgpeertable), "cSipCfgRetry" : ("csipcfgretry", CISCOSIPUAMIB.Csipcfgretry), "cSipCfgStatusCauseTable" : ("csipcfgstatuscausetable", CISCOSIPUAMIB.Csipcfgstatuscausetable), "cSipCfgTimer" : ("csipcfgtimer", CISCOSIPUAMIB.Csipcfgtimer), "cSipCfgVoiceServiceVoip" : ("csipcfgvoiceservicevoip", CISCOSIPUAMIB.Csipcfgvoiceservicevoip), "cSipStatsConnection" : ("csipstatsconnection", CISCOSIPUAMIB.Csipstatsconnection), "cSipStatsErrClient" : ("csipstatserrclient", CISCOSIPUAMIB.Csipstatserrclient), "cSipStatsErrServer" : ("csipstatserrserver", CISCOSIPUAMIB.Csipstatserrserver), "cSipStatsGlobalFail" : ("csipstatsglobalfail", CISCOSIPUAMIB.Csipstatsglobalfail), "cSipStatsInfo" : ("csipstatsinfo", CISCOSIPUAMIB.Csipstatsinfo), "cSipStatsMisc" : ("csipstatsmisc", CISCOSIPUAMIB.Csipstatsmisc), "cSipStatsRedirect" : ("csipstatsredirect", CISCOSIPUAMIB.Csipstatsredirect), "cSipStatsRetry" : ("csipstatsretry", CISCOSIPUAMIB.Csipstatsretry), "cSipStatsSuccess" : ("csipstatssuccess", CISCOSIPUAMIB.Csipstatssuccess), "cSipStatsSuccessOkTable" : ("csipstatssuccessoktable", CISCOSIPUAMIB.Csipstatssuccessoktable), "cSipStatsTraffic" : ("csipstatstraffic", CISCOSIPUAMIB.Csipstatstraffic)}
    ...
    class Csipcfgbase(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipcfgbase, ['csipcfgbindsrcaddrinterface', 'csipcfgbindsrcaddrscope', 'csipcfgdnssrvquerystringformat', 'csipcfgmaxforwards', 'csipcfgmaximumforwards', 'csipcfgoffercallhold', 'csipcfgreasonheaderoveride', 'csipcfgredirectiondisabled', 'csipcfgsuspendresumeenabled', 'csipcfgsymnatdirectionrole', 'csipcfgsymnatenabled', 'csipcfgtransport', 'csipcfguserlocationserveraddr', 'csipcfgversion'], name, value)
    ...
    class Csipcfgcausestatustable(Entity):
        ...
        class Csipcfgcausestatusentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSIPUAMIB.Csipcfgcausestatustable.Csipcfgcausestatusentry, ['csipcfgpstncauseindex', 'csipcfgcausestatusstorestatus', 'csipcfgstatuscode'], name, value)
    ...
    class Csipcfgpeer(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipcfgpeer, ['csipcfgoutsessiontransport', 'csipcfgreliable1xxrsphdr', 'csipcfgreliable1xxrspstr', 'csipcfgurltype'], name, value)
    ...
    class Csipcfgpeertable(Entity):
        ...
        class Csipcfgpeerentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(CISCOSIPUAMIB.Csipcfgpeertable.Csipcfgpeerentry, ['csipcfgpeerindex', 'csipcfgpeeroutsessiontransport', 'csipcfgpeerreliable1xxrsphdr', 'csipcfgpeerreliable1xxrspstr', 'csipcfgpeerswitchtransenabled', 'csipcfgpeerurltype'], name, value)
    ...
    class Csipcfgretry(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipcfgretry, ['csipcfgretrybye', 'csipcfgretrycancel', 'csipcfgretrycomet', 'csipcfgretryinfo', 'csipcfgretryinvite', 'csipcfgretrynotify', 'csipcfgretryprack', 'csipcfgretryrefer', 'csipcfgretryregister', 'csipcfgretryreliablersp', 'csipcfgretryresponse', 'csipcfgretrysubscribe'], name, value)
    ...
    class Csipcfgtimer(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipcfgtimer, ['csipcfgtimerbufferinvite', 'csipcfgtimercomet', 'csipcfgtimerconnect', 'csipcfgtimerconnectionaging', 'csipcfgtimerdisconnect', 'csipcfgtimerexpires', 'csipcfgtimerhold', 'csipcfgtimerinfo', 'csipcfgtimernotify', 'csipcfgtimerprack', 'csipcfgtimerrefer', 'csipcfgtimerreliablersp', 'csipcfgtimersessiontimer', 'csipcfgtimertrying'], name, value)
    ...
    class Csipstatsconnection(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatsconnection, ['csipstatsactivetcpconnections', 'csipstatsactiveudpconnections', 'csipstatsconntcpcreatefailures', 'csipstatsconntcpinactivetimeouts', 'csipstatsconntcpremoteclosures', 'csipstatsconntcpsendfailures', 'csipstatsconnudpcreatefailures', 'csipstatsconnudpinactivetimeouts', 'csipstatsconnudpsendfailures'], name, value)
    ...
    class Csipstatserrclient(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatserrclient, ['csipstatsclientaddrincompleteins', 'csipstatsclientaddrincompleteouts', 'csipstatsclientambiguousins', 'csipstatsclientambiguousouts', 'csipstatsclientbadeventins', 'csipstatsclientbadeventouts', 'csipstatsclientbadextensionins', 'csipstatsclientbadextensionouts', 'csipstatsclientbadrequestins', 'csipstatsclientbadrequestouts', 'csipstatsclientbusyhereins', 'csipstatsclientbusyhereouts', 'csipstatsclientcalllegnoexistins', 'csipstatsclientcalllegnoexistouts', 'csipstatsclientconflictins', 'csipstatsclientconflictouts', 'csipstatsclientforbiddenins', 'csipstatsclientforbiddenouts', 'csipstatsclientgoneins', 'csipstatsclientgoneouts', 'csipstatsclientlengthrequiredins', 'csipstatsclientlengthrequiredouts', 'csipstatsclientloopdetectedins', 'csipstatsclientloopdetectedouts', 'csipstatsclientmethnotallowedins', 'csipstatsclientmethnotallowedouts', 'csipstatsclientnoaccepthereins', 'csipstatsclientnoaccepthereouts', 'csipstatsclientnosupmediatypeins', 'csipstatsclientnosupmediatypeouts', 'csipstatsclientnotacceptableins', 'csipstatsclientnotacceptableouts', 'csipstatsclientnotfoundins', 'csipstatsclientnotfoundouts', 'csipstatsclientpaymentreqdins', 'csipstatsclientpaymentreqdouts', 'csipstatsclientproxyauthreqdins', 'csipstatsclientproxyauthreqdouts', 'csipstatsclientreqenttoolargeins', 'csipstatsclientreqenttoolargeouts', 'csipstatsclientreqpendingins', 'csipstatsclientreqpendingouts', 'csipstatsclientreqtermins', 'csipstatsclientreqtermouts', 'csipstatsclientreqtimeoutins', 'csipstatsclientreqtimeoutouts', 'csipstatsclientrequritoolargeins', 'csipstatsclientrequritoolargeouts', 'csipstatsclientsttoosmallins', 'csipstatsclientsttoosmallouts', 'csipstatsclienttempnotavailins', 'csipstatsclienttempnotavailouts', 'csipstatsclienttoomanyhopsins', 'csipstatsclienttoomanyhopsouts', 'csipstatsclientunauthorizedins', 'csipstatsclientunauthorizedouts'], name, value)
    ...
    class Csipstatserrserver(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatserrserver, ['csipstatsserverbadgatewayins', 'csipstatsserverbadgatewayouts', 'csipstatsserverbadsipversionins', 'csipstatsserverbadsipversionouts', 'csipstatsservergatewaytimeoutins', 'csipstatsservergatewaytimeoutouts', 'csipstatsserverinterrorins', 'csipstatsserverinterrorouts', 'csipstatsservernotimplementedins', 'csipstatsservernotimplementedouts', 'csipstatsserverprecondfailureins', 'csipstatsserverprecondfailureouts', 'csipstatsserverserviceunavailins', 'csipstatsserverserviceunavailouts'], name, value)
    ...
    class Csipstatsglobalfail(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatsglobalfail, ['csipstatsglobalbusyeverywhereins', 'csipstatsglobalbusyeverywhereouts', 'csipstatsglobaldeclineins', 'csipstatsglobaldeclineouts', 'csipstatsglobalnotacceptableins', 'csipstatsglobalnotacceptableouts', 'csipstatsglobalnotanywhereins', 'csipstatsglobalnotanywhereouts'], name, value)
    ...
    class Csipstatsinfo(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatsinfo, ['csipstatsinfoforwardedins', 'csipstatsinfoforwardedouts', 'csipstatsinfoqueuedins', 'csipstatsinfoqueuedouts', 'csipstatsinforingingins', 'csipstatsinforingingouts', 'csipstatsinfosessionprogins', 'csipstatsinfosessionprogouts', 'csipstatsinfotryingins', 'csipstatsinfotryingouts'], name, value)
    ...
    class Csipstatsredirect(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatsredirect, ['csipstatsrediraltservices', 'csipstatsredirmovedperms', 'csipstatsredirmovedtemps', 'csipstatsredirmovedtempsins', 'csipstatsredirmovedtempsouts', 'csipstatsredirmultiplechoices', 'csipstatsredirseeothers', 'csipstatsrediruseproxys'], name, value)
    ...
    class Csipstatsretry(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatsretry, ['csipstatsretrybyes', 'csipstatsretrycancels', 'csipstatsretrycomets', 'csipstatsretryinfo', 'csipstatsretryinvites', 'csipstatsretrynotifys', 'csipstatsretrypracks', 'csipstatsretryrefers', 'csipstatsretryregisters', 'csipstatsretryreliable1xxrsps', 'csipstatsretryresponses', 'csipstatsretrysubscribe'], name, value)
    ...
    class Csipstatssuccess(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatssuccess, ['csipstatssuccessacceptedins', 'csipstatssuccessacceptedouts', 'csipstatssuccessokins', 'csipstatssuccessokouts'], name, value)
    ...
    class Csipstatstraffic(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOSIPUAMIB.Csipstatstraffic, ['csipstatstrafficackins', 'csipstatstrafficackouts', 'csipstatstrafficbyeins', 'csipstatstrafficbyeouts', 'csipstatstrafficcancelins', 'csipstatstrafficcancelouts', 'csipstatstrafficcometins', 'csipstatstrafficcometouts', 'csipstatstrafficinfoins', 'csipstatstrafficinfoouts', 'csipstatstrafficinviteins', 'csipstatstrafficinviteouts', 'csipstatstrafficnotifyins', 'csipstatstrafficnotifyouts', 'csipstatstrafficoptionsins', 'csipstatstrafficoptionsouts', 'csipstatstrafficprackins', 'csipstatstrafficprackouts', 'csipstatstrafficreferins', 'csipstatstrafficreferouts', 'csipstatstrafficregisterins', 'csipstatstrafficregisterouts', 'csipstatstrafficsubscribeins', 'csipstatstrafficsubscribeouts', 'csipstatstrafficupdateins', 'csipstatstrafficupdateouts'], name, value)
