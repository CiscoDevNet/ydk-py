...
class CISCOTAP2MIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"cTap2DebugGroup" : ("ctap2debuggroup", CISCOTAP2MIB.Ctap2Debuggroup), "cTap2DebugTable" : ("ctap2debugtable", CISCOTAP2MIB.Ctap2Debugtable), "cTap2DebugUserTable" : ("ctap2debugusertable", CISCOTAP2MIB.Ctap2Debugusertable), "cTap2MediationGroup" : ("ctap2mediationgroup", CISCOTAP2MIB.Ctap2Mediationgroup), "cTap2MediationTable" : ("ctap2mediationtable", CISCOTAP2MIB.Ctap2Mediationtable), "cTap2StreamTable" : ("ctap2streamtable", CISCOTAP2MIB.Ctap2Streamtable)}
    ...
    class Ctap2Debugtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cTap2DebugEntry" : ("ctap2debugentry", CISCOTAP2MIB.Ctap2Debugtable.Ctap2Debugentry)}
        ...
        class Ctap2Debugentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cTap2DebugEntry" + "[cTap2DebugIndex='" + self.ctap2debugindex.get() + "']"
                self._absolute_path = lambda: "CISCO-TAP2-MIB:CISCO-TAP2-MIB/cTap2DebugTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOTAP2MIB.Ctap2Debugtable.Ctap2Debugentry, ['ctap2debugindex', 'ctap2debugmediationid', 'ctap2debugmessage', 'ctap2debugstatus', 'ctap2debugstreamid'], name, value)
    ...
    class Ctap2Debugusertable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cTap2DebugUserEntry" : ("ctap2debuguserentry", CISCOTAP2MIB.Ctap2Debugusertable.Ctap2Debuguserentry)}
        ...
        class Ctap2Debuguserentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cTap2DebugUserEntry" + "[cTap2MediationContentId='" + self.ctap2mediationcontentid.get() + "']" + "[cTap2DebugUserName='" + self.ctap2debugusername.get() + "']"
                self._absolute_path = lambda: "CISCO-TAP2-MIB:CISCO-TAP2-MIB/cTap2DebugUserTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOTAP2MIB.Ctap2Debugusertable.Ctap2Debuguserentry, ['ctap2mediationcontentid', 'ctap2debugusername', 'ctap2debuguserstatus', 'ctap2debuguserstoragetype', 'ctap2debugusertimeout'], name, value)
    ...
    class Ctap2Mediationgroup(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOTAP2MIB.Ctap2Mediationgroup, ['ctap2mediationcapabilities', 'ctap2mediationnewindex'], name, value)
    ...
    class Ctap2Mediationtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cTap2MediationEntry" : ("ctap2mediationentry", CISCOTAP2MIB.Ctap2Mediationtable.Ctap2Mediationentry)}
        ...
        class Ctap2Mediationentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cTap2MediationEntry" + "[cTap2MediationContentId='" + self.ctap2mediationcontentid.get() + "']"
                self._absolute_path = lambda: "CISCO-TAP2-MIB:CISCO-TAP2-MIB/cTap2MediationTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOTAP2MIB.Ctap2Mediationtable.Ctap2Mediationentry, ['ctap2mediationcontentid', 'ctap2mediationdatatype', 'ctap2mediationdestaddress', 'ctap2mediationdestaddresstype', 'ctap2mediationdestport', 'ctap2mediationdscp', 'ctap2mediationnotificationenable', 'ctap2mediationradiuskey', 'ctap2mediationretransmittype', 'ctap2mediationrtcpport', 'ctap2mediationsrcinterface', 'ctap2mediationstatus', 'ctap2mediationtimeout', 'ctap2mediationtransport'], name, value)
    ...
    class Ctap2Streamtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"cTap2StreamEntry" : ("ctap2streamentry", CISCOTAP2MIB.Ctap2Streamtable.Ctap2Streamentry)}
        ...
        class Ctap2Streamentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "cTap2StreamEntry" + "[cTap2MediationContentId='" + self.ctap2mediationcontentid.get() + "']" + "[cTap2StreamIndex='" + self.ctap2streamindex.get() + "']"
                self._absolute_path = lambda: "CISCO-TAP2-MIB:CISCO-TAP2-MIB/cTap2StreamTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(CISCOTAP2MIB.Ctap2Streamtable.Ctap2Streamentry, ['ctap2mediationcontentid', 'ctap2streamindex', 'ctap2streaminterceptdrops', 'ctap2streaminterceptedhcpackets', 'ctap2streaminterceptedpackets', 'ctap2streaminterceptenable', 'ctap2streamintercepthcdrops', 'ctap2streamstatus', 'ctap2streamtype'], name, value)
