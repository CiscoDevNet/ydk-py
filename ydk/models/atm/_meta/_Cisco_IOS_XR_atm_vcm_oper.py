...
_meta_table = {
    ...
    'AtmVcm.Nodes.Node.CellPacks' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes.Node.CellPacks',
            False, 
            [
            _MetaInfoClassMember('cell-pack', REFERENCE_LIST, 'CellPack' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.CellPacks.CellPack', 
                [], [], 
    ...
    'AtmVcm.Nodes.Node.ClassLinks' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes.Node.ClassLinks',
            False, 
            [
            _MetaInfoClassMember('class-link', REFERENCE_LIST, 'ClassLink' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.ClassLinks.ClassLink', 
                [], [], 
    ...
    'AtmVcm.Nodes.Node.Interfaces.Interface' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes.Node.Interfaces.Interface',
            ...
            _MetaInfoClassMember('interface-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'interface_name',
                'Cisco-IOS-XR-atm-vcm-oper', True),
            _MetaInfoClassMember('cell-packing-data', REFERENCE_CLASS, 'CellPackingData' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.Interfaces.Interface.CellPackingData', 
                [], [], 
    ...
    'AtmVcm.Nodes.Node.Interfaces' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes.Node.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.Interfaces.Interface', 
                [], [], 
                '''                ATM Interface data
                ''',
                'interface',
    ...
    'AtmVcm.Nodes.Node.VpTunnels' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes.Node.VpTunnels',
            False, 
            [
            _MetaInfoClassMember('vp-tunnel', REFERENCE_LIST, 'VpTunnel' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.VpTunnels.VpTunnel', 
                [], [], 
    ...
    'AtmVcm.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes.Node',
            ...
            _MetaInfoClassMember('class-links', REFERENCE_CLASS, 'ClassLinks' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.ClassLinks', 
                ...
                'class_links',
                'Cisco-IOS-XR-atm-vcm-oper', False),
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node.Interfaces', 
                [], [], 
    ...
    'AtmVcm.Nodes' : {
        'meta_info' : _MetaInfoClass('AtmVcm.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes.Node', 
                [], [], 
    ...
    'AtmVcm' : {
        'meta_info' : _MetaInfoClass('AtmVcm',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper', 'AtmVcm.Nodes', 
                [], [], 
