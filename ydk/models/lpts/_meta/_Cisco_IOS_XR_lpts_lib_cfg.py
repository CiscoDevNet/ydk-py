...
_meta_table = {
    ...
    'Lpts.Ipolicer.Flows.Flow' : {
        'meta_info' : _MetaInfoClass('Lpts.Ipolicer.Flows.Flow',
            ...
            _MetaInfoClassMember('precedences', REFERENCE_CLASS, 'Precedences' , 'ydk.models.lpts.Cisco_IOS_XR_lpts_lib_cfg', 'Lpts.Ipolicer.Flows.Flow.Precedences', 
                [], [], 
    ...
    'Lpts.Ipolicer.Flows' : {
        'meta_info' : _MetaInfoClass('Lpts.Ipolicer.Flows',
            False, 
            [
            _MetaInfoClassMember('flow', REFERENCE_LIST, 'Flow' , 'ydk.models.lpts.Cisco_IOS_XR_lpts_lib_cfg', 'Lpts.Ipolicer.Flows.Flow', 
                [], [], 
                '''                selected flow type
                ''',
                'flow',
    ...
    'Lpts.Ipolicer' : {
        'meta_info' : _MetaInfoClass('Lpts.Ipolicer',
            ...
            _MetaInfoClassMember('enable', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'enable',
                'Cisco-IOS-XR-lpts-pre-ifib-cfg', False),
            _MetaInfoClassMember('flows', REFERENCE_CLASS, 'Flows' , 'ydk.models.lpts.Cisco_IOS_XR_lpts_lib_cfg', 'Lpts.Ipolicer.Flows', 
                [], [], 
                '''                Table for Flows
                ''',
                'flows',
    ...
    'Lpts' : {
        'meta_info' : _MetaInfoClass('Lpts',
            False, 
            [
            _MetaInfoClassMember('ipolicer', REFERENCE_CLASS, 'Ipolicer' , 'ydk.models.lpts.Cisco_IOS_XR_lpts_lib_cfg', 'Lpts.Ipolicer', 
                [], [], 
