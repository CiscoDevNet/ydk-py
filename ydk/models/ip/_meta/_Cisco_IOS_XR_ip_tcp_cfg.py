...
_meta_table = {
    'Ip.Cinetd.Services.Ipv4.SmallServers.TcpSmallServers' : {
        ...
        'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg'
        ),
    },
    ...
    'Ip.Cinetd.Services.Ipv4.SmallServers' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Ipv4.SmallServers',
            False, 
            [
            _MetaInfoClassMember('tcp-small-servers', REFERENCE_CLASS, 'TcpSmallServers' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Ipv4.SmallServers.TcpSmallServers', 
                [], [], 
                ...
                'tcp_small_servers',
                'Cisco-IOS-XR-ip-tcp-cfg', False),
            _MetaInfoClassMember('udp-small-servers', REFERENCE_CLASS, 'UdpSmallServers' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Ipv4.SmallServers.UdpSmallServers', 
                [], [], 
    ...
    'Ip.Cinetd.Services.Ipv4' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Ipv4',
            False, 
            [
            _MetaInfoClassMember('small-servers', REFERENCE_CLASS, 'SmallServers' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Ipv4.SmallServers', 
                [], [], 
    ...
    'Ip.Cinetd.Services.Ipv6.SmallServers' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Ipv6.SmallServers',
            False, 
            [
            _MetaInfoClassMember('tcp-small-servers', REFERENCE_CLASS, 'TcpSmallServers' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Ipv6.SmallServers.TcpSmallServers', 
                [], [], 
                '''                Describing TCP related IPV4 and IPV6 small
                servers
                ''',
    ...
    'Ip.Cinetd.Services.Ipv6' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Ipv6',
            False, 
            [
            _MetaInfoClassMember('small-servers', REFERENCE_CLASS, 'SmallServers' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Ipv6.SmallServers', 
                [], [], 
                '''                Describing IPV4 and IPV6 small servers
                ''',
                'small_servers',
    ...
    'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Telnet' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Telnet',
            False, 
            [
            _MetaInfoClassMember('tcp', REFERENCE_CLASS, 'Tcp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Telnet.Tcp', 
                [], [], 
                '''                TCP details
                ''',
                'tcp',
    ...
    'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp',
            False, 
            [
            _MetaInfoClassMember('udp', REFERENCE_CLASS, 'Udp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp.Udp', 
                [], [], 
                '''                UDP details
                ''',
                'udp',
    ...
    'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs.Vrf.Ipv4',
            False, 
            [
            _MetaInfoClassMember('telnet', REFERENCE_CLASS, 'Telnet' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Telnet', 
                [], [], 
                '''                TELNET server configuration commands
                ''',
                'telnet',
                'Cisco-IOS-XR-ip-tcp-cfg', False),
            _MetaInfoClassMember('tftp', REFERENCE_CLASS, 'Tftp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv4.Tftp', 
                [], [], 
    ...
    'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Telnet' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Telnet',
            False, 
            [
            _MetaInfoClassMember('tcp', REFERENCE_CLASS, 'Tcp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Telnet.Tcp', 
                [], [], 
                '''                TCP details
                ''',
                'tcp',
    ...
    'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp',
            False, 
            [
            _MetaInfoClassMember('udp', REFERENCE_CLASS, 'Udp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp.Udp', 
                [], [], 
                '''                UDP details
                ''',
                'udp',
    ...
    'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs.Vrf.Ipv6',
            False, 
            [
            _MetaInfoClassMember('telnet', REFERENCE_CLASS, 'Telnet' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Telnet', 
                [], [], 
                '''                TELNET server configuration commands
                ''',
                'telnet',
                'Cisco-IOS-XR-ip-tcp-cfg', False),
            _MetaInfoClassMember('tftp', REFERENCE_CLASS, 'Tftp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf.Ipv6.Tftp', 
                [], [], 
                '''                TFTP server configuration commands
                ''',
                'tftp',
    ...
    'Ip.Cinetd.Services.Vrfs' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services.Vrfs',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Vrfs.Vrf', 
                [], [], 
                '''                VRF specific data
                ''',
                'vrf',
    ...
    'Ip.Cinetd.Services' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd.Services',
            False, 
            [
            _MetaInfoClassMember('ipv4', REFERENCE_CLASS, 'Ipv4' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services.Ipv4', 
                [], [], 
                '''                IPV4 related services
                ''',
                'ipv4',
    ...
    'Ip.Cinetd' : {
        'meta_info' : _MetaInfoClass('Ip.Cinetd',
            False, 
            [
            _MetaInfoClassMember('services', REFERENCE_CLASS, 'Services' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd.Services', 
                [], [], 
    ...
    'Ip.ForwardProtocol.Udp.Ports' : {
        'meta_info' : _MetaInfoClass('Ip.ForwardProtocol.Udp.Ports',
            False, 
            [
            _MetaInfoClassMember('port', REFERENCE_LIST, 'Port' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.ForwardProtocol.Udp.Ports.Port', 
                [], [], 
    ...
    'Ip.ForwardProtocol' : {
        'meta_info' : _MetaInfoClass('Ip.ForwardProtocol',
            False, 
            [
            _MetaInfoClassMember('udp', REFERENCE_CLASS, 'Udp' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.ForwardProtocol.Udp', 
                [], [], 
    ...
    'Ip' : {
        'meta_info' : _MetaInfoClass('Ip',
            False, 
            [
            _MetaInfoClassMember('cinetd', REFERENCE_CLASS, 'Cinetd' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.Cinetd', 
                [], [], 
                '''                Cinetd configuration data
                ''',
                'cinetd',
                'Cisco-IOS-XR-ip-tcp-cfg', False),
            _MetaInfoClassMember('forward-protocol', REFERENCE_CLASS, 'ForwardProtocol' , 'ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg', 'Ip.ForwardProtocol', 
                [], [], 
