...
class CISCOPIMMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ciscoPimMIBNotificationObjects" : ("ciscopimmibnotificationobjects", CISCOPIMMIB.Ciscopimmibnotificationobjects), "cpim" : ("cpim", CISCOPIMMIB.Cpim)}
    ...
    class Cpim(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(CISCOPIMMIB.Cpim, ['cpiminvalidjoinprunemsgsrcvd', 'cpiminvalidregistermsgsrcvd', 'cpimlasterrorgroup', 'cpimlasterrorgrouptype', 'cpimlasterrororigin', 'cpimlasterrororigintype', 'cpimlasterrorrp', 'cpimlasterrorrptype', 'cpimlasterrortype'], name, value)
