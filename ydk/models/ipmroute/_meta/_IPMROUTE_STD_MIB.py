...
_meta_table = {
    'IPMROUTESTDMIB.IpMRoute.IpMRouteEnable_Enum' : _MetaInfoEnum('IpMRouteEnable_Enum', 'ydk.models.ipmroute.IPMROUTE_STD_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
    ...
    'IPMROUTESTDMIB.IpMRoute' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRoute',
            False, 
            [
            _MetaInfoClassMember('ipMRouteEnable', REFERENCE_ENUM_CLASS, 'IpMRouteEnable_Enum' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRoute.IpMRouteEnable_Enum', 
                [], [], 
        ...
        'ydk.models.ipmroute.IPMROUTE_STD_MIB'
        ),
    },
    'IPMROUTESTDMIB.IpMRouteBoundaryTable.IpMRouteBoundaryEntry' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteBoundaryTable.IpMRouteBoundaryEntry',
            ...
            _MetaInfoClassMember('ipMRouteBoundaryIfIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'IPMROUTE-STD-MIB', True),
            _MetaInfoClassMember('ipMRouteBoundaryStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteBoundaryTable' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteBoundaryTable',
            False, 
            [
            _MetaInfoClassMember('ipMRouteBoundaryEntry', REFERENCE_LIST, 'IpMRouteBoundaryEntry' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteBoundaryTable.IpMRouteBoundaryEntry', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteInterfaceTable.IpMRouteInterfaceEntry' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteInterfaceTable.IpMRouteInterfaceEntry',
            ...
            _MetaInfoClassMember('ipMRouteInterfaceOutMcastOctets', ATTRIBUTE, 'int' , None, None, 
                ...
                'ipmrouteinterfaceoutmcastoctets',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteInterfaceProtocol', REFERENCE_ENUM_CLASS, 'IANAipMRouteProtocol_Enum' , 'ydk.models.iana.IANA_RTPROTO_MIB', 'IANAipMRouteProtocol_Enum', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteInterfaceTable' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteInterfaceTable',
            False, 
            [
            _MetaInfoClassMember('ipMRouteInterfaceEntry', REFERENCE_LIST, 'IpMRouteInterfaceEntry' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteInterfaceTable.IpMRouteInterfaceEntry', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteNextHopTable.IpMRouteNextHopEntry.IpMRouteNextHopState_Enum' : _MetaInfoEnum('IpMRouteNextHopState_Enum', 'ydk.models.ipmroute.IPMROUTE_STD_MIB',
        {
            'pruned':'PRUNED',
    ...
    'IPMROUTESTDMIB.IpMRouteNextHopTable.IpMRouteNextHopEntry' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteNextHopTable.IpMRouteNextHopEntry',
            ...
            _MetaInfoClassMember('ipMRouteNextHopPkts', ATTRIBUTE, 'int' , None, None, 
                ...
                'ipmroutenexthoppkts',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteNextHopProtocol', REFERENCE_ENUM_CLASS, 'IANAipMRouteProtocol_Enum' , 'ydk.models.iana.IANA_RTPROTO_MIB', 'IANAipMRouteProtocol_Enum', 
                [], [], 
                '''                The routing mechanism via which this next-hop was learned.
                ''',
                'ipmroutenexthopprotocol',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteNextHopState', REFERENCE_ENUM_CLASS, 'IpMRouteNextHopState_Enum' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteNextHopTable.IpMRouteNextHopEntry.IpMRouteNextHopState_Enum', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteNextHopTable' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteNextHopTable',
            False, 
            [
            _MetaInfoClassMember('ipMRouteNextHopEntry', REFERENCE_LIST, 'IpMRouteNextHopEntry' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteNextHopTable.IpMRouteNextHopEntry', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteScopeNameTable.IpMRouteScopeNameEntry' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteScopeNameTable.IpMRouteScopeNameEntry',
            ...
            _MetaInfoClassMember('ipMRouteScopeNameDefault', ATTRIBUTE, 'bool' , None, None, 
                ...
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteScopeNameStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                The status of this row, by which new entries may be
                created, or old entries deleted from this table.
                ''',
    ...
    'IPMROUTESTDMIB.IpMRouteScopeNameTable' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteScopeNameTable',
            False, 
            [
            _MetaInfoClassMember('ipMRouteScopeNameEntry', REFERENCE_LIST, 'IpMRouteScopeNameEntry' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteScopeNameTable.IpMRouteScopeNameEntry', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteTable.IpMRouteEntry.IpMRouteRtType_Enum' : _MetaInfoEnum('IpMRouteRtType_Enum', 'ydk.models.ipmroute.IPMROUTE_STD_MIB',
        {
            'unicast':'UNICAST',
            'multicast':'MULTICAST',
        }, 'IPMROUTE-STD-MIB', _yang_ns._namespaces['IPMROUTE-STD-MIB']),
    'IPMROUTESTDMIB.IpMRouteTable.IpMRouteEntry' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteTable.IpMRouteEntry',
            ...
            _MetaInfoClassMember('ipMRoutePkts', ATTRIBUTE, 'int' , None, None, 
                ...
                'ipmroutepkts',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteProtocol', REFERENCE_ENUM_CLASS, 'IANAipMRouteProtocol_Enum' , 'ydk.models.iana.IANA_RTPROTO_MIB', 'IANAipMRouteProtocol_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ipMRouteRtMask', ATTRIBUTE, 'str' , None, None, 
                ...
                'ipmroutertmask',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteRtProto', REFERENCE_ENUM_CLASS, 'IANAipRouteProtocol_Enum' , 'ydk.models.iana.IANA_RTPROTO_MIB', 'IANAipRouteProtocol_Enum', 
                [], [], 
                ...
                'ipmroutertproto',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteRtType', REFERENCE_ENUM_CLASS, 'IpMRouteRtType_Enum' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteTable.IpMRouteEntry.IpMRouteRtType_Enum', 
                [], [], 
    ...
    'IPMROUTESTDMIB.IpMRouteTable' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB.IpMRouteTable',
            False, 
            [
            _MetaInfoClassMember('ipMRouteEntry', REFERENCE_LIST, 'IpMRouteEntry' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteTable.IpMRouteEntry', 
                [], [], 
                '''                An entry (conceptual row) containing the multicast routing
    ...
    'IPMROUTESTDMIB' : {
        'meta_info' : _MetaInfoClass('IPMROUTESTDMIB',
            False, 
            [
            _MetaInfoClassMember('ipMRoute', REFERENCE_CLASS, 'IpMRoute' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRoute', 
                [], [], 
                '''                ''',
                'ipmroute',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteBoundaryTable', REFERENCE_CLASS, 'IpMRouteBoundaryTable' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteBoundaryTable', 
                [], [], 
                ...
                'ipmrouteboundarytable',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteInterfaceTable', REFERENCE_CLASS, 'IpMRouteInterfaceTable' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteInterfaceTable', 
                [], [], 
                ...
                'ipmrouteinterfacetable',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteNextHopTable', REFERENCE_CLASS, 'IpMRouteNextHopTable' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteNextHopTable', 
                [], [], 
                ...
                'ipmroutenexthoptable',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteScopeNameTable', REFERENCE_CLASS, 'IpMRouteScopeNameTable' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteScopeNameTable', 
                [], [], 
                '''                The (conceptual) table listing the multicast scope names.
                ''',
                'ipmroutescopenametable',
                'IPMROUTE-STD-MIB', False),
            _MetaInfoClassMember('ipMRouteTable', REFERENCE_CLASS, 'IpMRouteTable' , 'ydk.models.ipmroute.IPMROUTE_STD_MIB', 'IPMROUTESTDMIB.IpMRouteTable', 
                [], [], 
                '''                The (conceptual) table containing multicast routing
