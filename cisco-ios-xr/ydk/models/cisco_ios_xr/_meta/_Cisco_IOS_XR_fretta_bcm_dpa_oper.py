...
_meta_table = {
    'Dpa.Stats.Nodes.Node.AllTrapsStatsDataBlocks.AllTrapsStatsDataBlock' : {
        ...
        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper'
        ),
    },
    'Dpa.Stats.Nodes.Node.AllTrapsStatsDataBlocks' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.AllTrapsStatsDataBlocks',
            False, 
            [
            _MetaInfoClassMember('all-traps-stats-data-block', REFERENCE_LIST, 'AllTrapsStatsDataBlock' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.AllTrapsStatsDataBlocks.AllTrapsStatsDataBlock', 
                [], [], 
    ...
    'Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks.SingleTrapStatsDataBlock' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks.SingleTrapStatsDataBlock',
            ...
            _MetaInfoClassMember('trapid', ATTRIBUTE, 'int' , None, None, 
                ...
                'trapid',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', True),
            _MetaInfoClassMember('trap-data-block-number', REFERENCE_LIST, 'TrapDataBlockNumber' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks.SingleTrapStatsDataBlock.TrapDataBlockNumber', 
                [], [], 
    ...
    'Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks',
            False, 
            [
            _MetaInfoClassMember('single-trap-stats-data-block', REFERENCE_LIST, 'SingleTrapStatsDataBlock' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks.SingleTrapStatsDataBlock', 
                [], [], 
                '''                Trap number
                ''',
    ...
    'Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks.AllVoqStatsDataBlock' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks.AllVoqStatsDataBlock',
            ...
            _MetaInfoClassMember('voq-base', ATTRIBUTE, 'int' , None, None, 
                ...
                'voq_base',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('voq-stat', REFERENCE_LIST, 'VoqStat' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks.AllVoqStatsDataBlock.VoqStat', 
                [], [], 
                '''                voq stat
                ''',
                'voq_stat',
    ...
    'Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks',
            False, 
            [
            _MetaInfoClassMember('all-voq-stats-data-block', REFERENCE_LIST, 'AllVoqStatsDataBlock' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks.AllVoqStatsDataBlock', 
                [], [], 
    ...
    'Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber.VoqBaseDataBlockNumber' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber.VoqBaseDataBlockNumber',
            ...
            _MetaInfoClassMember('voq-base', ATTRIBUTE, 'int' , None, None, 
                ...
                'voq_base',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('voq-stat', REFERENCE_LIST, 'VoqStat' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber.VoqBaseDataBlockNumber.VoqStat', 
                [], [], 
                '''                voq stat
                ''',
                'voq_stat',
    ...
    'Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber',
            ...
            _MetaInfoClassMember('base-number', ATTRIBUTE, 'int' , None, None, 
                ...
                'base_number',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', True),
            _MetaInfoClassMember('voq-base-data-block-number', REFERENCE_LIST, 'VoqBaseDataBlockNumber' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber.VoqBaseDataBlockNumber', 
                [], [], 
                '''                Indicates the data block number for a
    ...
    'Dpa.Stats.Nodes.Node.VoqBaseNumbers' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.VoqBaseNumbers',
            False, 
            [
            _MetaInfoClassMember('voq-base-number', REFERENCE_LIST, 'VoqBaseNumber' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.VoqBaseNumbers.VoqBaseNumber', 
                [], [], 
    ...
    'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock.VoqStatsDataBlockNumber' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock.VoqStatsDataBlockNumber',
            ...
            _MetaInfoClassMember('voq-base', ATTRIBUTE, 'int' , None, None, 
                ...
                'voq_base',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('voq-stat', REFERENCE_LIST, 'VoqStat' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock.VoqStatsDataBlockNumber.VoqStat', 
                [], [], 
                '''                voq stat
                ''',
                'voq_stat',
    ...
    'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock',
            ...
            _MetaInfoClassMember('interface-handle', ATTRIBUTE, 'int' , None, None, 
                ...
                'interface_handle',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', True),
            _MetaInfoClassMember('voq-stats-data-block-number', REFERENCE_LIST, 'VoqStatsDataBlockNumber' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock.VoqStatsDataBlockNumber', 
                [], [], 
                '''                Indicates the data block number for a
    ...
    'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks',
            False, 
            [
            _MetaInfoClassMember('single-voq-stats-data-block', REFERENCE_LIST, 'SingleVoqStatsDataBlock' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks.SingleVoqStatsDataBlock', 
                [], [], 
    ...
    'Dpa.Stats.Nodes.Node' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes.Node',
            ...
            _MetaInfoClassMember('node-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'node_name',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', True),
            _MetaInfoClassMember('all-traps-stats-data-blocks', REFERENCE_CLASS, 'AllTrapsStatsDataBlocks' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.AllTrapsStatsDataBlocks', 
                [], [], 
                '''                DPA trap stats 
                ''',
                'all_traps_stats_data_blocks',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('all-voq-stats-data-blocks', REFERENCE_CLASS, 'AllVoqStatsDataBlocks' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.AllVoqStatsDataBlocks', 
                [], [], 
                '''                DPA voq ingress stats 
                ''',
                'all_voq_stats_data_blocks',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('single-trap-stats-data-blocks', REFERENCE_CLASS, 'SingleTrapStatsDataBlocks' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleTrapStatsDataBlocks', 
                [], [], 
                '''                DPA stats for a single trap
                ''',
                'single_trap_stats_data_blocks',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('single-voq-stats-data-blocks', REFERENCE_CLASS, 'SingleVoqStatsDataBlocks' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.SingleVoqStatsDataBlocks', 
                [], [], 
                '''                DPA voq ingress stats for a single interface
                ''',
                'single_voq_stats_data_blocks',
                'Cisco-IOS-XR-fretta-bcm-dpa-oper', False),
            _MetaInfoClassMember('voq-base-numbers', REFERENCE_CLASS, 'VoqBaseNumbers' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node.VoqBaseNumbers', 
                [], [], 
                '''                DPA voq base stats 
                ''',
                'voq_base_numbers',
    ...
    'Dpa.Stats.Nodes' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes.Node', 
                [], [], 
    ...
    'Dpa.Stats' : {
        'meta_info' : _MetaInfoClass('Dpa.Stats',
            False, 
            [
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats.Nodes', 
                [], [], 
    ...
    'Dpa' : {
        'meta_info' : _MetaInfoClass('Dpa',
            False, 
            [
            _MetaInfoClassMember('stats', REFERENCE_CLASS, 'Stats' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_fretta_bcm_dpa_oper', 'Dpa.Stats', 
                [], [], 
                '''                DPA voq data
                ''',
                'stats',
