...
_meta_table = {
    ...
    'Ipv6Neighbor.Neighbors' : {
        'meta_info' : _MetaInfoClass('Ipv6Neighbor.Neighbors',
            False, 
            [
            _MetaInfoClassMember('neighbor', REFERENCE_LIST, 'Neighbor' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_cfg', 'Ipv6Neighbor.Neighbors.Neighbor', 
                [], [], 
    ...
    'Ipv6Neighbor' : {
        'meta_info' : _MetaInfoClass('Ipv6Neighbor',
            False, 
            [
            _MetaInfoClassMember('neighbors', REFERENCE_CLASS, 'Neighbors' , 'ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_cfg', 'Ipv6Neighbor.Neighbors', 
                [], [], 
                '''                IPv6 neighbors
                ''',
                'neighbors',
