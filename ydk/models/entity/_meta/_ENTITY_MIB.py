...
_meta_table = {
    'PhysicalClass_Enum' : _MetaInfoEnum('PhysicalClass_Enum', 'ydk.models.entity.ENTITY_MIB',
        {
            'other':'OTHER',
            'unknown':'UNKNOWN',
            'chassis':'CHASSIS',
    ...
    'ENTITYMIB.EntAliasMappingTable' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB.EntAliasMappingTable',
            False, 
            [
            _MetaInfoClassMember('entAliasMappingEntry', REFERENCE_LIST, 'EntAliasMappingEntry' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntAliasMappingTable.EntAliasMappingEntry', 
                [], [], 
    ...
    'ENTITYMIB.EntLPMappingTable' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB.EntLPMappingTable',
            False, 
            [
            _MetaInfoClassMember('entLPMappingEntry', REFERENCE_LIST, 'EntLPMappingEntry' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntLPMappingTable.EntLPMappingEntry', 
                [], [], 
    ...
    'ENTITYMIB.EntLogicalTable' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB.EntLogicalTable',
            False, 
            [
            _MetaInfoClassMember('entLogicalEntry', REFERENCE_LIST, 'EntLogicalEntry' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntLogicalTable.EntLogicalEntry', 
                [], [], 
    ...
    'ENTITYMIB.EntPhysicalContainsTable' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB.EntPhysicalContainsTable',
            False, 
            [
            _MetaInfoClassMember('entPhysicalContainsEntry', REFERENCE_LIST, 'EntPhysicalContainsEntry' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntPhysicalContainsTable.EntPhysicalContainsEntry', 
                [], [], 
    ...
    'ENTITYMIB.EntPhysicalTable.EntPhysicalEntry' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB.EntPhysicalTable.EntPhysicalEntry',
            ...
            _MetaInfoClassMember('entPhysicalAssetID', ATTRIBUTE, 'str' , None, None, 
                ...
                'entphysicalassetid',
                'ENTITY-MIB', False),
            _MetaInfoClassMember('entPhysicalClass', REFERENCE_ENUM_CLASS, 'PhysicalClass_Enum' , 'ydk.models.entity.ENTITY_MIB', 'PhysicalClass_Enum', 
                [], [], 
    ...
    'ENTITYMIB.EntPhysicalTable' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB.EntPhysicalTable',
            False, 
            [
            _MetaInfoClassMember('entPhysicalEntry', REFERENCE_LIST, 'EntPhysicalEntry' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntPhysicalTable.EntPhysicalEntry', 
                [], [], 
    ...
    'ENTITYMIB' : {
        'meta_info' : _MetaInfoClass('ENTITYMIB',
            False, 
            [
            _MetaInfoClassMember('entAliasMappingTable', REFERENCE_CLASS, 'EntAliasMappingTable' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntAliasMappingTable', 
                [], [], 
                ...
                'entaliasmappingtable',
                'ENTITY-MIB', False),
            _MetaInfoClassMember('entityGeneral', REFERENCE_CLASS, 'EntityGeneral' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntityGeneral', 
                [], [], 
                '''                ''',
                'entitygeneral',
                'ENTITY-MIB', False),
            _MetaInfoClassMember('entLogicalTable', REFERENCE_CLASS, 'EntLogicalTable' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntLogicalTable', 
                [], [], 
                ...
                'entlogicaltable',
                'ENTITY-MIB', False),
            _MetaInfoClassMember('entLPMappingTable', REFERENCE_CLASS, 'EntLPMappingTable' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntLPMappingTable', 
                [], [], 
                ...
                'entlpmappingtable',
                'ENTITY-MIB', False),
            _MetaInfoClassMember('entPhysicalContainsTable', REFERENCE_CLASS, 'EntPhysicalContainsTable' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntPhysicalContainsTable', 
                [], [], 
                ...
                'entphysicalcontainstable',
                'ENTITY-MIB', False),
            _MetaInfoClassMember('entPhysicalTable', REFERENCE_CLASS, 'EntPhysicalTable' , 'ydk.models.entity.ENTITY_MIB', 'ENTITYMIB.EntPhysicalTable', 
                [], [], 
