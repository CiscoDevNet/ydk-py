...
class TelemetrySystem(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"destination-groups" : ("destination_groups", TelemetrySystem.DestinationGroups), "sensor-groups" : ("sensor_groups", TelemetrySystem.SensorGroups), "subscriptions" : ("subscriptions", TelemetrySystem.Subscriptions)}
    ...
    class DestinationGroups(Entity):
        ...
        def __init__(self):
            ...
            self._child_list_classes = {"destination-group" : ("destination_group", TelemetrySystem.DestinationGroups.DestinationGroup)}
        ...
        class DestinationGroup(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"config" : ("config", TelemetrySystem.DestinationGroups.DestinationGroup.Config), "destinations" : ("destinations", TelemetrySystem.DestinationGroups.DestinationGroup.Destinations), "state" : ("state", TelemetrySystem.DestinationGroups.DestinationGroup.State)}
                self._child_list_classes = {}
                ...
                self._segment_path = lambda: "destination-group" + "[group-id='" + self.group_id.get() + "']"
            ...
            class Destinations(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = True
                    self._child_container_classes = {}
                    self._child_list_classes = {"destination" : ("destination", TelemetrySystem.DestinationGroups.DestinationGroup.Destinations.Destination)}
                ...
                class Destination(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = True
                        self._child_container_classes = {"config" : ("config", TelemetrySystem.DestinationGroups.DestinationGroup.Destinations.Destination.Config), "state" : ("state", TelemetrySystem.DestinationGroups.DestinationGroup.Destinations.Destination.State)}
                        self._child_list_classes = {}
                        ...
                        self._children_name_map["state"] = "state"
                        self._children_yang_names.add("state")
                        self._segment_path = lambda: "destination" + "[destination-address='" + self.destination_address.get() + "']" + "[destination-port='" + self.destination_port.get() + "']"
    ...
    class SensorGroups(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"sensor-group" : ("sensor_group", TelemetrySystem.SensorGroups.SensorGroup)}
        ...
        class SensorGroup(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = False
                self._child_container_classes = {"config" : ("config", TelemetrySystem.SensorGroups.SensorGroup.Config), "sensor-paths" : ("sensor_paths", TelemetrySystem.SensorGroups.SensorGroup.SensorPaths), "state" : ("state", TelemetrySystem.SensorGroups.SensorGroup.State)}
                self._child_list_classes = {}
            ...
            class SensorPaths(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = True
                    self._child_container_classes = {}
                    self._child_list_classes = {"sensor-path" : ("sensor_path", TelemetrySystem.SensorGroups.SensorGroup.SensorPaths.SensorPath)}
                ...
                class SensorPath(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.is_top_level_class = False
                        self.has_list_ancestor = True
                        self._child_container_classes = {"config" : ("config", TelemetrySystem.SensorGroups.SensorGroup.SensorPaths.SensorPath.Config), "state" : ("state", TelemetrySystem.SensorGroups.SensorGroup.SensorPaths.SensorPath.State)}
                        self._child_list_classes = {}
                        ...
                        self._children_name_map["state"] = "state"
                        self._children_yang_names.add("state")
                        self._segment_path = lambda: "sensor-path" + "[path='" + self.path.get() + "']"
                    ...
                    class Config(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(TelemetrySystem.SensorGroups.SensorGroup.SensorPaths.SensorPath.Config, ['exclude_filter', 'path'], name, value)
                    ...
                    class State(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(TelemetrySystem.SensorGroups.SensorGroup.SensorPaths.SensorPath.State, ['exclude_filter', 'path'], name, value)
    ...
    class Subscriptions(Entity):
        ...
        def __init__(self):
            ...
            self.is_top_level_class = False
            self.has_list_ancestor = False
            self._child_container_classes = {"dynamic" : ("dynamic", TelemetrySystem.Subscriptions.Dynamic), "persistent" : ("persistent", TelemetrySystem.Subscriptions.Persistent)}
            self._child_list_classes = {}
        ...
        class Dynamic(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"subscription" : ("subscription", TelemetrySystem.Subscriptions.Dynamic.Subscription)}
            ...
            class Subscription(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"sensor-paths" : ("sensor_paths", TelemetrySystem.Subscriptions.Dynamic.Subscription.SensorPaths), "state" : ("state", TelemetrySystem.Subscriptions.Dynamic.Subscription.State)}
                    self._child_list_classes = {}
                ...
                class SensorPaths(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"sensor-path" : ("sensor_path", TelemetrySystem.Subscriptions.Dynamic.Subscription.SensorPaths.SensorPath)}
                    ...
                    class SensorPath(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"state" : ("state", TelemetrySystem.Subscriptions.Dynamic.Subscription.SensorPaths.SensorPath.State)}
                            self._child_list_classes = {}
                        ...
                        class State(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(TelemetrySystem.Subscriptions.Dynamic.Subscription.SensorPaths.SensorPath.State, ['exclude_filter', 'path'], name, value)
                ...
                class State(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(TelemetrySystem.Subscriptions.Dynamic.Subscription.State, ['destination_address', 'destination_port', 'destination_protocol', 'heartbeat_interval', 'originated_qos_marking', 'sample_interval', 'subscription_id', 'suppress_redundant'], name, value)
        ...
        class Persistent(Entity):
            ...
            def __init__(self):
                ...
                self.has_list_ancestor = False
                self._child_container_classes = {}
                self._child_list_classes = {"subscription" : ("subscription", TelemetrySystem.Subscriptions.Persistent.Subscription)}
            ...
            class Subscription(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = False
                    self._child_container_classes = {"config" : ("config", TelemetrySystem.Subscriptions.Persistent.Subscription.Config), "destination-groups" : ("destination_groups", TelemetrySystem.Subscriptions.Persistent.Subscription.DestinationGroups), "sensor-profiles" : ("sensor_profiles", TelemetrySystem.Subscriptions.Persistent.Subscription.SensorProfiles), "state" : ("state", TelemetrySystem.Subscriptions.Persistent.Subscription.State)}
                    self._child_list_classes = {}
                ...
                class Config(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(TelemetrySystem.Subscriptions.Persistent.Subscription.Config, ['local_source_address', 'originated_qos_marking', 'subscription_id'], name, value)
                ...
                class DestinationGroups(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"destination-group" : ("destination_group", TelemetrySystem.Subscriptions.Persistent.Subscription.DestinationGroups.DestinationGroup)}
                    ...
                    class DestinationGroup(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"config" : ("config", TelemetrySystem.Subscriptions.Persistent.Subscription.DestinationGroups.DestinationGroup.Config), "state" : ("state", TelemetrySystem.Subscriptions.Persistent.Subscription.DestinationGroups.DestinationGroup.State)}
                            self._child_list_classes = {}
                ...
                class SensorProfiles(Entity):
                    ...
                    def __init__(self):
                        ...
                        self.has_list_ancestor = True
                        self._child_container_classes = {}
                        self._child_list_classes = {"sensor-profile" : ("sensor_profile", TelemetrySystem.Subscriptions.Persistent.Subscription.SensorProfiles.SensorProfile)}
                    ...
                    class SensorProfile(Entity):
                        ...
                        def __init__(self):
                            ...
                            self.is_top_level_class = False
                            self.has_list_ancestor = True
                            self._child_container_classes = {"config" : ("config", TelemetrySystem.Subscriptions.Persistent.Subscription.SensorProfiles.SensorProfile.Config), "state" : ("state", TelemetrySystem.Subscriptions.Persistent.Subscription.SensorProfiles.SensorProfile.State)}
                            self._child_list_classes = {}
                            ...
                            self._children_name_map["state"] = "state"
                            self._children_yang_names.add("state")
                            self._segment_path = lambda: "sensor-profile" + "[sensor-group='" + self.sensor_group.get() + "']"
                        ...
                        class Config(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(TelemetrySystem.Subscriptions.Persistent.Subscription.SensorProfiles.SensorProfile.Config, ['heartbeat_interval', 'sample_interval', 'sensor_group', 'suppress_redundant'], name, value)
                        ...
                        class State(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(TelemetrySystem.Subscriptions.Persistent.Subscription.SensorProfiles.SensorProfile.State, ['heartbeat_interval', 'sample_interval', 'sensor_group', 'suppress_redundant'], name, value)
                ...
                class State(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(TelemetrySystem.Subscriptions.Persistent.Subscription.State, ['local_source_address', 'originated_qos_marking', 'subscription_id'], name, value)
