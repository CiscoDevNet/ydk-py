...
_meta_table = {
    ...
    'Bfd.FlapDamp' : {
        'meta_info' : _MetaInfoClass('Bfd.FlapDamp',
            False, 
            [
            _MetaInfoClassMember('bundle-member', REFERENCE_CLASS, 'BundleMember' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.FlapDamp.BundleMember', 
                [], [], 
                '''                Bundle per member feature class container
                ''',
                'bundle_member',
                'Cisco-IOS-XR-ip-bfd-cfg', False),
            _MetaInfoClassMember('extensions', REFERENCE_CLASS, 'Extensions' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.FlapDamp.Extensions', 
                [], [], 
    ...
    'Bfd.EchoLatency' : {
        'meta_info' : _MetaInfoClass('Bfd.EchoLatency',
            False, 
            [
            _MetaInfoClassMember('detect', REFERENCE_CLASS, 'Detect' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.EchoLatency.Detect', 
                [], [], 
    ...
    'Bfd.Interfaces' : {
        'meta_info' : _MetaInfoClass('Bfd.Interfaces',
            False, 
            [
            _MetaInfoClassMember('interface', REFERENCE_LIST, 'Interface' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.Interfaces.Interface', 
                [], [], 
    ...
    'Bfd.MultiPathIncludes' : {
        'meta_info' : _MetaInfoClass('Bfd.MultiPathIncludes',
            False, 
            [
            _MetaInfoClassMember('multi-path-include', REFERENCE_LIST, 'MultiPathInclude' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.MultiPathIncludes.MultiPathInclude', 
                [], [], 
    ...
    'Bfd.Bundle' : {
        'meta_info' : _MetaInfoClass('Bfd.Bundle',
            False, 
            [
            _MetaInfoClassMember('coexistence', REFERENCE_CLASS, 'Coexistence' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.Bundle.Coexistence', 
                [], [], 
    ...
    'Bfd' : {
        'meta_info' : _MetaInfoClass('Bfd',
            ...
            _MetaInfoClassMember('echo-latency', REFERENCE_CLASS, 'EchoLatency' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.EchoLatency', 
                ...
                'echo_latency',
                'Cisco-IOS-XR-ip-bfd-cfg', False),
            _MetaInfoClassMember('echo-startup', REFERENCE_CLASS, 'EchoStartup' , 'ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg', 'Bfd.EchoStartup', 
                [], [], 
