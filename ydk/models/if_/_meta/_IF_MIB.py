...
_meta_table = {
    'IFMIB.IfMIBObjects' : {
        ...
        'ydk.models.if_.IF_MIB'
        ),
    },
    'IFMIB.IfRcvAddressTable.IfRcvAddressEntry.IfRcvAddressType_Enum' : _MetaInfoEnum('IfRcvAddressType_Enum', 'ydk.models.if_.IF_MIB',
        {
            'other':'OTHER',
            'volatile':'VOLATILE',
    ...
    'IFMIB.IfRcvAddressTable.IfRcvAddressEntry' : {
        'meta_info' : _MetaInfoClass('IFMIB.IfRcvAddressTable.IfRcvAddressEntry',
            ...
            _MetaInfoClassMember('ifRcvAddressAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'ifrcvaddressaddress',
                'IF-MIB', True),
            _MetaInfoClassMember('ifRcvAddressStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'ifrcvaddressstatus',
                'IF-MIB', False),
            _MetaInfoClassMember('ifRcvAddressType', REFERENCE_ENUM_CLASS, 'IfRcvAddressType_Enum' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfRcvAddressTable.IfRcvAddressEntry.IfRcvAddressType_Enum', 
                [], [], 
    ...
    'IFMIB.IfRcvAddressTable' : {
        'meta_info' : _MetaInfoClass('IFMIB.IfRcvAddressTable',
            False, 
            [
            _MetaInfoClassMember('ifRcvAddressEntry', REFERENCE_LIST, 'IfRcvAddressEntry' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfRcvAddressTable.IfRcvAddressEntry', 
                [], [], 
    ...
    'IFMIB.IfStackTable.IfStackEntry' : {
        'meta_info' : _MetaInfoClass('IFMIB.IfStackTable.IfStackEntry',
            ...
            _MetaInfoClassMember('ifStackLowerLayer', ATTRIBUTE, 'int' , None, None, 
                ...
                'ifstacklowerlayer',
                'IF-MIB', True),
            _MetaInfoClassMember('ifStackStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
    ...
    'IFMIB.IfStackTable' : {
        'meta_info' : _MetaInfoClass('IFMIB.IfStackTable',
            False, 
            [
            _MetaInfoClassMember('ifStackEntry', REFERENCE_LIST, 'IfStackEntry' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfStackTable.IfStackEntry', 
                [], [], 
    ...
    'IFMIB.IfTable.IfEntry.IfAdminStatus_Enum' : _MetaInfoEnum('IfAdminStatus_Enum', 'ydk.models.if_.IF_MIB',
        {
            'up':'UP',
            'down':'DOWN',
            'testing':'TESTING',
        }, 'IF-MIB', _yang_ns._namespaces['IF-MIB']),
    'IFMIB.IfTable.IfEntry.IfLinkUpDownTrapEnable_Enum' : _MetaInfoEnum('IfLinkUpDownTrapEnable_Enum', 'ydk.models.if_.IF_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'IF-MIB', _yang_ns._namespaces['IF-MIB']),
    'IFMIB.IfTable.IfEntry.IfOperStatus_Enum' : _MetaInfoEnum('IfOperStatus_Enum', 'ydk.models.if_.IF_MIB',
        {
            'up':'UP',
            'down':'DOWN',
            'testing':'TESTING',
    ...
    'IFMIB.IfTable.IfEntry.IfTestResult_Enum' : _MetaInfoEnum('IfTestResult_Enum', 'ydk.models.if_.IF_MIB',
        {
            'none':'NONE',
            'success':'SUCCESS',
    ...
    'IFMIB.IfTable.IfEntry.IfTestStatus_Enum' : _MetaInfoEnum('IfTestStatus_Enum', 'ydk.models.if_.IF_MIB',
        {
            'notInUse':'NOTINUSE',
            'inUse':'INUSE',
        }, 'IF-MIB', _yang_ns._namespaces['IF-MIB']),
    'IFMIB.IfTable.IfEntry' : {
        'meta_info' : _MetaInfoClass('IFMIB.IfTable.IfEntry',
            ...
            _MetaInfoClassMember('ifIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'ifindex',
                'IF-MIB', True),
            _MetaInfoClassMember('ifAdminStatus', REFERENCE_ENUM_CLASS, 'IfAdminStatus_Enum' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable.IfEntry.IfAdminStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ifLastChange', ATTRIBUTE, 'int' , None, None, 
                ...
                'iflastchange',
                'IF-MIB', False),
            _MetaInfoClassMember('ifLinkUpDownTrapEnable', REFERENCE_ENUM_CLASS, 'IfLinkUpDownTrapEnable_Enum' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable.IfEntry.IfLinkUpDownTrapEnable_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ifName', ATTRIBUTE, 'str' , None, None, 
                ...
                'ifname',
                'IF-MIB', False),
            _MetaInfoClassMember('ifOperStatus', REFERENCE_ENUM_CLASS, 'IfOperStatus_Enum' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable.IfEntry.IfOperStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ifTestOwner', ATTRIBUTE, 'str' , None, None, 
                ...
                'iftestowner',
                'IF-MIB', False),
            _MetaInfoClassMember('ifTestResult', REFERENCE_ENUM_CLASS, 'IfTestResult_Enum' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable.IfEntry.IfTestResult_Enum', 
                [], [], 
                ...
                'iftestresult',
                'IF-MIB', False),
            _MetaInfoClassMember('ifTestStatus', REFERENCE_ENUM_CLASS, 'IfTestStatus_Enum' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable.IfEntry.IfTestStatus_Enum', 
                [], [], 
    ...
    'IFMIB.IfTable' : {
        'meta_info' : _MetaInfoClass('IFMIB.IfTable',
            False, 
            [
            _MetaInfoClassMember('ifEntry', REFERENCE_LIST, 'IfEntry' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable.IfEntry', 
                [], [], 
    ...
    'IFMIB' : {
        'meta_info' : _MetaInfoClass('IFMIB',
            False, 
            [
            _MetaInfoClassMember('ifMIBObjects', REFERENCE_CLASS, 'IfMIBObjects' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfMIBObjects', 
                [], [], 
                '''                ''',
                'ifmibobjects',
                'IF-MIB', False),
            _MetaInfoClassMember('ifRcvAddressTable', REFERENCE_CLASS, 'IfRcvAddressTable' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfRcvAddressTable', 
                [], [], 
                ...
                'ifrcvaddresstable',
                'IF-MIB', False),
            _MetaInfoClassMember('ifStackTable', REFERENCE_CLASS, 'IfStackTable' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfStackTable', 
                [], [], 
                ...
                'ifstacktable',
                'IF-MIB', False),
            _MetaInfoClassMember('ifTable', REFERENCE_CLASS, 'IfTable' , 'ydk.models.if_.IF_MIB', 'IFMIB.IfTable', 
                [], [], 
                ...
                'iftable',
                'IF-MIB', False),
            _MetaInfoClassMember('interfaces', REFERENCE_CLASS, 'Interfaces' , 'ydk.models.if_.IF_MIB', 'IFMIB.Interfaces', 
                [], [], 
                '''                ''',
                'interfaces',
                'IF-MIB', False),
