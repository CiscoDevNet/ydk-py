...
class MplsStatic(Entity):
    ...
    class MplsStaticCfg(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ipv4-ingress-lsps", ("ipv4_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv4IngressLsps)), ("interfaces", ("interfaces", MplsStatic.MplsStaticCfg.Interfaces)), ("named-lsps", ("named_lsps", MplsStatic.MplsStaticCfg.NamedLsps)), ("ipv6-ingress-lsps", ("ipv6_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv6IngressLsps)), ("in-label-lsps", ("in_label_lsps", MplsStatic.MplsStaticCfg.InLabelLsps))])
            self._leafs = OrderedDict()
                ...
                class Path(Entity):
                    ...
                    class NextHop(Entity):
                        ...
                        class NextHopType(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.NextHopType, ['ipv6_address', 'mac_address', 'if_index', 'ipv4_address', 'out_interface_name'], name, value)
