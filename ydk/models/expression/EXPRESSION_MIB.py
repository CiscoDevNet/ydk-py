...
class EXPRESSIONMIB(object):
    ...
    .. attribute:: expexpressiontable
    	...
    	**type**\: :py:class:`ExpExpressionTable <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpExpressionTable>`
    
    .. attribute:: expnames
    
    	
    	**type**\: :py:class:`ExpNames <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpNames>`
    
    .. attribute:: expnametable
    
    	A table of expression names, for creating and deleting expressions
    	**type**\: :py:class:`ExpNameTable <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpNameTable>`
    ...
    .. attribute:: expobjecttable
    	...
    	**type**\: :py:class:`ExpObjectTable <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpObjectTable>`
    
    .. attribute:: expresource
    
    	
    	**type**\: :py:class:`ExpResource <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpResource>`
    
    .. attribute:: expvaluetable
    
    	A table of values from evaluated expressions
    	**type**\: :py:class:`ExpValueTable <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpValueTable>`
    ...
    class ExpExpressionTable(object):
        ...
        .. attribute:: expexpressionentry
        	...
        	**type**\: list of :py:class:`ExpExpressionEntry <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry>`
        ...
        class ExpExpressionEntry(object):
            ...
            .. attribute:: expexpressionerror
            	...
            	**type**\: :py:class:`ExpExpressionError_Enum <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionError_Enum>`
            ...
            .. attribute:: expexpressionvaluetype
            	...
            	**type**\: :py:class:`ExpExpressionValueType_Enum <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionValueType_Enum>`
            ...
            class ExpExpressionError_Enum(Enum):
                """
                ExpExpressionError_Enum
                ...
                @staticmethod
                def _meta_info():
                    from ydk.models.expression._meta import _EXPRESSION_MIB as meta
                    return meta._meta_table['EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionError_Enum']
            ...
            class ExpExpressionValueType_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.expression._meta import _EXPRESSION_MIB as meta
                    return meta._meta_table['EXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionValueType_Enum']


            @property
            def _common_path(self):
                if self.expexpressionindex is None:
                    raise YPYDataValidationError('Key property expexpressionindex is None')
    ...
    class ExpNameTable(object):
        ...
        .. attribute:: expnameentry
        	...
        	**type**\: list of :py:class:`ExpNameEntry <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpNameTable.ExpNameEntry>`
        ...
        class ExpNameEntry(object):
            ...
            def _common_path(self):
                if self.expname is None:
                    raise YPYDataValidationError('Key property expname is None')
    ...
    class ExpObjectTable(object):
        ...
        .. attribute:: expobjectentry
        	...
        	**type**\: list of :py:class:`ExpObjectEntry <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry>`
        ...
        class ExpObjectEntry(object):
            ...
            .. attribute:: expobjectdiscontinuityidtype
            	...
            	**type**\: :py:class:`ExpObjectDiscontinuityIDType_Enum <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectDiscontinuityIDType_Enum>`
            ...
            .. attribute:: expobjectsampletype
            	...
            	**type**\: :py:class:`ExpObjectSampleType_Enum <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectSampleType_Enum>`
            ...
            class ExpObjectDiscontinuityIDType_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.expression._meta import _EXPRESSION_MIB as meta
                    return meta._meta_table['EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectDiscontinuityIDType_Enum']
            ...
            class ExpObjectSampleType_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.expression._meta import _EXPRESSION_MIB as meta
                    return meta._meta_table['EXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectSampleType_Enum']
    ...
    class ExpValueTable(object):
        ...
        .. attribute:: expvalueentry
        	...
        	**type**\: list of :py:class:`ExpValueEntry <ydk.models.expression.EXPRESSION_MIB.EXPRESSIONMIB.ExpValueTable.ExpValueEntry>`
    ...
    def _has_data(self):
        ...
        if self.expnames is not None and self.expnames.is_presence():
            return True

        if self.expnametable is not None and self.expnametable._has_data():
            return True

        if self.expnametable is not None and self.expnametable.is_presence():
            return True
