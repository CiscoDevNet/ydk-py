...
class DISMANEXPRESSIONMIB(object):
    ...
    .. attribute:: experrortable
    	...
    	**type**\: :py:class:`ExpErrorTable <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpErrorTable>`
    
    .. attribute:: expexpressiontable
    
    	A table of expression definitions
    	**type**\: :py:class:`ExpExpressionTable <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpExpressionTable>`
    ...
    .. attribute:: expobjecttable
    	...
    	**type**\: :py:class:`ExpObjectTable <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpObjectTable>`
    
    .. attribute:: expresource
    
    	
    	**type**\: :py:class:`ExpResource <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpResource>`
    
    .. attribute:: expvaluetable
    
    	A table of values from evaluated expressions
    	**type**\: :py:class:`ExpValueTable <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpValueTable>`
    
    

    """

    _prefix = 'disman-expression'
    ...
    class ExpErrorTable(object):
        ...
        .. attribute:: experrorentry
        	...
        	**type**\: list of :py:class:`ExpErrorEntry <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpErrorTable.ExpErrorEntry>`
        ...
        class ExpErrorEntry(object):
            ...
            .. attribute:: experrorcode
            	...
            	**type**\: :py:class:`ExpErrorCode_Enum <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpErrorTable.ExpErrorEntry.ExpErrorCode_Enum>`
            ...
            class ExpErrorCode_Enum(Enum):
                ...
                @staticmethod
                def _meta_info():
                    from ydk.models.disman._meta import _DISMAN_EXPRESSION_MIB as meta
                    return meta._meta_table['DISMANEXPRESSIONMIB.ExpErrorTable.ExpErrorEntry.ExpErrorCode_Enum']


            @property
            def _common_path(self):
                if self.expexpressionname is None:
                    raise YPYDataValidationError('Key property expexpressionname is None')
                if self.expexpressionowner is None:
                    raise YPYDataValidationError('Key property expexpressionowner is None')

                return '/DISMAN-EXPRESSION-MIB:DISMAN-EXPRESSION-MIB/DISMAN-EXPRESSION-MIB:expErrorTable/DISMAN-EXPRESSION-MIB:expErrorEntry[DISMAN-EXPRESSION-MIB:expExpressionName = ' + str(self.expexpressionname) + '][DISMAN-EXPRESSION-MIB:expExpressionOwner = ' + str(self.expexpressionowner) + ']'
    ...
    class ExpExpressionTable(object):
        ...
        .. attribute:: expexpressionentry
        	...
        	**type**\: list of :py:class:`ExpExpressionEntry <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry>`
        ...
        class ExpExpressionEntry(object):
            ...
            .. attribute:: expexpressionvaluetype
            	...
            	**type**\: :py:class:`ExpExpressionValueType_Enum <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionValueType_Enum>`
            ...
            class ExpExpressionValueType_Enum(Enum):
                """
                ExpExpressionValueType_Enum
                ...
                def _meta_info():
                    from ydk.models.disman._meta import _DISMAN_EXPRESSION_MIB as meta
                    return meta._meta_table['DISMANEXPRESSIONMIB.ExpExpressionTable.ExpExpressionEntry.ExpExpressionValueType_Enum']
            ...
            def _common_path(self):
                ...
                return '/DISMAN-EXPRESSION-MIB:DISMAN-EXPRESSION-MIB/DISMAN-EXPRESSION-MIB:expExpressionTable/DISMAN-EXPRESSION-MIB:expExpressionEntry[DISMAN-EXPRESSION-MIB:expExpressionName = ' + str(self.expexpressionname) + '][DISMAN-EXPRESSION-MIB:expExpressionOwner = ' + str(self.expexpressionowner) + ']'
    ...
    class ExpObjectTable(object):
        ...
        .. attribute:: expobjectentry
        	...
        	**type**\: list of :py:class:`ExpObjectEntry <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpObjectTable.ExpObjectEntry>`
        ...
        class ExpObjectEntry(object):
            ...
            .. attribute:: expobjectdiscontinuityidtype
            	...
            	**type**\: :py:class:`ExpObjectDiscontinuityIDType_Enum <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectDiscontinuityIDType_Enum>`
            ...
            .. attribute:: expobjectsampletype
            	...
            	**type**\: :py:class:`ExpObjectSampleType_Enum <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectSampleType_Enum>`
            ...
            class ExpObjectDiscontinuityIDType_Enum(Enum):
                """
                ExpObjectDiscontinuityIDType_Enum
                ...
                def _meta_info():
                    from ydk.models.disman._meta import _DISMAN_EXPRESSION_MIB as meta
                    return meta._meta_table['DISMANEXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectDiscontinuityIDType_Enum']


            class ExpObjectSampleType_Enum(Enum):
                """
                ExpObjectSampleType_Enum
                ...
                def _meta_info():
                    from ydk.models.disman._meta import _DISMAN_EXPRESSION_MIB as meta
                    return meta._meta_table['DISMANEXPRESSIONMIB.ExpObjectTable.ExpObjectEntry.ExpObjectSampleType_Enum']
            ...
            def _common_path(self):
                ...
                if self.expobjectindex is None:
                    raise YPYDataValidationError('Key property expobjectindex is None')

                return '/DISMAN-EXPRESSION-MIB:DISMAN-EXPRESSION-MIB/DISMAN-EXPRESSION-MIB:expObjectTable/DISMAN-EXPRESSION-MIB:expObjectEntry[DISMAN-EXPRESSION-MIB:expExpressionName = ' + str(self.expexpressionname) + '][DISMAN-EXPRESSION-MIB:expExpressionOwner = ' + str(self.expexpressionowner) + '][DISMAN-EXPRESSION-MIB:expObjectIndex = ' + str(self.expobjectindex) + ']'
    ...
    class ExpValueTable(object):
        ...
        .. attribute:: expvalueentry
        	...
        	**type**\: list of :py:class:`ExpValueEntry <ydk.models.disman.DISMAN_EXPRESSION_MIB.DISMANEXPRESSIONMIB.ExpValueTable.ExpValueEntry>`
        ...
        class ExpValueEntry(object):
            ...
            def _common_path(self):
                ...
                if self.expvalueinstance is None:
                    raise YPYDataValidationError('Key property expvalueinstance is None')

                return '/DISMAN-EXPRESSION-MIB:DISMAN-EXPRESSION-MIB/DISMAN-EXPRESSION-MIB:expValueTable/DISMAN-EXPRESSION-MIB:expValueEntry[DISMAN-EXPRESSION-MIB:expExpressionName = ' + str(self.expexpressionname) + '][DISMAN-EXPRESSION-MIB:expExpressionOwner = ' + str(self.expexpressionowner) + '][DISMAN-EXPRESSION-MIB:expValueInstance = ' + str(self.expvalueinstance) + ']'
    ...
    def _has_data(self):
        ...
        if self.experrortable is not None and self.experrortable.is_presence():
            return True

        if self.expexpressiontable is not None and self.expexpressiontable._has_data():
            return True

        if self.expexpressiontable is not None and self.expexpressiontable.is_presence():
            return True

        if self.expobjecttable is not None and self.expobjecttable._has_data():
            return True

        if self.expobjecttable is not None and self.expobjecttable.is_presence():
            return True

        if self.expresource is not None and self.expresource._has_data():
            return True

        if self.expresource is not None and self.expresource.is_presence():
            return True

        if self.expvaluetable is not None and self.expvaluetable._has_data():
            return True

        if self.expvaluetable is not None and self.expvaluetable.is_presence():
            return True
