...
class TOKENRINGRMONMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"ringStationConfigControlTable" : ("ringstationconfigcontroltable", TOKENRINGRMONMIB.Ringstationconfigcontroltable), "ringStationConfigTable" : ("ringstationconfigtable", TOKENRINGRMONMIB.Ringstationconfigtable), "ringStationControlTable" : ("ringstationcontroltable", TOKENRINGRMONMIB.Ringstationcontroltable), "ringStationOrderTable" : ("ringstationordertable", TOKENRINGRMONMIB.Ringstationordertable), "ringStationTable" : ("ringstationtable", TOKENRINGRMONMIB.Ringstationtable), "sourceRoutingStatsTable" : ("sourceroutingstatstable", TOKENRINGRMONMIB.Sourceroutingstatstable), "tokenRingMLHistoryTable" : ("tokenringmlhistorytable", TOKENRINGRMONMIB.Tokenringmlhistorytable), "tokenRingMLStatsTable" : ("tokenringmlstatstable", TOKENRINGRMONMIB.Tokenringmlstatstable), "tokenRingPHistoryTable" : ("tokenringphistorytable", TOKENRINGRMONMIB.Tokenringphistorytable), "tokenRingPStatsTable" : ("tokenringpstatstable", TOKENRINGRMONMIB.Tokenringpstatstable)}
    ...
    class Ringstationconfigtable(Entity):
        ...
        class Ringstationconfigentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Ringstationconfigtable.Ringstationconfigentry, ['ringstationconfigifindex', 'ringstationconfigmacaddress', 'ringstationconfigfunctionaladdress', 'ringstationconfiggroupaddress', 'ringstationconfiglocation', 'ringstationconfigmicrocode', 'ringstationconfigupdatetime'], name, value)
    ...
    class Ringstationcontroltable(Entity):
        ...
        class Ringstationcontrolentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Ringstationcontroltable.Ringstationcontrolentry, ['ringstationcontrolifindex', 'ringstationcontrolactivemonitor', 'ringstationcontrolactivestations', 'ringstationcontrolbeaconnaun', 'ringstationcontrolbeaconsender', 'ringstationcontrolcreatetime', 'ringstationcontroldroppedframes', 'ringstationcontrolorderchanges', 'ringstationcontrolowner', 'ringstationcontrolringstate', 'ringstationcontrolstatus', 'ringstationcontroltablesize'], name, value)
    ...
    class Ringstationtable(Entity):
        ...
        class Ringstationentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Ringstationtable.Ringstationentry, ['ringstationifindex', 'ringstationmacaddress', 'ringstationaborterrors', 'ringstationacerrors', 'ringstationcongestionerrors', 'ringstationduplicateaddresses', 'ringstationframecopiederrors', 'ringstationfrequencyerrors', 'ringstationinbeaconerrors', 'ringstationinbursterrors', 'ringstationinlineerrors', 'ringstationinsertions', 'ringstationinternalerrors', 'ringstationlastentertime', 'ringstationlastexittime', 'ringstationlastnaun', 'ringstationlostframeerrors', 'ringstationoutbeaconerrors', 'ringstationoutbursterrors', 'ringstationoutlineerrors', 'ringstationstationstatus', 'ringstationtokenerrors'], name, value)
    ...
    class Sourceroutingstatstable(Entity):
        ...
        class Sourceroutingstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Sourceroutingstatstable.Sourceroutingstatsentry, ['sourceroutingstatsifindex', 'sourceroutingstats1hopframes', 'sourceroutingstats2hopsframes', 'sourceroutingstats3hopsframes', 'sourceroutingstats4hopsframes', 'sourceroutingstats5hopsframes', 'sourceroutingstats6hopsframes', 'sourceroutingstats7hopsframes', 'sourceroutingstats8hopsframes', 'sourceroutingstatsallroutesbroadcastframes', 'sourceroutingstatsallroutesbroadcastoctets', 'sourceroutingstatscreatetime', 'sourceroutingstatsdroppedframes', 'sourceroutingstatsinframes', 'sourceroutingstatsinoctets', 'sourceroutingstatslocalllcframes', 'sourceroutingstatsmorethan8hopsframes', 'sourceroutingstatsoutframes', 'sourceroutingstatsoutoctets', 'sourceroutingstatsowner', 'sourceroutingstatsringnumber', 'sourceroutingstatssingleroutebroadcastframes', 'sourceroutingstatssingleroutesbroadcastoctets', 'sourceroutingstatsstatus', 'sourceroutingstatsthroughframes', 'sourceroutingstatsthroughoctets'], name, value)
    ...
    class Tokenringmlhistorytable(Entity):
        ...
        class Tokenringmlhistoryentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Tokenringmlhistorytable.Tokenringmlhistoryentry, ['tokenringmlhistoryindex', 'tokenringmlhistorysampleindex', 'tokenringmlhistoryaborterrors', 'tokenringmlhistoryacerrors', 'tokenringmlhistoryactivestations', 'tokenringmlhistorybeaconevents', 'tokenringmlhistorybeaconpkts', 'tokenringmlhistorybeacontime', 'tokenringmlhistorybursterrors', 'tokenringmlhistoryclaimtokenevents', 'tokenringmlhistoryclaimtokenpkts', 'tokenringmlhistorycongestionerrors', 'tokenringmlhistorydropevents', 'tokenringmlhistoryframecopiederrors', 'tokenringmlhistoryfrequencyerrors', 'tokenringmlhistoryinternalerrors', 'tokenringmlhistoryintervalstart', 'tokenringmlhistorylineerrors', 'tokenringmlhistorylostframeerrors', 'tokenringmlhistorymacoctets', 'tokenringmlhistorymacpkts', 'tokenringmlhistorynaunchanges', 'tokenringmlhistoryringpollevents', 'tokenringmlhistoryringpurgeevents', 'tokenringmlhistoryringpurgepkts', 'tokenringmlhistorysofterrorreports', 'tokenringmlhistorytokenerrors'], name, value)
    ...
    class Tokenringmlstatstable(Entity):
        ...
        class Tokenringmlstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Tokenringmlstatstable.Tokenringmlstatsentry, ['tokenringmlstatsindex', 'tokenringmlstatsaborterrors', 'tokenringmlstatsacerrors', 'tokenringmlstatsbeaconevents', 'tokenringmlstatsbeaconpkts', 'tokenringmlstatsbeacontime', 'tokenringmlstatsbursterrors', 'tokenringmlstatsclaimtokenevents', 'tokenringmlstatsclaimtokenpkts', 'tokenringmlstatscongestionerrors', 'tokenringmlstatscreatetime', 'tokenringmlstatsdatasource', 'tokenringmlstatsdropevents', 'tokenringmlstatsdroppedframes', 'tokenringmlstatsframecopiederrors', 'tokenringmlstatsfrequencyerrors', 'tokenringmlstatsinternalerrors', 'tokenringmlstatslineerrors', 'tokenringmlstatslostframeerrors', 'tokenringmlstatsmacoctets', 'tokenringmlstatsmacpkts', 'tokenringmlstatsnaunchanges', 'tokenringmlstatsowner', 'tokenringmlstatsringpollevents', 'tokenringmlstatsringpurgeevents', 'tokenringmlstatsringpurgepkts', 'tokenringmlstatssofterrorreports', 'tokenringmlstatsstatus', 'tokenringmlstatstokenerrors'], name, value)
    ...
    class Tokenringphistorytable(Entity):
        ...
        class Tokenringphistoryentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Tokenringphistorytable.Tokenringphistoryentry, ['tokenringphistoryindex', 'tokenringphistorysampleindex', 'tokenringphistorydatabroadcastpkts', 'tokenringphistorydatamulticastpkts', 'tokenringphistorydataoctets', 'tokenringphistorydatapkts', 'tokenringphistorydatapkts1024to2047octets', 'tokenringphistorydatapkts128to255octets', 'tokenringphistorydatapkts18to63octets', 'tokenringphistorydatapkts2048to4095octets', 'tokenringphistorydatapkts256to511octets', 'tokenringphistorydatapkts4096to8191octets', 'tokenringphistorydatapkts512to1023octets', 'tokenringphistorydatapkts64to127octets', 'tokenringphistorydatapkts8192to18000octets', 'tokenringphistorydatapktsgreaterthan18000octets', 'tokenringphistorydropevents', 'tokenringphistoryintervalstart'], name, value)
    ...
    class Tokenringpstatstable(Entity):
        ...
        class Tokenringpstatsentry(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(TOKENRINGRMONMIB.Tokenringpstatstable.Tokenringpstatsentry, ['tokenringpstatsindex', 'tokenringpstatscreatetime', 'tokenringpstatsdatabroadcastpkts', 'tokenringpstatsdatamulticastpkts', 'tokenringpstatsdataoctets', 'tokenringpstatsdatapkts', 'tokenringpstatsdatapkts1024to2047octets', 'tokenringpstatsdatapkts128to255octets', 'tokenringpstatsdatapkts18to63octets', 'tokenringpstatsdatapkts2048to4095octets', 'tokenringpstatsdatapkts256to511octets', 'tokenringpstatsdatapkts4096to8191octets', 'tokenringpstatsdatapkts512to1023octets', 'tokenringpstatsdatapkts64to127octets', 'tokenringpstatsdatapkts8192to18000octets', 'tokenringpstatsdatapktsgreaterthan18000octets', 'tokenringpstatsdatasource', 'tokenringpstatsdropevents', 'tokenringpstatsdroppedframes', 'tokenringpstatsowner', 'tokenringpstatsstatus'], name, value)
