...
_meta_table = {
    'RedundancyGroupManager.Controllers.Controller' : {
        ...
        'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_oper'
        ),
    },
    'RedundancyGroupManager.Controllers' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager.Controllers',
            False, 
            [
            _MetaInfoClassMember('controller', REFERENCE_LIST, 'Controller' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_oper', 'RedundancyGroupManager.Controllers.Controller', 
                [], [], 
    ...
    'RedundancyGroupManager' : {
        'meta_info' : _MetaInfoClass('RedundancyGroupManager',
            False, 
            [
            _MetaInfoClassMember('controllers', REFERENCE_CLASS, 'Controllers' , 'ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_oper', 'RedundancyGroupManager.Controllers', 
                [], [], 
