...
_meta_table = {
    'CISCOCEFMIB.CefAdjSummaryTable.CefAdjSummaryEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefAdjSummaryTable.CefAdjSummaryEntry',
            False, 
            [
            _MetaInfoClassMember('cefAdjSummaryLinkType', REFERENCE_ENUM_CLASS, 'CefAdjLinkType_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefAdjLinkType_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefAdjSummaryTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefAdjSummaryTable',
            False, 
            [
            _MetaInfoClassMember('cefAdjSummaryEntry', REFERENCE_LIST, 'CefAdjSummaryEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefAdjSummaryTable.CefAdjSummaryEntry', 
                [], [], 
    ...
    'CISCOCEFMIB.CefAdjTable.CefAdjEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefAdjTable.CefAdjEntry',
            ...
            _MetaInfoClassMember('cefAdjNextHopAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'cefadjnexthopaddr',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefAdjNextHopAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cefAdjPkts', ATTRIBUTE, 'int' , None, None, 
                ...
                'cefadjpkts',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefAdjSource', REFERENCE_BITS, 'CefAdjacencySource_Bits' , 'ydk.models.cef.CISCO_CEF_TC', 'CefAdjacencySource_Bits', 
                [], [], 
    ...
    'CISCOCEFMIB.CefAdjTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefAdjTable',
            False, 
            [
            _MetaInfoClassMember('cefAdjEntry', REFERENCE_LIST, 'CefAdjEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefAdjTable.CefAdjEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefCC' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCC',
            False, 
            [
            _MetaInfoClassMember('cefInconsistencyReset', REFERENCE_ENUM_CLASS, 'CefCCAction_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefCCAction_Enum', 
                [], [], 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefInconsistencyResetStatus', REFERENCE_ENUM_CLASS, 'CefCCStatus_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefCCStatus_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefCCGlobalTable.CefCCGlobalEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCCGlobalTable.CefCCGlobalEntry',
            False, 
            [
            _MetaInfoClassMember('cefFIBIpVersion', REFERENCE_ENUM_CLASS, 'CefIpVersion_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefIpVersion_Enum', 
                [], [], 
                '''                ''',
                'ceffibipversion',
                'CISCO-CEF-MIB', True),
            ...
            _MetaInfoClassMember('cefCCGlobalErrorMsgEnabled', ATTRIBUTE, 'bool' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCCGlobalFullScanAction', REFERENCE_ENUM_CLASS, 'CefCCAction_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefCCAction_Enum', 
                [], [], 
                '''                Setting the value of this object to ccActionStart(1)
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCCGlobalFullScanStatus', REFERENCE_ENUM_CLASS, 'CefCCStatus_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefCCStatus_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefCCGlobalTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCCGlobalTable',
            False, 
            [
            _MetaInfoClassMember('cefCCGlobalEntry', REFERENCE_LIST, 'CefCCGlobalEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCCGlobalTable.CefCCGlobalEntry', 
                [], [], 
    ...
    'CISCOCEFMIB.CefCCTypeTable.CefCCTypeEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCCTypeTable.CefCCTypeEntry',
            False, 
            [
            _MetaInfoClassMember('cefCCType', REFERENCE_ENUM_CLASS, 'CefCCType_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefCCType_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefCCTypeTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCCTypeTable',
            False, 
            [
            _MetaInfoClassMember('cefCCTypeEntry', REFERENCE_LIST, 'CefCCTypeEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCCTypeTable.CefCCTypeEntry', 
                [], [], 
                '''                If the managed device supports CEF,
    ...
    'CISCOCEFMIB.CefCfgTable.CefCfgEntry.CefCfgLoadSharingAlgorithm_Enum' : _MetaInfoEnum('CefCfgLoadSharingAlgorithm_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
            'none':'NONE',
            'original':'ORIGINAL',
            'tunnel':'TUNNEL',
    ...
    'CISCOCEFMIB.CefCfgTable.CefCfgEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCfgTable.CefCfgEntry',
            ...
            _MetaInfoClassMember('entPhysicalIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'entphysicalindex',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefCfgAccountingMap', REFERENCE_BITS, 'CefCfgAccountingMap_Bits' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCfgTable.CefCfgEntry.CefCfgAccountingMap_Bits', 
                [], [], 
                ...
                'cefcfgaccountingmap',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCfgAdminState', REFERENCE_ENUM_CLASS, 'CefAdminStatus_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefAdminStatus_Enum', 
                [], [], 
                '''                The desired state of CEF.
                ''',
                'cefcfgadminstate',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCfgDistributionAdminState', REFERENCE_ENUM_CLASS, 'CefAdminStatus_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefAdminStatus_Enum', 
                [], [], 
                '''                The desired state of CEF distribution.
                ''',
                'cefcfgdistributionadminstate',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCfgDistributionOperState', REFERENCE_ENUM_CLASS, 'CefOperStatus_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefOperStatus_Enum', 
                [], [], 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCfgLoadSharingAlgorithm', REFERENCE_ENUM_CLASS, 'CefCfgLoadSharingAlgorithm_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCfgTable.CefCfgEntry.CefCfgLoadSharingAlgorithm_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cefCfgLoadSharingID', ATTRIBUTE, 'int' , None, None, 
                ...
                'cefcfgloadsharingid',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCfgOperState', REFERENCE_ENUM_CLASS, 'CefOperStatus_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefOperStatus_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefCfgTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefCfgTable',
            False, 
            [
            _MetaInfoClassMember('cefCfgEntry', REFERENCE_LIST, 'CefCfgEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCfgTable.CefCfgEntry', 
                [], [], 
                '''                If the Managed device supports CEF, 
    ...
    'CISCOCEFMIB.CefFESelectionTable.CefFESelectionEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefFESelectionTable.CefFESelectionEntry',
            ...
            _MetaInfoClassMember('cefFESelectionAdjInterface', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefFESelectionAdjLinkType', REFERENCE_ENUM_CLASS, 'CefAdjLinkType_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefAdjLinkType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cefFESelectionAdjNextHopAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefFESelectionAdjNextHopAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cefFESelectionLabels', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefFESelectionSpecial', REFERENCE_ENUM_CLASS, 'CefForwardingElementSpecialType_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefForwardingElementSpecialType_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefFESelectionTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefFESelectionTable',
            False, 
            [
            _MetaInfoClassMember('cefFESelectionEntry', REFERENCE_LIST, 'CefFESelectionEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefFESelectionTable.CefFESelectionEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefFIBSummaryTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefFIBSummaryTable',
            False, 
            [
            _MetaInfoClassMember('cefFIBSummaryEntry', REFERENCE_LIST, 'CefFIBSummaryEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefFIBSummaryTable.CefFIBSummaryEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefInconsistencyRecordTable.CefInconsistencyRecordEntry.CefInconsistencyReason_Enum' : _MetaInfoEnum('CefInconsistencyReason_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
            'missing':'MISSING',
    ...
    'CISCOCEFMIB.CefInconsistencyRecordTable.CefInconsistencyRecordEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefInconsistencyRecordTable.CefInconsistencyRecordEntry',
            ...
            _MetaInfoClassMember('cefInconsistencyRecId', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefInconsistencyCCType', REFERENCE_ENUM_CLASS, 'CefCCType_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefCCType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cefInconsistencyPrefixLen', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefInconsistencyPrefixType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefInconsistencyReason', REFERENCE_ENUM_CLASS, 'CefInconsistencyReason_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefInconsistencyRecordTable.CefInconsistencyRecordEntry.CefInconsistencyReason_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefInconsistencyRecordTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefInconsistencyRecordTable',
            False, 
            [
            _MetaInfoClassMember('cefInconsistencyRecordEntry', REFERENCE_LIST, 'CefInconsistencyRecordEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefInconsistencyRecordTable.CefInconsistencyRecordEntry', 
                [], [], 
                '''                If the managed device supports CEF,
    ...
    'CISCOCEFMIB.CefIntTable.CefIntEntry.CefIntLoadSharing_Enum' : _MetaInfoEnum('CefIntLoadSharing_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
            'perPacket':'PERPACKET',
            'perDestination':'PERDESTINATION',
        }, 'CISCO-CEF-MIB', _yang_ns._namespaces['CISCO-CEF-MIB']),
    'CISCOCEFMIB.CefIntTable.CefIntEntry.CefIntNonrecursiveAccouting_Enum' : _MetaInfoEnum('CefIntNonrecursiveAccouting_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
            'internal':'INTERNAL',
            'external':'EXTERNAL',
        }, 'CISCO-CEF-MIB', _yang_ns._namespaces['CISCO-CEF-MIB']),
    'CISCOCEFMIB.CefIntTable.CefIntEntry.CefIntSwitchingState_Enum' : _MetaInfoEnum('CefIntSwitchingState_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
    ...
    'CISCOCEFMIB.CefIntTable.CefIntEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefIntTable.CefIntEntry',
            ...
            _MetaInfoClassMember('ifIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'ifindex',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefIntLoadSharing', REFERENCE_ENUM_CLASS, 'CefIntLoadSharing_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefIntTable.CefIntEntry.CefIntLoadSharing_Enum', 
                [], [], 
                ...
                'cefintloadsharing',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefIntNonrecursiveAccouting', REFERENCE_ENUM_CLASS, 'CefIntNonrecursiveAccouting_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefIntTable.CefIntEntry.CefIntNonrecursiveAccouting_Enum', 
                [], [], 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefIntSwitchingState', REFERENCE_ENUM_CLASS, 'CefIntSwitchingState_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefIntTable.CefIntEntry.CefIntSwitchingState_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefIntTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefIntTable',
            False, 
            [
            _MetaInfoClassMember('cefIntEntry', REFERENCE_LIST, 'CefIntEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefIntTable.CefIntEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device, 
    ...
    'CISCOCEFMIB.CefLMPrefixTable.CefLMPrefixEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefLMPrefixTable.CefLMPrefixEntry',
            ...
            _MetaInfoClassMember('cefLMPrefixDestAddr', ATTRIBUTE, 'str' , None, None, 
                ...
                'ceflmprefixdestaddr',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefLMPrefixDestAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cefLMPrefixLen', ATTRIBUTE, 'int' , None, None, 
                ...
                'ceflmprefixlen',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefLMPrefixRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefLMPrefixState', REFERENCE_ENUM_CLASS, 'CefPrefixSearchState_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefPrefixSearchState_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefLMPrefixTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefLMPrefixTable',
            False, 
            [
            _MetaInfoClassMember('cefLMPrefixEntry', REFERENCE_LIST, 'CefLMPrefixEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefLMPrefixTable.CefLMPrefixEntry', 
                [], [], 
    ...
    'CISCOCEFMIB.CefPathTable.CefPathEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPathTable.CefPathEntry',
            ...
            _MetaInfoClassMember('cefPrefixLen', ATTRIBUTE, 'int' , None, None, 
                ...
                'cefprefixlen',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefPrefixType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
                '''                ''',
                'cefprefixtype',
                'CISCO-CEF-MIB', True),
            ...
            _MetaInfoClassMember('cefPathRecurseVrfName', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefPathType', REFERENCE_ENUM_CLASS, 'CefPathType_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefPathType_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefPathTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPathTable',
            False, 
            [
            _MetaInfoClassMember('cefPathEntry', REFERENCE_LIST, 'CefPathEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPathTable.CefPathEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefPeerFIBTable.CefPeerFIBEntry.CefPeerFIBOperState_Enum' : _MetaInfoEnum('CefPeerFIBOperState_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
    ...
    'CISCOCEFMIB.CefPeerFIBTable.CefPeerFIBEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPeerFIBTable.CefPeerFIBEntry',
            ...
            _MetaInfoClassMember('entPhysicalIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'entphysicalindex',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefPeerFIBOperState', REFERENCE_ENUM_CLASS, 'CefPeerFIBOperState_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPeerFIBTable.CefPeerFIBEntry.CefPeerFIBOperState_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefPeerFIBTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPeerFIBTable',
            False, 
            [
            _MetaInfoClassMember('cefPeerFIBEntry', REFERENCE_LIST, 'CefPeerFIBEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPeerFIBTable.CefPeerFIBEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefPeerTable.CefPeerEntry.CefPeerOperState_Enum' : _MetaInfoEnum('CefPeerOperState_Enum', 'ydk.models.cef.CISCO_CEF_MIB',
        {
    ...
    'CISCOCEFMIB.CefPeerTable.CefPeerEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPeerTable.CefPeerEntry',
            ...
            _MetaInfoClassMember('cefPeerNumberOfResets', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefPeerOperState', REFERENCE_ENUM_CLASS, 'CefPeerOperState_Enum' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPeerTable.CefPeerEntry.CefPeerOperState_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefPeerTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPeerTable',
            False, 
            [
            _MetaInfoClassMember('cefPeerEntry', REFERENCE_LIST, 'CefPeerEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPeerTable.CefPeerEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefPrefixTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefPrefixTable',
            False, 
            [
            _MetaInfoClassMember('cefPrefixEntry', REFERENCE_LIST, 'CefPrefixEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPrefixTable.CefPrefixEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB.CefResourceTable.CefResourceEntry' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefResourceTable.CefResourceEntry',
            ...
            _MetaInfoClassMember('entPhysicalIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'entphysicalindex',
                'CISCO-CEF-MIB', True),
            _MetaInfoClassMember('cefResourceFailureReason', REFERENCE_ENUM_CLASS, 'CefFailureReason_Enum' , 'ydk.models.cef.CISCO_CEF_TC', 'CefFailureReason_Enum', 
                [], [], 
    ...
    'CISCOCEFMIB.CefResourceTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefResourceTable',
            False, 
            [
            _MetaInfoClassMember('cefResourceEntry', REFERENCE_LIST, 'CefResourceEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefResourceTable.CefResourceEntry', 
                [], [], 
                '''                If the Managed device supports CEF,
    ...
    'CISCOCEFMIB.CefStatsPrefixLenTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefStatsPrefixLenTable',
            False, 
            [
            _MetaInfoClassMember('cefStatsPrefixLenEntry', REFERENCE_LIST, 'CefStatsPrefixLenEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefStatsPrefixLenTable.CefStatsPrefixLenEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device
    ...
    'CISCOCEFMIB.CefSwitchingStatsTable' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB.CefSwitchingStatsTable',
            False, 
            [
            _MetaInfoClassMember('cefSwitchingStatsEntry', REFERENCE_LIST, 'CefSwitchingStatsEntry' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefSwitchingStatsTable.CefSwitchingStatsEntry', 
                [], [], 
                '''                If CEF is enabled on the Managed device,
    ...
    'CISCOCEFMIB' : {
        'meta_info' : _MetaInfoClass('CISCOCEFMIB',
            False, 
            [
            _MetaInfoClassMember('cefAdjSummaryTable', REFERENCE_CLASS, 'CefAdjSummaryTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefAdjSummaryTable', 
                [], [], 
                ...
                'cefadjsummarytable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefAdjTable', REFERENCE_CLASS, 'CefAdjTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefAdjTable', 
                [], [], 
                '''                A list of CEF adjacencies.
                ''',
                'cefadjtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCC', REFERENCE_CLASS, 'CefCC' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCC', 
                [], [], 
                '''                ''',
                'cefcc',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCCGlobalTable', REFERENCE_CLASS, 'CefCCGlobalTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCCGlobalTable', 
                [], [], 
                ...
                'cefccglobaltable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCCTypeTable', REFERENCE_CLASS, 'CefCCTypeTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCCTypeTable', 
                [], [], 
                ...
                'cefcctypetable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefCfgTable', REFERENCE_CLASS, 'CefCfgTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefCfgTable', 
                [], [], 
                ...
                'cefcfgtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefFESelectionTable', REFERENCE_CLASS, 'CefFESelectionTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefFESelectionTable', 
                [], [], 
                '''                A list of forwarding element selection entries.
                ''',
                'ceffeselectiontable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefFIB', REFERENCE_CLASS, 'CefFIB' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefFIB', 
                [], [], 
                '''                ''',
                'ceffib',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefFIBSummaryTable', REFERENCE_CLASS, 'CefFIBSummaryTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefFIBSummaryTable', 
                [], [], 
                '''                This table contains the summary information
                ...
                'ceffibsummarytable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefInconsistencyRecordTable', REFERENCE_CLASS, 'CefInconsistencyRecordTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefInconsistencyRecordTable', 
                [], [], 
                ...
                'cefinconsistencyrecordtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefIntTable', REFERENCE_CLASS, 'CefIntTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefIntTable', 
                [], [], 
                ...
                'cefinttable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefLMPrefixTable', REFERENCE_CLASS, 'CefLMPrefixTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefLMPrefixTable', 
                [], [], 
                ...
                'ceflmprefixtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefNotifCntl', REFERENCE_CLASS, 'CefNotifCntl' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefNotifCntl', 
                [], [], 
                '''                ''',
                'cefnotifcntl',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefPathTable', REFERENCE_CLASS, 'CefPathTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPathTable', 
                [], [], 
                ...
                'cefpathtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefPeerFIBTable', REFERENCE_CLASS, 'CefPeerFIBTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPeerFIBTable', 
                [], [], 
                ...
                'cefpeerfibtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefPeerTable', REFERENCE_CLASS, 'CefPeerTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPeerTable', 
                [], [], 
                ...
                'cefpeertable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefPrefixTable', REFERENCE_CLASS, 'CefPrefixTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefPrefixTable', 
                [], [], 
                '''                A list of CEF forwarding prefixes.
                ''',
                'cefprefixtable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefResourceTable', REFERENCE_CLASS, 'CefResourceTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefResourceTable', 
                [], [], 
                ...
                'cefresourcetable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefStatsPrefixLenTable', REFERENCE_CLASS, 'CefStatsPrefixLenTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefStatsPrefixLenTable', 
                [], [], 
                ...
                'cefstatsprefixlentable',
                'CISCO-CEF-MIB', False),
            _MetaInfoClassMember('cefSwitchingStatsTable', REFERENCE_CLASS, 'CefSwitchingStatsTable' , 'ydk.models.cef.CISCO_CEF_MIB', 'CISCOCEFMIB.CefSwitchingStatsTable', 
                [], [], 
