    ...
    class Locations(Entity):
        ...
        class Location(Entity):
            ...
            def __init__(self):
                ...
                self._child_classes = OrderedDict([("fpd", ("fpd", ShowFpd.Locations.Location.Fpd))])
                self._leafs = OrderedDict([
            ...
            class Fpd(Entity):
                ...
                def __init__(self):
                    ...
                    self._child_classes = OrderedDict([("fpd-info-detaile", ("fpd_info_detaile", ShowFpd.Locations.Location.Fpd.FpdInfoDetaile))])
                    self._leafs = OrderedDict([
                ...
                class FpdInfoDetaile(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(ShowFpd.Locations.Location.Fpd.FpdInfoDetaile, [u'location', u'card_name', u'fpd_name', u'hw_version', u'secure_boot_attr', u'status', u'running_version', u'programd_version'], name, value)
