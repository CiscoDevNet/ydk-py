...
_meta_table = {
    'NetFlow.Statistics.Statistic.Producer.Statistics_' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Producer.Statistics_',
            ...
            _MetaInfoClassMember('drops-others', ATTRIBUTE, 'int' , None, None, 
                ...
                'drops_others',
                'Cisco-IOS-XR-skywarp-netflow-oper', False),
            _MetaInfoClassMember('ethernet-pkts', ATTRIBUTE, 'int' , None, None, 
                [('0', '18446744073709551615')], [], 
                '''                Ethernet Packets
                ''',
                'ethernet_pkts',
            ...
            'Cisco-IOS-XR-skywarp-netflow-oper',
            'statistics',
    ...
    'NetFlow.Statistics.Statistic.Producer' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Producer',
            False, 
            [
            _MetaInfoClassMember('statistics', REFERENCE_CLASS, 'Statistics_' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Producer.Statistics_', 
                [], [], 
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic_' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic_',
            False, 
            [
            _MetaInfoClassMember('collector', REFERENCE_LIST, 'Collector' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic_.Collector', 
                [], [], 
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter',
            False, 
            [
            _MetaInfoClassMember('statistic', REFERENCE_LIST, 'Statistic_' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter.Statistic_', 
                [], [], 
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter',
            ...
            _MetaInfoClassMember('exporter-name', ATTRIBUTE, 'str' , None, None, 
                ...
                ''',
                'exporter_name',
                'Cisco-IOS-XR-skywarp-netflow-oper', True),
            _MetaInfoClassMember('exporter', REFERENCE_CLASS, 'Exporter' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter.Exporter', 
                [], [], 
    ...
    'NetFlow.Statistics.Statistic.Server.FlowExporters' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server.FlowExporters',
            False, 
            [
            _MetaInfoClassMember('flow-exporter', REFERENCE_LIST, 'FlowExporter' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters.FlowExporter', 
                [], [], 
    ...
    'NetFlow.Statistics.Statistic.Server' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic.Server',
            False, 
            [
            _MetaInfoClassMember('flow-exporters', REFERENCE_CLASS, 'FlowExporters' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Server.FlowExporters', 
                [], [], 
    ...
    'NetFlow.Statistics.Statistic' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics.Statistic',
            ...
            _MetaInfoClassMember('node', ATTRIBUTE, 'str' , None, None, 
                ...
                'node',
                'Cisco-IOS-XR-skywarp-netflow-oper', True),
            _MetaInfoClassMember('producer', REFERENCE_CLASS, 'Producer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Producer', 
                [], [], 
                '''                NetFlow producer statistics
                ''',
                'producer',
                'Cisco-IOS-XR-skywarp-netflow-oper', False),
            _MetaInfoClassMember('server', REFERENCE_CLASS, 'Server' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic.Server', 
                [], [], 
    ...
    'NetFlow.Statistics' : {
        'meta_info' : _MetaInfoClass('NetFlow.Statistics',
            False, 
            [
            _MetaInfoClassMember('statistic', REFERENCE_LIST, 'Statistic' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics.Statistic', 
                [], [], 
    ...
    'NetFlow' : {
        'meta_info' : _MetaInfoClass('NetFlow',
            False, 
            [
            _MetaInfoClassMember('statistics', REFERENCE_CLASS, 'Statistics' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skywarp_netflow_oper', 'NetFlow.Statistics', 
                [], [], 
