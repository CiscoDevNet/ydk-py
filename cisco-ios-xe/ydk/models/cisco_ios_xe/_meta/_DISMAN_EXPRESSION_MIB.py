...
_meta_table = {
    'DismanExpressionMib.Expresource' : {
        ...
        'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB'
        ),
    },
    'DismanExpressionMib.Expexpressiontable.Expexpressionentry.ExpexpressionvaluetypeEnum' : _MetaInfoEnum('ExpexpressionvaluetypeEnum', 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB',
        {
            'counter32':'counter32',
    ...
    'DismanExpressionMib.Expexpressiontable.Expexpressionentry' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Expexpressiontable.Expexpressionentry',
            ...
            _MetaInfoClassMember('expExpressionDeltaInterval', ATTRIBUTE, 'int' , None, None, 
                ...
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expExpressionEntryStatus', REFERENCE_ENUM_CLASS, 'RowstatusEnum' , 'ydk.models.cisco_ios_xe.SNMPv2_TC', 'RowstatusEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('expExpressionPrefix', ATTRIBUTE, 'str' , None, None, 
                ...
                'expexpressionprefix',
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expExpressionValueType', REFERENCE_ENUM_CLASS, 'ExpexpressionvaluetypeEnum' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expexpressiontable.Expexpressionentry.ExpexpressionvaluetypeEnum', 
                [], [], 
    ...
    'DismanExpressionMib.Expexpressiontable' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Expexpressiontable',
            False, 
            [
            _MetaInfoClassMember('expExpressionEntry', REFERENCE_LIST, 'Expexpressionentry' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expexpressiontable.Expexpressionentry', 
                [], [], 
    ...
    'DismanExpressionMib.Experrortable.Experrorentry.ExperrorcodeEnum' : _MetaInfoEnum('ExperrorcodeEnum', 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB',
        {
    ...
    'DismanExpressionMib.Experrortable.Experrorentry' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Experrortable.Experrorentry',
            ...
            _MetaInfoClassMember('expExpressionName', ATTRIBUTE, 'str' , None, None, 
                ...
                'expexpressionname',
                'DISMAN-EXPRESSION-MIB', True),
            _MetaInfoClassMember('expErrorCode', REFERENCE_ENUM_CLASS, 'ExperrorcodeEnum' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Experrortable.Experrorentry.ExperrorcodeEnum', 
                [], [], 
    ...
    'DismanExpressionMib.Experrortable' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Experrortable',
            False, 
            [
            _MetaInfoClassMember('expErrorEntry', REFERENCE_LIST, 'Experrorentry' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Experrortable.Experrorentry', 
                [], [], 
    ...
    'DismanExpressionMib.Expobjecttable.Expobjectentry.ExpobjectdiscontinuityidtypeEnum' : _MetaInfoEnum('ExpobjectdiscontinuityidtypeEnum', 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB',
        {
            'timeTicks':'timeTicks',
            'timeStamp':'timeStamp',
            'dateAndTime':'dateAndTime',
        }, 'DISMAN-EXPRESSION-MIB', _yang_ns._namespaces['DISMAN-EXPRESSION-MIB']),
    'DismanExpressionMib.Expobjecttable.Expobjectentry.ExpobjectsampletypeEnum' : _MetaInfoEnum('ExpobjectsampletypeEnum', 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB',
        {
    ...
    'DismanExpressionMib.Expobjecttable.Expobjectentry' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Expobjecttable.Expobjectentry',
            ...
            _MetaInfoClassMember('expObjectDeltaDiscontinuityID', ATTRIBUTE, 'str' , None, None, 
                ...
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectDiscontinuityIDType', REFERENCE_ENUM_CLASS, 'ExpobjectdiscontinuityidtypeEnum' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expobjecttable.Expobjectentry.ExpobjectdiscontinuityidtypeEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('expObjectDiscontinuityIDWildcard', ATTRIBUTE, 'bool' , None, None, 
                ...
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectEntryStatus', REFERENCE_ENUM_CLASS, 'RowstatusEnum' , 'ydk.models.cisco_ios_xe.SNMPv2_TC', 'RowstatusEnum', 
                [], [], 
            ...
            _MetaInfoClassMember('expObjectIDWildcard', ATTRIBUTE, 'bool' , None, None, 
                ...
                'expobjectidwildcard',
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectSampleType', REFERENCE_ENUM_CLASS, 'ExpobjectsampletypeEnum' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expobjecttable.Expobjectentry.ExpobjectsampletypeEnum', 
                [], [], 
    ...
    'DismanExpressionMib.Expobjecttable' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Expobjecttable',
            False, 
            [
            _MetaInfoClassMember('expObjectEntry', REFERENCE_LIST, 'Expobjectentry' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expobjecttable.Expobjectentry', 
                [], [], 
    ...
    'DismanExpressionMib.Expvaluetable' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib.Expvaluetable',
            False, 
            [
            _MetaInfoClassMember('expValueEntry', REFERENCE_LIST, 'Expvalueentry' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expvaluetable.Expvalueentry', 
                [], [], 
    ...
    'DismanExpressionMib' : {
        'meta_info' : _MetaInfoClass('DismanExpressionMib',
            False, 
            [
            _MetaInfoClassMember('expErrorTable', REFERENCE_CLASS, 'Experrortable' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Experrortable', 
                [], [], 
                '''                A table of expression errors.
                ''',
                'experrortable',
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expExpressionTable', REFERENCE_CLASS, 'Expexpressiontable' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expexpressiontable', 
                [], [], 
                '''                A table of expression definitions.
                ''',
                'expexpressiontable',
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expObjectTable', REFERENCE_CLASS, 'Expobjecttable' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expobjecttable', 
                [], [], 
                ...
                'expobjecttable',
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expResource', REFERENCE_CLASS, 'Expresource' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expresource', 
                [], [], 
                '''                ''',
                'expresource',
                'DISMAN-EXPRESSION-MIB', False),
            _MetaInfoClassMember('expValueTable', REFERENCE_CLASS, 'Expvaluetable' , 'ydk.models.cisco_ios_xe.DISMAN_EXPRESSION_MIB', 'DismanExpressionMib.Expvaluetable', 
                [], [], 
