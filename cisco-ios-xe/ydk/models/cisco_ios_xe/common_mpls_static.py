                ...
                class Path(Entity):
                    ...
                    class NextHop(Entity):
                        ...
                        class NextHopType(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.NextHopType, ['mac_address', 'ipv4_address', 'if_index', 'ipv6_address', 'out_interface_name'], name, value)
