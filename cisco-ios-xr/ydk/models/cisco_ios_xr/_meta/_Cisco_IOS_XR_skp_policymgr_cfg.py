...
_meta_table = {
    'AuthorizeIdentifierEnum' : _MetaInfoEnum('AuthorizeIdentifierEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
    ...
    'EventTypeEnum' : _MetaInfoEnum('EventTypeEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
    ...
    'ClassMapTypeEnum' : _MetaInfoEnum('ClassMapTypeEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
            'qos':'QOS',
        }, 'Cisco-IOS-XR-skp-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-skp-policymgr-cfg']),
    'PrecedenceNumberEnum' : _MetaInfoEnum('PrecedenceNumberEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
            'critical':'CRITICAL',
            'flash':'FLASH',
    ...
    'ExecutionStrategyEnum' : _MetaInfoEnum('ExecutionStrategyEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
            'do-all':'DO_ALL',
            'do-until-failure':'DO_UNTIL_FAILURE',
            'do-until-success':'DO_UNTIL_SUCCESS',
        }, 'Cisco-IOS-XR-skp-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-skp-policymgr-cfg']),
    'PmapClassMapTypeEnum' : _MetaInfoEnum('PmapClassMapTypeEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
            'qos':'QOS',
        }, 'Cisco-IOS-XR-skp-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-skp-policymgr-cfg']),
    'PolicyMapTypeEnum' : _MetaInfoEnum('PolicyMapTypeEnum', 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg',
        {
            'qos':'QOS',
        }, 'Cisco-IOS-XR-skp-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-skp-policymgr-cfg']),
    'PolicyManager.ClassMaps.ClassMap.Match.DestinationAddressIpv4' : {
        'meta_info' : _MetaInfoClass('PolicyManager.ClassMaps.ClassMap.Match.DestinationAddressIpv4',
            ...
            _yang_ns._namespaces['Cisco-IOS-XR-skp-policymgr-cfg'],
        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg'
        ),
    },
    ...
    'PolicyManager.ClassMaps.ClassMap.Match.Flow' : {
        'meta_info' : _MetaInfoClass('PolicyManager.ClassMaps.ClassMap.Match.Flow',
            False, 
            [
            _MetaInfoClassMember('flow-cache', REFERENCE_CLASS, 'FlowCache' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.Flow.FlowCache', 
                [], [], 
            ...
            _MetaInfoClassMember('flow-key', REFERENCE_LEAFLIST, 'str' , None, None, 
                ...
                ''',
                'flow_key',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=2),
            ],
            'Cisco-IOS-XR-skp-policymgr-cfg',
            'flow',
            _yang_ns._namespaces['Cisco-IOS-XR-skp-policymgr-cfg'],
    ...
    'PolicyManager.ClassMaps.ClassMap.Match' : {
        'meta_info' : _MetaInfoClass('PolicyManager.ClassMaps.ClassMap.Match',
            ...
            _MetaInfoClassMember('cos', REFERENCE_LEAFLIST, 'int' , None, None, 
                ...
                ''',
                'cos',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('destination-address-ipv4', REFERENCE_LIST, 'DestinationAddressIpv4' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.DestinationAddressIpv4', 
                [], [], 
                '''                Match destination IPv4 address.
                ''',
                'destination_address_ipv4',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('destination-address-ipv6', REFERENCE_LIST, 'DestinationAddressIpv6' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.DestinationAddressIpv6', 
                [], [], 
            ...
            _MetaInfoClassMember('discard-class', REFERENCE_LEAFLIST, 'int' , None, None, 
                ...
                'discard_class',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('domain-name', REFERENCE_LIST, 'DomainName' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.DomainName', 
                [], [], 
                '''                Match domain name.
                ''',
                'domain_name',
            ...
            _MetaInfoClassMember('dscp', REFERENCE_LEAFLIST, 'str' , None, None, 
                ...
                'dscp',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('flow', REFERENCE_CLASS, 'Flow' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.Flow', 
                [], [], 
                '''                Match flow.
                ''',
                'flow',
            ...
            _MetaInfoClassMember('fragment-type', REFERENCE_LEAFLIST, 'str' , None, None, 
                ...
                ''',
                'fragment_type',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=3),
            ...
            _MetaInfoClassMember('ipv4-precedence', REFERENCE_UNION, 'str' , None, None, 
                ...
                'ipv4_precedence',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, [
                    _MetaInfoClassMember('ipv4-precedence', REFERENCE_LEAFLIST, 'PrecedenceNumberEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PrecedenceNumberEnum', 
                        [], [], 
                        '''                        Match IPv4 precedence.
                        ''',
                        'ipv4_precedence',
            ...
            _MetaInfoClassMember('ipv6-precedence', REFERENCE_UNION, 'str' , None, None, 
                ...
                'ipv6_precedence',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, [
                    _MetaInfoClassMember('ipv6-precedence', REFERENCE_LEAFLIST, 'PrecedenceNumberEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PrecedenceNumberEnum', 
                        [], [], 
                        '''                        Match IPv6 precedence.
                        ''',
                        'ipv6_precedence',
            ...
            _MetaInfoClassMember('precedence', REFERENCE_UNION, 'str' , None, None, 
                ...
                'precedence',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, [
                    _MetaInfoClassMember('precedence', REFERENCE_LEAFLIST, 'PrecedenceNumberEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PrecedenceNumberEnum', 
                        [], [], 
                        '''                        Match precedence.
                        ''',
                        'precedence',
            ...
            _MetaInfoClassMember('protocol', REFERENCE_LEAFLIST, 'str' , None, None, 
                ...
                ''',
                'protocol',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=7),
            ...
            _MetaInfoClassMember('service-name-regex', REFERENCE_LEAFLIST, 'str' , None, None, 
                ...
                'service_name_regex',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('source-address-ipv4', REFERENCE_LIST, 'SourceAddressIpv4' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.SourceAddressIpv4', 
                [], [], 
                '''                Match source IPv4 address.
                ''',
                'source_address_ipv4',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('source-address-ipv6', REFERENCE_LIST, 'SourceAddressIpv6' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match.SourceAddressIpv6', 
                [], [], 
    ...
    'PolicyManager.ClassMaps.ClassMap.MatchNot' : {
        'meta_info' : _MetaInfoClass('PolicyManager.ClassMaps.ClassMap.MatchNot',
            ...
            _MetaInfoClassMember('cos', REFERENCE_LEAFLIST, 'int' , None, None, 
                ...
                'cos',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('destination-address-ipv4', REFERENCE_LIST, 'DestinationAddressIpv4' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.MatchNot.DestinationAddressIpv4', 
                [], [], 
                '''                Match destination IPv4 address.
                ''',
                'destination_address_ipv4',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('destination-address-ipv6', REFERENCE_LIST, 'DestinationAddressIpv6' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.MatchNot.DestinationAddressIpv6', 
                [], [], 
                '''                Match destination IPv6 address.
                ''',
                'destination_address_ipv6',
            ...
            _MetaInfoClassMember('discard-class', REFERENCE_LEAFLIST, 'int' , None, None, 
                ...
                'discard_class',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('domain-name', REFERENCE_LIST, 'DomainName' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.MatchNot.DomainName', 
                [], [], 
                '''                Match domain name.
                ''',
                'domain_name',
            ...
            _MetaInfoClassMember('service-name-regex', REFERENCE_LEAFLIST, 'str' , None, None, 
                ...
                'service_name_regex',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('source-address-ipv4', REFERENCE_LIST, 'SourceAddressIpv4' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.MatchNot.SourceAddressIpv4', 
                [], [], 
                '''                Match source IPv4 address.
                ''',
                'source_address_ipv4',
                'Cisco-IOS-XR-skp-policymgr-cfg', False, max_elements=8),
            _MetaInfoClassMember('source-address-ipv6', REFERENCE_LIST, 'SourceAddressIpv6' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.MatchNot.SourceAddressIpv6', 
                [], [], 
                '''                Match source IPv6 address.
                ''',
                'source_address_ipv6',
    ...
    'PolicyManager.ClassMaps.ClassMap' : {
        'meta_info' : _MetaInfoClass('PolicyManager.ClassMaps.ClassMap',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('type', REFERENCE_ENUM_CLASS, 'ClassMapTypeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'ClassMapTypeEnum', 
                [], [], 
                '''                Type of class-map.
                ''',
                'type',
            ...
            _MetaInfoClassMember('description', ATTRIBUTE, 'str' , None, None, 
                ...
                'description',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('match', REFERENCE_CLASS, 'Match' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.Match', 
                [], [], 
                '''                Match rules.
                ''',
                'match',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('match-not', REFERENCE_CLASS, 'MatchNot' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap.MatchNot', 
                [], [], 
                '''                Match not rules.
                ''',
                'match_not',
    ...
    'PolicyManager.ClassMaps' : {
        'meta_info' : _MetaInfoClass('PolicyManager.ClassMaps',
            False, 
            [
            _MetaInfoClassMember('class-map', REFERENCE_LIST, 'ClassMap' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps.ClassMap', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.Authorize' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.Authorize',
            ...
            _MetaInfoClassMember('format', ATTRIBUTE, 'str' , None, None, 
                ...
                'format',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('identifier', REFERENCE_ENUM_CLASS, 'AuthorizeIdentifierEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'AuthorizeIdentifierEnum', 
                [], [], 
                '''                Specify an Authorize format name.
                ''',
                'identifier',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule',
            ...
            _MetaInfoClassMember('action-sequence-number', ATTRIBUTE, 'int' , None, None, 
                ...
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('activate-dynamic-template', REFERENCE_CLASS, 'ActivateDynamicTemplate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.ActivateDynamicTemplate', 
                [], [], 
                '''                Activate dynamic templates.
                ''',
                'activate_dynamic_template',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('authenticate', REFERENCE_CLASS, 'Authenticate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.Authenticate', 
                [], [], 
                '''                Authentication related configuration.
                ''',
                'authenticate',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('authorize', REFERENCE_CLASS, 'Authorize' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.Authorize', 
                [], [], 
                '''                Authorize.
                ''',
                'authorize',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('deactivate-dynamic-template', REFERENCE_CLASS, 'DeactivateDynamicTemplate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.DeactivateDynamicTemplate', 
                [], [], 
            ...
            _MetaInfoClassMember('monitor', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'monitor',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('set-timer', REFERENCE_CLASS, 'SetTimer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.SetTimer', 
                [], [], 
                ...
                'set_timer',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('stop-timer', REFERENCE_CLASS, 'StopTimer' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.StopTimer', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event.Class' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event.Class',
            ...
            _MetaInfoClassMember('class-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'class_name',
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('class-type', REFERENCE_ENUM_CLASS, 'PmapClassMapTypeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PmapClassMapTypeEnum', 
                [], [], 
                '''                Type of class.
                ''',
                'class_type',
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('action-rule', REFERENCE_LIST, 'ActionRule' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule', 
                [], [], 
                '''                Action rule.
                ''',
                'action_rule',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('class-execution-strategy', REFERENCE_ENUM_CLASS, 'ExecutionStrategyEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'ExecutionStrategyEnum', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event',
            False, 
            [
            _MetaInfoClassMember('event-type', REFERENCE_ENUM_CLASS, 'EventTypeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'EventTypeEnum', 
                [], [], 
                '''                Event type.
                ''',
                'event_type',
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('class', REFERENCE_LIST, 'Class' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event.Class', 
                [], [], 
                '''                Class-map rule.
                ''',
                'class_',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ConformAction' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ConformAction',
            ...
            _MetaInfoClassMember('drop', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'drop',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('set', REFERENCE_CLASS, 'Set' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ConformAction.Set', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ExceedAction' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ExceedAction',
            ...
            _MetaInfoClassMember('drop', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'drop',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('set', REFERENCE_CLASS, 'Set' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ExceedAction.Set', 
                [], [], 
                '''                Police action packet marking.
                ''',
                'set',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ViolateAction' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ViolateAction',
            ...
            _MetaInfoClassMember('drop', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'drop',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('set', REFERENCE_CLASS, 'Set' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ViolateAction.Set', 
                [], [], 
                '''                Police action packet marking.
                ''',
                'set',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police',
            False, 
            [
            _MetaInfoClassMember('burst', REFERENCE_CLASS, 'Burst' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.Burst', 
                [], [], 
                '''                Burst configuration.
                ''',
                'burst',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('conform-action', REFERENCE_CLASS, 'ConformAction' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ConformAction', 
                [], [], 
                ...
                'conform_action',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('exceed-action', REFERENCE_CLASS, 'ExceedAction' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ExceedAction', 
                [], [], 
                ...
                'exceed_action',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('peak-burst', REFERENCE_CLASS, 'PeakBurst' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.PeakBurst', 
                [], [], 
                '''                Peak burst configuration.
                ''',
                'peak_burst',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('peak-rate', REFERENCE_CLASS, 'PeakRate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.PeakRate', 
                [], [], 
                '''                Peak rate configuration.
                ''',
                'peak_rate',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('rate', REFERENCE_CLASS, 'Rate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.Rate', 
                [], [], 
                '''                Rate configuration.
                ''',
                'rate',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('violate-action', REFERENCE_CLASS, 'ViolateAction' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police.ViolateAction', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.CacLocal' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.CacLocal',
            ...
            _MetaInfoClassMember('flow-rate', REFERENCE_CLASS, 'FlowRate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.CacLocal.FlowRate', 
                [], [], 
                '''                The rate allocated per flow.
                ''',
                'flow_rate',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('rate', REFERENCE_CLASS, 'Rate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.CacLocal.Rate', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.MetricsIpcbr' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.MetricsIpcbr',
            False, 
            [
            _MetaInfoClassMember('media-packet', REFERENCE_CLASS, 'MediaPacket' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.MetricsIpcbr.MediaPacket', 
                [], [], 
                '''                Media-packet structure.
                ''',
                'media_packet',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('rate', REFERENCE_CLASS, 'Rate' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.MetricsIpcbr.Rate', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Alarm' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Alarm',
            ...
            _MetaInfoClassMember('severity', ATTRIBUTE, 'str' , None, None, 
                ...
                'severity',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('type', REFERENCE_CLASS, 'Type' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Alarm.Type', 
                [], [], 
                '''                Alarm type.
                ''',
                'type',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Treshold' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Treshold',
            False, 
            [
            _MetaInfoClassMember('trigger-type', REFERENCE_CLASS, 'TriggerType' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Treshold.TriggerType', 
                [], [], 
                '''                Alarm trigger type settings.
                ''',
                'trigger_type',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('trigger-value', REFERENCE_CLASS, 'TriggerValue' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Treshold.TriggerValue', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React',
            False, 
            [
            _MetaInfoClassMember('action', REFERENCE_CLASS, 'Action' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Action', 
                [], [], 
                '''                Action on alert.
                ''',
                'action',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('alarm', REFERENCE_CLASS, 'Alarm' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Alarm', 
                [], [], 
                '''                Alaram settings.
                ''',
                'alarm',
            ...
            _MetaInfoClassMember('descrition', ATTRIBUTE, 'str' , None, None, 
                ...
                'descrition',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('treshold', REFERENCE_CLASS, 'Treshold' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React.Treshold', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr.PbrForward' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr.PbrForward',
            ...
            _MetaInfoClassMember('default', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'default',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('next-hop', REFERENCE_CLASS, 'NextHop' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr.PbrForward.NextHop', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr',
            ...
            _MetaInfoClassMember('pbr-drop', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'pbr_drop',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('pbr-forward', REFERENCE_CLASS, 'PbrForward' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr.PbrForward', 
                [], [], 
            ...
            _MetaInfoClassMember('pbr-transmit', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'pbr_transmit',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('set', REFERENCE_CLASS, 'Set' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr.Set', 
                [], [], 
    ...
    'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule',
            ...
            _MetaInfoClassMember('class-type', REFERENCE_ENUM_CLASS, 'PmapClassMapTypeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PmapClassMapTypeEnum', 
                ...
                'class_type',
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('bandwidth-remaining', REFERENCE_CLASS, 'BandwidthRemaining' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.BandwidthRemaining', 
                [], [], 
                '''                Policy action bandwidth remaining queue.
                ''',
                'bandwidth_remaining',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('cac-local', REFERENCE_CLASS, 'CacLocal' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.CacLocal', 
                [], [], 
                '''                Policy action CAC.
                ''',
                'cac_local',
            ...
            _MetaInfoClassMember('default-red', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'default_red',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('flow-params', REFERENCE_CLASS, 'FlowParams' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.FlowParams', 
                [], [], 
            ...
            _MetaInfoClassMember('fragment', ATTRIBUTE, 'str' , None, None, 
                ...
                'fragment',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('metrics-ipcbr', REFERENCE_CLASS, 'MetricsIpcbr' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.MetricsIpcbr', 
                [], [], 
                '''                Policy IP-CBR metric action.
                ''',
                'metrics_ipcbr',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('min-bandwidth', REFERENCE_CLASS, 'MinBandwidth' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.MinBandwidth', 
                [], [], 
                '''                Policy action minimum bandwidth queue.
                ''',
                'min_bandwidth',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('pbr', REFERENCE_CLASS, 'Pbr' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Pbr', 
                [], [], 
                '''                Policy action PBR.
                ''',
                'pbr',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('police', REFERENCE_CLASS, 'Police' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Police', 
                [], [], 
            ...
            _MetaInfoClassMember('priority-level', ATTRIBUTE, 'int' , None, None, 
                ...
                'priority_level',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('queue-limit', REFERENCE_CLASS, 'QueueLimit' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.QueueLimit', 
                [], [], 
                '''                Policy action queue limit.
                ''',
                'queue_limit',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('random-detect', REFERENCE_LIST, 'RandomDetect' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.RandomDetect', 
                [], [], 
                ...
                'random_detect',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('react', REFERENCE_CLASS, 'React' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.React', 
                [], [], 
                '''                Policy action react.
                ''',
                'react',
            ...
            _MetaInfoClassMember('service-fragment', ATTRIBUTE, 'str' , None, None, 
                ...
                'service_fragment',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('service-policy', REFERENCE_CLASS, 'ServicePolicy' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.ServicePolicy', 
                [], [], 
                '''                Configure a child service policy.
                ''',
                'service_policy',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('set', REFERENCE_CLASS, 'Set' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Set', 
                [], [], 
                '''                Policy action packet marking.
                ''',
                'set',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('shape', REFERENCE_CLASS, 'Shape' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule.Shape', 
                [], [], 
                '''                Policy action shape.
                ''',
                'shape',
    ...
    'PolicyManager.PolicyMaps.PolicyMap' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'Cisco-IOS-XR-skp-policymgr-cfg', True),
            _MetaInfoClassMember('type', REFERENCE_ENUM_CLASS, 'PolicyMapTypeEnum' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyMapTypeEnum', 
                [], [], 
                '''                Type of policy-map.
                ''',
                'type',
            ...
            _MetaInfoClassMember('description', ATTRIBUTE, 'str' , None, None, 
                ...
                'description',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('event', REFERENCE_LIST, 'Event' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.Event', 
                [], [], 
                '''                Policy event.
                ''',
                'event',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('policy-map-rule', REFERENCE_LIST, 'PolicyMapRule' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap.PolicyMapRule', 
                [], [], 
                '''                Class-map rule.
                ''',
                'policy_map_rule',
    ...
    'PolicyManager.PolicyMaps' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps',
            False, 
            [
            _MetaInfoClassMember('policy-map', REFERENCE_LIST, 'PolicyMap' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps.PolicyMap', 
                [], [], 
    ...
    'PolicyManager' : {
        'meta_info' : _MetaInfoClass('PolicyManager',
            False, 
            [
            _MetaInfoClassMember('class-maps', REFERENCE_CLASS, 'ClassMaps' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.ClassMaps', 
                [], [], 
                '''                Class-maps configuration.
                ''',
                'class_maps',
                'Cisco-IOS-XR-skp-policymgr-cfg', False),
            _MetaInfoClassMember('policy-maps', REFERENCE_CLASS, 'PolicyMaps' , 'ydk.models.cisco_ios_xr.Cisco_IOS_XR_skp_policymgr_cfg', 'PolicyManager.PolicyMaps', 
                [], [], 
