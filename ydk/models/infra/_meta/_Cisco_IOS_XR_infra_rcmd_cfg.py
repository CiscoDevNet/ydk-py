...
_meta_table = {
    ...
    'RouterConvergence.CollectDiagnostics.CollectDiagnostic' : {
        ...
        'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg'
        ),
    },
    'RouterConvergence.CollectDiagnostics' : {
        'meta_info' : _MetaInfoClass('RouterConvergence.CollectDiagnostics',
            False, 
            [
            _MetaInfoClassMember('collect-diagnostic', REFERENCE_LIST, 'CollectDiagnostic' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.CollectDiagnostics.CollectDiagnostic', 
                [], [], 
    ...
    'RouterConvergence.MplsLdp' : {
        'meta_info' : _MetaInfoClass('RouterConvergence.MplsLdp',
            ...
            _MetaInfoClassMember('enable', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'enable',
                'Cisco-IOS-XR-infra-rcmd-cfg', False),
            _MetaInfoClassMember('remote-lfa', REFERENCE_CLASS, 'RemoteLfa' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.MplsLdp.RemoteLfa', 
                [], [], 
    ...
    'RouterConvergence.Nodes' : {
        'meta_info' : _MetaInfoClass('RouterConvergence.Nodes',
            False, 
            [
            _MetaInfoClassMember('node', REFERENCE_LIST, 'Node' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.Nodes.Node', 
                [], [], 
    ...
    'RouterConvergence.Protocols.Protocol.Priorities' : {
        'meta_info' : _MetaInfoClass('RouterConvergence.Protocols.Protocol.Priorities',
            False, 
            [
            _MetaInfoClassMember('priority', REFERENCE_LIST, 'Priority' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.Protocols.Protocol.Priorities.Priority', 
                [], [], 
                '''                Priority
                ''',
                'priority',
    ...
    'RouterConvergence.Protocols.Protocol' : {
        'meta_info' : _MetaInfoClass('RouterConvergence.Protocols.Protocol',
            ...
            _MetaInfoClassMember('enable', ATTRIBUTE, 'Empty' , None, None, 
                ...
                'enable',
                'Cisco-IOS-XR-infra-rcmd-cfg', False),
            _MetaInfoClassMember('priorities', REFERENCE_CLASS, 'Priorities' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.Protocols.Protocol.Priorities', 
                [], [], 
                '''                Table of Priority
                ''',
                'priorities',
    ...
    'RouterConvergence.Protocols' : {
        'meta_info' : _MetaInfoClass('RouterConvergence.Protocols',
            False, 
            [
            _MetaInfoClassMember('protocol', REFERENCE_LIST, 'Protocol' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.Protocols.Protocol', 
                [], [], 
    ...
    'RouterConvergence' : {
        'meta_info' : _MetaInfoClass('RouterConvergence',
            False, 
            [
            _MetaInfoClassMember('collect-diagnostics', REFERENCE_CLASS, 'CollectDiagnostics' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.CollectDiagnostics', 
                [], [], 
            ...
            _MetaInfoClassMember('monitoring-interval', ATTRIBUTE, 'int' , None, None, 
                ...
                'monitoring_interval',
                'Cisco-IOS-XR-infra-rcmd-cfg', False),
            _MetaInfoClassMember('mpls-ldp', REFERENCE_CLASS, 'MplsLdp' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.MplsLdp', 
                [], [], 
                '''                RCMD related configuration for MPLS-LDP
                ''',
                'mpls_ldp',
                'Cisco-IOS-XR-infra-rcmd-cfg', False),
            _MetaInfoClassMember('nodes', REFERENCE_CLASS, 'Nodes' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.Nodes', 
                [], [], 
                '''                Table of Node
                ''',
                'nodes',
            ...
            _MetaInfoClassMember('prefix-monitor-limit', ATTRIBUTE, 'int' , None, None, 
                ...
                'Cisco-IOS-XR-infra-rcmd-cfg', False),
            _MetaInfoClassMember('protocols', REFERENCE_CLASS, 'Protocols' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.Protocols', 
                [], [], 
                '''                Table of Protocol
                ''',
                'protocols',
                'Cisco-IOS-XR-infra-rcmd-cfg', False),
            _MetaInfoClassMember('storage-location', REFERENCE_CLASS, 'StorageLocation' , 'ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg', 'RouterConvergence.StorageLocation', 
                [], [], 
