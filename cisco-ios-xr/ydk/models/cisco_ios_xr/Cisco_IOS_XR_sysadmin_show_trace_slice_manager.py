...
class SliceManager(Entity):
    ...
    def __init__(self):
        ...
        self._child_classes = OrderedDict([("trace", ("trace", SliceManager.Trace))])
    ...
    class Trace(Entity):
        ...
        def __init__(self):
            ...
            self._child_classes = OrderedDict([("location", ("location", SliceManager.Trace.Location))])
            self._leafs = OrderedDict([
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(SliceManager.Trace, [u'buffer'], name, value)
        ...
        class Location(Entity):
            ...
            def __init__(self):
                ...
                self._child_classes = OrderedDict([("all-options", ("all_options", SliceManager.Trace.Location.AllOptions))])
                self._leafs = OrderedDict([
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(SliceManager.Trace.Location, [u'location_name'], name, value)
            ...
            class AllOptions(Entity):
                ...
                def __init__(self):
                    ...
                    self._child_classes = OrderedDict([("trace-blocks", ("trace_blocks", SliceManager.Trace.Location.AllOptions.TraceBlocks))])
                    self._leafs = OrderedDict([
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(SliceManager.Trace.Location.AllOptions, [u'option'], name, value)
                ...
                class TraceBlocks(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SliceManager.Trace.Location.AllOptions.TraceBlocks, [u'data'], name, value)
