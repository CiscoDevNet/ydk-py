...
_meta_table = {
    'EventTypeEnum' : _MetaInfoEnum('EventTypeEnum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg',
        {
    ...
    'ClassMapTypeEnum' : _MetaInfoEnum('ClassMapTypeEnum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg',
        {
            'qos':'QOS',
            'traffic':'TRAFFIC',
            'control':'CONTROL',
        }, 'Cisco-IOS-XR-asr9k-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-policymgr-cfg']),
    'AuthorizeIdentifierEnum' : _MetaInfoEnum('AuthorizeIdentifierEnum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg',
        {
    ...
    'ExecutionStrategyEnum' : _MetaInfoEnum('ExecutionStrategyEnum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg',
        {
            'do-all':'DO_ALL',
            'do-until-failure':'DO_UNTIL_FAILURE',
            'do-until-success':'DO_UNTIL_SUCCESS',
        }, 'Cisco-IOS-XR-asr9k-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-policymgr-cfg']),
    'PmapClassMapTypeEnum' : _MetaInfoEnum('PmapClassMapTypeEnum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg',
        {
            'qos':'QOS',
            'traffic':'TRAFFIC',
            'subscriber-control':'SUBSCRIBER_CONTROL',
        }, 'Cisco-IOS-XR-asr9k-policymgr-cfg', _yang_ns._namespaces['Cisco-IOS-XR-asr9k-policymgr-cfg']),
    'PolicyMapTypeEnum' : _MetaInfoEnum('PolicyMapTypeEnum', 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg',
        {
            'qos':'QOS',
            'pbr':'PBR',
            'traffic':'TRAFFIC',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.Authorize' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event.Class.ActionRule.Authorize',
            ...
            _MetaInfoClassMember('format', ATTRIBUTE, 'str' , None, None, 
                ...
                'format',
                'Cisco-IOS-XR-asr9k-policymgr-cfg', False),
            _MetaInfoClassMember('identifier', REFERENCE_ENUM_CLASS, 'AuthorizeIdentifierEnum' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg', 'AuthorizeIdentifierEnum', 
                [], [], 
                '''                Specify an Authorize format name.
                ''',
                'identifier',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event.Class' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event.Class',
            ...
            _MetaInfoClassMember('class-name', ATTRIBUTE, 'str' , None, None, 
                ...
                'class_name',
                'Cisco-IOS-XR-asr9k-policymgr-cfg', True),
            _MetaInfoClassMember('class-type', REFERENCE_ENUM_CLASS, 'PmapClassMapTypeEnum' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg', 'PmapClassMapTypeEnum', 
                [], [], 
                '''                Type of class.
                ''',
                'class_type',
    ...
    'PolicyManager.PolicyMaps.PolicyMap.Event' : {
        'meta_info' : _MetaInfoClass('PolicyManager.PolicyMaps.PolicyMap.Event',
            False, 
            [
            _MetaInfoClassMember('event-type', REFERENCE_ENUM_CLASS, 'EventTypeEnum' , 'ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg', 'EventTypeEnum', 
                [], [], 
                '''                Event type.
                ''',
                'event_type',
