...
_identity_map = { \
    ...
    ('ietf-system', 'authentication-method'):('ydk.models.ietf.ietf_system', 'AuthenticationMethod_Identity'),
    ('ietf-system', 'local-users'):('ydk.models.ietf.ietf_system', 'LocalUsers_Identity'),
    ('ietf-system', 'radius-authentication-type'):('ydk.models.ietf.ietf_system', 'RadiusAuthenticationType_Identity'),
    ('ietf-system', 'radius-chap'):('ydk.models.ietf.ietf_system', 'RadiusChap_Identity'),
    ('ietf-system', 'radius-pap'):('ydk.models.ietf.ietf_system', 'RadiusPap_Identity'),
    ('ietf-system', 'radius'):('ydk.models.ietf.ietf_system', 'Radius_Identity'),
...
('http://cisco.com/ns/yang/Cisco-IOS-XR-parser-cfg', 'parser') : 'from ydk.models.parser.Cisco_IOS_XR_parser_cfg import Parser', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-cfg', 'selective-vrf-download') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg import SelectiveVrfDownload', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-oper', 'bundle-information') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_oper import BundleInformation', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rcmd-cfg', 'router-convergence') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rcmd_cfg import RouterConvergence', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-infra-clock-linux-cfg', 'clock') : 'from ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_linux_cfg import Clock', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-pce-stdby') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsPceStdby', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-udp-cfg', 'ip-udp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_udp_cfg import IpUdp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-lcac-standby') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsLcacStandby', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-tcp-oper', 'tcp-nsr') : 'from ydk.models.ip.Cisco_IOS_XR_ip_tcp_oper import TcpNsr', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-bfd-oper', 'bfd') : 'from ydk.models.ip.Cisco_IOS_XR_ip_bfd_oper import Bfd', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-objmgr-oper', 'object-group') : 'from ydk.models.infra.Cisco_IOS_XR_infra_objmgr_oper import ObjectGroup', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-syslog-cfg', 'syslog') : 'from ydk.models.infra.Cisco_IOS_XR_infra_syslog_cfg import Syslog', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-domain-cfg', 'ip-domain') : 'from ydk.models.ip.Cisco_IOS_XR_ip_domain_cfg import IpDomain', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-oper', 'l2vpn') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_oper import L2Vpn', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-plat-chas-invmgr-oper', 'platform-inventory') : 'from ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper import PlatformInventory', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-ldp-cfg', 'mpls-ldp') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_ldp_cfg import MplsLdp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-sla-oper', 'sla-nodes') : 'from ydk.models.infra.Cisco_IOS_XR_infra_sla_oper import SlaNodes', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-pmengine-oper', 'performance-management') : 'from ydk.models.pmengine.Cisco_IOS_XR_pmengine_oper import PerformanceManagement', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-pbr-oper', 'pbr') : 'from ydk.models.pbr.Cisco_IOS_XR_pbr_oper import Pbr', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-telnet-mgmt-cfg', 'telnet') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg import Telnet', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-controller-otu-oper', 'otu') : 'from ydk.models.controller.Cisco_IOS_XR_controller_otu_oper import Otu', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-io-oper', 'ipv6-io') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_oper import Ipv6Io', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-cfg', 'evpn') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_cfg import Evpn', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-drivers-media-eth-oper', 'ethernet-interface') : 'from ydk.models.drivers.Cisco_IOS_XR_drivers_media_eth_oper import EthernetInterface', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-infra-clock-cfg', 'clock') : 'from ydk.models.infra.Cisco_IOS_XR_infra_infra_clock_cfg import Clock', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-acl-oper', 'ipv4-acl-and-prefix-list') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_oper import Ipv4AclAndPrefixList', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-iep-cfg', 'ip-explicit-paths') : 'from ydk.models.ip.Cisco_IOS_XR_ip_iep_cfg import IpExplicitPaths', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-acl-oper', 'ipv6-acl-and-prefix-list') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_acl_oper import Ipv6AclAndPrefixList', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-sla-oper', 'sla') : 'from ydk.models.infra.Cisco_IOS_XR_infra_sla_oper import Sla', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-static-oper', 'mpls-static') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_static_oper import MplsStatic', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-lib-keychain-oper', 'keychain') : 'from ydk.models.lib.Cisco_IOS_XR_lib_keychain_oper import Keychain', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-fib-common-oper', 'mpls-forwarding') : 'from ydk.models.fib.Cisco_IOS_XR_fib_common_oper import MplsForwarding', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-shellutil-oper', 'system-time') : 'from ydk.models.shellutil.Cisco_IOS_XR_shellutil_oper import SystemTime', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-new-dhcpv6d-cfg', 'dhcpv6') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_cfg import Dhcpv6', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-arp-cfg', 'arp-redundancy') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_arp_cfg import ArpRedundancy', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-man-xml-ttyagent-cfg', 'xr-xml') : 'from ydk.models.man.Cisco_IOS_XR_man_xml_ttyagent_cfg import XrXml', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-ntp-oper', 'ntp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_ntp_oper import Ntp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-asr9k-netflow-oper', 'net-flow') : 'from ydk.models.asr9k.Cisco_IOS_XR_asr9k_netflow_oper import NetFlow', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ncs1k-mxp-cfg', 'hardware-module') : 'from ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_cfg import HardwareModule', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-bfd-cfg', 'bfd') : 'from ydk.models.ip.Cisco_IOS_XR_ip_bfd_cfg import Bfd', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-tcp-oper', 'tcp-connection') : 'from ydk.models.ip.Cisco_IOS_XR_ip_tcp_oper import TcpConnection', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-statsd-cfg', 'statistics') : 'from ydk.models.infra.Cisco_IOS_XR_infra_statsd_cfg import Statistics', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-icpe-infra-oper', 'nv-satellite') : 'from ydk.models.icpe.Cisco_IOS_XR_icpe_infra_oper import NvSatellite', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-cfg', 'generic-interface-lists') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_cfg import GenericInterfaceLists', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-statsd-oper', 'infra-statistics') : 'from ydk.models.infra.Cisco_IOS_XR_infra_statsd_oper import InfraStatistics', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-subscriber-infra-tmplmgr-cfg', 'dynamic-template') : 'from ydk.models.subscriber.Cisco_IOS_XR_subscriber_infra_tmplmgr_cfg import DynamicTemplate', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-asr9k-qos-cfg', 'qos') : 'from ydk.models.asr9k.Cisco_IOS_XR_asr9k_qos_cfg import Qos', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-crypto-ssh-oper', 'ssh') : 'from ydk.models.crypto.Cisco_IOS_XR_crypto_ssh_oper import Ssh', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-clns-isis-cfg', 'isis') : 'from ydk.models.clns.Cisco_IOS_XR_clns_isis_cfg import Isis', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ethernet-lldp-oper', 'lldp') : 'from ydk.models.ethernet.Cisco_IOS_XR_ethernet_lldp_oper import Lldp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-bgp-oper', 'bgp') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_bgp_oper import Bgp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-fib-common-oper', 'fib-statistics') : 'from ydk.models.fib.Cisco_IOS_XR_fib_common_oper import FibStatistics', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-io-cfg', 'ipv6-assembler') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_cfg import Ipv6Assembler', 
...
('http://cisco.com/ns/yang/Cisco-IOS-XR-watchd-cfg', 'watchdog') : 'from ydk.models.watchd.Cisco_IOS_XR_watchd_cfg import Watchdog', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-shellutil-filesystem-oper', 'file-system') : 'from ydk.models.shellutil.Cisco_IOS_XR_shellutil_filesystem_oper import FileSystem', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-dnx-netflow-oper', 'net-flow') : 'from ydk.models.dnx.Cisco_IOS_XR_dnx_netflow_oper import NetFlow', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-tty-server-oper', 'tty') : 'from ydk.models.tty.Cisco_IOS_XR_tty_server_oper import Tty', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-ma-cfg', 'subscriber-pta') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_ma_cfg import SubscriberPta', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ifmgr-cfg', 'interface-configurations') : 'from ydk.models.ifmgr.Cisco_IOS_XR_ifmgr_cfg import InterfaceConfigurations', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-aaa-lib-cfg', 'aaa') : 'from ydk.models.aaa.Cisco_IOS_XR_aaa_lib_cfg import Aaa', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-snmp-agent-cfg', 'snmp') : 'from ydk.models.snmp.Cisco_IOS_XR_snmp_agent_cfg import Snmp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ha-eem-oper', 'system-monitoring') : 'from ydk.models.ha.Cisco_IOS_XR_ha_eem_oper import SystemMonitoring', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-tty-server-cfg', 'tty') : 'from ydk.models.tty.Cisco_IOS_XR_tty_server_cfg import Tty', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rib-ipv6-oper', 'ipv6-rib') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rib_ipv6_oper import Ipv6Rib', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-skp-policymgr-cfg', 'policy-manager') : 'from ydk.models.skp.Cisco_IOS_XR_skp_policymgr_cfg import PolicyManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-config-mda-cfg', 'preconfigured-nodes') : 'from ydk.models.config.Cisco_IOS_XR_config_mda_cfg import PreconfiguredNodes', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-arp-cfg', 'arpgmp') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_arp_cfg import Arpgmp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-lib-mpp-cfg', 'control-plane') : 'from ydk.models.lib.Cisco_IOS_XR_lib_mpp_cfg import ControlPlane', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-Ethernet-SPAN-oper', 'span-monitor-session') : 'from ydk.models.ethernet.Cisco_IOS_XR_Ethernet_SPAN_oper import SpanMonitorSession', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2-eth-infra-cfg', 'ethernet-features') : 'from ydk.models.l2.Cisco_IOS_XR_l2_eth_infra_cfg import EthernetFeatures', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-oper', 'lacp-bundles') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_oper import LacpBundles', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-cfg', 'vrf-groups') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg import VrfGroups', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ifmgr-oper', 'interface-properties') : 'from ydk.models.ifmgr.Cisco_IOS_XR_ifmgr_oper import InterfaceProperties', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-cmproxy-oper', 'sdr-inventory-vm') : 'from ydk.models.cmproxy.Cisco_IOS_XR_cmproxy_oper import SdrInventoryVm', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-crypto-sam-oper', 'sam') : 'from ydk.models.crypto.Cisco_IOS_XR_crypto_sam_oper import Sam', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-sdr-invmgr-oper', 'sdr-inventory') : 'from ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper import SdrInventory', 
('urn:ietf:params:xml:ns:yang:ietf-interfaces', 'interfaces') : 'from ydk.models.ietf.ietf_interfaces import Interfaces', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-aaa-locald-admin-cfg', 'aaa') : 'from ydk.models.aaa.Cisco_IOS_XR_aaa_locald_admin_cfg import Aaa', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-arp-oper', 'arp-gmp') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_arp_oper import ArpGmp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-ma-oper', 'ipv6-network') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_ma_oper import Ipv6Network', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-syslog-cfg', 'syslog-service') : 'from ydk.models.infra.Cisco_IOS_XR_infra_syslog_cfg import SyslogService', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ncs1k-mxp-oper', 'hw-module') : 'from ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_oper import HwModule', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-ntp-admin-oper', 'ntp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_ntp_admin_oper import Ntp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-nd-oper', 'ipv6-node-discovery') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_oper import Ipv6NodeDiscovery', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-arp-cfg', 'arp') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_arp_cfg import Arp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-sdr-invmgr-diag-oper', 'diag') : 'from ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_diag_oper import Diag', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-cdp-oper', 'cdp') : 'from ydk.models.cdp.Cisco_IOS_XR_cdp_oper import Cdp', 
('urn:ietf:params:xml:ns:yang:ietf-netconf-acm', 'nacm') : 'from ydk.models.ietf.ietf_netconf_acm import Nacm', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-invmgr-oper', 'inventory') : 'from ydk.models.invmgr.Cisco_IOS_XR_invmgr_oper import Inventory', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-ma-cfg', 'ipv4-network-global') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_ma_cfg import Ipv4NetworkGlobal', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-io-cfg', 'ipv6icmp') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_io_cfg import Ipv6Icmp', 
('urn:ietf:params:xml:ns:yang:ietf-interfaces', 'interfaces-state') : 'from ydk.models.ietf.ietf_interfaces import InterfacesState', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-dnx-driver-oper', 'fia') : 'from ydk.models.dnx.Cisco_IOS_XR_dnx_driver_oper import Fia', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rcmd-oper', 'rcmd') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rcmd_oper import Rcmd', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-cfg', 'mpls-te') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_cfg import MplsTe', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2-eth-infra-oper', 'mac-accounting') : 'from ydk.models.l2.Cisco_IOS_XR_l2_eth_infra_oper import MacAccounting', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-cfg', 'vrfs') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg import Vrfs', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-syslog-oper', 'syslog') : 'from ydk.models.infra.Cisco_IOS_XR_infra_syslog_oper import Syslog', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-infra-locale-cfg', 'locale') : 'from ydk.models.infra.Cisco_IOS_XR_infra_infra_locale_cfg import Locale', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-aaa-protocol-radius-oper', 'radius') : 'from ydk.models.aaa.Cisco_IOS_XR_aaa_protocol_radius_oper import Radius', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ncs1k-mxp-headless-oper', 'headless-func-data') : 'from ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_headless_oper import HeadlessFuncData', 
('urn:ietf:params:xml:ns:yang:ietf-system', 'system-state') : 'from ydk.models.ietf.ietf_system import SystemState', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-ospfv3-oper', 'ospfv3') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_ospfv3_oper import Ospfv3', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-tty-management-cmd-oper', 'show-users') : 'from ydk.models.tty.Cisco_IOS_XR_tty_management_cmd_oper import ShowUsers', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-objmgr-cfg', 'object-group') : 'from ydk.models.infra.Cisco_IOS_XR_infra_objmgr_cfg import ObjectGroup', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-telnet-cfg', 'ipv6-telnet') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg import Ipv6Telnet', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-lcac') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsLcac', 
...
('http://cisco.com/ns/yang/Cisco-IOS-XR-ethernet-lldp-cfg', 'lldp') : 'from ydk.models.ethernet.Cisco_IOS_XR_ethernet_lldp_cfg import Lldp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-rgmgr-cfg', 'redundancy-group-manager') : 'from ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_cfg import RedundancyGroupManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-fretta-bcm-dpa-oper', 'dpa') : 'from ydk.models.fretta.Cisco_IOS_XR_fretta_bcm_dpa_oper import Dpa', 
('http://openconfig.net/yang/inventory', 'components') : 'from ydk.models.openconfig.openconfig_inventory import Components', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-clns-isis-oper', 'isis') : 'from ydk.models.clns.Cisco_IOS_XR_clns_isis_oper import Isis', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-static-cfg', 'router-static') : 'from ydk.models.ip.Cisco_IOS_XR_ip_static_cfg import RouterStatic', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-linux-os-reboot-history-oper', 'reboot-history') : 'from ydk.models.linux.Cisco_IOS_XR_linux_os_reboot_history_oper import RebootHistory', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-config-mda-cfg', 'active-nodes') : 'from ydk.models.config.Cisco_IOS_XR_config_mda_cfg import ActiveNodes', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-controller-optics-oper', 'optics-oper') : 'from ydk.models.controller.Cisco_IOS_XR_controller_optics_oper import OpticsOper', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-asr9k-policymgr-cfg', 'policy-manager') : 'from ydk.models.asr9k.Cisco_IOS_XR_asr9k_policymgr_cfg import PolicyManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ifmgr-oper', 'interface-dampening') : 'from ydk.models.ifmgr.Cisco_IOS_XR_ifmgr_oper import InterfaceDampening', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-fib-common-oper', 'fib') : 'from ydk.models.fib.Cisco_IOS_XR_fib_common_oper import Fib', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2-eth-infra-oper', 'ethernet-encapsulation') : 'from ydk.models.l2.Cisco_IOS_XR_l2_eth_infra_oper import EthernetEncapsulation', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-acl-cfg', 'ipv6-acl-and-prefix-list') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_acl_cfg import Ipv6AclAndPrefixList', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-snmp-agent-cfg', 'mib') : 'from ydk.models.snmp.Cisco_IOS_XR_snmp_agent_cfg import Mib', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-oper', 'lacp-data') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_oper import LacpData', 
('http://openconfig.net/yang/mpls', 'mpls') : 'from ydk.models.openconfig.openconfig_mpls import Mpls', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-wdsysmon-fd-oper', 'system-monitoring') : 'from ydk.models.wdsysmon.Cisco_IOS_XR_wdsysmon_fd_oper import SystemMonitoring', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-policy-repository-cfg', 'routing-policy') : 'from ydk.models.policy.Cisco_IOS_XR_policy_repository_cfg import RoutingPolicy', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-ospf-oper', 'ospf') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_ospf_oper import Ospf', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-acl-cfg', 'ipv4-acl-and-prefix-list') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_acl_cfg import Ipv4AclAndPrefixList', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-sla-cfg', 'sla') : 'from ydk.models.infra.Cisco_IOS_XR_infra_sla_cfg import Sla', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-lpts-lib-cfg', 'lpts') : 'from ydk.models.lpts.Cisco_IOS_XR_lpts_lib_cfg import Lpts', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-tp') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsTp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rib-ipv4-oper', 'rib-stdby') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rib_ipv4_oper import RibStdby', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-lsd-oper', 'mpls-lsd') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_lsd_oper import MplsLsd', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-tcp-cfg', 'ip-tcp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg import IpTcp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-ntp-cfg', 'ntp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_ntp_cfg import Ntp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-ospf-cfg', 'ospf') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_ospf_cfg import Ospf', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rsvp-oper', 'rsvp-standby') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rsvp_oper import RsvpStandby', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-icpe-infra-cfg', 'nv-satellites') : 'from ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg import NvSatellites', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-policy-repository-oper', 'routing-policy') : 'from ydk.models.policy.Cisco_IOS_XR_policy_repository_oper import RoutingPolicy', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-alarm-logger-oper', 'alarm-logger') : 'from ydk.models.infra.Cisco_IOS_XR_infra_alarm_logger_oper import AlarmLogger', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-te-standby') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsTeStandby', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-spirit-corehelper-cfg', 'exception') : 'from ydk.models.spirit.Cisco_IOS_XR_spirit_corehelper_cfg import Exception', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-udp-oper', 'udp-connection') : 'from ydk.models.ip.Cisco_IOS_XR_ip_udp_oper import UdpConnection', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-pfi-im-cmd-oper', 'interfaces') : 'from ydk.models.pfi.Cisco_IOS_XR_pfi_im_cmd_oper import Interfaces', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-ldp-oper', 'mpls-ldp') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_ldp_oper import MplsLdp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-snmp-agent-oper', 'snmp') : 'from ydk.models.snmp.Cisco_IOS_XR_snmp_agent_oper import Snmp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-cfg', 'l2vpn') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_cfg import L2Vpn', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-wanphy-ui-oper', 'wanphy') : 'from ydk.models.wanphy.Cisco_IOS_XR_wanphy_ui_oper import Wanphy', 
('urn:ietf:params:xml:ns:yang:ietf-system', 'system') : 'from ydk.models.ietf.ietf_system import System', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rib-cfg', 'rib') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rib_cfg import Rib', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-udp-oper', 'udp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_udp_oper import Udp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-icpe-infra-cfg', 'nv-satellite-global') : 'from ydk.models.icpe.Cisco_IOS_XR_icpe_infra_cfg import NvSatelliteGlobal', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-pfilter-oper', 'pfilter-ma') : 'from ydk.models.ip.Cisco_IOS_XR_ip_pfilter_oper import PfilterMa', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-segment-routing-ms-oper', 'srms') : 'from ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_oper import Srms', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-fib-common-oper', 'fib-mpls') : 'from ydk.models.fib.Cisco_IOS_XR_fib_common_oper import FibMpls', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-lsd-oper', 'mpls-lsd-nodes') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_lsd_oper import MplsLsdNodes', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-arp-oper', 'arp') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_arp_oper import Arp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-oper', 'l2vpnv2') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_oper import L2Vpnv2', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ncs5500-qos-oper', 'platform-qos') : 'from ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_qos_oper import PlatformQos', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-domain-oper', 'ip-domain') : 'from ydk.models.ip.Cisco_IOS_XR_ip_domain_oper import IpDomain', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-oper', 'vrf-group') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper import VrfGroup', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-man-xml-ttyagent-oper', 'xr-xml') : 'from ydk.models.man.Cisco_IOS_XR_man_xml_ttyagent_oper import XrXml', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-oper', 'srlg') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper import Srlg', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-man-netconf-cfg', 'netconf-yang') : 'from ydk.models.man.Cisco_IOS_XR_man_netconf_cfg import NetconfYang', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-oper', 'bundles-adjacency') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_oper import BundlesAdjacency', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-bgp-cfg', 'bmp-servers') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_bgp_cfg import BmpServers', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-plat-chas-invmgr-oper', 'platform') : 'from ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper import Platform', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-rgmgr-oper', 'redundancy-group-manager') : 'from ydk.models.rgmgr.Cisco_IOS_XR_rgmgr_oper import RedundancyGroupManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-dumper-cfg', 'exception') : 'from ydk.models.infra.Cisco_IOS_XR_infra_dumper_cfg import Exception', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-oper', 'bundles') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_oper import Bundles', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-man-ems-cfg', 'grpc') : 'from ydk.models.man.Cisco_IOS_XR_man_ems_cfg import Grpc', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ncs1k-mxp-lldp-oper', 'lldp-snoop-data') : 'from ydk.models.ncs1k.Cisco_IOS_XR_ncs1k_mxp_lldp_oper import LldpSnoopData', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-spirit-install-instmgr-oper', 'software-install') : 'from ydk.models.spirit.Cisco_IOS_XR_spirit_install_instmgr_oper import SoftwareInstall', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-te') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsTe', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-tty-vty-cfg', 'vty') : 'from ydk.models.tty.Cisco_IOS_XR_tty_vty_cfg import Vty', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-lib-keychain-cfg', 'keychains') : 'from ydk.models.lib.Cisco_IOS_XR_lib_keychain_cfg import Keychains', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-new-dhcpv6d-oper', 'dhcpv6') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_new_dhcpv6d_oper import Dhcpv6', 
('http://openconfig.net/yang/routing-policy', 'routing-policy') : 'from ydk.models.routing.routing_policy import RoutingPolicy', 
('http://openconfig.net/yang/bgp', 'bgp') : 'from ydk.models.bgp.bgp import Bgp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ifmgr-cfg', 'global-interface-configuration') : 'from ydk.models.ifmgr.Cisco_IOS_XR_ifmgr_cfg import GlobalInterfaceConfiguration', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ncs5500-policymgr-cfg', 'policy-manager') : 'from ydk.models.ncs5500.Cisco_IOS_XR_ncs5500_policymgr_cfg import PolicyManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-iep-oper', 'explicit-paths') : 'from ydk.models.ip.Cisco_IOS_XR_ip_iep_oper import ExplicitPaths', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-tcp-cfg', 'ip') : 'from ydk.models.ip.Cisco_IOS_XR_ip_tcp_cfg import Ip', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-syslog-oper', 'logging') : 'from ydk.models.infra.Cisco_IOS_XR_infra_syslog_oper import Logging', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-cfg', 'srlg') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg import Srlg', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ethernet-link-oam-oper', 'ether-link-oam') : 'from ydk.models.ethernet.Cisco_IOS_XR_ethernet_link_oam_oper import EtherLinkOam', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-watchd-cfg', 'watchd') : 'from ydk.models.watchd.Cisco_IOS_XR_watchd_cfg import Watchd', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ethernet-cfm-oper', 'cfm') : 'from ydk.models.ethernet.Cisco_IOS_XR_ethernet_cfm_oper import Cfm', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2-eth-infra-oper', 'vlan') : 'from ydk.models.l2.Cisco_IOS_XR_l2_eth_infra_oper import Vlan', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-oper', 'selective-vrf-download') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_oper import SelectiveVrfDownload', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-oper', 'l2vpn-forwarding') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_oper import L2VpnForwarding', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-lib-mpp-oper', 'management-plane-protection') : 'from ydk.models.lib.Cisco_IOS_XR_lib_mpp_oper import ManagementPlaneProtection', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-oam-cfg', 'mpls-oam') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_oam_cfg import MplsOam', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-crypto-sam-cfg', 'crypto') : 'from ydk.models.crypto.Cisco_IOS_XR_crypto_sam_cfg import Crypto', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-pmengine-oper', 'performance-management-history') : 'from ydk.models.pmengine.Cisco_IOS_XR_pmengine_oper import PerformanceManagementHistory', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-bgp-cfg', 'bgp') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_bgp_cfg import Bgp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-nto-misc-shprocmem-oper', 'processes-memory') : 'from ydk.models.nto.Cisco_IOS_XR_nto_misc_shprocmem_oper import ProcessesMemory', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-traffmon-netflow-cfg', 'net-flow') : 'from ydk.models.traffmon.Cisco_IOS_XR_traffmon_netflow_cfg import NetFlow', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-segment-routing-ms-cfg', 'sr') : 'from ydk.models.segment.Cisco_IOS_XR_segment_routing_ms_cfg import Sr', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-cdp-cfg', 'cdp') : 'from ydk.models.cdp.Cisco_IOS_XR_cdp_cfg import Cdp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-policymgr-oper', 'policy-manager') : 'from ydk.models.infra.Cisco_IOS_XR_infra_policymgr_oper import PolicyManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-telnet-cfg', 'ipv4-telnet') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg import Ipv4Telnet', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-static-cfg', 'mpls-static') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_static_cfg import MplsStatic', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-ospfv3-cfg', 'ospfv3') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_ospfv3_cfg import Ospfv3', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rsvp-oper', 'rsvp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rsvp_oper import Rsvp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-cfg', 'lacp') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_cfg import Lacp', 
('http://openconfig.net/yang/interfaces', 'interfaces') : 'from ydk.models.openconfig.openconfig_interfaces import Interfaces', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-te-oper', 'mpls-pce') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_te_oper import MplsPce', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv4-io-oper', 'ipv4-network') : 'from ydk.models.ipv4.Cisco_IOS_XR_ipv4_io_oper import Ipv4Network', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-atm-vcm-oper', 'atm-vcm') : 'from ydk.models.atm.Cisco_IOS_XR_atm_vcm_oper import AtmVcm', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-procmem-oper', 'processes-memory') : 'from ydk.models.procmem.Cisco_IOS_XR_procmem_oper import ProcessesMemory', 
('http://openconfig.net/yang/vlan', 'vlans') : 'from ydk.models.openconfig.openconfig_vlan import Vlans', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rsi-cfg', 'global-af') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rsi_cfg import GlobalAf', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-nto-misc-oper', 'memory-summary') : 'from ydk.models.nto.Cisco_IOS_XR_nto_misc_oper import MemorySummary', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rsvp-cfg', 'rsvp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rsvp_cfg import Rsvp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-infra-rmf-oper', 'redundancy') : 'from ydk.models.infra.Cisco_IOS_XR_infra_rmf_oper import Redundancy', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-l2vpn-oper', 'generic-interface-list-v2') : 'from ydk.models.l2vpn.Cisco_IOS_XR_l2vpn_oper import GenericInterfaceListV2', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-bundlemgr-oper', 'lacp-bundle-members') : 'from ydk.models.bundlemgr.Cisco_IOS_XR_bundlemgr_oper import LacpBundleMembers', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rib-ipv4-oper', 'rib') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rib_ipv4_oper import Rib', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ha-eem-cfg', 'event-manager') : 'from ydk.models.ha.Cisco_IOS_XR_ha_eem_cfg import EventManager', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-aaa-locald-oper', 'aaa') : 'from ydk.models.aaa.Cisco_IOS_XR_aaa_locald_oper import Aaa', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ipv6-nd-cfg', 'ipv6-neighbor') : 'from ydk.models.ipv6.Cisco_IOS_XR_ipv6_nd_cfg import Ipv6Neighbor', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-qos-ma-oper', 'qos') : 'from ydk.models.qos.Cisco_IOS_XR_qos_ma_oper import Qos', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-mpls-lsd-cfg', 'mpls-lsd') : 'from ydk.models.mpls.Cisco_IOS_XR_mpls_lsd_cfg import MplsLsd', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-Ethernet-SPAN-cfg', 'span-monitor-session') : 'from ydk.models.ethernet.Cisco_IOS_XR_Ethernet_SPAN_cfg import SpanMonitorSession', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-tcp-oper', 'tcp') : 'from ydk.models.ip.Cisco_IOS_XR_ip_tcp_oper import Tcp', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-wd-cfg', 'watchdog') : 'from ydk.models.wd.Cisco_IOS_XR_wd_cfg import Watchdog', 
('http://cisco.com/ns/yang/Cisco-IOS-XR-ip-rib-ipv6-oper', 'ipv6-rib-stdby') : 'from ydk.models.ip.Cisco_IOS_XR_ip_rib_ipv6_oper import Ipv6RibStdby', 
}
