...
_meta_table = {
    'CCallControlJitterDelayMode_Enum' : _MetaInfoEnum('CCallControlJitterDelayMode_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'adaptive':'ADAPTIVE',
            'fixed':'FIXED',
        }, 'CISCO-MEDIA-GATEWAY-MIB', _yang_ns._namespaces['CISCO-MEDIA-GATEWAY-MIB']),
    'CGwAdminState_Enum' : _MetaInfoEnum('CGwAdminState_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'inService':'INSERVICE',
            'forcedOutOfService':'FORCEDOUTOFSERVICE',
            'gracefulOutOfService':'GRACEFULOUTOFSERVICE',
        }, 'CISCO-MEDIA-GATEWAY-MIB', _yang_ns._namespaces['CISCO-MEDIA-GATEWAY-MIB']),
    'CGwServiceState_Enum' : _MetaInfoEnum('CGwServiceState_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'inService':'INSERVICE',
            'forcedOutOfService':'FORCEDOUTOFSERVICE',
            'gracefulOutOfService':'GRACEFULOUTOFSERVICE',
        }, 'CISCO-MEDIA-GATEWAY-MIB', _yang_ns._namespaces['CISCO-MEDIA-GATEWAY-MIB']),
    'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry.CMediaGwCcCfgClusterEnabled_Enum' : _MetaInfoEnum('CMediaGwCcCfgClusterEnabled_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'disabled':'DISABLED',
            'enabled':'ENABLED',
            'conditionalEnabled':'CONDITIONALENABLED',
        }, 'CISCO-MEDIA-GATEWAY-MIB', _yang_ns._namespaces['CISCO-MEDIA-GATEWAY-MIB']),
    'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry.CMediaGwCcCfgDefBearerTraffic_Enum' : _MetaInfoEnum('CMediaGwCcCfgDefBearerTraffic_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'ipPvcAal5':'IPPVCAAL5',
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry',
            ...
            _MetaInfoClassMember('cMediaGwCcCfgBearerTos', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwCcCfgClusterEnabled', REFERENCE_ENUM_CLASS, 'CMediaGwCcCfgClusterEnabled_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry.CMediaGwCcCfgClusterEnabled_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cMediaGwCcCfgDefaultTonePlanId', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwCcCfgDefBearerTraffic', REFERENCE_ENUM_CLASS, 'CMediaGwCcCfgDefBearerTraffic_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry.CMediaGwCcCfgDefBearerTraffic_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cMediaGwCcCfgRtpNamePrefix', ATTRIBUTE, 'str' , None, None, 
                ...
                'cmediagwcccfgrtpnameprefix',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwCcCfgVbdJitterDelayMode', REFERENCE_ENUM_CLASS, 'CCallControlJitterDelayMode_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CCallControlJitterDelayMode_Enum', 
                [], [], 
        ...
        'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB'
        ),
    },
    'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable',
            False, 
            [
            _MetaInfoClassMember('cMediaGwCallControlConfigEntry', REFERENCE_LIST, 'CMediaGwCallControlConfigEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable.CMediaGwCallControlConfigEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwDnsIpConfigTable.CMediaGwDnsIpConfigEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwDnsIpConfigTable.CMediaGwDnsIpConfigEntry',
            ...
            _MetaInfoClassMember('cmgwDnsIp', ATTRIBUTE, 'str' , None, None, 
                ...
                'cmgwdnsip',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwDnsIpRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                ...
                'cmgwdnsiprowstatus',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwDnsIpType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwDnsIpConfigTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwDnsIpConfigTable',
            False, 
            [
            _MetaInfoClassMember('cMediaGwDnsIpConfigEntry', REFERENCE_LIST, 'CMediaGwDnsIpConfigEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwDnsIpConfigTable.CMediaGwDnsIpConfigEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable.CMediaGwDomainNameConfigEntry.CmgwConfigDomainNameEntity_Enum' : _MetaInfoEnum('CmgwConfigDomainNameEntity_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'gateway':'GATEWAY',
            'dnsServer':'DNSSERVER',
            'mgc':'MGC',
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable.CMediaGwDomainNameConfigEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable.CMediaGwDomainNameConfigEntry',
            ...
            _MetaInfoClassMember('cmgwConfigDomainName', ATTRIBUTE, 'str' , None, None, 
                ...
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwConfigDomainNameEntity', REFERENCE_ENUM_CLASS, 'CmgwConfigDomainNameEntity_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable.CMediaGwDomainNameConfigEntry.CmgwConfigDomainNameEntity_Enum', 
                [], [], 
                ...
                'cmgwconfigdomainnameentity',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwConfigDomainNameRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This object is used to add and delete an entry.
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable',
            False, 
            [
            _MetaInfoClassMember('cMediaGwDomainNameConfigEntry', REFERENCE_LIST, 'CMediaGwDomainNameConfigEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable.CMediaGwDomainNameConfigEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwIpConfigTable.CMediaGwIpConfigEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwIpConfigTable.CMediaGwIpConfigEntry',
            ...
            _MetaInfoClassMember('cmgwIpConfigAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'cmgwipconfigaddress',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwIpConfigAddrType', REFERENCE_ENUM_CLASS, 'InetAddressType_Enum' , 'ydk.models.inet.INET_ADDRESS_MIB', 'InetAddressType_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cmgwIpConfigIfIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cmgwipconfigifindex',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwIpConfigRowStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
                '''                This object is used to add and delete an entry.
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwIpConfigTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwIpConfigTable',
            False, 
            [
            _MetaInfoClassMember('cMediaGwIpConfigEntry', REFERENCE_LIST, 'CMediaGwIpConfigEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwIpConfigTable.CMediaGwIpConfigEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable.CMediaGwRscStatsEntry.CmgwRscStatsIndex_Enum' : _MetaInfoEnum('CmgwRscStatsIndex_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'cpu':'CPU',
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable.CMediaGwRscStatsEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable.CMediaGwRscStatsEntry',
            ...
            _MetaInfoClassMember('cmgwIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cmgwindex',
                'CISCO-MEDIA-GATEWAY-MIB', True),
            _MetaInfoClassMember('cmgwRscStatsIndex', REFERENCE_ENUM_CLASS, 'CmgwRscStatsIndex_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable.CMediaGwRscStatsEntry.CmgwRscStatsIndex_Enum', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable',
            False, 
            [
            _MetaInfoClassMember('cMediaGwRscStatsEntry', REFERENCE_LIST, 'CMediaGwRscStatsEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable.CMediaGwRscStatsEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwTable.CMediaGwEntry.CmgwVtMappingMode_Enum' : _MetaInfoEnum('CmgwVtMappingMode_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'standard':'STANDARD',
            'titan':'TITAN',
        }, 'CISCO-MEDIA-GATEWAY-MIB', _yang_ns._namespaces['CISCO-MEDIA-GATEWAY-MIB']),
    'CISCOMEDIAGATEWAYMIB.CMediaGwTable.CMediaGwEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwTable.CMediaGwEntry',
            ...
            _MetaInfoClassMember('cmgwIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cmgwindex',
                'CISCO-MEDIA-GATEWAY-MIB', True),
            _MetaInfoClassMember('cmgwAdminState', REFERENCE_ENUM_CLASS, 'CGwAdminState_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CGwAdminState_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cmgwPhysicalIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'cmgwphysicalindex',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwServiceState', REFERENCE_ENUM_CLASS, 'CGwServiceState_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CGwServiceState_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('cmgwV23Enabled', ATTRIBUTE, 'bool' , None, None, 
                ...
                'cmgwv23enabled',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwVtMappingMode', REFERENCE_ENUM_CLASS, 'CmgwVtMappingMode_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwTable.CMediaGwEntry.CmgwVtMappingMode_Enum', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CMediaGwTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CMediaGwTable',
            False, 
            [
            _MetaInfoClassMember('cMediaGwEntry', REFERENCE_LIST, 'CMediaGwEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwTable.CMediaGwEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CmgwLifTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CmgwLifTable',
            False, 
            [
            _MetaInfoClassMember('cmgwLifEntry', REFERENCE_LIST, 'CmgwLifEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CmgwLifTable.CmgwLifEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable.CmgwSignalProtocolEntry.CmgwSignalProtocol_Enum' : _MetaInfoEnum('CmgwSignalProtocol_Enum', 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB',
        {
            'other':'OTHER',
            'mgcp':'MGCP',
            'h248':'H248',
    ...
    'CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable.CmgwSignalProtocolEntry' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable.CmgwSignalProtocolEntry',
            ...
            _MetaInfoClassMember('cmgwSignalMgcProtocolPort', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwSignalProtocol', REFERENCE_ENUM_CLASS, 'CmgwSignalProtocol_Enum' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable.CmgwSignalProtocolEntry.CmgwSignalProtocol_Enum', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable',
            False, 
            [
            _MetaInfoClassMember('cmgwSignalProtocolEntry', REFERENCE_LIST, 'CmgwSignalProtocolEntry' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable.CmgwSignalProtocolEntry', 
                [], [], 
    ...
    'CISCOMEDIAGATEWAYMIB' : {
        'meta_info' : _MetaInfoClass('CISCOMEDIAGATEWAYMIB',
            False, 
            [
            _MetaInfoClassMember('cMediaGwCallControlConfigTable', REFERENCE_CLASS, 'CMediaGwCallControlConfigTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwCallControlConfigTable', 
                [], [], 
                ...
                'cmediagwcallcontrolconfigtable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwDnsIpConfigTable', REFERENCE_CLASS, 'CMediaGwDnsIpConfigTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwDnsIpConfigTable', 
                [], [], 
                ...
                'cmediagwdnsipconfigtable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwDomainNameConfigTable', REFERENCE_CLASS, 'CMediaGwDomainNameConfigTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwDomainNameConfigTable', 
                [], [], 
                ...
                'cmediagwdomainnameconfigtable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwIpConfigTable', REFERENCE_CLASS, 'CMediaGwIpConfigTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwIpConfigTable', 
                [], [], 
                ...
                'cmediagwipconfigtable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwRscStatsTable', REFERENCE_CLASS, 'CMediaGwRscStatsTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwRscStatsTable', 
                [], [], 
                ...
                'cmediagwrscstatstable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cMediaGwTable', REFERENCE_CLASS, 'CMediaGwTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CMediaGwTable', 
                [], [], 
                ...
                'cmediagwtable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwLifTable', REFERENCE_CLASS, 'CmgwLifTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CmgwLifTable', 
                [], [], 
                ...
                'cmgwliftable',
                'CISCO-MEDIA-GATEWAY-MIB', False),
            _MetaInfoClassMember('cmgwSignalProtocolTable', REFERENCE_CLASS, 'CmgwSignalProtocolTable' , 'ydk.models.media.CISCO_MEDIA_GATEWAY_MIB', 'CISCOMEDIAGATEWAYMIB.CmgwSignalProtocolTable', 
                [], [], 
