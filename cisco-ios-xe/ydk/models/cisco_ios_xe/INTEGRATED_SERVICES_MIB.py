...
class QosserviceEnum(Enum):
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.cisco_ios_xe._meta import _INTEGRATED_SERVICES_MIB as meta
    ...
    class Intsrvflowtable(object):
        ...
        class Intsrvflowentry(object):
            ...
            .. attribute:: intsrvflowowner
            	...
            	**type**\:   :py:class:`IntsrvflowownerEnum <ydk.models.cisco_ios_xe.INTEGRATED_SERVICES_MIB.IntegratedServicesMib.Intsrvflowtable.Intsrvflowentry.IntsrvflowownerEnum>`
            ...
            class IntsrvflowownerEnum(Enum):
                ...
                def _meta_info():
                    from ydk.models.cisco_ios_xe._meta import _INTEGRATED_SERVICES_MIB as meta
                    return meta._meta_table['IntegratedServicesMib.Intsrvflowtable.Intsrvflowentry.IntsrvflowownerEnum']
