...
class Instmgr(_Entity_):
    ...
    def __init__(self):
        ...
        self._child_classes = OrderedDict([("trace", ("trace", Instmgr.Trace))])
    ...
    class Trace(_Entity_):
        ...
        def __init__(self):
            ...
            self._child_classes = OrderedDict([("location", ("location", Instmgr.Trace.Location))])
            self._leafs = OrderedDict([
        ...
        class Location(_Entity_):
            ...
            def __init__(self):
                ...
                self._child_classes = OrderedDict([("all-options", ("all_options", Instmgr.Trace.Location.AllOptions))])
                self._leafs = OrderedDict([
            ...
            class AllOptions(_Entity_):
                ...
                def __init__(self):
                    ...
                    self._child_classes = OrderedDict([("trace-blocks", ("trace_blocks", Instmgr.Trace.Location.AllOptions.TraceBlocks))])
                    self._leafs = OrderedDict([
                ...
                class TraceBlocks(_Entity_):
                    ...
                    @staticmethod
                    def _meta_info():
                        from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_instmgr as meta
                        return meta._meta_table['Instmgr.Trace.Location.AllOptions.TraceBlocks']['meta_info']

                @staticmethod
                def _meta_info():
                    from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_instmgr as meta
                    return meta._meta_table['Instmgr.Trace.Location.AllOptions']['meta_info']

            @staticmethod
            def _meta_info():
                from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_instmgr as meta
                return meta._meta_table['Instmgr.Trace.Location']['meta_info']

        @staticmethod
        def _meta_info():
            from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_instmgr as meta
            return meta._meta_table['Instmgr.Trace']['meta_info']
    ...
    def _meta_info():
        from ydk.models.cisco_ios_xr._meta import _Cisco_IOS_XR_sysadmin_show_trace_instmgr as meta
        return meta._meta_table['Instmgr']['meta_info']
