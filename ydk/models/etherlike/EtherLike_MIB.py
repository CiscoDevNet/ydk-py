...
class Dot3ErrorInitError_Identity(ObjectIdentity_Identity):
    """
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.etherlike._meta import _EtherLike_MIB as meta
        return meta._meta_table['Dot3ErrorInitError_Identity']['meta_info']


class Dot3ErrorLoopbackError_Identity(ObjectIdentity_Identity):
    """
    \*\*\*\*\*\*\*\* THIS IDENTITY IS DEPRECATED \*\*\*\*\*\*\*
    ...
    def _meta_info():
        from ydk.models.etherlike._meta import _EtherLike_MIB as meta
        return meta._meta_table['Dot3ErrorLoopbackError_Identity']['meta_info']


class Dot3TestLoopBack_Identity(ObjectIdentity_Identity):
    """
    \*\*\*\*\*\*\*\* THIS IDENTITY IS DEPRECATED \*\*\*\*\*\*\*
    ...
    def _meta_info():
        from ydk.models.etherlike._meta import _EtherLike_MIB as meta
        return meta._meta_table['Dot3TestLoopBack_Identity']['meta_info']


class Dot3TestTdr_Identity(ObjectIdentity_Identity):
    """
    \*\*\*\*\*\*\*\* THIS IDENTITY IS DEPRECATED \*\*\*\*\*\*\*
    ...
    def _meta_info():
        from ydk.models.etherlike._meta import _EtherLike_MIB as meta
        return meta._meta_table['Dot3TestTdr_Identity']['meta_info']
...
class EtherLikeMIB(object):
    ...
    .. attribute:: dot3colltable
    	...
    	**type**\: :py:class:`Dot3CollTable <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3CollTable>`
    ...
    .. attribute:: dot3controltable
    	...
    	**type**\: :py:class:`Dot3ControlTable <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3ControlTable>`
    ...
    .. attribute:: dot3hcstatstable
    	...
    	**type**\: :py:class:`Dot3HCStatsTable <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3HCStatsTable>`
    ...
    .. attribute:: dot3pausetable
    	...
    	**type**\: :py:class:`Dot3PauseTable <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3PauseTable>`
    ...
    .. attribute:: dot3statstable
    	...
    	**type**\: :py:class:`Dot3StatsTable <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3StatsTable>`
    ...
    class Dot3CollTable(object):
        ...
        .. attribute:: dot3collentry
        	...
        	**type**\: list of :py:class:`Dot3CollEntry <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3CollTable.Dot3CollEntry>`
        ...
        class Dot3CollEntry(object):
            ...
            def _common_path(self):
                if self.dot3collcount is None:
                    raise YPYDataValidationError('Key property dot3collcount is None')
                if self.ifindex is None:
                    raise YPYDataValidationError('Key property ifindex is None')

                return '/EtherLike-MIB:EtherLike-MIB/EtherLike-MIB:dot3CollTable/EtherLike-MIB:dot3CollEntry[EtherLike-MIB:dot3CollCount = ' + str(self.dot3collcount) + '][EtherLike-MIB:ifIndex = ' + str(self.ifindex) + ']'
    ...
    class Dot3ControlTable(object):
        ...
        .. attribute:: dot3controlentry
        	...
        	**type**\: list of :py:class:`Dot3ControlEntry <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry>`
        ...
        class Dot3ControlEntry(object):
            ...
            .. attribute:: dot3controlfunctionssupported
            	...
            	**type**\: :py:class:`Dot3ControlFunctionsSupported_Bits <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry.Dot3ControlFunctionsSupported_Bits>`
            ...
            def __init__(self):
                ...
                self.dot3controlfunctionssupported = EtherLikeMIB.Dot3ControlTable.Dot3ControlEntry.Dot3ControlFunctionsSupported_Bits()
                self.dot3controlinunknownopcodes = None
                self.dot3hccontrolinunknownopcodes = None

            class Dot3ControlFunctionsSupported_Bits(FixedBitsDict):
                """
                Dot3ControlFunctionsSupported_Bits
    ...
    class Dot3HCStatsTable(object):
        ...
        .. attribute:: dot3hcstatsentry
        	...
        	**type**\: list of :py:class:`Dot3HCStatsEntry <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3HCStatsTable.Dot3HCStatsEntry>`
    ...
    class Dot3PauseTable(object):
        ...
        .. attribute:: dot3pauseentry
        	...
        	**type**\: list of :py:class:`Dot3PauseEntry <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry>`
        ...
        class Dot3PauseEntry(object):
            ...
            .. attribute:: dot3pauseadminmode
            	...
            	**type**\: :py:class:`Dot3PauseAdminMode_Enum <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseAdminMode_Enum>`
            ...
            .. attribute:: dot3pauseopermode
            	...
            	**type**\: :py:class:`Dot3PauseOperMode_Enum <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseOperMode_Enum>`
            ...
            class Dot3PauseAdminMode_Enum(Enum):
                """
                Dot3PauseAdminMode_Enum
                ...
                def _meta_info():
                    from ydk.models.etherlike._meta import _EtherLike_MIB as meta
                    return meta._meta_table['EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseAdminMode_Enum']


            class Dot3PauseOperMode_Enum(Enum):
                """
                Dot3PauseOperMode_Enum
                ...
                def _meta_info():
                    from ydk.models.etherlike._meta import _EtherLike_MIB as meta
                    return meta._meta_table['EtherLikeMIB.Dot3PauseTable.Dot3PauseEntry.Dot3PauseOperMode_Enum']
    ...
    class Dot3StatsTable(object):
        ...
        .. attribute:: dot3statsentry
        	...
        	**type**\: list of :py:class:`Dot3StatsEntry <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry>`
        ...
        class Dot3StatsEntry(object):
            ...
            .. attribute:: dot3statsduplexstatus
            	...
            	**type**\: :py:class:`Dot3StatsDuplexStatus_Enum <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsDuplexStatus_Enum>`
            ...
            .. attribute:: dot3statsratecontrolstatus
            	...
            	**type**\: :py:class:`Dot3StatsRateControlStatus_Enum <ydk.models.etherlike.EtherLike_MIB.EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsRateControlStatus_Enum>`
            ...
            class Dot3StatsDuplexStatus_Enum(Enum):
                """
                Dot3StatsDuplexStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.etherlike._meta import _EtherLike_MIB as meta
                    return meta._meta_table['EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsDuplexStatus_Enum']


            class Dot3StatsRateControlStatus_Enum(Enum):
                """
                Dot3StatsRateControlStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.etherlike._meta import _EtherLike_MIB as meta
                    return meta._meta_table['EtherLikeMIB.Dot3StatsTable.Dot3StatsEntry.Dot3StatsRateControlStatus_Enum']
    ...
    def _has_data(self):
        ...
        if self.dot3colltable is not None and self.dot3colltable.is_presence():
            return True

        if self.dot3controltable is not None and self.dot3controltable._has_data():
            return True

        if self.dot3controltable is not None and self.dot3controltable.is_presence():
            return True

        if self.dot3hcstatstable is not None and self.dot3hcstatstable._has_data():
            return True

        if self.dot3hcstatstable is not None and self.dot3hcstatstable.is_presence():
            return True

        if self.dot3pausetable is not None and self.dot3pausetable._has_data():
            return True

        if self.dot3pausetable is not None and self.dot3pausetable.is_presence():
            return True

        if self.dot3statstable is not None and self.dot3statstable._has_data():
            return True

        if self.dot3statstable is not None and self.dot3statstable.is_presence():
            return True
