...
_meta_table = {
    'EntryStatus_Enum' : _MetaInfoEnum('EntryStatus_Enum', 'ydk.models.token.TOKEN_RING_RMON_MIB',
        {
            'valid':'VALID',
    ...
    'TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry.RingStationConfigControlRemove_Enum' : _MetaInfoEnum('RingStationConfigControlRemove_Enum', 'ydk.models.token.TOKEN_RING_RMON_MIB',
        {
            'stable':'STABLE',
            'removing':'REMOVING',
        }, 'TOKEN-RING-RMON-MIB', _yang_ns._namespaces['TOKEN-RING-RMON-MIB']),
    'TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry.RingStationConfigControlUpdateStats_Enum' : _MetaInfoEnum('RingStationConfigControlUpdateStats_Enum', 'ydk.models.token.TOKEN_RING_RMON_MIB',
        {
            'stable':'STABLE',
            'updating':'UPDATING',
        }, 'TOKEN-RING-RMON-MIB', _yang_ns._namespaces['TOKEN-RING-RMON-MIB']),
    'TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry',
            ...
            _MetaInfoClassMember('ringStationConfigControlMacAddress', ATTRIBUTE, 'str' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', True),
            _MetaInfoClassMember('ringStationConfigControlRemove', REFERENCE_ENUM_CLASS, 'RingStationConfigControlRemove_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry.RingStationConfigControlRemove_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ringStationConfigControlUpdateStats', REFERENCE_ENUM_CLASS, 'RingStationConfigControlUpdateStats_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry.RingStationConfigControlUpdateStats_Enum', 
                [], [], 
        ...
        'ydk.models.token.TOKEN_RING_RMON_MIB'
        ),
    },
    'TOKENRINGRMONMIB.RingStationConfigControlTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationConfigControlTable',
            False, 
            [
            _MetaInfoClassMember('ringStationConfigControlEntry', REFERENCE_LIST, 'RingStationConfigControlEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationConfigControlTable.RingStationConfigControlEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.RingStationConfigTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationConfigTable',
            False, 
            [
            _MetaInfoClassMember('ringStationConfigEntry', REFERENCE_LIST, 'RingStationConfigEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationConfigTable.RingStationConfigEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.RingStationControlTable.RingStationControlEntry.RingStationControlRingState_Enum' : _MetaInfoEnum('RingStationControlRingState_Enum', 'ydk.models.token.TOKEN_RING_RMON_MIB',
        {
    ...
    'TOKENRINGRMONMIB.RingStationControlTable.RingStationControlEntry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationControlTable.RingStationControlEntry',
            ...
            _MetaInfoClassMember('ringStationControlBeaconSender', ATTRIBUTE, 'str' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationControlCreateTime', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                ...
                'RMON2-MIB', False),
            _MetaInfoClassMember('ringStationControlDroppedFrames', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
            ...
            _MetaInfoClassMember('ringStationControlOwner', ATTRIBUTE, 'str' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationControlRingState', REFERENCE_ENUM_CLASS, 'RingStationControlRingState_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationControlTable.RingStationControlEntry.RingStationControlRingState_Enum', 
                [], [], 
                '''                The current status of this ring.
                ''',
                'ringstationcontrolringstate',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationControlStatus', REFERENCE_ENUM_CLASS, 'EntryStatus_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'EntryStatus_Enum', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.RingStationControlTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationControlTable',
            False, 
            [
            _MetaInfoClassMember('ringStationControlEntry', REFERENCE_LIST, 'RingStationControlEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationControlTable.RingStationControlEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.RingStationOrderTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationOrderTable',
            False, 
            [
            _MetaInfoClassMember('ringStationOrderEntry', REFERENCE_LIST, 'RingStationOrderEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationOrderTable.RingStationOrderEntry', 
                [], [], 
                '''                A collection of statistics for a particular
    ...
    'TOKENRINGRMONMIB.RingStationTable.RingStationEntry.RingStationStationStatus_Enum' : _MetaInfoEnum('RingStationStationStatus_Enum', 'ydk.models.token.TOKEN_RING_RMON_MIB',
        {
            'active':'ACTIVE',
            'inactive':'INACTIVE',
    ...
    'TOKENRINGRMONMIB.RingStationTable.RingStationEntry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationTable.RingStationEntry',
            ...
            _MetaInfoClassMember('ringStationOutLineErrors', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationStationStatus', REFERENCE_ENUM_CLASS, 'RingStationStationStatus_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationTable.RingStationEntry.RingStationStationStatus_Enum', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.RingStationTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.RingStationTable',
            False, 
            [
            _MetaInfoClassMember('ringStationEntry', REFERENCE_LIST, 'RingStationEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationTable.RingStationEntry', 
                [], [], 
                '''                A collection of statistics for a particular
                station that has been discovered on a ring
    ...
    'TOKENRINGRMONMIB.SourceRoutingStatsTable.SourceRoutingStatsEntry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.SourceRoutingStatsTable.SourceRoutingStatsEntry',
            ...
            _MetaInfoClassMember('sourceRoutingStatsAllRoutesBroadcastOctets', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('sourceRoutingStatsCreateTime', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                '''                The value of sysUpTime when this control entry was last activated.
                This can be used by the management station to ensure that the
                table has not been deleted and recreated between polls.
                ...
                'RMON2-MIB', False),
            _MetaInfoClassMember('sourceRoutingStatsDroppedFrames', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                '''                The total number of frames which were received by the probe
                and therefore not accounted for in the *StatsDropEvents, but
                for which the probe chose not to count for this entry for
            ...
            _MetaInfoClassMember('sourceRoutingStatsSingleRoutesBroadcastOctets', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('sourceRoutingStatsStatus', REFERENCE_ENUM_CLASS, 'EntryStatus_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'EntryStatus_Enum', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.SourceRoutingStatsTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.SourceRoutingStatsTable',
            False, 
            [
            _MetaInfoClassMember('sourceRoutingStatsEntry', REFERENCE_LIST, 'SourceRoutingStatsEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.SourceRoutingStatsTable.SourceRoutingStatsEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.TokenRingMLHistoryTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.TokenRingMLHistoryTable',
            False, 
            [
            _MetaInfoClassMember('tokenRingMLHistoryEntry', REFERENCE_LIST, 'TokenRingMLHistoryEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingMLHistoryTable.TokenRingMLHistoryEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.TokenRingMLStatsTable.TokenRingMLStatsEntry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.TokenRingMLStatsTable.TokenRingMLStatsEntry',
            ...
            _MetaInfoClassMember('tokenRingMLStatsCongestionErrors', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingMLStatsCreateTime', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                '''                The value of sysUpTime when this control entry was last activated.
                This can be used by the management station to ensure that the
                table has not been deleted and recreated between polls.
            ...
            _MetaInfoClassMember('tokenRingMLStatsDropEvents', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingMLStatsDroppedFrames', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                '''                The total number of frames which were received by the probe
                and therefore not accounted for in the *StatsDropEvents, but
                for which the probe chose not to count for this entry for
            ...
            _MetaInfoClassMember('tokenRingMLStatsSoftErrorReports', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingMLStatsStatus', REFERENCE_ENUM_CLASS, 'EntryStatus_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'EntryStatus_Enum', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.TokenRingMLStatsTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.TokenRingMLStatsTable',
            False, 
            [
            _MetaInfoClassMember('tokenRingMLStatsEntry', REFERENCE_LIST, 'TokenRingMLStatsEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingMLStatsTable.TokenRingMLStatsEntry', 
                [], [], 
                '''                A collection of Mac-Layer statistics kept for a
                particular Token Ring interface.
                ''',
    ...
    'TOKENRINGRMONMIB.TokenRingPHistoryTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.TokenRingPHistoryTable',
            False, 
            [
            _MetaInfoClassMember('tokenRingPHistoryEntry', REFERENCE_LIST, 'TokenRingPHistoryEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingPHistoryTable.TokenRingPHistoryEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.TokenRingPStatsTable.TokenRingPStatsEntry' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.TokenRingPStatsTable.TokenRingPStatsEntry',
            ...
            _MetaInfoClassMember('tokenRingPStatsIndex', ATTRIBUTE, 'int' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', True),
            _MetaInfoClassMember('tokenRingPStatsCreateTime', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                '''                The value of sysUpTime when this control entry was last activated.
                This can be used by the management station to ensure that the
                table has not been deleted and recreated between polls.
            ...
            _MetaInfoClassMember('tokenRingPStatsDropEvents', ATTRIBUTE, 'int' , None, None, 
                ...
                'tokenringpstatsdropevents',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingPStatsDroppedFrames', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                '''                The total number of frames which were received by the probe
                and therefore not accounted for in the *StatsDropEvents, but
                for which the probe chose not to count for this entry for
            ...
            _MetaInfoClassMember('tokenRingPStatsOwner', ATTRIBUTE, 'str' , None, None, 
                ...
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingPStatsStatus', REFERENCE_ENUM_CLASS, 'EntryStatus_Enum' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'EntryStatus_Enum', 
                [], [], 
    ...
    'TOKENRINGRMONMIB.TokenRingPStatsTable' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB.TokenRingPStatsTable',
            False, 
            [
            _MetaInfoClassMember('tokenRingPStatsEntry', REFERENCE_LIST, 'TokenRingPStatsEntry' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingPStatsTable.TokenRingPStatsEntry', 
                [], [], 
    ...
    'TOKENRINGRMONMIB' : {
        'meta_info' : _MetaInfoClass('TOKENRINGRMONMIB',
            False, 
            [
            _MetaInfoClassMember('ringStationConfigControlTable', REFERENCE_CLASS, 'RingStationConfigControlTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationConfigControlTable', 
                [], [], 
                ...
                'ringstationconfigcontroltable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationConfigTable', REFERENCE_CLASS, 'RingStationConfigTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationConfigTable', 
                [], [], 
                ...
                'ringstationconfigtable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationControlTable', REFERENCE_CLASS, 'RingStationControlTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationControlTable', 
                [], [], 
                '''                A list of ringStation table control entries.
                ''',
                'ringstationcontroltable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationOrderTable', REFERENCE_CLASS, 'RingStationOrderTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationOrderTable', 
                [], [], 
                ...
                'ringstationordertable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('ringStationTable', REFERENCE_CLASS, 'RingStationTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.RingStationTable', 
                [], [], 
                ...
                'ringstationtable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('sourceRoutingStatsTable', REFERENCE_CLASS, 'SourceRoutingStatsTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.SourceRoutingStatsTable', 
                [], [], 
                '''                A list of source routing statistics entries.
                ''',
                'sourceroutingstatstable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingMLHistoryTable', REFERENCE_CLASS, 'TokenRingMLHistoryTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingMLHistoryTable', 
                [], [], 
                ...
                'tokenringmlhistorytable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingMLStatsTable', REFERENCE_CLASS, 'TokenRingMLStatsTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingMLStatsTable', 
                [], [], 
                '''                A list of Mac-Layer Token Ring statistics
                ...
                'tokenringmlstatstable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingPHistoryTable', REFERENCE_CLASS, 'TokenRingPHistoryTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingPHistoryTable', 
                [], [], 
                ...
                'tokenringphistorytable',
                'TOKEN-RING-RMON-MIB', False),
            _MetaInfoClassMember('tokenRingPStatsTable', REFERENCE_CLASS, 'TokenRingPStatsTable' , 'ydk.models.token.TOKEN_RING_RMON_MIB', 'TOKENRINGRMONMIB.TokenRingPStatsTable', 
                [], [], 
                '''                A list of promiscuous Token Ring statistics
                entries.
                ''',
