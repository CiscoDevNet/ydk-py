...
class MplsStatic(Entity):
    ...
    def __init__(self):
        ...
        self._child_classes = OrderedDict([("mpls-static-state", ("mpls_static_state", MplsStatic.MplsStaticState)), ("mpls-static-cfg", ("mpls_static_cfg", MplsStatic.MplsStaticCfg))])
    ...
    class MplsStaticCfg(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_classes = OrderedDict([("ipv4-ingress-lsps", ("ipv4_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv4IngressLsps)), ("interfaces", ("interfaces", MplsStatic.MplsStaticCfg.Interfaces)), ("ipv6-ingress-lsps", ("ipv6_ingress_lsps", MplsStatic.MplsStaticCfg.Ipv6IngressLsps)), ("in-label-lsps", ("in_label_lsps", MplsStatic.MplsStaticCfg.InLabelLsps)), ("named-lsps", ("named_lsps", MplsStatic.MplsStaticCfg.NamedLsps))])
            self._leafs = OrderedDict()
            ...
            class Ipv4IngressLsp(Entity):
                ...
                class Path(Entity):
                    ...
                    class NextHop(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop, ['index', 'type', 'protected_by'], name, value)
                        ...
                        class NextHopType(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.NextHopType, ['mac_address', 'if_index', 'ipv4_address', 'ipv6_address', 'out_interface_name'], name, value)
                        ...
                        class Operations(Entity):
                            ...
                            def __init__(self):
                                ...
                                self.has_list_ancestor = True
                                self.ylist_key_names = []
                                self._child_classes = OrderedDict([("push", ("push", MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.Operations.Push)), ("swap", ("swap", MplsStatic.MplsStaticCfg.Ipv4IngressLsps.Ipv4IngressLsp.Path.NextHop.Operations.Swap))])
                                self._leafs = OrderedDict([
                                    ('preserve', (YLeaf(YType.empty, 'preserve'), ['Empty'])),
                                    ('pop_and_forward', (YLeaf(YType.empty, 'pop-and-forward'), ['Empty'])),
                                ])
