...
_meta_table = {
    'SdrInventory.Racks.Rack.Slot.Card.Attributes' : {
        ...
        'ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper'
        ),
    },
    'SdrInventory.Racks.Rack.Slot.Card' : {
        'meta_info' : _MetaInfoClass('SdrInventory.Racks.Rack.Slot.Card',
            ...
            _MetaInfoClassMember('attributes', REFERENCE_CLASS, 'Attributes' , 'ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper', 'SdrInventory.Racks.Rack.Slot.Card.Attributes', 
                [], [], 
                '''                Attributes
                ''',
                'attributes',
    ...
    'SdrInventory.Racks.Rack.Slot' : {
        'meta_info' : _MetaInfoClass('SdrInventory.Racks.Rack.Slot',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'Cisco-IOS-XR-sdr-invmgr-oper', True),
            _MetaInfoClassMember('card', REFERENCE_LIST, 'Card' , 'ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper', 'SdrInventory.Racks.Rack.Slot.Card', 
                [], [], 
                '''                Card
                ''',
                'card',
    ...
    'SdrInventory.Racks.Rack' : {
        'meta_info' : _MetaInfoClass('SdrInventory.Racks.Rack',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'Cisco-IOS-XR-sdr-invmgr-oper', True),
            _MetaInfoClassMember('slot', REFERENCE_LIST, 'Slot' , 'ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper', 'SdrInventory.Racks.Rack.Slot', 
                [], [], 
                '''                Slot name
                ''',
                'slot',
    ...
    'SdrInventory.Racks' : {
        'meta_info' : _MetaInfoClass('SdrInventory.Racks',
            False, 
            [
            _MetaInfoClassMember('rack', REFERENCE_LIST, 'Rack' , 'ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper', 'SdrInventory.Racks.Rack', 
                [], [], 
                '''                Rack name
                ''',
                'rack',
    ...
    'SdrInventory' : {
        'meta_info' : _MetaInfoClass('SdrInventory',
            False, 
            [
            _MetaInfoClassMember('racks', REFERENCE_CLASS, 'Racks' , 'ydk.models.sdr.Cisco_IOS_XR_sdr_invmgr_oper', 'SdrInventory.Racks', 
                [], [], 
                '''                RackTable
                ''',
                'racks',
