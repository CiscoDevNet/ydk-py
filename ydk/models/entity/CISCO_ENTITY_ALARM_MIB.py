...
class AlarmSeverity_Enum(Enum):
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.entity._meta import _CISCO_ENTITY_ALARM_MIB as meta
        return meta._meta_table['AlarmSeverity_Enum']
...
class CISCOENTITYALARMMIB(object):
    ...
    .. attribute:: cealarmdescrmaptable
    	...
    	**type**\: :py:class:`CeAlarmDescrMapTable <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmDescrMapTable>`
    ...
    .. attribute:: cealarmdescrtable
    	...
    	**type**\: :py:class:`CeAlarmDescrTable <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmDescrTable>`
    
    .. attribute:: cealarmfiltering
    
    	
    	**type**\: :py:class:`CeAlarmFiltering <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmFiltering>`
    
    .. attribute:: cealarmfilterprofiletable
    
    	This table contains a list of alarm filter profiles
    	**type**\: :py:class:`CeAlarmFilterProfileTable <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmFilterProfileTable>`
    
    .. attribute:: cealarmhistory
    
    	
    	**type**\: :py:class:`CeAlarmHistory <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmHistory>`
    
    .. attribute:: cealarmhisttable
    
    	This table contains a history of ceAlarmIndicate and ceAlarmClear traps generated by the agent
    	**type**\: :py:class:`CeAlarmHistTable <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmHistTable>`
    
    .. attribute:: cealarmmonitoring
    
    	
    	**type**\: :py:class:`CeAlarmMonitoring <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmMonitoring>`
    ...
    .. attribute:: cealarmtable
    	...
    	**type**\: :py:class:`CeAlarmTable <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmTable>`
    ...
    class CeAlarmDescrMapTable(object):
        ...
        .. attribute:: cealarmdescrmapentry
        	...
        	**type**\: list of :py:class:`CeAlarmDescrMapEntry <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmDescrMapTable.CeAlarmDescrMapEntry>`
        ...
        class CeAlarmDescrMapEntry(object):
            ...
            def _common_path(self):
                if self.cealarmdescrindex is None:
                    raise YPYDataValidationError('Key property cealarmdescrindex is None')
    ...
    class CeAlarmDescrTable(object):
        ...
        .. attribute:: cealarmdescrentry
        	...
        	**type**\: list of :py:class:`CeAlarmDescrEntry <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmDescrTable.CeAlarmDescrEntry>`
        ...
        class CeAlarmDescrEntry(object):
            ...
            .. attribute:: cealarmdescralarmtype
            ...
            def _common_path(self):
                if self.cealarmdescralarmtype is None:
                    raise YPYDataValidationError('Key property cealarmdescralarmtype is None')
                if self.cealarmdescrindex is None:
                    raise YPYDataValidationError('Key property cealarmdescrindex is None')

                return '/CISCO-ENTITY-ALARM-MIB:CISCO-ENTITY-ALARM-MIB/CISCO-ENTITY-ALARM-MIB:ceAlarmDescrTable/CISCO-ENTITY-ALARM-MIB:ceAlarmDescrEntry[CISCO-ENTITY-ALARM-MIB:ceAlarmDescrAlarmType = ' + str(self.cealarmdescralarmtype) + '][CISCO-ENTITY-ALARM-MIB:ceAlarmDescrIndex = ' + str(self.cealarmdescrindex) + ']'
    ...
    class CeAlarmFilterProfileTable(object):
        ...
        .. attribute:: cealarmfilterprofileentry
        	...
        	**type**\: list of :py:class:`CeAlarmFilterProfileEntry <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmFilterProfileTable.CeAlarmFilterProfileEntry>`
        ...
        class CeAlarmFilterProfileEntry(object):
            ...
            def _common_path(self):
                if self.cealarmfilterindex is None:
                    raise YPYDataValidationError('Key property cealarmfilterindex is None')
    ...
    class CeAlarmHistTable(object):
        ...
        .. attribute:: cealarmhistentry
        	...
        	**type**\: list of :py:class:`CeAlarmHistEntry <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmHistTable.CeAlarmHistEntry>`
        ...
        class CeAlarmHistEntry(object):
            ...
            .. attribute:: cealarmhistseverity
            	...
            	**type**\: :py:class:`AlarmSeverity_Enum <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.AlarmSeverity_Enum>`
            ...
            .. attribute:: cealarmhisttype
            	...
            	**type**\: :py:class:`CeAlarmHistType_Enum <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmHistTable.CeAlarmHistEntry.CeAlarmHistType_Enum>`
            ...
            class CeAlarmHistType_Enum(Enum):
                """
                CeAlarmHistType_Enum
                ...
                def _meta_info():
                    from ydk.models.entity._meta import _CISCO_ENTITY_ALARM_MIB as meta
                    return meta._meta_table['CISCOENTITYALARMMIB.CeAlarmHistTable.CeAlarmHistEntry.CeAlarmHistType_Enum']


            @property
            def _common_path(self):
                if self.cealarmhistindex is None:
                    raise YPYDataValidationError('Key property cealarmhistindex is None')
    ...
    class CeAlarmTable(object):
        ...
        .. attribute:: cealarmentry
        	...
        	**type**\: list of :py:class:`CeAlarmEntry <ydk.models.entity.CISCO_ENTITY_ALARM_MIB.CISCOENTITYALARMMIB.CeAlarmTable.CeAlarmEntry>`
    ...
    def _has_data(self):
        ...
        if self.cealarmdescrmaptable is not None and self.cealarmdescrmaptable.is_presence():
            return True

        if self.cealarmdescrtable is not None and self.cealarmdescrtable._has_data():
            return True

        if self.cealarmdescrtable is not None and self.cealarmdescrtable.is_presence():
            return True

        if self.cealarmfiltering is not None and self.cealarmfiltering._has_data():
            return True

        if self.cealarmfiltering is not None and self.cealarmfiltering.is_presence():
            return True

        if self.cealarmfilterprofiletable is not None and self.cealarmfilterprofiletable._has_data():
            return True

        if self.cealarmfilterprofiletable is not None and self.cealarmfilterprofiletable.is_presence():
            return True

        if self.cealarmhistory is not None and self.cealarmhistory._has_data():
            return True

        if self.cealarmhistory is not None and self.cealarmhistory.is_presence():
            return True

        if self.cealarmhisttable is not None and self.cealarmhisttable._has_data():
            return True

        if self.cealarmhisttable is not None and self.cealarmhisttable.is_presence():
            return True

        if self.cealarmmonitoring is not None and self.cealarmmonitoring._has_data():
            return True

        if self.cealarmmonitoring is not None and self.cealarmmonitoring.is_presence():
            return True

        if self.cealarmtable is not None and self.cealarmtable._has_data():
            return True

        if self.cealarmtable is not None and self.cealarmtable.is_presence():
            return True
