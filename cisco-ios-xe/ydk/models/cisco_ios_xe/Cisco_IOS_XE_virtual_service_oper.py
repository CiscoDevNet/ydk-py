...
class VirtualServices(Entity):
    ...
    class VirtualService(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"attached-devices" : ("attached_devices", VirtualServices.VirtualService.AttachedDevices), "details" : ("details", VirtualServices.VirtualService.Details), "guest-routes" : ("guest_routes", VirtualServices.VirtualService.GuestRoutes), "network-interfaces" : ("network_interfaces", VirtualServices.VirtualService.NetworkInterfaces), "network-utils" : ("network_utils", VirtualServices.VirtualService.NetworkUtils), "storage-utils" : ("storage_utils", VirtualServices.VirtualService.StorageUtils), "utilization" : ("utilization", VirtualServices.VirtualService.Utilization)}
        ...
        class AttachedDevices(Entity):
            ...
            class AttachedDevice(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(VirtualServices.VirtualService.AttachedDevices.AttachedDevice, ['name', 'alias', 'type'], name, value)
        ...
        class Details(Entity):
            ...
            def __init__(self):
                ...
                self.is_top_level_class = False
                self.has_list_ancestor = True
                self._child_container_classes = {"detailed-guest-status" : ("detailed_guest_status", VirtualServices.VirtualService.Details.DetailedGuestStatus), "package-information" : ("package_information", VirtualServices.VirtualService.Details.PackageInformation), "resource-admission" : ("resource_admission", VirtualServices.VirtualService.Details.ResourceAdmission), "resource-reservation" : ("resource_reservation", VirtualServices.VirtualService.Details.ResourceReservation)}
                self._child_list_classes = {}
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(VirtualServices.VirtualService.Details, ['activated_profile_name', 'guest_interface', 'state'], name, value)
            ...
            class DetailedGuestStatus(Entity):
                ...
                class Processes(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(VirtualServices.VirtualService.Details.DetailedGuestStatus.Processes, ['memory', 'name', 'pid', 'status', 'uptime'], name, value)
            ...
            class PackageInformation(Entity):
                ...
                def __init__(self):
                    ...
                    self.is_top_level_class = False
                    self.has_list_ancestor = True
                    self._child_container_classes = {"application" : ("application", VirtualServices.VirtualService.Details.PackageInformation.Application), "licensing" : ("licensing", VirtualServices.VirtualService.Details.PackageInformation.Licensing), "signing" : ("signing", VirtualServices.VirtualService.Details.PackageInformation.Signing)}
                    self._child_list_classes = {}
                ...
                class Application(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(VirtualServices.VirtualService.Details.PackageInformation.Application, ['description', 'installed_version', 'name'], name, value)
            ...
            class ResourceAdmission(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(VirtualServices.VirtualService.Details.ResourceAdmission, ['cpu', 'disk_space', 'memory', 'state', 'vcpus'], name, value)
            ...
            class ResourceReservation(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(VirtualServices.VirtualService.Details.ResourceReservation, ['cpu', 'disk', 'memory'], name, value)
        ...
        class NetworkUtils(Entity):
            ...
            class NetworkUtil(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(VirtualServices.VirtualService.NetworkUtils.NetworkUtil, ['name', 'alias', 'rx_bytes', 'rx_errors', 'rx_packets', 'tx_bytes', 'tx_errors', 'tx_packets'], name, value)
        ...
        class StorageUtils(Entity):
            ...
            class StorageUtil(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(VirtualServices.VirtualService.StorageUtils.StorageUtil, ['name', 'alias', 'available', 'capacity', 'errors', 'rd_bytes', 'rd_requests', 'usage', 'used', 'wr_bytes', 'wr_requests'], name, value)
        ...
        class Utilization(Entity):
            ...
            class CpuUtil(Entity):
                ...
                def __setattr__(self, name, value):
                    self._perform_setattr(VirtualServices.VirtualService.Utilization.CpuUtil, ['actual_application_util', 'cpu_state', 'requested_application_util'], name, value)
