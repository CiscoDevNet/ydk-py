...
_meta_table = {
    'Ipv6Telnet.Client' : {
        ...
        'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg'
        ),
    },
    'Ipv6Telnet' : {
        'meta_info' : _MetaInfoClass('Ipv6Telnet',
            False, 
            [
            _MetaInfoClassMember('client', REFERENCE_CLASS, 'Client' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg', 'Ipv6Telnet.Client', 
                [], [], 
    ...
    'Ipv4Telnet' : {
        'meta_info' : _MetaInfoClass('Ipv4Telnet',
            False, 
            [
            _MetaInfoClassMember('client', REFERENCE_CLASS, 'Client' , 'ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg', 'Ipv4Telnet.Client', 
                [], [], 
                '''                Telnet client configuration
                ''',
                'client',
