...
_meta_table = {
    'BRIDGEMIB.Dot1dBase.Dot1dBaseType_Enum' : _MetaInfoEnum('Dot1dBaseType_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'unknown':'UNKNOWN',
    ...
    'BRIDGEMIB.Dot1dBase' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dBase',
            ...
            _MetaInfoClassMember('dot1dBaseNumPorts', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot1dbasenumports',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dBaseType', REFERENCE_ENUM_CLASS, 'Dot1dBaseType_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dBase.Dot1dBaseType_Enum', 
                [], [], 
        ...
        'ydk.models.bridge.BRIDGE_MIB'
        ),
    },
    'BRIDGEMIB.Dot1dBasePortTable.Dot1dBasePortEntry.Dot1qPortAcceptableFrameTypes_Enum' : _MetaInfoEnum('Dot1qPortAcceptableFrameTypes_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'admitAll':'ADMITALL',
            'admitOnlyVlanTagged':'ADMITONLYVLANTAGGED',
    ...
    'BRIDGEMIB.Dot1dBasePortTable.Dot1dBasePortEntry' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dBasePortTable.Dot1dBasePortEntry',
            ...
            _MetaInfoClassMember('dot1dBasePortMtuExceededDiscards', ATTRIBUTE, 'int' , None, None, 
                ...
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dPortCapabilities', REFERENCE_BITS, 'Dot1dPortCapabilities_Bits' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dBasePortTable.Dot1dBasePortEntry.Dot1dPortCapabilities_Bits', 
                [], [], 
            ...
            _MetaInfoClassMember('dot1dPortGmrpLastPduOrigin', ATTRIBUTE, 'str' , None, None, 
                ...
                'P-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dPortGmrpStatus', REFERENCE_ENUM_CLASS, 'EnabledStatus_Enum' , 'ydk.models.p.P_BRIDGE_MIB', 'EnabledStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dot1dPortRestrictedGroupRegistration', ATTRIBUTE, 'bool' , None, None, 
                ...
                'P-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPortAcceptableFrameTypes', REFERENCE_ENUM_CLASS, 'Dot1qPortAcceptableFrameTypes_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dBasePortTable.Dot1dBasePortEntry.Dot1qPortAcceptableFrameTypes_Enum', 
                [], [], 
                ...
                'dot1qportacceptableframetypes',
                'Q-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPortGvrpFailedRegistrations', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
                ...
                'Q-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPortGvrpLastPduOrigin', ATTRIBUTE, 'str' , None, None, 
                [], ['[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}'], 
                ...
                'Q-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPortGvrpStatus', REFERENCE_ENUM_CLASS, 'EnabledStatus_Enum' , 'ydk.models.p.P_BRIDGE_MIB', 'EnabledStatus_Enum', 
                [], [], 
                ...
                'dot1qportgvrpstatus',
                'Q-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPortIngressFiltering', ATTRIBUTE, 'bool' , None, None, 
                [], [], 
                ...
                'Q-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPortRestrictedVlanRegistration', ATTRIBUTE, 'bool' , None, None, 
                [], [], 
                ...
                'Q-BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1qPvid', ATTRIBUTE, 'int' , None, None, 
                [(0, 4294967295)], [], 
    ...
    'BRIDGEMIB.Dot1dBasePortTable' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dBasePortTable',
            False, 
            [
            _MetaInfoClassMember('dot1dBasePortEntry', REFERENCE_LIST, 'Dot1dBasePortEntry' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dBasePortTable.Dot1dBasePortEntry', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dStaticTable.Dot1dStaticEntry.Dot1dStaticStatus_Enum' : _MetaInfoEnum('Dot1dStaticStatus_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'other':'OTHER',
            'invalid':'INVALID',
            'permanent':'PERMANENT',
    ...
    'BRIDGEMIB.Dot1dStaticTable.Dot1dStaticEntry' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dStaticTable.Dot1dStaticEntry',
            ...
            _MetaInfoClassMember('dot1dStaticAllowedToGoTo', ATTRIBUTE, 'str' , None, None, 
                ...
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStaticStatus', REFERENCE_ENUM_CLASS, 'Dot1dStaticStatus_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStaticTable.Dot1dStaticEntry.Dot1dStaticStatus_Enum', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dStaticTable' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dStaticTable',
            False, 
            [
            _MetaInfoClassMember('dot1dStaticEntry', REFERENCE_LIST, 'Dot1dStaticEntry' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStaticTable.Dot1dStaticEntry', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dStp.Dot1dStpProtocolSpecification_Enum' : _MetaInfoEnum('Dot1dStpProtocolSpecification_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'unknown':'UNKNOWN',
            'decLb100':'DECLB100',
            'ieee8021d':'IEEE8021D',
    ...
    'BRIDGEMIB.Dot1dStp' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dStp',
            ...
            _MetaInfoClassMember('dot1dStpPriority', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot1dstppriority',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStpProtocolSpecification', REFERENCE_ENUM_CLASS, 'Dot1dStpProtocolSpecification_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStp.Dot1dStpProtocolSpecification_Enum', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry.Dot1dStpPortEnable_Enum' : _MetaInfoEnum('Dot1dStpPortEnable_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'enabled':'ENABLED',
            'disabled':'DISABLED',
        }, 'BRIDGE-MIB', _yang_ns._namespaces['BRIDGE-MIB']),
    'BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry.Dot1dStpPortState_Enum' : _MetaInfoEnum('Dot1dStpPortState_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'disabled':'DISABLED',
            'blocking':'BLOCKING',
            'listening':'LISTENING',
    ...
    'BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry',
            ...
            _MetaInfoClassMember('dot1dStpPortDesignatedRoot', ATTRIBUTE, 'str' , None, None, 
                ...
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStpPortEnable', REFERENCE_ENUM_CLASS, 'Dot1dStpPortEnable_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry.Dot1dStpPortEnable_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('dot1dStpPortPriority', ATTRIBUTE, 'int' , None, None, 
                ...
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStpPortState', REFERENCE_ENUM_CLASS, 'Dot1dStpPortState_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry.Dot1dStpPortState_Enum', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dStpPortTable' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dStpPortTable',
            False, 
            [
            _MetaInfoClassMember('dot1dStpPortEntry', REFERENCE_LIST, 'Dot1dStpPortEntry' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStpPortTable.Dot1dStpPortEntry', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dTpFdbTable.Dot1dTpFdbEntry.Dot1dTpFdbStatus_Enum' : _MetaInfoEnum('Dot1dTpFdbStatus_Enum', 'ydk.models.bridge.BRIDGE_MIB',
        {
            'other':'OTHER',
            'invalid':'INVALID',
            'learned':'LEARNED',
    ...
    'BRIDGEMIB.Dot1dTpFdbTable.Dot1dTpFdbEntry' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dTpFdbTable.Dot1dTpFdbEntry',
            ...
            _MetaInfoClassMember('dot1dTpFdbPort', ATTRIBUTE, 'int' , None, None, 
                ...
                'dot1dtpfdbport',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dTpFdbStatus', REFERENCE_ENUM_CLASS, 'Dot1dTpFdbStatus_Enum' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dTpFdbTable.Dot1dTpFdbEntry.Dot1dTpFdbStatus_Enum', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dTpFdbTable' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dTpFdbTable',
            False, 
            [
            _MetaInfoClassMember('dot1dTpFdbEntry', REFERENCE_LIST, 'Dot1dTpFdbEntry' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dTpFdbTable.Dot1dTpFdbEntry', 
                [], [], 
    ...
    'BRIDGEMIB.Dot1dTpPortTable' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB.Dot1dTpPortTable',
            False, 
            [
            _MetaInfoClassMember('dot1dTpPortEntry', REFERENCE_LIST, 'Dot1dTpPortEntry' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dTpPortTable.Dot1dTpPortEntry', 
                [], [], 
    ...
    'BRIDGEMIB' : {
        'meta_info' : _MetaInfoClass('BRIDGEMIB',
            False, 
            [
            _MetaInfoClassMember('dot1dBase', REFERENCE_CLASS, 'Dot1dBase' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dBase', 
                [], [], 
                '''                ''',
                'dot1dbase',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dBasePortTable', REFERENCE_CLASS, 'Dot1dBasePortTable' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dBasePortTable', 
                [], [], 
                ...
                'dot1dbaseporttable',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStaticTable', REFERENCE_CLASS, 'Dot1dStaticTable' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStaticTable', 
                [], [], 
                ...
                'dot1dstatictable',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStp', REFERENCE_CLASS, 'Dot1dStp' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStp', 
                [], [], 
                '''                ''',
                'dot1dstp',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dStpPortTable', REFERENCE_CLASS, 'Dot1dStpPortTable' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dStpPortTable', 
                [], [], 
                ...
                'dot1dstpporttable',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dTp', REFERENCE_CLASS, 'Dot1dTp' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dTp', 
                [], [], 
                '''                ''',
                'dot1dtp',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dTpFdbTable', REFERENCE_CLASS, 'Dot1dTpFdbTable' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dTpFdbTable', 
                [], [], 
                ...
                'dot1dtpfdbtable',
                'BRIDGE-MIB', False),
            _MetaInfoClassMember('dot1dTpPortTable', REFERENCE_CLASS, 'Dot1dTpPortTable' , 'ydk.models.bridge.BRIDGE_MIB', 'BRIDGEMIB.Dot1dTpPortTable', 
                [], [], 
