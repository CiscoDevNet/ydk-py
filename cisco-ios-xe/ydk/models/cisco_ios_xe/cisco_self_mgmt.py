...
class NetconfYang(Entity):
    ...
    class CiscoIa(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {"blocking" : ("blocking", NetconfYang.CiscoIa.Blocking), "logging" : ("logging", NetconfYang.CiscoIa.Logging), "snmp-trap-control" : ("snmp_trap_control", NetconfYang.CiscoIa.SnmpTrapControl)}
            self._child_list_classes = {"conf-full-sync-cli" : ("conf_full_sync_cli", NetconfYang.CiscoIa.ConfFullSyncCli), "conf-parser-msg-ignore" : ("conf_parser_msg_ignore", NetconfYang.CiscoIa.ConfParserMsgIgnore), "full-sync-cli" : ("full_sync_cli", NetconfYang.CiscoIa.FullSyncCli), "parser-msg-ignore" : ("parser_msg_ignore", NetconfYang.CiscoIa.ParserMsgIgnore), "preserve-ned-path" : ("preserve_ned_path", NetconfYang.CiscoIa.PreserveNedPath)}
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(NetconfYang.CiscoIa, ['auto_sync', 'config_change_delay', 'init_sync', 'intelligent_sync', 'max_diag_messages_saved', 'message_diag_level', 'nes_ttynum', 'post_sync_acl_process', 'preserve_paths_enabled', 'process_missing_prc', 'restored', 'snmp_community_string'], name, value)
        ...
        class Blocking(Entity):
            ...
            def __init__(self):
                ...
                self._child_list_classes = {"confd-cfg-command" : ("confd_cfg_command", NetconfYang.CiscoIa.Blocking.ConfdCfgCommand), "network-element-command" : ("network_element_command", NetconfYang.CiscoIa.Blocking.NetworkElementCommand)}
        ...
        class Logging(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(NetconfYang.CiscoIa.Logging, ['ciaauthd_log_level', 'confd_log_level', 'nes_log_level', 'odm_log_level', 'onep_log_level', 'sync_log_level'], name, value)
    ...
    class CiscoOdm(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(NetconfYang.CiscoOdm, ['on_demand_default_time', 'on_demand_enable', 'polling_enable'], name, value)
        ...
        class Actions(Entity):
            ...
            def __setattr__(self, name, value):
                self._perform_setattr(NetconfYang.CiscoOdm.Actions, ['action_name', 'cdb_xpath', 'mode', 'polling_interval'], name, value)
