...
from ydk.models.ietf.ietf_inet_types import IpVersion_Enum
...
class IpAddressOriginTC_Enum(Enum):
    """
    IpAddressOriginTC_Enum
    ...
    @staticmethod
    def _meta_info():
        from ydk.models.ip._meta import _IP_MIB as meta
        return meta._meta_table['IpAddressOriginTC_Enum']


class IpAddressPrefixOriginTC_Enum(Enum):
    """
    IpAddressPrefixOriginTC_Enum
    ...
    def _meta_info():
        from ydk.models.ip._meta import _IP_MIB as meta
        return meta._meta_table['IpAddressPrefixOriginTC_Enum']


class IpAddressStatusTC_Enum(Enum):
    """
    IpAddressStatusTC_Enum
    ...
    def _meta_info():
        from ydk.models.ip._meta import _IP_MIB as meta
        return meta._meta_table['IpAddressStatusTC_Enum']
...
class IPMIB(object):
    ...
    .. attribute:: icmp
    	...
    	**type**\: :py:class:`Icmp <ydk.models.ip.IP_MIB.IPMIB.Icmp>`
    
    .. attribute:: icmpmsgstatstable
    
    	The table of system\-wide per\-version, per\-message type ICMP counters
    	**type**\: :py:class:`IcmpMsgStatsTable <ydk.models.ip.IP_MIB.IPMIB.IcmpMsgStatsTable>`
    
    .. attribute:: icmpstatstable
    
    	The table of generic system\-wide ICMP counters
    	**type**\: :py:class:`IcmpStatsTable <ydk.models.ip.IP_MIB.IPMIB.IcmpStatsTable>`
    
    .. attribute:: ip
    
    	
    	**type**\: :py:class:`Ip <ydk.models.ip.IP_MIB.IPMIB.Ip>`
    ...
    .. attribute:: ipaddressprefixtable
    	...
    	**type**\: :py:class:`IpAddressPrefixTable <ydk.models.ip.IP_MIB.IPMIB.IpAddressPrefixTable>`
    ...
    .. attribute:: ipaddresstable
    	...
    	**type**\: :py:class:`IpAddressTable <ydk.models.ip.IP_MIB.IPMIB.IpAddressTable>`
    ...
    .. attribute:: ipaddrtable
    	...
    	**type**\: :py:class:`IpAddrTable <ydk.models.ip.IP_MIB.IPMIB.IpAddrTable>`
    
    .. attribute:: ipdefaultroutertable
    
    	The table used to describe the default routers known to this   entity
    	**type**\: :py:class:`IpDefaultRouterTable <ydk.models.ip.IP_MIB.IPMIB.IpDefaultRouterTable>`
    ...
    .. attribute:: ipifstatstable
    	...
    	**type**\: :py:class:`IpIfStatsTable <ydk.models.ip.IP_MIB.IPMIB.IpIfStatsTable>`
    ...
    .. attribute:: ipnettomediatable
    	...
    	**type**\: :py:class:`IpNetToMediaTable <ydk.models.ip.IP_MIB.IPMIB.IpNetToMediaTable>`
    ...
    .. attribute:: ipnettophysicaltable
    	...
    	**type**\: :py:class:`IpNetToPhysicalTable <ydk.models.ip.IP_MIB.IPMIB.IpNetToPhysicalTable>`
    ...
    .. attribute:: ipsystemstatstable
    	...
    	**type**\: :py:class:`IpSystemStatsTable <ydk.models.ip.IP_MIB.IPMIB.IpSystemStatsTable>`
    
    .. attribute:: iptrafficstats
    
    	
    	**type**\: :py:class:`IpTrafficStats <ydk.models.ip.IP_MIB.IPMIB.IpTrafficStats>`
    
    .. attribute:: ipv4interfacetable
    
    	The table containing per\-interface IPv4\-specific information
    	**type**\: :py:class:`Ipv4InterfaceTable <ydk.models.ip.IP_MIB.IPMIB.Ipv4InterfaceTable>`
    
    .. attribute:: ipv6interfacetable
    
    	The table containing per\-interface IPv6\-specific information
    	**type**\: :py:class:`Ipv6InterfaceTable <ydk.models.ip.IP_MIB.IPMIB.Ipv6InterfaceTable>`
    
    .. attribute:: ipv6routeradverttable
    
    	The table containing information used to construct router advertisements
    	**type**\: :py:class:`Ipv6RouterAdvertTable <ydk.models.ip.IP_MIB.IPMIB.Ipv6RouterAdvertTable>`
    ...
    .. attribute:: ipv6scopezoneindextable
    	...
    	**type**\: :py:class:`Ipv6ScopeZoneIndexTable <ydk.models.ip.IP_MIB.IPMIB.Ipv6ScopeZoneIndexTable>`
    ...
    class IcmpMsgStatsTable(object):
        ...
        .. attribute:: icmpmsgstatsentry
        	...
        	**type**\: list of :py:class:`IcmpMsgStatsEntry <ydk.models.ip.IP_MIB.IPMIB.IcmpMsgStatsTable.IcmpMsgStatsEntry>`
        ...
        class IcmpMsgStatsEntry(object):
            ...
            .. attribute:: icmpmsgstatsipversion
            
            	The IP version of the statistics
            	**type**\: :py:class:`IpVersion_Enum <ydk.models.ietf.ietf_inet_types.IpVersion_Enum>`
            
            .. attribute:: icmpmsgstatstype
            ...
            def _common_path(self):
                if self.icmpmsgstatsipversion is None:
                    raise YPYDataValidationError('Key property icmpmsgstatsipversion is None')
                if self.icmpmsgstatstype is None:
                    raise YPYDataValidationError('Key property icmpmsgstatstype is None')
    ...
    class IcmpStatsTable(object):
        ...
        .. attribute:: icmpstatsentry
        	...
        	**type**\: list of :py:class:`IcmpStatsEntry <ydk.models.ip.IP_MIB.IPMIB.IcmpStatsTable.IcmpStatsEntry>`
        ...
        class IcmpStatsEntry(object):
            ...
            def _common_path(self):
                if self.icmpstatsipversion is None:
                    raise YPYDataValidationError('Key property icmpstatsipversion is None')
    ...
    class Ip(object):
        ...
        .. attribute:: ipforwarding
        	...
        	**type**\: :py:class:`IpForwarding_Enum <ydk.models.ip.IP_MIB.IPMIB.Ip.IpForwarding_Enum>`
        ...
        .. attribute:: ipv6ipforwarding
        	...
        	**type**\: :py:class:`Ipv6IpForwarding_Enum <ydk.models.ip.IP_MIB.IPMIB.Ip.Ipv6IpForwarding_Enum>`
        ...
        class IpForwarding_Enum(Enum):
            ...
            def _meta_info():
                from ydk.models.ip._meta import _IP_MIB as meta
                return meta._meta_table['IPMIB.Ip.IpForwarding_Enum']


        class Ipv6IpForwarding_Enum(Enum):
            """
            Ipv6IpForwarding_Enum
            ...
            def _meta_info():
                from ydk.models.ip._meta import _IP_MIB as meta
                return meta._meta_table['IPMIB.Ip.Ipv6IpForwarding_Enum']
    ...
    class IpAddrTable(object):
        ...
        .. attribute:: ipaddrentry
        	...
        	**type**\: list of :py:class:`IpAddrEntry <ydk.models.ip.IP_MIB.IPMIB.IpAddrTable.IpAddrEntry>`
    ...
    class IpAddressPrefixTable(object):
        ...
        .. attribute:: ipaddressprefixentry
        	...
        	**type**\: list of :py:class:`IpAddressPrefixEntry <ydk.models.ip.IP_MIB.IPMIB.IpAddressPrefixTable.IpAddressPrefixEntry>`
        ...
        class IpAddressPrefixEntry(object):
            ...
            .. attribute:: ipaddressprefixifindex
            ...
            .. attribute:: ipaddressprefixlength
            ...
            .. attribute:: ipaddressprefixprefix
            ...
            .. attribute:: ipaddressprefixorigin
            	...
            	The origin of this prefix
            	**type**\: :py:class:`IpAddressPrefixOriginTC_Enum <ydk.models.ip.IP_MIB.IpAddressPrefixOriginTC_Enum>`
            ...
            def _common_path(self):
                if self.ipaddressprefixifindex is None:
                    raise YPYDataValidationError('Key property ipaddressprefixifindex is None')
                if self.ipaddressprefixlength is None:
                    raise YPYDataValidationError('Key property ipaddressprefixlength is None')
                if self.ipaddressprefixprefix is None:
                    raise YPYDataValidationError('Key property ipaddressprefixprefix is None')
                if self.ipaddressprefixtype is None:
                    raise YPYDataValidationError('Key property ipaddressprefixtype is None')

                return '/IP-MIB:IP-MIB/IP-MIB:ipAddressPrefixTable/IP-MIB:ipAddressPrefixEntry[IP-MIB:ipAddressPrefixIfIndex = ' + str(self.ipaddressprefixifindex) + '][IP-MIB:ipAddressPrefixLength = ' + str(self.ipaddressprefixlength) + '][IP-MIB:ipAddressPrefixPrefix = ' + str(self.ipaddressprefixprefix) + '][IP-MIB:ipAddressPrefixType = ' + str(self.ipaddressprefixtype) + ']'
    ...
    class IpAddressTable(object):
        ...
        .. attribute:: ipaddressentry
        	...
        	**type**\: list of :py:class:`IpAddressEntry <ydk.models.ip.IP_MIB.IPMIB.IpAddressTable.IpAddressEntry>`
        ...
        class IpAddressEntry(object):
            ...
            .. attribute:: ipaddressorigin
            	...
            	The origin of the address
            	**type**\: :py:class:`IpAddressOriginTC_Enum <ydk.models.ip.IP_MIB.IpAddressOriginTC_Enum>`
            ...
            .. attribute:: ipaddressstatus
            	...
            	**type**\: :py:class:`IpAddressStatusTC_Enum <ydk.models.ip.IP_MIB.IpAddressStatusTC_Enum>`
            ...
            .. attribute:: ipaddresstype
            	...
            	**type**\: :py:class:`IpAddressType_Enum <ydk.models.ip.IP_MIB.IPMIB.IpAddressTable.IpAddressEntry.IpAddressType_Enum>`
            ...
            class IpAddressType_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.IpAddressTable.IpAddressEntry.IpAddressType_Enum']


            @property
            def _common_path(self):
                if self.ipaddressaddr is None:
                    raise YPYDataValidationError('Key property ipaddressaddr is None')
                if self.ipaddressaddrtype is None:
                    raise YPYDataValidationError('Key property ipaddressaddrtype is None')

                return '/IP-MIB:IP-MIB/IP-MIB:ipAddressTable/IP-MIB:ipAddressEntry[IP-MIB:ipAddressAddr = ' + str(self.ipaddressaddr) + '][IP-MIB:ipAddressAddrType = ' + str(self.ipaddressaddrtype) + ']'
    ...
    class IpDefaultRouterTable(object):
        ...
        .. attribute:: ipdefaultrouterentry
        	...
        	**type**\: list of :py:class:`IpDefaultRouterEntry <ydk.models.ip.IP_MIB.IPMIB.IpDefaultRouterTable.IpDefaultRouterEntry>`
        ...
        class IpDefaultRouterEntry(object):
            ...
            .. attribute:: ipdefaultrouteraddress
            ...
            .. attribute:: ipdefaultrouteraddresstype
            
            	The address type for this row
            	**type**\: :py:class:`InetAddressType_Enum <ydk.models.inet.INET_ADDRESS_MIB.InetAddressType_Enum>`
            
            .. attribute:: ipdefaultrouterifindex
            ...
            .. attribute:: ipdefaultrouterpreference
            	...
            	**type**\: :py:class:`IpDefaultRouterPreference_Enum <ydk.models.ip.IP_MIB.IPMIB.IpDefaultRouterTable.IpDefaultRouterEntry.IpDefaultRouterPreference_Enum>`
            ...
            class IpDefaultRouterPreference_Enum(Enum):
                """
                IpDefaultRouterPreference_Enum
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.IpDefaultRouterTable.IpDefaultRouterEntry.IpDefaultRouterPreference_Enum']


            @property
            def _common_path(self):
                if self.ipdefaultrouteraddress is None:
                    raise YPYDataValidationError('Key property ipdefaultrouteraddress is None')
                if self.ipdefaultrouteraddresstype is None:
                    raise YPYDataValidationError('Key property ipdefaultrouteraddresstype is None')
                if self.ipdefaultrouterifindex is None:
                    raise YPYDataValidationError('Key property ipdefaultrouterifindex is None')

                return '/IP-MIB:IP-MIB/IP-MIB:ipDefaultRouterTable/IP-MIB:ipDefaultRouterEntry[IP-MIB:ipDefaultRouterAddress = ' + str(self.ipdefaultrouteraddress) + '][IP-MIB:ipDefaultRouterAddressType = ' + str(self.ipdefaultrouteraddresstype) + '][IP-MIB:ipDefaultRouterIfIndex = ' + str(self.ipdefaultrouterifindex) + ']'
    ...
    class IpIfStatsTable(object):
        ...
        .. attribute:: ipifstatsentry
        	...
        	**type**\: list of :py:class:`IpIfStatsEntry <ydk.models.ip.IP_MIB.IPMIB.IpIfStatsTable.IpIfStatsEntry>`
        ...
        class IpIfStatsEntry(object):
            ...
            def _common_path(self):
                if self.ipifstatsifindex is None:
                    raise YPYDataValidationError('Key property ipifstatsifindex is None')
                if self.ipifstatsipversion is None:
                    raise YPYDataValidationError('Key property ipifstatsipversion is None')

                return '/IP-MIB:IP-MIB/IP-MIB:ipIfStatsTable/IP-MIB:ipIfStatsEntry[IP-MIB:ipIfStatsIfIndex = ' + str(self.ipifstatsifindex) + '][IP-MIB:ipIfStatsIPVersion = ' + str(self.ipifstatsipversion) + ']'
    ...
    class IpNetToMediaTable(object):
        ...
        .. attribute:: ipnettomediaentry
        	...
        	**type**\: list of :py:class:`IpNetToMediaEntry <ydk.models.ip.IP_MIB.IPMIB.IpNetToMediaTable.IpNetToMediaEntry>`
        ...
        class IpNetToMediaEntry(object):
            ...
            .. attribute:: ipnettomediatype
            	...
            	**type**\: :py:class:`IpNetToMediaType_Enum <ydk.models.ip.IP_MIB.IPMIB.IpNetToMediaTable.IpNetToMediaEntry.IpNetToMediaType_Enum>`
            ...
            class IpNetToMediaType_Enum(Enum):
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.IpNetToMediaTable.IpNetToMediaEntry.IpNetToMediaType_Enum']
    ...
    class IpNetToPhysicalTable(object):
        ...
        .. attribute:: ipnettophysicalentry
        	...
        	**type**\: list of :py:class:`IpNetToPhysicalEntry <ydk.models.ip.IP_MIB.IPMIB.IpNetToPhysicalTable.IpNetToPhysicalEntry>`
        ...
        class IpNetToPhysicalEntry(object):
            ...
            .. attribute:: ipnettophysicalifindex
            ...
            .. attribute:: ipnettophysicalnetaddress
            ...
            .. attribute:: ipnettophysicalnetaddresstype
            ...
            .. attribute:: ipnettophysicalstate
            	...
            	**type**\: :py:class:`IpNetToPhysicalState_Enum <ydk.models.ip.IP_MIB.IPMIB.IpNetToPhysicalTable.IpNetToPhysicalEntry.IpNetToPhysicalState_Enum>`
            ...
            .. attribute:: ipnettophysicaltype
            	...
            	**type**\: :py:class:`IpNetToPhysicalType_Enum <ydk.models.ip.IP_MIB.IPMIB.IpNetToPhysicalTable.IpNetToPhysicalEntry.IpNetToPhysicalType_Enum>`
            ...
            class IpNetToPhysicalState_Enum(Enum):
                """
                IpNetToPhysicalState_Enum
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.IpNetToPhysicalTable.IpNetToPhysicalEntry.IpNetToPhysicalState_Enum']


            class IpNetToPhysicalType_Enum(Enum):
                """
                IpNetToPhysicalType_Enum
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.IpNetToPhysicalTable.IpNetToPhysicalEntry.IpNetToPhysicalType_Enum']


            @property
            def _common_path(self):
                if self.ipnettophysicalifindex is None:
                    raise YPYDataValidationError('Key property ipnettophysicalifindex is None')
                if self.ipnettophysicalnetaddress is None:
                    raise YPYDataValidationError('Key property ipnettophysicalnetaddress is None')
                if self.ipnettophysicalnetaddresstype is None:
                    raise YPYDataValidationError('Key property ipnettophysicalnetaddresstype is None')

                return '/IP-MIB:IP-MIB/IP-MIB:ipNetToPhysicalTable/IP-MIB:ipNetToPhysicalEntry[IP-MIB:ipNetToPhysicalIfIndex = ' + str(self.ipnettophysicalifindex) + '][IP-MIB:ipNetToPhysicalNetAddress = ' + str(self.ipnettophysicalnetaddress) + '][IP-MIB:ipNetToPhysicalNetAddressType = ' + str(self.ipnettophysicalnetaddresstype) + ']'
    ...
    class IpSystemStatsTable(object):
        ...
        .. attribute:: ipsystemstatsentry
        	...
        	**type**\: list of :py:class:`IpSystemStatsEntry <ydk.models.ip.IP_MIB.IPMIB.IpSystemStatsTable.IpSystemStatsEntry>`
        ...
        class IpSystemStatsEntry(object):
            ...
            .. attribute:: ipsystemstatsipversion
            ...
            def _common_path(self):
                if self.ipsystemstatsipversion is None:
                    raise YPYDataValidationError('Key property ipsystemstatsipversion is None')
    ...
    class Ipv4InterfaceTable(object):
        ...
        .. attribute:: ipv4interfaceentry
        	...
        	**type**\: list of :py:class:`Ipv4InterfaceEntry <ydk.models.ip.IP_MIB.IPMIB.Ipv4InterfaceTable.Ipv4InterfaceEntry>`
        ...
        class Ipv4InterfaceEntry(object):
            ...
            .. attribute:: ipv4interfaceifindex
            ...
            .. attribute:: ipv4interfaceenablestatus
            	...
            	**type**\: :py:class:`Ipv4InterfaceEnableStatus_Enum <ydk.models.ip.IP_MIB.IPMIB.Ipv4InterfaceTable.Ipv4InterfaceEntry.Ipv4InterfaceEnableStatus_Enum>`
            ...
            class Ipv4InterfaceEnableStatus_Enum(Enum):
                """
                Ipv4InterfaceEnableStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.Ipv4InterfaceTable.Ipv4InterfaceEntry.Ipv4InterfaceEnableStatus_Enum']


            @property
            def _common_path(self):
                if self.ipv4interfaceifindex is None:
                    raise YPYDataValidationError('Key property ipv4interfaceifindex is None')
    ...
    class Ipv6InterfaceTable(object):
        ...
        .. attribute:: ipv6interfaceentry
        	...
        	**type**\: list of :py:class:`Ipv6InterfaceEntry <ydk.models.ip.IP_MIB.IPMIB.Ipv6InterfaceTable.Ipv6InterfaceEntry>`
        ...
        class Ipv6InterfaceEntry(object):
            ...
            .. attribute:: ipv6interfaceifindex
            ...
            .. attribute:: ipv6interfaceenablestatus
            	...
            	**type**\: :py:class:`Ipv6InterfaceEnableStatus_Enum <ydk.models.ip.IP_MIB.IPMIB.Ipv6InterfaceTable.Ipv6InterfaceEntry.Ipv6InterfaceEnableStatus_Enum>`
            ...
            .. attribute:: ipv6interfaceforwarding
            	...
            	**type**\: :py:class:`Ipv6InterfaceForwarding_Enum <ydk.models.ip.IP_MIB.IPMIB.Ipv6InterfaceTable.Ipv6InterfaceEntry.Ipv6InterfaceForwarding_Enum>`
            ...
            class Ipv6InterfaceEnableStatus_Enum(Enum):
                """
                Ipv6InterfaceEnableStatus_Enum
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.Ipv6InterfaceTable.Ipv6InterfaceEntry.Ipv6InterfaceEnableStatus_Enum']


            class Ipv6InterfaceForwarding_Enum(Enum):
                """
                Ipv6InterfaceForwarding_Enum
                ...
                def _meta_info():
                    from ydk.models.ip._meta import _IP_MIB as meta
                    return meta._meta_table['IPMIB.Ipv6InterfaceTable.Ipv6InterfaceEntry.Ipv6InterfaceForwarding_Enum']


            @property
            def _common_path(self):
                if self.ipv6interfaceifindex is None:
                    raise YPYDataValidationError('Key property ipv6interfaceifindex is None')
    ...
    class Ipv6RouterAdvertTable(object):
        ...
        .. attribute:: ipv6routeradvertentry
        	...
        	**type**\: list of :py:class:`Ipv6RouterAdvertEntry <ydk.models.ip.IP_MIB.IPMIB.Ipv6RouterAdvertTable.Ipv6RouterAdvertEntry>`
        ...
        class Ipv6RouterAdvertEntry(object):
            ...
            .. attribute:: ipv6routeradvertifindex
            ...
            def _common_path(self):
                if self.ipv6routeradvertifindex is None:
                    raise YPYDataValidationError('Key property ipv6routeradvertifindex is None')
    ...
    class Ipv6ScopeZoneIndexTable(object):
        ...
        .. attribute:: ipv6scopezoneindexentry
        	...
        	**type**\: list of :py:class:`Ipv6ScopeZoneIndexEntry <ydk.models.ip.IP_MIB.IPMIB.Ipv6ScopeZoneIndexTable.Ipv6ScopeZoneIndexEntry>`
        ...
        class Ipv6ScopeZoneIndexEntry(object):
            ...
            .. attribute:: ipv6scopezoneindexifindex
            ...
            def _common_path(self):
                if self.ipv6scopezoneindexifindex is None:
                    raise YPYDataValidationError('Key property ipv6scopezoneindexifindex is None')
    ...
    def _has_data(self):
        ...
        if self.icmpmsgstatstable is not None and self.icmpmsgstatstable.is_presence():
            return True

        if self.icmpstatstable is not None and self.icmpstatstable._has_data():
            return True

        if self.icmpstatstable is not None and self.icmpstatstable.is_presence():
            return True
        ...
        if self.ipaddressprefixtable is not None and self.ipaddressprefixtable.is_presence():
            return True

        if self.ipaddresstable is not None and self.ipaddresstable._has_data():
            return True

        if self.ipaddresstable is not None and self.ipaddresstable.is_presence():
            return True
        ...
        if self.ipdefaultroutertable is not None and self.ipdefaultroutertable.is_presence():
            return True

        if self.ipifstatstable is not None and self.ipifstatstable._has_data():
            return True

        if self.ipifstatstable is not None and self.ipifstatstable.is_presence():
            return True
        ...
        if self.ipnettophysicaltable is not None and self.ipnettophysicaltable.is_presence():
            return True

        if self.ipsystemstatstable is not None and self.ipsystemstatstable._has_data():
            return True

        if self.ipsystemstatstable is not None and self.ipsystemstatstable.is_presence():
            return True

        if self.iptrafficstats is not None and self.iptrafficstats._has_data():
            return True

        if self.iptrafficstats is not None and self.iptrafficstats.is_presence():
            return True

        if self.ipv4interfacetable is not None and self.ipv4interfacetable._has_data():
            return True

        if self.ipv4interfacetable is not None and self.ipv4interfacetable.is_presence():
            return True

        if self.ipv6interfacetable is not None and self.ipv6interfacetable._has_data():
            return True

        if self.ipv6interfacetable is not None and self.ipv6interfacetable.is_presence():
            return True

        if self.ipv6routeradverttable is not None and self.ipv6routeradverttable._has_data():
            return True

        if self.ipv6routeradverttable is not None and self.ipv6routeradverttable.is_presence():
            return True

        if self.ipv6scopezoneindextable is not None and self.ipv6scopezoneindextable._has_data():
            return True

        if self.ipv6scopezoneindextable is not None and self.ipv6scopezoneindextable.is_presence():
            return True
