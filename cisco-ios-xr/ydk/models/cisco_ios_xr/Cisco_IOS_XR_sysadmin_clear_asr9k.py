...
class Clear(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = OrderedDict([("controller", ("controller", Clear.Controller)), ("plugin", ("plugin", Clear.Plugin))])
        ...
        self._children_yang_names.add("plugin")
    ...
    class Controller(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_container_classes = OrderedDict([("switch", ("switch", Clear.Controller.Switch))])
            self._child_list_classes = OrderedDict([])
            self._leafs = OrderedDict()
        ...
        class Switch(Entity):
            ...
            class Oper(Entity):
                ...
                def __init__(self):
                    ...
                    self.has_list_ancestor = False
                    self.ylist_key_names = []
                    self._child_container_classes = OrderedDict([("fdb", ("fdb", Clear.Controller.Switch.Oper.Fdb)), ("statistics", ("statistics", Clear.Controller.Switch.Oper.Statistics))])
                    self._child_list_classes = OrderedDict([])
                    self._leafs = OrderedDict()
    ...
    class Plugin(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self.ylist_key_names = []
            self._child_container_classes = OrderedDict([("slot", ("slot", Clear.Plugin.Slot))])
            self._child_list_classes = OrderedDict([])
            self._leafs = OrderedDict()
            ...
            self._children_yang_names.add("slot")
        ...
        class Slot(Entity):
            ...
            def __init__(self):
                ...
                self.ylist_key_names = []
                self._child_container_classes = OrderedDict([])
                self._child_list_classes = OrderedDict([("location", ("location", Clear.Plugin.Slot.Location))])
                self._leafs = OrderedDict()
