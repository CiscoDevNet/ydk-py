...
class Pce(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"backoff" : ("backoff", Pce.Backoff), "disjoint-path" : ("disjoint_path", Pce.DisjointPath), "explicit-paths" : ("explicit_paths", Pce.ExplicitPaths), "logging" : ("logging", Pce.Logging), "netconf" : ("netconf", Pce.Netconf), "pcc-addresses" : ("pcc_addresses", Pce.PccAddresses), "segment-routing" : ("segment_routing", Pce.SegmentRouting), "state-syncs" : ("state_syncs", Pce.StateSyncs), "timers" : ("timers", Pce.Timers)}
    ...
    def __setattr__(self, name, value):
        self._perform_setattr(Pce, ['enable', 'password', 'server_address'], name, value)
    ...
    class Backoff(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(Pce.Backoff, ['difference', 'ratio', 'threshold'], name, value)
        ...
        class ExplicitPath(Entity):
            ...
            class PathHops(Entity):
                ...
                class PathHop(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Pce.ExplicitPaths.ExplicitPath.PathHops.PathHop, ['index', 'address', 'hop_type', 'mpls_label', 'remote_address'], name, value)
    ...
    class Logging(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(Pce.Logging, ['fallback', 'no_path'], name, value)
        ...
        class PccAddress(Entity):
            ...
            class LspNames(Entity):
                ...
                class LspName(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(Pce.PccAddresses.PccAddress.LspNames.LspName, ['name', 'enable', 'explicit_path_name', 'undelegate'], name, value)
                    ...
                    class RsvpTe(Entity):
                        ...
                        def __setattr__(self, name, value):
                            self._perform_setattr(Pce.PccAddresses.PccAddress.LspNames.LspName.RsvpTe, ['bandwidth', 'enable', 'fast_protect'], name, value)
                        ...
                        class Affinity(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(Pce.PccAddresses.PccAddress.LspNames.LspName.RsvpTe.Affinity, ['exclude_any', 'include_all', 'include_any'], name, value)
                        ...
                        class Priority(Entity):
                            ...
                            def __setattr__(self, name, value):
                                self._perform_setattr(Pce.PccAddresses.PccAddress.LspNames.LspName.RsvpTe.Priority, ['hold_priority', 'setup_priority'], name, value)
    ...
    class SegmentRouting(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(Pce.SegmentRouting, ['strict_sid_only', 'te_latency'], name, value)
    ...
    class Timers(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(Pce.Timers, ['keepalive', 'minimum_peer_keepalive', 'reoptimization_timer'], name, value)
