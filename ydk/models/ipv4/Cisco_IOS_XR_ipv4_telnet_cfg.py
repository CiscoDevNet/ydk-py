...
class Ipv6Telnet(object):
    ...
    .. attribute:: client
    	...
    	**type**\: :py:class:`Client <ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg.Ipv6Telnet.Client>`
    ...
    class Client(object):
        ...
        @staticmethod
        def _meta_info():
            from ydk.models.ipv4._meta import _Cisco_IOS_XR_ipv4_telnet_cfg as meta
...
class Ipv4Telnet(object):
    ...
    .. attribute:: client
    	...
    	Telnet client configuration
    	**type**\: :py:class:`Client <ydk.models.ipv4.Cisco_IOS_XR_ipv4_telnet_cfg.Ipv4Telnet.Client>`
