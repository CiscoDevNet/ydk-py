...
class QBRIDGEMIB(Entity):
    ...
    def __init__(self):
        ...
        self._child_container_classes = {"dot1qBase" : ("dot1qbase", QBRIDGEMIB.Dot1Qbase), "dot1qFdbTable" : ("dot1qfdbtable", QBRIDGEMIB.Dot1Qfdbtable), "dot1qForwardAllTable" : ("dot1qforwardalltable", QBRIDGEMIB.Dot1Qforwardalltable), "dot1qForwardUnregisteredTable" : ("dot1qforwardunregisteredtable", QBRIDGEMIB.Dot1Qforwardunregisteredtable), "dot1qLearningConstraintsTable" : ("dot1qlearningconstraintstable", QBRIDGEMIB.Dot1Qlearningconstraintstable), "dot1qPortVlanHCStatisticsTable" : ("dot1qportvlanhcstatisticstable", QBRIDGEMIB.Dot1Qportvlanhcstatisticstable), "dot1qPortVlanStatisticsTable" : ("dot1qportvlanstatisticstable", QBRIDGEMIB.Dot1Qportvlanstatisticstable), "dot1qStaticMulticastTable" : ("dot1qstaticmulticasttable", QBRIDGEMIB.Dot1Qstaticmulticasttable), "dot1qStaticUnicastTable" : ("dot1qstaticunicasttable", QBRIDGEMIB.Dot1Qstaticunicasttable), "dot1qTpFdbTable" : ("dot1qtpfdbtable", QBRIDGEMIB.Dot1Qtpfdbtable), "dot1qTpGroupTable" : ("dot1qtpgrouptable", QBRIDGEMIB.Dot1Qtpgrouptable), "dot1qVlan" : ("dot1qvlan", QBRIDGEMIB.Dot1Qvlan), "dot1qVlanCurrentTable" : ("dot1qvlancurrenttable", QBRIDGEMIB.Dot1Qvlancurrenttable), "dot1qVlanStaticTable" : ("dot1qvlanstatictable", QBRIDGEMIB.Dot1Qvlanstatictable), "dot1vProtocolGroupTable" : ("dot1vprotocolgrouptable", QBRIDGEMIB.Dot1Vprotocolgrouptable), "dot1vProtocolPortTable" : ("dot1vprotocolporttable", QBRIDGEMIB.Dot1Vprotocolporttable)}
    ...
    class Dot1Qbase(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(QBRIDGEMIB.Dot1Qbase, ['dot1qgvrpstatus', 'dot1qmaxsupportedvlans', 'dot1qmaxvlanid', 'dot1qnumvlans', 'dot1qvlanversionnumber'], name, value)
    ...
    class Dot1Qfdbtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qFdbEntry" : ("dot1qfdbentry", QBRIDGEMIB.Dot1Qfdbtable.Dot1Qfdbentry)}
        ...
        class Dot1Qfdbentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qFdbEntry" + "[dot1qFdbId='" + self.dot1qfdbid.get() + "']"
    ...
    class Dot1Qforwardalltable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qForwardAllEntry" : ("dot1qforwardallentry", QBRIDGEMIB.Dot1Qforwardalltable.Dot1Qforwardallentry)}
        ...
        class Dot1Qforwardallentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qForwardAllEntry" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qForwardAllTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qforwardalltable.Dot1Qforwardallentry, ['dot1qvlanindex', 'dot1qforwardallforbiddenports', 'dot1qforwardallports', 'dot1qforwardallstaticports'], name, value)
    ...
    class Dot1Qforwardunregisteredtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qForwardUnregisteredEntry" : ("dot1qforwardunregisteredentry", QBRIDGEMIB.Dot1Qforwardunregisteredtable.Dot1Qforwardunregisteredentry)}
        ...
        class Dot1Qforwardunregisteredentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qForwardUnregisteredEntry" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qForwardUnregisteredTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qforwardunregisteredtable.Dot1Qforwardunregisteredentry, ['dot1qvlanindex', 'dot1qforwardunregisteredforbiddenports', 'dot1qforwardunregisteredports', 'dot1qforwardunregisteredstaticports'], name, value)
    ...
    class Dot1Qlearningconstraintstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qLearningConstraintsEntry" : ("dot1qlearningconstraintsentry", QBRIDGEMIB.Dot1Qlearningconstraintstable.Dot1Qlearningconstraintsentry)}
        ...
        class Dot1Qlearningconstraintsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qLearningConstraintsEntry" + "[dot1qConstraintVlan='" + self.dot1qconstraintvlan.get() + "']" + "[dot1qConstraintSet='" + self.dot1qconstraintset.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qLearningConstraintsTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qlearningconstraintstable.Dot1Qlearningconstraintsentry, ['dot1qconstraintvlan', 'dot1qconstraintset', 'dot1qconstraintstatus', 'dot1qconstrainttype'], name, value)
    ...
    class Dot1Qportvlanhcstatisticstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qPortVlanHCStatisticsEntry" : ("dot1qportvlanhcstatisticsentry", QBRIDGEMIB.Dot1Qportvlanhcstatisticstable.Dot1Qportvlanhcstatisticsentry)}
        ...
        class Dot1Qportvlanhcstatisticsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qPortVlanHCStatisticsEntry" + "[dot1dBasePort='" + self.dot1dbaseport.get() + "']" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qPortVlanHCStatisticsTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qportvlanhcstatisticstable.Dot1Qportvlanhcstatisticsentry, ['dot1dbaseport', 'dot1qvlanindex', 'dot1qtpvlanporthcindiscards', 'dot1qtpvlanporthcinframes', 'dot1qtpvlanporthcoutframes'], name, value)
    ...
    class Dot1Qportvlanstatisticstable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qPortVlanStatisticsEntry" : ("dot1qportvlanstatisticsentry", QBRIDGEMIB.Dot1Qportvlanstatisticstable.Dot1Qportvlanstatisticsentry)}
        ...
        class Dot1Qportvlanstatisticsentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qPortVlanStatisticsEntry" + "[dot1dBasePort='" + self.dot1dbaseport.get() + "']" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qPortVlanStatisticsTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qportvlanstatisticstable.Dot1Qportvlanstatisticsentry, ['dot1dbaseport', 'dot1qvlanindex', 'dot1qtpvlanportindiscards', 'dot1qtpvlanportinframes', 'dot1qtpvlanportinoverflowdiscards', 'dot1qtpvlanportinoverflowframes', 'dot1qtpvlanportoutframes', 'dot1qtpvlanportoutoverflowframes'], name, value)
    ...
    class Dot1Qstaticmulticasttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qStaticMulticastEntry" : ("dot1qstaticmulticastentry", QBRIDGEMIB.Dot1Qstaticmulticasttable.Dot1Qstaticmulticastentry)}
        ...
        class Dot1Qstaticmulticastentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qStaticMulticastEntry" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']" + "[dot1qStaticMulticastAddress='" + self.dot1qstaticmulticastaddress.get() + "']" + "[dot1qStaticMulticastReceivePort='" + self.dot1qstaticmulticastreceiveport.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qStaticMulticastTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qstaticmulticasttable.Dot1Qstaticmulticastentry, ['dot1qvlanindex', 'dot1qstaticmulticastaddress', 'dot1qstaticmulticastreceiveport', 'dot1qstaticmulticastforbiddenegressports', 'dot1qstaticmulticaststaticegressports', 'dot1qstaticmulticaststatus'], name, value)
    ...
    class Dot1Qstaticunicasttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qStaticUnicastEntry" : ("dot1qstaticunicastentry", QBRIDGEMIB.Dot1Qstaticunicasttable.Dot1Qstaticunicastentry)}
        ...
        class Dot1Qstaticunicastentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qStaticUnicastEntry" + "[dot1qFdbId='" + self.dot1qfdbid.get() + "']" + "[dot1qStaticUnicastAddress='" + self.dot1qstaticunicastaddress.get() + "']" + "[dot1qStaticUnicastReceivePort='" + self.dot1qstaticunicastreceiveport.get() + "']"
    ...
    class Dot1Qtpfdbtable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qTpFdbEntry" : ("dot1qtpfdbentry", QBRIDGEMIB.Dot1Qtpfdbtable.Dot1Qtpfdbentry)}
        ...
        class Dot1Qtpfdbentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qTpFdbEntry" + "[dot1qFdbId='" + self.dot1qfdbid.get() + "']" + "[dot1qTpFdbAddress='" + self.dot1qtpfdbaddress.get() + "']"
    ...
    class Dot1Qtpgrouptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qTpGroupEntry" : ("dot1qtpgroupentry", QBRIDGEMIB.Dot1Qtpgrouptable.Dot1Qtpgroupentry)}
        ...
        class Dot1Qtpgroupentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qTpGroupEntry" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']" + "[dot1qTpGroupAddress='" + self.dot1qtpgroupaddress.get() + "']"
    ...
    class Dot1Qvlan(Entity):
        ...
        def __setattr__(self, name, value):
            self._perform_setattr(QBRIDGEMIB.Dot1Qvlan, ['dot1qconstraintsetdefault', 'dot1qconstrainttypedefault', 'dot1qnextfreelocalvlanindex', 'dot1qvlannumdeletes'], name, value)
    ...
    class Dot1Qvlancurrenttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qVlanCurrentEntry" : ("dot1qvlancurrententry", QBRIDGEMIB.Dot1Qvlancurrenttable.Dot1Qvlancurrententry)}
        ...
        class Dot1Qvlancurrententry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qVlanCurrentEntry" + "[dot1qVlanTimeMark='" + self.dot1qvlantimemark.get() + "']" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qVlanCurrentTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qvlancurrenttable.Dot1Qvlancurrententry, ['dot1qvlantimemark', 'dot1qvlanindex', 'dot1qvlancreationtime', 'dot1qvlancurrentegressports', 'dot1qvlancurrentuntaggedports', 'dot1qvlanfdbid', 'dot1qvlanstatus'], name, value)
    ...
    class Dot1Qvlanstatictable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1qVlanStaticEntry" : ("dot1qvlanstaticentry", QBRIDGEMIB.Dot1Qvlanstatictable.Dot1Qvlanstaticentry)}
        ...
        class Dot1Qvlanstaticentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1qVlanStaticEntry" + "[dot1qVlanIndex='" + self.dot1qvlanindex.get() + "']"
                self._absolute_path = lambda: "Q-BRIDGE-MIB:Q-BRIDGE-MIB/dot1qVlanStaticTable/%s" % self._segment_path()

            def __setattr__(self, name, value):
                self._perform_setattr(QBRIDGEMIB.Dot1Qvlanstatictable.Dot1Qvlanstaticentry, ['dot1qvlanindex', 'dot1qvlanforbiddenegressports', 'dot1qvlanstaticegressports', 'dot1qvlanstaticname', 'dot1qvlanstaticrowstatus', 'dot1qvlanstaticuntaggedports'], name, value)
    ...
    class Dot1Vprotocolgrouptable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1vProtocolGroupEntry" : ("dot1vprotocolgroupentry", QBRIDGEMIB.Dot1Vprotocolgrouptable.Dot1Vprotocolgroupentry)}
        ...
        class Dot1Vprotocolgroupentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1vProtocolGroupEntry" + "[dot1vProtocolTemplateFrameType='" + self.dot1vprotocoltemplateframetype.get() + "']" + "[dot1vProtocolTemplateProtocolValue='" + self.dot1vprotocoltemplateprotocolvalue.get() + "']"
    ...
    class Dot1Vprotocolporttable(Entity):
        ...
        def __init__(self):
            ...
            self.has_list_ancestor = False
            self._child_container_classes = {}
            self._child_list_classes = {"dot1vProtocolPortEntry" : ("dot1vprotocolportentry", QBRIDGEMIB.Dot1Vprotocolporttable.Dot1Vprotocolportentry)}
        ...
        class Dot1Vprotocolportentry(Entity):
            ...
            def __init__(self):
                ...
                self._segment_path = lambda: "dot1vProtocolPortEntry" + "[dot1dBasePort='" + self.dot1dbaseport.get() + "']" + "[dot1vProtocolPortGroupId='" + self.dot1vprotocolportgroupid.get() + "']"
