...
_meta_table = {
    'CISCOPINGMIB.CiscoPingTable.CiscoPingEntry' : {
        'meta_info' : _MetaInfoClass('CISCOPINGMIB.CiscoPingTable.CiscoPingEntry',
            ...
            _MetaInfoClassMember('ciscoPingEntryOwner', ATTRIBUTE, 'str' , None, None, 
                ...
                'ciscopingentryowner',
                'CISCO-PING-MIB', False),
            _MetaInfoClassMember('ciscoPingEntryStatus', REFERENCE_ENUM_CLASS, 'RowStatus_Enum' , 'ydk.models.snmpv2.SNMPv2_TC', 'RowStatus_Enum', 
                [], [], 
            ...
            _MetaInfoClassMember('ciscoPingPacketTimeout', ATTRIBUTE, 'int' , None, None, 
                ...
                'CISCO-PING-MIB', False),
            _MetaInfoClassMember('ciscoPingProtocol', REFERENCE_ENUM_CLASS, 'CiscoNetworkProtocol_Enum' , 'ydk.models.tc.CISCO_TC', 'CiscoNetworkProtocol_Enum', 
                [], [], 
                '''                The protocol to use.
        ...
        'ydk.models.ping.CISCO_PING_MIB'
        ),
    },
    'CISCOPINGMIB.CiscoPingTable' : {
        'meta_info' : _MetaInfoClass('CISCOPINGMIB.CiscoPingTable',
            False, 
            [
            _MetaInfoClassMember('ciscoPingEntry', REFERENCE_LIST, 'CiscoPingEntry' , 'ydk.models.ping.CISCO_PING_MIB', 'CISCOPINGMIB.CiscoPingTable.CiscoPingEntry', 
                [], [], 
    ...
    'CISCOPINGMIB' : {
        'meta_info' : _MetaInfoClass('CISCOPINGMIB',
            False, 
            [
            _MetaInfoClassMember('ciscoPingTable', REFERENCE_CLASS, 'CiscoPingTable' , 'ydk.models.ping.CISCO_PING_MIB', 'CISCOPINGMIB.CiscoPingTable', 
                [], [], 
