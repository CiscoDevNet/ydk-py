...
_meta_table = {
    'InvAdminState_Enum' : _MetaInfoEnum('InvAdminState_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
    ...
    'InvResetReason_Enum' : _MetaInfoEnum('InvResetReason_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
    ...
    'InvCardState_Enum' : _MetaInfoEnum('InvCardState_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
    ...
    'InvMonitorState_Enum' : _MetaInfoEnum('InvMonitorState_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
            'unmonitored':'UNMONITORED',
            'monitored':'MONITORED',
        }, 'Cisco-IOS-XR-plat-chas-invmgr-oper', _yang_ns._namespaces['Cisco-IOS-XR-plat-chas-invmgr-oper']),
    'NodeState_Enum' : _MetaInfoEnum('NodeState_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
    ...
    'CardRedundancyState_Enum' : _MetaInfoEnum('CardRedundancyState_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
            'active':'ACTIVE',
            'standby':'STANDBY',
        }, 'Cisco-IOS-XR-plat-chas-invmgr-oper', _yang_ns._namespaces['Cisco-IOS-XR-plat-chas-invmgr-oper']),
    'InvPowerAdminState_Enum' : _MetaInfoEnum('InvPowerAdminState_Enum', 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper',
        {
    ...
    'Platform.Racks.Rack.Slots.Slot.Instances.Instance.State' : {
        'meta_info' : _MetaInfoClass('Platform.Racks.Rack.Slots.Slot.Instances.Instance.State',
            ...
            _MetaInfoClassMember('card-redundancy-state', REFERENCE_ENUM_CLASS, 'CardRedundancyState_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'CardRedundancyState_Enum', 
                [], [], 
                '''                Redundancy state
                ''',
            ...
            _MetaInfoClassMember('plim', ATTRIBUTE, 'str' , None, None, 
                ...
                'plim',
                'Cisco-IOS-XR-plat-chas-invmgr-oper', False),
            _MetaInfoClassMember('state', REFERENCE_ENUM_CLASS, 'NodeState_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'NodeState_Enum', 
                [], [], 
                '''                State
                ''',
                'state',
    ...
    'PlatformInventory.Racks.Rack.Attributes.FruInfo' : {
        'meta_info' : _MetaInfoClass('PlatformInventory.Racks.Rack.Attributes.FruInfo',
            ...
            _MetaInfoClassMember('last-operational-state-change', REFERENCE_CLASS, 'LastOperationalStateChange' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'PlatformInventory.Racks.Rack.Attributes.FruInfo.LastOperationalStateChange', 
                ...
                'Cisco-IOS-XR-plat-chas-invmgr-oper', False),
            _MetaInfoClassMember('module-administrative-state', REFERENCE_ENUM_CLASS, 'InvAdminState_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'InvAdminState_Enum', 
                [], [], 
                '''                Administrative    state
                ''',
                'module_administrative_state',
                'Cisco-IOS-XR-plat-chas-invmgr-oper', False),
            _MetaInfoClassMember('module-monitor-state', REFERENCE_ENUM_CLASS, 'InvMonitorState_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'InvMonitorState_Enum', 
                [], [], 
                '''                Monitor state
                ''',
                'module_monitor_state',
                'Cisco-IOS-XR-plat-chas-invmgr-oper', False),
            _MetaInfoClassMember('module-operational-state', REFERENCE_ENUM_CLASS, 'InvCardState_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'InvCardState_Enum', 
                [], [], 
                '''                Operation state
                ''',
                'module_operational_state',
                'Cisco-IOS-XR-plat-chas-invmgr-oper', False),
            _MetaInfoClassMember('module-power-administrative-state', REFERENCE_ENUM_CLASS, 'InvPowerAdminState_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'InvPowerAdminState_Enum', 
                [], [], 
                '''                Power administrative state
                ''',
                'module_power_administrative_state',
                'Cisco-IOS-XR-plat-chas-invmgr-oper', False),
            _MetaInfoClassMember('module-reset-reason', REFERENCE_ENUM_CLASS, 'InvResetReason_Enum' , 'ydk.models.plat.Cisco_IOS_XR_plat_chas_invmgr_oper', 'InvResetReason_Enum', 
                [], [], 
                '''                Reset reason
                ''',
                'module_reset_reason',
